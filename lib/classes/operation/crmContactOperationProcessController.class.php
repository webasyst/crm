...
class crmContactOperationProcessController extends crmJsonController
{
    /**
     * @var int
     */
    ...
    {
        return $this->getContactsCollection()->count();
    }
    ...
    protected function getContext()
    {
        $context = array(
            ...
            'is_checked_all' => (int) $this->isCheckedAll(),    // for js it must be 1 or 0
            'hash' => $this->getHash(),
            'contact_ids' => null
        );
