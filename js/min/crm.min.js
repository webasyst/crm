...
function(){function b(h){return{left:parseInt((e-h.width)/2),top:parseInt((f-h.height)/2)}}var c=this.$window,e=c.width(),f=c.height();c=this.$block?this.$block:this.$wrapper;var g=c.outerWidth(),l=c.outerHeight();var k=this.position?this.position:(this.userPosition?this.userPosition:b)({width:g,height:l});0<k.left&&k.left+g>e&&(k.left=e-g-20);0<k.top?k.top+l>f&&(k.top=f-l-20):(k.top=20,g=c.find(".crm-dialog-content"),g.hide(),l=c.outerHeight(),g.height(f-l-40).addClass("is-long-content").show());
c.css(k)};CRMDialog.prototype.close=function(){this.is_closed=!0;this.onClose(this.$wrapper,this);this.$wrapper.remove()};CRMDialog.prototype.resize=function(){this.$block.addClass("is-animated");this.setPosition();if(this.onResize)this.onResize(this.$wrapper,this)};CRMDialog.prototype.hide=function(){this.$wrapper.hide();this.is_visible=!1};CRMDialog.prototype.show=function(){this.$wrapper.show();this.is_visible=!0};return CRMDialog}(jQuery);var CRMElasticBlock=function(d){CRMElasticBlock=function(a){this.$window=d(window);this.$wrapper=a.$wrapper;this.$aside=a.$aside;this.$content=a.$content;this.top_fix_class="fixed-to-top";this.bottom_fix_class="fixed-to-bottom";this.debug=a.debug;this.initClass()};CRMElasticBlock.prototype.initClass=function(){function a(){if(d.contains(document,p[0])){var A=Math.floor(l.$content.outerHeight()),C=Math.floor(p.outerHeight()),E=Math.floor(n.height()),F=m.scrollTop(),G=Math.floor(p.offset().top),H=B>
F?1:-1,I=F-v;D=p.width();if(!(!t&&E>r&&760<=q)||A&&A<C)t?(E=Math.floor(n.height()),G=Math.floor(n.offset().top),G=E+G-r-F,H=C-r,t=!1,E>C&&F>v&&(H<G?e(0):f())):g();else{A=r>C+0;var K=F<=v,J=parseInt(G+C-F-r),L=0<J;J=0>=J;if(A)0<I+0?(w||x||!y)&&e(0):(w||y||x||z)&&g();else if(K){if(w||x||y)z?G<=v&&g():g()}else L?0<H?G>=0+F&&(w||!y||x)&&e():(!w||y||x)&&c(G-v):J?u.top+E<F+r?(!w||y||x)&&c(E-C):0<H?(!w||y||x)&&c(G-v):(w||y||!x)&&f():(!w||y||x)&&c(G-v)}B=F}else m.off("scroll",a)}function b(){d.contains(document,
p[0])?(q=Math.floor(m.width()),r=Math.floor(m.height()),g(),m.trigger("scroll")):m.off("scroll",b)}function c(A){l.log("Manual top scroll position");p.css("top",A).width(D).removeClass(k).removeClass(h);w=!0;y=x=z=!1}function e(A){l.log("Fixed to top scroll position");p.removeAttr("style").width(D).removeClass(h).addClass(k);A&&(z=!0,p.css("top",A));w=x=!1;y=!0}function f(){l.log("Fixed to bottom scroll position");p.removeAttr("style").width(D).removeClass(k).addClass(h);w=y=z=!1;x=!0}function g(){l.log("Default scroll position");
p.removeAttr("style").removeClass(h).removeClass(k);w=y=x=z=!1}var l=this,k=l.top_fix_class,h=l.bottom_fix_class,m=l.$window,n=l.$wrapper,p=l.$aside;p.addClass("crm-elastic-block");var q=Math.floor(m.width()),r=Math.floor(m.height()),u=n.offset(),v=p.offset().top,t=!0,w=!1,x=!1,y=!1,z=!1,B=0,D;m.on("scroll",a).on("resize",b)};CRMElasticBlock.prototype.log=function(a){this.debug&&console.log(a)};return CRMElasticBlock}(jQuery);(function(d){function a(c,e){var f=d(window);e=f.scrollTop();var g=f.scrollLeft()+f.width(),l=f.scrollTop()+f.height();f=f.scrollLeft();var k=c.element.offset();k.right=k.left+c.element.outerWidth();k.bottom=k.top+c.element.outerHeight();return e<k.top&&f<k.left&&g>k.right&&l>k.bottom}function b(c,e){return c.clone().addClass(e.fixed_class||"sticky-fixed").css(d.extend({position:"fixed",display:"none"},e.fixed_css||{})).removeAttr("id").insertAfter(c)}d.fn.sticky=function(c){function e(){f.closest("body").length?
d.each(l,function(k,h){g.isStaticVisible.call(h.element,h,g)?h.is_fixed&&(h.is_fixed=!1,h.fixed_clone.hide(),g.hideFixed&&g.hideFixed.call(h.fixed_clone,h,g)):(h.is_fixed||(h.is_fixed=!0,h.fixed_clone.show(),g.showFixed&&g.showFixed.call(h.fixed_clone,h,g)),g.updateFixed&&g.updateFixed.call(h.fixed_clone,h,g))}):d(window).off("resize scroll",e)}var f=this,g=d.extend({fixed_class:"sticky-fixed",isStaticVisible:a,getClone:b},c||{}),l=f.map(function(){var k=d(this);return{element:k,fixed_clone:g.getClone.call(k,
...
"XHR error "+b.status).replace("%text%",b.responseText).replace("%button%","Close")),d.waDialog({html:a,onOpen:function(f,g){f.find(".wa-exception-debug-dump #Trace pre").each(function(){var l=d(this),k=l.html().replace(/^(#(#|\d+)\s+(wa-system|index\.php|\{main\}).*)$/gm,'<span style="color:#999">$1</span>');l.html(k)})}}),-1===a.indexOf("dialog-background")&&(document.open("text/html"),document.write(b.responseText),document.close()))});d.crm=d.extend(d.crm||{},{lang:!1,app_url:!1,backend_url:!1,
is_debug:!1,is_page_loaded:!1,content:!1,sidebar:!1,storage:new d.store,locales:!1,confirm:{show:function(a){var b=a.title||"",c=a.text||"",e=a.button||"",f=a.onConfirm||function(){},g=a.onCancel||function(){};a=a.onClose||function(){};var l=d.crm.confirm.template;return(l=l.replace("%title%",b).replace("%text%",c).replace("%button%",e))?d.waDialog({html:l,onOpen:function(k,h){k.on("click",".js-confirm-dialog",function(m){m.preventDefault();h.options.onConfirm();h.close()});k.on("click",".js-cancel-dialog",
...
1.055,2.4):p/12.92;h=(.4124*m+.3576*n+.1805*p)/.95047;var q=.2126*m+.7152*n+.0722*p;m=(.0193*m+.1192*n+.9505*p)/1.08883;h=.008856<h?Math.pow(h,1/3):7.787*h+16/116;q=.008856<q?Math.pow(q,1/3):7.787*q+16/116;m=.008856<m?Math.pow(m,1/3):7.787*m+16/116;return[116*q-16,500*(h-q),200*(q-m)]}function l(h,m,n){var p=Math.floor(6*h),q=6*h-p;h=n*(1-m);var r=n*(1-q*m);m=n*(1-(1-q)*m);switch(p%6){case 0:var u=n;var v=m;var t=h;break;case 1:u=r;v=n;t=h;break;case 2:u=h;v=n;t=m;break;case 3:u=h;v=r;t=n;break;case 4:u=
m;v=h;t=n;break;case 5:u=n,v=h,t=r}return[255*u,255*v,255*t]}function k(h){var m=h[0]/255,n=h[1]/255,p=h[2]/255,q,r=Math.max(m,n,p);var u=r-Math.min(m,n,p);if(0==u)var v=q=0;else{q=u/r;h=(r-m)/6/u+.5;var t=(r-n)/6/u+.5;u=(r-p)/6/u+.5;m===r?v=u-t:n===r?v=1/3+h-u:p===r&&(v=2/3+t-h);0>v?v+=1:1<v&&--v}return{h:Math.round(360*v),s:Math.round(100*q),b:Math.round(100*r)}}b=function(h){h=this.hex=h;var m=!1;"string"===typeof h?(h=h.replace("#",""),3===h.length?m=c(h[0]+""+h[0],h[1]+""+h[1],h[2]+""+h[2]):
...
p?p=100:0>p&&(p=0);return p}var n=k(this.rgb);n.s=m(n.s*(1+h/100));n.b=m(n.b*(1+h/100));h=l(n.h/360,n.s/100,n.b/100);return e(h)};return b}();return new b(a)},initWYSIWYG:function(a,b){if(!a||!a.length||a.data("redactor"))return a;b=d.extend({minHeight:130,buttons:"inline bold italic underline deleted lists outdent indent image link horizontalrule fontcolor fontsize fontfamily".split(" "),plugins:["fontcolor","fontsize","fontfamily"],allowedTags:"a b i u pre blockquote p strong em del strike span ul ol li div span br".split(" "),
uploadImage:!1,lang:this.lang},b||{});a.redactor(b);d(document).one("wa_before_render",function(){d.contains(document,a[0])&&a.data("redactor")&&a.redactor("core.destroy")});return a},escape:function(a){return d("<div />").text(a).html()},runBackgroundWorker:function(a){var b=Math.floor(100*Math.random())/100,c=Math.floor(100*Math.random())/100,e=a.delay||1E4,f=e/2,g=a.id||(""+Math.random()).slice(2),l=null,k=null,h=a.url;h?(e+=f*b,200>=e?console.error("Delay value too low"):function(){try{var m=
function(){l&&clearTimeout(l);k&&k.abort();k=d.post(h,{process_id:g});k.always(function(){k=null;l=setTimeout(m,e)});k.fail(function(){return!1})};l=setTimeout(m,500+300*c)}catch(n){console.error(["source email worker fail",n])}}()):console.error("Empty url")}})})(jQuery);(function(d,a){d.fn.serializeObject=function(){var b={};d.each(this.serializeArray(),function(c,e){c=e.name;e=e.value;b[c]=b[c]===a?e:d.isArray(b[c])?b[c].concat(e):[b[c],e]});return b}})(jQuery);
...
f.$wrapper;this.$outer_wrapper=f.$outer_wrapper;this.debug=f.debug;this.indent=f.indent;this.$clone=null;this.offset=this.getOffset();this.type=null;this.init()};b.prototype.init=function(){function f(){c.contains(document,l.$wrapper[0])?(l.reset(),l.onScroll()):c(document).off("refresh",f)}function g(){if(c.contains(l.$window[0].document,l.$wrapper[0]))l.onScroll();else l.$window.off("scroll",g)}var l=this;l.$clone=function(h){var m=c("<div />");h.before(m);return m.hide()}(l.$wrapper);l.onScroll();
var k=0;l.$window.on("resize",function(){clearTimeout(k);k=setTimeout(function(){l.reset();l.onScroll()},50)});c(document).on("refresh",f);l.$window.on("scroll",g)};b.prototype.onScroll=function(){var f=this.$window.scrollTop(),g=e(this),l=this.$window,k=l.width();l.height();l=this.offset;var h=this.$outer_wrapper.outerHeight();!(0<k)||h<=this.offset.height?this.fixTo("default"):f<=l.top-g?this.fixTo("default"):this.fixTo("fix_top")};b.prototype.fixTo=function(f,g){function l(){var m=h.getHeight();
h.$wrapper.css({position:"static",top:"auto",left:"auto",width:"auto",height:m});h.$clone.hide().height(0)}function k(){var m=h.getHeight();h.$wrapper.css({position:"fixed",top:e(h),left:h.offset.left,width:h.offset.width,height:m});h.$clone.css({height:m}).show()}var h=this;f=f?f:null;"fix_top"===f?(k(),h.type!==f&&h.$wrapper.addClass("is-fixed")):(l(),h.type!==f&&h.$wrapper.removeClass("is-fixed"));h.type=f;h.log(f)};b.prototype.reset=function(){this.fixTo("default");this.offset=this.getOffset()};
...
CRMDeal.prototype.initLogSection=function(){var c=this.deal_id;this.$log_section.on("click",".js-open-conversation",function(e){e.preventDefault();e=d(this).attr("href");-1===e.indexOf("?")?window.location.href=e+"?deal_id="+c:window.location.href=e+"&deal_id="+c})};CRMDeal.prototype.initScroll=function(){function c(){d.contains(document,l.$wrapper[0])?f():k.off("scroll",c)}function e(){d.contains(document,l.$wrapper[0])?g():k.off("resize",e)}function f(){0<k.scrollTop()?m||(h.show(),m=!0):m&&(h.hide(),
m=!1)}function g(){var q=p.offset().left;h.css("right",k.width()-q)}var l=this,k=d(window),h=d('<div class="c-scroll-action"><div class="c-icon to-top"></div></div>'),m=!1,n=l.$wrapper.find(".c-deal-board"),p=l.$wrapper.find(".c-deal-aside-wrapper");n.append(h);f();g();h.on("click",function(){d("html, body").animate({scrollTop:0},500)});k.on("scroll",c);k.on("resize",e)};CRMDeal.prototype.initSticky=function(){function c(){0<f[0].scrollTop?f.addClass("is-scrolled"):f.removeClass("is-scrolled")}var e=
this.$wrapper.find(".js-page-header"),f=this.$wrapper.find("#js-deal-aside");new a({$wrapper:e,$outer_wrapper:this.$wrapper,debug:!1});new b({$wrapper:f,$outer_wrapper:f.closest(".c-deal-board"),indent:function(){return e.outerHeight()},debug:!1});c();f.on("scroll",c)};CRMDeal.prototype.initChangeState=function(){function c(f){function g(){d.crm.content.load(d.crm.app_url+"deal/"+e.deal_id+"/")}d.post("?module=deal&action=move",{deal_id:e.deal_id,stage_id:f},function(l){"ok"===l.status&&(l.data.dialog_html&&
...
e||(e=!0,d.post("?module=deal&action=closeDialog",{id:c.deal_id},function(g){new CRMDialog({html:g})}).always(function(){e=!1}))})};CRMDeal.prototype.initReopenDeal=function(){var c=this,e=!1;c.$wrapper.on("click",".js-reopen-deal",function(f){f.preventDefault();e||(e=!0,d.post("?module=deal&action=reopen",{id:c.deal_id},function(g){"ok"==g.status?d.crm.content.reload():alert("Error: Deal Reopen")},"json").always(function(){e=!1}))})};CRMDeal.prototype.initAddContact=function(){function c(k,h){k=
k.closest(".c-add-contact");h?(l.hide(),k.addClass("is-shown")):(l.show(),k.removeClass("is-shown"))}function e(k,h){function m(n){n=n?n:[];d.each(n,function(p,q){p=q.text;var r=d('<div class="errormsg" />').html(p);l.one("click",function(){r.remove()});g.prepend(r)})}h=h?h:function(){};d.post("?module=deal&action=userAdd",{contact_id:k,deal_id:f.deal_id},function(n){"ok"===n.status?h(n.data.html):n.errors&&m(n.errors)},"json")}var f=this,g=f.$aside.find(".js-add-user-wrapper"),l=g.find(".js-add-contact");
l.on("click",function(k){k.preventDefault();c(d(this),!0)});g.on("click",".js-close-add-contact",function(k){k.preventDefault();c(d(this))});(function(){function k(m,n){var p=f.$aside.find('.c-contact[data-id="'+m+'"]');p.length&&h(p);e(m,function(q){q=d(q);n.before(q);h(q);d(document).trigger("refresh")})}function h(m){m.addClass("is-highlight");setTimeout(function(){d.each(m,function(n,p){d.contains(document,p)&&d(this).removeClass("is-highlight")})},3E3)}f.$aside.find(".js-contact-autocomplete").each(function(){var m=
...
r.stopPropagation()}));return q};m.on("focus",function(){m.data("uiAutocomplete").search(m.val())})})})()};CRMDeal.prototype.initRemoveFiles=function(){function c(g,l){d.post("?module=file&action=delete",{id:g},function(k){"ok"==k.status?l.remove():console&&console.log&&console.log("File Remove Error")})}var e=this,f;e.$wrapper.find(".c-files-wrapper").on("click",".js-remove-file",function(g){g.preventDefault();var l=d(this).closest(".c-file");g=l.find(".c-name").text();var k=parseInt(l.data("id"));
f&&f.abort();g={title:e.locales.remove_file_title,text:e.locales.remove_file_text.replace(/%s/,g),ok_button:e.locales.remove_file_button};0<k?f=d.post("?module=dialogConfirm",g,function(h){new CRMDialog({html:h,onConfirm:function(){c(k,l)}})}).always(function(){f=!1}):console&&console.log&&console.log("File ID is empty")})};CRMDeal.prototype.initEditableName=function(){var c=this.$wrapper.find(".js-editable").first();if(!(0>=c.length)){var e=d.crm.app_url+"?module=deal&action=rename",f=this.deal_id,
g=null;new CrmEditable({$wrapper:c,onSave:function(l){var k=l.$field.val();if(k.length&&l.text!==k){g&&g.abort();k={id:f,name:k};l.$field.attr("disabled",!0);var h=d('<i class="icon16 loading"></i>').css("margin","0 0 0 4px").insertAfter(l.$field);g=d.post(e,k,function(m){l.$field.attr("disabled",!1);h.remove();l.toggle("hide");m&&m.data&&m.data.deal&&(l.text=m.data.deal.name,l.$wrapper.text(m.data.deal.name),d.crm.title.set(m.data.deal.name))})}else k.length||l.$field.val(l.text),l.toggle("hide")}})}};
CRMDeal.prototype.initChangeDate=function(){function c(n){n?(g.addClass("is-shown"),h.focus()):(g.removeClass("is-shown"),h.datepicker("hide"))}function e(n){h.val()||(n="");d.post("?module=deal&action=changeExpectedDate",{id:f.deal_id,expected_date:n?n:""},function(p){"ok"==p.status&&p.data&&p.data.deal&&((p=p.data.deal.expected_date)?(l.hide(),k.show().find(".js-name").text(p)):(k.hide().find(".js-name").text(""),l.show()),c())},"json")}var f=this,g=f.$wrapper.find(".js-date-toggle");if(!g.length)return!1;
var l=g.find(".js-link"),k=g.find(".js-span"),h=g.find(".js-datepicker"),m=g.find(".js-field");g.on("click",".js-set-date",function(n){n.preventDefault();c(!0)});h.on("keydown keypress keyup",function(n){27===n.keyCode&&c()});g.on("click",".js-close-edit-date",function(){c()});(function(){h.datepicker({altField:m,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var n=h.val(),p=m.val(),q=d.datepicker._defaults.dateFormat,r=!1;try{d.datepicker.parseDate(q,n),r=!0}catch(u){}if(r)e(p);
else return!1}});h.val()||h.datepicker("setDate","+0d")})()};CRMDeal.prototype.initChangePrice=function(){function c(p){p?l.addClass("is-shown"):l.removeClass("is-shown")}function e(p,q){d.post("?module=deal&action=changeAmount",{id:g.deal_id,amount:p?p:"",currency_id:q?q:""},function(r){"ok"==r.status&&r.data&&r.data.deal&&((r=r.data.deal.amount)?(k.hide(),h.show().text(r)):(h.hide().text(""),k.show()),c())},"json")}function f(){var p=m.val(),q=n.val(),r=!1;p&&(r=p.replace(",","."));0<=r?e(p,q):
m.addClass("error")}var g=this,l=g.$wrapper.find(".js-price-toggle");if(!l.length)return!1;var k=l.find(".js-link"),h=l.find(".js-span"),m=l.find(".js-price-field"),n=l.find(".js-currency-field");l.on("click",".js-set-price",function(p){p.preventDefault();c(!0)});l.on("click",".js-save-price",function(p){p.preventDefault();f()});l.on("click",".js-cancel",function(p){p.preventDefault();c()});m.on("focus",function(){m.hasClass("error")&&m.removeClass("error")});m.on("keydown",function(p){13===p.keyCode&&
...
d(h).removeClass("error")):(p.text(p.data("empty-text")),d(h).siblings(".js-datepicker-field").datepicker("hide"));c(h,!1)}}else d(h).addClass("error")},"json")}var g=this.$wrapper.find(".js-field-toggle"),l=d(".c-deal-options-section");if(!g.length)return!1;var k=g.find(".js-field-value");g.on("click",".js-output-value",function(h){h.preventDefault();c(this,!0)});g.on("click",".js-save-field",function(h){h.preventDefault();e(this)});g.on("click",".js-cancel",function(h){h.preventDefault();d(document).trigger("mousedown")});
g.on("click",".js-field-value-checkbox",function(){e(this)});g.on("change",".js-field-value-select",function(h){h.preventDefault();e(this)});g.on("click",".js-field-value-radio-block input",function(){e(d(this).closest(".js-field-value-radio-block"))});g.on("click",".js-field-value-radio-block .js-clear-link",function(h){h.preventDefault();h=d(this).closest(".js-field-value-radio-block");h.find(":checked").attr("checked",!1);e(h)});k.on("focus",function(){k.hasClass("error")&&k.removeClass("error")});
d(document).on("mousedown",function(h){0!==g.has(h.target).length||g.is(h.target)||g.each(function(m,n){var p=d(n);m=p.find("textarea");p.hasClass("js-textarea")?m.slideUp(function(){p.removeClass("is-shown").removeAttr("style").prev().show()}):p.removeClass("is-shown")})});k.on("keydown",function(h){13===h.keyCode&&(h.preventDefault(),d(this).hasClass("js-datepicker-field")?e(d(this).siblings(".js-field-value")):e(this))});(function(){var h=l.find(".js-datepicker-field"),m=h.siblings(".js-field-value");
h.datepicker({altField:m,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var n=d(this).siblings(".js-field-value");e(n)}})})()};CRMDeal.prototype.initWYSIWYG=function(){var c=this.$wrapper.find(".js-wysiwyg");if(!c.length)return!1;d.crm.initWYSIWYG(c,{keydownCallback:function(e){}})};CRMDeal.prototype.initChangeDescription=function(){function c(k){k?g.addClass("is-shown"):g.removeClass("is-shown")}function e(k){d.post("?module=deal&action=changeDescription",k,function(h){if("ok"==
...
function(k){k.preventDefault();c(!1)});l.on("focus",function(){l.hasClass("error")&&l.removeClass("error")})};CRMDeal.prototype.initChangeUser=function(){function c(h){if(!h.length)return!1;var m=h.closest(".c-contact");h.autocomplete({appendTo:m,source:"?module=autocomplete&type=user&funnel_id="+l.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(n,p){e(p.item.id,m);h.val("");return!1}}).data("ui-autocomplete")._renderItem=function(n,p){var q=d("<li />");q.addClass("ui-menu-item-html").append("<div>"+
p.value+"</div>").appendTo(n);p.rights||(q.addClass("is-locked"),q.on("click",function(r){r.preventDefault();r.stopPropagation()}));return q};h.on("focus",function(){h.data("uiAutocomplete").search(h.val())})}function e(h,m){k?g(m):f(h,function(){k=!0;d.post("?module=deal&action=changeUser",{id:l.deal_id,user_contact_id:h},function(n){if("ok"!==n.status)n.errors?console.error(n.errors):console.error(n),d.crm.alert.show({title:"Error",button:"Error"});else if(n.data=n.data||{},n.data.deal_access_denied)window.location.href=
d.crm.app_url+"deal/";else if(n.data.html){n=d(n.data.html);var p=l.$aside.find('.c-users-section .c-contact[data-id="'+h+'"]').not(m);p.length&&p.remove();m.replaceWith(n);c(n.find(".js-owner-autocomplete"))}},"json").always(function(){k=!1})})}function f(h,m){d.post("?module=deal&action=changeUserConfirm",{id:l.deal_id,user_contact_id:h},"json").done(function(n){n.data&&n.data.need_confirm?new CRMDialog({html:n.data.html||"",onOpen:function(p,q){p.find(".js-confirm-button").on("click",function(){m()})}}):
m()})}function g(h,m){m?h.addClass("is-edit"):h.removeClass("is-edit")}var l=this,k=!1;l.$aside.on("click",".js-show-combobox",function(h){h.preventDefault();h=d(this).closest(".c-contact");g(h,!0)});l.$aside.on("click",".js-hide-combobox",function(h){h.preventDefault();h=d(this).closest(".c-contact");g(h)});l.$aside.find(".js-owner-autocomplete").each(function(){c(d(this))});(function(){function h(q){n||f(q,function(){n=!0;d.post("?module=deal&action=changeUser",{id:l.deal_id,user_contact_id:q},
function(r){if("ok"===r.status)if(r.data.deal_access_denied)window.location.href=d.crm.app_url+"deal/";else{r=d(r.data.html);var u=l.$aside.find('.c-users-section .c-contact[data-id="'+l.user_id+'"]');u.length&&u.remove();l.$aside.find('.c-contact[data-id="'+r.data("id")+'"]').remove();p.after(r).css("display","none");l.$aside.find(".js-add-user-wrapper").show();c(r.find(".js-owner-autocomplete"))}},"json").always(function(){n=!1})})}function m(q){q?p.addClass("is-extended"):p.removeClass("is-extended")}
var n=!1,p=l.$aside.find(".js-empty-user-wrapper");p.on("click",".js-set-user-me",function(q){q.preventDefault();h(l.user_id)});p.on("click",".js-set-extended",function(q){q.preventDefault();m(!0)});p.on("click",".js-unset-extended",function(q){q.preventDefault();m(!1)});(function(){p.find(".js-empty-user-autocomplete").each(function(){var q=d(this);q.autocomplete({appendTo:p,source:"?module=autocomplete&type=user&funnel_id="+l.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(r,
u){h(u.item.id);q.val("");return!1}}).data("ui-autocomplete")._renderItem=function(r,u){var v=d("<li />");v.addClass("ui-menu-item-html").append("<div>"+u.value+"</div>").appendTo(r);u.rights||(v.addClass("is-locked"),v.on("click",function(t){t.preventDefault();t.stopPropagation()}));return v};q.on("focus",function(){q.data("uiAutocomplete").search(q.val())})})})()})()};CRMDeal.prototype.initChangeClient=function(){function c(k,h,m){g||(g=!0,d.post("?module=deal&action=changeClient",{deal_id:e.deal_id,
client_type:m,contact_id:h},function(n){const p=new CRMDialog({html:n,options:{onChange:function(q){1===p.$block.find(".js-view-toggle > .is-active").data("id")?k.replaceWith(q):(k.replaceWith(q.html),(parseInt(e.deal.contact_id)||0)===h&&q.contact.id!==h&&(e.deal.contact_id=q.contact.id));k.find(".js-add-company-contact").show();d(document).trigger("refresh")}}})}).always(function(){g=!1}))}var e=this,f=e.$wrapper.find(".js-contacts-section"),g=!1;f.on("click",".js-edit-company-owner",function(k){k.preventDefault();
k=d(this).closest(".c-contact");var h=k.data("type"),m=k.data("id");c(k,m,h)});var l=f.find(".js-empty-contact-wrapper");if(l.length)l.on("click",".js-set-company-owner",function(k){k.preventDefault();c(l,"","contact_owner")})};CRMDeal.prototype.initDealDelete=function(){function c(){f||(f=!0,d.post(d.crm.app_url+"?module=deal&action=delete",{id:e.deal_id},function(g){"ok"===g.status&&d.crm.content.load(d.crm.app_url+"deal/")},"json").always(function(){f=!1}))}var e=this,f=!1;e.$wrapper.on("click",
".js-deal-delete",function(g){g.preventDefault();d.crm.confirm.show({title:e.locales.delete_deal_title,text:e.locales.delete_deal_text,button:e.locales.delete_deal_button,onConfirm:c})})};CRMDeal.prototype.initCall=function(){var c=this,e=!1;c.$wrapper.on("click",".js-show-call-dialog",function(f){f.preventDefault();var g=d(this);f=g.data("id");g=g.data("phone");!e&&f&&g&&(e=!0,d.post("?module=call&action=initContactDialog",{deal_id:c.deal_id,contact_id:f,phone:g},function(l){new CRMDialog({remain_after_load:!0,
html:l})}).always(function(){e=!1}))})};CRMDeal.prototype.initOrderSection=function(){var c=this.$wrapper.find(".c-order-section"),e=c.find(".c-order-details"),f=c.find(".c-products-wrapper");e.on("click",".js-details-toggle",function(g){g.preventDefault();g=d(this).find(".icon16");e.hasClass("is-extended")?(g.removeClass("darr").addClass("rarr"),e.removeClass("is-extended")):(g.removeClass("rarr").addClass("darr"),e.addClass("is-extended"));d(document).trigger("refresh")});f.on("click",".js-products-toggle",
...
g=g.data("email");!e&&f&&(e=!0,d.post("?module=message&action=writeDealDialog",{deal_id:c.deal_id,contact_id:f,email:g},function(l){new CRMDialog({html:l})}).always(function(){e=!1}))})};CRMDeal.prototype.initSendSMS=function(){var c=this,e=!1;c.$wrapper.on("click",".js-show-send-sms-dialog",function(f){f.preventDefault();var g=d(this);f=g.data("id");g=g.data("phone");!e&&f&&(e=!0,d.get("?module=message&action=writeSMSDealDialog",{deal_id:c.deal_id,contact_id:f,phone:g},function(l){new CRMDialog({html:l})}).always(function(){e=
!1}))})};CRMDeal.prototype.addExternalContact=function(c){d.get(d.crm.app_url+"?module=deal&action=addParticipant",{id:this.deal_id},function(e){new CRMDialog({html:e,options:{onAdd:function(f){c.closest(".c-add-contact").before(f);d(document).trigger("refresh")}}})})};CRMDeal.prototype.removeOwner=function(c){function e(k,h){k={owner_id:k,deal_id:h};var m=d(".js-empty-user-wrapper");f.remove_is_locked=!0;d.post("?module=deal&action=ownerDelete",k,function(n){"ok"==n.status&&(c.remove(),m.fadeIn())},
"json").always(function(){f.remove_is_locked=!1})}var f=this,g=c.data("id"),l=d.trim(c.find(".c-name").html());d.crm.confirm.show({title:f.locales.remove_owner_title,text:f.locales.remove_owner_text.replace(/%s/,l),button:f.locales.remove_owner_button,onConfirm:function(){e(g,f.deal_id)}})};CRMDeal.prototype.removeContact=function(c){function e(k,h,m){k={contact_id:k,deal_id:h,role_id:m};f.remove_is_locked=!0;d.post("?module=deal&action=contactDelete",k,function(n){"ok"==n.status&&c.remove()},"json").always(function(){f.remove_is_locked=
!1})}var f=this,g=c.data("id"),l=d.trim(c.find(".c-name").html());d.crm.confirm.show({title:f.locales.remove_contact_title,text:f.locales.remove_contact_text.replace(/%s/,l),button:f.locales.remove_contact_button,onConfirm:function(){e(g,f.deal_id,c.data("role-id"))}})};CRMDeal.prototype.initAssignTags=function(){var c=this.$wrapper.find(".js-assign-tags"),e=d.crm.app_url+"?module=dealOperation&action=assignTags&is_assign=1",f=parseInt(this.deal_id)||0;c.click(function(g){g.preventDefault();d.get(e,
{deal_ids:[f]},function(l){new CRMDialog({html:l})})})};CRMDeal.prototype.initOrderEditShippingDetailLink=function(){var c=this;c.$wrapper.find(".js-order-edit-shipping-details-link").click(function(){var e=d(this).parent().find(".js-order-edit-shipping-details-loading");e.show();c.loadEditOrderShippingDetailsDialog(c.order_id,{onLoad:function(){e.hide()}})})};CRMDeal.prototype.initCreateOrderLink=function(){var c=this;c.$wrapper.on("click",".js-create-order-link",function(e){e.preventDefault();if(c.shop_in_welcome_stage)d.crm.alert.show({title:c.locales.shop_alert_title||
...
{onLoad:function(){f.removeClass("is-loading")}})}})};CRMDeal.prototype.loadEditOrderDialog=function(c,e){var f=this.deal||{},g=d(this.templates.create_order_dialog_html),l=e.onLoad||function(){};g.hide();new CRMDialog({html:g,onOpen:function(){var k=this,h=d.crm.backend_url+"shop/?module=order&action=embededit",m=g.find(".crm-dialog-content");0<f.contact_id&&(h+="&customer_id="+f.contact_id);0<c&&(h+="&id="+c);m.html('<iframe src="'+h+'" class="c-content-iframe">');var n=m.find("iframe");n.one("load",
function(){l();k.show();k.resize();var p=n.get(0);d(p.contentWindow.document).find("#order-edit-form").append('<input type="hidden" name="crm_deal[id]" value="'+f.id+'">');p.contentWindow.$.order_edit.container.on("order_edit_save_success",function(){k.close();d.crm.content.reload()})})}})};CRMDeal.prototype.loadEditOrderShippingDetailsDialog=function(c,e){if(0>=c)console.error("Invalid input parameter");else{var f=this.$wrapper.find(".js-deal-edit-order-shipping-details-dialog").clone(),g=e.onLoad||
function(){};f.hide();new CRMDialog({html:f,onOpen:function(){var l=this,k=d.crm.backend_url+"shop/?module=workflow&action=prepare",h=f.find(".crm-dialog-content");d.post(k,{action_id:"editshippingdetails",id:c},function(m){h.html(m);h.find(".js-form-footer-actions").hide();l.show();l.resize();m=h.find("#wf-ship-form").height();f.find(".crm-dialog-block").height(m+150);var n=f.find(".js-submit-dialog-loading"),p=h.find(".js-form-footer-actions .js-submit-button");f.find(".js-submit-dialog-button").on("click",
function(q){q.preventDefault();if(p.is(":disabled"))return!1;h.bind("formSend",function(){n.hide();l.close();d.crm.content.reload()});n.show();p.trigger("click")});g&&g()})}})}};return CRMDeal}(jQuery),CRMDealChangeWorkflowDialog=function(d){CRMDealChangeWorkflowDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form").first();this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMDealChangeWorkflowDialog.prototype.initClass=function(){var a=this;a.$wrapper.find(".js-form-footer-actions").hide();
...
this.initChangeFunnel();this.initWYSIWYG();this.initFieldsBlock();this.initSave();this.initCombobox()};CRMDealEdit.prototype.initEstimatedDate=function(){function a(){var f=d.datepicker._defaults.dateFormat,g=!1;try{d.datepicker.parseDate(f,c.val()),g=!0}catch(l){}g?(c.data("last-correct-value",c.val()),e.data("last-correct-value",e.val())):(c.val(c.data("last-correct-value")||""),e.val(e.data("last-correct-value")||""))}var b=this.$wrapper.find(".c-estimated-close-date-field").find(".js-datepicker-wrapper"),
c=b.find(".js-datepicker"),e=b.find('[name="deal[expected_date]"]');c.datepicker({altField:e,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:a});c.on("blur",a);c.on("keydown keypress keyup",function(f){13===f.which&&f.preventDefault()});c.on("click",".js-icon",function(){c.focus()})};CRMDealEdit.prototype.initSave=function(){function a(){for(var n={data:[],errors:[]},p=l.serializeArray(),q=0;q<p.length-1;q++)for(var r=q+1;r<p.length;r++)p[q].name==p[r].name&&(""==p[q].value?p.splice(q,
...
value:g.locales.empty_name}),n.errors.push({name:"contact[firstname]",value:g.locales.empty_name}))}var g=this,l=g.$form,k=g.$form.find(".js-errors-place"),h=g.$wrapper.find(".js-submit-button"),m=!1;h.on("click",function(){l.trigger("submit")});l.on("submit",function(n){n.preventDefault();n=a();n.errors.length?b(n.errors):c(n.data)})};CRMDealEdit.prototype.initSuggestName=function(){var a=this,b=a.$form,c=a.$deal_name_input;if(!c.data("edited")){c.one("mark-edited.crm-deal-suggestion",function(){c.data("edited",
1);c.off(".crm-deal-suggestion");b.off(".crm-deal-suggestion",".js-crm-deal-name-suggester-input")});c.on("keyup.crm-deal-suggestion",function(){var l=d(this);0<d.trim(l.val()).length&&l.trigger("mark-edited")});var e=null,f=null,g=function(){e&&(e.abort(),e=null);c.data("edited")||(e=d.post(d.crm.app_url+"?module=deal&action=suggestName",a.suggester_values,function(l){"ok"!==l.status||c.data("edited")||c.val(d.trim(l.data&&l.data.name)||"")}))};b.on("keyup.crm-deal-suggestion change.crm-deal-suggestion",
".js-crm-deal-name-suggester-input",function(l){var k=d(this);f&&clearTimeout(f);f=setTimeout(function(){if(k.hasClass("crm-find-contact-input")){if("keyup"===l.type)return;k=b.find('[name="deal[id]"]')}var h=k.attr("name")||"",m=d.trim(k.val());if(h){a.suggester_values[h]=d.trim(a.suggester_values[h]);if(a.suggester_values[h]===m)return;a.suggester_values[h]=m}g()},250)})}};CRMDealEdit.prototype.initChangeCompanyContact=function(){var a=this,b=a.$wrapper.find(".js-contact-block"),c=b.find(".js-view-toggle"),
...
n.status?(e.dialog.options.onChange(n.data.html),e.dialog.close()):n.errors&&c(n.errors)},"json").always(function(){l=!1})}function c(m){m=m?m:[];d.each(m,function(n,p){n=p.name;p=p.value;"contact[name]"===n&&(n="contact[firstname]");var q=g.find('[name="'+n+'"]'),r=d("<span />").addClass("errormsg").text(p);q.length?q.hasClass("error")||(q.parent().append(r),q.addClass("error").one("focus click",function(){q.removeClass("error");r.remove()})):(f.append(r),g.one("submit",function(){r.remove()}))})}
var e=this,f=e.$wrapper.find(".js-errors-place"),g=e.$wrapper.find("#c-contact-edit-form").closest("form"),l=!1,k=g.find(".js-phone-list"),h=g.find(".js-email-list");e.$wrapper.on("click",".js-save-changed-data",function(m){m.preventDefault();g.trigger("submit")});g.on("submit",function(m){m.preventDefault();l||(l=!0,m=a(),m.errors.length?(c(m.errors),l=!1):b(m.data))})};CRMDealChangeClient.prototype.initSwitchContact=function(){function a(l){l=l?l:[];d.each(l,function(k,h){k=h.name;h=h.value;"contact[name]"===
k&&(k="contact[firstname]");var m=f.find('[name="'+k+'"]'),n=d("<span />").addClass("errormsg").text(h);m.length?m.hasClass("error")||(m.parent().append(n),m.addClass("error").one("focus click",function(){m.removeClass("error");n.remove()})):(e.append(n),c.$wrapper.one("click",".js-switch-contact",function(){n.remove()}))})}function b(l){g||(g=!0,l.push({name:"deal_id",value:c.deal_id}),d.post("?module=deal&action=personUpdate",l,function(k){"ok"===k.status?(c.dialog.options.onChange(k.data),c.dialog.close()):
k.errors&&a(k.errors)}).always(function(){g=!1}))}var c=this,e=c.$wrapper.find(".js-errors-place"),f=c.$wrapper.find("#c-contact-add-form").closest("form"),g=!1;c.$wrapper.on("click",".js-switch-contact",function(l){l.preventDefault();l=f.serializeArray();var k=[];k.length?a(k):b(l)})};return CRMDealChangeClient}(jQuery);var CRMDealsFunnel=function(d){CRMDealsFunnel=function(a){this.$wrapper=a.$wrapper;this.$header=this.$wrapper.find("#js-funnel-header");this.$actionsHeader=this.$wrapper.find("#js-actions-header");this.$tableContent=this.$wrapper.find(".js-table-content");this.funnel_id=a.funnel_id;this.locales=a.locales;this.selected_deals=[];this.initClass()};CRMDealsFunnel.prototype.initClass=function(){this.initFixedHeader();this.initDealsMove();this.initMassiveActionsHeader();this.initMassActions()};CRMDealsFunnel.prototype.initFixedHeader=
function(){function a(){if(d.contains(document,e[0])){var m=c.scrollTop();l.top<m?g||(g=!0,f=d("<div />"),f.height(h).insertAfter(e),e.width(k).addClass("is-fixed-to-top")):b()}else c.off("scroll",a)}function b(){f&&f.length&&f.remove();f=!1;e.removeAttr("style").removeClass("is-fixed-to-top");k=e.width();h=e.height();g=!1}var c=d(window),e=this.$header,f=!1,g=!1,l=e.offset(),k=e.width(),h=e.height();c.on("scroll",a);c.on("resize",function(){b();c.trigger("scroll")})};CRMDealsFunnel.prototype.initDealsMove=
function(){function a(g,l,k,h){function m(){d.crm.content.reload()}if(!b){b=!0;var n=k.closest(".js-drop-area");e.draggable("disable");k.addClass("is-loading").removeAttr("style").prependTo(h);d.post("?module=deal&action=move",{deal_id:g,stage_id:l},function(p){"ok"===p.status&&(p.data.dialog_html&&p.data.dialog_html.html?new CRMDialog({html:p.data.dialog_html.html,options:{onShopSubmit:m},onCancel:function(){k.removeClass("is-loading").prependTo(n)},onConfirm:function(){d.post("?module=deal&action=move",
{deal_id:g,stage_id:l,force_execute:1},m)}}):m())},"json").always(function(){e.draggable("enable");b=!1})}}var b=!1,c=!1,e=this.$wrapper.find(".c-deal-wrapper"),f=this.$wrapper.find(".js-drop-area");e.draggable({handle:".js-drag-toggle",revert:!0,start:function(){var g=d(this),l=g.closest(".js-drop-area");g.data("stage-index",l.index()).data("stage-id",l.data("id")).draggable("option","revert",!0);c=l.addClass("is-wrapper")}});f.droppable({tolerance:"pointer",drop:function(g,l){g=d(this);l=d(l.draggable);
var k=g.data("id"),h=l.data("stage-id"),m=l.data("id");h!==k&&(l.draggable("option","revert",!1),a(m,k,l,g));c.length&&(c.removeClass("is-wrapper"),c=!1)}})};CRMDealsFunnel.prototype.initMassiveActionsHeader=function(){function a(){if(d.contains(document,f[0]))if(c.selected_deals.length){f.hasClass("is-hidden")&&f.removeClass("is-hidden");var n=e.scrollTop();k.top+m>n+e.height()?l||(l=!0,g=d("<div />"),g.height(m).insertAfter(f),f.width(h).addClass("is-fixed-to-bottom")):b()}else b(),f.hasClass("is-hidden")||
f.addClass("is-hidden");else e.off("scroll",a)}function b(){g&&g.length&&g.remove();g=!1;f.removeAttr("style").removeClass("is-fixed-to-bottom");h=f.width();m=f.height();l=!1}var c=this,e=d(window),f=c.$actionsHeader,g=!1,l=!1,k=f.offset(),h=f.width(),m=f.height();e.on("scroll",a);e.on("resize",function(){b();e.trigger("scroll")})};CRMDealsFunnel.prototype.initMassActions=function(){function a(k){k.find(".js-check-deal").is(":checked")?(k.addClass("is-active"),l.push(k[0])):(k.removeClass("is-active"),
k=l.indexOf(k[0]),l.splice(k,1));b();d(window).trigger("scroll")}function b(){function k(){var p=c("open"),q=f.find(".js-deals-close").closest(".c-action"),r=q.find(".js-open-count");p.length?(r.text(p.length),q.show()):q.hide()}function h(){var p=f.find(".js-deals-merge").closest(".c-action");1<l.length?p.show():p.hide()}function m(){var p=!1;d(l).each(function(){if(d(this).data("can-delete"))return p=!0,!1});var q=f.find(".js-deals-delete").closest(".c-action");p?q.show():q.hide()}var n=l.length;
0<l.length&&(f.find(".js-count").text(n),k(),h(),m())}function c(k){var h=[];d.each(l,function(m,n){m=d(n);n=m.data("id");(!k||m.data(k))&&n&&h.push(n)});return h}var e=this,f=e.$actionsHeader,g=f.find(".js-checkbox-all"),l=e.selected_deals;e.$wrapper.on("click",".js-deal-wrapper",function(k){k=d(k.target);var h=!(!k.is("a")&&!k.closest("a").length);k=k.is(":checkbox");if(!h){h=d(this);var m=h.find(".js-check-deal");k||m.attr("checked",!m.is(":checked"));a(h)}});e.$tableContent.find(".js-state-column").shiftSelectable({selector:".js-deal-wrapper",
onSelect:function(k,h){var m=d(h.target);m=!(!m.is("a")&&!m.closest("a").length);var n=h.extra.is_first;h=h.extra.is_last;m||n||h||(k.find(".js-check-deal").attr("checked",!0),a(k))}});g.on("change",function(){var k=d(this).is(":checked");e.$wrapper.find(".js-deal-wrapper").each(function(){var h=d(this),m=h.find(".js-check-deal");m.is(":checked")!==k&&(m.attr("checked",k),a(h))})});f.on("click",".js-deals-merge",function(k){k.preventDefault();k=c();k=d.crm.app_url+"deal/merge/?ids="+k.join(",");d.crm.content.load(k)});
(function(){var k=!1;f.on("click",".js-deals-delete",function(h){h.preventDefault();d.crm.confirm.show({title:e.locales.delete_confirm_title.replace("%s",l.length),text:e.locales.delete_confirm_text,button:e.locales.delete_confirm_button,onConfirm:function(m){function n(){var u=[],v=c();d.each(v,function(t,w){u.push({name:"id[]",value:w})});return u}function p(){var u=l.map(function(v){return v});d.each(u,function(v,t){v=d(t);v.find(".js-check-deal").attr("checked",!1).trigger("change");v.remove()})}
if(!k){k=!0;var q=d.crm.app_url+"?module=deal&action=delete",r=n();d.post(q,r,function(u){"ok"===u.status&&(p(),m.close(),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){k=!1})}return!1}})})})();(function(){var k=!1;f.on("click",".js-deals-change-responsible",function(h){h.preventDefault();k||(k=!0,h={ids:c().join(",")},d.post("?module=deal&action=changeResponsible",h,function(m){new CRMDialog({html:m})}).always(function(){k=!1}))})})();(function(){var k=!1;f.on("click",".js-deals-close",
function(h){h.preventDefault();k||(k=!0,h={ids:c("open").join(",")},d.post("?module=deal&action=massClose",h,function(m){new CRMDialog({html:m})}).always(function(){k=!1}))})})();(function(){var k=!1;f.on("click",".js-deals-change-funnel",function(h){h.preventDefault();k||(k=!0,h={deal_ids:c().join(",")},d.post("?module=deal&action=changeFunnel",h,function(m){new CRMDialog({html:m})}).always(function(){k=!1}))})})();(function(){var k=!1;f.on("click",".js-deals-export",function(h){h.preventDefault();
k||(k=!0,h=c(),d.post(d.crm.app_url+"?module=deal&action=export",{ids:h},function(m){new CRMDialog({html:m})}).always(function(){k=!1}))})})();(function(){var k=!1;f.on("click",".js-deals-set-tags",function(h){h.preventDefault();if(!k){k=!0;h=c();var m=d.crm.app_url+"?module=dealOperation&action=assignTags",n={deal_ids:h};1===h.length&&(n.is_assign=1);d.post(m,n,function(p){new CRMDialog({html:p})}).always(function(){k=!1})}})})()};return CRMDealsFunnel}(jQuery),CRMDealsList=function(d){CRMDealsList=
...
function(){this.initLazy();this.initElasticHeader();this.initMassActions()};CRMDealsList.prototype.initLazy=function(){function a(){if(d.contains(document,g[0])){var k=d(window).scrollTop(),h=e.height(),m=g.offset().top;k+h>=m&&(l||b())}else e.off("scroll",a)}function b(){var k={offset:g.data("offset")};c.stage_id&&(k.stage=c.stage_id);c.contact_id&&(k.user=c.contact_id);l=!0;d.post("?module=deal&action=list",k,function(h){var m=d(h).find(".js-lazyload");m.length?(c.limit+=k.offset,m.insertAfter(g),
g.remove(),g=m):g.remove();d(h).find(".c-deal-wrapper").insertAfter(f.find("tr:last"))}).always(function(){l=!1})}var c=this,e=d(window),f=c.$tableBody,g=c.$wrapper.find(".js-lazyload"),l=!1;g.length&&(e.on("scroll",a),g.offset().top<e.height()&&e.trigger("scroll"))};CRMDealsList.prototype.initElasticHeader=function(){function a(){d.contains(document,e[0])?b.scrollTop()>f.top?e.css({left:f.left}).width(c.outerWidth()).addClass("is-fixed"):e.removeAttr("style").removeClass("is-fixed"):b.off("scroll",
a)}var b=d(window),c=this.$tableWrapper,e=this.$tableHeaderW,f=c.offset();b.on("scroll",a)};CRMDealsList.prototype.initMassActions=function(){function a(n){n.find(".js-check-deal").prop("checked",!0).trigger("change",[!0])}function b(n){n.find(".js-check-deal").prop("checked",!1).trigger("change",[!1])}function c(n){n.find(".js-check-deal").is(":checked")?(n.addClass("is-active"),l.push(n[0])):(n.removeClass("is-active"),n=l.indexOf(n[0]),l.splice(n,1));e()}function e(){function n(){var u=f("open"),
v=h.find(".js-deals-close").closest(".c-operation-li"),t=v.find(".js-open-count");u.length?(t.text(u.length),v.show()):v.hide()}function p(){var u=h.find(".js-deals-merge").closest(".c-operation-li");1<l.length?u.show():u.hide()}function q(){var u=!1;d(l).each(function(){if(d(this).data("can-delete"))return u=!0,!1});var v=h.find(".js-deals-delete").closest(".c-operation-li");u?v.show():v.hide()}var r=l.length;0<r?(k.hide(),h.show().find(".js-count").text(r),n(),p(),q(),r<g.limit?m.prop("indeterminate",
!0):m.prop("indeterminate",!1).prop("checked",!0)):(k.show(),h.hide(),m.prop("indeterminate",!1).prop("checked",!1))}function f(n){var p=[];d.each(l,function(q,r){q=d(r);r=q.data("id");(!n||q.data(n))&&r&&p.push(r)});return p}var g=this,l=[],k=g.$tableHeader,h=g.$tableActions,m=g.$tableHeaderW.find(".js-checkbox-all");g.$tableBody.on("click",".js-deal-wrapper",function(n){n=d(n.target);var p=d(this),q=p.find(".js-check-deal");q.closest("td");var r=!(!n.is("a")&&!n.closest("a").length),u=!(!n.is(".c-column-checkbox")&&
...
x=f();d.each(x,function(y,z){w.push({name:"id[]",value:z})});return w}function u(){var w=l.map(function(x){return x});d.each(w,function(x,y){x=d(y);x.find(".js-check-deal").attr("checked",!1).trigger("change");x.remove()})}if(!n){n=!0;var v=d.crm.app_url+"?module=deal&action=delete",t=r();d.post(v,t,function(w){"ok"===w.status&&(u(),q.close(),k.show(),h.hide(),m.prop("indeterminate",!1).prop("checked",!1),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){n=!1})}return!1}})})})();
...
function(){this.initSubmit();this.initSelectDeal()};CRMDealsMergePage.prototype.initSubmit=function(){function a(){function e(g){var l="";d.each(g,function(k,h){if("master_id"===h.name)return l=h.value,!1});return l}if(!c){c=!0;var f=b.serializeArray();d.post("?module=deal&action=mergeRun",f,function(g){g=d.crm.app_url+"deal/"+e(f)+"/";let l=(new URLSearchParams(document.location.search)).get("iframe");window.parent&&l?window.parent.location=g:d.crm.content.load(g)},"json").always(function(){c=!1})}}
...
CRMDealsChangeResponsibleDialog.prototype.initChangeResponsible=function(){var a=this,b=a.$wrapper.find(".js-users-list"),c=b.find(".js-visible-link"),e=a.$wrapper.find(".js-user-field"),f=b.find(".menu-v");f.on("click","a",function(){var g=d(this),l=g.closest(".js-user");c.find(".js-text").html(g.html());f.find(".selected").removeClass("selected");l.addClass("selected");f.hide();setTimeout(function(){f.removeAttr("style")},200);g=l.data("id");e.val(g).trigger("change");a.is_responsive_set||(a.$submitButton.attr("disabled",
...
function(d){CRMDealsChangeFunnelDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.funnels=a.funnels;this.stage_template_html=a.stage_template_html;this.initClass()};CRMDealsChangeFunnelDialog.prototype.initClass=function(){this.initChangeFunnel();this.initChangeStage();this.initSubmit();d.crm.renderSVG(this.$wrapper)};CRMDealsChangeFunnelDialog.prototype.initChangeFunnel=function(){function a(l){(l=b.funnels[l]||!1)&&c.trigger("changeFunnel",
l)}var b=this,c=b.$wrapper.find(".js-funnels-list"),e=c.find(".js-visible-link"),f=c.find(".js-field"),g=c.find(".menu-v");g.on("click","a",function(){var l=d(this);e.find(".js-text").html(l.html());g.find(".selected").removeClass("selected");l.closest("li").addClass("selected");g.hide();setTimeout(function(){g.removeAttr("style")},200);l=l.data("id");f.val(l).trigger("change");a(l)})};CRMDealsChangeFunnelDialog.prototype.initChangeStage=function(){function a(k){l.html("");d.each(k,function(h,m){h=
b.stage_template_html;var n=d("<div />").text(m.name).html();h=h.replace("%id%",m.id).replace("%color%",m.color).replace("%name%",n);m=d(h);l.append(m)});d.crm.renderSVG(e);l.find("li:first-child a").trigger("click")}var b=this,c=b.$wrapper.find(".js-funnels-list"),e=b.$wrapper.find(".js-funnel-stages-list"),f=e.find(".js-visible-link"),g=e.find(".js-field"),l=e.find(".menu-v");l.on("click","a",function(){var k=d(this);f.find(".js-text").html(k.html());l.find(".selected").removeClass("selected");
k.closest("li").addClass("selected");l.hide();setTimeout(function(){l.removeAttr("style")},200);k=k.data("id");g.val(k)});c.on("changeFunnel",function(k,h){a(h.stages)})};CRMDealsChangeFunnelDialog.prototype.initSubmit=function(){var a=this,b=a.$form,c=!1;b.on("submit",function(e){e.preventDefault();c||(c=!0,e=b.serializeArray(),d.post("?module=deal&action=changeFunnelRun",e,function(f){"ok"===f.status&&(a.dialog.close(),d.crm.content.reload())},"json").always(function(){c=!1}))})};return CRMDealsChangeFunnelDialog}(jQuery),
...
!0,l=e.$table.find(".js-tax-dropdown.is-active");f=d(f.target).closest(".js-tax-dropdown");f.length&&(g=f.hasClass("is-active"));l.removeClass("is-active");g||"NONE"===e.tax_type||f.addClass("is-active")}else d(document).off("click",c)}var e=this;e.$table.on("focus",".js-name-field",function(){var f=d(this).closest("tr"),g=e.$tableBody.find("tr").length;f.index()+1>=g&&e.addTableRow(g+1)});e.$table.on("keypress",".js-name-field",function(f){13===f.keyCode&&f.preventDefault()});e.$table.on("click",
".js-remove-row",function(f){f.preventDefault();1<e.$tableBody.find("tr").length&&e.removeTableRow(d(this).closest("tr"))});e.$table.on("change",".js-amount-field",function(){e.changeTableRow(d(this))});e.$table.on("change",".js-price-field",function(){var f=d(this).closest("tr").find(".js-amount-field");f.val()||f.val("1");e.changeTableRow(d(this))});e.$table.on("click",".js-set-product-tax",function(){var f=d(this),g=f.closest(".js-tax-dropdown"),l=g.find(".js-product-tax-percent"),k=g.find(".js-product-tax-type");
f=parseInt(f.data("tax-index"));if(f=e.active_tax_array[f])parseInt(e.tax_percent)===parseInt(f.tax_percent)&&e.tax_type===f.tax_type?g.removeClass(e.tax_set_class):g.addClass(e.tax_set_class),g=e.tax_type,"NONE"===f.tax_type&&(g="NONE"),k.val(g).trigger("change"),k=f.tax_percent+"%","NONE"===f.tax_type&&(k=e.companies[e.$companyField.val()],k=e.locales.no_tax.replace("%name",k.tax_name)),l.val(k).trigger("change"),e.refreshTable()});d(document).on("click",c)};CRMInvoiceEdit.prototype.addTableRow=
...
g=c.val(),l=0;g&&g.length&&(g=g.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(g)&&(l=parseFloat(g)));c.val(f?a(l,e):l);this.refreshTable()};CRMInvoiceEdit.prototype.refreshTable=function(){var c=this,e=function(){var k=[];c.$tableBody.find("tr").each(function(){var h=d(this),m=h.find(".js-amount-field"),n=h.find(".js-price-field"),p=h.find(".js-product-total"),q=h.find(".js-product-tax-percent");m=b(m.val());n=b(n.val());var r=0;0<m&&0<n&&(r=n*m);p.text(a(r,c.locale));(p=parseInt(q.val()))&&(0<
p||0===p)||(p=0);k.push({$tr:h,percent:p,amount:m,price:n,total:r})});return k}(),f=c.tax_type&&"INCLUDE"===c.tax_type,g=0,l=0;d.each(e,function(k,h){g+=h.total;k=h.percent/100;l+=f?k/(1+k)*h.total:h.total*k});c.$table.find(".js-subtotal").text(a(g,c.locale));c.$table.find(".js-tax").text(a(l,c.locale));c.$table.find(".js-total").text(a(g+(f?0:l),c.locale))};CRMInvoiceEdit.prototype.renderProductTaxOptions=function(c){var e=this,f=!1,g;f=c&&c.length?c.find(".js-tax-dropdown"):e.$tableBody.find(".js-tax-dropdown");
var l=f.find(".js-hidden-list").html(""),k=e.companies[e.$companyField.val()],h=[];d.each(e.active_tax_array,function(m,n){g="NONE"===n.tax_type?e.locales.no_tax.replace("%name",k.tax_name):n.tax_percent+"%";0>h.indexOf(g)&&(h.push(g),l.append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><div class="js-set-product-tax" data-tax-index="'+m+'">'+g+"</div></div></li>"))})};CRMInvoiceEdit.prototype.renderProductTaxFields=function(c){var e=this,f=e.$tableBody.find(".js-tax-dropdown");
c&&f.removeClass(e.tax_set_class);f.each(function(){var g=d(this),l=g.find(".js-product-tax-percent"),k=g.find(".js-product-tax-type");g.hasClass(e.tax_set_class)&&"NONE"!==e.tax_type||(k.val(e.tax_type).trigger("change"),k=e.tax_percent+"%","NONE"===e.tax_type&&(k="\u2014",g.removeClass(e.tax_set_class)),l.val(k).trigger("change"))})};CRMInvoiceEdit.prototype.initSubmit=function(){function c(){var h={data:[],errors:[]},m=l.serializeArray();d.each(m,function(n,p){"invoice[contact]"!==p.name&&h.data.push(p);
...
d("<span />").addClass("state-error-hint").text(p);u.insertAfter(r);r.addClass("state-error").one("focus click change",function(){r.removeClass("state-error");u.remove()})}})}function f(h,m){if(!k){k=!0;var n=d.crm.app_url+"?module=invoice&action=save";const p=spinnerView(m);p.show();d.post(n,h,function(q){if("ok"===q.status){if(q.data.id){d(document).trigger("unsavedChanges",!1);var r=d.crm.app_url+"invoice/"+q.data.id+"/";const u=getIframeIfExists();u?(window.parent.iframe_invoice_is_saved=!0,u.dispatchEvent(new CustomEvent("close",
{detail:{id:q.data.id}}))):d.crm.content.load(r)}}else p.hide(),e(q.errors)},"json").always(function(){k=!1})}}var g=this,l=g.$form,k=!1;l.on("submit",function(h){h.preventDefault();h=c();h.errors.length?e(!1,h.errors):f(h.data,l.find(".js-submit-button"))})};CRMInvoiceEdit.prototype.initDatePickers=function(){var c=this,e=c.$wrapper.find(".js-invoice-datepicker"),f=c.$wrapper.find(".js-invoice-due-datepicker"),g=c.$wrapper.find(".js-due-days-field"),l=c.$wrapper.find(".js-clear-due-date");(function(){var k=
e.parent().find("input[type='hidden']");e.datepicker({altField:k,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});c.invoice_id||e.datepicker("setDate","+0d")})();(function(){var k=f.parent().find("input[type='hidden']");f.datepicker({altField:k,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});f.on("change",function(){var h=d(this).val();d.trim(h).length?l.show():(k.val(""),l.hide())})})();c.$wrapper.on("click",".js-focus-on-field",function(){d(this).parent().find(".js-invoice-due-datepicker").trigger("focus")});
g.on("change",function(){var k=g.val(),h=0;k&&k.length&&0<parseInt(k)&&(h=parseInt(k),g.val(h));0<h?l.show():l.hide();g.val(h);k=h;h=e.datepicker("getDate");k=new Date(h.getTime()+864E5*k);f.datepicker("setDate",k)});e.on("change",function(){var k=g.val();k&&k.length&&0<parseInt(k)&&g.trigger("change")});f.on("change",function(){g.val("")});l.on("click",function(){f.val("").trigger("change")})};CRMInvoiceEdit.prototype.initChangeContact=function(){var c=this,e=c.$wrapper.find(".js-contact-toggle"),
f=e.find(".js-name"),g=e.find(".js-company-name"),l=e.find(".js-profile-image img"),k=e.find(".js-contact-id"),h=!1;e.on("click",".js-change-contact",function(m){m.preventDefault();var n=d(this);d.get(d.crm.app_url+"?module=invoice&action=contactAdd",function(p){d.waDialog({html:p,options:{onAdd:function(q,r,u,v){k.val(q).trigger("change");f.text(r);g.length&&v?g.text(v):g.text("");l.length&&u?l.attr("src",u):l.attr("src",`${c.wa_app_url}wa-content/img/userpic.svg`);h||(q=n.find(".js-label"),r=q.data("change-text"),
e.find(".c-profile-block").show(),q.find("span").text(r),q.find("svg").addClass("fa-pen"),h=!0)}}})})})};CRMInvoiceEdit.prototype.initDealActions=function(){function c(l,k){let h=null;l.on("click",".js-detach-deal",function(m){m.preventDefault();d.crm.confirm.show({title:e.locales.deal_detach_title,text:e.locales.deal_detach_text.replace(/%s/,k),button:e.locales.deal_detach_confirm_button,onConfirm:function(){h&&h.abort();e.loadDealListByContact(function(n){h=d.post(d.crm.app_url+"?module=invoiceDeal&action=detach",
{invoice_id:e.invoice_id}).done(function(p){p&&"ok"===p.status&&(d.crm.content.reload(),l.data("dialog").close())}).always(function(){h=null})})}})})}let e=this,f=e.$wrapper.find(".js-deal-toggle"),g=e.$wrapper.find(".js-deal-toggle [name='invoice[deal_id]']").val();f.on("click",".js-attach-other-deal, .js-associate-deal",function(l){l.preventDefault();let k=f.find(".js-deal-name").text();e.loadDealListByContact(function(h){d.get(d.crm.app_url+"?module=invoiceDeal&action=attachDialog",{invoice_id:e.invoice_id,
deal_id:g},function(m){let n=d(m);d.waDialog({html:n,onOpen:function(){let p=n.find(".js-invoice-deal"),q=e.initSelectDeal({$wrapper:p,data:h});n.find(".js-save-button").on("click",function(){q.submit()});c(n,k)}})})})});f.on("click",".js-detach-deal",function(l){l.preventDefault();let k=null;l=f.find(".js-deal-name").text();d.crm.confirm.show({title:e.locales.deal_detach_title,text:e.locales.deal_detach_text.replace(/%s/,l),button:e.locales.deal_detach_confirm_button,onConfirm:function(){k&&k.abort();
e.loadDealListByContact(function(h){k=d.post(d.crm.app_url+"?module=invoiceDeal&action=detach",{invoice_id:e.invoice_id}).done(function(m){m&&"ok"===m.status&&d.crm.content.reload()}).always(function(){k=null})})}})})};CRMInvoiceEdit.prototype.initSelectDeal=function(c){function e(){t.html(g.locales.deal_empty);z.val("none");m.val("");h.addClass("c-deal-name-hidden");p.addClass("hidden").removeAttr("title");v.addClass("c-empty-deal-hidden");w.addClass("hidden");y.find("li").removeClass("selected");
0<q.data("deals_count")?(q.removeClass("hidden"),r.addClass("hidden")):(q.addClass("hidden"),r.removeClass("hidden"))}function f(){let D=l.find(".js-created-deal");var A=x.find(".js-visible-link .js-text .funnel-state").clone(),C=d.trim(m.val());let E=k.serializeObject();E.invoice_id=g.invoice_id;E["deal[id]"]=z.val();E["deal[name]"]=m.val();E["deal[funnel_id]"]=k.find(".js-select-deal-funnel").val();E["deal[stage_id]"]=k.find(".js-select-deal-stage").val();if("none"===z.val())return k.addClass("shake animated"),
setTimeout(function(){k.removeClass("shake animated")},500),!1;if(0>=z.val()&&!C)return h.addClass("shake animated"),setTimeout(function(){h.removeClass("shake animated");m.focus()},500),!1;k.addClass("deal-form-hidden");D.removeClass("hidden");0>=z.val()?(D.html(A),D.append(d.crm.escape(C))):(C=q.find(".js-visible-link .js-text"),A=C.find(".funnel-state").clone(),C=C.find(".deal-item--name").text(),D.html(A),D.append(d.crm.escape(C)));d.post(d.crm.app_url+"?module=invoice&action=associateDealSave",
E,function(F){"ok"===F.status?(l.closest(".dialog").data("dialog").close(),d.crm.content.reload()):(D.html(""),D.addClass("hidden"),e(),k.removeClass("deal-form-hidden"))})}c=c||{};let g=this,l=c.$wrapper||g.$wrapper,k=l.find(".js-deal-selector-control-wrapper"),h=k.find(".js-deal-name"),m=k.find(".js-deal-name-input"),n=l.closest(".js-conversation-deal-attach-dialog").find(".js-save-button"),p=k.find(".js-save-deal"),q=k.find(".js-deals-dropdown"),r=k.find(".js-create-new-deal-link"),u=k.find(".js-remove-deal"),
v=q.find(".js-empty-deal"),t=k.find(".js-select-deal .js-visible-link .js-text"),w=k.find(".js-select-funnel-wrapper"),x=k.find(".js-select-stage-wrapper"),y=k.find(".js-deals-list"),z=k.find(".js-deal-id");var B=function(D){D=D||{};let A=D.funnels||{},C=0;d.each(D.deals||{},function(E,F){E=y;var G=E.prepend;var H=A[F.funnel_id];if(!F||0>=F.id)F="";else{var I=F.id,K=F.name||"",J="",L="";H&&H.stages&&H.stages[F.stage_id]&&(J=H.stages[F.stage_id].color||"");d.isEmptyObject(H)&&(L='<span class="hint">'+
g.locales.funnel_deleted+"</span>");F='<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+I+'"><span class="flexbox middle js-text"><i class="fas fa-circle funnel-state" style="color: '+J+'"></i><span class="deal-item--name" style="word-break: break-word;">'+K+"</span></span>"+L+"</a></li>"}G.call(E,F);C++});k.show();q.data("deals_count",C);0<C?(q.removeClass("hidden"),r.addClass("hidden")):(r.removeClass("hidden"),q.addClass("hidden"))};z.val("none");"undefined"===typeof c.data?
g.loadDealListByContact(B):B(c.data);k.on("click",".js-create-new-deal",function(){z.val("0");q.addClass("hidden");r.addClass("hidden");h.removeClass("c-deal-name-hidden");p.attr("title",g.locales.deal_create).removeClass("hidden");w.removeClass("hidden");v.removeClass("c-empty-deal-hidden");m.focus();n.addClass("yellow")});k.on("click",".js-deal-item",function(){var D=d(this).find(".js-text").html();t.html(D);z.val(d(this).data("deal-id"));p.attr("title",g.locales.deal_add).removeClass("hidden");
w.addClass("hidden");v.removeClass("c-empty-deal-hidden");y.find("li").removeClass("selected");d(this).parent().addClass("selected");n.addClass("yellow")});y.on("click",function(){y.hide();setTimeout(function(){y.removeAttr("style")},200)});v.on("click",function(){e()});u.on("click",function(){e()});p.on("click",function(D){D.preventDefault();k.trigger("submit")});k.on("submit",function(D){D.preventDefault();f()});k.on("change",".js-select-deal-funnel",function(){k.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+
d(this).val())});return{submit:function(){k.trigger("submit")}}};CRMInvoiceEdit.prototype.loadDealListByContact=function(c){let e=this.$wrapper.find(".js-contact-toggle .js-contact-id").val(),f="?module=deal&action=byContact&id="+e;c=c||function(){};0>=e||this.iframe?c({}):d.get(f,"json").always(function(g){g&&"ok"===g.status?c(g.data||{}):c({})})};CRMInvoiceEdit.prototype.initChangeCompany=function(){function c(l,k,h){l&&l.length&&(e.active_tax_array=l);g.find("option").remove();e.$taxHeader.text(k.length?
k:"\u2014");l&&k?(e.$emptyTax.hide(),e.$tax.parent().show(),d.each(l,function(m,n){m=d('<option value="'+m+'"></option>');if("INCLUDE"===n.tax_type){m.data("type","INCLUDE");var p=e.locales.include_tax}else"APPEND"===n.tax_type?(m.data("type","APPEND"),p=e.locales.append_tax):"NONE"===n.tax_type&&(m.data("type","NONE"),n.tax_percent=0,p=e.locales.no_tax);0<n.tax_percent?(m.data("percent",n.tax_percent),p=p.replace("%value",n.tax_percent+"%")):(m.data("percent",0),p=p.replace("%value",""));if(p=p.replace("%name",
k)){if(e.tax){var q=k===e.tax.name,r=n.tax_type===e.tax.type;n=(+n.tax_percent).toFixed(2)===(+e.tax.percent).toFixed(2);q&&r&&n&&m.attr("selected",!0)}m.text(p);m.data("name",k);g.append(m)}})):(e.$tax.parent().hide(),e.$emptyTax.show(),l=e.$emptyTaxLink.data("href"),e.$emptyTaxLink.attr("href",l+e.$companyField.val().toString()+"/"));g.trigger("change",!h)}var e=this,f=e.$companyField,g=e.$tax;f.on("change",function(l,k){l=d(this).val();var h=e.companies[l];e.active_tax_array=[];h&&(l=h.tax_name||
e.locales.tax,h=JSON.parse(h.tax_options),c(h,l,k))});f.trigger("change",!0)};CRMInvoiceEdit.prototype.initChangeTax=function(){var c=this;c.$tax.on("change",function(e,f){e=d(this).find("option");c.tax_percent=0;c.tax_type="NONE";c.tax_name="";e.length&&(e=e[this.selectedIndex],c.tax_percent=d(e).data("percent")||0,c.tax_type=d(e).data("type"),c.tax_name=d(e).data("name"));c.$taxPercent.val(c.tax_percent);c.$taxType.val(c.tax_type);c.$taxName.val(c.tax_name);c.renderProductTaxOptions();c.renderProductTaxFields(f);
c.refreshTable()})};CRMInvoiceEdit.prototype.initWYSIWYG=function(){var c=this.$wrapper.find(".js-wysiwyg");d.crm.initWYSIWYG(c,{keydownCallback:function(e){}})};CRMInvoiceEdit.prototype.initProductName=function(){function c(g){function l(x){w&&w.abort();var y=d.crm.backend_url+"shop/?action=autocomplete&with_counts=1";x={term:x};h("loading");w=d.get(y,x,function(z){z.length?(r.html(""),d.each(z,function(B,D){B=d("<div />");B.html(D.label).data("product",D).addClass("js-set-product");h(B)})):e.$wrapper.trigger("searchProduct")},
"json").always(function(){w=!1})}function k(x){w&&w.abort();h("loading");var y=e.$currencyField.val();w=d.get(d.crm.backend_url+"shop/?module=orders&action=getProduct",{product_id:x.id,currency:y},function(z){"ok"===z.status?(r.html(""),d.each(z.data.sku_ids,function(B,D){B=d("<div />");D=z.data.product.skus[D];B.text(z.data.product.name+(D.name.length?" ("+D.name+")":"")).data("product",z.data.product).data("sku",D).addClass("js-set-sku");h(B);1===z.data.sku_ids.length&&B.trigger("click")})):e.$wrapper.trigger("searchProduct")},
...
q.trigger("blur");break;case 38:n(!1);break;case 40:n(!0)}else{var y=d(this).val();1<y.length?(v||(e.$wrapper.trigger("searchProduct"),g.addClass("is-active"),v=!0),clearTimeout(t),t=setTimeout(function(){l(y)},500)):e.$wrapper.trigger("searchProduct")}});q.on("change",function(){u.val("").trigger("change")});e.$wrapper.on("searchProduct",m);r.on("click",".js-set-product",function(){var x=d(this).data("product");x&&k(x)});r.on("click",".js-set-sku",function(){var x=d(this),y=x.data("product");x=x.data("sku")||
!1;if(y){var z="shop:"+y.id+(x?":"+x.id:""),B=x.price;q.val(y.name+(x.name.length?" ("+x.name+")":"")).trigger("change");g.closest("tr").find(".js-price-field").val(B).trigger("change");u.val(z).trigger("change")}m();q.trigger("blur")})}var e=this,f=e.$wrapper.find(".js-name-autocomplete");f.length&&(f.each(function(){c(d(this))}),e.refreshTable());e.$wrapper.on("addProduct",function(g,l){g=d(l).find(".js-name-autocomplete");g.length&&c(g)})};CRMInvoiceEdit.prototype.initChangeCurrency=function(){function c(g,
l){e.$tableBody.find(".js-price-field").each(function(){var k=d(this),h=k.val(),m=0;h&&h.length&&(h=h.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(h)&&(m=parseFloat(h)),k.val(m*e.currencies[l].rate/e.currencies[g].rate).trigger("change"))})}var e=this,f=e.$currencyField.val();e.$currencyField.on("change",function(){var g=e.$currencyField.val(),l=!1;e.$tableBody.find(".js-price-field").each(function(){if(d(this).val().length)return l=!0,!1});l?(e.$currencyField.val(f),d.waDialog({html:e.confirm_dialog_template,
...
function(d){CRMInvoiceContactAdd=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.locales=a.locales;this.initClass()};CRMInvoiceContactAdd.prototype.initClass=function(){function a(){var g=e.$form.serializeArray(),l={data:[],errors:[]},k=!1,h=!1;d.each(g,function(m,n){m=n.name;var p=n.value;"deal[contact_id]"===m&&p&&(k=!0);"contact[firstname]"===m&&p&&(h=!0);"contact[lastname]"===m&&p&&(h=!0);"contact[middlename]"===m&&p&&(h=
!0);"contact[name]"===m&&p&&(h=!0);l.data.push(n)});k||h||(l.errors.push({name:"contact[name]",value:e.locales.empty_name}),l.errors.push({name:"contact[firstname]",value:e.locales.empty_name}));return l}function b(g){d.post("?module=invoice&action=contactAddSave",g,function(l){"ok"===l.status?(e.dialog.options.onAdd(l.data.id,l.data.name,!1,!1),e.dialog.close()):c(l.errors)},"json").always(function(){f=!1})}function c(g,l){l=l?l:[];if(g){var k=Object.keys(g);d.each(k,function(h,m){l.push({name:m,
value:g[m]})})}d.each(l,function(h,m){h=m.name;m=m.value;"name"===h&&(h="contact[firstname]");var n=e.$form.find('[name="'+h+'"]');"contact[firstname]"!==h||n.is(":visible")||(n=e.$form.find(".js-contact-autocomplete"));if(n.length&&!n.hasClass("state-error")){var p=d("<div />").addClass("state-error-hint").text(m);p.insertAfter(n);n.addClass("state-error").one("focus click",function(){n.removeClass("state-error");p.remove()});d(document).on("toggleChanged",function(){n.removeClass("state-error");
p.remove()})}})}var e=this,f=!1;e.$form.on("submit",function(g){g.preventDefault();g=e.$wrapper.find(".js-contact-id-field").val();var l=!1;if(g){var k=e.$wrapper.find(".js-contact-autocomplete");var h=k.val();is_company=k.data("is_company");+is_company||(l=e.$wrapper.find(".js-company-autocomplete").val());k=k.data("photo_url");e.dialog.options.onAdd(g,h,k,l);e.dialog.close()}else f||(f=!0,g=a(),g.errors.length?(c(!1,g.errors),f=!1):b(g.data))})};return CRMInvoiceContactAdd}(jQuery),CRMInvoicePage=
...
function(c){spinnerView(d(this)).show()})};CRMInvoicePage.prototype.initChangeState=function(){function b(g,l){if(!f){f=!0;var k={invoice_id:e,action:g};const h=spinnerView(l);h.show();d.post("?module=invoice&action=handleTransaction",k,function(m){if("ok"===m.status){const n=getIframeIfExists();n?(window.parent.iframe_invoice_is_saved=!0,n.contentWindow.location.reload()):(a(c.invoice_id,"delete"===g?"":m.data.html),c.load(d.crm.app_url+"invoice/"+c.invoice_id+"/"))}else alert(m.errors)},"json").always(function(){h.hide();
f=!1})}}var c=this,e=c.invoice_id,f=!1;c.$wrapper.on("click",".js-change-state",function(g){g.preventDefault();(g=d(this).data("action"))&&b(g,d(this))})};CRMInvoicePage.prototype.initDelete=function(){function b(f){if(!e){e=!0;var g={invoice_id:c.invoice_id,action:"delete"};const l=spinnerView(f.$body.find(".js-success-action"));l.show();d.post("?module=invoice&action=handleTransaction",g,function(k){if("ok"===k.status){k=d.crm.app_url+"invoice/";const h=getIframeIfExists();h?h.dispatchEvent(new CustomEvent("close",
{detail:"refresh"})):d.crm.content.load(k)}},"json").always(function(){l.hide();e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-delete-invoice",function(f){f.preventDefault();d.waDialog.confirm({title:c.locales.delete_confirm_title,text:c.locales.delete_confirm_text,success_button_title:c.locales.delete_confirm_button,success_button_class:"danger",cancel_button_title:d.crm.locales.cancel,cancel_button_class:"light-gray",onSuccess:b})})};CRMInvoicePage.prototype.initRefund=function(){function b(f){if(!e){e=
!0;var g=d.crm.app_url+"?module=invoice&action=refundDialog",l={invoice_id:c.invoice_id};const k=spinnerView(f,0);k.show();d.post(g,l,function(h){d.waDialog({html:h,options:{onRefund:function(m){const n=getIframeIfExists();n?(window.parent.iframe_invoice_is_saved=!0,n.contentWindow.location.reload()):(a(c.invoice_id,m.html),c.reload())}}})}).always(function(){k.hide();e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-change-refund",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.initRestore=
function(){function b(f){if(!e){e=!0;var g={id:c.invoice_id};const l=spinnerView(f);l.show();d.post("?module=invoiceRestore",g,function(k){if("ok"===k.status){const h=getIframeIfExists();h?(window.parent.iframe_invoice_is_saved=!0,h.contentWindow.location.reload()):(a(c.invoice_id,k.data.html),c.reload())}else l.hide(),alert(k.errors)},"json").always(function(){e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-restore-invoice",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.load=
...
function(){function b(k){l&&l.abort();d(document).trigger("wa_before_load");return l=d.ajax({method:"GET",url:k,data:{content_only:1},dataType:"html",global:!1,cache:!1,xhr:function(){var h=new window.XMLHttpRequest;h.addEventListener("progress",function(m){d(document).trigger("wa_loading",m)},!1);h.addEventListener("abort",function(m){d(document).trigger("wa_abort")},!1);return h}}).always(function(){c.xhr=!1}).done(function(h){g&&history.pushState({reload:!0,content_uri:k},"",k);d(document).trigger("wa_before_render");
e.html(h);d(document).trigger("wa_loaded")}).fail(function(h){d(document).trigger("wa_abort");h.responseText&&d.waDialog.alert({title:"Error",text:h.responseText,button_title:"Close"})})}var c=this,e=c.$content.find(".js-inner-content"),f=!1,g=!(!history||!history.pushState),l=!1;c.$wrapper.on("click","a",function(k){const h=d(this),m=h.hasClass("js-disable-router")?h.attr("href"):!1;if(!m)return!0;k.preventDefault();f?d.waDialog.confirm({title:d.crm.locales.unsaved_dialog_title,text:d.crm.locales.unsaved_dialog_text,
success_button_title:d.crm.locales.unsaved_dialog_button,success_button_class:"danger",cancel_button_title:d.crm.locales.cancel,cancel_button_class:"light-gray",onSuccess:function(){d(document).trigger("unsavedChanges",!1);b(m)}}):b(m).then(()=>{c.$content.is(":hidden")&&c.showContentMobile()})});d(document).on("unsavedChanges",function(k,h){f=!!h})};CRMInvoices.prototype.initLazy=function(){function b(){if(!g){var l={offset:f.data("offset")},k=a();k&&(l.invoice_id=k);g=!0;d.post("?module=invoice&action=sidebar",
l,function(h){var m=d(h);h=m.find(".js-lazyload");m=m.find(".c-invoice");e.unobserve(f[0]);h.length?(h.insertAfter(f),f.remove(),f=h,e.observe(f[0])):f.remove();c.append(m)}).always(function(){g=!1})}}let c=this.$invoiceList,e=null,f=this.$wrapper.find(".js-lazyload"),g=!1;this.$invoiceList.on("touchstart",function(){d("body").css({overflow:"hidden"});d(this).closest(".sidebar-body").css({overflow:"overlay"});setTimeout(()=>{d("body").css({overflow:"auto"})})});f.length&&function(){e=new IntersectionObserver(l=>
{0>=l[0].intersectionRatio||b()});e.observe(f[0])}()};CRMInvoices.prototype.initInvoiceList=function(){function b(f){c.$invoiceList.find(".c-invoice").each(function(){var g=d(this),l=g.data("id");f==l&&(g.addClass("selected"),e=g)})}var c=this,e=c.$invoiceList.find(".c-invoice.selected");d(document).on("viewInvoice",function(f,g){e.length&&e.removeClass("selected");g&&b(g)})};CRMInvoices.prototype.initInvoiceSearch=function(){var b=this.$wrapper.find(".js-search-field");b.autocomplete({appendTo:this.$sidebar,
...
".js-hide-combobox",function(f){f.stopPropagation();a(!1)});(function(){var f=c.find(".js-autocomplete");f.autocomplete({appendTo:c,source:b.app_url+"?module=autocomplete&type=user",minLength:0,html:!0,focus:function(){return!1},select:function(g,l){b.setContact(l.item);a(!1);f.val("");b.form_is_change=!0;return!1}}).data("ui-autocomplete")._renderItem=function(g,l){return d("<li />").addClass("ui-menu-item-html").append("<div>"+l.value+"</div>").appendTo(g)};f.on("focus",function(){f.data("uiAutocomplete").search(f.val())})})();
b.setContact=function(f){var g=c.find(".js-user");f.photo_url&&g.find(".icon.size-24").css("background-image","url("+f.photo_url+")").html("");g.find(".c-name").text(f.name);e.val(f.id)}};CRMReminderFormEdit.prototype.initSearchDeal=function(){var a=this,b=a.$form.find(".c-deal-wrapper"),c=a.$form.find('[name="data[deal_id]"]'),e=a.$form.find('[name="data[contact_id]"]'),f=b.find(".c-search-contact-wrapper"),g=b.find(".c-deal-item"),l=b.find(".js-autocomplete-deal");l.autocomplete({appendTo:f,position:{my:"right top",
at:"right bottom"},source:a.app_url+"?module=autocompleteSidebar",minLength:0,html:!0,focus:function(k,h){return!1},select:function(k,h){a.setDeal(h.item);l.val("");f.find(".ui-autocomplete").hide();a.form_is_change=!0;c.trigger("click");return!1}}).data("ui-autocomplete")._renderItem=function(k,h){return d("<li />").addClass("ui-menu-item-html").append("<div>"+h.value+"</div>").appendTo(k)};b.on("click",function(k){k.preventDefault();k=d(k.target);f.is(":visible")?k.closest(".js-reset-deal").length&&
a.clearDeal():k.closest(".js-open-search").length&&(f.addClass("is-shown"),l.focus())});a.clearDeal=function(){g.html("");f.removeClass("is-hidden is-shown");e.val("");c.val("");a.form_is_change=!0;c.trigger("click");a.tempFormData.contact.id="";a.tempFormData.contact.name="";a.tempFormData.contact.photo_url=""};l.on("focus",function(){l.data("uiAutocomplete").search(l.val())});a.setDeal=function(k,h=!1){var m=a.app_url+(k.photo_url?"contact/":"deal/")+k.id;m=`<a class="flexbox middle c-user" href="${h?
m:"javascript:void(0);"}">
            ...
            ${h?"":'<div class="hint custom-pl-12 js-open-search cursor-pointer">\n                <span class="icon size-14"><i class="fas fa-pen" title="[`edit`]"></i></span>\n            </div>'}`;if(h)return m;f.addClass("is-hidden").removeClass("is-shown");g.html(m);k.photo_url?(e.val(k.id),c.val(""),a.tempFormData.contact.photo_url=k.photo_url):(c.val(k.id),e.val(""),a.tempFormData.contact.photo_url="");a.tempFormData.contact.id=k.id;a.tempFormData.contact.name=k.name}};CRMReminderFormEdit.prototype.initTextArea=
...
a.editClickWatcher);b.on("escKeyPress",a.$clear)});a.close_edit=function(){b.trigger("reminderNotChanged");a.form_is_change=!1;d(document).off("click",a.editClickWatcher);b.off("escKeyPress",a.$clear)};a.editClickWatcher=function(f){if(d.contains(document,c[0])){var g=d(f.target);if(c.is(":visible")){f=d.contains(b[0],f.target);var l=!!g.closest(".js-edit-reminder").length,k=!!g.closest(".ui-timepicker-wrapper").length,h=!!g.closest(".ui-datepicker").length||!!g.closest(".ui-corner-all").length,m=
c.find(".js-contact-wrapper").hasClass("is-shown"),n=!!g.closest(".js-contact-wrapper").length,p=c.find(".c-search-contact-wrapper").hasClass("is-shown");g=!!g.closest(".c-deal-wrapper").length;f||k||h||(a.checkFormChange()?a.close_edit():l&&a.close_edit());m&&!n&&c.find(".js-contact-wrapper").removeClass("is-shown");p&&!g&&c.find(".c-search-contact-wrapper").removeClass("is-shown")}}else d(document).off("click",a.editClickWatcher),b.off("escKeyPress",a.$clear)}};CRMReminderFormEdit.prototype.initTypeToggle=
...
const e={all:!0,date_time:!0};e.all=this.initialFormValues===b;b=c.filter(g=>"data[due_date]"===g.name)[0].value;const f=c.filter(g=>"data[due_time]"===g.name)[0].value;c=c.filter(g=>"data[user_contact_id]"===g.name)[0].value;e.date_time=a.due_date===b&&a.due_time===f&&a.user_contact.id===c?!0:!1;return e}return this.initialFormValues===b};CRMReminderFormEdit.prototype.initSubmit=function(){function a(){var n={data:[],errors:[]},p=l.serializeArray(),q=!1;type_other=!1;d.each(p,function(r,u){u.value.length&&
(n.data.push(u),"data[due_time]"===u.name&&(q=!0),"OTHER"===u.value&&(type_other=!0))});n.data.length<(q?5:type_other?4:3)&&n.errors.push({name:"content",value:f.locales.at_least});type_other&&(p=n.data.filter(r=>"data[content]"===r.name),p.length&&/\S/.test(p[0].value)||n.errors.push({name:"content",value:f.locales.empty}));return n}function b(n,p){p=p?p:[];if(n){var q=Object.keys(n);d.each(q,function(r,u){p.push({name:u,value:n[u]})})}d.each(p,function(r,u){r=u.value;var v=l.find(`[name="data[${u.name}]"`);
...
(n=f.$main_wrapper.find(".is-view .c-deal-wrapper"),""!==f.tempFormData.contact.id?n.html(f.setDeal(f.tempFormData.contact,!0)):n.html(""));f.initialFormData=jQuery.extend(!0,{},f.tempFormData);k.addClass("highlighted");k.trigger("reminderNotChanged");k.trigger("updatePadding")}var f=this,g=!1,l=f.$form,k=f.$main_wrapper,h=f.$wrapper,m=l.find(".js-save");$cancel_button=l.find(".js-cancel");$has_errors=!1;m.on("click",function(n){n.stopPropagation();f.$form.trigger("submit")});$cancel_button.on("click",
function(n){n.stopPropagation();n.preventDefault();f.$clear()});f.$clear=function(){const n=l.find(".js-textarea"),p=l.find(".js-datepicker"),q=l.find(".js-timepicker"),r=l.find(".c-search-contact-wrapper").hasClass("is-hidden"),u=l.find(".js-contact-field");if(!f.checkFormChange()){const v=f.initialFormData;n.val(v.content);h.find(`.menu a[data-type-id='${v.type}']`).trigger("click");p.val(v.due_date).trigger("change");q.val(v.due_time).trigger("change");v.contact.id?f.setDeal(v.contact):r&&f.clearDeal();
u!==v.user_contact.id&&f.setContact(v.user_contact);$has_errors&&(l.find('[name="data[content]"').trigger("clear_error"),$has_errors=!1);n.css("height",0);n.css("height",n[0].scrollHeight+"px")}f.close_edit()};l.on("submit",function(n){n.preventDefault();n=f.checkFormChange(!0);n.all?f.close_edit():n.date_time?f.$submit_reminder():f.$submit_reminder(!0)});f.$submit_reminder=function(n){$has_errors&&(l.find('[name="data[content]"').trigger("clear_error"),$has_errors=!1);var p=a();p.errors.length?b(!1,
...
"?module=autocompleteSidebar",minLength:0,html:!0,focus:function(){return!1},select:function(D,A){D=A.item;A=`<a class="flexbox middle c-user" href="javascript:void(0);">
                ${D.photo_url?`<span class="icon size-18 rounded js-open-search" style="background-image: url(${D.photo_url});"></span>`:""}
                <span class="c-user-name">&nbsp;${D.name}</span>
                </a>
                <div class="hint custom-pl-12 js-open-search cursor-pointer">
                    <span class="icon size-14"><i class="fas fa-pen" title="[\`edit\`]"></i></span>
                </div>`;y.addClass("is-hidden").removeClass("is-shown");z.html(A);D.photo_url?(x.val(D.id),w.val("")):(w.val(D.id),x.val(""));B.val("");y.find(".ui-autocomplete").hide();return!1}}).data("ui-autocomplete")._renderItem=function(D,A){return d("<li />").addClass("ui-menu-item-html").append("<div>"+A.value+"</div>").appendTo(D)};t.on("click",function(D){D=d(D.target);y.is(":visible")?D.closest(".js-reset-deal").length&&n.clearDeal():D.closest(".js-open-search").length&&(y.addClass("is-shown"),
...
!0),d.post("?module=reminder&action=add",data,function(x){"ok"===x.status?w||(n.$iframe?null:d.crm.sidebar.reload(),d.crm.content.reload()):console.error(x.errors)},"json").always(function(){is_locked=!1}))))})};CRMReminders.prototype.initLazyLoading=function(){function a(){function e(){var h=d.contains(document,$loader[0]);h?f($loader):($loader=$list.find(".js-lazy-load"),(h=d.contains(document,$loader[0]))?f($loader):k.off("scroll",e))}function f(h){var m=d(window).scrollTop(),n=l.height(),p=h.offset().top;
m+n>=p&&(c||g(h))}function g(h){var m=d.crm.app_url+"?module=reminder&action=actual"+((0<b.setting_deal_id?"&deal="+b.setting_deal_id:"")+(0<b.setting_contact_id?"&contact="+b.setting_contact_id:"")+(b.$iframe?"&iframe=1":""));data={user_id:b.user_id,page:++b.current_page};c=!0;d.post(m,data,function(n){b.click_reminder_event||(h&&h.remove(),$list.append(n),a())}).always(function(){c=!1})}var l=d(window),k=l;$list=b.$wrapper.find("#c-main-reminders-list");$loader=$list.find(".js-lazy-load");if($loader.length)if(0<
l.height())if(1==b.current_page&&l.height()>$list.height())e();else k.on("scroll",e);else setTimeout(()=>a(),100)}var b=this,c=!1;a()};CRMReminders.prototype.initCompletedReminders=function(){function a(){var t=m.width();l.width(t)}function b(){var t="?module=reminder&action=completed"+((0<g.setting_deal_id?"&deal="+g.setting_deal_id:"")+(0<g.setting_contact_id?"&contact="+g.setting_contact_id:"")),w={user_id:g.user_id};v=!0;n.append(q);p.hide();d.post(t,w,function(x){r=!0;k.html(x);f();n.children().last().remove();
p.show();d(window).trigger("scroll");c(!0)}).always(function(){v=!1})}function c(t,w){u?(setTimeout(()=>{h.hide();m.css("overflow","unset");g.$iframe||m.css("max-height","unset")},300),d(document).off("click",e)):(m.css("overflow","hidden"),g.$iframe||m.css("max-height","calc(100vh - 4rem)"),h.show(),d(document).on("click",e));w?(l.toggleClass("is-shown"),u=!u,k.slideToggle(300)):t?(l.addClass("is-shown"),u=!0,k.slideDown(300)):(l.removeClass("is-shown"),u=!1,k.slideUp(300))}function e(t){t.preventDefault();
(is_target=d.contains(l[0],t.target))||c(!1)}function f(){function t(){if(d.contains(document,x[0])){if(u){var z=x,B=k.scrollTop(),D=k.height(),A=z.offset().top;list_top=k.offset().top;B+D>=A-list_top&&(y||w(z))}}else k.off("scroll",t)}function w(z){var B="?module=reminder&action=completed"+((0<g.setting_deal_id?"&deal="+g.setting_deal_id:"")+(0<g.setting_contact_id?"&contact="+g.setting_contact_id:"")),D={user_id:g.user_id,min_dt:k.find("> li[data-datetime]:last").data("datetime")};y=!0;d.post(B,
D,function(A){z.remove();k.append(A);f()}).always(function(){y=!1})}d(window);var x=k.find(".js-lazy-load"),y=!1;if(x.length)k.on("scroll",t)}var g=this,l=g.$completedSection,k=l.find(".c-reminders-list"),h=g.$wrapper.find(".drawer"),m=g.$wrapper.find(".article-body"),n=l.find(".c-actions"),p=n.find(".sort-down"),q=d("<span/>").addClass("icon size-16").append("<i/>").addClass("fas fa-spinner wa-animation-spin speed-1000 text-gray"),r=!1,u=!1,v=!1;g.$iframe||(a(),d(window).on("resize",function(){a()}));
d(document).on("is_completed_loaded_false",function(t,w){if(w){w.new_text&&l.find(".js-completed-reminders-btn-text").text(w.new_text);l.hasClass("hidden")&&l.removeClass("hidden");t=w.state;var x=g.$sidebar.find(`[data-id='${w.user_id}'] .details`);w=g.$sidebar.find("[data-id='all'] .details");var y=x.find(".count.all"),z=w.find(".count.all");y.text(y.text()-1);z.text(z.text()-1);if("overdue"==t||"burn"==t)y=x.find(".count.overdue"),x=x.find(".count.burn"),y.length?(x=y.data("due-count"),z=+y.text(),
"overdue"==t?y.data("due-count",--x):null,y.text(--z),0>=x&&y.removeClass("overdue").addClass("burn"),0>=z&&y.remove()):x.length&&(y=+x.text(),x.text(--y),0>=y&&x.remove()),y=w.find(".count.overdue"),w=w.find(".count.burn"),y.length?(w=y.data("due-count"),x=+y.text(),"overdue"==t?y.data("due-count",--w):null,y.text(--x),0>=w&&y.removeClass("overdue").addClass("burn"),0>=x&&y.remove()):w.length&&(t=+w.text(),w.text(--t),0>=t&&w.remove())}else r=!1});l.on("click",".js-load-completed-reminders",function(t){t.preventDefault();
...
!1):!0};return CRMReminderSettings}(jQuery);var CRMLogLive=function(d){var a=function(c){a=function(e){this.list_name=e.names.list;this.items_name=e.names.items;this.pagind_name=e.names.paging;this.log=e.log;this.$wrapper=e.$wrapper||!1;this.$list=this.$wrapper.find(this.list_name);this.$window=c(window);this.onLoad=e.onLoad||function(){};this.$paging=this.$wrapper.find(this.pagind_name);this.is_locked=this.xhr=!1;this.addWatcher()};a.prototype.addWatcher=function(){function e(){var l=window&&c.contains(document,f.$paging[0]);l&&g&&window.frameElement&&
(l=c.contains(g.document,window.frameElement));if(l)f.onScroll();else f.$window.off("scroll",e),c(g).off("scroll",e)}var f=this,g=window.parent;f.$window.on("scroll",e);if(g&&window.frameElement)c(g).on("scroll",e)};a.prototype.onScroll=function(){var e=this.$window,f=e.scrollTop();e=e.height();var g=this.$paging.offset().top;if(window.parent&&window.frameElement){var l=c(window.parent);e=l.height();f+=l.scrollTop();g+=c(window.frameElement).offset().top}f+e>=g&&!this.is_locked&&(this.is_locked=!0,
this.loadNextPage())};a.prototype.loadNextPage=function(){var e=this,f=e.log.filtersData.slice(0);f.push({name:"max_id",value:e.$paging.data("max-id")});f.push({name:"timestamp",value:e.$list.find(e.items_name).last().data("timestamp")});e.xhr&&e.xhr.abort();e.xhr=c.get("?module=logLive",f,function(g){var l=c("<div id='c-temp-wrapper' />");e.log.$wrapper.after(l);l.html(g);g=l.find(e.list_name+" "+e.items_name);l=l.find(e.pagind_name);e.$list.append(g);e.$paging.after(l);e.$paging.remove();e.$paging=
l;e.is_locked=!1;e.onLoad()})};return a}(jQuery),b=function(c){function e(k,h){var m=k.offsetWidth;k=k.offsetHeight;return{outer_width:m,outer_height:k,inner_width:m-h.left-h.right,inner_height:k-h.top-h.bottom}}function f(k){function h(t){var w=t.split("-");t=parseInt(w[0]);var x=parseInt(w[1])-1;w=parseInt(w[2]);return new Date(t,x,w)}var m=[];k=function(t){function w(x,y){var z=x.split("-");x=parseInt(z[0]);var B=parseInt(z[1])-1;z=parseInt(z[2]);B=new Date((new Date(x,B,z)).getTime()+(y?864E5:
...
function g(k,h,m){var n=null;m+=1;k&&m&&(n=(k-h*(m-1))/m,1>n&&(n=1));return n}function l(k,h){var m=h[0];h=h[1]||1;m=h-m+(1<h-m?0:1);h=m/(k-1);for(var n=[],p=0;p<k;p++){var q=10<m?Math.round(p*h):parseInt(p*h*10)/10;n.push(q)}return n}b=function(k){this.$wrapper=k.$wrapper;this.$hint=this.$wrapper.find(".js-hint-wrapper");this.node=this.$wrapper.find(".js-chart-wrapper")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=k.data;this.data=f(this.charts);this.group_by=k.group_by;
...
h.outer_width).attr("height",h.outer_height);k.renderBackground();k.renderCharts();k.renderAxis();setTimeout(function(){function m(){c.contains(document,k.$wrapper[0])?k.update():c(window).off("resize",m)}c(window).on("resize",m)},4)};b.prototype.initGraphCore=function(){var k=this.data,h=this.area,m=this.x=d3.time.scale().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([h.inner_height,0]);this.yDomain=function(){var n=d3.min(k,function(q){return d3.min(q,function(r){return r.value})});
0<n&&(n=0);var p=d3.max(k,function(q){return d3.max(q,function(r){return r.value+r.y0})});return[n,p]}();this.xDomain=function(){var n=k[0][0].date;var p=k[0][k[0].length-1].date;var q=parseInt((k[0][1].date.getTime()-n.getTime())/2);n=new Date(n.getTime()-q);p=new Date(p.getTime()+q);return[n,p]}();m.domain(this.xDomain);h.domain(this.yDomain)};b.prototype.renderAxis=function(){var k=this.x,h=this.y,m=this.svg;this.xAxis=d3.svg.axis().scale(k).orient("bottom").ticks(10);this.yAxis=d3.svg.axis().scale(h).innerTickSize(2).orient("right").tickValues(l(6,
this.yDomain)).tickFormat(function(n){return n+""});k=m.append("g").attr("class","axis");k.append("g").attr("transform","translate(10,"+this.margin.top+")").attr("class","y").call(this.yAxis);k.append("g").attr("class","x").attr("transform","translate("+this.margin.left+","+(this.area.outer_height-this.margin.bottom)+")").call(this.xAxis)};b.prototype.renderBackground=function(){var k=this.area.inner_width,h=this.area.inner_height,m,n=this.svg.append("g").attr("class","background").attr("transform",
"translate("+this.margin.left+","+this.margin.top+")");n.append("rect").attr("width",k).attr("height",h);for(m=0;5>=m;m++){var p=1+(h-2)/5*m;n.append("line").attr("x1",1).attr("x2",k).attr("y1",p).attr("y2",p)}};b.prototype.renderCharts=function(){var k=this,h=k.data;h=k.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+k.margin.left+","+k.margin.top+")");var m=h.selectAll(".rect").data(function(n){return n});m.enter().append("rect").attr("class",
...
this.yDomain));this.svg.selectAll(".axis .y").transition().duration(600).call(this.yAxis);this.xAxis.scale(this.x);this.svg.selectAll(".axis .x").transition().duration(600).call(this.xAxis);this.renderCharts()};b.prototype.showHint=function(k,h,m,n){var p=this;k=c(h);if(!(0<Math.ceil(k.attr("height"))))return!1;var q=m.date;h=p.$hint.find(".c-date");var r=p.$hint.find(".c-app"),u=p.$hint.find(".c-value");q=function(v,t){var w=parseInt(v.getMonth());"months"==t?(v=p.locales.months,v[w]||(v="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ")),
...
k.hide();setTimeout(function(){k.removeAttr("style")},200);m.val(v);h.val(t);"custom"!==v?(p.removeClass("is-shown"),e()):p.addClass("is-shown")}function e(){var u=l.serializeArray();u.push({name:"chart",value:1});d.post("?module=logLive",u,function(v){"ok"==v.status&&(v=v.data,v.group_by=h.val(),f.chart.update(v))},"json").always(function(){q=!1})}var f=this,g=f.$wrapper.find(".js-dates-filter"),l=g.find("form"),k=g.find(".js-list"),h=g.find(".js-group-field"),m=g.find(".js-timeframe-field"),n=g.find(".js-link-text"),
p=g.find(".js-hidden-part"),q=!1,r=k.find(".selected");k.on("click",".js-toggle",function(u){u.preventDefault();c(d(this))});l.on("submit",function(u){u.preventDefault();q||(q=!0,e())});(function(){g.find(".js-datepicker").each(function(){var u=d(this),v=g.find("."+u.data("selector"));u.datepicker({altField:v,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMLogLive.prototype.initChart=function(){var c=this.$wrapper.find(".js-chart-section");c.length&&this.chartData&&this.chartData.length&&
...
"0"===A[3].value?k():l(h.started_deal,A[3].value);A[3].value===H[3].value||"0"!==H[3].value&&"0"!==A[3].value||K.trigger("click");I.eq(0).datepicker("setDate",new Date(A[5].value));I.eq(1).datepicker("setDate",new Date(A[6].value));G.trigger("click")}function f(A,C,E,F){var G=A.name;A=`<div class="c-user-wrapper">
                ...
                <span class="icon cursor-pointer js-call-filter-contact-cancel"><i class="fas fa-times-circle"></i></span>`;p.find("#input-contact").val(C);F.val()?F.val(""):null;E.html(A);F.hide()}function g(){r.show();w.html("");p.find("#input-contact").val("")}function l(A,C){var E=h.escapeHtml(A.name);A=`
                ...
                <span class="icon js-call-filter-deal-cancel"><i class="fas fa-times-circle"></i></span>`;p.find("#input-deal").val(C);v.val("");x.html(A);v.hide()}function k(){v.show();x.html("");p.find("#input-deal").val("")}var h=this,m=h.$wrapper.find(".js-filter-button"),n=h.$wrapper.find(".js-reload-filter-button"),p=h.$wrapper.find(".c-call-filter"),q=p.find(".c-call-filter-form"),r=p.find(".js-search-field-contact"),u=r.parent(),v=p.find(".js-search-field-deal"),t=v.parent(),w=p.find(".js-call-filter-contact"),
x=p.find(".js-call-filter-deal"),y=q.serializeArray(),z=q.serialize(),B=h.$wrapper.height()<d(".content.blank.c-shadowed-content").height(),D=[{name:"direction",value:"all"},{name:"status",value:"ALL"},{name:"contact",value:""},{name:"deal",value:""},{name:"timeframe",value:"null"},{name:"start",value:""},{name:"end",value:""},{name:"user",value:""}];m.on("click",function(A){A.preventDefault();a()});n.on("click",function(A){A.preventDefault();n.find("svg").removeClass("fa-times").addClass("fa-spinner fa-spin");
d.crm.content.load(d.crm.app_url+"call/?direction=all&status=ALL")});p.on("click",".js-close-drawer",function(A){A.preventDefault();b()});p.on("click",".js-apply-filter",function(A){A.preventDefault();c()});p.on("click",".js-reset-filter",function(A){A.preventDefault();"direction=all&status=ALL&timeframe=null&deal=&contact=&start=&end="!==q.serialize()&&e(D)});p.on("click",".js-restore-filter",function(A){A.preventDefault();z!==q.serialize()&&e(y);b()});p.on("click",".js-call-filter-contact-cancel",
function(A){A.preventDefault();g()});p.on("click",".js-call-filter-deal-cancel",function(A){A.preventDefault();k()});(function(){var A=h.$wrapper.find(".js-search-field-client"),C=A.parent();$search_contact_wrapper=h.$wrapper.find(".js-call-filter-search");$search_contact_cancel=h.$wrapper.find(".c-call-filter-contact .js-call-filter-contact-cancel");A.autocomplete({appendTo:C,source:d.crm.app_url+"?module=autocompleteContact&with_email=1&with_phone=1",minLength:0,html:!0,focus:function(){return!1},
select:function(E,F){f(F.item,F.item.id,$search_contact_wrapper,C);c(!0);return!1}}).data("ui-autocomplete")._renderItem=function(E,F){return d("<li />").addClass("ui-menu-item-html").append("<div><span class='icon userpic custom-mr-4'><i style='background-image: url("+F.userpic+");'></i></span>"+F.name+"</div>").appendTo(E)};$search_contact_cancel.on("click",function(E){E.preventDefault();C.show();$search_contact_wrapper.html("")})})();r.autocomplete({appendTo:u,source:d.crm.app_url+"?module=autocompleteContact&with_email=1&with_phone=1",
minLength:0,html:!0,focus:function(){return!1},select:function(A,C){f(C.item,C.item.id,w,r);return!1}}).data("ui-autocomplete")._renderItem=function(A,C){return d("<li />").addClass("ui-menu-item-html").append("<div class='flexbox'><span class='icon userpic custom-mr-4'><i style='background-image: url("+C.userpic+");'></i></span>"+C.name+"</div>").appendTo(A)};v.autocomplete({appendTo:t,source:d.crm.app_url+"?module=autocompleteDeal",minLength:0,html:!0,focus:function(){return!1},select:function(A,
C){l(C.item,C.item.id);return!1}}).data("ui-autocomplete")._renderItem=function(A,C){return d("<li />").addClass("ui-menu-item-html").append("<div>"+h.escapeHtml(C.name)+"</div>").appendTo(A)};(function(){p.find(".js-datepicker").each(function(){var A=d(this),C=p.find("."+A.data("selector"));A.datepicker({altField:C,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMCallPage.prototype.initDownloadLink=function(){$records_array=this.$wrapper.find(".c-call-wrapper .c-call-record-link");setTimeout(function(){$records_array.eq(0).trigger("click")},
...
l=g.data("id");e=f.data("title");d.waDialog.confirm({title:`<i class=\"fas fa-exclamation-triangle smaller state-error\"></i> ${e}?`,text:b.locales.delete_confirm_text,success_button_title:b.locales.delete_confirm_button,success_button_class:"danger custom-mr-4",cancel_button_title:`${b.locales.delete_cancel_button}`,cancel_button_class:"light-gray",onSuccess:function(){if(!c){c=!0;var k={id:l},h=f.find(".delete");h.removeClass("delete").addClass("loading");d.post("?module=call&action=delete",k,function(m){"ok"===
...
function(){function a(){clearTimeout(f);f=setTimeout(b,1E4)}function b(){var g=!1,l=c.$wrapper.find("audio");d.each(l,function(k,h){d(h)[0].ended||(g=!0)});if(g)return a(),!1;e||(e=!0,d.post("?module=call&action=ts&background_process=1",{call_ts:c.call_ts},function(k){"ok"==k.status&&d.contains(document,c.$wrapper[0])&&(k.data!==c.call_ts?d.crm.content.reload():a())}).always(function(){e=!1}))}var c=this,e=!1,f=0;a()};CRMCallPage.prototype.initLazyLoading=function(){function a(){function e(){if(d.contains(document,
k[0])){var h=k,m=d(window).scrollTop(),n=g.height(),p=h.offset().top;m+n>=p&&(c||f(h))}else g.off("scroll",e)}function f(h){var m=window.location.href.split("/crm/call/")[1];m=d.crm.app_url+"?module=call"+(m?"&"+m.slice(1):"");data={lazy:1,page:++b.current_page};c=!0;console.log(m);d.post(m,data,function(n){n=d(n).find("#js-calls-table").html();l.append(n);d(document).trigger("wa_loaded");h&&h.remove();a()}).always(function(){c=!1})}var g=d(window),l=b.$wrapper.find("#js-calls-table"),k=b.$wrapper.find(".js-lazy-load");
...
"?module=call&action=checkStatus",{id:c},function(h){try{h.errors&&(clearInterval(k),b.$content.html(l),setTimeout(function(){b.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):(b.dialog.close(),d.crm.content.reload())},3E3),console.log(h.errors.message)),"PENDING"===h.data.status_id?b.$content.html(f):"CONNECTED"===h.data.status_id?b.$content.html(g):(b.$content.html(l),clearInterval(k),setTimeout(function(){b.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):
...
d.trim(f)||(f=d.trim(a.$autocomplete.val()));if(!d.trim(f))return b.addClass("shake animated"),setTimeout(function(){b.removeClass("shake animated")},500),!1;(function(){var g=a.$form.find(".js-number-type").val(),l=a.$wrapper.find(".js-dialog-footer"),k=d('<span class="icon size-16 loading"><i class="fas fa-spinner fa-spin"></i></span>');a.$button.prop("disabled",!0);l.append(k);d.post(d.crm.app_url+"?module=call&action=redirect",{call_id:e,number_type:g,number:f},function(h){"ok"===h.status&&(l.find(".svg-inline--fa.fa-spinner").removeClass("fa-spinner fa-spin").addClass("fa-check text-green"),
...
else{console.log("Error saving Responsible contact classification: "+arguments[2],arguments);var l="Error saving Responsible contact classification: "+arguments[2];l=d('<div class="errormsg" />').text(l);b.$errorsPlace.append(l)}},"json").always(function(){b.$button.attr("disabled",!1);f.remove()})}var b=this;b.$wrapper.find(".js-delete-message").on("click",function(){event.preventDefault();d.crm.confirm.show({title:b.locales.delete_message,text:b.locales.delete_message_text,button:b.locales["delete"],
...
this.$button=this.$wrapper.find(".js-close-dialog");this.contact_id=a.contact_id;this.message=a.message||{};this.locales=a.locales;this.initClass()};CRMMessageBodyDialog.prototype.initClass=function(){this.initMessageShowBodyLink();this.is_admin&&(this.initSelectDeal(),this.initMessageDeleteLink())};CRMMessageBodyDialog.prototype.initSelectDeal=function(){function a(){n.html(""+c.locales.deal_empty);u.val("none");g.val("");f.addClass("c-deal-name-hidden");l.addClass("hidden").removeAttr("title");
m.addClass("c-empty-deal-hidden");p.addClass("hidden");r.find("li").removeClass("selected");k.removeClass("hidden")}function b(){var t=c.$wrapper.find(".js-created-deal"),w=q.find(".js-visible-link .js-text .funnel-state").clone(),x=d.trim(g.val()),y=e.serializeObject();y.message_id=c.message.id;if("none"===u.val())return e.addClass("shake animated"),setTimeout(function(){e.removeClass("shake animated")},500),!1;if(0>=u.val()&&!x)return f.addClass("shake animated"),setTimeout(function(){f.removeClass("shake animated");
g.focus()},500),!1;e.addClass("deal-form-hidden");t.removeClass("hidden");0>=u.val()?(t.html(w),t.append(d.crm.escape(x))):(x=k.find(".js-visible-link .js-text"),w=x.find(".funnel-state").clone(),x=x.find("b i").text(),t.html(w),t.append(d.crm.escape(x)));d.post(d.crm.app_url+"?module=message&action=associateDealSave",y,function(z){if("ok"===z.status&&z.data.deal_url){var B=t.html();t.html('<a href="'+z.data.deal_url+'">'+B+"</a>")}else t.html(""),t.addClass("hidden"),a(),e.removeClass("deal-form-hidden")})}
var c=this,e=c.$wrapper.find(".deal-form"),f=e.find(".js-deal-name"),g=e.find(".js-deal-name-input"),l=e.find(".js-save-deal"),k=e.find(".js-deals-dropdown"),h=e.find(".js-remove-deal"),m=k.find(".js-empty-deal"),n=e.find(".js-select-deal .js-visible-link .js-text"),p=e.find(".js-select-funnel-wrapper"),q=e.find(".js-select-stage-wrapper"),r=e.find(".js-deals-list"),u=e.find(".js-deal-id"),v=c.contact_id;u.val("none");v&&d.get("?module=deal&action=byContact&id="+v,function(t){"ok"===t.status&&d.each(t.data.deals,
function(w,x){r.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+x.id+'"><i class="fas fa-circle funnel-state" style="color: '+t.data.funnels[x.funnel_id].stages[x.stage_id].color+'"></i><span class="js-text">'+x.name+"</span></a></li>")})},"json");e.on("click",".js-create-new-deal",function(){u.val("0");k.addClass("hidden");f.removeClass("c-deal-name-hidden");l.attr("title",c.locales.deal_create).removeClass("hidden");p.removeClass("hidden");m.removeClass("c-empty-deal-hidden");
g.focus()});e.on("click",".js-deal-item",function(){var t=d(this).find(".js-text").html();n.html(t);u.val(d(this).data("deal-id"));l.attr("title",c.locales.deal_add).removeClass("hidden");p.addClass("hidden");m.removeClass("c-empty-deal-hidden");r.find("li").removeClass("selected");d(this).parent().addClass("selected")});r.on("click",function(){r.hide();setTimeout(function(){r.removeAttr("style")},200)});m.on("click",function(){a()});h.on("click",function(){a()});l.on("click",function(t){t.preventDefault();
...
function(a,b){var c=this;a.on("click",".js-message-reply",function(){function e(l){var k=f.find(".icon");if(!k.length)return!1;l?k.removeClass("fa-undo").addClass("fa-spinner fa-spin"):k.removeClass("fa-spinner fa-spin").addClass("fa-undo")}var f=d(this),g=f.data("message-id");e(!0);d.post(c.app_url+"?module=message&action=writeReplyDialog",{id:g},function(l){d.waDialog({html:l,onClose:function(){}})}).always(function(){e(!1)})})};CRMMessageBodyDialog.prototype.initMessageForwardBtn=function(a,b){var c=
this;a.on("click",".js-message-forward",function(){function e(l){var k=f.find(".icon");if(!k.length)return!1;l?k.removeClass("fa-redo").addClass("fa-spinner fa-spin"):k.removeClass("fa-spinner fa-spin").addClass("fa-redo")}var f=d(this),g=f.data("message-id");e(!0);d.post(c.app_url+"?module=message&action=writeForwardDialog",{id:g},function(l){d.waDialog({html:l})}).always(function(){e(!1)})})};CRMMessageDeleteLinkMixin.mixInFor(CRMMessageBodyDialog);return CRMMessageBodyDialog}(jQuery),CRMMessagesSidebar=
...
this.settings=a;this.iframe=a.iframe;this.noemail=a.noemail;this.initClass()};CRMMessagesSidebar.prototype.initClass=function(){var a=this;a.initLazyLoading();a.initSearchHandler();a.conversationListHandler();new CRMPageMessagesOperations(a.settings);a.no_messages&&a.$wrapper.closest("#c-messages-sidebar").addClass("no-messages-sidebar");a.$wrapper.on("click",".js-associate-deal",function(c){c.preventDefault();c=d(this).data("dialog-url");d.get(c,function(e){d.waDialog({html:e})})});var b=!1;a.$wrapper.on("click",
".js-write-message",function(c){c.preventDefault();b||(b=!0,c=d.crm.app_url+"?module=message&action=writeNewDialog",data={contact_id:a.$settings_contact_id?a.$settings_contact_id:null,deal_id:a.$settings_deal_id?a.$settings_deal_id:null},d.get(c,data,function(e){d.waDialog({html:e,onOpen:function(){b=!1}})}))});a.$wrapper.on("click",".js-filter-open",function(){a.$wrapper.find(".c-message-filter-wrapper").toggle()});a.current_page&&a.initBackgroundUpdate()};CRMMessagesSidebar.prototype.initSearchHandler=
function(){var a=this,b=a.$sidebar;a.$search_wrapper=b.find(".js-search-wrapper");var c=a.$search_wrapper;$page_name=b.find(".js-page-name-header");$autocomplete=c.find(".js-search-field");$search_block=c.find(".state-with-inner-icon");a.iframe||($autocomplete.autocomplete({appendTo:c,source:d.crm.app_url+"?module=autocompleteContact",minLength:0,html:!0,focus:function(){return!1},select:function(e,f){d.crm.content.load(d.crm.app_url+"message/?contact="+f.item.id);a.$skeleton.show();$autocomplete.val("");
...
a.initSelectDeal();a.short_link&&a.setLinkWithId();a.initDealActions();a.initChangeResponsible();a.initBackgroundActions();a.initDelete();d(document).ready(function(){function b(){0==f&&a.scroll2bottom(!1,!1)}var c=a.$wrapper[0].getElementsByTagName("img"),e=a.$wrapper[0].getElementsByTagName("video"),f=c.length+e.length;b();for(var g=0;g<e.length;g++)3<=e[g].readyState?(f--,b()):(e[g].addEventListener("loadeddata",function(){f--;b()}),e[g].addEventListener("error",function(){f--;b()}));for(g=0;g<
c.length;g++)c[g].complete?(f--,b()):(c[g].addEventListener("load",function(){f--;b()}),c[g].addEventListener("error",function(){f--;b()}));window.document.documentElement.dispatchEvent(new CustomEvent("wa-gallery-load",{detail:{forceFullPreview:!0}}))});a.initSingleMessage();a.initToggleSidebar();a.initLazyLoading();a.initBlockquotToggle();a.initScrollToBottom();a.initAuxDropdown()};CRMMessageConversationPage.prototype.setLinkWithId=function(){var a=window.location.href;a.slice(-8).includes("message")&&
...
c.conversation_id+"&old_message_id="+c.old_message_id;e=!0;d.ajax({url:n,type:"POST",dataType:"html",beforeSend:function(){l.show();h=f.prop("scrollHeight")},complete:function(){},data:{delay:1},success:function(p){var q=d(p).find(".js-messages-list");p=d(p).find(".js-message-wrapper");var r=p.length;if(r){c.old_message_id=p.eq(0).data("id");10>r&&q.find(".js-lazy-load").remove();q=q.html();g.append(q);u();function u(){var t=g[0].getElementsByTagName("img"),w=t.length;if(0==w)v();else for(var x=0;x<
t.length;x++)t[x].complete?w--:(t[x].addEventListener("load",function(){w--;0==w&&v();window.document.documentElement.dispatchEvent(new CustomEvent("wa-gallery-load",{detail:{forceFullPreview:!0,timeout:500}}))}),t[x].addEventListener("error",function(){w--;0==w&&v()})),0==w&&v()}function v(){m&&m.remove();f.prepend(g.html());c.handleYaMaps(f);c.initBlockquotToggle();g.html("");f.scrollTop(f.prop("scrollHeight")-h);h=f.prop("scrollHeight");l.hide();a()}}else m&&m.remove();c.current_page++;a()}})}
var c=this,e=!1,f=c.$wrapper.find(".js-messages-list"),g=c.$wrapper.find(".c-conversation-body--blank"),l=f.find(".js-messages-list--transparent-layer"),k=f.find(".js-message-wrapper").length,h=c.$wrapper.prop("scrollHeight");c.current_page=1;a();d(document).on("new_message_lazy",m=>{a()})};CRMMessageConversationPage.prototype.initVisiblityWatcher=function(){function a(e){e?(c.addClass("is-extended").trigger("resize"),b.$wrapper.addClass("scroll-lock")):(c.removeClass("is-extended").trigger("resize"),
b.$wrapper.removeClass("scroll-lock"))}var b=this,c=b.$replySection;c.on("click",".js-revert",function(){a(!1)});c.on("click",".js-message-resize",function(){a(!1)});c.on("click",".js-message-resize-open",function(){a(!0)})};CRMMessageConversationPage.prototype.loadDealListByContact=function(a){a=a||function(){};var b=this.contact_id;0>=b||this.iframe?a({}):d.get("?module=deal&action=byContact&id="+b,"json").always(function(c){c&&"ok"===c.status?a(c.data||{}):a({})})};CRMMessageConversationPage.prototype.initSelectDeal=
function(a){function b(){t.html(e.locales.deal_empty);z.val("none");m.val("");h.addClass("c-deal-name-hidden");p.addClass("hidden").removeAttr("title");v.addClass("c-empty-deal-hidden");w.addClass("hidden");y.find("li").removeClass("selected");0<q.data("deals_count")?(q.removeClass("hidden"),r.addClass("hidden")):(q.addClass("hidden"),r.removeClass("hidden"))}function c(){var B=f.find(".js-created-deal"),D=x.find(".js-visible-link .js-text .funnel-state").clone(),A=d.trim(m.val()),C=k.serializeObject();
C.conversation_id=e.conversation_id;if("none"===z.val())return k.addClass("shake animated"),setTimeout(function(){k.removeClass("shake animated")},500),!1;if(0>=z.val()&&!A)return h.addClass("shake animated"),setTimeout(function(){h.removeClass("shake animated");m.focus()},500),!1;k.addClass("deal-form-hidden");B.removeClass("hidden");0>=z.val()?(B.html(D),B.append(d.crm.escape(A))):(A=q.find(".js-visible-link .js-text"),D=A.find(".funnel-state").clone(),A=A.find(".deal-item--name").text(),B.html(D),
B.append(d.crm.escape(A)));d.post(d.crm.app_url+"?module=message&action=conversationAssociateDealSave",C,function(E){"ok"===E.status?(f.closest(".dialog").data("dialog").close(),d.crm.content.reload()):(B.html(""),B.addClass("hidden"),b(),k.removeClass("deal-form-hidden"))})}var e=this;a=a||{};var f=a.$wrapper||e.$wrapper,g=function(B){B=B||{};var D=B.funnels||{},A=0;d.each(B.deals||{},function(C,E){C=y;var F=C.prepend;var G=D[E.funnel_id];if(!E||0>=E.id)E="";else{var H=E.id,I=E.name||"",K="",J="";
G&&G.stages&&G.stages[E.stage_id]&&(K=G.stages[E.stage_id].color||"");d.isEmptyObject(G)&&(J='<span class="hint">'+e.locales.funnel_deleted+"</span>");E='<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+H+'"><span class="flexbox js-text"><i class="fas fa-circle funnel-state custom-mr-4" style="color: '+K+'"></i><span class="deal-item--name" style="word-break: break-word;">'+I+"</span></span>"+J+"</a></li>"}F.call(C,E);A++});l.show();q.data("deals_count",A);0<A?(q.removeClass("hidden"),
r.addClass("hidden")):(r.removeClass("hidden"),q.addClass("hidden"))},l=f.find(".js-deal-selector-control-wrapper"),k=l.find(".deal-form"),h=k.find(".js-deal-name"),m=k.find(".js-deal-name-input"),n=f.closest(".js-conversation-deal-attach-dialog").find(".js-save-button"),p=k.find(".js-save-deal"),q=k.find(".js-deals-dropdown"),r=k.find(".js-create-new-deal-link"),u=k.find(".js-remove-deal"),v=q.find(".js-empty-deal"),t=k.find(".js-select-deal .js-visible-link .js-text"),w=k.find(".js-select-funnel-wrapper"),
x=k.find(".js-select-stage-wrapper"),y=k.find(".js-deals-list"),z=k.find(".js-deal-id");z.val("none");"undefined"===typeof a.data?e.loadDealListByContact(g):g(a.data);k.on("click",".js-create-new-deal",function(){z.val("0");q.addClass("hidden");r.addClass("hidden");h.removeClass("c-deal-name-hidden");p.attr("title",e.locales.deal_create).removeClass("hidden");w.removeClass("hidden");v.removeClass("c-empty-deal-hidden");m.focus();n.addClass("yellow")});k.on("click",".js-deal-item",function(){var B=
d(this).find(".js-text").html();t.html(B);z.val(d(this).data("deal-id"));p.attr("title",e.locales.deal_add).removeClass("hidden");w.addClass("hidden");v.removeClass("c-empty-deal-hidden");y.find("li").removeClass("selected");d(this).parent().addClass("selected");n.addClass("yellow")});y.on("click",function(){y.hide();setTimeout(function(){y.removeAttr("style")},200)});v.on("click",function(){b()});u.on("click",function(){b()});p.on("click",function(B){B.preventDefault();k.trigger("submit")});k.on("submit",
function(B){B.preventDefault();c()});k.on("change",".js-select-deal-funnel",function(){k.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())});return{submit:function(){k.trigger("submit")}}};CRMMessageConversationPage.prototype.initDealActions=function(){function a(f,g){var l=null;f.on("click",".js-detach-deal",function(k){k.preventDefault();d.crm.confirm.show({title:b.locales.deal_detach_title,text:b.locales.deal_detach_text.replace(/%s/,g),button:b.locales.deal_detach_confirm_button,
onConfirm:function(){l&&l.abort();b.loadDealListByContact(function(h){l=d.post(d.crm.app_url+"?module=messageConversationDeal&action=detach",{id:b.conversation_id}).done(function(m){m&&"ok"===m.status&&(d.crm.content.reload(),f.data("dialog").close())}).always(function(){l=null})})}})})}var b=this,c=b.$wrapper,e=c.find(".js-conversation-deal");$deal_second=c.find("#dropdown-c-deal");e.on("click",".js-associate-deal",function(f){f.preventDefault();f=d(this).data("dialog-url");d.get(f,function(g){d.waDialog({html:g})})});
e.on("click",".js-attach-other-deal",function(f){setTimeout(()=>{$deal_second.find(".dropdown-toggle").trigger("click")},50)});$deal_second.on("click",".js-return-back",function(f){setTimeout(()=>{b.$dropdown_name.find(".dropdown-toggle.c-name").trigger("click")},50)});$deal_second.on("click",".js-attach-other-deal",function(f){f.preventDefault();var g=e.find(".js-deal-link").text();b.loadDealListByContact(function(l){d.get(d.crm.app_url+"?module=messageConversationDeal&action=attachDialog",{id:b.conversation_id},
function(k){var h=d(k);d.waDialog({html:h,onOpen:function(){var m=h.find(".js-conversation-deal"),n=b.initSelectDeal({$wrapper:m,data:l});h.find(".js-save-button").on("click",function(){n.submit()});a(h,g)}})})})});$deal_second.on("click",".js-detach-deal",function(f){f.preventDefault();var g=null;f=e.find(".js-deal-link--name").text();d.crm.confirm.show({title:b.locales.deal_detach_title,text:b.locales.deal_detach_text.replace(/%s/,f),button:b.locales.deal_detach_confirm_button,onConfirm:function(){g&&
g.abort();b.loadDealListByContact(function(l){g=d.post(d.crm.app_url+"?module=messageConversationDeal&action=detach",{id:b.conversation_id}).done(function(k){k&&"ok"===k.status&&d.crm.content.reload()}).always(function(){g=null})})}})})};CRMMessageConversationPage.prototype.initChangeResponsible=function(){function a(){e||(e=!0,d.post("?module=message&action=changeConversationUser",{action:"remove",id:c.conversation_id},function(h){"ok"===h.status&&(e=!1)},"json").always(function(){e=!1;d.crm.content.reload()}))}
function b(h,m){function n(w){var x="?module=autocomplete&type=user";x=0<c.funnel_id?x+("&funnel_id="+c.funnel_id):x+("&contact_id="+c.contact_id);w.autocomplete({appendTo:w.parent(),source:x,minLength:0,html:!0,focus:function(){return!1},select:function(y,z){p(z.item.id);w.val("");m.close();d.crm.content.reload();return!1}}).data("ui-autocomplete")._renderItem=function(y,z){var B=d("<li />");B.addClass("ui-menu-item-html").append("<div>"+z.value+"</div>").appendTo(y);z.rights||(B.addClass("is-locked"),
B.on("click",function(D){D.preventDefault();D.stopPropagation()}));return B};w.on("focus",function(){w.data("uiAutocomplete").search(w.val())})}function p(w){e||(e=!0,d.post("?module=message&action=changeConversationUser",{action:"set",id:c.conversation_id,user_contact_id:w},function(x){"ok"===x.status&&(x=d(x.data.html),r.html(x),v.addClass("hidden"),x=r.find(".js-owner-autocomplete"),x.length&&n(x))},"json").always(function(){e=!1}))}function q(){e||(e=!0,d.post("?module=message&action=changeConversationUser",
{action:"remove",id:c.conversation_id},function(w){"ok"===w.status&&(r.html(""),v.removeClass("hidden"),e=!1)},"json").always(function(){e=!1;m.close();d.crm.content.reload()}))}h.on("click",".js-cancel",function(w){w.preventDefault();m.close()});var r=h.find(".js-responsible-wrapper"),u=r.find(".js-owner-autocomplete"),v=h.find(".js-responsible-empty-wrapper"),t=v.find(".js-responsible-empty-autocomplete");t.length&&n(t);u.length&&n(u);v.on("click",".js-set-extended, .js-unset-extended",function(){v.toggleClass("is-extended");
v.hasClass("is-extended")&&t.focus()});r.on("click",".js-show-combobox",function(){r.find(".c-conversation-member").addClass("is-edit");r.find(".js-owner-autocomplete").focus()});r.on("click",".c-conversation-member .profile",function(){m.close()});r.on("click",".js-hide-combobox",function(){r.find(".c-conversation-member").removeClass("is-edit")});r.on("click",".js-remove-owner",function(w){w.preventDefault();w=d.trim(r.find(".c-name").html());d.crm.confirm.show({title:c.locales.remove_owner_title,
text:c.locales.remove_owner_text.replace(/%s/,w),button:c.locales.remove_owner_button,onConfirm:function(){q()}})})}var c=this,e=!1,f=c.$wrapper.find(".js-conversation-contact"),g=c.$wrapper.find(".js-open-responsible-dialog"),l=c.$wrapper.find("#dropdown-c-contact");$responsible_wrapper_dialog=c.$wrapper.find(".js-conversation-responsible-wrapper");html_content=$responsible_wrapper_dialog.html();f.on("click",".js-open-second-menu",function(h){setTimeout(()=>{l.find(".dropdown-toggle").trigger("click")},
50)});l.on("click",".js-return-back",function(h){setTimeout(()=>{c.$dropdown_name.find(".dropdown-toggle.c-name").trigger("click")},50)});l.on("click",".js-remove-owner",function(h){h.preventDefault();h=d.trim($responsible_wrapper_dialog.find(".c-name").html());d.crm.confirm.show({title:c.locales.remove_owner_title,text:c.locales.remove_owner_text.replace(/%s/,h),button:c.locales.remove_owner_button,onConfirm:function(){a()}})});const k=`<div class="dialog dialog-conversation-responsible" id="my-dialog">
        <div class="dialog-background"></div>
        ...
        </div>`;g.on("click",function(){d.waDialog({html:k,onOpen:b})})};CRMMessageConversationPage.prototype.triggerChatUpdate=function(){d(document).trigger("msg_conversation_update")};CRMMessageConversationPage.prototype.initBackgroundActions=function(){function a(l=!1){clearTimeout(g);l?b():g=setTimeout(b,e.check_interval)}function b(){f||(f=!0,d.post("?module=message&action=conversationIdCheck&background_process=1",{id:e.conversation_id},function(l){"ok"===l.status&&(1*l.data!==1*e.last_message_id?
c().then(function(k){k.length&&(e.initBlockquotToggle(),e.scroll2bottom(!0,!0));a()}):a())},"json").always(function(){f=!1}))}function c(){var l=d.Deferred();d.get(location.href,{background_process:1},function(k){function h(q){function r(){q.removeClass("is-new");q.off("hover",r);u.off("unmark-new-messages",r)}var u=d(document);q.addClass("is-new");q.on("hover",r);u.on("unmark-new-messages",r);setTimeout(function(){d.contains(document,q[0])&&r()},1E4)}var m=e.last_message_id,n=e.$wrapper.find(".js-messages-list").first();
k=d(k).find(".js-messages-list .js-message-wrapper");var p=[];n.length&&(k.each(function(){var q=d(this),r=!1,u=q.data("id");q.hasClass("verification_message")&&(r=q.data("verification"));u>e.last_message_id&&(n.append(q),h(q),r&&d(document).trigger("updateProfile",{contact_id:r}),p.push({id:u,$message:q}),m=u)}),e.last_message_id=m,e.handleYaMaps(n),window.document.documentElement.dispatchEvent(new CustomEvent("wa-gallery-load",{detail:{forceFullPreview:!0,timeout:500}})));l.resolve(p)});return l.promise()}
var e=this,f=!1,g=0;d(document).on("wa_before_load",function(){clearTimeout(g);d(document).off("wa_before_load")});d(document).on("msg_conversation_updated",function(){setTimeout(function(){e.initBlockquotToggle();e.scroll2bottom(!0,!0)},500)});d(document).on("msg_conversation_update",function(){c().then(function(l){l.length&&(e.initBlockquotToggle(),e.scroll2bottom(!0,!0));a()})});a()};CRMMessageConversationPage.prototype.initDelete=function(){function a(){var e=b.filter_contact_id?"contact="+b.filter_contact_id:
b.filter_deal_id?"deal="+b.filter_deal_id:null,f=b.iframe?"?iframe=1":"";e=e?(b.iframe?"&":"?")+e:"";var g=b.$wrapper.closest("#c-messages-page").find("#c-messages-sidebar"),l=d.crm.app_url+"message/"+f+e;g.is(":visible")&&(f=g.find(`.c-message-wrapper[data-id='${b.conversation_id}']`).next(".c-message-wrapper"),l=f.length?f.find("a.item").prop("href")+e:l);d.post(d.crm.app_url+"?module=message&action=conversationIdDelete",{id:b.conversation_id},function(k){"ok"===k.status&&d.crm.content.load(l)}).always(function(){c=
...
email:c},function(e){d.waDialog({html:e})}).always(function(){a=!1}))})};CRMMessageConversationPage.prototype.initSingleMessage=function(){var a=!1;this.$wrapper.on("click",".js-open-detail-message",function(b){b.preventDefault();a||(a=!0,b=d(this).data("dialog-url"),d.get(b,function(c){d.waDialog({html:c,onClose:function(){a=!1}})}))})};CRMMessageConversationPage.prototype.initScrollToBottom=function(){function a(){if(d.contains(document,e[0])){var f=c.get(0).scrollHeight-c.scrollTop()-c.height();
50>=f&&e.is(":visible")?e.hide():50<f&&e.is(":hidden")&&e.show()}else c.off("scroll touchmove",a)}var b=this,c=b.$wrapper.find(".js-messages-list"),e=b.$wrapper.find(".js-messages-list--to-bottom-button");c.on("scroll touchmove",a);e.on("click",()=>b.scroll2bottom(!0,!0));d(document).on("scroll_button_event",(f,g)=>{b.old_message_id=g.old_message_id;b.last_message_id=g.last_message_id;b.scroll2bottom(!0,!0)})};CRMMessageConversationPage.prototype.scroll2bottom=function(a,b){function c(){setTimeout(function(){d.contains(document,
f.$wrapper[0])&&l&&e()},0)}function e(){var k=f.$wrapper.find(".js-messages-list"),h=k.height(),m=k.get(0).scrollHeight;0<m?(h<m?b?k.animate({scrollTop:m},500):k.scrollTop(m):f.$wrapper.trigger("bigWindowEvent.lazy"),d.message.content.animate(!1)):setTimeout(()=>e(),100)}var f=this,g=f.iframe?d(top.window):d(window);g.height();var l=!0;if(a)e();else if(d.crm.is_page_loaded||f.iframe)c();else g.one("scroll",function(){l=!1}).one("load",c)};CRMMessageConversationPage.prototype.initToggleSidebar=function(){var a=
this.$wrapper.parent().parent(),b=this.$wrapper.find(".js-expand-sidebar");if(b.length)b.on("click",function(c){c.preventDefault();c=a.prev();if(a.is(":visible")){a.addClass("desktop-and-tablet-only");c.removeClass("desktop-and-tablet-only");c=window.history.state;const e=c.content_uri.replace("?view=chat","").replace("&view=chat","");c.content_uri=e;window.history.replaceState(c,c.title,e)}})};return CRMMessageConversationPage}(jQuery),CRMMessagesProfileAdditional=function(d){CRMMessagesProfileAdditional=
function(a){this.$main_wrapper=a.$wrapper;this.contact_id=a.contact_id;this.$wrapper=this.$main_wrapper.find("#c-messages-info-additional");this.initClass()};CRMMessagesProfileAdditional.prototype.initClass=function(){function a(g){c.$main_wrapper.prepend(`<iframe frameborder="0" src="${d.crm.app_url}frame/contact/${g}" style="width:100%; background-color: var(--background-color);"></iframe>`);c.$main_wrapper.find("iframe").on("load",b)}function b(){var g=d(this),l=g.contents().find("#app");l.length?
(new ResizeObserver(k=>{k=k[0].target.scrollHeight+1;g.css("height",k);300<k&&c.$wrapper.removeClass("hidden")})).observe(l[0]):setTimeout(()=>b(),100);g.on("beforeShowModal",()=>{g.addClass("height-full");c.$main_wrapper.addClass("freeze-sidebar")});g.on("beforeCloseModal",()=>{g.removeClass("height-full");c.$main_wrapper.removeClass("freeze-sidebar")})}var c=this,e=!1,f=d(window).width();if(1024<=f)a(c.contact_id),e=!0;else d(window).on("resize",function(){e||d(this).width()===f||(f=d(this).width(),
1024<=f&&(a(c.contact_id),e=!0))});d(document).on("updateProfile",(g,l)=>{c.$main_wrapper.find("iframe").remove();a(l.contact_id)});c.initTopInfoFields();c.initAdditionalContentLink()};CRMMessagesProfileAdditional.prototype.initTopInfoFields=function(){function a(){var g=d.crm.app_url+"?module=contact&action=tabs&id="+b.contact_id;f=!0;b.item_html={};d.get(g).done(function(l){d.each(l.data.tabs,function(k,h){e.append(`<li class="custom-mb-16 bold">
                    ...
                    <span class="js-drawer-list-link--header" >${h.title}</span>${h.count?`<span class="hint custom-ml-4">${h.count}</span>`:""}</a></li>`);b.item_html[h.app_id]=h.html});d.each(l.data.counters,function(k,h){h.value&&e.find(`.js-drawer-list-counter--${h.name}`).text(h.value)});e.find(".skeleton").hide();b.$main_wrapper.animate({scrollTop:b.$main_wrapper[0].scrollHeight},450)})}var b=this,c=b.$wrapper.find(".js-info-list"),e=b.$wrapper.find(".js-drawer-list"),f=!1;b.$wrapper.on("click",
".js-info-toggle",function(g){g.preventDefault();g=d(this);f||a();g.toggleClass("is-active");c.slideToggle();g.hasClass("is-active")&&b.$main_wrapper.animate({scrollTop:b.$main_wrapper[0].scrollHeight},450)})};CRMMessagesProfileAdditional.prototype.initAdditionalContentLink=function(){function a(e,f,g){function l(){m.append("\n                    <script>\n                    (() => {\n                        setTimeout( function() {\n                            Array.from(document.getElementsByTagName('a')).forEach(l => {\n                                l.setAttribute('target', '_top');\n                            });\n                        }, 200);\n                    })();\n                    \x3c/script>")}
var k=e.contents(),h=k.find("head"),m=k.find("body");k.find("html").attr("data-theme",document.documentElement.getAttribute("data-theme")).addClass("blank");h.append(`<meta charset="utf-8">
                <link rel="icon" href="data:;base64,iVBORw0KGgo=">
                <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta name="viewport" content="viewport-fit=cover, width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
                <link href="${wa_url}wa-content/css/wa/wa-2.0.css" rel="stylesheet" type="text/css">
                <script src="${wa_url}wa-content/js/jquery/jquery-3.6.0.min.js"><\/script>`);m.addClass("blank custom-px-16");f?d.ajax({method:"GET",url:f,dataType:"html",global:!1,cache:!1}).done(function(n){m.html(n);l()}).fail(function(n){n.statusText&&m.html(n.statusText)}).always(function(){e.trigger("load")}):(g?(m.html(b.item_html[g]),l()):m.html("<div>Not found</div>"),e.trigger("load"))}var b=this,c=!1;b.$wrapper.on("click",".js-drawer-list-link",function(e){e.preventDefault();if(!c){c=!0;
var f=d(this).data("dialog-url"),g=d(this).hasClass("additional"),l=d(this).data("id")||null;e=d(this).data("class-name")||"";var k=d(this).find(".js-drawer-list-link--header").text();drawer_html=`<div class=\"drawer crm-help crm-message-additional ${e}\" id=\"\"> <div class=\"drawer-background\"><\/div> <div class=\"drawer-body\"><header class=\"drawer-header\"><h3>${k}<\/h3><\/header><a href=\"#\" class=\"drawer-close js-close-drawer\"><i class=\"fas fa-times\"><\/i><\/a><div class=\"drawer-block\">${'<div class="flexbox middle width-100 height-100 spinner-wrapper"><div class="spinner custom-p-16"></div></div>'}<\/div><\/div><\/div>`;
...
h=k.find("a").length;l.length||l.push({id:!1,name:b.locales.no_segments});d.each(l,function(m,n){m="javascript:void(0);";var p="",q='<span class="hint">'+n.name+"</span>";n.id&&(m=d.crm.app_url+"contact/segment/"+n.id+"/",p=b.icons_array[n.icon]?b.icons_array[n.icon]:b.icons_array.noname,q="<span>"+n.name+"</span>");n='<a href="'+m+'">'+p+q+"</a>";h&&(n=", "+n);k.append(n);h=!0})}var b=this,c=b.$wrapper.find(".crm-contact-assign-segments"),e=d.crm.app_url+"?module=contactOperation&action=addToSegments&is_assign=1",
f=parseInt(b.contact_id)||0;c.click(function(l){l.preventDefault();d.get(e,{contact_ids:[f]},function(k){d.waDialog({html:k,onOpen:function(h){new CRMContactsOperationAddToSegments({$wrapper:h,context:{contact_ids:[f]},is_assign:1})}})})});var g=!1;b.$wrapper.on("click",".js-show-dynamic-segments",function(l){l.preventDefault();var k=d(this);k.find(".icon").removeClass("fa-filter").addClass("fa-spinner fa-spin");g&&g.abort();g=d.post("?module=contact&action=segmentSearch",{id:b.contact_id},function(h){"ok"==
...
a.$wrapper.on("change",a.$sender_email_select,function(b){b.preventDefault();a.$sender_email.val(a.$sender_email_select.val());a.disableResizer(!0)})};CRMEmailConversationEmailSender.prototype.getFilesController=function(){function a(q){q.length&&(d.each(q,function(r,u){r=c.files_storage;var v=r.push,t=d(h);t.find(".js-name").text(u.name);k.prepend(t);f.prop("disabled")&&f.prop("disabled",!1);v.call(r,{$file:t,file:u})}),l.val(""))}function b(q){var r=[];d.each(c.files_storage,function(u,v){q[0]!==
v.$file[0]?r.push(v):q.remove()});c.files_storage=r}var c=this,e=c.$wrapper.find(".js-files-wrapper"),f=c.$wrapper.find(".c-visible .js-save-button");if(!e.length)return!1;var g=c.$wrapper.find(".js-default-drop-area"),l=c.$wrapper.find(".js-drop-field"),k=c.$wrapper.find(".c-upload-list"),h=c.file_template_html,m=d.crm.app_url+"?module=file&action=uploadTmp",n=0,p=0;c.files_storage=[];c.$form.on("click",".js-message-attachment",function(){l.click()});l.on("change",function(q){q.preventDefault();
...
new FormData,C=document.cookie.match(RegExp("(?:^|; )_csrf=([^;]*)"));(C=C?decodeURIComponent(C[1]):"")&&A.append("_csrf",C);q&&q.length&&d.each(q,function(E,F){F.name&&F.value&&A.append(F.name,F.value)});A.append("file_size",t.file.size);A.append("files",t.file);A.append("file_end",1);d.ajax({xhr:function(){var E=new window.XMLHttpRequest;E.upload.addEventListener("progress",function(F){F.lengthComputable&&(F=parseInt(F.loaded/F.total*100),y.css("--progress-value",F),100===F&&(y.css("background",
"transparent"),z.show()))},!1);return E},url:m,data:A,cache:!1,contentType:!1,processData:!1,type:"POST",success:function(E){setTimeout(function(){d.contains(document,x[0])&&(--n,0>=n&&v())},2E3)}}).always(function(){c.is_locked=!1})}var x=t.$file,y=x.find(".js-bar"),z=y.find(".js-progress-success-icon"),B=x.find(".js-status");x.addClass("is-upload");if(c.max_upload_size>t.file.size)w();else{var D=c.$form.find(".js-submit-button");B.addClass("errormsg");x.removeClass("is-upload");c.is_locked=!1;f.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");
D.attr("disabled",!1);c.$textarea_small.attr("disabled",!1);l.prop("disabled",!1);c.$form.find("button").prop("disabled",!1)}}var v=r?r:function(){};c.files_storage.length?(n=c.files_storage.length,d.each(c.files_storage,function(t,w){u(w)})):v()}}};CRMEmailConversationEmailSender.prototype.initWYSIWYG=function(){var a=this,b=a.$textarea;d.crm.initWYSIWYG(b,{maxHeight:50,allowedAttr:[["section","data-role"]],callbacks:{change:function(){a.disableResizer(!0)}}});a.body&&b.redactor("code.set",a.body);
a.$body_redactor_p=a.$wrapper.find(".redactor-layer.redactor-styles.redactor-layer-img-edit section p").eq(0)};CRMEmailConversationEmailSender.prototype.initSave=function(){function a(){k.css("min-height","auto");var q=k[0].scrollHeight;250>q?k.css("min-height",q+"px"):k.css("min-height","250px")}function b(){var q=l.send_action_url,r=d('<div class="spinner custom-ml-16 js-spinner"></div>'),u=l.$wrapper.find(".js-extended-form-actions").find(".js-save-button"),v=l.$form.serializeArray();n.prop("disabled",
!0);k.attr("disabled",!0);u.attr("disabled",!0);r.insertAfter(l.$wrapper.find(".js-extended-form-drop-area"));d.ajax({method:"POST",url:q,data:v,dataType:"json"}).done(function(t){if("ok"==t.status){var w=jQuery.parseJSON(t.data.html);e(t.data.id?t.data.id:t.data.message_id);g();h.attr("disabled",!0);m.attr("disabled",!0);l.body=l.body_old;l.$replySection.find(".js-revert").trigger("click");a();d("#c-messages-page #c-messages-sidebar").length&&d(document).trigger("msg_sidebar_upd_needed");var x=l.$wrapper.find(".redactor-layer.redactor-styles.redactor-layer-img-edit");
t=x.find("blockquote").eq(0);x=x.find("> p").eq(1);var y=d(w).find(".c-message-body").html(),z=d(w).find(".c-contact-link--name").html();w=d(w).find(".c-date.hint").data("time");t.html(y);x.html(`${w}, ${z} ${l.locales.wrote}:`)}else c(t)}).fail(function(t){c(t)}).always(function(){l.is_locked=!1;r.remove();u.removeAttr("disabled")})}function c(q){var r=l.$form.find("#tooltip-error-message"),u=Object.values(q.errors);r.addClass("errormsg");d.each(u,function(v,t){r.append(`<span><i class="fas fa-exclamation-triangle state-error"></i> <span class="small">${t}</span></span>`)});
g();h.attr("disabled",!0);m.attr("disabled",!0);l.body=l.body_old;l.$replySection.find(".js-revert").trigger("click");a();l.is_locked=!1;q.errors&&console.error(q.errors);l.$textarea.on("focus",f);k.on("focus",f);l.$form.on("change",f)}function e(q){var r=p.find("#js-message-conversation-page"),u=r.data("conv-id"),v=r.find(".c-conversation-body--blank");r.find(".js-messages-list--transparent-layer");d.ajax({url:d.crm.app_url+"?module=messageConversationId&id="+u,type:"POST",dataType:"html",beforeSend:function(){},
complete:function(){},data:{delay:1},success:function(t){var w=d(t).find(".js-messages-list");t=d(t).find(".js-message-wrapper");var x=t.eq(0).data("id");if(t=t.length){10>t&&w.find(".js-lazy-load").remove();w=w.html();v.append(w);d(document).trigger("msg_conversation_updated");y();function y(){function z(){0==A&&(l.$message_list.html(v.html()),v.html(""),d(document).trigger("scroll_button_event",{old_message_id:x,last_message_id:q}),d(document).trigger("new_message_lazy"))}var B=v[0].getElementsByTagName("img"),
D=v[0].getElementsByTagName("video"),A=B.length+D.length;z();for(var C=0;C<D.length;C++)3<=D[C].readyState?(A--,z()):(D[C].addEventListener("loadeddata",function(){A--;z()}),D[C].addEventListener("error",function(){A--;z()}));for(C=0;C<B.length;C++)B[C].complete?(A--,z()):(B[C].addEventListener("load",function(){A--;z()}),B[C].addEventListener("error",function(){A--;z()}))}}}})}function f(){l.$form.find("#tooltip-error-message").removeClass("errormsg").html("");k.off("focus",f);l.$textarea.off("focus",
f);l.$form.off("change",f)}function g(){h.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");m.attr("disabled",!1);k.attr("disabled",!1);n.prop("disabled",!1);l.$form.find("button").prop("disabled",!1);k.val("");760<d(window).width()&&k.focus();if(l.files_storage.length){var q=l.$form.find(".c-upload-item");d.each(q,function(r,u){u.remove()});l.files_storage=[]}}var l=this,k=l.$textarea_small,h=l.$wrapper.find(".c-visible .js-save-button"),m=l.$form.find(".js-submit-button"),n=
l.$form.find(".js-drop-field"),p=d(".c-messages-page-content-wrapper");l.$message_list=p.find(".js-messages-list");d(document).on("wa_before_load",function(){d(document).off("wa_before_load")});k.on("keydown",function(q){13!==q.keyCode&&10!==q.keyCode||q.ctrlKey||q.metaKey||q.shiftKey||(q.preventDefault(),""!==k.val()||l.files_storage.length?l.$form.submit():(k.addClass("shake animated"),setTimeout(function(){k.removeClass("shake animated")},500)))});k.on("focus",function(q){l.$replySection.addClass("focused")});
k.on("blur",function(q){l.$replySection.removeClass("focused")});k.on("keyup",function(q){if(13!==q.keyCode&&10!==q.keyCode||!(q.ctrlKey||q.metaKey||q.shiftKey))""!==k.val()||l.files_storage.length?h.prop("disabled")&&h.prop("disabled",!1):h.prop("disabled")||h.prop("disabled",!0);else if(!q.shiftKey){var r=k.val(),u=k.prop("selectionStart");q=r.slice(0,u);r=r.slice(u);k.val(q+"\n"+r)}a();l.$body_redactor_p.html(k.val().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,
"&quot;").replace(/'/g,"&#039;").replace(/\n/g,"<br>"))});l.$form.on("submit",function(q){q.preventDefault();l.is_locked||(l.is_locked=!0,q=d('<span class="icon size-16"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>'),h.find("svg").removeClass("fa-arrow-up").addClass("fa-spinner fa-spin"),m.attr("disabled",!0),q.insertBefore(m),l.$form.find("button").prop("disabled",!0),l.filesController.uploadFiles([{name:"hash",value:l.hash}],b))})};CRMEmailConversationEmailSender.prototype.initPersonalSettingsDialog=
...
function(){function a(){var n=d.trim(k.val()).split(/[,:;]/);if(n[0].length)return d.each(n,function(p,q){p=d.trim(q).split(/\s+/);var r=!1,u=q=null;d.each(p,function(v,t){d.crm.check.email(t)&&!r&&(q=t.replace(/<|>/g,""),r=v)});!1!==r&&p.splice(r,1);u=p.join(" ");q&&u&&c(0,q,u);q&&!u&&b(0,q,q);u&&!q&&(k.addClass("shake animated"),setTimeout(function(){k.removeClass("shake animated")},500));r=!1;u=q=null}),!1}function b(n,p,q){l.children('[data-email="'+p+'"]').length&&"0"!==n||!p.length||(e.$wrapper.find(".email-copy-input-div").before('<div class="email-copy-user" title="'+
...
e.$wrapper.closest(".js-reply-wrapper").trigger("resize")});g.on("click",function(){k.focus()});h.on("click",".email-copy-user",function(){var n=d(this).data("cc-contact-id"),p=d(this).data("cc-email"),q=d(this).html();b(n,p,q)});k.on("focusout",function(n){a()});k.on("keydown",function(n){13==n.keyCode&&(n.preventDefault(),a())});l.on("click",".js-remove-cc",function(n){n.preventDefault();n=d(this).parent(".email-copy-user");var p=n.data("email");n.remove();e.$wrapper.find(".email-copy-text-collapsed").children('[data-email="'+
...
this.hover_class="is-hover";this.files_controller=this.getFilesController();this.is_locked=!1;this.initClass()};CRMImConversationSection.prototype.initClass=function(){this.initSubmit()};CRMImConversationSection.prototype.getFilesController=function(){function a(n){n.length&&(d.each(n,function(p,q){p=c.files_storage;var r=p.push,u=d(l);u.find(".js-name").text(q.name);f.prepend(u);c.$submitButton.prop("disabled")&&c.$submitButton.prop("disabled",!1);r.call(p,{$file:u,file:q})}),g.val(""))}function b(n){var p=
[];d.each(c.files_storage,function(q,r){n[0]!==r.$file[0]?p.push(r):n.remove()});c.files_storage=p}var c=this,e=c.$form.find(".js-default-drop-area"),f=c.$form.find(".js-upload-list"),g=c.$form.find(".js-drop-field"),l=c.file_template_html,k=d.crm.app_url+"?module=file&action=uploadTmp";c.files_storage=[];var h=0,m=0;c.$attachment_icon.on("click",function(){g.click()});g.on("change",function(n){n.preventDefault();a(this.files)});e.on("drop",function(n){n.preventDefault();a(n.originalEvent.dataTransfer.files)});
e.on("dragover",function(n){n.preventDefault();e.addClass(c.hover_class);clearTimeout(m);m=setTimeout(function(){e.removeClass(c.hover_class)},100)});document.onpaste=function(n){a((n.clipboardData||n.originalEvent.clipboardData).files)};c.$wrapper.on("click",".js-file-delete",function(n){n.preventDefault();b(d(this).closest(".c-upload-item"));c.files_storage.length||""!==c.$textarea.val()||c.$submitButton.prop("disabled")||c.$submitButton.prop("disabled",!0)});return{uploadFiles:function(n,p,q){function r(v){function t(){var D=
new FormData,A=document.cookie.match(RegExp("(?:^|; )_csrf=([^;]*)"));(A=A?decodeURIComponent(A[1]):"")&&D.append("_csrf",A);n&&n.length&&d.each(n,function(C,E){E.name&&E.value&&D.append(E.name,E.value)});D.append("file_size",v.file.size);D.append("files",v.file);D.append("file_end",1);d.ajax({xhr:function(){var C=new window.XMLHttpRequest;C.upload.addEventListener("progress",function(E){E.lengthComputable&&(E=parseInt(E.loaded/E.total*100),B.css("--progress-value",E),100===E&&(B.css("background",
"transparent"),z.show()))},!1);return C},url:k,data:D,cache:!1,contentType:!1,processData:!1,type:"POST",success:function(C){setTimeout(function(){d.contains(document,x[0])&&(--h,0>=h&&u())},250)}}).always(function(){is_locked=!1})}var w="image"===v.file.type.split("/")[0]?"image":"file";w=p?w===p:!0;var x=v.$file;x.find(".js-file-delete");var y=x.find(".js-status"),z=x.find(".js-progress-success-icon"),B=x.find(".js-bar");x.addClass("is-upload");c.max_upload_size>v.file.size?w?t():(--h,0>=h&&u()):
(y.addClass("errormsg"),x.removeClass("is-upload"),c.is_locked=!1,c.$submitButton.prop("disabled",!1),c.$submitButton.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up"),c.$textarea.attr("disabled",!1),g.prop("disabled",!1),c.$form.find("button").prop("disabled",!1))}var u=q?q:function(){};c.files_storage.length?(h=c.files_storage.length,d.each(c.files_storage,function(v,t){r(t)})):u()}}};CRMImConversationSection.prototype.initSubmit=function(){function a(){c.css("min-height","auto");
...
!1):e.prop("disabled")||e.prop("disabled",!0);else if(!k.shiftKey){var h=c.val(),m=c.prop("selectionStart");k=h.slice(0,m);h=h.slice(m);c.val(k+"\n"+h)}a()});b.$form.on("submit",function(k){function h(){b.$form.find("#tooltip-error-message").removeClass("errormsg").html("");b.$form.off("change",h);c.off("focus",h)}function m(){e.prop("disabled",!1);e.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");c.attr("disabled",!1);g.prop("disabled",!1);b.$form.find("button").prop("disabled",
...
(e={conversation_ids:c},f="detachDealsFromConversations");var g=d.crm.app_url+"?module=messageOperation&action="+f,l=function(k,h){d.waDialog.confirm({title:`<i class=\"fas fa-exclamation-triangle smaller state-error\"></i> ${k}`,text:d.trim(h),success_button_title:a.locales.detach_button,success_button_class:"danger",cancel_button_title:a.locales.cancel_button,cancel_button_class:"light-gray",onSuccess:function(){d.post(g,e).done(function(m){var n=Object.keys(e)[0];m=m.data[n];m.length&&(m.forEach(function(p){d('.js-message-wrapper[data-id="'+
p+'"]',a.$list).data("has-deal",0).attr("data-has-deal",0);a.no_deal_list.push(p);a.deal_list=a.deal_list.splice(p,1)}),a.no_deal_counter=a.no_deal_list.length,a.deal_counter=a.deal_list.length,a.formBar());m=a.$list.find(".js-message-wrapper.selected").data("id");d.message.content.reload(m)}).fail(function(m){console.error("Detach Deals From Conversations",m)})},onClose:function(m){}})};(function(){if("conversation"===b){var k=d.extend({check:1},e,!0);return d.post(g,k)}return d.Deferred().resolve({})})().done(function(k){l(a.locales.detach_dialog_h2,
...
b.unread_counter=b.unread_list.length};CRMPageMessagesOperations.prototype.deleteConversation=function(){var a=this,b=a.view,c=a.getSelectedIds(),e={message_ids:c},f="delete";"conversation"===b&&(e={conversation_ids:c},f="deleteConversations");var g=d.crm.app_url+"?module=messageOperation&action="+f,l=a.is_admin?`
            <label>
                <span class="wa-checkbox">
...
v){u=n;var t=u.push,w=d(h);w.find(".js-name").text(v.name);k.prepend(w);!e.iframe&&e.dialog.resize();t.call(u,{$file:w,file:v})})}function c(r){var u=[];d.each(n,function(v,t){r[0]!==t.$file[0]?u.push(t):r.remove()});n=u}var e=this,f=e.$wrapper.find(".js-files-wrapper");if(!f.length)return!1;var g=e.$wrapper.find(".js-drop-area"),l=e.$wrapper.find(".js-drop-field"),k=f.find(".c-upload-list"),h=e.file_template_html,m=e.app_url+"?module=file&action=uploadTmp",n=[],p=0,q=0;l.on("change",function(r){r.preventDefault();
...
"")&&E.append("_csrf",F);r&&r.length&&d.each(r,function(G,H){H.name&&H.value&&E.append(H.name,H.value)});E.append("file_size",w.file.size);E.append("files",w.file);E.append("file_end",1);d.ajax({xhr:function(){var G=new window.XMLHttpRequest;G.upload.addEventListener("progress",function(H){H.lengthComputable&&(H=parseInt(H.loaded/H.total*100),z.css("--progress-value",H),100===H&&(z.css("background","transparent"),B.show()))},!1);return G},url:m,data:E,cache:!1,contentType:!1,processData:!1,type:"POST",
success:function(G){setTimeout(function(){d.contains(document,y[0])&&(y.remove(),--p,0>=p&&t())},2E3)}}).always(function(){e.is_locked=!1})}e.is_locked=!0;var y=w.$file,z=y.find(".js-bar"),B=z.find(".js-progress-success-icon"),D=y.find(".js-status");y.addClass("is-upload");if(e.max_upload_size>w.file.size)x();else{D.addClass("errormsg");y.removeClass("is-upload");e.is_locked=!1;D=e.$form.find(".js-submit-button");var A=e.$form.find(".js-drop-field"),C=e.$form.find(".submit-loader");D.attr("disabled",
!1);A.attr("disabled",!1);C.remove();e.$form.find("button").prop("disabled",!1)}}var t=u?u:function(){};n.length?(p=n.length,d.each(n,function(w,x){v(x)})):t()}}};CRMSendEmailDialog.prototype.initWYSIWYG=function(){var b=this,c=b.$textarea,e=0;b.iframe||(b.dialog.onClose=function(){a(c)});b.crm.initWYSIWYG(c,{allowedAttr:[["section","data-role"]],callbacks:{change:function(){var f=b.iframe?0:b.dialog.$block.height();e&&e===f||(e=f,!b.iframe&&b.dialog.resize())}}});b.body&&c.redactor("code.set",b.body)};
CRMSendEmailDialog.prototype.initSendMessage=function(){var b=this,c=b.$wrapper.find(".js-to-email"),e=b.$to_id,f=b.$wrapper.find(".js-to-new-name");b.is_locked=!1;b.$form.on("submit",function(l){l.preventDefault();if(!(0!=e.val()||d.trim(f.val())&&d.trim(c.val())||"new"!=b.action&&"forward"!=b.action))return d(".js-to-input, .js-to-add-name, .js-to-add-email").addClass("shake animated").focus(),setTimeout(function(){d(".js-to-input, .js-to-add-name, .js-to-add-email").removeClass("shake animated").focus()},
500),!1;if(!d.trim(c.val()))return b.$to_input.addClass("shake animated").focus(),setTimeout(function(){b.$to_input.removeClass("shake animated").focus()},500),!1;if(!b.is_locked){b.is_locked=!0;l=b.$form.find(".js-submit-button");var k=b.$form.find(".js-drop-field"),h=d('<div class="spinner custom-ml-16"></div>');l.attr("disabled",!0);b.$footer.append(h);k.attr("disabled",!0);b.$form.find("button").prop("disabled",!0);b.filesController.uploadFiles([{name:"hash",value:b.hash}],g)}});var g=function(){var l=
b.send_action_url,k=b.$form.serializeArray(),h=function(m,n){if(!d.isEmptyObject(m)){m=d.extend(!0,{},m);var p=b.locales.send_error_title||"Send error",q=b.locales.send_error_text||"Can't send email message";q=d(b.error_html).find(".js-error-text").text(q).end();var r=m.common;b.is_admin&&(r?(q.find(".js-technical-info-block.js-known-error").show(),q.find(".js-technical-info-text").text(r)):q.find(".js-technical-info-block.js-unknown-error").show());d.crm.alert.show({title:p,text:q.get(0).outerHTML,
button:b.locales.close||"close",button_class:"red",onOpen:function(u){u.find(".js-technical-info-link").one("click",function(){d(this).remove();u.find(".js-technical-info-text").show()})}});delete m.common;d.isEmptyObject(m)||console.log.error(m)}n&&console.log.error(n)};d.post(l,k,"json").done(function(m){if("ok"===m.status){a(b.$textarea);b.$wrapper.find(".dialog-body").html(b.success_html);!b.iframe&&b.dialog.resize();var n=null;b.iframe||(b.dialog.onClose=function(){n&&clearTimeout(n);n=null;
d.crm?d.crm.content.reload():b.crm.content.reload()});n=setTimeout(function(){b.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):b.dialog.close()},2500)}else!b.iframe&&b.dialog.close(),d.isEmptyObject(m.errors)?h({common:"Send error"},m):h(m.errors)}).always(function(){b.is_locked=!1}).fail(function(m){h({},m);!b.iframe&&b.dialog.close()})}};CRMSendEmailDialog.prototype.initPersonalSettingsDialog=function(){function b(){c.is_locked||(c.is_locked=!0,d.post(c.crm.app_url+
...
b.$sender_email_select,function(c){c.preventDefault();b.$sender_email.val(b.$sender_email_select.val())})};CRMSendEmailDialog.prototype.initEmailTo=function(){function b(){var t=d.trim(l.val()).split(/\s+/),w=!1;d.each(t,function(x,y){d.crm.check.email(y)&&!w&&(g=y.replace(/<|>/g,""),w=x)});!1!==w&&t.splice(w,1);f=t.join(" ");g&&f&&(t='<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b>'+d.crm.escape(f)+'</b> <span style="color: #999;">&lt;'+d.crm.escape(g)+"&gt;</span></span>",
c(0,g,t),h.val(d.crm.escape(f)));if(f&&!g)return t='<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b>'+d.crm.escape(f)+'</b></span> <input class="c-to-input js-to-add-email" type="text" autocomplete="off" placeholder="'+e.locales.type_email+'" style="margin-left: 8px; width: 150px;" />',c(0,null,t),h.val(d.crm.escape(f)),d(".js-to-add-email").focus(),!1;if(g&&!f)return t='<input class="c-to-input js-to-add-name" type="text" autocomplete="off" placeholder="'+e.locales.type_name+
...
k.val(w);m.val(t).trigger("change")}var e=this,f=null,g=null,l=e.$to_input,k=e.$wrapper.find(".js-to-email"),h=e.$wrapper.find(".js-to-new-name"),m=e.$to_id,n=e.$wrapper.find(".js-to-name"),p=e.$wrapper.find(".js-deal-field"),q=e.$wrapper.find(".js-select-funnel"),r=e.$wrapper.find(".js-select-deal .js-visible-link .js-text"),u=e.$wrapper.find(".js-deals-list"),v=e.$wrapper.find(".js-create-new-deal");l.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",appendTo:e.$wrapper,
minLength:0,focus:function(){return!1},select:function(t,w){t=w.item;w=(t.criteria||{}).email||t.email;c(t.id,w,'<i class="icon userpic" style="background-image: url('+t.photo_url+');"></i>'+t.name+' <span style="color: #999;">&lt;'+w+"&gt;</span>");return!1}}).data("ui-autocomplete")._renderItem=function(t,w){return d('<li class="ui-menu-item-html"><div>'+w.value+"</div></li>").appendTo(t)};l.on("focus",function(){l.data("uiAutocomplete").search(l.val())});l.on("keydown",function(t){if(13==t.keyCode)return t.preventDefault(),
l.blur(),!1});l.on("focusout",function(t){t.preventDefault();b();return!1});n.on("click",".js-remove-to-email",function(){d(this).parent(".js-email-to-user").remove();l.removeClass("hidden").focus();p.addClass("hidden");q.addClass("hidden");u.html(v);r.html(""+e.locales.deal_select);k.val("");h.val("");m.val("").trigger("change");g=f=null});e.$wrapper.on("click",".js-edit-recipient",function(){var t=[f,g].join(" ");l.val(d.trim(t)).removeClass("hidden").focus();d(".js-email-to-user").remove();g=f=
null;k.val("");h.val("")});e.$wrapper.on("keydown",".js-to-add-email",function(t){13==t.keyCode&&(t.preventDefault(),d(this).blur())});e.$wrapper.on("focusout",".js-to-add-email",function(){var t=d(".js-to-add-email"),w=d.trim(t.val());w.length&&!0===d.crm.check.email(w)&&(g=w,k.val(d.crm.escape(w)),t.before(d('<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'" style="color: #999;"></span>').text("<"+w+">")).remove())});e.$wrapper.on("keydown",".js-to-add-name",function(t){13==t.keyCode&&
(t.preventDefault(),d(this).blur())});e.$wrapper.on("focusout",".js-to-add-name",function(){var t=d.trim(d(".js-to-add-name").val());t.length&&(f=t,h.val(d.crm.escape(t)),d(".js-to-add-name:first-child").before(d('<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b></b></span>').text(t)).remove())})};CRMSendEmailDialog.prototype.initEmailCopy=function(){function b(){var p=d.trim(h.val()).split(/[,:;]/);if(p[0].length)return d.each(p,function(q,r){q=d.trim(r).split(/\s+/);var u=
...
function(p){p.preventDefault();p=f.$wrapper.find(".js-email-copy-link-icon");g.toggleClass("email-copy-wrapper-block");g.is(":visible")?(p.removeClass("fa-caret-right").addClass("fa-caret-down"),h.focus(),n.removeClass("email-copy-wrapper-collapsed-block")):(p.removeClass("fa-caret-down").addClass("fa-caret-right"),d(".email-copy-text-collapsed").children().length&&n.addClass("email-copy-wrapper-collapsed-block"))});l.on("click",function(){h.focus()});m.on("click",".email-copy-user",function(){var p=
d(this).data("cc-contact-id"),q=d(this).data("cc-email"),r=d(this).html();c(p,q,r)});h.on("focusout",function(p){b()});h.on("keydown",function(p){13==p.keyCode&&(p.preventDefault(),b())});k.on("click",".js-remove-cc",function(p){p.preventDefault();p=d(this).parent(".email-copy-user");var q=p.data("email");p.remove();d(".email-copy-text-collapsed").children('[data-email="'+q+'"]').remove()});h.on("keydown",function(p){if(8==p.keyCode&&0==h.val().length){p=d(".email-copy-text .email-copy-user:last");
var q=p.data("email");p.remove();d(".email-copy-text-collapsed").children('[data-email="'+q+'"]').remove();h.focus()}})};CRMSendEmailDialog.prototype.initSelectDeal=function(){function b(){var n=h.val();k.val("none");n&&d.get("?module=deal&action=byContact&id="+n,function(p){"ok"===p.status&&d.each(p.data.deals,function(q,r){l.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+r.id+'"><span class="js-text flexbox"><i class="fas fa-circle funnel-state" style="color: '+
p.data.funnels[r.funnel_id].stages[r.stage_id].color+'"></i><span class="flexbox">'+r.name+"</span></span></a></li>")})},"json")}var c=this,e=c.$form.find(".js-select-deal .js-visible-link .js-text"),f=c.$form.find(".js-select-funnel"),g=c.$wrapper.find(".js-deal-field"),l=c.$form.find(".js-deals-list"),k=c.$form.find(".js-deal-id"),h=c.$to_id,m=c.$form.find(".js-empty-deal");c.$form.on("click",".js-create-new-deal",function(){var n=d(this).find(".js-text").html();f.removeClass("hidden");m.removeClass("c-empty-deal-hidden");
e.html(n);k.val("0")});m.on("click",function(){d(this).addClass("c-empty-deal-hidden");f.addClass("hidden");l.find("li").removeClass("selected");e.html(c.locales.deal_empty);k.val("none")});c.$form.on("click",".js-deal-item",function(){var n=d(this).find(".js-text").html();l.find("li").removeClass("selected");d(this).parent().addClass("selected");e.html(n);m.removeClass("c-empty-deal-hidden");f.addClass("hidden");k.val(d(this).data("deal-id"))});"reply"==c.action&&b();"new"==c.action&&0<h.val()&&
(b(),g.removeClass("hidden"));h.on("change",b);l.on("click",function(){l.hide();setTimeout(function(){l.removeAttr("style")},200)});c.$form.on("change",".js-select-deal-funnel",function(){c.$form.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};return CRMSendEmailDialog}(jQuery);var CRMSendSmsDialog=function(d){CRMSendSmsDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$textarea=this.$wrapper.find(".js-send-sms-textarea");this.$footer=this.$wrapper.find(".dialog-footer");this.dialog=this.$wrapper.data("dialog");this.success_html=a.success_html;this.error_html=a.error_html;this.hash=a.hash;this.send_action_url=a.send_action_url;var b=!1;window&&window.parent&&window.parent.$&&window.parent.$.crm?b=window.parent.$.crm:window.$&&window.$.crm&&
...
c=a.send_action_url;e=a.$form.serializeArray();var f=function(g){var l=a.locales.send_error_title||"Send error",k=a.locales.send_error_text||"Can't send sms message",h=d(a.error_html).find(".js-error-text").text(k);a.iframe&&a.$wrapper.find(".dialog-body").html(a.error_html).find(".js-error-text").text(k);a.iframe||d.crm.alert.show({title:l,text:h.get(0).outerHTML,button_class:"red"});g&&console.error(g)};d.post(c,e,function(g){if("ok"===g.status){a.$wrapper.find(".dialog-body").html(a.success_html);
!a.iframe&&a.dialog.resize();var l=null,k=a.dialog.onClose;a.dialog.onClose=function(){k();l&&clearTimeout(l);l=null;a.crm.content.reload()};l=setTimeout(function(){a.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):a.dialog.close()},2500)}else!a.iframe&&a.dialog.close(),f(g.errors||{})},"json").always(function(){b=!1}).fail(function(g){!a.iframe&&a.dialog.close();f(g)})}})};return CRMSendSmsDialog}(jQuery);var CRMImSourceMessageDialog=function(d){CRMImSourceMessageDialog=function(a){this.$wrapper=a.$wrapper;this.$button=this.$wrapper.find(".js-reply-button");this.dialog=this.$wrapper.data("dialog");this.send_dialog=null;this.message=a.message||{};this.locales=a.locales||{};var b=!1;window&&window.parent&&window.parent.$&&window.parent.$.crm?b=window.parent.$.crm:window.$&&window.$.crm&&(b=window.$.crm);this.crm=b;this.app_url=a.crm_app_url||this.crm&&this.crm.app_url;this.initClass()};CRMImSourceMessageDialog.prototype.initClass=
function(){this.initMessageDeleteLink();this.initMessageReplyBtn()};CRMImSourceMessageDialog.prototype.initMessageReplyBtn=function(){function a(k){f.append(g);d.post(b.app_url+"?module=message&action=writeReplyDialog",{id:b.message.id},function(h){d.waDialog({html:h,onOpen:function(m,n){b.send_dialog=n;m.find(".js-cancel-dialog").click(function(){b.send_dialog.hide();e.show()});k&&k()},onClose:function(){b.send_dialog=null;b.dialog&&b.dialog.close();b.dialog=null}})})}var b=this,c=b.$wrapper,e=b.dialog,
f=c.find(".js-dialog-footer"),g=d('<span class="icon size-16"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>'),l=c.find(".js-reply-button");l.click(function(){l.attr("disabled",!0);var k=function(){g.remove();l.attr("disabled",!1);e.hide()};b.send_dialog?(b.send_dialog.show(),k()):a(function(){k();var h=b.dialog.onClose;b.dialog.onClose=function(){h.apply(this,arguments);b.dialog=null;b.send_dialog&&b.send_dialog.close();b.send_dialog=null}})})};CRMMessageDeleteLinkMixin.mixInFor(CRMImSourceMessageDialog);
...
function(){var a=this,b=a.$form,c=a.$button;b.on("submit",function(e){function f(k){k&&!d.isEmptyObject(k.errors)?a.showErrors(k.errors):console.error(k?["Server error",k]:"Server error")}e.preventDefault();var g=null,l=d('<span class="icon size-16"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>');c.attr("disabled",!0).after(l);g&&g.abort();g=d.post(a.send_action_url,a.$form.serializeArray()).done(function(k){if("ok"!==k.status)f(k);else{a.$wrapper.find(".dialog-body").html(a.success_html);
a.dialog.resize();var h=null;a.dialog.onClose=function(){h&&clearTimeout(h);h=null;a.crm.content.reload()};h=setTimeout(function(){a.dialog.close()},2500)}}).fail(f).always(function(){c.attr("disabled",!1);l.remove();g=null})});b.on("click",".js-cancel-dialog",function(){a.$wrapper.css({display:"none"})})};CRMImSourceSendMessageDialog.prototype.showErrors=function(a){var b=this.$wrapper;d.each(a,function(c,e){c=b.find('[name="'+c+'"]');e='<span class="errormsg">'+e+"</span>";c.length?(c.addClass("state-error"),
...
function(){var a=this.$wrapper,b=a.find(".crm-delete-link"),c=this.contact_id,e=d.crm.app_url+"?module=contactOperation&action=delete",f=a.find(".crm-contact-operation-delete-checking").clone();b.click(function(g){g.preventDefault();new CRMDialog({html:f.show(),onOpen:function(l){var k=this;l.find(".crm-cancel").click(function(){k.close()});d.get(e,{contact_ids:[c],is_contact_page:1},function(h){new CRMDialog({html:h,onOpen:function(){k.close()}})})}})})};CRMContactPage.prototype.initClassifyAccessLink=
...
var e={company_contact_id:a.contact_id};b&&b.abort();b=d.post(c,e,function(f){new CRMDialog({html:f})})})};CRMContactPage.prototype.initAssignTags=function(){var a=this.$wrapper.find(".crm-contact-assign-tags"),b=d.crm.app_url+"?module=contactOperation&action=assignTags&is_assign=1",c=parseInt(this.contact_id)||0;a.click(function(e){e.preventDefault();d.get(b,{contact_ids:[c]},function(f){new CRMDialog({html:f})})})};CRMContactPage.prototype.initSegments=function(){function a(l){var k=b.$wrapper.find(".js-segment-list"),
h=k.find("a").length;l.length||l.push({id:!1,name:b.locales.no_segments});d.each(l,function(m,n){m="javascript:void(0);";var p="",q='<span class="hint">'+n.name+"</span>";n.id&&(m=d.crm.app_url+"contact/segment/"+n.id+"/",p='<i class="icon16 '+(n.icon?n.icon:"folder-dynamic")+'"></i>',q="<span>"+n.name+"</span>");n='<a href="'+m+'">'+p+q+"</a>";h&&(n=","+n);k.append(n);h=!0})}var b=this,c=b.$wrapper.find(".crm-contact-assign-segments"),e=d.crm.app_url+"?module=contactOperation&action=addToSegments&is_assign=1",
f=parseInt(b.contact_id)||0;c.click(function(l){l.preventDefault();d.get(e,{contact_ids:[f]},function(k){new CRMDialog({html:k,onOpen:function(h){new CRMContactsOperationAddToSegments({$wrapper:h,context:{contact_ids:[f]},is_assign:1})}})})});var g=!1;b.$wrapper.on("click",".js-show-dynamic-segments",function(l){l.preventDefault();var k=d(this);k.find(".icon16").removeClass("folder-dynamic").addClass("loading");g&&g.abort();g=d.post("?module=contact&action=segmentSearch",{id:b.contact_id},function(h){"ok"==
...
g):(k="linear-gradient(to bottom, "+g+" 0%, "+g+" 70%, rgba("+l.join(",")+") 100%)",e.addClass("is-hover").css("background",k)),c.addClass("is-over")):(e.removeAttr("style").removeClass("is-fixed"),c.removeClass("is-over"))}else b.off("scroll",a)}var b=d(window),c=this.$wrapper.find(".js-profile"),e=this.$wrapper.find(".js-short-profile"),f=c.offset(),g=c.css("background-color"),l=g.replace("rgba(","").replace("rgb(","").replace(")","").split(",");l=d.map(l,function(k){return parseInt(k)});3>=l.length?
l.push(0):l[3]=0;e.on("click",".js-short-responsible-link",function(){c.find(".profile-header-links .js-responsible-link").trigger("click")});e.on("click",".js-short-access-link",function(){c.find(".profile-header-links .js-access-link").trigger("click")});e.on("click",".js-short-edit-link",function(){c.find(".profile-header-links .js-edit-link").trigger("click")});e.on("click",".js-short-delete-link",function(){c.find(".profile-header-links .js-delete-link").trigger("click")});b.on("scroll",a)};
...
f.hide();setTimeout(function(){f.removeAttr("style")},200);g=g.data("id");e.val(g).trigger("change");(g=a.funnels[g]||!1)&&b.trigger("changeFunnel",g)});d.crm.renderSVG(b)})();(function(){function c(h){k.html("");d.each(h,function(m,n){m=a.stage_template_html;var p=d("<div />").text(n.name).html();m=m.replace("%id%",n.id).replace("%color%",n.color).replace("%name%",p);n=d(m);k.append(n)});d.crm.renderSVG(f);k.find("li:first-child a").trigger("click")}var e=a.$wrapper.find(".js-funnels-list"),f=a.$wrapper.find(".js-funnel-stages-list"),
g=f.find(".js-visible-link"),l=f.find(".js-field"),k=f.find(".menu-v");k.on("click","a",function(){var h=d(this);g.find(".js-text").html(h.html());k.find(".selected").removeClass("selected");h.closest("li").addClass("selected");k.hide();setTimeout(function(){k.removeAttr("style")},200);h=h.data("id");l.val(h)});e.on("changeFunnel",function(h,m){c(m.stages)})})();(function(){function c(){var l=d.datepicker._defaults.dateFormat,k=!1;try{d.datepicker.parseDate(l,f.val()),k=!0}catch(h){}k?(f.data("last-correct-value",
f.val()),g.data("last-correct-value",g.val())):(f.val(f.data("last-correct-value")||""),g.val(g.data("last-correct-value")||""))}var e=a.$wrapper.find(".js-datepicker-wrapper"),f=e.find(".js-datepicker"),g=e.find('[name="deal[expected_date]"]');f.datepicker({altField:g,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:c});f.on("blur",c);f.on("keydown keypress keyup",function(l){13===l.which&&l.preventDefault()});e.on("click",".js-icon",function(){f.focus()})})();(function(){var c=a.$wrapper.find(".js-contact-block"),
e=c.find(".js-view-toggle"),f=e.find(".is-active");e.on("click",".c-toggle",function(g){g.preventDefault();g=d(this);var l=g.data("id");if(g.hasClass("is-active"))return!1;a.contact_mode=l;f.length&&f.removeClass("is-active");g.addClass("is-active");f=g;c.find(".c-hidden.is-active").removeClass("is-active");c.find(".c-hidden-"+l).addClass("is-active")})})()};CRMNewContactPage.prototype.initCreate=function(){function a(){function g(){var n=e.$wrapper.find(".js-option-field:checked"),p=e.$wrapper.find(".js-vault-toggle"),
q=e.$wrapper.find(".js-owners-list");n.length&&(n=n.val(),"vaults"===n?(p=p.find(".js-field").val(),m.data.push({name:"vault_id",value:p})):"owners"===n&&(p=q.find(".c-owner"),p.length||m.errors.push({name:"owner[autocomplete]"}),p.each(function(){var r=d(this).data("id");0<r&&m.data.push({name:"owners[]",value:r})})))}function l(){var n=e.$segmentsSection.find("form").serializeArray();d.each(n,function(p,q){m.data.push(q)})}function k(){var n=e.$dealSection.find("form").serializeArray(),p=!0;d.each(n,
...
value:x});v="contact[email]["+v+"][ext]";t.attr("name",v);m.data.push({name:v,value:y})}})})();e.$extendedFieldsW.length&&e.is_extended&&h();e.selected_access&&g();e.selected_segments&&l();e.create_deal&&k();return m}function b(g,l){l=l?l:[];g&&(l=g);d.each(l,function(k,h){k=h.value;var m=e.$wrapper.find(':input[name="'+h.name+'"]'),n=d("<div />").addClass("errormsg").text(k);m.length?m.hasClass("error")||(m.parent().append(n),m.addClass("error").one("focus click change",function(){m.removeClass("error");
n.remove()})):e.$errorsSection.append(n)})}function c(g){f||(f=!0,d.post("?module=contact&action=newSave",g,function(l){"ok"===l.status?d.crm.content.load(d.crm.app_url+"contact/"+l.data.contact.id+"/"):b(l.errors)},"json").always(function(){f=!1}))}var e=this,f=!1;e.$wrapper.on("click",".js-submit-form",function(g){g.preventDefault();e.$errorsSection.html("");g=a();g.errors.length?b(!1,g.errors):c(g.data)})};CRMNewContactPage.prototype.initExtendedFields=function(){function a(f){f=f||{};var g=b.$wrapper,
l="c-conditional-field-"+(""+Math.random()).slice(2),k=f.input_name;f.parent_field=f.parent_field||"";f.parent_options=f.parent_options||{};f.index=f.index||0;if(f.parent_field&&!d.isEmptyObject(f.parent_options)){var h=f.parent_field.split(":");if(!(1>=h.length)){h='[name="contact['+h[0]+"]["+f.index+"]["+h[1]+']"]';var m=g.find(h);if(!(0>=m.length)){f.show_empty_option=f.required;var n=f.parent_options,p=g.find(':input[name="'+k+'"]').first();if(!(0>=p.length)){if(p.is("input"))var q=p.next();else q=
...
(q.attr("name",p.attr("name")),p[0].removeAttribute("name"))}else f.hide_unmatched?(r(),p.val(""),p.closest(".field").hide()):p.is(":visible")||(r(),p.val(u))};g.call(m);k=m.closest(".field");k.length?(k.off("."+l),k.on("change."+l,h,g)):(m.off("."+l),m.on("change."+l,g))}}}}}var b=this,c=b.$extendedFieldsW,e=c.find("form");(function(){var f=c.find(".js-dynamic-field-wrapper");f.each(function(){var g=d(this),l=g.find(".js-list"),k=l.find(".c-item")[0].outerHTML;g.on("click",".js-add",function(){l.append(k)});
g.on("click",".js-remove",function(){d(this).closest(".c-item").remove()});l.on("change",".js-ext-toggle",function(){var h=d(this),m=h.closest(".c-item").find(".js-ext-field");"custom"===h.val()?m.attr("disabled",!1).show():m.attr("disabled",!0).hide()})});c.on("prepareSave",function(){f.each(function(){d(this).find(".js-list").find(".c-item").each(function(g){d(this).find("[data-name-pattern]").each(function(){var l=d(this),k=l.data("name-pattern");k&&(k=k.replace("%index%",g),l.attr("name",k))})})})})})();
(function(){function f(g){function l(){h.each(function(){d(this).find(".js-address-wrapper").each(function(n){d(this).find("[data-name-pattern]").each(function(){var p=d(this),q=p.data("name-pattern");if(q&&(q=q.replace("%index%",n),p.attr("name",q),p.is("input"))){var r=p.closest(".js-custom-sub-field-line");r.is('[data-type="Conditional"]')&&(p=r.data("field-id"),r=r.data("subfield-id"),(p=k[p].fields[r])&&a(d.extend(p,{input_name:q,index:n})))}})})})}(function(){g.find(".js-custom-sub-field-line").each(function(){var n=
...
this,c=b.$ownersList.find(".js-autocomplete");c.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user",appendTo:b.$wrapper,minLength:0,focus:function(){return!1},select:function(e,f){e=b.$ownersList.find('.c-owner[data-id="'+f.item.id+'"]');e=e.length?e:void 0;if(!e){f=f.item;e=b.owner_template_html;e=e.replace(/%id%/,f.id);var g=e.replace;var l=f.name;l=d("<div></div>").text(l).html();e=g.call(e,"%name%",l).replace("%photo_url%",f.photo_url);f=d(e);b.$ownersList.append(f);e=f}a(e);c.val("");
...
!1;var l=d('<span class="icon loading"><i class="fas fa-spinner wa-animation-spin"></i></span>');l.appendTo(c.$submitButton.parent());c.$submitButton.attr("disabled",!0);d.post(f,g,function(k){"ok"===k.data.result?d.crm.content.reload().then(function(){c.dialog.close()}):"no_vault_access"===k.data.result&&(d(".no-access-error").html(k.data.message),setTimeout(function(){c.dialog.close()},5E3))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);l.remove();e=!1})}}function b(){var f=
...
!0);d.post(e,f,function(l){"ok"===l.status?d.crm.content.reload().then(function(){c.dialog.close()}):(console.log("Error saving Responsible contact classification: "+arguments[2],arguments),b("Error saving Responsible contact classification: "+arguments[2]))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);g.remove()})}function b(e){e=d('<div class="errormsg" />').text(e);c.$errorsPlace.append(e)}var c=this;c.$wrapper.on("click",".js-clear-responsible",function(e){e.preventDefault();
...
minLength:0,focus:function(){return!1},select:function(f,g){f=b.$responsibleList.find('.c-responsible[data-id="'+g.item.id+'"]');f=f.length?f:void 0;if(!f){g=g.item;f=b.responsible_template_html;f=f.replace(/%id%/,g.id);var l=f.replace;var k=g.name;k=d("<div></div>").text(k).html();f=l.call(f,"%name%",k).replace("%photo_url%",g.photo_url);d("#responsible_id").val(g.id);g=d(f);b.$responsibleList.append(g);d(".js-input").css("display","none");b.$submitButton.attr("disabled",!1);b.toggleButton(!0);f=
g}a(f);b.toggleButton(!0);e.val("");return!1}}).data("ui-autocomplete")._renderItem=function(f,g){var l=d("<li />");l.addClass("ui-menu-item-html").append("<div>"+g.value+"</div>").appendTo(f);g.rights||(l.addClass("is-locked"),l.on("click",function(k){k.preventDefault();k.stopPropagation()}));return l};e.on("focus",function(){e.data("uiAutocomplete").search(e.val())});b.$responsibleList.on("click",".js-delete-responsible",function(){d(this).closest(".c-responsible").remove();d("#responsible_id").val("");
...
a.initChangeOptions();a.initSubmit();a.initAutocomplete();a.initVaultToggle()};CRMContactAccessDialog.prototype.initSubmit=function(){function a(){if(!f){f=!0;e.$errorsPlace.html("");var g=d.crm.app_url+"?module=contact&action=accessSave",l=b();if(!l)return f=!1;var k=d('<span class="icon loading"><i class="fas fa-spinner wa-animation-spin"></i></span>');k.appendTo(e.$submitButton.parent());e.$submitButton.attr("disabled",!0);d.post(g,l,function(h){"ok"===h.status?d.crm.content.reload().then(function(){e.dialog.close()}):
(console.log("Error saving contact access classification: "+arguments[2],arguments),c("Error saving contact access classification: "+arguments[2]))},"json").always(function(){e.$submitButton.attr("disabled",!1);k.remove();e.toggleButton(!1);f=!1})}}function b(){var g=[],l=e.$wrapper.find(".js-option-field:checked");if(l.length){l=l.val();if("vaults"===l){var k=e.$vaultsToggle.find(".js-field").val();g.push({name:"vault_id",value:k})}if("owners"===l){k=e.$ownersList.find(".c-owner");if(!k.length)return c(e.locales.empty_owner),
!1;k.each(function(){var h=d(this).data("id");0<h&&g.push({name:"owners[]",value:h})})}"all"===l&&g.push({name:"vault_id",value:"0"});l=e.$wrapper.find(".js-employees-field");l.length&&"checked"===l.attr("checked")&&g.push({name:"employees",value:"on"});g.push({name:"contact_id",value:e.contact_id})}return g}function c(g){g=d('<div class="errormsg" />').text(g);e.$errorsPlace.append(g)}var e=this,f=!1;e.$form.on("submit",function(g){g.preventDefault();a()})};CRMContactAccessDialog.prototype.initChangeOptions=
...
"?module=autocomplete&type=user",appendTo:b.$wrapper,minLength:0,focus:function(){return!1},select:function(e,f){e=b.$ownersList.find('.c-owner[data-id="'+f.item.id+'"]');e=e.length?e:void 0;if(!e){f=f.item;e=b.owner_template_html;e=e.replace(/%id%/g,f.id);var g=e.replace;var l=f.name;l=d("<div></div>").text(l).html();e=g.call(e,"%name%",l).replace("%photo_url%",f.photo_url);f=d(e);b.$ownersList.append(f);b.dialog.resize();e=f}a(e);b.toggleButton(!0);c.val("");return!1}}).data("ui-autocomplete")._renderItem=
...
this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMContactCreateSettings.prototype.initClass=function(){this.initSave()};CRMContactCreateSettings.prototype.initSave=function(){function a(){var g={data:[],errors:[]},l=e.serializeArray();d.each(l,function(k,h){g.data.push(h)});return g}function b(g){f||(f=!0,d.post("?module=contact&action=createSettingsSave",g,function(l){"ok"===l.status?c.dialog.close():(l=(l=l.errors)?l:[],console.log(l))},"json").always(function(){f=
...
function(){function a(l){function k(m){var n=d('<div class="line errormsg" />').html(m);f.append(n);c.$form.one("submit",function(){n.remove()})}if(l[0])d.each(l,function(m,n){k(n.value)});else{var h=Object.keys(l);d.each(h,function(m,n){k(l[n])})}}function b(l){g||(g=!0,d.post("?module=contact&action=addEmployeeSave",l,function(k){"ok"===k.status?(d.crm.content.reload(),c.dialog.close()):k.errors&&a(k.errors)}).always(function(){g=!1}))}var c=this,e=c.$wrapper.find("#c-contact-add-employee-form"),
f=c.$wrapper.find(".js-errors-place"),g=!1;e.on("submit",function(l){l.preventDefault();l=e.serializeArray();var k=[];k.length?a(k):b(l)})};return CRMContactAddEmployeeDialog}(jQuery),CRMContactUpdateDialog=function(d){CRMContactUpdateDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$dialog=this.$wrapper.data("dialog");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$submitButton=this.$wrapper.find(".js-submit-button");this.initClass()};CRMContactUpdateDialog.prototype.initClass=
function(){this.initAutocomplete();this.initSubmit()};CRMContactUpdateDialog.prototype.initAutocomplete=function(){var a=this,b=a.$wrapper.find(".js-autocomplete-wrapper"),c=b.find(".js-autocomplete"),e=b.find(".js-field"),f=a.$wrapper.find(".js-field-autocomplete");c.autocomplete({appendTo:b,source:d.crm.app_url+"?module=autocomplete",minLength:2,html:!0,focus:function(){return!1},select:function(g,l){g=d("<div />").text(l.item.name).text();c.val(g).blur();e.val(l.item.id).trigger("change");g=f.html;
l=l.item;l=contactHtml=`        
            <div class="c-column c-column-image">
                <a class="flexbox middle" href="${d.crm.app_url}${l.link}" target="_top" data-link="top" >
                    <img src="${l.photo_url}" alt="${l.name}">
                </a>
            </div>
            <div class="c-column middle nowrap">
                <a href="${d.crm.app_url}${l.link}" target="_top" data-link="top" title="${l.name}">${l.name}</a>
            </div>`;g.call(f,l);return!1}}).data("ui-autocomplete")._renderItem=function(g,l){return d("<li />").addClass("ui-menu-item-html").append("<div>"+l.value+"</div>").appendTo(g)};e.on("change",function(){a.$submitButton.attr("disabled",!1)})};CRMContactUpdateDialog.prototype.initSubmit=function(){function a(){var k={data:[],errors:[]},h=f.serializeArray();d.each(h,function(m,n){k.data.push(n)});return k}function b(k){k=k?k:[];d.each(k,function(h,m){h=m.value;var n=f.find('[name="'+m.name+
'"]'),p=d("<span />").addClass("errormsg").text(h);n.length?n.hasClass("error")||(n.parent().append(p),n.addClass("error").one("focus click",function(){n.removeClass("error");p.remove()})):(g.append(p),f.one("submit",function(){p.remove()}))})}function c(k){l||(l=!0,d.post("?module=contact&action=update",k,function(h){"ok"===h.status?(e.$wrapper.find(".js-field-autocomplete").data("success",!0),e.$dialog.close()):b(h.errors)},"json").always(function(){l=!1}))}var e=this,f=e.$form,g=e.$wrapper.find(".js-errors-place"),
l=!1;f.on("submit",function(k){k.preventDefault();k=a();k.errors.length?b(k.errors):c(k.data)})};return CRMContactUpdateDialog}(jQuery),CRMContactAddCompanyContactDialog=function(d){CRMContactAddCompanyContactDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$company_value=this.$wrapper.find(".js-company-value");this.$submit=this.$wrapper.find(".js-submit");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$company_id_input=this.$wrapper.find(".js-company-id");
...
a.$company_name_input.autocomplete({source:function(f,g){d.post("?module=autocomplete&type=company",f,function(l){d.isEmptyObject(l)&&f.term?e.css({color:"#999"}):e.css({color:"#FFF"});g(l)},"json")},minLength:0,focus:function(){return!1},select:function(f,g){a.$company_id_input.val(g.item.id);b.html('<i class="icon userpic size-20" style="background-image: url('+g.item.photo_url+');"></i>').append(d("<span />").text(g.item.name)).removeClass("hidden");a.$company_name_input.addClass("hidden");return!1}}).data("ui-autocomplete")._renderItem=
...
this.initTableSlider();this.initHoverNames();this.initDroppable()};CRMContactsPage.prototype.initEditableName=function(a,b){var c=this.$wrapper.find(".js-name-editable").first();if(!(0>=c.length)){var e=this,f=!1,g=null;new CrmEditable({$wrapper:c,onSave:function(l){var k=l.$field.val();k.length&&l.text!==k?(g&&g.abort(),k={id:b.info.id,name:k},l.$field.attr("disabled",!0),f||=d('<i class="icon16 loading"></i>').css("margin","0 0 0 4px").insertAfter(l.$field),g=d.post(a,k,function(h){h&&h.data&&h.data.segment&&
(l.text=h.data.segment.name,l.$wrapper.text(h.data.segment.name),e.sidebar.updateItem(b,{name:h.data.segment.name}))},"json").always(function(){l.$field.attr("disabled",!1);l.toggle("hide");f.length&&(f.remove(),f=!1)})):(k.length||l.$field.val(l.text),l.toggle("hide"))}})}};CRMContactsPage.prototype.initElastic=function(){var a=this.$wrapper,b=this.$wrapper.find("#js-aside-block"),c=this.$content;new CRMElasticBlock({$wrapper:a,$aside:b,$content:c});new CRMElasticBlock({$wrapper:a,$content:b,$aside:c})};
CRMContactsPage.prototype.initContactsColumnsSection=function(){function a(k){if(d.contains(document,e[0])){var h=e.hasClass("is-active");k=d.contains(e[0],k.target);h&&!k&&c()}else d(document).off("click",a)}function b(k){k.preventDefault();l||(l=!0,k=d.crm.app_url+"?module=contact&action=columns",f.html(g),c(!0),d.post(k,{},function(h){f.html(h)}).always(function(){l=!1}))}function c(k){k?e.addClass("is-active"):e.removeClass("is-active")}var e=this.$wrapper.find(".js-contacts-columns-section"),
...
!1})}var b=this,c=b.$wrapper.find(".js-segment-actions-list"),e=!1,f=!1;c.on("click",".js-show-edit-dialog",function(g){g.preventDefault();f&&f.abort();f=d.post(d.crm.app_url+"?module=contactSegment&action=edit",{id:b.context.info.id},function(l){new CRMDialog({html:l})}).always(function(){f=!1})});c.on("click",".js-show-archive-dialog",function(g){g.preventDefault();if(!e){e=!0;var l=d(this).closest(".crm-segment-archive-li"),k=l.hasClass("archived");l.removeClass("archived not-archived").addClass("loading");
d.post(d.crm.app_url+"?module=contactSegment&action=archive",{id:b.context.info.id,archive:k?0:1},function(){l.addClass(k?"not-archived":"archived")}).always(function(){l.removeClass("loading");e=!1})}});c.on("click",".js-show-delete-confirm",function(){function g(){d.post(d.crm.app_url+"?module=contactSegment&action=delete",{id:b.context.info.id},function(l){"ok"===l.status&&d.crm.content.load(d.crm.app_url+"contact/")}).always(function(){e=!1})}e||(e=!0,d.crm.confirm.show({title:b.locales.delete_segment_title,
...
hash:c,name:a.find(".crm-contact-list-name").text()};d.get(b,c).done(function(e){new CRMDialog({html:e})})})};CRMContactsPage.prototype.initTableSlider=function(){function a(){d.contains(document,g[0])?(q=g.outerWidth(),r=l.outerWidth(),b(),u&&(u=!1,v=0,e(v))):d(window).off("resize",a)}function b(){if(r>q){var t=v+q>=r,w=v+q<r;0<v?t?(n.addClass("is-active"),p.removeClass("is-active")):w&&(n.addClass("is-active"),p.addClass("is-active")):(n.removeClass("is-active"),p.addClass("is-active"))}else n.removeClass("is-active"),
p.removeClass("is-active")}function c(t){var w=q/3;t?(t=v+w,t>r-q&&(t=r-q)):(t=v-w,0>t&&(t=0));v=t;u=!0;e(t);b()}function e(t){var w="-"+t+"px";l.data("isLeftSet",0<t);l.css({"-webkit-transform":"translate("+w+",0)",transform:"translate("+w+",0)"});h.css({"-webkit-transform":"translate("+w+",0)",transform:"translate("+w+",0)"})}var f=this,g=f.$wrapper.find(".js-contacts-section");if(!g.length)return!1;var l=g.find(".js-slider-body"),k=g.find(".js-header-table-wrapper"),h=k.find(".js-header-table"),
m=g.find(".js-arrows-wrapper"),n=m.find(".js-arrow-left"),p=m.find(".js-arrow-right"),q=g.outerWidth(),r=l.outerWidth(),u=!1,v=0;b();(function(){function t(){if(d.contains(document,x[0])){var z=w.scrollTop()>y.top,B=f.$content.height()>w.height();z&&B?(k.css({left:y.left}).width(g.outerWidth()).addClass("is-fixed"),x.addClass("is-fixed")):(k.removeAttr("style").removeClass("is-fixed"),x.removeClass("is-fixed"))}else w.off("scroll",t)}var w=d(window),x=m,y=g.offset();w.on("scroll",t)})();n.on("click",
function(){c(!1)});p.on("click",function(){c(!0)});d(window).on("resize",a)};CRMContactsPage.prototype.initHoverNames=function(){function a(){g=setTimeout(function(){c.removeClass("is-shown").html("")},500)}var b=this.$wrapper.find(".js-contacts-section");if(!b.length)return!1;var c=b.find(".c-hint-wrapper"),e=this.$wrapper.find(".js-contacts-table"),f=e.offset(),g=0;e.on("mouseenter","tr",function(){var l=d(this);if(e.data("isLeftSet")){clearTimeout(g);var k=l.find(".c-name").html();l=l.find("td:first").offset();
c.html(k).css({top:l.top+10-(f.top-28),left:10}).addClass("is-shown")}});e.on("mouseleave","tr",function(){a()});c.on("mouseenter",function(){clearTimeout(g)});c.on("mouseleave",a)};CRMContactsPage.prototype.initDroppable=function(){function a(c,e){d.post(d.crm.app_url+"?module=contactSegment&action=addContactsSave",{id:c,contact_id:e},"json").done(function(f){"ok"===f.status&&f.data.segment&&b.sidebar.updateItem({type:"segment",info:{id:c}},{count:f.data.segment.count})})}var b=this;b.$wrapper.find(".js-sidebar").find(".js-segment-droparea").each(function(){var c=
d(this);c.droppable({tolerance:"pointer",hoverClass:"is-hovered",over:function(e,f){f.draggable.hasClass("ui-draggable")||c.removeClass("is-hovered")},drop:function(e,f){e=d(this).data("id");var g=[],l=f.helper.data("user-id");f=f.helper.data("user-ids");l="undefined"!==typeof l?l+"":null;f="undefined"!==typeof f?f+"":null;l?g.push(l):f&&(0<f.indexOf(",")?g=f.split(","):g.push(f));0<e&&0<g.length&&a(e,g)}})})};return CRMContactsPage}(jQuery),CRMContactsColumnsDialog=function(d){CRMContactsColumnsDialog=
...
function(){function a(l){return l.find("> li").map(function(){var k=parseInt(d(this).data("id"),10);return 0<k?k:!1}).toArray()}function b(l,k){g&&(g.abort(),g=!1);g=d.post(l,k,function(){g=!1})}var c=this,e=d.crm.app_url+"?module=contact&action=sortSave",f,g=!1;c.$segmentsLists.each(function(){var l=d(this),k=l.data("shared")?1:0;!c.is_admin&&k||l.sortable({distance:10,items:"> li:not(.sort-disabled)",axis:"y",delay:200,tolerance:"pointer",start:function(h,m){f=m.item.index()},stop:function(h,m){m.item.removeAttr("style");
f!=m.item.index()&&(h=a(l),b(e,{segments:h,shared:k}))}})})};CRMContactsSidebar.prototype.initAddLink=function(){var a=!1,b=this.$wrapper.find(".js-add-link"),c=b.find(".icon16"),e=c.attr("class");b.on("click",function(){if(!a){a=!0;var f=d.crm.app_url+"?module=contact&action=add";c.attr("class","icon16 loading");d.post(f,{},function(g){new CRMDialog({html:g})}).always(function(){a=!1;c.attr("class",e)})}})};CRMContactsSidebar.prototype.initAddNewSegmentLink=function(){var a=this.$add_new_segment_link;
...
if(e=JSON.parse(e).length)c.text(e),b.removeClass("js-selected-contacts-hidden");b.on("click",function(f){f.preventDefault();f=d.crm.app_url+"?module=contact&action=selected";var g=sessionStorage.getItem("selected_contacts");d.post(f,{selected_ids:g},function(l){l&&(history.pushState(null,null,d.crm.app_url+"contact/selected/"),d(document).find("#c-content-block").html(l),a.initHighlight())})})};CRMContactsSidebar.prototype.initArchivedToggles=function(){this.$wrapper.find(".js-archived-section").each(function(){var a=
...
f=[],g=d.extend({},a.context,!0);g.is_assign=a.is_assign?1:0;var l=function(h){c.hide();b.attr("disabled",!1);a.sidebar&&d.each(h.segments||{},function(m,n){a.sidebar.updateItem({type:"segment",info:{id:n.id}},n)});g.is_assign?d.crm.content.reload():1==f.length?d.crm.content.load(d.crm.app_url+"contact/segment/"+f[0]+"/"):d.crm.content.load(d.crm.app_url)},k=function(h){h=d.extend({offset:h||0},g);d.post(e,h).done(function(m){"ok"==m.status&&(m.data.done?l(m.data):k(m.data.offset||0))})};b.click(function(h){h.preventDefault();
...
function(){var a=this,b=a.$button,c=d.crm.app_url+"?module=contactOperation&action=excludeFromSegmentProcess",e=a.$wrapper.find(".crm-loading"),f=d.extend({},a.context);f.segment_id=a.segment.id;var g=function(l,k){l=d.extend({offset:l||0,process_count:k||0},f);d.post(c,l).done(function(h){"ok"==h.status&&(h.data.done?(h=h.data,e.hide(),b.attr("disabled",!1),a.segment=h.segment,a.sidebar.updateItem({type:"segment",info:{id:a.segment.id}},a.segment),a.dialog.close(),d.crm.content.load(d.crm.app_url+
...
f.text("100%"),k=!0)},p=function(){a.$wrapper.find(".dialog-footer--visible").addClass("hidden");l&&clearTimeout(l);l=setTimeout(p,3200);!g||2<=h||(m.processId=g,d.post(b,m,function(q){h--;if(g&&q.ready){if(a.pid=g,a.pid){l&&clearTimeout(l);g=l=null;q=d.crm.app_url+"?module=contactOperationExport&action=process&processId="+a.pid;var r=a.$download_file_form.find('input[name="_csrf"]').val(),u=a.$download_file_form.find('input[name="file"]').val();d.post(q,{processId:a.pid,_csrf:r,file:u},function(v){v=
JSON.parse(v);a.$download_button.attr("href",d.crm.app_url+"?module=contactOperation&action=download&file="+v.file)});a.$wrapper.find(".dialog-footer--hidden").removeClass("hidden")}}else q.progress&&n(q.progress,!k)},"json"),h++)};a.$wrapper.find(".crm-start-block").hide();a.$wrapper.find(".crm-process-block").show();n(0,!1);d.post(b,m,function(q){q.processId||alert("Error processing request.");g=q.processId;p()},"json");return{cancel:function(){l&&clearTimeout(l);d.post(b,{processId:g,ready:1})}}};
...
function(){var a=this;a.$wrapper.on("change","input",function(){a.toggleButton(!0)});a.initSubmit();a.initAutocomplete()};CRMContactsOperationAssignResponsible.prototype.initSubmit=function(){function a(){if(!e){e=!0;var f=d.crm.app_url+"?module=contactOperation&action=assignResponsibleProcess",g=b();if(!g)return e=!1;var l=d('<i class="icon16 loading" style="vertical-align: middle; margin: 0;"></i>');l.appendTo(c.$submitButton.parent());c.$submitButton.attr("disabled",!0);var k=d("#responsible_id").val(),
h=k?d.crm.app_url+"contact/responsible/"+k+"/":d.crm.app_url+"contact/";d.post(f,g,function(m){"ok"===m.data.result?d.crm.content.reload().then(function(){c.dialog.close();d.crm.content.load(h)}):"no_vault_access"===m.data.result&&(d(".crm-dialog-header h1").html(c.$errorh1),d(".crm-dialog-content p, .js-responsible-list").html(""),d(".crm-dialog-footer").html('<a class="button js-close-dialog" href="javascript:void(0);">'+c.$close_dialog+"</a>"),d(".no-access-error").html(m.data.message),d.each(m.data.users,
function(n,p){d(".no-access-users").append('<a href="'+p.id+'" style="display: block; margin-top: 10px;"><i class="icon16 userpic20" style="background-image: url('+p.photo+');"></i><span>'+p.name+"</span></a>")}))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);l.remove();e=!1})}}function b(){var f=d("#responsible_id").val();return{contact_ids:d("#contact_ids").val(),responsible_id:f}}var c=this,e=!1;c.$form.on("submit",function(f){f.preventDefault();a()})};CRMContactsOperationAssignResponsible.prototype.initAutocomplete=
function(){function a(e){e.addClass("highlighted");setTimeout(function(){e.removeClass("highlighted")},2E3)}var b=this,c=b.$responsibleList.find(".js-autocomplete");c.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user",appendTo:b.$wrapper,minLength:0,focus:function(){return!1},select:function(e,f){e=b.$responsibleList.find('.c-responsible[data-id="'+f.item.id+'"]');e=e.length?e:void 0;if(!e){f=f.item;e=b.responsible_template_html;e=e.replace(/%id%/,f.id);var g=e.replace;var l=f.name;
l=d("<div></div>").text(l).html();e=g.call(e,"%name%",l).replace("%photo_url%",f.photo_url);d("#responsible_id").val(f.id);f=d(e);b.$responsibleList.append(f);d(".js-input").css("display","none");b.$submitButton.attr("disabled",!1);b.toggleButton(!0);e=f}a(e);b.toggleButton(!0);c.val("");return!1}}).data("ui-autocomplete")._renderItem=function(e,f){return d('<li class="ui-menu-item-html"><div>'+f.value+"</div></li>").appendTo(e)};c.on("focus",function(){c.data("uiAutocomplete").search(c.val())});
...
function(){var a=this,b=a.$form,c=b.find(".crm-loading"),e=a.$button;b.submit(function(f){f.preventDefault();a.clearValidateErrors();e.attr("disabled",!0);c.show();d.post(b.attr("action"),b.serialize()).done(function(g){if("ok"!==g.status)e.attr("disabled",!1),c.hide(),a.showValidateErrors(g.errors||{});else if(!a.dialog.options.afterSave||!1!==a.dialog.options.afterSave(g))a:if(g.data.segment){var l="search"==a.segment.type,k="category"===g.data.segment.type?"category":"search",h=g.data.segment.id;
if(0>=a.segment.id){if("search"===k&&!l){d.crm.content.load(d.crm.app_url+"contact/search/segment/"+g.data.segment.id+"/");break a}d.crm.storage.set("crm/create/category",{id:h,timestamp:+new Date})}d.crm.content.load(d.crm.app_url+"contact/segment/"+g.data.segment.id+"/")}})})};CRMContactSegmentEdit.prototype.initDeleteLink=function(){var a=this,b=a.$wrapper.find(".crm-delete-link"),c=null,e=d.crm.app_url+"?module=dialogConfirm",f=null,g=d.crm.app_url+"?module=contactSegment&action=delete";b.click(function(l){l.preventDefault();
c&&c.abort();c=d.post(e,{title:a.messages.delete_confirm_title,text:a.messages.delete_confirm_text,ok_button:a.messages.delete_button}).done(function(k){a.dialog.close();new CRMDialog({html:k,onConfirm:function(){f&&f.abort();f=d.post(g,{id:a.segment.id}).done(function(h){"ok"===h.status&&d.crm.content.load(d.crm.app_url+"contact/")}).always(function(){f=null});return!1}})}).always(function(){c=null})})};return CRMContactSegmentEdit}(jQuery);var CRMContactSegmentAddContacts=function(d){CRMContactSegmentAddContacts=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$button=this.$form.find(".js-submit-button");this.$find_contact=this.$wrapper.find(".js-find-contact");this.$contact_list=this.$wrapper.find(".c-contact-list");this.segment=a.segment||{};this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMContactSegmentAddContacts.prototype.initClass=function(){this.initAutocomplete();this.initDeleteLinks();
...
g.find("li .js-value, li .js-ext").removeAttr("name");var l=e.serializeArray(),k={data:[],errors:[]},h=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],m=!0;d.each(l,function(n,p){k.data.push({name:p.name,value:p.value});0<d.trim(p.value).length&&0<=h.indexOf(p.name)&&(m=!1)});m&&(k.errors.push({name:"contact[firstname]",value:"Name is empty"}),k.errors.push({name:"contact[name]",value:"Name is empty"}));f.find("li").each(function(n){var p=d(this),q=p.find(".js-value");
...
var b=this,c=b.$wrapper.find('.js-toggle-content[data-content="contact"]'),e=c.find("form");(function(){function f(h){d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",h,function(m){"ok"==m.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+"contact/"+m.data.contact.id+"/")):m.errors&&g(m.errors)},"json").always(function(){k=!1})}function g(h){h=h?h:[];d.each(h,function(m,n){m=n.name;n=n.value;"name"===m&&(m="contact[firstname]");var p=e.find('[name="'+m+
'"]'),q=d("<span />").addClass("errormsg").text(n);p.length?p.hasClass("error")||(p.parent().append(q),p.addClass("error").one("focus click",function(){p.removeClass("error");q.remove()})):(l.append(q),e.one("submit",function(){q.remove()}))})}var l=b.$wrapper.find(".js-errors-place"),k=!1;e.on("submit",function(h){h.preventDefault();k||(k=!0,h=a(),h.errors.length?(g(h.errors),k=!1):f(h.data))})})();(function(){c.on("click",".js-extended-form",function(){var f=a(),g=[];g.push("extended=true");d.each(f.data,
function(l,k){(l=d.trim(k.value))&&g.push(k.name+"="+l)});f=d.crm.app_url+"contact/new/?"+g.join("&");d.crm.content.load(f)})})();a()};CRMContactAddDialog.prototype.initCompanyForm=function(){function a(){var f=c.find(".js-phone-list"),g=c.find(".js-email-list");f.find("li .js-value, li .js-ext").removeAttr("name");g.find("li .js-value, li .js-ext").removeAttr("name");var l=e.serializeArray(),k={data:[],errors:[]},h=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],
m=!0;d.each(l,function(n,p){k.data.push({name:p.name,value:p.value});0<d.trim(p.value).length&&0<=h.indexOf(p.name)&&(m=!1)});m&&(k.errors.push({name:"contact[firstname]",value:"Name is empty"}),k.errors.push({name:"contact[name]",value:"Name is empty"}));f.find("li").each(function(n){var p=d(this),q=p.find(".js-value");p=p.find(".js-ext");var r=q.val(),u=p.val();if(r){var v="contact[phone]["+n+"][value]";q.attr("name",v);k.data.push({name:v,value:r});n="contact[phone]["+n+"][ext]";p.attr("name",
...
n||q.is(":visible")||(q=c.find(".js-contact-autocomplete"));var r=d("<span class='c-error' />").addClass("errormsg").text(p);q.length&&!q.hasClass("error")?(q.parent().append(r),q.addClass("error").one("focus click change",function(){q.removeClass("error");r.remove()})):(h.append(r),e.one("submit",function(){remove(r)}))})}function l(m){k||(k=!0,d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",m,function(n){"ok"===n.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+
"contact/"+n.data.contact.id+"/")):n.errors&&g(n.errors)},"json").always(function(){k=!1}))}var k=!1,h=c.find(".js-errors-place");e.on("submit",function(m){m.preventDefault();m=f();m.errors.length?g(errors):l(m.data)})})();(function(){c.on("click",".js-extended-form",function(){var f=a(),g=[];g.push("extended=true");g.push("type=company");d.each(f.data,function(l,k){(l=d.trim(k.value))&&g.push(k.name+"="+l)});f=d.crm.app_url+"contact/new/?"+g.join("&");d.crm.content.load(f)})})()};return CRMContactAddDialog}(jQuery),
...
d('<div class="line errormsg" />').html(k);c.$content.append(h);c.$form.one("submit",function(){h.remove()})}if(f[0])d.each(f,function(k,h){g(h.value)});else{var l=Object.keys(f);d.each(l,function(k,h){g(f[h])})}}function b(f){e||(e=!0,d.post("?module=deal&action=addParticipantSave",f,function(g){"ok"==g.status?(c.dialog.options.onAdd(g.data.html),c.dialog.close()):g.errors&&a(g.errors)}).always(function(){e=!1}))}var c=this,e=!1;c.$form.on("submit",function(f){f.preventDefault();f=c.$form.serializeArray();
...
m.photo_url),e.data("is_company",m.data.is_company),g.val(m.id),b(m.data);else if(0>m.id){g.val("");c.$toggleW.find(".js-show-fio").trigger("click",!0);f.val("");var n=0<=m.name.indexOf("@"),p=!!m.name.match(/^\+?\d/);n?c.$wrapper.find(".js-email-field").val(m.name).trigger("change"):p?c.$wrapper.find(".js-phone-field").val(m.name).trigger("change"):c.$wrapper.find(".js-firstname,.js-name").val(m.name).trigger("change")}}function b(m){d.each(l,function(n,p){n=m[p];var q="phone"===p||"email"===p,r;
if(q){n="";for(r=(m[p]||[]).reverse();""==n&&0<r.length;)n=r.pop();d.isPlainObject(n)&&(n=n.value)}n=d.trim(n||"");""!=n&&(p=q?c.$wrapper.find('[name="contact['+p+'][0][value]"]'):c.$wrapper.find('[name="contact['+p+']"]'),p.val(n))});f.attr("disabled",!0)}var c=this,e=c.$wrapper.find(".js-contact-autocomplete"),f=c.$wrapper.find(".js-field"),g=c.$wrapper.find(".js-contact-id-field"),l=["firstname","company","jobtitle","phone","email"],k="?module=autocomplete&add_new=true&join="+l.join(","),h=!1;
e.autocomplete({appendTo:e.closest(".value"),source:k,minLength:2,html:!0,focus:function(){return!1},select:function(m,n){h=!0;a(n.item);e.blur();return!1},search:function(){g.val("")},open:function(){h=!1},change:function(){h||a({id:-1,name:e.val()})}}).data("ui-autocomplete")._renderItem=function(m,n){return d("<li />").addClass("ui-menu-item-html").append("<div>"+n.value+"</div>").appendTo(m)};e.on("keydown",function(m){13!==m.keyCode&&(f.attr("disabled",!1),f.val(""))})};CRMContactAddForm.prototype.initCompanyAutocomplete=
...
!1;b.$wrapper.find("form").each(function(){a(d(this))});c.on("load",function(){if(!e)return!1;var f=d(this).contents().find("body").html(),g=null;try{g=JSON.parse(f)}catch(l){}g&&g.errors?(b.$wrapper.find(".loading").hide(),alert(g.errors)):d.crm.content.load(d.crm.app_url+"contact/import/upload/")})};CRMContactImportPage.prototype.initViewToggle=function(){var a=this,b=a.$wrapper.find(".js-view-toggle"),c=b.find(".selected").data("content");b.on("click",".c-toggle",function(e){e.preventDefault();
var f=d(this).data("content"),g=f===c;console.log(e.target);if(g)return!1;c=f;a.$wrapper.find(".js-toggle-content.is-active").removeClass("is-active");e=a.$wrapper.find('.js-toggle-content[data-content="'+f+'"]');e.length&&e.addClass("is-active")})};return CRMContactImportPage}(jQuery);var crmContactImportUpload=function(d){var a=function(c){var e=c.$wrapper,f=e.find("form"),g=e.find(".crm-import-upload-table"),l=e.find(".crm-import-upload-button"),k=e.find(".crm-total-count-column .crm-count");this.$wrapper=e;this.$form=f;var h=c.fieldInfo,m=/[\s~!@#\$%\^&\*\(\)_\+\|\\=\-`\{\}:"<>\?\[\];',\.\/]+/g,n=function(u,v){u+=1;v?(g.find("td:nth-child("+u+")").addClass("crm-highlight-cell"),l.attr("disabled",!1)):g.find("td:nth-child("+u+")").removeClass("crm-highlight-cell")};d("select",
...
h[y],B=!1,D=0,A=!1;y.length>w&&!x&&0==v.indexOf(y)&&(D=y.length,B=!0);var C=z.name.toLowerCase().replace(m,"");C&&C.length>w&&0==v.indexOf(C)&&(D=C.length,A=B=!0);if(B){C=B=null;if(z.fields){for(var E in z.fields){if(0<=v.indexOf(E)){B=E;D+=E.length;break}if(0<=v.indexOf(z.fields[E].name.toLowerCase().replace(m,""))){B=E;D+=z.fields[E].name.length;break}}if(!B)continue}if(z.ext)for(var F in z.ext){if(0<=v.indexOf(F)){C=F;break}if(0<=v.indexOf(z.ext[F].toLowerCase().replace(m,""))){C=F;break}}t=y+
(B?":"+B:"")+(C?"."+C:"");w=D;x=A}}t&&w&&(r.eq(u).val(t),n(u,!0),q=!0)});q&&p.call(f.find("input[name='first_line']").attr("checked",!1));this.initCreateDealsSettings();this.initAddToSegments();f.submit(function(u){u.preventDefault();u=e.find(".crm-warning-require-primary-fields").hide();var v=!1;g.find("select").each(function(){var t=d(this).val();if("firstname"==t||"lastname"==t||"company"==t||"email"==t.substr(0,5))return v=!0,!1});v?(e.find(".crm-loading").show(),(new b({$wrapper:e,need_validation:f.find("[name=validate]").is(":checked"),
messages:c.messages||{}})).run()):u.show()})};a.prototype.initCreateDealsSettings=function(){var c=this.$form,e=c.find('[name="create_deals"]'),f=c.find(".crm-deals-settings-wrapper"),g=c.find('[name="deal_funnel_id"]'),l=c.find('[name="deal_stage_id"]');e.click(function(){d(this).is(":checked")?f.show():f.hide()});g.change(function(){l.load("?module=contactImportUpload&action=stagesByFunnel&id="+d(this).val())})};a.prototype.initAddToSegments=function(){var c=this.$form;c.find('[name="add_to_segments"]').click(function(){d(this).is(":checked")?
d.get(d.crm.app_url+"?module=contactOperation&action=AddToSegments",function(e){d.waDialog({html:e,onOpen:function(f){new CRMContactsOperationAddToSegments({$wrapper:f,onSave:function(g,l){var k=l.data("dialog"),h=[],m=[];l=d(".c-segment-item",l);for(var n=0;n<g.segment_ids.length;n+=1){var p=g.segment_ids[n],q=l.filter('[data-id="'+p+'"]');h.push(q.find(".c-name").text());m.push('<input type="hidden" name="segment_id[]" value="'+p+'">')}h="<span>"+h.join(",")+"</span>";m=m.join(" ");d(".c-add-to-segments-names",
c).html(h+m);k.close();return!1}})}})}):d(".c-add-to-segments-names",c).html("")})};var b=function(c){this.$wrapper=c.$wrapper;this.$form=this.$wrapper.find("form");this.processId=null;this.requests=0;this.$loading=this.$wrapper.find(".crm-loading");this.timer=null;this.messages=c.messages||{};this.url=d.crm.app_url+"?module=contact&action=importProcess"+(c.need_validation?"&need_validation=1":"");this.$progress_bar_dialog=this.$wrapper.find(".crm-import-progressbar-dialog");this.$progress_bar=this.$progress_bar_dialog.find(".crm-progressbar")};
...
let l="";l=0<f.rowsRejected?0>=f.rowsAdded?c.messages.no_imported:c.messages.some_imported:c.messages.all_imported;d.waDialog.alert({text:l,button_title:c.messages.button,button_class:"gray",onClose:function(){location.href=0<f.rowsAdded?d.crm.app_url+"contact/import/result/"+f.timeStart+"/":d.crm.app_url+"contact/import/"}})},queue:!1})):g.animate({width:""+Math.round(100*f.done/f.total)+"%"},{duration:500,queue:!1})},"json"),c.requests++)};d.post(c.url,c.$form.serializeArray(),function(f){c.processId=
...
location.href=d.crm.app_url+"?module=contactMergeDuplicates&field="+b+(d.crm.iframe?"&iframe=1":"")})};CRMContactsMergePage.prototype.initAutoMerge=function(){var a=this,b=a.$wrapper,c=a.$merge_field,e=a.$wrapper.find(".crm-auto-merge-duplicates-start-text"),f=a.$wrapper.find(".crm-auto-merge-duplicates-progress"),g=a.$table,l=a.$auto_merge_start_button,k=a.$auto_merge_pause_button,h=a.$auto_merge_resume_button,m=null,n=!1;a.$auto_merge_link.on("click",function(r){r.preventDefault();e.toggle();l.toggle()});
var p=function(r,u){var v=a.messages.progress,t=Math.round(1E3*parseFloat(r/u))/10;r=v.replace(":percentage:",t||0).replace(":count:",r).replace(":total_count:",u);f.find(".crm-text").text(r)},q=function(){var r=c.val(),u=0,v=a.groups_count;k.show();l.hide();h.hide();f.show();b.find(".pager").hide();var t=function(){var D=b.find(".crm-merge.crm-js-partial").length;d.get(d.crm.app_url+"?module=contact&action=mergeDuplicates",{offset:D,field:r,no_js:1}).done(function(A){if(A){A=d("<div>").html(A);var C=
A.find(".crm-duplicates-table tbody").find(".crm-mergeduplicates-row");C.length?(g.find("tbody").append(C),z()):B();A.remove()}else B()})},w=function(D){var A=d.crm.app_url+"?module=contact&action=mergeDuplicatesGetContacts";D.attr("data-field-value");d.get(A,{field:r,value:D.attr("data-field-value"),master_slaves:1},function(C){C&&"ok"===C.status&&!d.isEmptyObject(C.data)?x(D,C.data):(D.addClass("crm-finished"),m.resolve())},"json").fail(function(){m.resolve()})},x=function(D,A){crmContactMerger.merge({master_id:A.master,
slave_ids:A.slaves,onDone:function(C){if(C.result&&C.result.total_count===C.result.merged_count){var E=d.crm.app_url+"contact/"+C.master.id+"/";D.closest("tr").find("td:not(:first)").css({textDecoration:"line-through"}).end().find("td:first").html('<a href="'+E+'" target="_blank">'+d.crm.encodeHTML(C.master.name)+"</a>")}else D.addClass("crm-partial");C=C.message||a.messages.done||"Done";D.closest("td").css({textDecoration:""}).html('<span class="float-right" style="margin-right: 10px;">'+C+"</span>").append(D.hide().addClass("crm-finished"));
m.resolve()},onError:function(){m.resolve()}})},y=function(){n?setTimeout(y,1E3):z()},z=function(){var D=b.find(".crm-merge:not(.crm-finished):first");D.length?(D.parent().find(".crm-loading").css("opacity",1),m=new d.Deferred,m.fail(function(){k.hide();h.show()}),m.done(function(){u+=1;p(u,v);n?y():z()}),w(D)):u<v?t():B()},B=function(){l.hide();h.hide();k.hide();f.hide();a.$wrapper.find(".crm-attention-message").hide();a.$wrapper.find(".crm-done-message").show()};z()};l.click(function(r){r.preventDefault();
q()});h.click(function(r){r.preventDefault();k.show();h.hide();n=!1});k.click(function(r){r.preventDefault();n=!0;k.hide();h.show()});p(0,a.groups_count)};CRMContactsMergePage.prototype.initGroupMergeLinks=function(){let a=(new URLSearchParams(document.location.search)).get("iframe");if(window.parent&&a)this.$table.find(".js-merge-group-link").on("click",function(b){b.preventDefault();window.parent.history&&window.parent.history.pushState?window.parent.history.pushState({reload:!0},"",this.href):
...
","+this.area.top+")")};return a}(jQuery,d3);this.$wrapper.find(".js-svg-bar").each(function(){var b=d(this);new a({$wrapper:b})})};CRMReportPage.prototype.initChart=function(){function a(f,g){function l(k,h,m){var n=k.date.split("-");k=parseInt(n[0]);var p=parseInt(n[1]);n=parseInt(n[2]);k=[k,p,n];"years"===m?(m=k.slice(),m[0]+=h?1:-1):"months"===m?(m=k.slice(),m[1]+=h?1:-1):(m=k.slice(),m[2]+=h?1:-1);m[1]=(10>m[1]?"0":"")+m[1];m[2]=(10>m[2]?"0":"")+m[2];return{date:m.join("-"),value:0}}d.each(f,
function(k){k=f[k];if(1===k.data.length){var h=k.data[0],m=l(h,!1,g),n=l(h,!0,g);console.log(h);console.log(m);console.log(n);h=[m].concat(k.data);h.push(n);k.data=h;console.log(k.data)}});return f}var b=this.$wrapper.find(".js-graph-section");if(!b.length)return!1;var c=function(f){function g(h){function m(w){var x=w.split("-");w=parseInt(x[0]);var y=parseInt(x[1])-1;x=parseInt(x[2]);return new Date(w,y,x)}for(var n=[],p=0;p<h.length;p++){for(var q=h[p].data,r=[],u=0;u<q.length;u++){var v=q[u],t=
parseInt(v.value);r.push({date:m(v.date),value:t})}n.push(r)}return d3.layout.stack().offset("zero").values(function(w){return w}).x(function(w){return w.date}).y(function(w){return w.value})(n)}function l(h,m){m=(m[1]||1)-m[0]+1;for(var n=m/(h-1),p=[],q=0;q<h;q++){var r=10<m?Math.round(q*n):parseInt(q*n*10)/10;p.push(r)}return p}function k(h,m){var n=f(window),p=n.width();n.height();n=m.$hint.outerWidth();var q=m.$hint.outerHeight(),r=m.$wrapper.offset();m=h.pageX;h={left:m-r.left+10,top:h.pageY-
...
""});this.svg.selectAll(".axis .y").call(h);this.renderCharts()};c.prototype.showHint=function(h,m,n){m=this.$hint.find(".js-name");this.$hint.find(".js-date");this.$hint.find(".js-value");n.name&&(m.text(n.name),h=k(h,this),this.$hint.css(h).addClass(this.show_class))};c.prototype.moveHint=function(){if(this.$hint.hasClass(this.show_class)){var h=k(event,this);this.$hint.css(h)}};c.prototype.hideHint=function(){this.$hint.removeAttr("style").removeClass(this.show_class)};return c}(jQuery),e=function(f){function g(k){function h(t){var w=
t.split("-");t=parseInt(w[0]);var x=parseInt(w[1])-1;w=parseInt(w[2]);return new Date(t,x,w)}for(var m=[],n=0;n<k.length;n++){for(var p=k[n].data,q=[],r=0;r<p.length;r++){var u=p[r],v=parseInt(u.value);q.push({date:h(u.date),value:v})}m.push(q)}return d3.layout.stack().offset("zero").values(function(t){return t}).x(function(t){return t.date}).y(function(t){return t.value})(m)}function l(k,h){var m=h[0];h=h[1]||1;m=0<h-m?h-m:1;h=m/(k-1);for(var n=[],p=0;p<k;p++){var q=10<m?Math.round(p*h):parseInt(p*
h*10)/10;q=0<parseInt(q)?parseInt(q):1;n.push(q)}return n}e=function(k){this.$wrapper=k.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=k.data;this.data=g(this.charts);this.color=k.color;this.group_by=k.group_by;this.locales=k.locales;this.margin={top:8,right:10,bottom:4,left:34};var h=this.node;k=this.margin;var m=h.offsetWidth;h=h.offsetHeight;this.area={outer_width:m,outer_height:h,
inner_width:m-k.left-k.right,inner_height:h-k.top-k.bottom};this.column_indent=200<this.data[0].length?2:4;k=this.area.inner_width;m=this.data[0].length;h=null;m+=1;k&&m&&(h=(k-this.column_indent*(m-1))/m,1>h?h=1:20<h&&(h=20));this.column_width=h;this.yDomain=this.xDomain=this.y=this.x=this.defs=this.svg=!1;this.initGraph()};e.prototype.initGraph=function(){var k=this.area;this.initGraphCore();200<this.data[0].length?this.$wrapper.addClass("is-large"):this.$wrapper.removeClass("is-large");this.svg=
this.d3node.append("svg").attr("width",k.outer_width).attr("height",k.outer_height);this.renderBackground();this.renderCharts();this.renderAxis()};e.prototype.initGraphCore=function(){var k=this.data,h=this.area,m=this.x=d3.time.scale().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([0,h.inner_height]);this.yDomain=function(){var n=d3.min(k,function(q){return d3.min(q,function(r){return r.value})});0<n&&(n=0);var p=d3.max(k,function(q){return d3.max(q,function(r){return r.value+r.y0})});
return[n,p]}();this.xDomain=function(){var n=k[0][0].date;var p=k[0][k[0].length-1].date;var q=.05*(p.getTime()-n.getTime());n=new Date(n.getTime()-q);p=new Date(p.getTime()+q);return[n,p]}();m.domain(this.xDomain);h.domain(this.yDomain)};e.prototype.renderAxis=function(){var k=this.x,h=this.y,m=this.svg;d3.svg.axis().scale(k).orient("bottom").ticks(10);k=d3.svg.axis().scale(h).innerTickSize(2).orient("right").tickValues(l(6,this.yDomain)).tickFormat(function(n){return n+""});m.append("g").attr("class",
"axis").append("g").attr("transform","translate(10,"+this.margin.top+")").attr("class","y").call(k)};e.prototype.renderBackground=function(){var k=this.area.inner_width,h=this.area.inner_height,m,n=this.svg.append("g").attr("class","background").attr("transform","translate("+this.margin.left+","+this.margin.top+")");n.append("rect").attr("width",k).attr("height",h);for(m=0;5>=m;m++){var p=1+(h-2)/5*m;n.append("line").attr("x1",1).attr("x2",k).attr("y1",p).attr("y2",p)}};e.prototype.renderCharts=function(){var k=
this,h=k.data;h=k.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+k.margin.left+","+k.margin.top+")");var m=h.selectAll(".rect").data(function(q){return q}),n=!1;if(k.color){var p=f.crm.color(k.color).rgb;p.push(.5);n="rgba("+p.join(",")+")"}m.enter().append("rect").attr("class","rect").on("mouseover",function(q,r,u){k.showHint(d3.event,this,q,k.charts[u])}).on("mousemove",function(){k.moveHint(this)}).on("mouseout",function(){k.hideHint()});
m.transition().duration(1E3).attr("x",function(q,r){return k.x(q.date)-k.column_width/2}).attr("y",function(q){return k.y(q.y0)}).attr("height",function(q){return k.y(q.value)}).style("stroke",function(q,r,u){return k.charts[u].color?"":k.color}).style("fill",function(q,r,u){q=k.charts[u];return q.color?q.color:n}).attr("width",k.column_width);m.exit().remove();h.exit().remove()};e.prototype.update=function(k){this.data=g(this.charts,k);this.column_indent=200<this.data[0].length?2:4;200<this.data[0].length?
this.$wrapper.addClass("is-large"):this.$wrapper.removeClass("is-large");this.initGraphCore();k=d3.svg.axis().scale(this.y).innerTickSize(2).orient("right").tickValues(l(6,this.yDomain)).tickFormat(function(h){return h+""});this.svg.selectAll(".axis .y").call(k);this.renderCharts()};e.prototype.showHint=function(k,h,m,n){var p=this;k=f(h);if(!(0<Math.ceil(k.attr("height"))))return!1;var q=m.date;h=p.$hint.find(".js-name");var r=p.$hint.find(".js-date"),u=p.$hint.find(".js-value");q=function(v,t){var w=
...
this.$wrapper.find(".js-stage-graph-section"),c=a.stages;if(!b.length||!c.length)return!1;var e=[0,2*c.length],f=function(l){f=function(k){this.$wrapper=k.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";console.log(k.data);for(var h=k.data,m=0;m<h.length;m++){var n=h[m];1!==m||n.color||(n.color="#e07d6e")}h=this.charts=h;m=[];for(n=0;n<h.length;n++){for(var p=h[n].data,q=[],r=0;r<p.length;r++){var u=
parseInt(p[r].value);q.push({index:1+2*r,value:u})}m.push(q)}this.data=m;this.color=k.color;this.group_by=k.group_by;this.locales=k.locales;this.margin={top:20,right:0,bottom:0,left:0};m=this.node;k=this.margin;h=m.offsetWidth;m=m.offsetHeight;this.area={outer_width:h,outer_height:m,inner_width:h-k.left-k.right,inner_height:m-k.top-k.bottom};this.column_indent=8;k=this.area.inner_width;h=this.data[0].length;m=null;k&&h&&(m=(k-this.column_indent*(h-1))/h,1>m&&(m=1));this.column_width=m;this.yDomain=
this.xDomain=this.y=this.x=this.defs=this.svg=!1;this.initGraph()};f.prototype.initGraph=function(){var k=this.area;this.initGraphCore();this.svg=this.d3node.append("svg").attr("width",k.outer_width).attr("height",k.outer_height);this.renderCharts()};f.prototype.initGraphCore=function(){var k=this.data,h=this.area,m=this.x=d3.scale.linear().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([0,h.inner_height]);this.yDomain=function(){var n=d3.min(k,function(q){return d3.min(q,function(r){return r.value})});
0<n&&(n=0);var p=d3.max(k,function(q){return d3.max(q,function(r){return r.value})});return[n,p]}();this.xDomain=e;m.domain(this.xDomain);h.domain(this.yDomain)};f.prototype.renderCharts=function(){var k=this,h=k.data;h=k.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+k.margin.left+","+k.margin.top+")");var m=h.selectAll(".rect").data(function(q){return q});m.enter().append("rect").attr("class","rect");m.transition().duration(1E3).attr("x",
function(q,r){return k.x(q.index)-k.column_width/2}).attr("y",function(q){return k.area.inner_height-k.y(q.value)}).attr("height",function(q){return k.y(q.value)}).style("stroke",function(q,r,u){return k.charts[u].color?"":k.color}).style("fill",function(q,r,u){q=k.charts[u];return q.color?q.color:k.color}).attr("width",k.column_width);var n=h.selectAll(".base-text").data(function(q){return q});n.enter().append("text").attr("class","base-text");n.transition().duration(1E3).attr("text-anchor","middle").attr("x",
...
r,u){q="";if(r=k.charts[u].data[r])q=r.over_text;return q});n.exit().remove();p.exit().remove();m.exit().remove();h.exit().remove()};return f}(jQuery),g=function(l){function k(h){for(var m=[],n=0;n<h.length;n++){for(var p=h[n].data,q=[],r=0;r<p.length;r++){var u=parseInt(p[r].value);q.push({index:1+2*r,value:u})}m.push(q)}return d3.layout.stack().offset("zero").values(function(v){return v}).x(function(v){return v.index}).y(function(v){return v.value})(m)}g=function(h){this.$wrapper=h.$wrapper;this.$hint=
this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=h.data;this.data=k(this.charts);this.color=h.color;this.group_by=h.group_by;this.locales=h.locales;this.margin={top:0,right:0,bottom:20,left:0};var m=this.node;h=this.margin;var n=m.offsetWidth;m=m.offsetHeight;this.area={outer_width:n,outer_height:m,inner_width:n-h.left-h.right,inner_height:m-h.top-h.bottom};this.column_indent=8;h=this.area.inner_width;
...
this.ns).val(JSON.stringify({op:"*=",val:b})):this.hidden.attr("name",this.ns).val(b);this.input.val(e);a.data("icon")&&this._addIcon(a.data("icon"))}else this.hidden.attr("name",this.ns);this.input.bind("autocompleteselect",function(g,l){l.item.option&&(l.item.option.selected=!0,d(this).trigger("select",g,{item:l.item.option}));if(l.item.option&&!d(l.item.option).hasClass("value"))if(d(l.item.option).data("period")){var k=c._showPeriodDialog();k.bind("select",function(m,n,p){c._updatePeriodInput(n,
p);c._removeIcon()});k.bind("cancel",function(){c.input.val("");c.hidden.attr("name",c.ns).val("");c.label.text("")})}else(k=d(l.item.option).val())?"value"===c.element.data("pass")?c.hidden.attr("name",c.ns).val(k):c.hidden.attr("name",c.ns+"."+k).val("1"):c.hidden.attr("name",c.ns).val(""),c.input.val(d(l.item.option).text()),c.label.text("="),c._removeIcon();else{k=l.item.value;var h=l.item.text||l.item.name;l.item.option&&(k=d(l.item.option).val());c.hidden.attr("name",c.ns).val(k);c.input.val(h);
c.label.text("=");l.item.icon?c._addIcon(l.item.icon):c._removeIcon()}c.element.trigger("change");c.element.data("readonly")&&setTimeout(function(){c.input.blur()});"function"===typeof c.options.select&&c.options.select.apply(this,[g,l]);return!1}).bind("autocompletechange",function(g,l){c._removeIfInvalid.call(c,g,l)});var f="";this.element.data("readonly")||(this.input.bind("keydown",function(){f=d(this).val()}),this.input.bind("keyup",function(){var g=d(this).val();f!==g&&(c._removeIcon(),g?(c.label.text("\u2248"),
...
typeof c.options.clear&&c.options.clear.apply(this))});this.input.bind("autocompleteopen",function(g,l){var k=c.input.width();c.ul.find("li.ui-menu-item").each(function(){var h=d(this),m=h.find(".count"),n=h.find(".crm-text");m.insertBefore(n);n.width(Math.max(k-m.outerWidth(!0)-30,0)).data("sep")&&h.css({borderTop:"0px solid #ccc"})});c.ul.width(k)});_other_version_||(this.input.bind("autocompleteopen",function(g,l){c.ul.width(c.input.outerWidth(!0)-5);void 0!==c.offset&&void 0!==c.count&&(c.offset<
...
height:c.height})):(c.ul.unbind("scroll."+c.ns),c.ul.css({overflowY:"",overflowX:""})));c.ul.find(".sep").closest("li").addClass("ignore-hover");var k=c.ul.width(),h="scroll"===c.ul.css("overflowY");c.ul.find("li.ui-menu-item").each(function(){var m=d(this);m.find(".sep").length?m.find(".sep").width(h?k-25:k-10):m.find(".crm-text").width(Math.max(k-m.find(".count").outerWidth(!0)-30,0))})}),this.input.bind("autocompleteload",function(g){!c.loading&&c.offset<c.count&&(c.loading=!0,c.input.addClass("ui-autocomplete-loading"),
d.get(c.options.url,{id:c.ns,offset:c.offset,limit:c.limit,term:c.input.val()},function(l){if("ok"===l.status){var k=l.data.values,h=[];c.ul.find(".ui-menu-item").each(function(){h.push(d(this).data("item.autocomplete"))});for(var m=0;m<k.length;m+=1)h.push(c._formItem(k[m]));c.count=l.data.count;c.response(h);c.offset+=k.length;c.offset>=c.count&&c.ul.find(".dummy-end").remove()}c.loading=!1;c.input.removeClass("ui-autocomplete-loading")},"json"))}));this.input.bind("autocompletefocus",function(g,
l){d(this).val(l.item.name);d(this).data("hold",1);return!1});this.input.bind("autocompleteclose",function(g,l){if(13===g.keyCode){var k=d(this);setTimeout(function(){k.data("hold",0)},200)}else d(this).data("hold",0)});this.input.focus(function(){c.arrow.show()}).blur(function(){c.wrapper.data("mouserover")||c.arrow.hide()});this.wrapper.mouseover(function(){d(this).data("mouserover",1);c.arrow.show()}).mouseout(function(){d(this).data("mouserover",0);c.input.is(":focus")||c.arrow.hide()})}},_createShowAllButton:function(){var a=
...
_source:function(a,b){var c=new RegExp(d.ui.autocomplete.escapeRegex(a.term),"i"),e=this;e.response=b;if(_other_version_&&!a.term)b([]);else{var f=function(l,k){_other_version_&&(l.highlight=1);d.get(e.options.url,l,function(h){var m=[],n=0;h&&"ok"===h.status&&(d.isArray(h.data.values)&&h.data.values.length&&(m=h.data.values),h.data.count&&(n=h.data.count));h=0;for(var p=m.length;h<p;h+=1)m[h]=e._formItem(d.extend(m[h],{option:null}));e.offset=m.length;e.count=n;b(m)},"json")};if(_other_version_)a.term?
f({term:a.term,id:this.ns}):b(this.element.children("option").map(function(){var l=d(this),k=l.html();if(l.hasClass("sep"))return d.extend({},sep,{option:this});if(this.value&&(!a.term||c.test(k))){var h=k;l.data("icon")&&(h+=' <img src="'+l.data("icon")+'" />');d.isNumeric(l.data("count"))&&(h+='<span class="count">'+l.data("count")+"</span>");return{label:h,text:k,value:this.value,option:this}}}).toArray());else if(a.term&&this.element.data("autocomplete"))f({term:a.term,id:this.ns},function(l){e.ul.height(e.h*
l.length);return l});else{var g=this.element.children("option").map(function(){var l=d(this),k=l.html();if(l.hasClass("sep"))return d.extend({},sep,{option:this});if(this.value&&(!a.term||c.test(k))){var h=k;l.data("icon")&&(h+=' <img src="'+l.data("icon")+'" />');d.isNumeric(l.data("count"))&&(h+='<span class="count">'+l.data("count")+"</span>");return{label:h,text:k,value:this.value,option:this}}}).toArray();this.element.data("autocomplete")?f({term:"",id:this.ns},function(l){l.length&&g[g.length-
1]&&!d(g[g.length-1].option).hasClass("sep")&&g.push(sep);g=g.concat(l);e.ul.height(e.h*g.length);return g}):b(g)}}},_removeIfInvalid:function(a,b){if(!b.item){a=this.input;var c=a.val().toLowerCase(),e=!1;this.element.children("option").each(function(){if(d(this).text().toLowerCase()===c)return this.selected=e=!0,!1});e||((b=a.data("uiAutocomplete"))||(b=a.date("autocomplete")),b&&(b.term=""))}},_updatePeriodInput:function(a,b){this.label.text("");this.hidden.attr("name",this.ns+".period").val("");
...
new Date(b)),op:"<="})),this.label.text("<="))},_renderItem:function(a,b){return d("<li class='crm-search-ui-menu-item'>").append(d("<div>").text(b.label)).appendTo(a)},_showPeriodDialog:function(){d("#c-combobox-dialog").remove();return d('<div id="c-combobox-dialog"></div>').appendTo("body").periodDialog()},_destroy:function(){this.wrapper.remove();this.element.show()}})})(jQuery);(function(d){d.fn.periodDialog=function(a,b){function c(k){var h=g().find(".datepicker.start");h=new Date(h.datepicker("getDate"));return d.datepicker.formatDate(k,h)}function e(k){var h=g().find(".datepicker.end");h=new Date(h.datepicker("getDate"));return d.datepicker.formatDate(k,h)}function f(k,h,m){return d.datepicker.formatDate(k,new Date(h),m)}function g(){return this.data("$dialog")}if(!this.length)return this;if("getStartDate"===a)return c();if("getEndDate"===a)return e();if("formatDate"===
a)return f.apply(this,Array.prototype.slice.call(arguments,1));var l={};"object"===typeof a&&(this.data("periodDialogOptions",d.extend({start_datetime:null,end_datetime:null},a)),l=this.data("periodDialogOptions"));return function(){var k=d(".crm-dialog-search-period-wrapper.is-template").clone(),h="crm-dialog-search-period-wrapper-"+(Math.random()+"").slice(2);d(".crm-dialog-search-period-wrapper:not(.is-template)").remove();k.removeClass("is-template");k.attr("id",h);k.show();d.waDialog({html:k,
onOpen:function(m,n){m.find(".datepicker").datepicker();l.start_datetime&&m.find(".datepicker.start").datepicker("setDate",d.datepicker.parseDate("yy-mm-dd",l.start_datetime));l.end_datetime&&m.find(".datepicker.end").datepicker("setDate",d.datepicker.parseDate("yy-mm-dd",l.end_datetime));var p=m.find(".js-apply-action"),q=m.find(".js-cancel-action");p.click(function(r){r.preventDefault();r=m.find(".start").datepicker("getDate");var u=m.find(".end").datepicker("getDate");m.trigger("select",[r,u]);
...
(function(){function f(){d.contains(document,a[0])?g():l.off("resize",f)}function g(){var h=a.outerWidth(!0)-k-38;b.css("max-width",h+"px")}var l=d(window),k=a.find(".c-add-wrapper").outerWidth(!0);g();l.on("resize",f)})();d.crm.tabSlider({$wrapper:b,$slider:c,$activeSlide:e.length?e:!1});(function(){function f(){var l={ids:function(){var k=[];c.find(".c-company").each(function(){k.push(d(this).data("id"))});return k.join(",")}()};g&&g.abort();g=d.post("?module=settings&action=companiesSortSave",
l,function(k){}).always(function(){g=!1})}var g=!1;c.sortable({distance:10,items:"> li",axis:"x",start:function(l,k){},stop:f,onUpdate:f})})()};CRMSettingsCompanies.prototype.initTaxActions=function(){var a=this,b=a.$company.find(".js-tax-name"),c=a.$taxList;a.$company.on("click",".js-delete-option",function(e){e.preventDefault();d(this).closest("li").remove();b.find("li").length||b.attr("required",!1);a.toggleButton(!0)});a.$company.on("click",".js-add-option",function(e){e.preventDefault();d(a.tax_option_template).appendTo(c);
...
b.logo=h}}var b=this,c=!1,e=!1,f=b.$logoWrapper,g=f.find(".js-drop-area"),l=g.find(".js-field"),k=f.find(".js-image");g.on("drop",function(h){h.stopPropagation();h=h.originalEvent.dataTransfer.files;h.length&&(a(h),b.toggleButton(!0))});l.on("change",function(){var h=this.files;h.length&&(a(h),b.toggleButton(!0))});f.on("click",".js-delete-logo",function(h){h.preventDefault();k.attr("src","");if(h=l.attr("name")){var m=d('<input type="hidden" />').attr("name",h).val("delete");l.attr("name","").data("name",
...
100)})};CRMSettingsCompanies.prototype.initSubmit=function(){var a=this,b=a.$wrapper.find(".js-form"),c=a.$wrapper.find(".js-errors-place"),e=a.$taxList,f=!1;b.on("submit",function(g){function l(){e.find(".c-tax-option").each(function(m){var n=d(this),p=n.find(".js-type");n=n.find(".js-percent");p.attr("name","company[tax_options]["+m+"][tax_type]");n.attr("name","company[tax_options]["+m+"][tax_percent]")});return b.serializeArray()}function k(m){m=m?m:[];d.each(m,function(n,p){n=p.name;p=p.value;
var q=a.$wrapper.find('[name="'+n+'"]');q.removeClass("error");q.parent().find("span.errormsg").remove();"contact[firstname]"!==n||q.is(":visible")||(q=a.$wrapper.find(".js-contact-autocomplete"));var r=d("<span class='c-error' />").addClass("errormsg").text(p);q.length&&!q.hasClass("error")?(q.parent().append(r),q.addClass("error").one("focus click change",function(){q.removeClass("error");r.remove()})):(c.append(r),b.one("submit",function(){remove(r)}))})}g.preventDefault();if(!f){f=!0;g=l();g=
m(g);var h=d(a.locales.loading);h.insertAfter(a.$submitButton);d.ajax({url:"?module=settings&action=companiesSave",data:g,dataType:"json",processData:!1,contentType:!1,type:"POST",success:function(n){"ok"===n.status?(d(a.locales.saved_html).insertAfter(a.$submitButton),a.company_id?d.crm.content.reload():d.crm.content.load(d.crm.app_url+"settings/companies/"+n.data.id+"/")):n.errors&&k(n.errors)}}).always(function(){h.remove();f=!1});function m(n){var p=new FormData;d.each(n,function(q,r){p.append(r.name,
...
{code:l},function(k){"ok"==k.status&&(a.$currencySelect.trigger("removeCurrency",l),f.remove())}).always(function(){b=!1}))}c.preventDefault();var f=d(this).closest(".c-currency"),g=f.data("title"),l=f.data("code");if(!l)return!1;(function(){b||(b=!0,d.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+a.locales.confirm_delete_title.replace("%currency_name",g),text:a.locales.confirm_delete_text,success_button_title:a.locales.confirm_delete_button,success_button_class:"danger",
...
f=this.$wrapper.find(".c-color-section .js-color-field"),g=this.$wrapper.find(".c-color-section .c-stages"),l=e.find(".is-active"),k=function(h){k=function(m){this.$wrapper=m.$wrapper;this.$field=f;this.$icon=this.$wrapper.find(".js-toggle");this.$colorPicker=this.$wrapper.find(".js-color-picker");this.farbtastic=this.is_opened=!1;this.initClass()};k.prototype.initClass=function(){function m(){l.length&&(l.removeClass("is-active"),l=!1)}var n=this;n.farbtastic=h.farbtastic(n.$colorPicker,function(p){n.$field.val()!==
p&&(m(),n.$field.val(p).change())});n.$wrapper.data("colorPicker",n);n.$field.on("change keyup",function(){var p=h(this).val();n.$icon.css("background-color",p);n.farbtastic.setColor(p)});n.$icon.on("click",function(p){p.preventDefault();n.displayToggle(!n.is_opened)});n.$field.on("click",function(){n.displayToggle(!n.is_opened)});n.$field.on("keyup",m)};k.prototype.displayToggle=function(m){m?(this.$wrapper.removeClass("is-hidden"),this.is_opened=!0):(this.$wrapper.addClass("is-hidden"),this.is_opened=
!1)};return k}(jQuery);e.on("click",".js-set-color",function(h){h.preventDefault();h=d(this);l.length&&l.removeClass("is-active");h.addClass("is-active");l=h;h=h.data("color");f.val(h).change()});f.on("change",function(){a(f.val())});new k({$wrapper:this.$wrapper.find(".js-toggle-wrapper").first()});f.change();d.crm.renderSVG(this.$wrapper)};CRMSettingsFunnel.prototype.initStagesSection=function(){function a(f){function g(l){function k(){var q=parseInt(m.val()),r=parseInt(p.val()),u="";0<q&&0<r&&
(u=q*r);n.val(u)}function h(q){q?(l.addClass("is-extended"),m.focus()):(l.removeClass("is-extended"),m.val(""),n.val(""),b.toggleButton(!0))}var m=l.find(".js-visible-time-field"),n=l.find(".js-hidden-time-field"),p=l.find(".js-time-period-select");l.on("click",".js-show-time",function(){h(!0)});l.on("click",".js-remove-limit",function(){h(!1)});m.on("change",k);p.on("change",k);m.on("keyup",function(){var q=d(this),r=q.val();r=parseInt(r.replace(",","").replace(".",""));isNaN(r)?q.val(""):r?q.val(r):
...
f=d(b.stage_html);b.$stages.append(f);a(f);b.toggleButton(!0)});e.sortable({distance:10,handle:".js-sort-toggle",helper:"clone",items:"> li",axis:"y",start:function(f,g){},stop:function(f,g){b.toggleButton(!0)}});a(e)};CRMSettingsFunnel.prototype.initSave=function(){function a(){var k=c.$form.serializeArray();c.$stages.find("li").each(function(h){var m=d(this),n=m.data("id");k.push({name:"stages["+h+"][name]",value:m.find(".js-name-field").val()});n&&k.push({name:"stages["+h+"][id]",value:n})});return k}
function b(k){f.insertAfter(l);d.post("?module=settings&action=funnelSave",k,function(h){"ok"===h.status&&(f.remove(),g.insertAfter(l),d.crm.content.load(d.crm.app_url+"settings/funnels/"+h.data.id+"/"))},"json").always(function(){e=!1})}var c=this,e=!1,f=d('<span class="c-notice"><i class="fas fa-spinner wa-animation-spin speed-1000 js-loading"></i></span>'),g=d('<span class="c-notice"><i class="fas fa-check"></i></span>'),l=c.$wrapper.find(".js-funnel-save-button");c.$form.on("submit",function(k){k.preventDefault();
!e&&(k=a())&&(e=!0,b(k))})};CRMSettingsFunnel.prototype.initDelete=function(){function a(){var e={id:b.funnel_id};c||(c=!0,d.post("?module=settings&action=funnelDelete",e,function(f){d.crm.content.load(d.crm.app_url+"settings/funnels/")},"json").always(function(){c=!1}))}var b=this,c=!1;b.$wrapper.on("click",".js-delete-funnel",function(e){e.preventDefault();d.waDialog.confirm({title:`<i class=\"fas fa-exclamation-triangle smaller state-error\"></i> ${b.locales.delete_confirm_title}?`,text:b.locales.delete_confirm_text,
...
this.$wrapper.find(".js-no-access-wrapper");a.on("click",".js-show-access-list",function(b){b.preventDefault();a.addClass("is-active")});a.on("click",".js-hide-access-list",function(b){b.preventDefault();a.removeClass("is-active")})};return CRMSettingsFunnel}(jQuery);var CRMSettingsFunnels=function(d){CRMSettingsFunnels=function(a){this.$wrapper=a.$wrapper;this.initClass()};CRMSettingsFunnels.prototype.initClass=function(){this.initTabs()};CRMSettingsFunnels.prototype.initTabs=function(){var a=this.$wrapper.find(".js-funnels-tabs"),b=this.$wrapper.find(".c-funnels-wrapper"),c=b.find(".c-funnels-list"),e=c.find(".c-funnel.selected");(function(){function f(){d.contains(document,a[0])?g():l.off("resize",f)}function g(){var h=a.outerWidth(!0)-k-38;b.css("max-width",
h+"px")}var l=d(window),k=a.find(".c-add-wrapper").outerWidth();g();l.on("resize",f)})();d.crm.tabSlider({$wrapper:b,$slider:c,$activeSlide:e.length?e:!1});(function(){function f(){var l={ids:function(){var k=[];c.find(".c-funnel").each(function(){k.push(d(this).data("id"))});return k.join(",")}()};g&&g.abort();g=d.post("?module=settings&action=funnelsSortSave",l,function(k){}).always(function(){g=!1})}var g=!1;c.sortable({distance:10,items:"> li",axis:"x",stop:f,onUpdate:f})})()};return CRMSettingsFunnels}(jQuery);var crmSettingsField=function(d){var a=function(b){this.$wrapper=b.$wrapper;this.initClass()};a.prototype.initClass=function(){this.initSortable();this.bindEvents()};a.prototype.initSortable=function(){function b(k){return k.find(".field").map(function(){return d.trim(d(this).data("id"))||""}).toArray()}function c(k,h){g&&(g.abort(),g=null);return d.post(k,h,function(){g=null})}var e=d.crm.app_url+"?module=settings&action=fieldSaveSort",f,g=!1,l=this.$wrapper.find(".js-other-fields");l.sortable({helper:"clone",
handle:".sort",items:"> .field",axis:"y",tolerance:"pointer",start:function(k,h){f=h.item.index()},stop:function(k,h){f!=h.item.index()&&(k=b(l),c(e,{fields:k}))},onUpdate:function(k){k=b(l);c(e,{fields:k})}})};a.prototype.bindEvents=function(){var b=!1,c=d.crm.app_url+"?module=settings&action=fieldEdit",e=null;this.$wrapper.on("click",".crm-edit-field-link",function(){var f=d(this);b||(b=!0,e&&(e.abort(),e=null),e=d.post(c,{id:f.data("id")||null},function(g){d.waDialog({html:g,onOpen:function(l,
...
location.href=d.crm.app_url+"settings/field/")})})};a.prototype.save=function(){var b=this,c=b.$form,e=d(".crm-dialog-edit-field-wrapper").find(".js-save"),f=d('<span class="icon loading" style="vertical-align: middle;margin-left: 10px;"><i class="fas fa-spinner fa-spin"></i></span>');d(".loading").remove();e.prop("disabled",!0);var g=!0;c.find(".errormsg").text("");c.find(".state-error").removeClass("state-error");d('[name$="[localized_names]"]').each(function(){var l=d(this),k=l.val();if("string"===
typeof k||k instanceof String)k=k.trim();!k&&0>=l.parents(".template").length&&l.closest("tr").find('[name$="[_disabled]"]:checked').length&&(g=!1,l.addClass("state-error").parent().append(d('<span class="errormsg"></span>').text(b.locales.field_is_required)))});if(!g)return e.attr("disabled",!1),c.one("input, keydown",".state-error",function(){d(this).removeClass("state-error").nextAll(".state-error-hint:first, .errormsg:first").empty()}),!1;f.appendTo(e.parent());return d.post(c.attr("action"),
c.serialize(),function(l){"ok"==l.status&&(d(".loading").remove(),d('<i class="fas fa-check-circle" style="vertical-align: middle;margin-left: 10px;"></i>').appendTo(e.parent()),setTimeout(function(){d.crm.content.reload();b.dialog.close()},1E3));if("ok"!==l.status&&l.errors){e.removeProp("disabled");d(".loading").remove();for(var k=0,h=l.errors.length;k<h;k+=1){var m=l.errors[k];if("string"===typeof m)c.find(".errormsg.crm-common-errors").append(m);else if("object"===typeof m)for(var n in m)if(m.hasOwnProperty(n)){var p=
c.find('[data-error-id="'+n+'"]');p.addClass("state-error");p.nextAll(".state-error-hint:first").text(m[n])}}c.one("input, keydown",".state-error",function(){d(this).removeClass("state-error").nextAll(".state-error-hint:first, .errormsg:first").empty()});c.find("[type=submit]").attr("disabled",!1)}})};a.prototype.initIDAutoFiller=function(){var b,c=this.$form,e=c.find('input[name^="name["][data-main-locale]'),f=c.find('input[name="id_val"]'),g=null;f.on("keydown.check_edited",function(){var l=d(this);
l.data("val",l.val())}).on("keyup.check_edited",function(){var l=d(this);l.val()&&l.val()!=l.data("value")&&(l.off(".check_edited"),l.data("edited",1))});if(!f.prop("disabled")&&!f.data("edited"))c.on("keydown.crm-id-auto-filler",'input[name^="name["]',function(){var l=d(this),k=c.find('[type="submit"]'),h=f.next(".loading");if(l.data("main-locale")||!e.val())f.prop("disabled")||f.data("edited")?c.off(".crm-id-auto-filler"):(k.prop("disabled",!0),h=h.length?h:d('<i class="icon16 loading"></i>'),h.insertAfter(f),
b&&clearTimeout(b),b=setTimeout(function(){var m=function(){g&&(g.abort(),g=null);b&&clearTimeout(b);k.prop("disabled",!1);h.remove()};f.data("edited")?m():g=d.post(d.crm.app_url+"?module=settings&action=fieldTransliterate",c.find('input[name^="name["]').serialize(),function(n){m();"ok"!==n.status||f.data("edited")||f.val(n.data)},"json")},300))})};a.prototype.editSubFields=function(){function b(l){var k=d(".crm-dialog-edit-field-wrapper").find(".js-save");l?k.addClass("yellow").removeAttr("disabled"):
k.removeClass("yellow")}var c=this,e=d(".crm-dialog-edit-field-wrapper"),f=e.find(".subfields-list > .ui-sortable"),g=1;f.sortable({items:".field-row",handle:".js-subfield-sort",axis:"y",update:function(l){b(!0)}});f.on("click","a.js-add-subfield",function(){var l=f.find(".field-row.template");l=l.clone().insertBefore(l).removeClass("template").removeClass("hidden");c.dialog.resize();var k="__"+g;g++;l.find("[name]").each(function(){var h=d(this);h.attr("name",h.attr("name").replace(/%FID%/g,k))});
l.data("fieldId",k);l.find("select.type-selector").change();b(!0);return!1});e.on("click",".js-edit-subfield",function(l){l.preventDefault();d(this).closest("tr").addClass("editor-on").removeClass("editor-off");b(!0)});e.on("click",".js-delete-subfield",function(l){l.preventDefault();var k=d(this).closest("tr");k.hasClass("just-added")&&k.remove();d.crm.confirm.show({title:c.locales.delete_subfield_title,text:c.locales.delete_subfield_text,button:c.locales.delete_subfield_button,onConfirm:function(){k.addClass("editor-off").removeClass("editor-on");
var h=k.find('input:hidden[name$="[_disabled]"]').attr("name").replace("[_disabled]","[_deleted]");d(".js-field-form-edit").append(d('<input type="hidden" name="" value="1">').attr("name",h));k.children().children(":not(label)").remove();k.find("label").addClass("gray").addClass("strike");b(!0)}})});f.on("click","a.add-item",function(){c.dialog.resize()});e.on("change","select.type-selector",function(){var l=d(this),k=l.closest("tr"),h=k.closest("table"),m=k.find(".field-advanced-settings").html('<span class="icon"><i class="fas fa-spinner fa-spin"></i></span>');
d.post(d.crm.app_url+"?module=settings&action=fieldEditor",{ftype:l.val(),fid:k.data("fieldId"),parent:h.data("fieldParent")||"",prefix:h.data("fieldPrefix")},function(n){m.html(n);b(!0)})});e.on("change",":checkbox, .name-input",function(){b(!0)});e.on("input change",function(){b(!0)})};return a}(jQuery);var crmSettingsFieldEditSubfieldValues=function(d){var a=function(c){this.$wrapper=d(".subfields-list");this.$hidden=c.hidden;this.$dialog_link=c.dialog_link;this.dialog_url=c.dialog_url;this.locales=c.locales;this.initClass()};a.prototype.initClass=function(){this.initValuesLink()};a.prototype.initValuesLink=function(){var c=this,e=!1;c.$wrapper.find(c.$dialog_link).on("click",function(){e||(e=!0,d.get(c.dialog_url,function(f){d.waDialog({html:f,onOpen:function(g,l){l.resize();c.editValues(g,l);
c.initSubmit(g,l)},onClose:function(g,l){e=!1}})}))})};a.prototype.editValues=function(c,e){var f=c.find("form");c.on("click",".s-add-rule",function(){var g=c.find(".s-new-rule");if(g.length){var l=g.clone();l.removeClass("s-new-rule").show().insertBefore(g);l.find('input[name^="parent"]').attr("disabled",!1);l.find(".s-add-value").click();b(c);l=parseInt(g.find('input[name="parent[]"]').val(),10)+1||1;g.find('input[name="parent[]"]').val(l);g.find('input[name^="parent_value"]').attr("name","parent_value["+
l+"]");g.find('input[name^="value"]').attr("name","value["+l+"][0]");e.resize()}return!1});c.on("click",".s-add-value",function(){var g=d(this).parents("table:first").find(".s-new-value");if(g.length){var l=g.clone();l.addClass("sortable").removeClass("s-new-value").show().insertBefore(g);l.find("input").attr("disabled",!1);l=g.find("input:first").attr("name");var k=l.lastIndexOf("["),h=(parseInt(l.substr(k+1),10)||0)-1;l=l.substr(0,k)+"["+h+"]";g.find("input:first").attr("name",l)}e.resize();return!1});
c.on("click",".s-delete-value",function(){var g=d(this),l=g.attr("data-id");g=g.parents("tr:first");var k=g.parents("table:first");l&&f.append('<input type="hidden" name="delete[]" value="'+l+'">');g.remove();k.find("tr.sortable:first").length||k.parents("div.field:first").remove();e.resize();return!1});b(c);this.$hidden.val()?c.find("select.otherwise-options").val("hide"):c.find("select.otherwise-options").val("input")};a.prototype.initSubmit=function(c,e){var f=this,g=c.find("form"),l=c.find(".js-save-values"),
k=d('<span class="icon loading custom-ml-4"><i class="fas fa-spinner fa-spin"></i></span>'),h=d('<span class="icon yes custom-ml-4"><i class="icon fas fa-check"></i>');g.submit(function(m){m.preventDefault();l.prop("disabled",!0);d(".loading").remove();k.appendTo(l.parent());var n=!0;c.find(".errormsg").remove();c.find(".state-error").removeClass("state-error");c.find('[name^="parent_value["]:not(:disabled)').each(function(){this.value||(n=!1,d(this).addClass("state-error").after(d('<span class="errormsg"></span>').text(f.locales.field_is_required)))});
...
a.each(function(){var e=d(this),f=e.closest(".c-source"),g=f.data("id"),l=f.find(".c-loading");e.find("#switch-"+g).waSwitch({ready:function(k){let h=k.$wrapper.siblings("label");k.$label=h;k.active_text=h.data("active-text");k.inactive_text=h.data("inactive-text")},change:function(k,h){l.show();h.disable(!0);b&&b.abort();b=d.post(c,{id:g,disabled:k?0:1}).done(function(m){"ok"===m.status&&(k?(h.$label.text(h.inactive_text),f.removeClass("c-is-disabled")):(h.$label.text(h.active_text),f.addClass("c-is-disabled")),
h.disable(!1))}).always(function(){b=null;l.hide()})}})})};CRMSettingsSources.deleteSource=function(a,b){b=b.messages||{};d.crm.confirm.show({title:b.delete_confirm_title,text:b.delete_confirm_text,button:b.delete_confirm_button,onConfirm:function(){var c=d.crm.app_url+"?module=settings&action=sourceDelete",e=d(".crm-confirm-dialog"),f=e.find(".crm-loading").show(),g=e.find(".js-confirm-dialog").attr("disabled",!0);d.post(c,{id:a}).always(function(){d.crm.content.load(d.crm.app_url+"settings/sources/");
...
a.find(".crm-errors-block").remove()};CRMSettingsSourceIm.prototype.initSubmit=function(){var a=this,b=a.$form,c=a.$wrapper.find(".crm-form-buttons").find(".crm-loading"),e=a.$button,f=b.find(".crm-success-status"),g=d.crm.app_url+"?module=settingsSource&action=save";CRMSettingsSourceIm.clearValidateErrors(b);b.submit(function(l){l.preventDefault();l=b.serializeArray();l.push({name:"id",value:0<a.source.id?a.source.id:a.source.provider});c.show();e.prop("disabled",!0);a.submit_xhr&&a.submit_xhr.abort();
a.submit_xhr=d.post(g,l,null,"json").done(function(k){"ok"===k.status?(a.setFormChanged(!1),f.show().fadeOut(500,function(){k.data.source?d.crm.content.load(d.crm.app_url+"settings/sources/"+k.data.source.id+"/"):d.crm.content.reload()})):CRMSettingsSourceIm.showValidateErrors(b,k.errors||{})}).always(function(){c.hide();e.prop("disabled",!1);a.submit_xhr=null})})};CRMSettingsSourceIm.prototype.initDeleteLink=function(){var a=this;a.$wrapper.find(".crm-delete-source-link").click(function(b){b.preventDefault();
...
(a.funnel_id=c.funnel_id);a.responsible_contact_id=c.$user_id.val();a.group_id=c.$group.val();f.show();d.get(g,a,function(l){l=d("<div>").html(l);var k=l.find("."+c.class_id);c.$wrapper.replaceWith(k);k=k.data("block_object");b&&b(k);l.remove();c.destroy()})};CRMSettingsSourceResponsibleBlock.prototype.destroy=function(){var a=this;a.$user_delete_link.off(a.ns);a.$group.off(a.ns);a.$wrapper.removeData("block_object");a.$user.data("ui-autocomplete")&&(a.$user.autocomplete("destroy"),a.$user.removeData("ui-autocomplete"));
...
function(){a.renderToVariantSelectors()});b.on("changeResponsibleUser",function(){a.renderToVariantSelectors()})};crmSettingsForm.prototype.renderToVariantSelectors=function(){var a=this.$wrapper.find(".c-settings-messages-block"),b=this.getField("email"),c=b&&0<b.checked,e=function(f,g){var l=f.closest("label");g?(f.data("checked",f.is(":checked")),f.prop("disabled",!0).prop("checked",!1)):f.prop("disabled",!1).prop("checked",f.data("checked"));f.is(":checked")?l.addClass("bold"):l.removeClass("bold")};
a.find(".c-message-to-selector").each(function(){var f=d(this),g=f.find(".c-label");f=f.find(".c-message-to-variants-list");var l=f.find(':checkbox[data-id="client"]');e(l,!c);var k=[];f.find(":checkbox:checked:not(:disabled)").each(function(){var h=d(this).closest("li");k.push(h.find(".c-variant-name-text").text())});k=0<k.length?k.join(", "):g.data("initial_text");g.text(k)})};crmSettingsForm.prototype.getField=function(a,b){var c=this.form.params.fields,e=c.length,f=null;b="undefined"===typeof b?
...
new crmSettingsFormFieldEditDialog(c)}};crmSettingsForm.prototype.initSubmit=function(){var a=this,b=a.$form,c=b.find(".crm-loading"),e=b.find(".crm-success-status");b.on("keypress","input",function(f){13==f.keyCode&&f.preventDefault()});b.submit(function(f){f.preventDefault();f=b.serializeArray();var g=[];d.each(a.form.params.fields,function(l,k){if(0<k.checked){var h=g.length;d.each(k,function(m,n){"html"!==m&&(g[h]=g[l]||{},g[h][m]=n)})}});f.push({name:"form[params][fields]",value:JSON.stringify(g)});
a.clearValidateErrors();c.show();a.$button.prop("disabled",!0);a.submit_xhr&&a.submit_xhr.abort();a.submit_xhr=d.post(b.attr("action"),f).done(function(l){"ok"!==l.status?(a.showValidateErrors(l.errors||{}),c.hide(),a.$button.prop("disabled",!1)):(e.show().fadeOut(500),d.crm.content.load(d.crm.app_url+"settings/form/"+l.data.form.id).then(function(){c.hide();a.$button.prop("disabled",!1);a.setFormChanged(!1)}))}).fail(function(){a.showValidateErrors({"":a.messages.unknown_server_error});c.hide();
a.$button.prop("disabled",!1)}).always(function(){})})};crmSettingsForm.prototype.clearValidateErrors=function(){var a=this.$form;a.find(".state-error").removeClass("state-error");a.find(".crm-errors-block").remove()};crmSettingsForm.prototype.showValidateErrors=function(a){var b=this.$form,c={};d.each(a||{},function(e,f){"params"===e?d.each(f,function(g,l){c["form[params]["+g+"]"]=d.isArray(l)?l:[l]}):c[e?"form["+e+"]":""]=d.isArray(f)?f:[f]});this.clearValidateErrors();d.each(c,function(e,f){var g=
d('<div class="crm-errors-block"></div>');e=e?b.find('[name="'+e+'"]'):d();e.addClass("state-error");d.each(f,function(l,k){g.append('<span class="errormsg">'+k+"</span>")});e.length?e.after(g):b.find(".crm-common-errors-block").append(g)})};crmSettingsForm.prototype.initDeleteLink=function(){var a=this,b=a.messages||{};a.$delete_link.click(function(c){c.preventDefault();d.crm.confirm.show({title:b.delete_confirm_title,text:b.delete_confirm_text,button:b.delete_confirm_button,onConfirm:function(){var e=
d(".crm-confirm-dialog"),f=e.find(".crm-loading").show(),g=e.find(".js-confirm-dialog").attr("disabled",!0);d.post(d.crm.app_url+"?module=settings&action=formDelete",{id:a.form.id}).always(function(){d.crm.content.load(d.crm.app_url+"settings/form");f.hide();g.attr("disabled",!1)});return!1}})})};crmSettingsForm.prototype.initSortable=function(){function a(){for(var c=b.form.params.fields,e=c.length,f={},g=[],l=b.$form_fields.find(".crm-form-field:not(.crm-form-field-template)"),k=0;k<e;k+=1)f[c[k].id+
"-"+c[k].checked]=k;l.each(function(){var h=d(this),m=h.data("id");h=h.data("checked");g.push(c[f[m+"-"+h]])});b.form.params.fields=g;b.setFormChanged()}var b=this;b.$form_fields.sortable({distance:5,helper:"clone",items:".crm-form-field:not(:hidden)",opacity:.75,handle:".sort",tolerance:"pointer",containment:b.$form_fields,stop:a,onUpdate:a})};crmSettingsForm.prototype.initDeleteFieldLinks=function(){var a=this;a.$wrapper.on("click",".crm-delete-field-link",function(){var b=d(this).closest(".crm-form-field");
...
a=b.getFormField("password"),b.deleteFormField(a),b.renderToVariantSelectors());"company"===c&&b.$form_available_fields.find(".crm-form-field[data-person-enabled=0][data-company-enabled=1]").each(function(){var g=d(this),l=g.data("id");l=b.getFormField(l);b.deleteFormField(l);g.addClass("crm-disabled")});b.setFormChanged()}};crmSettingsForm.prototype.getFormField=function(a,b){var c='.%clz%[data-id="%id%"]%extra%:not(.%not_clz%)';a=[["%clz%","crm-form-field"],["%id%",a],["%extra%",void 0!==b?'[data-id="'+
...
function(){var a=this.$wrapper,b=a.find(".js-deal-section");a=a.find(".js-responsible-section");b=b.data("block_object");a=a.data("block_object");b.setResponsibleBlock(a)};return crmSettingsForm}(jQuery);var crmSettingsFormFieldEditDialog=function(d){var a=function(b){var c=this,e=b.onClose;b.onClose=function(g,l){e&&e(g,l)};var f=b.onOpen;b.onOpen=function(g,l){f&&f(g,l);c.$wrapper=g;c.$form=c.$wrapper.find("form");c.$button=c.$form.find("[type=submit]");c.id=b.id;c.checked=b.checked;c.settingsForm=b.settingsForm;c.dialog=l;c.initClass()};d.waDialog(b)};a.prototype.initClass=function(){var b=this.dialog.$block,c=this.settingsForm.getField(this.id,this.checked);d.each(c,function(g,l){"id"===g?d(".crm-field-id",
b).find(".value").text(c.name+" (ID="+l+")"):"name"!==g&&(g=d(".crm-field-"+g,b).find(".value").find(":input"),g.is(":checkbox")?g.prop("checked",!!l):g.is(":radio")?g.filter('[value="'+l+'"]').prop("checked",!0):g.val(l))});var e=function(g){d(".crm-field-"+g,b).hide().find(":input").attr("disabled",!0)},f=function(g){d(".crm-field-"+g,b).show().find(":input").attr("disabled",!1)};"Checkbox"!==c.type?f("captionplace"):e("captionplace");c.placeholder_need?f("placeholder"):e("placeholder");c.placeholder_need&&
"password"===c.id?f("placeholder_confirm"):e("placeholder_confirm");c.required_always?e("required"):f("required");"!deal_description"==c.id?f("redactor"):e("redactor");this.bindEvents()};a.prototype.bindEvents=function(){var b=this,c=b.$form,e=b.settingsForm.getField(b.id,b.checked);c.submit(function(f){f.preventDefault();c.find(":input[name*=params]:not(:disabled)").each(function(){var g=d(this),l=g.attr("name").replace("params[","").replace("]",""),k=g.val();g.is(":checkbox")?e[l]=g.is(":checked")?
!0:!1:g.is(":radio")?g.is(":checked")&&(e[l]=k):e[l]=k});b.settingsForm.updateField(b.id,b.checked,e);b.settingsForm.renderField(b.id,b.checked);b.dialog.close()});b.$form.on("change","input,textarea,select",function(){b.setFormChanged()});b.$form.on("keyup","input:text,textarea",function(){b.setFormChanged()})};a.prototype.setFormChanged=function(){this.$button.addClass("yellow")};return a}(jQuery);var crmSettingsFormParagraphEditDialog=function(d){var a=function(b){var c=this,e=b.onClose;b.onClose=function(g,l){e&&e(g,l);d(".redactor-dropdown").remove()};var f=b.onOpen;b.onOpen=function(g,l){f&&f(g,l);c.$wrapper=g;c.$textarea=c.$wrapper.find(".crm-paragraph-textarea");c.$button=c.$wrapper.find("[type=button]");c.id=b.id;c.checked=b.checked;c.settingsForm=b.settingsForm;c.dialog=l;c.initClass()};new CRMDialog(b)};a.prototype.initClass=function(){var b=this.$textarea,c=this.settingsForm.getField(this.id,
...
d(".dialog").remove()},1E4))},"json").always(function(){b=!1}));return!1}})})};CRMNotificationEdit.prototype.initSender=function(){function a(){return k&&0<k.id?k.transport||"email":h.filter(":checked").first().val()}function b(){"email"===a()?(c("specified"===l.$sender.val()),g()):(f("specified"===l.$sms_sender.val()),e())}function c(m){var n=l.$sender_block.find(".js-specified-sender-name"),p=l.$sender_block.find(".js-specified-sender-email");l.$sender_block.show();l.$sender.attr("disabled",!1);
m?(n.attr("disabled",!1).show(),p.attr("disabled",!1).show(),"system"!==l.sender[0]&&(p.val(l.sender[0]),n.val(l.sender[1]))):(n.attr("disabled",!0).hide(),p.attr("disabled",!0).hide())}function e(){l.$sender_block.hide();l.$sender.attr("disabled",!0);l.$sender_block.find(".js-specified-sender-name").attr("disabled",!0).hide();l.$sender_block.find(".js-specified-sender-email").attr("disabled",!0).hide()}function f(m){var n=l.$sms_sender_block.find(".js-specified-sms-sender");l.$sms_sender_block.show();
l.$sms_sender.attr("disabled",!1);m?(n.attr("disabled",!1).show(),"system"!==l.sender[0]&&n.val(l.sender[0])):n.attr("disabled",!0).hide()}function g(){l.$sms_sender_block.hide();l.$sms_sender.attr("disabled",!0);l.$sms_sender_block.find(".js-specified-sms-sender").attr("disabled",!0).hide()}var l=this,k=l.notification,h=l.$wrapper.find(".js-transport-toggle");"email"===a()?(c("specified"===l.$sender.val()),g()):(f("specified"===l.$sms_sender.val()),e());h.on("change",b);l.$sender.on("change",b);
l.$sms_sender.on("change",b)};CRMNotificationEdit.prototype.initRecipient=function(){function a(){b(c.$recipient.val())}function b(k){var h=l.filter(":checked").first().val();!h&&0<c.notification.id&&(h=c.notification.transport);h=c.$wrapper.find('.c-recipient-content[data-id="'+h+'"]');c.$wrapper.find(".c-recipient-content").hide().attr("disabled",!0);"other"===k?(h.show(),h.attr("disabled",!1)):h.hide()}var c=this,e=c.notification.recipient,f=c.recipients,g=c.$recipient,l=c.$wrapper.find(".js-transport-toggle");
g.on("change",a);l.on("change",a);f[e]||(c.$recipient.val("other"),b("other"),c.$wrapper.find('.c-recipient-content[data-id="'+l.filter(":checked").first().val()+'"]').val(e))};CRMNotificationEdit.prototype.initChangeEvent=function(){var a=this,b=a.$wrapper.find(".js-event-toggle"),c=a.$wrapper.find(".js-event-company"),e=a.$wrapper.find(".js-fields-group");b.on("change",function(){var f=d.trim(d(this).val());a.notification_event=f;var g=a.notifications[f];g&&(a.$name.val(g.name),a.$subject.val(g.subject),
...
function(){function a(){var l={data:[],errors:[]},k=f.serializeArray();d.each(k,function(h,m){l.data.push(m)});return l}function b(l,k){k=k?k:[];if(l){var h=Object.keys(l);d.each(h,function(m,n){k.push({name:n,value:l[n]})})}d.each(k,function(m,n){m=n.value;var p=e.$form.find('[name="'+n.name+'"]');if(p.length&&!p.hasClass("error")){var q=d("<span />").addClass("errormsg").text(m);e.$wrapper.append(q);p.addClass("error").one("focus click change",function(){p.removeClass("error");q.remove()})}})}function c(l){if(!g){g=
!0;var k=d(e.locales.saving);e.$footer.append(k);d.post("?module=settings&action=notificationsEditSave",l,"json").done(function(h){if("ok"!==h.status)b(h.errors||{});else if(0>=e.notification_id)d.crm.content.load(d.crm.app_url+"settings/notifications/edit/"+h.data.notification.id+"/");else{var m=d(e.locales.saved);e.$footer.append(m);setTimeout(function(){d.contains(document,m[0])&&m.remove()},2E3);d(document).trigger("formIsSaved")}}).always(function(){k.remove();g=!1})}}var e=this,f=e.$form,g=
!1;f.on("submit",function(l){l.preventDefault();d(document).trigger("updateEditorTextarea");l=a();l.errors.length?b(!1,l.errors):c(l.data)})};CRMNotificationEdit.prototype.initDelete=function(){var a=this,b=!1;a.$wrapper.on("click",".js-remove-notification",function(c){c.preventDefault();d.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+a.locales.delete_confirm_title,text:a.locales.delete_confirm_text,success_button_title:a.locales.delete_confirm_button,
...
var l="app=crm&key=notification."+e.notification_event;if(f)return e.drawer.show(),!1;e.drawer=d.waDrawer({html:'<div class="drawer crm-help" id=""> <div class="drawer-background"></div> <div class="drawer-body"> <a href="#" class="drawer-close js-close-drawer"><i class="fas fa-times"></i></a> <div class="drawer-block"><div class="flexbox middle width-100 height-100 spinner-wrapper"><div class="spinner custom-p-16"></div></div></div> </div> </div> ',direction:"right",onClose:()=>a(!1)});d.get(g,l,
function(k){d(".drawer .drawer-block").html(k);a(!0);f=!0},"html")})};return CRMNotificationEdit}(jQuery),CRMNotificationStatus=function(d){CRMNotificationStatus=function(a){this.$wrapper=a.$wrapper;this.messages=a.messages||{};this.messages.enable=this.messages.enable||"";this.messages.disable=this.messages.disable||"";this.notifications=a.notifications;this.initDisableLinks()};CRMNotificationStatus.prototype.initDisableLinks=function(){var a=this.$wrapper.find(".js-c-disable-link"),b=null,c=d.crm.app_url+
"?module=settingsNotifications&action=status";a.each(function(){var e=d(this),f=e.closest(".c-notification"),g=f.data("id"),l=f.find(".c-loading");e.find("#switch-"+g).waSwitch({ready:function(k){let h=k.$wrapper.siblings("label");k.$label=h;k.active_text=h.data("active-text");k.inactive_text=h.data("inactive-text")},change:function(k,h){l.show();h.disable(!0);b&&b.abort();b=d.post(c,{id:g,status:k?0:1}).done(function(m){"ok"===m.status&&(k?(h.$label.text(h.inactive_text),f.removeClass("c-is-disabled")):
(h.$label.text(h.active_text),f.addClass("c-is-disabled")),h.disable(!1))}).always(function(){b=null;l.hide()})}})})};return CRMNotificationStatus}(jQuery);var CRMSettingsPayments=function(d){CRMSettingsPayments=function(a){this.$wrapper=a.$wrapper;this.$dropdown=this.$wrapper.find(".dropdown");this.$pluginsDropdown=this.$wrapper.find(".js-plugins-dropdown");this.$table=this.$wrapper.find(".js-payments-table");this.company_id=a.company_id;this.locales=a.locales;this.initClass()};CRMSettingsPayments.prototype.initClass=function(){this.initTabs();this.initDelete();this.initSortable();this.initDropDown();var a=this.$wrapper.find(".c-payments-list");(new MutationObserver(function(b){a.trigger("refresh")})).observe(a[0],
{childList:!0,attributes:!0,subtree:!0})};CRMSettingsPayments.prototype.initTabs=function(){var a=this.$wrapper.find(".c-tabs-wrapper"),b=this.$wrapper.find(".c-companies-wrapper"),c=b.find(".c-companies-list"),e=c.find(".c-company.selected");(function(){function f(){d.contains(document,a[0])?g():l.off("resize refresh",f)}function g(){var h=a.outerWidth(!0)-k-38;b.css("max-width",h+"px")}var l=d(window),k=a.find(".c-add-wrapper").outerWidth();g();l.on("resize refresh",f)})();d.crm.tabSlider({$wrapper:b,
...
text:a.locales.confirm_delete_text,success_button_title:a.locales.confirm_delete_button,success_button_class:"danger",cancel_button_title:a.locales.confirm_cancel_button,cancel_button_class:"light-gray",onSuccess:function(){b||(b=!0,d.post("?module=settings&action=paymentDelete",{id:f,company_id:a.company_id},function(l){"ok"==l.status&&(e.remove(),l=a.$pluginsDropdown.find('li[data-plugin="'+g+'"]'),l.length&&l.show())}).always(function(){b=!1}))}})})()})};CRMSettingsPayments.prototype.initSortable=
...
var l=b.find(".crm-editor-wrapper[data-i]").last().data("i");l?l=parseInt(l+"",10):0!==l&&(l=-1);var k=l+1;g.find(".crm-editor-wrapper").data("i",""+k).attr("data-i",""+k);d.post(e,{input_name:c+"["+k+"][tmpl]",to_name:c+"["+k+"][to]",sourcefrom_name:c+"["+k+"][sourcefrom]",add_attachments_name:c+"["+k+"][add_attachments]",type:a.type},function(h){g.find(".crm-editor-wrapper").html(h);b.trigger("loadEditor",[k,g])});a.renderCheckboxLabel();f.prop("checked",!1)});b.on("click",".js-crm-remove-message-checkbox",
...
CRMSettingsShopWorkflowPage.prototype.initTabs=function(){var a=this.$wrapper.find(".js-funnels-tabs"),b=this.$wrapper.find(".c-funnels-wrapper"),c=b.find(".c-funnels-list"),e=c.find(".c-funnel.selected");(function(){function f(){d.contains(document,a[0])?g():l.off("resize",f)}function g(){var k=a.width();b.css("max-width",k+"px")}var l=d(window);g();l.on("resize",f)})();d.crm.tabSlider({$wrapper:b,$slider:c,$activeSlide:e.length?e:!1})};CRMSettingsShopWorkflowPage.prototype.initFooterToggle=function(){var a=
this.$wrapper.find(".js-footer-actions"),b=a.find(".js-submit-button");this.$wrapper.on("change keydown","input, textarea, select",function(){b.addClass("yellow");a.addClass("is-changed")})};CRMSettingsShopWorkflowPage.prototype.initSubmit=function(){function a(){var k={data:[],errors:[]},h=f.serializeArray();d.each(h,function(m,n){k.data.push(n)});return k}function b(k){k&&k[0]||(k=[]);d.each(k,function(h,m){h=m.value;var n=e.$wrapper.find('[name="'+m.name+'"]'),p=d("<span class='c-error' />").addClass("errormsg").text(h);
n.length&&!n.hasClass("error")?(n.parent().append(p),n.addClass("error").one("focus click change",function(){n.removeClass("error");p.remove()})):(g.append(p),f.one("submit",function(){p.remove()}))})}function c(k){if(!l){l=!0;var h=d.crm.app_url+"?module=settings&action=shopWorkflowSave",m=e.$form.find(".c-loading");m.show();d.post(h,k,function(n){"ok"===n.status?d.crm.content.reload():b(n.errors)},"json").always(function(){l=!1;m.hide()})}}var e=this,f=e.$form,g=e.$wrapper.find(".js-errors-place"),
l=!1;f.on("submit",function(k){k.preventDefault();k=a();k.errors.length?b(k.errors):c(k.data)})};return CRMSettingsShopWorkflowPage}(jQuery);var CRMSettingsPbxPage=function(d){CRMSettingsPbxPage=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.locales=a.locales;this.user_template_html=a.user_template_html;this.initClass()};CRMSettingsPbxPage.prototype.initClass=function(){var a=this;a.$wrapper.find(".c-pair-wrapper").each(function(){a.initPair(d(this))})};CRMSettingsPbxPage.prototype.initPair=function(a){function b(l){d.each(l,function(k,h){d.waDialog.alert({title:c.locales.dialog_error_title,text:h,button_title:c.locales.dialog_error_button,
button_class:"warning"});setTimeout(()=>{d(".js-dialog-close").click()},5E3)})}var c=this,e=a.data("plugin-id"),f=a.data("number"),g=!1;a.on("click",".js-user-delete",function(l){l.preventDefault();var k=d(this).closest(".c-user-wrapper"),h=k.find(".js-name");l=a.find(".js-number");h=h.html();d.waDialog.confirm({title:c.locales.delete_confirm_title.replace("%name%",h).replace("%number%",l.html()),text:c.locales.delete_confirm_text,success_button_title:c.locales.delete_confirm_button,success_button_class:"danger",
cancel_button_title:c.locales.dialog_error_button,cancel_button_class:"light-gray",onSuccess:function(){var m=k.data("id");g||(g=!0,d.post("?module=settingsPBX&action=delete",{p:e,n:f,u:m},function(n){"ok"===n.status&&k.remove()},"json").always(function(){g=!1}))}})});a.on("click",".js-delete-pbx-num",function(){var l=d(this).parents("tr"),k={p:e,n:f};l.addClass("hidden");d.post("?module=settingsPBX&action=deleteNumber",k,function(h){"ok"===h.status?l.remove():l.removeClass("hidden")},"json").always(function(){l.removeClass("hidden")})});
(function(){function l(p){p?h.addClass("is-shown"):h.removeClass("is-shown")}function k(p){n||(n=!0,d.post("?module=settingsPBX&action=add",{p:e,n:f,u:p.id},function(q){"ok"===q.status?(q=d(c.user_template_html),p.photo_url&&q.find(".userpic i").css("background-image","url("+p.photo_url+")"),q.find(".js-name").text(p.name),q.data("id",p.id),m.append(q)):b(q.errors)}).always(function(){n=!1}))}var h=a.find(".js-user-add-wrapper"),m=a.find(".js-users-list"),n=!1;h.on("click",".js-show-combobox",function(p){p.stopPropagation();
...
function(){var a=null,b,c=this.$param_list,e=this.$form;c.on("change","input.js-code-field",function(){d(this).removeClass("auto-filler")});c.on("keyup","input.js-name-field",function(){var f=d(this),g=f.val(),l=f.parents("tr").find(".js-code-field"),k=l.hasClass("auto-filler"),h=e.find('[type="submit"]');f=l.next(".fa-spinner");!h.prop("disabled")&&k&&(f=f.length?f:d('<span class="c-notice"><i class="fas fa-spinner wa-animation-spin speed-1000"></i></span>'),f.insertAfter(l),h.prop("disabled",!0),
...
d(this),e=c.find("textarea"),f=d('<div class="js-redactor" />'),g="js-textarea-"+b;b="js-redactor-"+b;f.attr("id",b).appendTo(c);e.attr("id",g);waEditorAceInit({id:g,ace_editor_container:b});"undefined"!==typeof wa_editor&&f.data("wa_editor",wa_editor);e.data("wa_editor",f.data("wa_editor"));e.on("editorDataUpdated",function(){var l=f.data("wa_editor");l&&l.getSession().setValue(e.val())});setTimeout(function(){f.data("wa_editor").on("input",function(){a.toggleButton(!0)})},100);d(document).on("updateEditorTextarea",
function(){var l=f.data("wa_editor");l&&(l=l.getValue(),e.val(l).trigger("change"))})})};CRMSettingsTemplate.prototype.initHelp=function(){function a(g){e.drawerWrapper=d(".drawer");e.drawerContent=e.drawerWrapper.find(".drawer-content");g?(e.drawerWrapper.on("click","ul.tabs li",b),e.drawerWrapper.on("click",".wa-help-vars-item",c),e.drawerWrapper.on("click",".drawer-background",()=>e.drawer.hide())):(e.drawerWrapper.off("click"),f=!1)}function b(g){g.preventDefault();if(d(this).hasClass("selected"))return!1;
...
height:!1},$preview:!1,is_active:!1,timer:0})});d(window).on("wa_dispatched",function(){a.destroy()});window.document.addEventListener("wa-gallery-unload",function(b){a.destroy()},!1)};waGallery.prototype.showPreview=function(a){var b=this,c=b.links[a],e=d('<div class="wa-gallery-preview"></div>'),f=b.getPreviewItems(a),g=b.storage.invisible,l=b.settings.zoom,k=b.settings.width,h=b.settings.start_time,m=c.$link;c.linkArea={top:b.settings.isFrame?0:m.offset().top,left:b.settings.isFrame?0:m.offset().left,
width:b.settings.isFrame?"100%":m.outerWidth(),height:b.settings.isFrame?"100%":m.outerHeight()};b.setActive(a);c.timer=setTimeout(function(){e.css({width:c.linkArea.width,height:c.linkArea.height,top:c.linkArea.top,left:c.linkArea.left,position:"fixed"}).addClass(g).html(f);b.$body.append(e);c.$preview=e;c.is_active=!0;setTimeout(function(){var n={width:c.linkArea.width,height:c.linkArea.height,top:c.linkArea.top,left:c.linkArea.left};l&&(n=b.offsetCorrection({width:parseInt(c.linkArea.width*l),
height:parseInt(c.linkArea.height*l),top:c.linkArea.top-parseInt(c.linkArea.height*(l-1)/2),left:c.linkArea.left-parseInt(c.linkArea.width*(l-1)/2)}));k&&!b.settings.isFrame&&(n=b.offsetCorrection({width:k,height:k,top:c.linkArea.top-parseInt((k-c.linkArea.width)/2),left:c.linkArea.left-parseInt((k-c.linkArea.width)/2)}));e.removeClass(g).css(n).on("click",function(){b.showFullImage(a);return!1});if(b.settings.isFrame)b.renderControls(a,!0);else e.on("mouseleave",function(){clearTimeout(c.timer);
c.timer=setTimeout(function(){b.hidePreview(c)},b.settings.close_time)}).on("mouseenter",function(){clearTimeout(c.timer)})},0);b.settings.forceFullPreview&&setTimeout(()=>b.showFullImage(a),100)},h)};waGallery.prototype.hidePreview=function(a){var b=a.$preview,c=a.linkArea,e=this.settings.animate_time;e||=333;b.length&&(b.css({width:c.width,height:c.height,top:c.top,left:c.left,zIndex:"auto"}).addClass(this.storage.invisible),a.$preview=!1,a.is_active=!1,setTimeout(function(){b.remove()},e))};waGallery.prototype.showFullImage=
...
function(a,b){var c=this,e=c.links[a],f=e.$preview,g=!b&&1<c.links.length,l=c.storage.body_active_class;if(!f.length)return!1;f.find(".wa-gallery-controls").remove();b=d('<div class="wa-gallery-controls top"></div>');var k=d('<div class="wa-gallery-controls bottom"></div>'),h=d('<a href="javascript:void(0);" class="wa-gallery-close largest custom-pr-16"><i class="fas fa-times"></i></a>'),m=d('<a href="javascript:void(0);" class="wa-gallery-download largest"><i class="fas fa-file-download"></i></a>'),
n=d('<a href="javascript:void(0);" class="wa-gallery-arrow right largest custom-pr-16"><i class="fas fa-chevron-right"></i></a>'),p=d('<a href="javascript:void(0);" class="wa-gallery-arrow left largest"><i class="fas fa-chevron-left"></i></a>');b.append(m);b.append(h);f.append(b);g&&(k.append(p),k.append(n),f.append(k));c.initSlider(a);h.on("click",function(){c.$body.removeClass(l);c.hidePreview(e);return!1});m.on("click",function(){var v=c.slider.$activeSlide.data("href");if(v)return location.href=
v,!1});g&&(p.on("click",function(){c.changeSlide(!1);return!1}),n.on("click",function(){c.changeSlide(!0);return!1}));var q=function(v){var t=37==v.keyCode,w=39==v.keyCode;27==v.keyCode&&(h.trigger("click"),c.$body.off("keyup",q));g&&(t&&p.trigger("click"),w&&n.trigger("click"))},r=function(){h.trigger("click");c.$body.off("mousewheel DOMMouseScroll",r)},u=function(v){v.originalEvent.dataTransfer.files.length&&(h.trigger("click"),c.$body.off("drop",u))};c.$body.on("keyup",q).on("drop",u).on("mousewheel DOMMouseScroll",
r);c.$close=h};waGallery.prototype.initSlider=function(a){var b=this.links[a].$preview.find(".wa-gallery-item");this.slider={is_lock:!1,current_slide:a,slide_count:this.links.length-1,$slides:b,$activeSlide:b.eq(a)}};waGallery.prototype.changeSlide=function(a){var b=this.slider,c=b.$activeSlide,e=this.storage.active;if(b.is_lock)return!1;b.is_lock=!0;if(a)if(b.current_slide<b.slide_count){var f=b.$slides.eq(b.current_slide+1);b.current_slide++}else f=b.$slides.first(),b.current_slide=0;else 1<=b.current_slide?
