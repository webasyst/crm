...
1.055,2.4):p/12.92;l=(.4124*m+.3576*n+.1805*p)/.95047;var q=.2126*m+.7152*n+.0722*p;m=(.0193*m+.1192*n+.9505*p)/1.08883;l=.008856<l?Math.pow(l,1/3):7.787*l+16/116;q=.008856<q?Math.pow(q,1/3):7.787*q+16/116;m=.008856<m?Math.pow(m,1/3):7.787*m+16/116;return[116*q-16,500*(l-q),200*(q-m)]}function h(l,m,n){var p=Math.floor(6*l),q=6*l-p;l=n*(1-m);var r=n*(1-q*m);m=n*(1-(1-q)*m);switch(p%6){case 0:var u=n;var v=m;var t=l;break;case 1:u=r;v=n;t=l;break;case 2:u=l;v=n;t=m;break;case 3:u=l;v=r;t=n;break;case 4:u=
m;v=l;t=n;break;case 5:u=n,v=l,t=r}return[255*u,255*v,255*t]}function k(l){var m=l[0]/255,n=l[1]/255,p=l[2]/255,q,r=Math.max(m,n,p);var u=r-Math.min(m,n,p);if(0==u)var v=q=0;else{q=u/r;l=(r-m)/6/u+.5;var t=(r-n)/6/u+.5;u=(r-p)/6/u+.5;m===r?v=u-t:n===r?v=1/3+l-u:p===r&&(v=2/3+t-l);0>v?v+=1:1<v&&--v}return{h:Math.round(360*v),s:Math.round(100*q),b:Math.round(100*r)}}b=function(l){l=this.hex=l;var m=!1;"string"===typeof l?(l=l.replace("#",""),3===l.length?m=c(l[0]+""+l[0],l[1]+""+l[1],l[2]+""+l[2]):
6===l.length&&(m=c(l[0]+""+l[1],l[2]+""+l[3],l[4]+""+l[5]))):"object"===typeof l&&3===l.length&&(m=l);this.rgb=m};b.prototype.getRange=function(){var l=this.rgb?g(this.rgb):!1;if(l){var m=f([90,l[1],l[2]]),n=f([40,l[1],l[2]]);l=e(m);var p=e(n);l=[l,p];l.getColor=function(q){if(0<=q&&100>=q){var r=m[0],u=m[1],v=m[2];return e([Math.floor(r+(n[0]-r)*q/100),Math.floor(u+(n[1]-u)*q/100),Math.floor(v+(n[2]-v)*q/100)])}return null};return l}return null};b.prototype.getTone=function(l){function m(p){100<
p?p=100:0>p&&(p=0);return p}var n=k(this.rgb);n.s=m(n.s*(1+l/100));n.b=m(n.b*(1+l/100));l=h(n.h/360,n.s/100,n.b/100);return e(l)};return b}();return new b(a)},initWYSIWYG:function(a,b){if(!a||!a.length||a.data("redactor"))return a;b=d.extend({minHeight:130,buttons:"inline bold italic underline deleted lists outdent indent image link horizontalrule fontcolor fontsize fontfamily".split(" "),plugins:["fontcolor","fontsize","fontfamily"],allowedTags:"a b i u pre blockquote p strong em del strike span ul ol li div span br".split(" "),
uploadImage:!1,lang:this.lang},b||{});a.redactor(b);d(document).one("wa_before_render",function(){d.contains(document,a[0])&&a.data("redactor")&&a.redactor("core.destroy")});return a},escape:function(a){return d("<div />").text(a).html()},runBackgroundWorker:function(a){var b=Math.floor(100*Math.random())/100,c=Math.floor(100*Math.random())/100,e=a.delay||1E4,f=e/2,g=a.id||(""+Math.random()).slice(2),h=null,k=null,l=a.url;l?(e+=f*b,200>=e?console.error("Delay value too low"):function(){try{var m=
function(){h&&clearTimeout(h);k&&k.abort();k=d.post(l,{process_id:g});k.always(function(){k=null;h=setTimeout(m,e)});k.fail(function(){return!1})};h=setTimeout(m,500+300*c)}catch(n){console.error(["source email worker fail",n])}}()):console.error("Empty url")}})})(jQuery);(function(d,a){d.fn.serializeObject=function(){var b={};d.each(this.serializeArray(),function(c,e){c=e.name;e=e.value;b[c]=b[c]===a?e:d.isArray(b[c])?b[c].concat(e):[b[c],e]});return b}})(jQuery);
...
"invoice[contact_id]"===p.name&&(0<p.value||l.errors.push({name:"invoice[contact_id]",value:g.locales.empty_contact}))});(function(n){g.$tableBody.find("tr").each(function(p){var q=d(this),r=q.find(".js-product-field"),u=q.find(".js-amount-field"),v=q.find(".js-price-field"),t=q.find(".js-product-tax-percent"),w=q.find(".js-product-tax-type");q=q.find(".js-name-field");u=b(u.val());v=b(v.val());t=parseInt(t.val());w=w.val();r=r.val();q=q.val();if(u||v||q)n.push({name:"items["+p+"][name]",value:q}),
n.push({name:"items["+p+"][price]",value:v}),n.push({name:"items["+p+"][quantity]",value:u}),n.push({name:"items["+p+"][tax_percent]",value:0<t||0===t?t:""}),n.push({name:"items["+p+"][tax_type]",value:w});r&&n.push({name:"items["+p+"][product_id]",value:r})})})(l.data);return l}function e(l,m){m=m?m:[];if(l){var n=Object.keys(l);d.each(n,function(p,q){m.push({name:q,value:l[q]})})}d.each(m,function(p,q){p=q.value;var r=g.$form.find('[name="'+q.name+'"]');if(r.length&&!r.hasClass("state-error")){var u=
...
{detail:{id:q.data.id}}))):d.crm.content.load(r)}}else p.hide(),e(q.errors)},"json").always(function(){k=!1})}}var g=this,h=g.$form,k=!1;h.on("submit",function(l){l.preventDefault();l=c();l.errors.length?e(!1,l.errors):f(l.data,h.find(".js-submit-button"))})};CRMInvoiceEdit.prototype.initDatePickers=function(){var c=this,e=c.$wrapper.find(".js-invoice-datepicker"),f=c.$wrapper.find(".js-invoice-due-datepicker"),g=c.$wrapper.find(".js-due-days-field"),h=c.$wrapper.find(".js-clear-due-date");(function(){var k=
e.parent().find("input[type='hidden']");e.datepicker({altField:k,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});c.invoice_id||e.datepicker("setDate","+0d")})();(function(){var k=f.parent().find("input[type='hidden']");f.datepicker({altField:k,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});f.on("change",function(){var l=d(this).val();d.trim(l).length?h.show():(k.val(""),h.hide())})})();c.$wrapper.on("click",".js-focus-on-field",function(){d(this).parent().find(".js-invoice-due-datepicker").trigger("focus")});
g.on("change",function(){var k=g.val(),l=0;k&&k.length&&0<parseInt(k)&&(l=parseInt(k),g.val(l));0<l?h.show():h.hide();g.val(l);k=l;l=e.datepicker("getDate");k=new Date(l.getTime()+864E5*k);f.datepicker("setDate",k)});e.on("change",function(){var k=g.val();k&&k.length&&0<parseInt(k)&&g.trigger("change")});f.on("change",function(){g.val("")});h.on("click",function(){f.val("").trigger("change")})};CRMInvoiceEdit.prototype.initChangeContact=function(){var c=this,e=c.$wrapper.find(".js-contact-toggle"),
f=e.find(".js-name"),g=e.find(".js-company-name"),h=e.find(".js-profile-image img"),k=e.find(".js-contact-id"),l=!1;e.on("click",".js-change-contact",function(m){m.preventDefault();var n=d(this);d.get(d.crm.app_url+"?module=invoice&action=contactAdd",function(p){d.waDialog({html:p,options:{onAdd:function(q,r,u,v){k.val(q).trigger("change");f.text(r);g.length&&v?g.text(v):g.text("");h.length&&u?h.attr("src",u):h.attr("src",`${c.wa_app_url}wa-content/img/userpic.svg`);l||(q=n.find(".js-label"),r=q.data("change-text"),
e.find(".c-profile-block").show(),q.find("span").text(r),q.find("svg").addClass("fa-pen"),l=!0)}}})})})};CRMInvoiceEdit.prototype.initDealActions=function(){function c(h,k){let l=null;h.on("click",".js-detach-deal",function(m){m.preventDefault();d.crm.confirm.show({title:e.locales.deal_detach_title,text:e.locales.deal_detach_text.replace(/%s/,k),button:e.locales.deal_detach_confirm_button,onConfirm:function(){l&&l.abort();e.loadDealListByContact(function(n){l=d.post(d.crm.app_url+"?module=invoiceDeal&action=detach",
{invoice_id:e.invoice_id}).done(function(p){p&&"ok"===p.status&&(d.crm.content.reload(),h.data("dialog").close())}).always(function(){l=null})})}})})}let e=this,f=e.$wrapper.find(".js-deal-toggle"),g=e.$wrapper.find(".js-deal-toggle [name='invoice[deal_id]']").val();f.on("click",".js-attach-other-deal, .js-associate-deal",function(h){h.preventDefault();let k=f.find(".js-deal-name").text();e.loadDealListByContact(function(l){d.get(d.crm.app_url+"?module=invoiceDeal&action=attachDialog",{invoice_id:e.invoice_id,
...
e.loadDealListByContact(function(l){k=d.post(d.crm.app_url+"?module=invoiceDeal&action=detach",{invoice_id:e.invoice_id}).done(function(m){m&&"ok"===m.status&&d.crm.content.reload()}).always(function(){k=null})})}})})};CRMInvoiceEdit.prototype.initSelectDeal=function(c){function e(){t.html(g.locales.deal_empty);z.val("none");m.val("");l.addClass("c-deal-name-hidden");p.addClass("hidden").removeAttr("title");v.addClass("c-empty-deal-hidden");w.addClass("hidden");y.find("li").removeClass("selected");
0<q.data("deals_count")?(q.removeClass("hidden"),r.addClass("hidden")):(q.addClass("hidden"),r.removeClass("hidden"))}function f(){let C=h.find(".js-created-deal");var A=x.find(".js-visible-link .js-text .funnel-state").clone(),D=d.trim(m.val());let E=k.serializeObject();E.invoice_id=g.invoice_id;E["deal[id]"]=z.val();E["deal[name]"]=m.val();E["deal[funnel_id]"]=k.find(".js-select-deal-funnel").val();E["deal[stage_id]"]=k.find(".js-select-deal-stage").val();if("none"===z.val())return k.addClass("shake animated"),
setTimeout(function(){k.removeClass("shake animated")},500),!1;if(0>=z.val()&&!D)return l.addClass("shake animated"),setTimeout(function(){l.removeClass("shake animated");m.focus()},500),!1;k.addClass("deal-form-hidden");C.removeClass("hidden");0>=z.val()?(C.html(A),C.append(d.crm.escape(D))):(D=q.find(".js-visible-link .js-text"),A=D.find(".funnel-state").clone(),D=D.find(".deal-item--name").text(),C.html(A),C.append(d.crm.escape(D)));d.post(d.crm.app_url+"?module=invoice&action=associateDealSave",
E,function(F){"ok"===F.status?(h.closest(".dialog").data("dialog").close(),d.crm.content.reload()):(C.html(""),C.addClass("hidden"),e(),k.removeClass("deal-form-hidden"))})}c=c||{};let g=this,h=c.$wrapper||g.$wrapper,k=h.find(".js-deal-selector-control-wrapper"),l=k.find(".js-deal-name"),m=k.find(".js-deal-name-input"),n=h.closest(".js-conversation-deal-attach-dialog").find(".js-save-button"),p=k.find(".js-save-deal"),q=k.find(".js-deals-dropdown"),r=k.find(".js-create-new-deal-link"),u=k.find(".js-remove-deal"),
v=q.find(".js-empty-deal"),t=k.find(".js-select-deal .js-visible-link .js-text"),w=k.find(".js-select-funnel-wrapper"),x=k.find(".js-select-stage-wrapper"),y=k.find(".js-deals-list"),z=k.find(".js-deal-id");var B=function(C){C=C||{};let A=C.funnels||{},D=0;d.each(C.deals||{},function(E,F){E=y;var G=E.prepend;var H=A[F.funnel_id];if(!F||0>=F.id)F="";else{var I=F.id,K=F.name||"",J="",L="";H&&H.stages&&H.stages[F.stage_id]&&(J=H.stages[F.stage_id].color||"");d.isEmptyObject(H)&&(L='<span class="hint">'+
...
k)){if(e.tax){var q=k===e.tax.name,r=n.tax_type===e.tax.type;n=(+n.tax_percent).toFixed(2)===(+e.tax.percent).toFixed(2);q&&r&&n&&m.attr("selected",!0)}m.text(p);m.data("name",k);g.append(m)}})):(e.$tax.parent().hide(),e.$emptyTax.show(),h=e.$emptyTaxLink.data("href"),e.$emptyTaxLink.attr("href",h+e.$companyField.val().toString()+"/"));g.trigger("change",!l)}var e=this,f=e.$companyField,g=e.$tax;f.on("change",function(h,k){h=d(this).val();var l=e.companies[h];e.active_tax_array=[];l&&(h=l.tax_name||
e.locales.tax,l=JSON.parse(l.tax_options),c(l,h,k))});f.trigger("change",!0)};CRMInvoiceEdit.prototype.initChangeTax=function(){var c=this;c.$tax.on("change",function(e,f){e=d(this).find("option");c.tax_percent=0;c.tax_type="NONE";c.tax_name="";e.length&&(e=e[this.selectedIndex],c.tax_percent=d(e).data("percent")||0,c.tax_type=d(e).data("type"),c.tax_name=d(e).data("name"));c.$taxPercent.val(c.tax_percent);c.$taxType.val(c.tax_type);c.$taxName.val(c.tax_name);c.renderProductTaxOptions();c.renderProductTaxFields(f);
c.refreshTable()})};CRMInvoiceEdit.prototype.initWYSIWYG=function(){var c=this.$wrapper.find(".js-wysiwyg");d.crm.initWYSIWYG(c,{keydownCallback:function(e){}})};CRMInvoiceEdit.prototype.initProductName=function(){function c(g){function h(x){w&&w.abort();var y=d.crm.backend_url+"shop/?action=autocomplete&with_counts=1";x={term:x};l("loading");w=d.get(y,x,function(z){z.length?(r.html(""),d.each(z,function(B,C){B=d("<div />");B.html(C.label).data("product",C).addClass("js-set-product");l(B)})):e.$wrapper.trigger("searchProduct")},
"json").always(function(){w=!1})}function k(x){w&&w.abort();l("loading");var y=e.$currencyField.val();w=d.get(d.crm.backend_url+"shop/?module=orders&action=getProduct",{product_id:x.id,currency:y},function(z){"ok"===z.status?(r.html(""),d.each(z.data.sku_ids,function(B,C){B=d("<div />");C=z.data.product.skus[C];B.text(z.data.product.name+(C.name.length?" ("+C.name+")":"")).data("product",z.data.product).data("sku",C).addClass("js-set-sku");l(B);1===z.data.sku_ids.length&&B.trigger("click")})):e.$wrapper.trigger("searchProduct")},
"json").always(function(){w=!1})}function l(x){if("loading"===x)r.html("").append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><i class="fas fa-spinner wa-animation-spin"></i></div></li>');else{var y=d("<li />").addClass("ui-menu-item-html ui-menu-item");d("<div />").addClass("ui-menu-item-wrapper").append(x).appendTo(y);y.appendTo(r)}}function m(){g.removeClass("is-active");r.html("");v=!1}function n(x){var y=r.find("li"),z=y.filter(".is-highlighted");if(!y.length)return!1;
...
!0;var g=d.crm.app_url+"?module=invoice&action=refundDialog",h={invoice_id:c.invoice_id};const k=spinnerView(f,0);k.show();d.post(g,h,function(l){d.waDialog({html:l,options:{onRefund:function(m){const n=getIframeIfExists();n?(window.parent.iframe_invoice_is_saved=!0,n.contentWindow.location.reload()):(a(c.invoice_id,m.html),c.reload())}}})}).always(function(){k.hide();e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-change-refund",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.initRestore=
function(){function b(f){if(!e){e=!0;var g={id:c.invoice_id};const h=spinnerView(f);h.show();d.post("?module=invoiceRestore",g,function(k){if("ok"===k.status){const l=getIframeIfExists();l?(window.parent.iframe_invoice_is_saved=!0,l.contentWindow.location.reload()):(a(c.invoice_id,k.data.html),c.reload())}else h.hide(),alert(k.errors)},"json").always(function(){e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-restore-invoice",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.load=
...
function(A,D){return d("<li />").addClass("ui-menu-item-html").append("<div>"+l.escapeHtml(D.name)+"</div>").appendTo(A)};(function(){p.find(".js-datepicker").each(function(){var A=d(this),D=p.find("."+A.data("selector"));A.datepicker({altField:D,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMCallPage.prototype.initDownloadLink=function(){$records_array=this.$wrapper.find(".c-call-wrapper .c-call-record-link");setTimeout(function(){$records_array.eq(0).trigger("click")},2E3)};CRMCallPage.prototype.initCustomAudioPlayer=
function(){let a=null;this.$wrapper.on("click",".c-call-record-link",function(b,c){var e=d(this);play=e.find(".play").length||null;loading=e.find(".loading").length||null;pause=e.find(".pause").length||null;$call_wrapper=e.closest(".c-call-wrapper");$call_id=$call_wrapper.data("id");$column_audio=$call_wrapper.find(".c-column-audio");$progressbar_new=$call_wrapper.find("#c-audio-slider");$progressbar_item=$progressbar_new[0];$duration=$call_wrapper.find(".c-audio-duration");$current_time=$call_wrapper.find(".c-audio-current-time");
let f=null;const g=h=>{const k=Math.floor(h%60);return`${Math.floor(h/60)}:${10>k?`0${k}`:`${k}`}`};if(loading||pause){id=setInterval(h,50);function h(){var l=e.find("audio");l.length&&0<l[0].readyState&&k(l)}function k(l){clearTimeout(a);clearInterval(id);var m=l[0];$column_audio.slideDown(200);$duration.text(g(m.duration));$progressbar_item.max=Math.floor(m.duration);$progressbar_new.on("input",p=>{$current_time.text(g($progressbar_item.value));p=p.target;$column_audio[0].style.setProperty("--seek-before-width",
p.value/p.max*100+"%");cancelAnimationFrame(f)});$progressbar_new.on("input",()=>{m.currentTime=$progressbar_item.value;requestAnimationFrame(n)});const n=()=>{$progressbar_item.value=Math.floor(m.currentTime);$current_time.text(g($progressbar_item.value));$column_audio[0].style.setProperty("--seek-before-width",`${$progressbar_item.value/$progressbar_item.max*100}%`);f=requestAnimationFrame(n);m.currentTime==m.duration&&(cancelAnimationFrame(f),a=setTimeout(()=>$column_audio.slideUp(200),3E3))};
l=()=>{const p=Math.floor(m.buffered.end(m.buffered.length-1));$column_audio[0].style.setProperty("--buffered-width",`${p/$progressbar_item.max*100}%`)};m.addEventListener("progress",l);l();requestAnimationFrame(n)}}play&&(a=setTimeout(()=>$column_audio.slideUp(200),3E3),$progressbar_new.off("change"),$progressbar_new.off("input"),cancelAnimationFrame(f))})};CRMCallPage.prototype.initDotsDetail=function(){var a=this;a.$wrapper.on("click",".js-dots",function(b){$detail=d(this).siblings(".c-dots-detail");
$detail_wrapper=$detail.closest(".js-dots-wrapper");$detail.toggle();$detail_wrapper.toggleClass("open");var c=$detail.height();b=$detail.width();let e=$detail_wrapper[0].getBoundingClientRect();window.innerHeight-e.bottom<c+30?$detail.css("bottom","30px"):$detail.css("bottom","unset");c=$detail_wrapper[0].getBoundingClientRect();window.innerWidth-c.left>b+30?$detail.css("left","0"):$detail.css("right","0")});d(document).on("click",function(b){var c=d(b.target),e=a.$wrapper.find(".js-dots-wrapper.open");
c=!!c.closest(".c-dots-detail").length;e.length&&!c&&e.each(function(){d.contains(d(this)[0],b.target)||(d(this).removeClass("open"),d(this).find(".c-dots-detail").hide())})})};CRMCallPage.prototype.initFinishCallLinks=function(){this.$wrapper.on("click",".js-finish-call",function(a){var b=d(this);a=d.crm.app_url+"?module=call&action=finish";var c=b.closest(".c-call-wrapper"),e=c.data("id");0>=e||b.data("loading")||(b.data("loading",1),b.find(".loading").show(),b.find(".yes-bw").hide(),d.post(a,{id:e},
function(f){if("ok"===f.status){f=d("<div>").html(f.data.html);var g=f.find('.c-call-wrapper[data-id="'+e+'"]').find(".c-column-state");c.find(".c-column-state").replaceWith(g);f.remove()}else b.data("loading",0),b.find(".loading").hide(),b.find(".yes-bw").show()}).error(function(){b.data("loading",0);b.find(".loading").hide();b.find(".yes-bw").show()}))})};CRMCallPage.prototype.initRedirectCall=function(){this.$wrapper.on("click",".js-redirect-call",function(a){a=d(this).parents(".c-call-wrapper").data("id");
a=d.crm.app_url+"?module=call&action=redirectDialog&id="+a;var b=d(this);b.prop("disabled",!0).find(".svg-inline--fa").removeClass("fa-exchange-alt").addClass("fa-spinner fa-spin");d.get(a,function(c){d.waDialog({html:c,onOpen:function(){b.prop("disabled",!1).find(".svg-inline--fa").removeClass("fa-spinner fa-spin").addClass("fa-exchange-alt")}})})})};CRMCallPage.prototype.initDeleteCall=function(){function a(e){var f=e.find(".c-delete-call"),g=f.closest(".c-call-wrapper"),h=g.data("id");e=f.data("title");
d.waDialog.confirm({title:`<i class=\"fas fa-exclamation-triangle smaller state-error\"></i> ${e}?`,text:b.locales.delete_confirm_text,success_button_title:b.locales.delete_confirm_button,success_button_class:"danger custom-mr-4",cancel_button_title:`${b.locales.delete_cancel_button}`,cancel_button_class:"light-gray",onSuccess:function(){if(!c){c=!0;var k={id:h},l=f.find(".delete");l.removeClass("delete").addClass("loading");d.post("?module=call&action=delete",k,function(m){"ok"===m.status&&g.remove()}).always(function(){l.removeClass("loading").addClass("delete");
c=!1})}}})}var b=this,c=!1;b.$wrapper.on("click",".js-delete-call",function(e){e.preventDefault();a(d(this))})};CRMCallPage.prototype.initAssociateDeal=function(){this.$wrapper.on("click",".js-associate-deal",function(a){a=d(this).data("dialog-url");var b=d(this);b.prop("disabled",!0);d.get(a,function(c){d.waDialog({html:c,onOpen:function(e,f){b.prop("disabled",!1)}})})})};CRMCallPage.prototype.initBackgroundReload=function(){function a(){clearTimeout(f);f=setTimeout(b,1E4)}function b(){var g=!1,
h=c.$wrapper.find("audio");d.each(h,function(k,l){d(l)[0].ended||(g=!0)});if(g)return a(),!1;e||(e=!0,d.post("?module=call&action=ts&background_process=1",{call_ts:c.call_ts},function(k){"ok"==k.status&&d.contains(document,c.$wrapper[0])&&(k.data!==c.call_ts?d.crm.content.reload():a())}).always(function(){e=!1}))}var c=this,e=!1,f=0;a()};CRMCallPage.prototype.initLazyLoading=function(){function a(){function e(){if(d.contains(document,k[0])){var l=k,m=d(window).scrollTop(),n=g.height(),p=l.offset().top;
m+n>=p&&(c||f(l))}else g.off("scroll",e)}function f(l){var m=window.location.href.split("/crm/call/")[1];m=d.crm.app_url+"?module=call"+(m?"&"+m.slice(1):"");data={lazy:1,page:++b.current_page};c=!0;console.log(m);d.post(m,data,function(n){n=d(n).find("#js-calls-table").html();h.append(n);d(document).trigger("wa_loaded");l&&l.remove();a()}).always(function(){c=!1})}var g=d(window),h=b.$wrapper.find("#js-calls-table"),k=b.$wrapper.find(".js-lazy-load");if(k.length)g.on("scroll",e)}var b=this,c=!1;
a()};return CRMCallPage}(jQuery);var CRMCallAssociateDealDialog=function(d){CRMCallAssociateDealDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$submit=this.$form.find(".js-submit");this.$deal_name=this.$form.find(".js-deal-name");this.$deal_funnel=this.$form.find(".js-select-deal-funnel");this.$deal_stage=this.$form.find(".js-select-deal-stage");this.$deal_id=this.$form.find(".js-deal-id");this.initClass()};CRMCallAssociateDealDialog.prototype.initClass=
...
else{console.log("Error saving Responsible contact classification: "+arguments[2],arguments);var h="Error saving Responsible contact classification: "+arguments[2];h=d('<div class="errormsg" />').text(h);b.$errorsPlace.append(h)}},"json").always(function(){b.$button.attr("disabled",!1);f.remove()})}var b=this;b.$wrapper.find(".js-delete-message").on("click",function(){event.preventDefault();d.crm.confirm.show({title:b.locales.delete_message,text:b.locales.delete_message_text,button:b.locales["delete"],
...
this.$button=this.$wrapper.find(".js-close-dialog");this.contact_id=a.contact_id;this.message=a.message||{};this.locales=a.locales;this.initClass()};CRMMessageBodyDialog.prototype.initClass=function(){this.initMessageShowBodyLink();this.is_admin&&(this.initSelectDeal(),this.initMessageDeleteLink())};CRMMessageBodyDialog.prototype.initSelectDeal=function(){function a(){q.html(""+c.locales.deal_empty);t.val("none");g.val("");f.addClass("hidden");h.addClass("hidden").removeAttr("title");k.addClass("hidden");
p.addClass("hidden");r.addClass("hidden");v.find("li").removeClass("selected");l.removeClass("hidden");m.removeClass("hidden")}function b(){var x=c.$wrapper.find(".js-created-deal"),y=u.find(".js-visible-link .js-text .funnel-state").clone(),z=d.trim(g.val()),B=e.serializeObject();B.message_id=c.message.id;if("none"===t.val())return e.addClass("shake animated"),setTimeout(function(){e.removeClass("shake animated")},500),!1;if(0>=t.val()&&!z)return f.addClass("shake animated"),setTimeout(function(){f.removeClass("shake animated");
g.focus()},500),!1;e.addClass("hidden");x.removeClass("hidden");0>=t.val()?(x.html(y),x.append(d.crm.escape(z))):(z=m.find(".js-visible-link .js-text"),y=z.find(".funnel-state").clone(),z=z.find("b i").text(),x.html(y),x.append(d.crm.escape(z)));d.post(d.crm.app_url+"?module=message&action=associateDealSave",B,function(C){if("ok"===C.status&&C.data.deal_url){var A=x.html();x.html('<a href="'+C.data.deal_url+'">'+A+"</a>")}else x.html(""),x.addClass("hidden"),a(),e.removeClass("deal-form-hidden")})}
var c=this,e=c.$wrapper.find(".deal-form"),f=e.find(".js-deal-name"),g=e.find(".js-deal-name-input"),h=e.find(".js-save-deal"),k=e.find(".js-deal-save-details"),l=e.find(".js-select-deal"),m=e.find(".js-deals-dropdown"),n=e.find(".js-remove-deal"),p=m.find(".js-empty-deal"),q=e.find(".js-select-deal .js-visible-link .js-text"),r=e.find(".js-select-funnel-wrapper"),u=e.find(".js-select-stage-wrapper"),v=e.find(".js-deals-list"),t=e.find(".js-deal-id"),w=c.contact_id;t.val("none");w&&d.get("?module=deal&action=byContact&id="+
w,function(x){"ok"===x.status&&d.each(x.data.deals,function(y,z){v.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+z.id+'"><i class="fas fa-circle funnel-state" style="color: '+x.data.funnels[z.funnel_id].stages[z.stage_id].color+'"></i><span class="js-text">'+z.name+"</span></a></li>")})},"json");e.on("click",".js-create-new-deal",function(){t.val("0");l.addClass("hidden");m.addClass("hidden");f.removeClass("hidden");h.attr("title",c.locales.deal_create).text(c.locales.deal_create).removeClass("hidden");
k.removeClass("hidden");r.removeClass("hidden");p.removeClass("hidden");g.focus()});e.on("click",".js-deal-item",function(){var x=d(this).find(".js-text").html();q.html(x);t.val(d(this).data("deal-id"));h.attr("title",c.locales.deal_add).text(c.locales.deal_add).removeClass("hidden");k.removeClass("hidden");r.addClass("hidden");p.removeClass("hidden");v.find("li").removeClass("selected");d(this).parent().addClass("selected")});v.on("click",function(){v.hide();setTimeout(function(){v.removeAttr("style")},
200)});p.on("click",function(){a()});n.on("click",function(){a()});h.on("click",function(x){x.preventDefault();e.trigger("submit")});e.on("submit",function(x){x.preventDefault();b()});e.on("change",".js-select-deal-funnel",function(){console.log(d(this).val());e.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};CRMMessageBodyDialog.prototype.initMessageShowBodyLink=function(){var a=this.dialog,b=this.$wrapper;this.initMessageReplyBtn(b,a);this.initMessageForwardBtn(b,
a);b.on("click","a",function(c){"javascript:void(0);"!==d(this).prop("href")&&a.close()})};CRMMessageBodyDialog.prototype.initMessageReplyBtn=function(a,b){var c=this;a.on("click",".js-message-reply",function(){function e(h){var k=f.find(".icon");if(!k.length)return!1;h?k.removeClass("fa-undo").addClass("fa-spinner fa-spin"):k.removeClass("fa-spinner fa-spin").addClass("fa-undo")}var f=d(this),g=f.data("message-id");e(!0);d.post(c.app_url+"?module=message&action=writeReplyDialog",{id:g},function(h){d.waDialog({html:h,
onClose:function(){}})}).always(function(){e(!1)})})};CRMMessageBodyDialog.prototype.initMessageForwardBtn=function(a,b){var c=this;a.on("click",".js-message-forward",function(){function e(h){var k=f.find(".icon");if(!k.length)return!1;h?k.removeClass("fa-redo").addClass("fa-spinner fa-spin"):k.removeClass("fa-spinner fa-spin").addClass("fa-redo")}var f=d(this),g=f.data("message-id");e(!0);d.post(c.app_url+"?module=message&action=writeForwardDialog",{id:g},function(h){d.waDialog({html:h})}).always(function(){e(!1)})})};
CRMMessageDeleteLinkMixin.mixInFor(CRMMessageBodyDialog);return CRMMessageBodyDialog}(jQuery),CRMMessagesSidebar=function(d){CRMMessagesSidebar=function(a){this.$wrapper=a.$wrapper;this.$ui=a.$ui;this.no_messages="true"===a.empty_conversations;this.$sidebar=this.$wrapper.parent();this.$list=this.$wrapper.find(".c-messages-table-section");this.$skeleton=this.$sidebar.find(".skeleton-wrapper");this.page_of_item=a.page_of_item;this.current_page=a.current_page;this.active_id=a.active_id;this.last_message_id=
a.last_message_id;this.$settings_contact_id=+a.settings_contact_id;this.$settings_deal_id=+a.settings_deal_id;this.settings=a;this.iframe=a.iframe;this.noemail=a.noemail;this.initClass()};CRMMessagesSidebar.prototype.initClass=function(){var a=this;a.initLazyLoading();a.initSearchHandler();a.conversationListHandler();new CRMPageMessagesOperations(a.settings);a.no_messages&&a.$wrapper.closest("#c-messages-sidebar").addClass("no-messages-sidebar");a.$wrapper.on("click",".js-associate-deal",function(c){c.preventDefault();
c=d(this).data("dialog-url");d.get(c,function(e){d.waDialog({html:e})})});var b=!1;a.$wrapper.on("click",".js-write-message",function(c){c.preventDefault();b||(b=!0,c=d.crm.app_url+"?module=message&action=writeNewDialog",data={contact_id:a.$settings_contact_id?a.$settings_contact_id:null,deal_id:a.$settings_deal_id?a.$settings_deal_id:null},d.get(c,data,function(e){d.waDialog({html:e,onOpen:function(){b=!1}})}))});a.$wrapper.on("click",".js-filter-open",function(){a.$wrapper.find(".c-message-filter-wrapper").toggle()});
a.current_page&&a.initBackgroundUpdate()};CRMMessagesSidebar.prototype.initSearchHandler=function(){var a=this,b=a.$sidebar;a.$search_wrapper=b.find(".js-search-wrapper");var c=a.$search_wrapper;$page_name=b.find(".js-page-name-header");$autocomplete=c.find(".js-search-field");$search_block=c.find(".state-with-inner-icon");a.iframe||($autocomplete.autocomplete({appendTo:c,source:d.crm.app_url+"?module=autocompleteContact",minLength:2,delay:300,html:!0,focus:function(){return!1},select:function(e,
f){d.crm.content.load(d.crm.app_url+"message/?contact="+f.item.id);a.$skeleton.show();$autocomplete.val("");return!1}}).data("ui-autocomplete")._renderItem=function(e,f){e.css("max-height","70vh");e.css("overflow-y","scroll");e.css("max-width","200px");return d("<li />").addClass("ui-menu-item-html").append("<div>"+f.label+"</div>").appendTo(e)});c.on("click",".js-search-contact-cancel",function(){a.$skeleton.show();d.crm.content.load(d.crm.app_url+"message/")});c.on("click",".js-search-mobile-show",
function(e){c.find(".js-search-mobile-show").removeClass("mobile-only").hide();$page_name.removeClass("mobile-only").hide();$search_block.removeClass("desktop-and-tablet-only");c.find(".js-search-contact-hide").show()});c.on("click",".js-search-contact-hide",function(e){c.find(".js-search-contact-hide").hide();c.find(".js-search-mobile-show").add("mobile-only").show();$page_name.addClass("mobile-only").show();$search_block.addClass("desktop-and-tablet-only")})};CRMMessagesSidebar.prototype.initBackgroundUpdate=
function(){function a(){d(document).off("msg_sidebar_upd_needed");d(document).off("change_active_id")}function b(l=!1){clearTimeout(k);l?c():k=setTimeout(c,12E4)}function c(){h||(h=!0,d.contains(document,f.$wrapper[0])&&d.post("?module=message&action=listByConversation&background_process=1",{check:1},function(l){"ok"===l.status&&(l=l.data!==g,d.contains(document,f.$wrapper[0])&&(l&&!d(".dialog-background:visible").length?e():b()))},"json").always(function(){h=!1}))}function e(){var l=d.crm.app_url+
"message/"+(f.active_id?"conversation/"+f.active_id+"/":"")+"?reload=1"+(f.$settings_contact_id?"&contact="+f.$settings_contact_id:f.$settings_deal_id?"&deal="+f.$settings_deal_id:"")+(f.iframe?"&iframe="+f.iframe:"")+(f.noemail?"&noemail=1":""),m={ui:f.$ui,id:+f.active_id,background_process:1,no_need_to_get_the_conversation:1};a();f.$wrapper.off("click");f.$search_wrapper.off("click");f.$list.off("click");clearTimeout(k);d.get(l,m,function(n){n=d(n).find("#c-messages-conversation-list").html();f.$wrapper.html(n)})}
var f=this,g=f.last_message_id,h=!1,k=0;a();d(document).on("change_active_id",function(l,m){m.target_id&&(f.active_id=m.target_id)});d(document).on("msg_sidebar_upd_needed",function(){b(!0)});b()};CRMMessagesSidebar.prototype.conversationListHandler=function(){function a(g){g.preventDefault();g.stopPropagation();g=d(this);var h=e.next();let k=g.prop("href"),l=g.parent().data("id");target_props=l+(b.iframe?"&iframe=1&view=chat":"&view=chat")+(b.$settings_contact_id?"&contact="+b.$settings_contact_id:
b.$settings_deal_id?"&deal="+b.$settings_deal_id:"");d.message.content.load(k,!1,target_props,l,g);c.find(".selected").removeClass("selected");g.parent().addClass("selected").removeClass("unread");h.is(":visible")||(e.addClass("desktop-and-tablet-only"),h.removeClass("desktop-and-tablet-only"))}var b=this,c=b.$list,e=b.$sidebar,f=d(window);c.on("click","a",a);f.on("beforeunload",function(){c.off("click","a",a)});d(document).ready(function(){b.scrollToSelected();b.$skeleton.hide()})};CRMMessagesSidebar.prototype.scrollToSelected=
function(){var a=this.$sidebar,b=this.$list.find(".js-message-wrapper.selected");if(b.length){var c=b.offset().top;target_h=b.height();viewportHeight=d(window).height();scrollIt=c-(viewportHeight-target_h)/2;a.scrollTop(scrollIt)}};CRMMessagesSidebar.prototype.initLazyLoading=function(){function a(){function m(){if(d.contains(document,n[0])){var q=n,r=f.scrollTop(),u=f.height(),v=q.offset().top;r+u>=v&&(e||b(q))}else g.off("scroll touchmove",m)}var n=k.find(".js-lazy-load");e=!1;if(l&&l>c.current_page)b(n);
else if(l&&l==c.current_page&&c.scrollToSelected(),n.length){var p=1==c.current_page&&f.height()-64>h?!0:!1;if(p)m();else g.on("scroll touchmove",m)}}function b(m){var n=d.crm.app_url+"?module=messageListByConversation",p=c.$settings_contact_id?+c.$settings_contact_id:void 0,q=c.$settings_deal_id?+c.$settings_deal_id:void 0;data={id:+c.active_id,page:++c.current_page,contact:p,deal:q,reload:1,iframe:c.iframe};e=!0;d.post(n,data,function(r){m&&m.remove();r=d(r).find(".c-messages-table-section").html();
k.append(r);a()}).always(function(){})}var c=this,e=!1,f=d(window),g=c.$sidebar,h=g.find(".c-messages-conversation-list").height(),k=c.$list,l=c.page_of_item;a()};return CRMMessagesSidebar}(jQuery);var CRMMessageConversationPage=function(d){CRMMessageConversationPage=function(a){this.$wrapper=a.$wrapper;this.locales=a.locales;this.conversation_id=a.conversation_id;this.contact_id=a.contact_id;this.filter_contact_id=a.filter_contact_id;this.filter_deal_id=a.filter_deal_id;this.funnel_id=a.funnel_id;this.last_message_id=a.last_message_id;this.check_interval=a.check_interval;this.$replySection=this.$wrapper.find(".c-reply-section");this.iframe=a.iframe;this.old_message_id=a.old_message_id;this.$dropdown_name=
...
text:c.locales.remove_owner_text.replace(/%s/,w),button:c.locales.remove_owner_button,onConfirm:function(){q()}})})}var c=this,e=!1,f=c.$wrapper.find(".js-conversation-contact"),g=c.$wrapper.find(".js-open-responsible-dialog"),h=c.$wrapper.find("#dropdown-c-contact");$responsible_wrapper_dialog=c.$wrapper.find(".js-conversation-responsible-wrapper");html_content=$responsible_wrapper_dialog.html();f.on("click",".js-open-second-menu",function(l){setTimeout(()=>{h.find(".dropdown-toggle").trigger("click")},
50)});h.on("click",".js-return-back",function(l){setTimeout(()=>{c.$dropdown_name.find(".dropdown-toggle.c-name").trigger("click")},50)});h.on("click",".js-remove-owner",function(l){l.preventDefault();l=d.trim($responsible_wrapper_dialog.find(".c-name").html());d.crm.confirm.show({title:c.locales.remove_owner_title,text:c.locales.remove_owner_text.replace(/%s/,l),button:c.locales.remove_owner_button,onConfirm:function(){a()}})});const k=`<div class="dialog dialog-conversation-responsible" id="my-dialog">
        <div class="dialog-background"></div>
...
(new ResizeObserver(k=>{k=k[0].target.scrollHeight+1;g.css("height",k);300<k&&c.$wrapper.removeClass("hidden")})).observe(h[0]):setTimeout(()=>b(),100);g.on("beforeShowModal",()=>{g.addClass("height-full");c.$main_wrapper.addClass("freeze-sidebar")});g.on("beforeCloseModal",()=>{g.removeClass("height-full");c.$main_wrapper.removeClass("freeze-sidebar")})}var c=this,e=!1,f=d(window).width();if(1024<=f)a(c.contact_id),e=!0;else d(window).on("resize",function(){e||d(this).width()===f||(f=d(this).width(),
1024<=f&&(a(c.contact_id),e=!0))});d(document).on("updateProfile",(g,h)=>{c.$main_wrapper.find("iframe").remove();a(h.contact_id)});c.initTopInfoFields();c.initAdditionalContentLink()};CRMMessagesProfileAdditional.prototype.initTopInfoFields=function(){function a(){var g=d.crm.app_url+"?module=contact&action=tabs&id="+b.contact_id;f=!0;b.item_html={};d.get(g).done(function(h){d.each(h.data.tabs,function(k,l){e.append(`<li class="custom-mb-16 bold">
...
v){u=n;var t=u.push,w=d(l);w.find(".js-name").text(v.name);k.prepend(w);!e.iframe&&e.dialog.resize();t.call(u,{$file:w,file:v})})}function c(r){var u=[];d.each(n,function(v,t){r[0]!==t.$file[0]?u.push(t):r.remove()});n=u}var e=this,f=e.$wrapper.find(".js-files-wrapper");if(!f.length)return!1;var g=e.$wrapper.find(".js-drop-area"),h=e.$wrapper.find(".js-drop-field"),k=f.find(".c-upload-list"),l=e.file_template_html,m=e.app_url+"?module=file&action=uploadTmp",n=[],p=0,q=0;h.on("change",function(r){r.preventDefault();
...
d.crm?d.crm.content.reload():b.crm.content.reload()});n=setTimeout(function(){b.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):b.dialog.close()},2500)}else!b.iframe&&b.dialog.close(),d.isEmptyObject(m.errors)?l({common:"Send error"},m):l(m.errors)}).always(function(){b.is_locked=!1}).fail(function(m){l({},m);!b.iframe&&b.dialog.close()})}};CRMSendEmailDialog.prototype.initPersonalSettingsDialog=function(){function b(){c.is_locked||(c.is_locked=!0,d.post(c.crm.app_url+
...
c(0,g,t),l.val(d.crm.escape(f)));if(f&&!g)return t='<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b>'+d.crm.escape(f)+'</b></span> <input class="c-to-input js-to-add-email" type="text" autocomplete="off" placeholder="'+e.locales.type_email+'" style="margin-left: 8px; width: 150px;" />',c(0,null,t),l.val(d.crm.escape(f)),d(".js-to-add-email").focus(),!1;if(g&&!f)return t='<input class="c-to-input js-to-add-name" type="text" autocomplete="off" placeholder="'+e.locales.type_name+
...
var q=p.data("email");p.remove();d(".email-copy-text-collapsed").children('[data-email="'+q+'"]').remove();l.focus()}})};CRMSendEmailDialog.prototype.initSelectDeal=function(){function b(){var n=l.val();k.val("none");n&&d.get("?module=deal&action=byContact&id="+n,function(p){"ok"===p.status&&d.each(p.data.deals,function(q,r){h.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+r.id+'"><span class="js-text flexbox"><i class="fas fa-circle funnel-state" style="color: '+
p.data.funnels[r.funnel_id].stages[r.stage_id].color+'"></i><span class="flexbox">'+r.name+"</span></span></a></li>")})},"json")}var c=this,e=c.$form.find(".js-select-deal .js-visible-link .js-text"),f=c.$form.find(".js-select-funnel"),g=c.$wrapper.find(".js-deal-field"),h=c.$form.find(".js-deals-list"),k=c.$form.find(".js-deal-id"),l=c.$to_id,m=c.$form.find(".js-empty-deal");c.$form.on("click",".js-create-new-deal",function(){var n=d(this).find(".js-text").html();f.removeClass("hidden");m.removeClass("c-empty-deal-hidden");
e.html(n);k.val("0")});m.on("click",function(){d(this).addClass("c-empty-deal-hidden");f.addClass("hidden");h.find("li").removeClass("selected");e.html(c.locales.deal_empty);k.val("none")});c.$form.on("click",".js-deal-item",function(){var n=d(this).find(".js-text").html();h.find("li").removeClass("selected");d(this).parent().addClass("selected");e.html(n);m.removeClass("c-empty-deal-hidden");f.addClass("hidden");k.val(d(this).data("deal-id"))});"reply"==c.action&&b();"new"==c.action&&0<l.val()&&
(b(),g.removeClass("hidden"));l.on("change",b);h.on("click",function(){h.hide();setTimeout(function(){h.removeAttr("style")},200)});c.$form.on("change",".js-select-deal-funnel",function(){c.$form.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};return CRMSendEmailDialog}(jQuery);var CRMSendSmsDialog=function(d){CRMSendSmsDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$textarea=this.$wrapper.find(".js-send-sms-textarea");this.$footer=this.$wrapper.find(".dialog-footer");this.dialog=this.$wrapper.data("dialog");this.success_html=a.success_html;this.error_html=a.error_html;this.hash=a.hash;this.send_action_url=a.send_action_url;var b=!1;window&&window.parent&&window.parent.$&&window.parent.$.crm?b=window.parent.$.crm:window.$&&window.$.crm&&
...
f=this.$wrapper.find(".c-color-section .js-color-field"),g=this.$wrapper.find(".c-color-section .c-stages"),h=e.find(".is-active"),k=function(l){k=function(m){this.$wrapper=m.$wrapper;this.$field=f;this.$icon=this.$wrapper.find(".js-toggle");this.$colorPicker=this.$wrapper.find(".js-color-picker");this.farbtastic=this.is_opened=!1;this.initClass()};k.prototype.initClass=function(){function m(){h.length&&(h.removeClass("is-active"),h=!1)}var n=this;n.farbtastic=l.farbtastic(n.$colorPicker,function(p){n.$field.val()!==
p&&(m(),n.$field.val(p).change())});n.$wrapper.data("colorPicker",n);n.$field.on("change keyup",function(){var p=l(this).val();n.$icon.css("background-color",p);n.farbtastic.setColor(p)});n.$icon.on("click",function(p){p.preventDefault();n.displayToggle(!n.is_opened)});n.$field.on("click",function(){n.displayToggle(!n.is_opened)});n.$field.on("keyup",m)};k.prototype.displayToggle=function(m){m?(this.$wrapper.removeClass("is-hidden"),this.is_opened=!0):(this.$wrapper.addClass("is-hidden"),this.is_opened=
!1)};return k}(jQuery);e.on("click",".js-set-color",function(l){l.preventDefault();l=d(this);h.length&&h.removeClass("is-active");l.addClass("is-active");h=l;l=l.data("color");f.val(l).change()});f.on("change",function(){a(f.val())});new k({$wrapper:this.$wrapper.find(".js-toggle-wrapper").first()});f.change();d.crm.renderSVG(this.$wrapper)};CRMSettingsFunnel.prototype.initStagesSection=function(){function a(f){function g(h){function k(){var q=parseInt(m.val()),r=parseInt(p.val()),u="";0<q&&0<r&&
(u=q*r);n.val(u)}function l(q){q?(h.addClass("is-extended"),m.focus()):(h.removeClass("is-extended"),m.val(""),n.val(""),b.toggleButton(!0))}var m=h.find(".js-visible-time-field"),n=h.find(".js-hidden-time-field"),p=h.find(".js-time-period-select");h.on("click",".js-show-time",function(){l(!0)});h.on("click",".js-remove-limit",function(){l(!1)});m.on("change",k);p.on("change",k);m.on("keyup",function(){var q=d(this),r=q.val();r=parseInt(r.replace(",","").replace(".",""));isNaN(r)?q.val(""):r?q.val(r):
...
f=d(b.stage_html);b.$stages.append(f);a(f);b.toggleButton(!0)});e.sortable({distance:10,handle:".js-sort-toggle",helper:"clone",items:"> li",axis:"y",start:function(f,g){},stop:function(f,g){b.toggleButton(!0)}});a(e)};CRMSettingsFunnel.prototype.initSave=function(){function a(){var k=c.$form.serializeArray();c.$stages.find("li").each(function(l){var m=d(this),n=m.data("id");k.push({name:"stages["+l+"][name]",value:m.find(".js-name-field").val()});n&&k.push({name:"stages["+l+"][id]",value:n})});return k}
function b(k){f.insertAfter(h);d.post("?module=settings&action=funnelSave",k,function(l){"ok"===l.status&&(f.remove(),g.insertAfter(h),d.crm.content.load(d.crm.app_url+"settings/funnels/"+l.data.id+"/"))},"json").always(function(){e=!1})}var c=this,e=!1,f=d('<span class="c-notice"><i class="fas fa-spinner wa-animation-spin speed-1000 js-loading"></i></span>'),g=d('<span class="c-notice"><i class="fas fa-check"></i></span>'),h=c.$wrapper.find(".js-funnel-save-button");c.$form.on("submit",function(k){k.preventDefault();
...
this.$wrapper.find(".crm-form-email-confirm-block");this.$back_button=this.$wrapper.find(".crm-form-header .js-back-button");this.$create_deal_block_wrapper=this.$wrapper.find(".crm-form-settings-block-form_create_deal");this.$button=this.$form.find("[type=submit]");this.$delete_link=this.$wrapper.find(".crm-delete-form-link");this.$copy=this.$wrapper.find(".js-copy");this.$external_code=this.$wrapper.find(".js-external-code");this.$available_deal_related_field=this.$form_available_fields.find('.crm-form-field[data-form-field-type="deal"]').add(this.$form_available_fields.find('.crm-form-field[data-id="!deal_description"]')).add(this.$form_available_fields.find('.crm-form-field[data-id="!deal_attachments"]'));
this.$edit_dialog_template=this.$wrapper.find("template.crm-settings-form-edit-field-wrapper");this.$checkbox_edit_dialog_template=this.$wrapper.find("template.crm-settings-form-edit-checkbox-wrapper");this.$paragraph_edit_dialog_template=this.$wrapper.find("template.crm-settings-form-paragraph-edit-wrapper");this.$agreement_checkbox_edit_dialog_tempalte=this.$wrapper.find("template.c-settings-form-agreement-checkbox-edit-wrapper");this.$button_edit_dialog_template=this.$wrapper.find("template.crm-settings-form-button-edit-wrapper");
this.referrer=d.crm.storage.get("crm/settings/web_form_referrer");d.crm.storage.del("crm/settings/web_form_referrer");this.form=a.form||{};this.form.params=this.form.params||{};this.form.params.fields=this.form.params.fields||[];this.available_fields=a.available_fields||{};this.lang=a.lang;this.messages=a.messages||{};a=a.default_checked_fields||[];if(0>=this.form.id&&"settings/sources"===this.referrer){var b=a.indexOf("password");0<=b?a[b]="!deal_description":a.push("!deal_description")}this.default_checked_fields=
a;this.changed=this.sortable_is_active=!1;this.submit_xhr=null;this.initClass()};crmSettingsForm.prototype.initClass=function(){this.initDealCreateCheckbox();this.renderDealDescription();this.bindEvents();this.initIButtons();this.initAvailableFields();this.initDeleteFieldLinks();this.initFormWidthInput();this.initFields();this.initSubmit();this.initDeleteLink();this.initSortable();this.initTextEditor();this.initCopySmartyHelper();this.initExternalCode();this.initMessagesBlock();this.initCancelLink();
this.initBlocks();this.initMarginsSettings();this.initViewModeToggler();this.initSubmitPlacement()};crmSettingsForm.prototype.renderDealDescription=function(a){var b=this.$form_fields.find('[data-id="!deal_description"]').find("textarea");a||=this.getField("!deal_description");!a||0>=a.checked||!b.length||(a.redactor?b.data("redactor")?(a=b.redactor("core.editor"))&&0<a.length&&a[0].attr("placeholder",b.attr("placeholder")):d.crm.initWYSIWYG(b,{focus:!1,buttons:["bold","italic","underline","link"],
plugins:[],maxHeight:100,minHeight:100}):(b.data("redactor")&&b.redactor("core.destroy"),b.show()))};crmSettingsForm.prototype.bindEvents=function(){var a=this;a.$form.on("change","input,textarea,select",function(b){a.setFormChanged();b.isTrigger||a.clearValidateErrors()});a.$form.on("keyup","input:text,textarea",function(b){a.setFormChanged();b.isTrigger||a.clearValidateErrors()});a.$form.find(".js-show-external-code").click(function(){a.$external_code.slideToggle();d(this).find("svg").toggleClass("fa-caret-down fa-caret-up")})};
crmSettingsForm.prototype.initDealCreateCheckbox=function(){var a=this,b=a.referrer,c=function(e){var f=a.$wrapper.find(".js-responsible-section").data("block_object");e?(a.$available_deal_related_field.removeClass("crm-disabled"),a.$wrapper.find(".js-hint-about-deal-fields").hide(),a.$wrapper.find(".js-hint-about-deal-fields").next().addClass("crm-top-bordered"),f.reload({})):(a.$available_deal_related_field.each(function(){var g=d(this).data("id");a.getFormField(g).find(".crm-delete-field-link").trigger("click")}),
a.$available_deal_related_field.addClass("crm-disabled"),a.$wrapper.find(".js-hint-about-deal-fields").show(),a.$wrapper.find(".js-hint-about-deal-fields").next().removeClass("crm-top-bordered"),f.reload({funnel_id:0}))};a.$create_deal_block_wrapper.on("toggled",function(e,f){c(f,!0)});0>=a.form.id&&"settings/sources"===b&&(a.$create_deal_block_wrapper.find(":checkbox").attr("checked",!0).trigger("change"),c(!0,!1))};crmSettingsForm.prototype.setFormChanged=function(a){(a=void 0!==a?a:!0)?this.$button.addClass("yellow"):
this.$button.removeClass("yellow");this.changed=a};crmSettingsForm.prototype.initPreviewButton=function(){var a=this.$wrapper,b=a.find(".crm-form-preview-submit-button-caption-input"),c=a.find(".crm-form-preview-submit-button"),e=function(f){f?(b.show(),c.hide(),b.val(c.val())):(b.hide(),c.show())};c.click(function(){e(!0)});b.blur(function(){c.val(b.val());e(!1)}).keyup(function(f){f.preventDefault();13==f.keyCode?(c.val(b.val()),e(!1)):27==f.keyCode&&e(!1)})};crmSettingsForm.prototype.initViewModeToggler=
function(){const a=this.$wrapper.find(".js-view-mode-toggler"),b=this.$wrapper.find(".crm-form-preview-block"),c={desktop:"crm-preview-mode crm-preview-mode-desktop",mobile:"crm-preview-mode crm-preview-mode-mobile"};a.waToggle({change:(e,f)=>{b.removeClass(Object.values(c));e=f.dataset.id;e in c&&b.addClass(c[e])}})};crmSettingsForm.prototype.initSubmitPlacement=function(){const a=this,b=a.$wrapper.find(".crm-form-preview-block .crm-form-fields:not(.crm-form-field-submit)"),c=()=>{if(!a.sortable_is_active){var e=
b.find('.crm-form-field[data-checked="1"]:not(.crm-form-field-template)').last(),f=e.find(".field > .name");e=e.hasClass("crm-caption-style-above")||f.length&&(f.is(":hidden")||!f.text().trim());a.getButton().captionplace=e?"left":"";a.renderButton()}};c();(new MutationObserver(c)).observe(b[0],{childList:!0,subtree:!0})};crmSettingsForm.prototype.initFormWidthInput=function(){var a=this.$wrapper,b=a.find(".crm-form-width-input"),c=a.find(".crm-form-preview-block");b.keyup(function(e){13==e.keyCode&&
(b.val(Math.max(Math.min(parseInt(b.val(),10)||0,600),200)),c.width(1*b.val()+68))})};crmSettingsForm.prototype.initMarginsSettings=function(){var a=this.$wrapper.find(".crm-form-preview-block");let b=null;this.$wrapper.find("input[data-css-var]").on("keyup change",function(){b&&clearTimeout(b);const c=d(this);b=setTimeout(()=>{a.css(c.data("css-var"),c.val()+c.data("css-unit"));b=null},500)})};crmSettingsForm.prototype.initTextEditor=function(){var a=this,b=a.$form.find('[name="form[params][confirm_mail_body]"]');
b.waEditor({focus:!1,buttons:["formatting","bold","italic","link"],plugins:["fontcolor","fontsize","fontfamily"],minHeight:200,callbacks:{keydown:function(c){},change:function(){b.waEditor("sync");a.setFormChanged()}},lang:a.lang})};crmSettingsForm.prototype.initMessagesBlock=function(){var a=this,b=a.$wrapper,c=b.find(".c-settings-messages-block");b=b.find(".js-deal-section");a.renderToVariantSelectors();c.on("loadEditor",function(){a.renderToVariantSelectors()});b.on("changeResponsibleUser",function(){a.renderToVariantSelectors()})};
crmSettingsForm.prototype.renderToVariantSelectors=function(){var a=this.$wrapper.find(".c-settings-messages-block"),b=this.getField("email"),c=b&&0<b.checked,e=function(f,g){var h=f.closest("label");g?(f.data("checked",f.is(":checked")),f.prop("disabled",!0).prop("checked",!1)):f.prop("disabled",!1).prop("checked",f.data("checked"));f.is(":checked")?h.addClass("bold"):h.removeClass("bold")};a.find(".c-message-to-selector").each(function(){var f=d(this),g=f.find(".c-label");f=f.find(".c-message-to-variants-list");
var h=f.find(':checkbox[data-id="client"]');e(h,!c);var k=[];f.find(":checkbox:checked:not(:disabled)").each(function(){var l=d(this).closest("li");k.push(l.find(".c-variant-name-text").text())});k=0<k.length?k.join(", "):g.data("initial_text");g.text(k)})};crmSettingsForm.prototype.getField=function(a,b){var c=this.form.params.fields,e=c.length,f=null;b="undefined"===typeof b?1:parseInt(b,10)||0;if(0>=b)return null;for(var g=0;g<e;g+=1)if(c[g].id==a&&c[g].checked==b){f=c[g];break}if(!f)return f;
f.required=f.required||"";f.captionplace=f.captionplace||"left";f.caption=f.caption||"string"===typeof f.caption?f.caption:f.name;f.placeholder=f.placeholder||"";return f};crmSettingsForm.prototype.getButton=function(){var a=this.form.params.button;if(!a)return{captionplace:"",width:"auto",caption:this.form.params.button_caption};a.captionplace=a.captionplace||"";a.width=a.width||"auto";a.caption=a.caption||this.form.params.button_caption;return a};crmSettingsForm.prototype.getAvailableField=function(a){if(this.available_fields[a]){a=
...
e=c.length;b=parseInt(b,10)||0;for(var f=[],g=0;g<e;g+=1)c[g].id==a&&c[g].checked==b||f.push(c[g]);b=0;e=f.length;for(g=0;g<e;g+=1)f[g].id==a&&(b+=1,f[g].checked=b);this.form.params.fields=f};crmSettingsForm.prototype.updateField=function(a,b,c){if(!(0>=b)){for(var e=this.getField(a,b),f=this.form.params.fields,g=this.form.params.fields.length,h=-1,k=0;k<g;k+=1)if(f[k].id==a&&f[k].checked==b){h=k;break}0>h||(e=d.extend(e,c),this.form.params.fields[h]=e,this.setFormChanged())}};crmSettingsForm.prototype.updateButton=
function(a){var b=this.getButton();b=d.extend(b,a);this.form.params.button=b;this.form.params.button_caption=b.caption;this.setFormChanged()};crmSettingsForm.prototype.renderField=function(a,b){var c=this.getField(a,b),e=this.$form_fields.find('.crm-form-field:not(.crm-form-field-template)[data-id="'+a+'"][data-checked="'+b+'"]');if(c)if(e.length||(e=this.$form_fields.find('.crm-form-field-template.crm-form-field-template[data-id="'+a+'"]').clone(),e.removeClass("crm-form-field-template"),e.attr("data-checked",
b),e.insertBefore(this.$form_fields.find(".crm-form-field-template:first")),e.show()),"!paragraph"===c.id)e.find(".crm-paragraph").html(c.text||"");else{a=e.find(".js-field-label");b=a.html;var f=(f=c.caption)&&(""+f).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");b.call(a,f+(c.required&&"!captcha"!==c.id?" *":""));e.removeClass("crm-caption-style-none crm-caption-style-above").addClass("crm-caption-style-"+c.captionplace);if("Composite"===c.type||"Address"===c.type)"none"===c.subfield_captionplace?
e.find(".crm-composite-field").removeClass("horizontal").addClass("no-name").find(".field").removeClass("vertical"):"left"===c.subfield_captionplace?e.find(".crm-composite-field").addClass("horizontal").removeClass("no-name").find(".field").removeClass("vertical"):e.find(".crm-composite-field").removeClass("horizontal").removeClass("no-name").find(".field").addClass("vertical");"Checkbox"===c.type&&e.find(".name").html("");e.find(":input:eq(0)").prop("placeholder",c.placeholder||"");"password"===
c.id&&e.find(":input:eq(1)").prop("placeholder",c.placeholder_confirm||"");"!deal_description"===c.id&&this.renderDealDescription(c)}else e.remove()};crmSettingsForm.prototype.renderButton=function(){var a=this.getButton(),b=this.$form_fields.find('.crm-form-field[data-id="!button"]');b.find(".js-field-label").toggle("left"!==a.captionplace);b.find(".crm-form-preview-submit-button").removeClass("wide auto left").addClass([a.width,a.captionplace]).text(a.caption||this.form.params.button_caption).show()};
crmSettingsForm.prototype.initFields=function(){var a=this;a.$form_fields.on("click",".crm-field-edit",function(b){b.preventDefault();b.stopPropagation();a.editField(d(this).closest(".crm-form-field"))})};crmSettingsForm.prototype.editField=function(a){var b=a.data("id"),c=a.data("checked");"!horizontal_rule"!==b&&(c={html:"",id:b,checked:c,settingsForm:this},a="!agreement_checkbox"===b?this.$agreement_checkbox_edit_dialog_tempalte.html():"!paragraph"===b?this.$paragraph_edit_dialog_template.html():
"!button"===b?this.$button_edit_dialog_template.html():"Checkbox"===a.data("type")?this.$checkbox_edit_dialog_template.html():this.$edit_dialog_template.html(),c.html=a,"!agreement_checkbox"===b?new crmSettingsFormAgreementCheckboxEditDialog(c):"!paragraph"===b?new crmSettingsFormParagraphEditDialog(c):"!button"===b?new crmSettingsFormButtonEditDialog(c):new crmSettingsFormFieldEditDialog(c))};crmSettingsForm.prototype.initSubmit=function(){var a=this,b=a.$form,c=b.find(".crm-loading"),e=b.find(".crm-success-status");
b.on("keypress","input",function(f){13==f.keyCode&&f.preventDefault()});b.submit(function(f){f.preventDefault();f=b.serializeArray();var g=[];d.each(a.form.params.fields,function(h,k){if("undefined"!==typeof k&&0<k.checked){var l=g.length;d.each(k,function(m,n){"html"!==m&&(g[l]=g[h]||{},g[l][m]=n)})}});f.push({name:"form[params][fields]",value:JSON.stringify(g)});f.push({name:"form[params][button]",value:JSON.stringify(a.form.params.button)});a.clearValidateErrors();c.show();a.$button.prop("disabled",
!0);a.submit_xhr&&a.submit_xhr.abort();a.submit_xhr=d.post(b.attr("action"),f).done(function(h){"ok"!==h.status?(a.showValidateErrors(h.errors||{}),c.hide(),a.$button.prop("disabled",!1)):(e.show().fadeOut(500),d.crm.content.load(d.crm.app_url+"settings/form/"+h.data.form.id).then(function(){c.hide();a.$button.prop("disabled",!1);a.setFormChanged(!1)}))}).fail(function(){a.showValidateErrors({"":a.messages.unknown_server_error});c.hide();a.$button.prop("disabled",!1)}).always(function(){})})};crmSettingsForm.prototype.clearValidateErrors=
function(){var a=this.$form;a.find(".state-error").removeClass("state-error");a.find(".crm-errors-block").remove()};crmSettingsForm.prototype.showValidateErrors=function(a){var b=this.$form,c={};d.each(a||{},function(e,f){"params"===e?d.each(f,function(g,h){c["form[params]["+g+"]"]=d.isArray(h)?h:[h]}):c[e?"form["+e+"]":""]=d.isArray(f)?f:[f]});this.clearValidateErrors();d.each(c,function(e,f){var g=d('<div class="crm-errors-block"></div>');e=e?b.find('[name="'+e+'"]'):d();e.addClass("state-error");
d.each(f,function(h,k){g.append('<span class="errormsg">'+k+"</span>")});e.length?e.after(g):b.find(".crm-common-errors-block").append(g)})};crmSettingsForm.prototype.initDeleteLink=function(){var a=this,b=a.messages||{};a.$delete_link.click(function(c){c.preventDefault();d.crm.confirm.show({title:b.delete_confirm_title,text:b.delete_confirm_text,button:b.delete_confirm_button,onConfirm:function(){var e=d(".crm-confirm-dialog"),f=e.find(".crm-loading").show(),g=e.find(".js-confirm-dialog").attr("disabled",
!0);d.post(d.crm.app_url+"?module=settings&action=formDelete",{id:a.form.id}).always(function(){d.crm.content.load(d.crm.app_url+"settings/form/");f.hide();g.attr("disabled",!1)});return!1}})})};crmSettingsForm.prototype.initSortable=function(){function a(){var c=b.form.params.fields,e=c.reduce((g,h,k)=>(g[h.id+"-"+h.checked]=k,g),{}),f=[];b.$form_fields.find(".crm-form-field:not(.crm-form-field-template)").each(function(){var g=d(this),h=g.data("id");g=g.data("checked");(h=c[e[h+"-"+g]])&&f.push(h)});
b.form.params.fields=f;b.setFormChanged()}var b=this;b.$form_fields.sortable({distance:5,helper:"clone",items:".crm-form-field:not(:hidden)",opacity:.75,handle:".sort",tolerance:"pointer",containment:b.$form_fields,start:()=>{b.sortable_is_active=!0},stop:()=>{a();b.sortable_is_active=!1},onUpdate:a})};crmSettingsForm.prototype.initDeleteFieldLinks=function(){var a=this;a.$wrapper.on("click",".crm-delete-field-link",function(){var b=d(this).closest(".crm-form-field");a.deleteFormField(b)})};crmSettingsForm.prototype.deleteFormField=
...
a=b.getFormField("password"),b.deleteFormField(a),b.renderToVariantSelectors());"company"===c&&b.$form_available_fields.find(".crm-form-field[data-person-enabled=0][data-company-enabled=1]").each(function(){var g=d(this),h=g.data("id");h=b.getFormField(h);b.deleteFormField(h);g.addClass("crm-disabled")});b.setFormChanged()}};crmSettingsForm.prototype.getFormField=function(a,b){var c='.%clz%[data-id="%id%"]%extra%:not(.%not_clz%)';a=[["%clz%","crm-form-field"],["%id%",a],["%extra%",void 0!==b?'[data-id="'+
...
crmSettingsForm.prototype.initExternalCode=function(){this.$external_code.find("textarea").click(function(){d(this).select()})};crmSettingsForm.prototype.initCancelLink=function(){var a=this.referrer;this.$wrapper.on("click",".js-c-cancel-link",function(b){b.preventDefault();"settings/sources"==a?(d.crm.storage.set("crm/settings/source_tab","form"),d.crm.content.load(d.crm.app_url+"settings/sources/")):d.crm.content.load(d.crm.app_url+"settings/form/")})};crmSettingsForm.prototype.initBlocks=function(){var a=
this.$wrapper,b=a.find(".js-deal-section");a=a.find(".js-responsible-section");b=b.data("block_object");a=a.data("block_object");b.setResponsibleBlock(a)};return crmSettingsForm}(jQuery);var crmSettingsFormFieldEditDialog=function(d){var a=function(b){var c=this,e=b.onClose;b.onClose=function(g,h){e&&e(g,h)};var f=b.onOpen;b.onOpen=function(g,h){f&&f(g,h);c.$wrapper=g;c.$form=c.$wrapper.find("form");c.$button=c.$form.find("[type=submit]");c.id=b.id;c.checked=b.checked;c.settingsForm=b.settingsForm;c.dialog=h;c.initClass()};d.waDialog(b)};a.prototype.initClass=function(){var b=this.dialog.$block,c=this.settingsForm.getField(this.id,this.checked);d.each(c,function(g,h){"id"===g?d(".crm-field-id",
b).find(".value").text(c.name+" (ID="+h+")"):"name"!==g&&(g=d(".crm-field-"+g,b).find(".value").find(":input"),g.is(":checkbox")?g.prop("checked",!!h):g.is(":radio")?g.filter('[value="'+h+'"]').prop("checked",!0):g.val(h))});var e=function(g){d(".crm-field-"+g,b).hide().find(":input").attr("disabled",!0)},f=function(g){d(".crm-field-"+g,b).show().find(":input").attr("disabled",!1)};"Composite"===c.type||"Address"===c.type?f("subfield_captionplace"):e("subfield_captionplace");c.placeholder_need?f("placeholder"):
...
b.settingsForm.updateButton(e);b.settingsForm.renderButton();b.dialog.close()});b.$form.on("change","input,textarea,select",function(){b.setFormChanged()});b.$form.on("keyup","input:text,textarea",function(){b.setFormChanged()})};a.prototype.setFormChanged=function(){this.$button.addClass("yellow")};return a}(jQuery);var crmSettingsFormParagraphEditDialog=function(d){var a=function(b){var c=this,e=b.onClose;b.onClose=function(g,h){e&&e(g,h);d(".redactor-dropdown").remove()};var f=b.onOpen;b.onOpen=function(g,h){f&&f(g,h);c.$wrapper=g;c.$textarea=c.$wrapper.find(".crm-paragraph-textarea");c.$button=c.$wrapper.find("[type=submit]");c.id=b.id;c.checked=b.checked;c.settingsForm=b.settingsForm;c.dialog=h;c.initClass()};d.waDialog(b)};a.prototype.initClass=function(){var b=this.$textarea,c=this.settingsForm.getField(this.id,
...
var h="app=crm&key=notification."+e.notification_event;if(f)return e.drawer.show(),!1;e.drawer=d.waDrawer({html:'<div class="drawer crm-help" id=""> <div class="drawer-background"></div> <div class="drawer-body"> <a href="#" class="drawer-close js-close-drawer"><i class="fas fa-times"></i></a> <div class="drawer-block"><div class="flexbox middle width-100 height-100 spinner-wrapper"><div class="spinner custom-p-16"></div></div></div> </div> </div> ',direction:"right",onClose:()=>a(!1)});d.get(g,h,
...
"?module=settingsNotifications&action=status";a.each(function(){var e=d(this),f=e.closest(".c-notification"),g=f.data("id"),h=f.find(".c-loading");e.find("#switch-"+g).waSwitch({ready:function(k){let l=k.$wrapper.siblings("label");k.$label=l;k.active_text=l.data("active-text");k.inactive_text=l.data("inactive-text")},change:function(k,l){h.show();l.disable(!0);b&&b.abort();b=d.post(c,{id:g,status:k?0:1}).done(function(m){"ok"===m.status&&(k?(l.$label.text(l.inactive_text),f.removeClass("c-is-disabled")):
