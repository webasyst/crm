...
$jscomp.polyfill=function(d,a,b,c){if(a){b=$jscomp.global;d=d.split(".");for(c=0;c<d.length-1;c++){var e=d[c];e in b||(b[e]={});b=b[e]}d=d[d.length-1];c=b[d];a=a(c);a!=c&&null!=a&&$jscomp.defineProperty(b,d,{configurable:!0,writable:!0,value:a})}};$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$jscomp.arrayIteratorImpl=function(d){var a=0;return function(){return a<d.length?{done:!1,value:d[a++]}:{done:!0}}};
$jscomp.arrayIterator=function(d){return{next:$jscomp.arrayIteratorImpl(d)}};$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};$jscomp.SymbolClass=function(d,a){this.$jscomp$symbol$id_=d;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:a})};$jscomp.SymbolClass.prototype.toString=function(){return this.$jscomp$symbol$id_};
...
$jscomp.iteratorFromArray=function(d,a){$jscomp.initSymbolIterator();d instanceof String&&(d+="");var b=0,c={next:function(){if(b<d.length){var e=b++;return{value:a(e,d[e]),done:!1}}c.next=function(){return{done:!0,value:void 0}};return c.next()}};c[Symbol.iterator]=function(){return c};return c};$jscomp.polyfill("Array.prototype.keys",function(d){return d?d:function(){return $jscomp.iteratorFromArray(this,function(a){return a})}},"es6","es3");
...
a,g),is_fixed:!1}}).get();d(window).on("resize scroll",e);e();return this}})(jQuery);(function(d){d.ajaxSetup({cache:!1});d(document).ajaxSend(function(a,d,c){c.crossDomain||"POST"!==(c.type||"").toUpperCase()||(a=(a=document.cookie.match(/(?:^|; )_csrf=([^;]*)/))?decodeURIComponent(a[1]):"",c.data||0===c.data||(c.data=""),"string"===typeof c.data?-1==c.data.indexOf("_csrf=")&&(c.data+=(0<c.data.length?"&":"")+"_csrf="+a,d.setRequestHeader("Content-type","application/x-www-form-urlencoded")):"object"===typeof c.data&&(window.FormData&&c.data instanceof window.FormData?"function"==
...
this.$icon.hasClass("funnel")?this.renderFunnel():this.$icon.hasClass("funnel-1")&&this.renderFunnel(1);this.$icon.data("icon",this)};b.prototype.renderFunnelState=function(){function a(a){return a/16*d.icon_w}function c(a){return a/16*d.icon_h}var d=this,b=d.$icon.data("color")||"#aaa",e=d.svg.append("g");e.append("polygon").attr("points",a(4)+","+c(16)+" "+a(0)+","+c(16)+" "+a(3.9)+","+c(7.9)+" "+a(0)+","+c(0)+" "+a(4)+","+c(0)+" "+a(8.7)+","+c(7.9)).style("opacity",.33).style("fill",b);e.append("polygon").attr("points",
a(8)+","+c(16)+" "+a(4)+","+c(16)+" "+a(7.9)+","+c(7.9)+" "+a(4)+","+c(0)+" "+a(8)+","+c(0)+" "+a(12.6)+","+c(7.9)).style("opacity",.66).style("fill",b);e.append("polygon").attr("points",a(11.9)+","+c(16)+" "+a(7.9)+","+c(16)+" "+a(11.8)+","+c(7.9)+" "+a(7.9)+","+c(0)+" "+a(11.9)+","+c(0)+" "+a(16)+","+c(7.9)).style("fill",b)};b.prototype.renderFunnel=function(c){function d(){var a=[],d=b.icon_w,e=b.icon_h;0<p&&(d-=p,e-=p);var f=d-6+",0";var g=d+","+e/2;d=d-6+","+e;var h="0,"+e;e="6,"+e/2;a.push("0,0");
a.push(f);a.push(g);a.push(d);a.push(h);c&&1===c||a.push(e);return a.join(" ")}var b=this,e=b.$icon.data("color")||"#aaa",f=a.crm.color(e),m=b.$icon.data("hover-color")||f.getTone(20),p=b.$icon.data("stroke-width")||0,n=b.$icon.data("hover")||!1,q=b.svg.append("g").append("polygon").attr("class","is-animated").attr("points",d()).attr("transform","translate("+p/2+","+p/2+")").style("fill",e);0<p&&(f=f.getTone(-20),q.style("stroke",f).style("stroke-width",p));n&&(n=q.node(),n=a(n).closest(".c-state-item "),
n.on("mouseenter",function(){q.style("fill",m)}),n.on("mouseleave",function(){q.style("fill",e)}));(function(){function c(){f||(f=!0,setTimeout(e,100))}function e(){a.contains(document,b.$icon[0])?(b.refresh(),q.attr("points",d())):a(window).off("resize refresh-icons",c);f=!1}var f=!1;a(window).on("resize refresh-icons",c)})()};b.prototype.refresh=function(){this.icon_w=this.$icon.outerWidth();this.icon_h=this.$icon.outerHeight();this.svg.attr("width",this.icon_w).attr("height",this.icon_h)};return b}(jQuery,
d3);"string"===typeof a&&(a=d(a));a.length&&a.find(".svg-icon").each(function(){var a=d(this),e=a.data("icon");e?e.refresh():b&&new b({$icon:a})})},tabSlider:function(a){var b=function(a){b=function(a){this.$wrapper=a.$wrapper;this.$slider=a.$slider;this.$activeSlide=a.$activeSlide||!1;this.type_class=!1;this.left=0;this.slider_w=this.wrapper_w=!1;this.initClass()};b.prototype.initClass=function(){function c(){a.contains(document,d.$wrapper[0])?d.wrapper_w!==d.$wrapper.outerWidth()&&d.reset():b.off("resize",
c)}var d=this,b=a(window);d.detectSliderWidth();d.initStartPosition();b.on("resize",c);d.$wrapper.on("click",".c-action",function(c){c.preventDefault();c=a(this);c.hasClass("left")&&d.moveSlider(!1);c.hasClass("right")&&d.moveSlider(!0)})};b.prototype.initStartPosition=function(){var a=0;if(this.$activeSlide.length){var c=this.$activeSlide.outerWidth(),d=Math.floor(Math.abs(this.$wrapper.offset().left-this.$activeSlide.offset().left));d+c>this.wrapper_w&&(a=d-40)}a?(this.start_left=a,this.moveSlider(!0,
...
this.left=a};b.prototype.moveSlider=function(a,c){c=c?c:100;var d=this.slider_w-this.wrapper_w,b=0;0<d&&(b=Math.abs(this.left)+(a?c:-c),b>d?b=d:0>b&&(b=0));this.setLeft(-b);this.showArrows()};b.prototype.reset=function(){this.setLeft(0);this.detectSliderWidth();this.showArrows()};return b}(d);return new b(a)},color:function(a){var d=function(){function a(a,c,d){a=parseInt(a,16);c=parseInt(c,16);d=parseInt(d,16);return 0<=a&&0<=c&&0<=d?[a,c,d]:null}function b(a){a[0]=parseInt(a[0].toFixed());a[1]=
parseInt(a[1].toFixed());a[2]=parseInt(a[2].toFixed());var c=a[0].toString(16),d=a[1].toString(16);a=a[2].toString(16);return 0<=c.length&&0<=d.length&&0<=a.length?"#"+(1==c.length?"0"+c:c)+(1==d.length?"0"+d:d)+(1==a.length?"0"+a:a):null}function f(a){var c=(a[0]+16)/116,d=a[1]/500+c,b=c-a[2]/200;d=.95047*(.008856<d*d*d?d*d*d:(d-16/116)/7.787);c=.008856<c*c*c?c*c*c:(c-16/116)/7.787;b=1.08883*(.008856<b*b*b?b*b*b:(b-16/116)/7.787);a=3.2406*d+-1.5372*c+-.4986*b;var e=-.9689*d+1.8758*c+.0415*b;c=.0557*
d+-.204*c+1.057*b;a=.0031308<a?1.055*Math.pow(a,1/2.4)-.055:12.92*a;e=.0031308<e?1.055*Math.pow(e,1/2.4)-.055:12.92*e;c=.0031308<c?1.055*Math.pow(c,1/2.4)-.055:12.92*c;return[255*Math.max(0,Math.min(1,a)),255*Math.max(0,Math.min(1,e)),255*Math.max(0,Math.min(1,c))]}function g(a){var c=a[0]/255,d=a[1]/255,b=a[2]/255;c=.04045<c?Math.pow((c+.055)/1.055,2.4):c/12.92;d=.04045<d?Math.pow((d+.055)/1.055,2.4):d/12.92;b=.04045<b?Math.pow((b+.055)/1.055,2.4):b/12.92;a=(.4124*c+.3576*d+.1805*b)/.95047;var e=
.2126*c+.7152*d+.0722*b;c=(.0193*c+.1192*d+.9505*b)/1.08883;a=.008856<a?Math.pow(a,1/3):7.787*a+16/116;e=.008856<e?Math.pow(e,1/3):7.787*e+16/116;c=.008856<c?Math.pow(c,1/3):7.787*c+16/116;return[116*e-16,500*(a-e),200*(e-c)]}function h(a,c,d){var b=Math.floor(6*a),e=6*a-b;a=d*(1-c);var f=d*(1-e*c);c=d*(1-(1-e)*c);switch(b%6){case 0:var g=d;var h=c;var l=a;break;case 1:g=f;h=d;l=a;break;case 2:g=a;h=d;l=c;break;case 3:g=a;h=f;l=d;break;case 4:g=c;h=a;l=d;break;case 5:g=d,h=a,l=f}return[255*g,255*
h,255*l]}function k(a){var c=a[0]/255,d=a[1]/255,b=a[2]/255,e,f=Math.max(c,d,b);var g=f-Math.min(c,d,b);if(0==g)var h=e=0;else{e=g/f;a=(f-c)/6/g+.5;var l=(f-d)/6/g+.5;g=(f-b)/6/g+.5;c===f?h=g-l:d===f?h=1/3+a-g:b===f&&(h=2/3+l-a);0>h?h+=1:1<h&&--h}return{h:Math.round(360*h),s:Math.round(100*e),b:Math.round(100*f)}}d=function(c){c=this.hex=c;var d=!1;"string"===typeof c?(c=c.replace("#",""),3===c.length?d=a(c[0]+""+c[0],c[1]+""+c[1],c[2]+""+c[2]):6===c.length&&(d=a(c[0]+""+c[1],c[2]+""+c[3],c[4]+""+
c[5]))):"object"===typeof c&&3===c.length&&(d=c);this.rgb=d};d.prototype.getRange=function(){var a=this.rgb?g(this.rgb):!1;if(a){var c=f([90,a[1],a[2]]),d=f([40,a[1],a[2]]);a=b(c);var e=b(d);a=[a,e];a.getColor=function(a){if(0<=a&&100>=a){var e=c[0],f=c[1],g=c[2];return b([Math.floor(e+(d[0]-e)*a/100),Math.floor(f+(d[1]-f)*a/100),Math.floor(g+(d[2]-g)*a/100)])}return null};return a}return null};d.prototype.getTone=function(a){function c(a){100<a?a=100:0>a&&(a=0);return a}var d=k(this.rgb);d.s=c(d.s*
(1+a/100));d.b=c(d.b*(1+a/100));a=h(d.h/360,d.s/100,d.b/100);return b(a)};return d}();return new d(a)},initWYSIWYG:function(a,b){if(!a||!a.length||a.data("redactor"))return a;b=d.extend({minHeight:130,buttons:"inline bold italic underline deleted lists outdent indent image link horizontalrule fontcolor fontsize fontfamily".split(" "),plugins:["fontcolor","fontsize","fontfamily"],allowedTags:"a b i u pre blockquote p strong em del strike span ul ol li div span br".split(" "),uploadImage:!1,lang:this.lang},
b||{});a.redactor(b);d(document).one("wa_before_render",function(){d.contains(document,a[0])&&a.data("redactor")&&a.redactor("core.destroy")});return a},escape:function(a){return d("<div />").text(a).html()},runBackgroundWorker:function(a){var b=Math.floor(100*Math.random())/100,c=Math.floor(100*Math.random())/100,e=a.delay||1E4,f=e/2,g=a.id||(""+Math.random()).slice(2),h=null,k=null,l=a.url;l?(e+=f*b,200>=e?console.error("Delay value too low"):function(){try{var a=function(){h&&clearTimeout(h);k&&
k.abort();k=d.post(l,{process_id:g});k.always(function(){k=null;h=setTimeout(a,e)});k.error(function(){return!1})};h=setTimeout(a,500+300*c)}catch(p){console.error(["source email worker fail",p])}}()):console.error("Empty url")}})})(jQuery);(function(d,a){d.fn.serializeObject=function(){var b={};d.each(this.serializeArray(),function(c,e){c=e.name;e=e.value;b[c]=b[c]===a?e:d.isArray(b[c])?b[c].concat(e):[b[c],e]});return b}})(jQuery);
...
"a",function(a){a.stopPropagation()});a.api_enabled&&(window.onpopstate=function(c){c.stopPropagation();a.onPopState(c)});d(document).on("unsavedChanges",function(c,d){a.need_confirm=!!d})};ContentRouter.prototype.load=function(a,b){var c=this;if(!(0<=a.indexOf(d.crm.app_url)))return alert("Determine the path error"),!1;c.animate(!0);c.xhr&&c.xhr.abort();d(document).trigger("wa_before_load",{content_uri:a});c.xhr=d.ajax({method:"GET",url:a,dataType:"html",global:!1,cache:!1}).done(function(e){c.api_enabled&&
...
d.crm.content.load(a);b.val("")});b.autocomplete({appendTo:a,classes:{"ui-autocomplete":"c-search-results-list"},source:"?module=autocompleteSidebar",minLength:2,html:!0,focus:function(){return!1},select:function(a,e){(a=e.item.link)&&d.crm.content.load(d.crm.app_url+a);b.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d("<li />").addClass("ui-menu-item-html").append("<div>"+b.value+"</div>").appendTo(a)}};return CRMSidebar}(jQuery);var CRMDeal=function(d){var a=function(c){a=function(a){this.$window=c(window);this.$wrapper=a.$wrapper;this.$outer_wrapper=a.$outer_wrapper;this.debug=a.debug;this.indent={top:0};this.$clone=null;this.offset=this.getOffset();this.type=null;this.init()};a.prototype.init=function(){function a(){c.contains(document,b.$wrapper[0])?(b.reset(),b.onScroll()):c(document).off("refresh",a)}function d(){if(c.contains(b.$window[0].document,b.$wrapper[0]))b.onScroll();else b.$window.off("scroll",d)}var b=this;
b.$clone=function(a){var d=c("<div />");a.before(d);return d.hide()}(b.$wrapper);b.onScroll();var h=0;b.$window.on("resize",function(){clearTimeout(h);h=setTimeout(function(){b.reset();b.onScroll()},50)});c(document).on("refresh",a);b.$window.on("scroll",d)};a.prototype.onScroll=function(){var a=this.$window.scrollTop(),c=this.$window,d=c.width();c.height();c=this.offset;var b=this.$outer_wrapper.outerHeight();!(0<d)||b<=this.offset.height?this.fixTo("default"):a<=c.top-this.indent.top?this.fixTo("default"):
this.fixTo("fix_top")};a.prototype.fixTo=function(a,d){a=a?a:null;this.type!==a&&("fix_top"===a?(this.$wrapper.removeAttr("style"),this.$clone.css({height:this.$wrapper.outerHeight()}).show(),this.$wrapper.css({position:"fixed",top:this.indent.top,left:this.offset.left-10,width:this.offset.width+20}),this.$wrapper.addClass("is-fixed-top")):(this.$wrapper.removeClass("is-fixed-top").removeAttr("style"),this.$clone.hide().height(0),this.$wrapper[0].scrollTop=0),c(document).trigger("refresh-icons"),
...
c.$wrapper;this.$outer_wrapper=c.$outer_wrapper;this.debug=c.debug;this.indent=c.indent;this.$clone=null;this.offset=this.getOffset();this.type=null;this.init()};b.prototype.init=function(){function c(){a.contains(document,b.$wrapper[0])?(b.reset(),b.onScroll()):a(document).off("refresh",c)}function d(){if(a.contains(b.$window[0].document,b.$wrapper[0]))b.onScroll();else b.$window.off("scroll",d)}var b=this;b.$clone=function(c){var d=a("<div />");c.before(d);return d.hide()}(b.$wrapper);b.onScroll();
var e=0;b.$window.on("resize",function(){clearTimeout(e);e=setTimeout(function(){b.reset();b.onScroll()},50)});a(document).on("refresh",c);b.$window.on("scroll",d)};b.prototype.onScroll=function(){var a=this.$window.scrollTop(),d=c(this),b=this.$window,e=b.width();b.height();b=this.offset;var l=this.$outer_wrapper.outerHeight();!(0<e)||l<=this.offset.height?this.fixTo("default"):a<=b.top-d?this.fixTo("default"):this.fixTo("fix_top")};b.prototype.fixTo=function(a,d){function b(){var a=f.getHeight();
f.$wrapper.css({position:"static",top:"auto",left:"auto",width:"auto",height:a});f.$clone.hide().height(0)}function e(){var a=f.getHeight();f.$wrapper.css({position:"fixed",top:c(f),left:f.offset.left,width:f.offset.width,height:a});f.$clone.css({height:a}).show()}var f=this;a=a?a:null;"fix_top"===a?(e(),f.type!==a&&f.$wrapper.addClass("is-fixed")):(b(),f.type!==a&&f.$wrapper.removeClass("is-fixed"));f.type=a;f.log(a)};b.prototype.reset=function(){this.fixTo("default");this.offset=this.getOffset()};
b.prototype.getOffset=function(){var a=this.$wrapper.offset();return{top:a.top,left:a.left,width:this.$wrapper.outerWidth(),height:this.$wrapper.outerHeight()}};b.prototype.log=function(a){this.debug&&console.log(a)};b.prototype.getHeight=function(){var a=this.$window.height(),d=c(this);this.offset.top-this.$window.scrollTop()>d&&(d=this.offset.top-this.$window.scrollTop());var b=this.$outer_wrapper.offset().top+this.$outer_wrapper.outerHeight(),e=this.$window.height()+this.$window.scrollTop();return a-
d-(0>b-e?Math.abs(b-e):0)};return b}(jQuery);CRMDeal=function(a){this.$wrapper=a.$wrapper;this.$aside=this.$wrapper.find(".c-deal-aside");this.$log_section=this.$wrapper.find(".js-deal-log-section");this.locales=a.locales;this.templates=a.templates;this.deal=a.deal||{};this.deal_id=this.deal.id||0;this.order_id=a.order_id||0;this.user_id=a.user_id;this.funnel_id=a.funnel_id;this.can_edit_deal=a.can_edit_deal||!1;this.shop_in_welcome_stage=a.shop_in_welcome_stage||!1;this.remove_is_locked=this.is_locked=
!1;this.init()};CRMDeal.prototype.init=function(){var a=this;d.crm.renderSVG(a.$wrapper);d.crm.sidebar.reload();a.can_edit_deal&&(a.initChangeState(),a.initCloseDeal(),a.initReopenDeal(),a.initAddContact(),a.initRemoveFiles(),a.initEditableName(),a.initChangeDate(),a.initChangePrice(),a.initChangeField(),a.initWYSIWYG(),a.initChangeDescription(),a.initChangeUser(),a.initChangeClient(),a.initDealDelete(),a.initAssignTags(),a.initCreateOrderLink(),a.initEditOrderLink());a.initCall();a.initMessages();
a.initOrderEditShippingDetailLink();a.initSticky();a.initOrderSection();a.initScroll();a.deal_id&&a.initLogSection();a.$wrapper.on("click",".js-remove-owner",function(c){c.preventDefault();a.remove_is_locked||a.removeOwner(d(this).closest(".c-contact"))});a.$wrapper.on("click",".js-remove-contact",function(c){c.preventDefault();a.remove_is_locked||a.removeContact(d(this).closest(".c-contact"))});a.$wrapper.on("click",".js-add-external-contact",function(c){c.preventDefault();a.addExternalContact(d(this))})};
CRMDeal.prototype.initLogSection=function(){var a=this.deal_id;this.$log_section.on("click",".js-open-conversation",function(c){c.preventDefault();c=d(this).attr("href");-1===c.indexOf("?")?window.location.href=c+"?deal_id="+a:window.location.href=c+"&deal_id="+a})};CRMDeal.prototype.initScroll=function(){function a(){d.contains(document,h.$wrapper[0])?f():k.off("scroll",a)}function b(){d.contains(document,h.$wrapper[0])?g():k.off("resize",b)}function f(){0<k.scrollTop()?m||(l.show(),m=!0):m&&(l.hide(),
m=!1)}function g(){var a=n.offset().left;l.css("right",k.width()-a)}var h=this,k=d(window),l=d('<div class="c-scroll-action"><div class="c-icon to-top"></div></div>'),m=!1,p=h.$wrapper.find(".c-deal-board"),n=h.$wrapper.find(".c-deal-aside-wrapper");p.append(l);f();g();l.on("click",function(){d("html, body").animate({scrollTop:0},500)});k.on("scroll",a);k.on("resize",b)};CRMDeal.prototype.initSticky=function(){function c(){0<f[0].scrollTop?f.addClass("is-scrolled"):f.removeClass("is-scrolled")}var d=
this.$wrapper.find(".js-page-header"),f=this.$wrapper.find("#js-deal-aside");new a({$wrapper:d,$outer_wrapper:this.$wrapper,debug:!1});new b({$wrapper:f,$outer_wrapper:f.closest(".c-deal-board"),indent:function(){return d.outerHeight()},debug:!1});c();f.on("scroll",c)};CRMDeal.prototype.initChangeState=function(){function a(a){function c(){d.crm.content.load(d.crm.app_url+"deal/"+b.deal_id+"/")}d.post("?module=deal&action=move",{deal_id:b.deal_id,stage_id:a},function(e){"ok"===e.status&&(e.data.dialog_html&&
e.data.dialog_html.html?new CRMDialog({html:e.data.dialog_html.html,options:{onShopSubmit:c},onConfirm:function(){d.post("?module=deal&action=move",{deal_id:b.deal_id,stage_id:a,force_execute:1},c)}}):c())},"json")}var b=this;b.$wrapper.find(".c-funnel-wrapper").on("click",".c-state-item.js-set-state",function(c){c.preventDefault();c=d(this);if(c.hasClass("selected"))return!1;c=c.data("id");a(c)})};CRMDeal.prototype.initCloseDeal=function(){var a=this,b=!1;a.$wrapper.on("click",".js-close-deal",function(c){c.preventDefault();
b||(b=!0,d.post("?module=deal&action=closeDialog",{id:a.deal_id},function(a){new CRMDialog({html:a})}).always(function(){b=!1}))})};CRMDeal.prototype.initReopenDeal=function(){var a=this,b=!1;a.$wrapper.on("click",".js-reopen-deal",function(c){c.preventDefault();b||(b=!0,d.post("?module=deal&action=reopen",{id:a.deal_id},function(a){"ok"==a.status?d.crm.content.reload():alert("Error: Deal Reopen")},"json").always(function(){b=!1}))})};CRMDeal.prototype.initAddContact=function(){function a(a,c){a=
a.closest(".c-add-contact");c?(h.hide(),a.addClass("is-shown")):(h.show(),a.removeClass("is-shown"))}function b(a,c){function b(a){a=a?a:[];d.each(a,function(a,c){a=c.text;var b=d('<div class="errormsg" />').html(a);h.one("click",function(){b.remove()});g.prepend(b)})}c=c?c:function(){};d.post("?module=deal&action=userAdd",{contact_id:a,deal_id:f.deal_id},function(a){"ok"===a.status?c(a.data.html):a.errors&&b(a.errors)},"json")}var f=this,g=f.$aside.find(".js-add-user-wrapper"),h=g.find(".js-add-contact");
h.on("click",function(c){c.preventDefault();a(d(this),!0)});g.on("click",".js-close-add-contact",function(c){c.preventDefault();a(d(this))});(function(){function a(a,e){var g=f.$aside.find('.c-contact[data-id="'+a+'"]');g.length&&c(g);b(a,function(a){a=d(a);e.before(a);c(a);d(document).trigger("refresh")})}function c(a){a.addClass("is-highlight");setTimeout(function(){d.each(a,function(a,c){d.contains(document,c)&&d(this).removeClass("is-highlight")})},3E3)}f.$aside.find(".js-contact-autocomplete").each(function(){var c=
d(this);c.autocomplete({appendTo:f.$aside,source:d.crm.app_url+"?module=autocomplete&type=user&funnel_id="+f.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(d,b){a(b.item.id,c.closest(".c-add-contact"));c.val("");f.$aside.find(".js-close-add-contact").trigger("click");return!1}}).data("ui-autocomplete")._renderItem=function(a,c){var b=d("<li />");b.addClass("ui-menu-item-html").append("<div>"+c.value+"</div>").appendTo(a);c.rights||(b.addClass("is-locked"),b.on("click",function(a){a.preventDefault();
a.stopPropagation()}));return b};c.on("focus",function(){c.data("uiAutocomplete").search(c.val())})})})()};CRMDeal.prototype.initRemoveFiles=function(){function a(a,c){d.post("?module=file&action=delete",{id:a},function(a){"ok"==a.status?c.remove():console&&console.log&&console.log("File Remove Error")})}var b=this,f;b.$wrapper.find(".c-files-wrapper").on("click",".js-remove-file",function(c){c.preventDefault();var e=d(this).closest(".c-file");c=e.find(".c-name").text();var g=parseInt(e.data("id"));
f&&f.abort();c={title:b.locales.remove_file_title,text:b.locales.remove_file_text.replace(/%s/,c),ok_button:b.locales.remove_file_button};0<g?f=d.post("?module=dialogConfirm",c,function(c){new CRMDialog({html:c,onConfirm:function(){a(g,e)}})}).always(function(){f=!1}):console&&console.log&&console.log("File ID is empty")})};CRMDeal.prototype.initEditableName=function(){var a=this.$wrapper.find(".js-editable").first();if(!(0>=a.length)){var b=d.crm.app_url+"?module=deal&action=rename",f=this.deal_id,
g=null;new CrmEditable({$wrapper:a,onSave:function(a){var c=a.$field.val();if(c.length&&a.text!==c){g&&g.abort();c={id:f,name:c};a.$field.attr("disabled",!0);var e=d('<i class="icon16 loading"></i>').css("margin","0 0 0 4px").insertAfter(a.$field);g=d.post(b,c,function(c){a.$field.attr("disabled",!1);e.remove();a.toggle("hide");c&&c.data&&c.data.deal&&(a.text=c.data.deal.name,a.$wrapper.text(c.data.deal.name),d.crm.title.set(c.data.deal.name))})}else c.length||a.$field.val(a.text),a.toggle("hide")}})}};
CRMDeal.prototype.initChangeDate=function(){function a(a){a?(g.addClass("is-shown"),l.focus()):(g.removeClass("is-shown"),l.datepicker("hide"))}function b(c){l.val()||(c="");d.post("?module=deal&action=changeExpectedDate",{id:f.deal_id,expected_date:c?c:""},function(c){"ok"==c.status&&c.data&&c.data.deal&&((c=c.data.deal.expected_date)?(h.hide(),k.show().find(".js-name").text(c)):(k.hide().find(".js-name").text(""),h.show()),a())},"json")}var f=this,g=f.$wrapper.find(".js-date-toggle");if(!g.length)return!1;
var h=g.find(".js-link"),k=g.find(".js-span"),l=g.find(".js-datepicker"),m=g.find(".js-field");g.on("click",".js-set-date",function(c){c.preventDefault();a(!0)});l.on("keydown keypress keyup",function(c){27===c.keyCode&&a()});g.on("click",".js-close-edit-date",function(){a()});(function(){l.datepicker({altField:m,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var a=l.val(),c=m.val(),e=d.datepicker._defaults.dateFormat,f=!1;try{d.datepicker.parseDate(e,a),f=!0}catch(v){}if(f)b(c);
else return!1}});l.val()||l.datepicker("setDate","+0d")})()};CRMDeal.prototype.initChangePrice=function(){function a(a){a?h.addClass("is-shown"):h.removeClass("is-shown")}function b(c,b){d.post("?module=deal&action=changeAmount",{id:g.deal_id,amount:c?c:"",currency_id:b?b:""},function(c){"ok"==c.status&&c.data&&c.data.deal&&((c=c.data.deal.amount)?(k.hide(),l.show().text(c)):(l.hide().text(""),k.show()),a())},"json")}function f(){var a=m.val(),c=p.val(),d=!1;a&&(d=a.replace(",","."));0<=d?b(a,c):
m.addClass("error")}var g=this,h=g.$wrapper.find(".js-price-toggle");if(!h.length)return!1;var k=h.find(".js-link"),l=h.find(".js-span"),m=h.find(".js-price-field"),p=h.find(".js-currency-field");h.on("click",".js-set-price",function(c){c.preventDefault();a(!0)});h.on("click",".js-save-price",function(a){a.preventDefault();f()});h.on("click",".js-cancel",function(c){c.preventDefault();a()});m.on("focus",function(){m.hasClass("error")&&m.removeClass("error")});m.on("keydown",function(a){13===a.keyCode&&
(a.preventDefault(),f())})};CRMDeal.prototype.initChangeField=function(){function a(a,c){var b=d(a).parents(".js-field-toggle");c?(b.find(".c-hidden").css({height:d(a).height()+8}),d(a).closest(".js-field-toggle").hasClass("js-textarea")?(b.addClass("is-shown").find(".c-hidden").css("width","100%"),b.find("textarea").slideDown().next().find(".icon16").removeClass("loading").addClass("disk"),b.css({width:"100%","margin-left":0}).prev().hide()):(b.addClass("is-shown"),b.find(".js-datepicker-field").focus())):
d(document).trigger("mousedown")}function b(a){var c=h.data("deal-id"),b="",e=d(a).data("field-id"),g=d(a).data("field-type"),k=!1;switch(g){case "checkbox":d(a).prop("required")&&!d(a).prop("checked")?(k=!0,d(a).addClass("error")):b=Number(d(a).prop("checked"));break;case "date":var l=d(a).siblings(".js-datepicker-field"),t=d.datepicker._defaults.dateFormat,y=!1;try{d.datepicker.parseDate(t,l.val()),y=!0}catch(x){}""!=l.val()&&""!=l.val().trim()&&y||!d(a).prop("required")?b=l.val():(k=!0,l.addClass("error"));
break;case "text":l=d(a).parents(".c-hidden").find(".js-field-value-text");l.next().find(".icon16").removeClass("disk").addClass("loading");""!=l.val()&&""!=l.val().trim()||!l.prop("required")?b=l.val():(k=!0,d(a).parents(".c-hidden").find(".js-field-value-text").addClass("error"));break;case "select":var u=d(a).val();y=!1;d(a).find("option").each(function(a,c){d(c).val()==u&&(y=!0)});!y||""==u&&d(a).prop("required")?(k=!0,d(a).addClass("error")):b=u;break;case "radio":b=d(a).find(":checked").val();
break;case "number":u=d(a).val().replace(",",".");(""==u||isNaN(Number(u)))&&d(a).prop("required")?(k=!0,d(a).addClass("error")):b=u;break;default:u=d(a).val(),""!=u&&""!=u.trim()||!d(a).prop("required")?b=u:(k=!0,d(a).addClass("error"))}k||f(a,{id:c,field_id:e,value:b,value_type:g})}function f(c,b){d.post("?module=deal&action=changeValue",b,function(b){if("ok"==b.status){if(b.data&&b.data.deal_params){b=b.data.deal_params.value;var e=d(c).parents(".js-field-toggle").find(".js-output-value");b?(e.text(b),
d(c).removeClass("error")):(e.text(e.data("empty-text")),d(c).siblings(".js-datepicker-field").datepicker("hide"));a(c,!1)}}else d(c).addClass("error")},"json")}var g=this.$wrapper.find(".js-field-toggle"),h=d(".c-deal-options-section");if(!g.length)return!1;var k=g.find(".js-field-value");g.on("click",".js-output-value",function(c){c.preventDefault();a(this,!0)});g.on("click",".js-save-field",function(a){a.preventDefault();b(this)});g.on("click",".js-cancel",function(a){a.preventDefault();d(document).trigger("mousedown")});
g.on("click",".js-field-value-checkbox",function(){b(this)});g.on("change",".js-field-value-select",function(a){a.preventDefault();b(this)});g.on("click",".js-field-value-radio-block input",function(){b(d(this).closest(".js-field-value-radio-block"))});g.on("click",".js-field-value-radio-block .js-clear-link",function(a){a.preventDefault();a=d(this).closest(".js-field-value-radio-block");a.find(":checked").attr("checked",!1);b(a)});k.on("focus",function(){k.hasClass("error")&&k.removeClass("error")});
d(document).on("mousedown",function(a){0!==g.has(a.target).length||g.is(a.target)||g.each(function(a,c){var b=d(c);a=b.find("textarea");b.hasClass("js-textarea")?a.slideUp(function(){b.removeClass("is-shown").removeAttr("style").prev().show()}):b.removeClass("is-shown")})});k.on("keydown",function(a){13===a.keyCode&&(a.preventDefault(),d(this).hasClass("js-datepicker-field")?b(d(this).siblings(".js-field-value")):b(this))});(function(){var a=h.find(".js-datepicker-field"),c=a.siblings(".js-field-value");
a.datepicker({altField:c,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var a=d(this).siblings(".js-field-value");b(a)}})})()};CRMDeal.prototype.initWYSIWYG=function(){var a=this.$wrapper.find(".js-wysiwyg");if(!a.length)return!1;d.crm.initWYSIWYG(a,{keydownCallback:function(a){}})};CRMDeal.prototype.initChangeDescription=function(){function a(a){a?g.addClass("is-shown"):g.removeClass("is-shown")}function b(c){d.post("?module=deal&action=changeDescription",c,function(c){if("ok"==
c.status){if(c.data&&c.data.deal_description){c=c.data.deal_description.value;var b=g.find(".js-output-value");c?(b.find(".c-description").html(c).show(),b.find(".js-add-description").hide()):(b.find(".js-add-description").show(),b.find(".c-description").html("").hide());a(!1)}}else d(f).addClass("error")},"json")}var f=this,g=f.$wrapper.find(".c-description-section .js-description-toggle");if(!g.length)return!1;var h=g.find(".js-field-value");g.on("click",".js-add-description, .js-edit-description",
function(c){c.preventDefault();a(!0)});g.on("hover",".c-description-wrapper",function(){""!=g.find(".c-description").html()&&g.find(".js-edit-description").css("visibility","visible")});g.on("mouseleave",".c-description-wrapper",function(){g.find(".js-edit-description").css("visibility","hidden")});g.on("click",".js-save-description",function(a){a.preventDefault();a=g.find('input[name="data[deal_id]"]').val();var c=g.find(".js-description-value").val();b({id:a,value:c})});g.on("click",".js-cancel",
function(c){c.preventDefault();a(!1)});h.on("focus",function(){h.hasClass("error")&&h.removeClass("error")})};CRMDeal.prototype.initChangeUser=function(){function a(a){if(!a.length)return!1;var c=a.closest(".c-contact");a.autocomplete({appendTo:c,source:"?module=autocomplete&type=user&funnel_id="+h.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(d,e){b(e.item.id,c);a.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,c){var b=d("<li />");b.addClass("ui-menu-item-html").append("<div>"+
c.value+"</div>").appendTo(a);c.rights||(b.addClass("is-locked"),b.on("click",function(a){a.preventDefault();a.stopPropagation()}));return b};a.on("focus",function(){a.data("uiAutocomplete").search(a.val())})}function b(c,b){k?g(b):f(c,function(){k=!0;d.post("?module=deal&action=changeUser",{id:h.deal_id,user_contact_id:c},function(e){if("ok"!==e.status)e.errors?console.error(e.errors):console.error(e),d.crm.alert.show({title:"Error",button:"Error"});else if(e.data=e.data||{},e.data.deal_access_denied)window.location.href=
d.crm.app_url+"deal/";else if(e.data.html){e=d(e.data.html);var f=h.$aside.find('.c-users-section .c-contact[data-id="'+c+'"]').not(b);f.length&&f.remove();b.replaceWith(e);a(e.find(".js-owner-autocomplete"))}},"json").always(function(){k=!1})})}function f(a,c){d.post("?module=deal&action=changeUserConfirm",{id:h.deal_id,user_contact_id:a},"json").done(function(a){a.data&&a.data.need_confirm?new CRMDialog({html:a.data.html||"",onOpen:function(a,b){a.find(".js-confirm-button").on("click",function(){c()})}}):
c()})}function g(a,c){c?a.addClass("is-edit"):a.removeClass("is-edit")}var h=this,k=!1;h.$aside.on("click",".js-show-combobox",function(a){a.preventDefault();a=d(this).closest(".c-contact");g(a,!0)});h.$aside.on("click",".js-hide-combobox",function(a){a.preventDefault();a=d(this).closest(".c-contact");g(a)});h.$aside.find(".js-owner-autocomplete").each(function(){a(d(this))});(function(){function c(c){e||f(c,function(){e=!0;d.post("?module=deal&action=changeUser",{id:h.deal_id,user_contact_id:c},
function(c){if("ok"===c.status)if(c.data.deal_access_denied)window.location.href=d.crm.app_url+"deal/";else{c=d(c.data.html);var b=h.$aside.find('.c-users-section .c-contact[data-id="'+h.user_id+'"]');b.length&&b.remove();h.$aside.find('.c-contact[data-id="'+c.data("id")+'"]').remove();g.after(c).css("display","none");h.$aside.find(".js-add-user-wrapper").show();a(c.find(".js-owner-autocomplete"))}},"json").always(function(){e=!1})})}function b(a){a?g.addClass("is-extended"):g.removeClass("is-extended")}
var e=!1,g=h.$aside.find(".js-empty-user-wrapper");g.on("click",".js-set-user-me",function(a){a.preventDefault();c(h.user_id)});g.on("click",".js-set-extended",function(a){a.preventDefault();b(!0)});g.on("click",".js-unset-extended",function(a){a.preventDefault();b(!1)});(function(){g.find(".js-empty-user-autocomplete").each(function(){var a=d(this);a.autocomplete({appendTo:g,source:"?module=autocomplete&type=user&funnel_id="+h.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(b,
d){c(d.item.id);a.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,c){var b=d("<li />");b.addClass("ui-menu-item-html").append("<div>"+c.value+"</div>").appendTo(a);c.rights||(b.addClass("is-locked"),b.on("click",function(a){a.preventDefault();a.stopPropagation()}));return b};a.on("focus",function(){a.data("uiAutocomplete").search(a.val())})})})()})()};CRMDeal.prototype.initChangeClient=function(){function a(a,c,e){g||(g=!0,d.post("?module=deal&action=changeClient",{deal_id:b.deal_id,
client_type:e,contact_id:c},function(e){new CRMDialog({html:e,options:{onChange:function(e){a.replaceWith(e.html);a.find(".js-add-company-contact").show();(parseInt(b.deal.contact_id)||0)===c&&e.contact.id!==c&&(b.deal.contact_id=e.contact.id);d(document).trigger("refresh")}}})}).always(function(){g=!1}))}var b=this,f=b.$wrapper.find(".js-contacts-section"),g=!1;f.on("click",".js-edit-company-owner",function(c){c.preventDefault();c=d(this).closest(".c-contact");var b=c.data("type"),e=c.data("id");
a(c,e,b)});var h=f.find(".js-empty-contact-wrapper");if(h.length)h.on("click",".js-set-company-owner",function(c){c.preventDefault();a(h,"","contact_owner")})};CRMDeal.prototype.initDealDelete=function(){function a(){f||(f=!0,d.post(d.crm.app_url+"?module=deal&action=delete",{id:b.deal_id},function(a){"ok"===a.status&&d.crm.content.load(d.crm.app_url+"deal/")},"json").always(function(){f=!1}))}var b=this,f=!1;b.$wrapper.on("click",".js-deal-delete",function(c){c.preventDefault();d.crm.confirm.show({title:b.locales.delete_deal_title,
text:b.locales.delete_deal_text,button:b.locales.delete_deal_button,onConfirm:a})})};CRMDeal.prototype.initCall=function(){var a=this,b=!1;a.$wrapper.on("click",".js-show-call-dialog",function(c){c.preventDefault();var e=d(this);c=e.data("id");e=e.data("phone");!b&&c&&e&&(b=!0,d.post("?module=call&action=initContactDialog",{deal_id:a.deal_id,contact_id:c,phone:e},function(a){new CRMDialog({remain_after_load:!0,html:a})}).always(function(){b=!1}))})};CRMDeal.prototype.initOrderSection=function(){var a=
this.$wrapper.find(".c-order-section"),b=a.find(".c-order-details"),f=a.find(".c-products-wrapper");b.on("click",".js-details-toggle",function(a){a.preventDefault();a=d(this).find(".icon16");b.hasClass("is-extended")?(a.removeClass("darr").addClass("rarr"),b.removeClass("is-extended")):(a.removeClass("rarr").addClass("darr"),b.addClass("is-extended"));d(document).trigger("refresh")});f.on("click",".js-products-toggle",function(a){a.preventDefault();a=d(this).find(".icon16");f.hasClass("is-extended")?
(a.removeClass("darr").addClass("rarr"),f.removeClass("is-extended")):(a.removeClass("rarr").addClass("darr"),f.addClass("is-extended"));d(document).trigger("refresh")})};CRMDeal.prototype.initMessages=function(){this.initSendEmail();this.initSendSMS()};CRMDeal.prototype.initSendEmail=function(){var a=this,b=!1;a.$wrapper.on("click",".js-show-message-dialog",function(c){c.preventDefault();var e=d(this);c=e.data("id");e=e.data("email");!b&&c&&(b=!0,d.post("?module=message&action=writeDealDialog",{deal_id:a.deal_id,
contact_id:c,email:e},function(a){new CRMDialog({html:a})}).always(function(){b=!1}))})};CRMDeal.prototype.initSendSMS=function(){var a=this,b=!1;a.$wrapper.on("click",".js-show-send-sms-dialog",function(c){c.preventDefault();var e=d(this);c=e.data("id");e=e.data("phone");!b&&c&&(b=!0,d.get("?module=message&action=writeSMSDealDialog",{deal_id:a.deal_id,contact_id:c,phone:e},function(a){new CRMDialog({html:a})}).always(function(){b=!1}))})};CRMDeal.prototype.addExternalContact=function(a){d.get(d.crm.app_url+
"?module=deal&action=addParticipant",{id:this.deal_id},function(c){new CRMDialog({html:c,options:{onAdd:function(c){a.closest(".c-add-contact").before(c);d(document).trigger("refresh")}}})})};CRMDeal.prototype.removeOwner=function(a){function c(c,e){c={owner_id:c,deal_id:e};var f=d(".js-empty-user-wrapper");b.remove_is_locked=!0;d.post("?module=deal&action=ownerDelete",c,function(c){"ok"==c.status&&(a.remove(),f.fadeIn())},"json").always(function(){b.remove_is_locked=!1})}var b=this,g=a.data("id"),
h=d.trim(a.find(".c-name").html());d.crm.confirm.show({title:b.locales.remove_owner_title,text:b.locales.remove_owner_text.replace(/%s/,h),button:b.locales.remove_owner_button,onConfirm:function(){c(g,b.deal_id)}})};CRMDeal.prototype.removeContact=function(a){function c(c,e,f){c={contact_id:c,deal_id:e,role_id:f};b.remove_is_locked=!0;d.post("?module=deal&action=contactDelete",c,function(c){"ok"==c.status&&a.remove()},"json").always(function(){b.remove_is_locked=!1})}var b=this,g=a.data("id"),h=d.trim(a.find(".c-name").html());
d.crm.confirm.show({title:b.locales.remove_contact_title,text:b.locales.remove_contact_text.replace(/%s/,h),button:b.locales.remove_contact_button,onConfirm:function(){c(g,b.deal_id,a.data("role-id"))}})};CRMDeal.prototype.initAssignTags=function(){var a=this.$wrapper.find(".js-assign-tags"),b=d.crm.app_url+"?module=dealOperation&action=assignTags&is_assign=1",f=parseInt(this.deal_id)||0;a.click(function(a){a.preventDefault();d.get(b,{deal_ids:[f]},function(a){new CRMDialog({html:a})})})};CRMDeal.prototype.initOrderEditShippingDetailLink=
function(){var a=this;a.$wrapper.find(".js-order-edit-shipping-details-link").click(function(){var c=d(this).parent().find(".js-order-edit-shipping-details-loading");c.show();a.loadEditOrderShippingDetailsDialog(a.order_id,{onLoad:function(){c.hide()}})})};CRMDeal.prototype.initCreateOrderLink=function(){var a=this;a.$wrapper.on("click",".js-create-order-link",function(c){c.preventDefault();if(a.shop_in_welcome_stage)d.crm.alert.show({title:a.locales.shop_alert_title||"",text:a.locales.shop_in_welcome_stage||
""});else{var b=d(this);b.addClass("is-loading");a.loadEditOrderDialog(0,{onLoad:function(){b.removeClass("is-loading")}})}})};CRMDeal.prototype.initEditOrderLink=function(){var a=this;a.$wrapper.on("click",".js-edit-order-link",function(c){c.preventDefault();if(a.shop_in_welcome_stage)d.crm.alert.show({title:a.locales.shop_alert_title||"",text:a.locales.shop_in_welcome_stage||""});else{var b=d(this);b.addClass("is-loading");a.loadEditOrderDialog(a.order_id,{onLoad:function(){b.removeClass("is-loading")}})}})};
CRMDeal.prototype.loadEditOrderDialog=function(a,b){var c=this.deal||{},e=d(this.templates.create_order_dialog_html),h=b.onLoad||function(){};e.hide();new CRMDialog({html:e,onOpen:function(){var b=this,f=d.crm.backend_url+"shop/?module=order&action=embededit",g=e.find(".crm-dialog-content");0<c.contact_id&&(f+="&customer_id="+c.contact_id);0<a&&(f+="&id="+a);g.html('<iframe src="'+f+'" class="c-content-iframe">');var p=g.find("iframe");p.one("load",function(){h();b.show();b.resize();var a=p.get(0);
d(a.contentWindow.document).find("#order-edit-form").append('<input type="hidden" name="crm_deal[id]" value="'+c.id+'">');a.contentWindow.$.order_edit.container.on("order_edit_save_success",function(){b.close();d.crm.content.reload()})})}})};CRMDeal.prototype.loadEditOrderShippingDetailsDialog=function(a,b){if(0>=a)console.error("Invalid input parameter");else{var c=this.$wrapper.find(".js-deal-edit-order-shipping-details-dialog").clone(),e=b.onLoad||function(){};c.hide();new CRMDialog({html:c,onOpen:function(){var b=
this,f=d.crm.backend_url+"shop/?module=workflow&action=prepare",g=c.find(".crm-dialog-content");d.post(f,{action_id:"editshippingdetails",id:a},function(a){g.html(a);g.find(".js-form-footer-actions").hide();b.show();b.resize();a=g.find("#wf-ship-form").height();c.find(".crm-dialog-block").height(a+150);var f=c.find(".js-submit-dialog-loading"),h=g.find(".js-form-footer-actions .js-submit-button");c.find(".js-submit-dialog-button").on("click",function(a){a.preventDefault();if(h.is(":disabled"))return!1;
g.bind("formSend",function(){f.hide();b.close();d.crm.content.reload()});f.show();h.trigger("click")});e&&e()})}})}};return CRMDeal}(jQuery),CRMDealChangeWorkflowDialog=function(d){CRMDealChangeWorkflowDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form").first();this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMDealChangeWorkflowDialog.prototype.initClass=function(){var a=this;a.$wrapper.find(".js-form-footer-actions").hide();a.$wrapper.on("click",".js-submit-dialog-button",
...
c=b.find(".js-datepicker"),e=b.find('[name="deal[expected_date]"]');c.datepicker({altField:e,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:a});c.on("blur",a);c.on("keydown keypress keyup",function(a){13===a.which&&a.preventDefault()});c.on("click",".js-icon",function(){c.focus()})};CRMDealEdit.prototype.initSave=function(){function a(){for(var a={data:[],errors:[]},c=h.serializeArray(),b=0;b<c.length-1;b++)for(var k=b+1;k<c.length;k++)c[b].name==c[k].name&&(""==c[b].value?c.splice(b,
1):""==c[k].value&&c.splice(k,1));d.each(c,function(c,b){c=d('[name="'+b.name+'"]');var e=0<d('[name="'+b.name+'"][type="radio"]').length,f=""==b.value||""==b.value.trim();1==d(c).prop("required")&&f&&a.errors.push({name:b.name,value:g.locales.bad_amount,is_radio:e});"deal[amount]"===b.name&&(b.value.length&&(b.value=d.trim(b.value)),e=b.value,c=!1,e.length&&(e=e.replace(",","."),0<e||"0"===e)&&(c=!0),c||a.errors.push({name:b.name,value:g.locales.bad_amount}));a.data.push(b)});"edit"===g.contact_mode?
g.can_edit_contact&&e(a):f(a);return a}function b(a){a&&a[0]||(a=[]);d.each(a,function(a,c){a=c.name;var b=c.value;if(c=c.is_radio)var e=g.$wrapper.find('[name="'+a+"\"][type='hidden']"),f=g.$wrapper.find('[name="'+a+"\"][type='radio']");else e=g.$wrapper.find('[name="'+a+'"]');"contact[firstname]"!==a||e.is(":visible")||(e=g.$wrapper.find(".js-contact-autocomplete"));var l=d("<span class='c-error' />").addClass("errormsg").text(b);if(e.length&&!e.hasClass("error"))if(e.parent().append(l),e.addClass("error"),
c)f.one("focus click change",function(){e.removeClass("error");l.remove()});else e.one("focus click change",function(){e.removeClass("error");l.remove()});else k.append(l),h.one("submit",function(){l.remove()})})}function c(a){if(!m){m=!0;var c=d.crm.app_url+"?module=deal&action=save";l.attr("disabled","disabled").prop("disabled",!0);var e=g.$wrapper.find(".loading");e.show();d.post(c,a,function(a){"ok"===a.status?d.crm.content.load(d.crm.app_url+"deal/"+a.data.deal.id+"/"):a.errors&&b(a.errors)},
"json").always(function(){e.hide();m=!1;l.removeAttr("disabled").prop("disabled",!1)})}}function e(a){var c=g.$wrapper.find("#c-contact-edit-form").closest("form"),b=c.find(".js-phone-list"),e=c.find(".js-email-list");c=c.serializeArray();var f=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],h=!0;d.each(c,function(c,b){a.data.push({name:b.name,value:b.value});0<d.trim(b.value).length&&0<=f.indexOf(b.name)&&(h=!1)});h&&(a.errors.push({name:"contact[firstname]",value:g.locales.empty_name}),
a.errors.push({name:"contact[name]",value:g.locales.empty_name}));b.find("li").each(function(c){var b=d(this),e=b.find(".js-value");b=b.find(".js-ext");var f=e.val(),g=b.val();if(f){var h="contact[phone]["+c+"][value]";e.attr("name",h);a.data.push({name:h,value:f});c="contact[phone]["+c+"][ext]";b.attr("name",c);a.data.push({name:c,value:g})}});e.find("li").each(function(c){var b=d(this),e=b.find(".js-value");b=b.find(".js-ext");var f=e.val(),g=b.val();if(f){var h="contact[email]["+c+"][value]";e.attr("name",
h);a.data.push({name:h,value:f});c="contact[email]["+c+"][ext]";b.attr("name",c);a.data.push({name:c,value:g})}});return a}function f(a){var c=g.$wrapper.find("#c-contact-add-form").closest("form").serializeArray(),b=!1,e=!1;d.each(c,function(c,d){c=d.name;var f=d.value;"deal[contact_id]"===c&&f&&(b=!0);"contact[firstname]"===c&&f&&(e=!0);"contact[lastname]"===c&&f&&(e=!0);"contact[middlename]"===c&&f&&(e=!0);"contact[name]"===c&&f&&(e=!0);a.data.push(d)});b||e||(a.errors.push({name:"contact[name]",
value:g.locales.empty_name}),a.errors.push({name:"contact[firstname]",value:g.locales.empty_name}))}var g=this,h=g.$form,k=g.$form.find(".js-errors-place"),l=g.$wrapper.find(".js-submit-button"),m=!1;l.on("click",function(){h.trigger("submit")});h.on("submit",function(d){d.preventDefault();d=a();d.errors.length?b(d.errors):c(d.data)})};CRMDealEdit.prototype.initSuggestName=function(){var a=this,b=a.$form,c=a.$deal_name_input;if(!c.data("edited")){c.one("mark-edited.crm-deal-suggestion",function(){c.data("edited",
1);c.off(".crm-deal-suggestion");b.off(".crm-deal-suggestion",".js-crm-deal-name-suggester-input")});c.on("keyup.crm-deal-suggestion",function(){var a=d(this);0<d.trim(a.val()).length&&a.trigger("mark-edited")});var e=null,f=null,g=function(){e&&(e.abort(),e=null);c.data("edited")||(e=d.post(d.crm.app_url+"?module=deal&action=suggestName",a.suggester_values,function(a){"ok"!==a.status||c.data("edited")||c.val(d.trim(a.data&&a.data.name)||"")}))};b.on("keyup.crm-deal-suggestion change.crm-deal-suggestion",
".js-crm-deal-name-suggester-input",function(c){var e=d(this);f&&clearTimeout(f);f=setTimeout(function(){if(e.hasClass("crm-find-contact-input")){if("keyup"===c.type)return;e=b.find('[name="deal[id]"]')}var f=e.attr("name")||"",h=d.trim(e.val());if(f){a.suggester_values[f]=d.trim(a.suggester_values[f]);if(a.suggester_values[f]===h)return;a.suggester_values[f]=h}g()},250)})}};CRMDealEdit.prototype.initChangeCompanyContact=function(){var a=this,b=a.$wrapper.find(".js-contact-block"),c=b.find(".js-view-toggle"),
e=c.find(".is-active");c.on("click",".c-toggle",function(c){c.preventDefault();c=d(this);var f=c.data("id");if(c.hasClass("is-active"))return!1;a.contact_mode=f;e.length&&e.removeClass("is-active");c.addClass("is-active");e=c;b.find(".c-hidden.is-active").removeClass("is-active");b.find(".c-hidden-"+f).addClass("is-active")})};CRMDealEdit.prototype.initChangeFunnel=function(){var a=this;a.$form.on("change",".js-select-deal-funnel",function(){a.$form.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+
d(this).val())})};CRMDealEdit.prototype.initWYSIWYG=function(){var a=this.$wrapper.find(".js-wysiwyg");if(!a.length)return!1;d.crm.initWYSIWYG(a,{keydownCallback:function(a){}})};CRMDealEdit.prototype.initFieldsBlock=function(){var a=this.$wrapper.find(".js-ext-fields-section");a.on("click",".js-ext-fields-toggle",function(){a.toggleClass("is-extended");d(".js-show-fields-button, .js-hide-fields-button").removeAttr("style")})};CRMDealEdit.prototype.initCombobox=function(){function a(a){a?c.addClass("is-shown"):
c.removeClass("is-shown")}var b=this,c=b.$form.find(".js-contact-owner-wrapper"),e=c.find(".js-field");c.on("click",".js-show-combobox",function(c){c.stopPropagation();a(!0)});c.on("click",".js-hide-combobox",function(c){c.stopPropagation();a(!1)});(function(){var f=c.find(".js-autocomplete");f.autocomplete({appendTo:c,position:{my:"right top",at:"right bottom"},source:b.urls.owner_autocomplete,minLength:0,html:!0,focus:function(){return!1},select:function(b,d){b=d.item;d=c.find(".js-user");b.photo_url&&
d.find(".userpic20").css("background-image","url("+b.photo_url+")");d.find(".c-name").text(b.name);e.val(b.id);a(!1);f.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,c){return d("<li />").addClass("ui-menu-item-html").append("<div>"+c.value+"</div>").appendTo(a)};f.on("focus",function(){f.data("uiAutocomplete").search(f.val())})})()};return CRMDealEdit}(jQuery);var CRMDealChangeClient=function(d){CRMDealChangeClient=function(a){this.$wrapper=a.$wrapper;this.dialog=this.$wrapper.data("dialog");this.deal_id=a.deal_id;this.contact_id=a.contact_id;this.type=a.type;this.can_edit_contact=a.can_edit_contact||!1;this.initClass()};CRMDealChangeClient.prototype.initClass=function(){this.initViewToggle();this.can_edit_contact&&this.initContactChangeData();this.initSwitchContact()};CRMDealChangeClient.prototype.initViewToggle=function(){var a=this,b=a.$wrapper.find(".js-view-toggle"),
c=b.find(".is-active");b.on("click",".c-toggle",function(b){b.preventDefault();b=d(this);var e=b.data("id");if(b.hasClass("is-active"))return!1;c.length&&c.removeClass("is-active");b.addClass("is-active");c=b;a.$wrapper.find(".c-hidden.is-active").removeClass("is-active");a.$wrapper.find(".c-hidden-"+e).addClass("is-active");a.dialog.resize()})};CRMDealChangeClient.prototype.initContactChangeData=function(){function a(){var a=g.serializeArray(),c={data:[],errors:[]},b=["contact[firstname]","contact[middlename]",
"contact[lastname]","contact[name]"],f=!0;d.each(a,function(a,e){c.data.push({name:e.name,value:e.value});0<d.trim(e.value).length&&0<=b.indexOf(e.name)&&(f=!1)});f&&(c.errors.push({name:"contact[firstname]",value:"Name is empty"}),c.errors.push({name:"contact[name]",value:"Name is empty"}));k.find("li").each(function(a){var b=d(this),e=b.find(".js-value");b=b.find(".js-ext");var f=e.val(),g=b.val();if(f){var h="contact[phone]["+a+"][value]";e.attr("name",h);c.data.push({name:h,value:f});a="contact[phone]["+
a+"][ext]";b.attr("name",a);c.data.push({name:a,value:g})}});l.find("li").each(function(a){var b=d(this),e=b.find(".js-value");b=b.find(".js-ext");var f=e.val(),g=b.val();if(f){var h="contact[email]["+a+"][value]";e.attr("name",h);c.data.push({name:h,value:f});a="contact[email]["+a+"][ext]";b.attr("name",a);c.data.push({name:a,value:g})}});c.data.push({name:"deal_id",value:e.deal_id});return c}function b(a){d.post(e.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",a,function(a){"ok"==
a.status?(e.dialog.options.onChange(a.data.html),e.dialog.close()):a.errors&&c(a.errors)},"json").always(function(){h=!1})}function c(a){a=a?a:[];d.each(a,function(a,c){a=c.name;c=c.value;"contact[name]"===a&&(a="contact[firstname]");var b=g.find('[name="'+a+'"]'),e=d("<span />").addClass("errormsg").text(c);b.length?b.hasClass("error")||(b.parent().append(e),b.addClass("error").one("focus click",function(){b.removeClass("error");e.remove()})):(f.append(e),g.one("submit",function(){e.remove()}))})}
var e=this,f=e.$wrapper.find(".js-errors-place"),g=e.$wrapper.find("#c-contact-edit-form").closest("form"),h=!1,k=g.find(".js-phone-list"),l=g.find(".js-email-list");e.$wrapper.on("click",".js-save-changed-data",function(a){a.preventDefault();g.trigger("submit")});g.on("submit",function(d){d.preventDefault();h||(h=!0,d=a(),d.errors.length?(c(d.errors),h=!1):b(d.data))})};CRMDealChangeClient.prototype.initSwitchContact=function(){function a(a){a=a?a:[];d.each(a,function(a,b){a=b.name;b=b.value;"contact[name]"===
a&&(a="contact[firstname]");var g=f.find('[name="'+a+'"]'),h=d("<span />").addClass("errormsg").text(b);g.length?g.hasClass("error")||(g.parent().append(h),g.addClass("error").one("focus click",function(){g.removeClass("error");h.remove()})):(e.append(h),c.$wrapper.one("click",".js-switch-contact",function(){h.remove()}))})}function b(b){g||(g=!0,b.push({name:"deal_id",value:c.deal_id}),d.post("?module=deal&action=personUpdate",b,function(b){"ok"===b.status?(c.dialog.options.onChange(b.data),c.dialog.close()):
b.errors&&a(b.errors)}).always(function(){g=!1}))}var c=this,e=c.$wrapper.find(".js-errors-place"),f=c.$wrapper.find("#c-contact-add-form").closest("form"),g=!1;c.$wrapper.on("click",".js-switch-contact",function(c){c.preventDefault();c=f.serializeArray();var d=[];d.length?a(d):b(c)})};return CRMDealChangeClient}(jQuery);var CRMDealsFunnel=function(d){CRMDealsFunnel=function(a){this.$wrapper=a.$wrapper;this.$header=this.$wrapper.find("#js-funnel-header");this.$actionsHeader=this.$wrapper.find("#js-actions-header");this.$tableContent=this.$wrapper.find(".js-table-content");this.funnel_id=a.funnel_id;this.locales=a.locales;this.selected_deals=[];this.initClass()};CRMDealsFunnel.prototype.initClass=function(){this.initFixedHeader();this.initDealsMove();this.initMassiveActionsHeader();this.initMassActions()};CRMDealsFunnel.prototype.initFixedHeader=
...
a=h.indexOf(a[0]),h.splice(a,1));b();d(window).trigger("scroll")}function b(){function a(){var a=c("open"),b=f.find(".js-deals-close").closest(".c-action"),d=b.find(".js-open-count");a.length?(d.text(a.length),b.show()):b.hide()}function b(){var a=f.find(".js-deals-merge").closest(".c-action");1<h.length?a.show():a.hide()}function e(){var a=!1;d(h).each(function(){if(d(this).data("can-delete"))return a=!0,!1});var c=f.find(".js-deals-delete").closest(".c-action");a?c.show():c.hide()}var g=h.length;
0<h.length&&(f.find(".js-count").text(g),a(),b(),e())}function c(a){var c=[];d.each(h,function(b,e){b=d(e);e=b.data("id");(!a||b.data(a))&&e&&c.push(e)});return c}var e=this,f=e.$actionsHeader,g=f.find(".js-checkbox-all"),h=e.selected_deals;e.$wrapper.on("click",".js-deal-wrapper",function(c){c=d(c.target);var b=!(!c.is("a")&&!c.closest("a").length);c=c.is(":checkbox");if(!b){b=d(this);var e=b.find(".js-check-deal");c||e.attr("checked",!e.is(":checked"));a(b)}});e.$tableContent.find(".js-state-column").shiftSelectable({selector:".js-deal-wrapper",
onSelect:function(c,b){var e=d(b.target);e=!(!e.is("a")&&!e.closest("a").length);var f=b.extra.is_first;b=b.extra.is_last;e||f||b||(c.find(".js-check-deal").attr("checked",!0),a(c))}});g.on("change",function(){var c=d(this).is(":checked");e.$wrapper.find(".js-deal-wrapper").each(function(){var b=d(this),e=b.find(".js-check-deal");e.is(":checked")!==c&&(e.attr("checked",c),a(b))})});f.on("click",".js-deals-merge",function(a){a.preventDefault();a=c();a=d.crm.app_url+"deal/merge/?ids="+a.join(",");d.crm.content.load(a)});
(function(){var a=!1;f.on("click",".js-deals-delete",function(b){b.preventDefault();d.crm.confirm.show({title:e.locales.delete_confirm_title.replace("%s",h.length),text:e.locales.delete_confirm_text,button:e.locales.delete_confirm_button,onConfirm:function(b){function e(){var a=[],b=c();d.each(b,function(c,b){a.push({name:"id[]",value:b})});return a}function f(){var a=h.map(function(a){return a});d.each(a,function(a,c){a=d(c);a.find(".js-check-deal").attr("checked",!1).trigger("change");a.remove()})}
if(!a){a=!0;var g=d.crm.app_url+"?module=deal&action=delete",k=e();d.post(g,k,function(a){"ok"===a.status&&(f(),b.close(),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){a=!1})}return!1}})})})();(function(){var a=!1;f.on("click",".js-deals-change-responsible",function(b){b.preventDefault();a||(a=!0,b={ids:c().join(",")},d.post("?module=deal&action=changeResponsible",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;f.on("click",".js-deals-close",
function(b){b.preventDefault();a||(a=!0,b={ids:c("open").join(",")},d.post("?module=deal&action=massClose",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;f.on("click",".js-deals-change-funnel",function(b){b.preventDefault();a||(a=!0,b={deal_ids:c().join(",")},d.post("?module=deal&action=changeFunnel",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;f.on("click",".js-deals-export",function(b){b.preventDefault();
a||(a=!0,b=c(),d.post(d.crm.app_url+"?module=deal&action=export",{ids:b},function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;f.on("click",".js-deals-set-tags",function(b){b.preventDefault();if(!a){a=!0;b=c();var e=d.crm.app_url+"?module=dealOperation&action=assignTags",f={deal_ids:b};1===b.length&&(f.is_assign=1);d.post(e,f,function(a){new CRMDialog({html:a})}).always(function(){a=!1})}})})()};return CRMDealsFunnel}(jQuery),CRMDealsList=function(d){CRMDealsList=
...
function(){this.initLazy();this.initElasticHeader();this.initMassActions()};CRMDealsList.prototype.initLazy=function(){function a(){if(d.contains(document,g[0])){var c=d(window).scrollTop(),f=e.height(),m=g.offset().top;c+f>=m&&(h||b())}else e.off("scroll",a)}function b(){var a={offset:g.data("offset")};c.stage_id&&(a.stage=c.stage_id);c.contact_id&&(a.user=c.contact_id);h=!0;d.post("?module=deal&action=list",a,function(b){var e=d(b).find(".js-lazyload");e.length?(c.limit+=a.offset,e.insertAfter(g),
g.remove(),g=e):g.remove();d(b).find(".c-deal-wrapper").insertAfter(f.find("tr:last"))}).always(function(){h=!1})}var c=this,e=d(window),f=c.$tableBody,g=c.$wrapper.find(".js-lazyload"),h=!1;g.length&&(e.on("scroll",a),g.offset().top<e.height()&&e.trigger("scroll"))};CRMDealsList.prototype.initElasticHeader=function(){function a(){d.contains(document,e[0])?b.scrollTop()>f.top?e.css({left:f.left}).width(c.outerWidth()).addClass("is-fixed"):e.removeAttr("style").removeClass("is-fixed"):b.off("scroll",
a)}var b=d(window),c=this.$tableWrapper,e=this.$tableHeaderW,f=c.offset();b.on("scroll",a)};CRMDealsList.prototype.initMassActions=function(){function a(a){a.find(".js-check-deal").prop("checked",!0).trigger("change",[!0])}function b(a){a.find(".js-check-deal").prop("checked",!1).trigger("change",[!1])}function c(a){a.find(".js-check-deal").is(":checked")?(a.addClass("is-active"),h.push(a[0])):(a.removeClass("is-active"),a=h.indexOf(a[0]),h.splice(a,1));e()}function e(){function a(){var a=f("open"),
b=l.find(".js-deals-close").closest(".c-operation-li"),c=b.find(".js-open-count");a.length?(c.text(a.length),b.show()):b.hide()}function b(){var a=l.find(".js-deals-merge").closest(".c-operation-li");1<h.length?a.show():a.hide()}function c(){var a=!1;d(h).each(function(){if(d(this).data("can-delete"))return a=!0,!1});var b=l.find(".js-deals-delete").closest(".c-operation-li");a?b.show():b.hide()}var e=h.length;0<e?(k.hide(),l.show().find(".js-count").text(e),a(),b(),c(),e<g.limit?m.prop("indeterminate",
!0):m.prop("indeterminate",!1).prop("checked",!0)):(k.show(),l.hide(),m.prop("indeterminate",!1).prop("checked",!1))}function f(a){var b=[];d.each(h,function(c,e){c=d(e);e=c.data("id");(!a||c.data(a))&&e&&b.push(e)});return b}var g=this,h=[],k=g.$tableHeader,l=g.$tableActions,m=g.$tableHeaderW.find(".js-checkbox-all");g.$tableBody.on("click",".js-deal-wrapper",function(a){a=d(a.target);var b=d(this),e=b.find(".js-check-deal");e.closest("td");var f=!(!a.is("a")&&!a.closest("a").length),g=!(!a.is(".c-column-checkbox")&&
!a.closest(".c-column-checkbox").length);if(a.is(":checkbox"))return c(b),!0;if(f)return!0;g&&(e.attr("checked",!e.is(":checked")),c(b))});g.$tableBody.shiftSelectable({selector:".js-deal-wrapper",onSelect:function(a,b){var e=d(b.target);e=!(!e.is("a")&&!e.closest("a").length);var f=b.extra.is_first;b=b.extra.is_last;e||f||b||(a.find(".js-check-deal").attr("checked",!0),c(a))}});m.on("change",function(){var e=d(this).is(":checked"),f=g.$wrapper.find(".js-deal-wrapper"),h=f.find(".js-check-deal").filter(":checked").length;
0<h?h<g.limit||h===g.limit?b(f):a(f):e?a(f):b(f);f.each(function(){c(d(this))})});l.on("click",".js-deals-merge",function(a){a.preventDefault();a=f();a=d.crm.app_url+"deal/merge/?ids="+a.join(",");d.crm.content.load(a)});(function(){var a=!1;l.on("click",".js-deals-delete",function(b){b.preventDefault();d.crm.confirm.show({title:g.locales.delete_confirm_title.replace("%s",h.length),text:g.locales.delete_confirm_text,button:g.locales.delete_confirm_button,onConfirm:function(b){function c(){var a=[],
b=f();d.each(b,function(b,c){a.push({name:"id[]",value:c})});return a}function e(){var a=h.map(function(a){return a});d.each(a,function(a,b){a=d(b);a.find(".js-check-deal").attr("checked",!1).trigger("change");a.remove()})}if(!a){a=!0;var g=d.crm.app_url+"?module=deal&action=delete",p=c();d.post(g,p,function(a){"ok"===a.status&&(e(),b.close(),k.show(),l.hide(),m.prop("indeterminate",!1).prop("checked",!1),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){a=!1})}return!1}})})})();
(function(){var a=!1;l.on("click",".js-deals-change-responsible",function(b){b.preventDefault();a||(a=!0,b={ids:f().join(",")},d.post("?module=deal&action=changeResponsible",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;l.on("click",".js-deals-close",function(b){b.preventDefault();a||(a=!0,b={ids:f("open").join(",")},d.post("?module=deal&action=massClose",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;l.on("click",
".js-deals-change-funnel",function(b){b.preventDefault();a||(a=!0,b={deal_ids:f().join(",")},d.post("?module=deal&action=changeFunnel",b,function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;l.on("click",".js-deals-export",function(b){b.preventDefault();a||(a=!0,b=f(),d.post(d.crm.app_url+"?module=deal&action=export",{ids:b},function(a){new CRMDialog({html:a})}).always(function(){a=!1}))})})();(function(){var a=!1;l.on("click",".js-deals-set-tags",function(b){b.preventDefault();
if(!a){a=!0;b=f();var c=d.crm.app_url+"?module=dealOperation&action=assignTags",e={deal_ids:b};1===b.length&&(e.is_assign=1);d.post(c,e,function(a){new CRMDialog({html:a})}).always(function(){a=!1})}})})()};return CRMDealsList}(jQuery),CRMDealsMergePage=function(d){CRMDealsMergePage=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$submitButton=this.$wrapper.find(".js-submit-button");this.$activeDeal=this.is_deal_set=!1;this.initClass()};CRMDealsMergePage.prototype.initClass=
function(){this.initSubmit();this.initSelectDeal()};CRMDealsMergePage.prototype.initSubmit=function(){function a(){function a(a){var b="";d.each(a,function(a,c){if("master_id"===c.name)return b=c.value,!1});return b}if(!c){c=!0;var f=b.serializeArray();d.post("?module=deal&action=mergeRun",f,function(b){b=d.crm.app_url+"deal/"+a(f)+"/";d.crm.content.load(b)},"json").always(function(){c=!1})}}var b=this.$form,c=!1;b.on("submit",function(b){b.preventDefault();a()})};CRMDealsMergePage.prototype.initSelectDeal=
...
e=a.$wrapper.find(".js-user-field"),f=b.find(".menu-v");f.on("click","a",function(){var b=d(this),h=b.closest(".js-user");c.find(".js-text").html(b.html());f.find(".selected").removeClass("selected");h.addClass("selected");f.hide();setTimeout(function(){f.removeAttr("style")},200);b=h.data("id");e.val(b).trigger("change");a.is_responsive_set||(a.$submitButton.attr("disabled",!1),a.is_responsive_set=!0)})};CRMDealsChangeResponsibleDialog.prototype.initSubmit=function(){function a(){if(!e){e=!0;var a=
c.serializeArray();d.post("?module=deal&action=changeResponsibleRun",a,function(a){"ok"===a.status?(b.dialog.close(),d.crm.content.reload()):alert("errors")},"json").always(function(){e=!1})}}var b=this,c=b.$form,e=!1;c.on("submit",function(b){b.preventDefault();a()})};return CRMDealsChangeResponsibleDialog}(jQuery),CRMDealsCloseDialog=function(d){CRMDealsCloseDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$reasonSelect=this.$wrapper.find(".js-reason-select");
...
g=c.find(".menu-v");g.on("click","a",function(){var b=d(this);e.find(".js-text").html(b.html());g.find(".selected").removeClass("selected");b.closest("li").addClass("selected");g.hide();setTimeout(function(){g.removeAttr("style")},200);b=b.data("id");f.val(b).trigger("change");a(b)})};CRMDealsChangeFunnelDialog.prototype.initChangeStage=function(){function a(a){h.html("");d.each(a,function(a,c){a=b.stage_template_html;var e=d("<div />").text(c.name).html();a=a.replace("%id%",c.id).replace("%color%",
c.color).replace("%name%",e);c=d(a);h.append(c)});d.crm.renderSVG(e);h.find("li:first-child a").trigger("click")}var b=this,c=b.$wrapper.find(".js-funnels-list"),e=b.$wrapper.find(".js-funnel-stages-list"),f=e.find(".js-visible-link"),g=e.find(".js-field"),h=e.find(".menu-v");h.on("click","a",function(){var a=d(this);f.find(".js-text").html(a.html());h.find(".selected").removeClass("selected");a.closest("li").addClass("selected");h.hide();setTimeout(function(){h.removeAttr("style")},200);a=a.data("id");
...
0},f);d.post(e,a).done(function(a){"ok"==a.status&&(a.data.done?(g.hide(),b.attr("disabled",!1),d.crm.content.reload()):k(a.data.offset||0))})};k()})};return CRMDealOperationAssignTags}(jQuery);var CRMInvoiceEdit=function(d){function a(a,b){a=a.toFixed(2);"ru"===b&&(a=a.replace(".",","));return a}function b(a){var b=0;a&&a.length&&(a=a.replace(/,/g,".").replace(/\s/g,""),b=parseFloat(a)!=a?!1:parseFloat(a));return b}CRMInvoiceEdit=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$table=this.$wrapper.find(".c-product-table");this.$tableBody=this.$table.find("tbody");this.$emptyTax=this.$table.find(".js-empty-tax");this.$emptyTaxLink=this.$table.find(".js-empty-tax-link");
this.$tax=this.$table.find(".js-tax-toggle");this.$taxPercent=this.$table.find(".js-tax-percent");this.$taxType=this.$table.find(".js-tax-type");this.$taxName=this.$table.find(".js-tax-name");this.$taxHeader=this.$table.find(".js-tax-header");this.$currencyField=this.$wrapper.find(".js-currency-field");this.$companyField=this.$wrapper.find(".js-company-select");this.locale=a.locale;this.locales=a.locales;this.companies=a.companies||{};this.invoice_id=a.invoice_id;this.row_template_html=a.row_template_html;
this.confirm_dialog_template=a.confirm_dialog_template;this.shop_supported=a.shop_supported;this.tax_set_class="is-changed";this.currencies=a.currencies;this.supported_currencies=a.supported_currencies;this.company_id=a.company_id;this.tax=a.tax&&a.tax.name?a.tax:!1;this.active_tax_array=[];this.tax_percent=d(this.$tax.find("option")[this.$tax[0].selectedIndex]).data("percent")||"0";this.tax_type=d(this.$tax.find("option")[this.$tax[0].selectedIndex]).data("type");this.initClass()};CRMInvoiceEdit.prototype.initClass=
function(){this.initDatePickers();this.initTableEvents();this.initWYSIWYG();this.initSubmit();this.initChangeContact();this.initChangeCurrency();this.shop_supported&&this.initProductName();this.initChangeTax();this.initChangeCompany();this.initToggleButton()};CRMInvoiceEdit.prototype.initTableEvents=function(){function a(c){if(d.contains(document,b.$table[0])){var e=!0,f=b.$table.find(".js-tax-dropdown.is-active");c=d(c.target).closest(".js-tax-dropdown");c.length&&(e=c.hasClass("is-active"));f.removeClass("is-active");
e||"NONE"===b.tax_type||c.addClass("is-active")}else d(document).off("click",a)}var b=this;b.$table.on("focus",".js-name-field",function(){var a=d(this).closest("tr"),c=b.$tableBody.find("tr").length;a.index()+1>=c&&b.addTableRow(c+1)});b.$table.on("keypress",".js-name-field",function(a){13===a.keyCode&&a.preventDefault()});b.$table.on("click",".js-remove-row",function(a){a.preventDefault();1<b.$tableBody.find("tr").length&&b.removeTableRow(d(this).closest("tr"))});b.$table.on("change",".js-amount-field",
function(){b.changeTableRow(d(this))});b.$table.on("change",".js-price-field",function(){var a=d(this).closest("tr").find(".js-amount-field");a.val()||a.val("1");b.changeTableRow(d(this))});b.$table.on("click",".js-set-product-tax",function(){var a=d(this),c=a.closest(".js-tax-dropdown"),e=c.find(".js-product-tax-percent"),k=c.find(".js-product-tax-type");a=parseInt(a.data("tax-index"));if(a=b.active_tax_array[a])parseInt(b.tax_percent)===parseInt(a.tax_percent)&&b.tax_type===a.tax_type?c.removeClass(b.tax_set_class):
c.addClass(b.tax_set_class),c=b.tax_type,"NONE"===a.tax_type&&(c="NONE"),k.val(c).trigger("change"),k=a.tax_percent+"%","NONE"===a.tax_type&&(k=b.companies[b.$companyField.val()],k=b.locales.no_tax.replace("%name",k.tax_name)),e.val(k).trigger("change"),b.refreshTable()});d(document).on("click",a)};CRMInvoiceEdit.prototype.addTableRow=function(a){var b=d(this.row_template_html);b.find(".js-product-number").text(a);this.renderProductTaxOptions(b);this.$tableBody.append(b);this.renderProductTaxFields();
this.shop_supported&&this.$wrapper.trigger("addProduct",b)};CRMInvoiceEdit.prototype.removeTableRow=function(a){a.remove();this.$tableBody.find("tr").each(function(a){d(this).find(".js-product-number").text(a+1)});this.refreshTable()};CRMInvoiceEdit.prototype.changeTableRow=function(b){var c=this.locale,d="price"===b.data("type"),g=b.val(),h=0;g&&g.length&&(g=g.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(g)&&(h=parseFloat(g)));b.val(d?a(h,c):h);this.refreshTable()};CRMInvoiceEdit.prototype.refreshTable=
function(){var c=this,e=function(){var e=[];c.$tableBody.find("tr").each(function(){var f=d(this),g=f.find(".js-amount-field"),h=f.find(".js-price-field"),k=f.find(".js-product-total"),q=f.find(".js-product-tax-percent");g=b(g.val());h=b(h.val());var r=0;0<g&&0<h&&(r=h*g);k.text(a(r,c.locale));(k=parseInt(q.val()))&&(0<k||0===k)||(k=0);e.push({$tr:f,percent:k,amount:g,price:h,total:r})});return e}(),f=c.tax_type&&"INCLUDE"===c.tax_type,g=0,h=0;d.each(e,function(a,b){g+=b.total;a=b.percent/100;h+=
f?a/(1+a)*b.total:b.total*a});c.$table.find(".js-subtotal").text(a(g,c.locale));c.$table.find(".js-tax").text(a(h,c.locale));c.$table.find(".js-total").text(a(g+(f?0:h),c.locale))};CRMInvoiceEdit.prototype.renderProductTaxOptions=function(a){var b=this,c=!1,g;c=a&&a.length?a.find(".js-tax-dropdown"):b.$tableBody.find(".js-tax-dropdown");var h=c.find(".js-hidden-list").html(""),k=b.companies[b.$companyField.val()],l=[];d.each(b.active_tax_array,function(a,c){g="NONE"===c.tax_type?b.locales.no_tax.replace("%name",
k.tax_name):c.tax_percent+"%";0>l.indexOf(g)&&(l.push(g),h.append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><div class="js-set-product-tax" data-tax-index="'+a+'">'+g+"</div></div></li>"))})};CRMInvoiceEdit.prototype.renderProductTaxFields=function(a){var b=this,c=b.$tableBody.find(".js-tax-dropdown");a&&c.removeClass(b.tax_set_class);c.each(function(){var a=d(this),c=a.find(".js-product-tax-percent"),e=a.find(".js-product-tax-type");a.hasClass(b.tax_set_class)&&
"NONE"!==b.tax_type||(e.val(b.tax_type).trigger("change"),e=b.tax_percent+"%","NONE"===b.tax_type&&(e="\u2014",a.removeClass(b.tax_set_class)),c.val(e).trigger("change"))})};CRMInvoiceEdit.prototype.initSubmit=function(){function a(){var a={data:[],errors:[]},c=h.serializeArray();d.each(c,function(b,c){"invoice[contact]"!==c.name&&a.data.push(c);"invoice[contact_id]"===c.name&&(0<c.value||a.errors.push({name:"invoice[contact_id]",value:g.locales.empty_contact}))});(function(a){g.$tableBody.find("tr").each(function(c){var e=
d(this),f=e.find(".js-product-field"),g=e.find(".js-amount-field"),h=e.find(".js-price-field"),k=e.find(".js-product-tax-percent"),l=e.find(".js-product-tax-type");e=e.find(".js-name-field");g=b(g.val());h=b(h.val());k=parseInt(k.val());l=l.val();f=f.val();e=e.val();if(g||h||e)a.push({name:"items["+c+"][name]",value:e}),a.push({name:"items["+c+"][price]",value:h}),a.push({name:"items["+c+"][quantity]",value:g}),a.push({name:"items["+c+"][tax_percent]",value:0<k||0===k?k:""}),a.push({name:"items["+
c+"][tax_type]",value:l});f&&a.push({name:"items["+c+"][product_id]",value:f})})})(a.data);return a}function e(a,b){b=b?b:[];if(a){var c=Object.keys(a);d.each(c,function(c,d){b.push({name:d,value:a[d]})})}d.each(b,function(a,b){a=b.value;var c=g.$form.find('[name="'+b.name+'"]');if(c.length&&!c.hasClass("error")){var e=d("<span />").addClass("errormsg").text(a);b=c.offset();a=g.$wrapper.offset();var f=b.top-a.top+c.outerHeight();e.css({left:b.left-a.left+"px",top:f+"px"});g.$wrapper.append(e);c.addClass("error").one("focus click change",
function(){c.removeClass("error");e.remove()})}})}function f(a){k||(k=!0,d.post(d.crm.app_url+"?module=invoice&action=save",a,function(a){"ok"===a.status?a.data.id&&(d(document).trigger("unsavedChanges",!1),d.crm.content.load(d.crm.app_url+"invoice/"+a.data.id+"/")):e(a.errors)},"json").always(function(){k=!1}))}var g=this,h=g.$form,k=!1;h.on("submit",function(b){b.preventDefault();b=a();b.errors.length?e(!1,b.errors):f(b.data)})};CRMInvoiceEdit.prototype.initDatePickers=function(){var a=this,b=a.$wrapper.find(".js-invoice-datepicker"),
f=a.$wrapper.find(".js-invoice-due-datepicker"),g=a.$wrapper.find(".js-due-days-field"),h=a.$wrapper.find(".js-clear-due-date");(function(){var c=b.parent().find("input[type='hidden']");b.datepicker({altField:c,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});a.invoice_id||b.datepicker("setDate","+0d")})();(function(){var a=f.parent().find("input[type='hidden']");f.datepicker({altField:a,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});f.on("change",function(){var b=d(this).val();d.trim(b).length?
h.show():(a.val(""),h.hide())})})();a.$wrapper.on("click",".js-focus-on-field",function(){d(this).parent().find("input:text").trigger("focus")});g.on("change",function(){var a=g.val(),c=0;a&&a.length&&0<parseInt(a)&&(c=parseInt(a),g.val(c));0<c?h.show():h.hide();g.val(c);a=c;c=b.datepicker("getDate");a=new Date(c.getTime()+864E5*a);f.datepicker("setDate",a)});b.on("change",function(){var a=g.val();a&&a.length&&0<parseInt(a)&&g.trigger("change")});f.on("change",function(){g.val("")});h.on("click",
function(){f.val("").trigger("change")})};CRMInvoiceEdit.prototype.initChangeContact=function(){var a=this.$wrapper.find(".js-contact-toggle"),b=a.find(".js-name"),f=a.find(".js-contact-id"),g=!1;a.on("click",".js-change-contact",function(a){a.preventDefault();var c=d(this);d.get(d.crm.app_url+"?module=invoice&action=contactAdd",function(a){new CRMDialog({html:a,options:{onAdd:function(a,d){f.val(a).trigger("change");b.text(d);g||(a=c.find(".js-label"),d=a.data("change-text"),a.text(d),g=!0)}}})})})};
CRMInvoiceEdit.prototype.initChangeCompany=function(){function a(a,c,e){a&&a.length&&(b.active_tax_array=a);g.find("option").remove();b.$taxHeader.text(c.length?c:"\u2014");a&&c?(b.$emptyTax.hide(),b.$tax.show(),d.each(a,function(a,e){a=d('<option value="'+a+'"></option>');if("INCLUDE"===e.tax_type){a.data("type","INCLUDE");var f=b.locales.include_tax}else"APPEND"===e.tax_type?(a.data("type","APPEND"),f=b.locales.append_tax):"NONE"===e.tax_type&&(a.data("type","NONE"),e.tax_percent=0,f=b.locales.no_tax);
0<e.tax_percent?(a.data("percent",e.tax_percent),f=f.replace("%value",e.tax_percent+"%")):(a.data("percent",0),f=f.replace("%value",""));if(f=f.replace("%name",c)){if(b.tax){var h=c===b.tax.name,k=e.tax_type===b.tax.type;e=(+e.tax_percent).toFixed(2)===(+b.tax.percent).toFixed(2);h&&k&&e&&a.attr("selected",!0)}a.text(f);a.data("name",c);g.append(a)}})):(b.$tax.hide(),b.$emptyTax.show(),a=b.$emptyTaxLink.data("href"),b.$emptyTaxLink.attr("href",a+b.$companyField.val().toString()+"/"));g.trigger("change",
!e)}var b=this,f=b.$companyField,g=b.$tax;f.on("change",function(c,e){c=d(this).val();var f=b.companies[c];b.active_tax_array=[];f&&(c=f.tax_name||b.locales.tax,f=JSON.parse(f.tax_options),a(f,c,e))});f.trigger("change",!0)};CRMInvoiceEdit.prototype.initChangeTax=function(){var a=this;a.$tax.on("change",function(b,c){b=d(this).find("option");a.tax_percent=0;a.tax_type="NONE";a.tax_name="";b.length&&(b=b[this.selectedIndex],a.tax_percent=d(b).data("percent")||0,a.tax_type=d(b).data("type"),a.tax_name=
d(b).data("name"));a.$taxPercent.val(a.tax_percent);a.$taxType.val(a.tax_type);a.$taxName.val(a.tax_name);a.renderProductTaxOptions();a.renderProductTaxFields(c);a.refreshTable()})};CRMInvoiceEdit.prototype.initWYSIWYG=function(){var a=this.$wrapper.find(".js-wysiwyg");d.crm.initWYSIWYG(a,{keydownCallback:function(a){}})};CRMInvoiceEdit.prototype.initProductName=function(){function a(a){function c(a){u&&u.abort();var c=d.crm.backend_url+"shop/?action=autocomplete&with_counts=1";a={term:a};f("loading");
u=d.get(c,a,function(a){a.length?(r.html(""),d.each(a,function(a,b){a=d("<div />");a.html(b.label).data("product",b).addClass("js-set-product");f(a)})):b.$wrapper.trigger("searchProduct")},"json").always(function(){u=!1})}function e(a){u&&u.abort();f("loading");var c=b.$currencyField.val();u=d.get(d.crm.backend_url+"shop/?module=orders&action=getProduct",{product_id:a.id,currency:c},function(a){"ok"===a.status?(r.html(""),d.each(a.data.sku_ids,function(b,c){b=d("<div />");c=a.data.product.skus[c];
b.text(a.data.product.name+(c.name.length?" ("+c.name+")":"")).data("product",a.data.product).data("sku",c).addClass("js-set-sku");f(b);1===a.data.sku_ids.length&&b.trigger("click")})):b.$wrapper.trigger("searchProduct")},"json").always(function(){u=!1})}function f(a){if("loading"===a)r.html("").append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><i class="icon16 loading"></i></div></li>');else{var b=d("<li />").addClass("ui-menu-item-html ui-menu-item");d("<div />").addClass("ui-menu-item-wrapper").append(a).appendTo(b);
b.appendTo(r)}}function g(){a.removeClass("is-active");r.html("");t=!1}function p(a){var b=r.find("li"),c=b.filter(".is-highlighted");if(!b.length)return!1;c.length&&1<b.length?(c.removeClass("is-highlighted"),a?(a=c.next(),a.length||(a=b.first())):(a=c.prev(),a.length||(a=b.last()))):a=b.first();a.addClass("is-highlighted")}function n(){var a=r.find("li.is-highlighted");a.length&&a.find(".ui-menu-item-wrapper > *").first().trigger("click")}var q=a.find(".js-name-field"),r=a.find(".js-hidden-list"),
v=a.find(".js-product-field"),t=!1,y=0,u=!1;q.on("keyup",function(e){e=e.keyCode;if(0<=[13,27,37,38,39,40].indexOf(e))switch(e){case 13:n();break;case 27:g();q.trigger("blur");break;case 38:p(!1);break;case 40:p(!0)}else{var f=d(this).val();1<f.length?(t||(b.$wrapper.trigger("searchProduct"),a.addClass("is-active"),t=!0),clearTimeout(y),y=setTimeout(function(){c(f)},500)):b.$wrapper.trigger("searchProduct")}});q.on("change",function(){v.val("").trigger("change")});b.$wrapper.on("searchProduct",g);
r.on("click",".js-set-product",function(){var a=d(this).data("product");a&&e(a)});r.on("click",".js-set-sku",function(){var b=d(this),c=b.data("product");b=b.data("sku")||!1;if(c){var e="shop:"+c.id+(b?":"+b.id:""),f=b.price;q.val(c.name+(b.name.length?" ("+b.name+")":"")).trigger("change");a.closest("tr").find(".js-price-field").val(f).trigger("change");v.val(e).trigger("change")}g();q.trigger("blur")})}var b=this,f=b.$wrapper.find(".js-name-autocomplete");f.length&&(f.each(function(){a(d(this))}),
b.refreshTable());b.$wrapper.on("addProduct",function(b,c){b=d(c).find(".js-name-autocomplete");b.length&&a(b)})};CRMInvoiceEdit.prototype.initChangeCurrency=function(){function a(a,c){b.$tableBody.find(".js-price-field").each(function(){var e=d(this),f=e.val(),g=0;f&&f.length&&(f=f.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(f)&&(g=parseFloat(f)),e.val(g*b.currencies[c].rate/b.currencies[a].rate).trigger("change"))})}var b=this,f=b.$currencyField.val();b.$currencyField.on("change",function(){var c=
b.$currencyField.val(),e=!1;b.$tableBody.find(".js-price-field").each(function(){if(d(this).val().length)return e=!0,!1});e?(b.$currencyField.val(f),new CRMDialog({html:b.confirm_dialog_template,options:{changeCurrencyWithPrice:function(){b.$currencyField.val(c);a(c,f);f=c},changeCurrency:function(){b.$currencyField.val(c);f=c}}})):f=c})};CRMInvoiceEdit.prototype.initToggleButton=function(){var a=this.$wrapper.find(".js-footer-actions"),b=a.find(".js-submit-button");this.$wrapper.on("change keydown",
"input, textarea, select",function(){b.removeClass("green").addClass("yellow");a.addClass("is-changed");d(document).trigger("unsavedChanges",!0)})};return CRMInvoiceEdit}(jQuery),CRMInvoiceContactAdd=function(d){CRMInvoiceContactAdd=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.locales=a.locales;this.initClass()};CRMInvoiceContactAdd.prototype.initClass=function(){function a(){var a=e.$form.serializeArray(),b={data:[],errors:[]},
c=!1,f=!1;d.each(a,function(a,d){a=d.name;var e=d.value;"deal[contact_id]"===a&&e&&(c=!0);"contact[firstname]"===a&&e&&(f=!0);"contact[lastname]"===a&&e&&(f=!0);"contact[middlename]"===a&&e&&(f=!0);"contact[name]"===a&&e&&(f=!0);b.data.push(d)});c||f||(b.errors.push({name:"contact[name]",value:e.locales.empty_name}),b.errors.push({name:"contact[firstname]",value:e.locales.empty_name}));return b}function b(a){d.post("?module=invoice&action=contactAddSave",a,function(a){"ok"===a.status?(e.dialog.options.onAdd(a.data.id,
a.data.name),e.dialog.close()):c(a.errors)},"json").always(function(){f=!1})}function c(a,b){b=b?b:[];if(a){var c=Object.keys(a);d.each(c,function(c,d){b.push({name:d,value:a[d]})})}d.each(b,function(a,b){a=b.name;b=b.value;"name"===a&&(a="contact[firstname]");var c=e.$form.find('[name="'+a+'"]');"contact[firstname]"!==a||c.is(":visible")||(c=e.$form.find(".js-contact-autocomplete"));if(c.length&&!c.hasClass("error")){var f=d("<span />").addClass("errormsg").text(b);f.insertAfter(c);c.addClass("error").one("focus click",
function(){c.removeClass("error");f.remove()});d(document).on("toggleChanged",function(){c.removeClass("error");f.remove()})}})}var e=this,f=!1;e.$form.on("submit",function(d){d.preventDefault();d=e.$wrapper.find(".js-contact-id-field").val();if(d){var g=e.$wrapper.find(".js-contact-autocomplete").val();e.dialog.options.onAdd(d,g);e.dialog.close()}else f||(f=!0,d=a(),d.errors.length?(c(!1,d.errors),f=!1):b(d.data))})};return CRMInvoiceContactAdd}(jQuery),CRMInvoicePage=function(d){function a(a,c){if(!a)return!1;
a=d('.js-invoices-list .c-invoice[data-id="'+a+'"]');a.length&&(c?a.replaceWith(c):a.remove())}CRMInvoicePage=function(a){this.$wrapper=a.$wrapper;this.invoice_id=a.invoice_id;this.locales=a.locales;this.initClass()};CRMInvoicePage.prototype.initClass=function(){var a=this;a.initChangeState();a.initDelete();a.initRefund();a.initRestore();setTimeout(function(){d(document).trigger("viewInvoice",a.invoice_id)},100);a.$wrapper.data("page",a)};CRMInvoicePage.prototype.initChangeState=function(){function b(b){f||
(f=!0,d.post("?module=invoice&action=handleTransaction",{invoice_id:e,action:b},function(e){"ok"===e.status?(a(c.invoice_id,"delete"===b?"":e.data.html),c.load(d.crm.app_url+"invoice/"+c.invoice_id+"/")):alert(e.errors)},"json").always(function(){f=!1}))}var c=this,e=c.invoice_id,f=!1;c.$wrapper.on("click",".js-change-state",function(a){a.preventDefault();(a=d(this).data("action"))&&b(a)})};CRMInvoicePage.prototype.initDelete=function(){function a(){e||(e=!0,d.post("?module=invoice&action=handleTransaction",
{invoice_id:c.invoice_id,action:"delete"},function(a){"ok"===a.status&&d.crm.content.load(d.crm.app_url+"invoice/")},"json").always(function(){e=!1}))}var c=this,e=!1;c.$wrapper.on("click",".js-delete-invoice",function(b){b.preventDefault();d.crm.confirm.show({title:c.locales.delete_confirm_title,text:c.locales.delete_confirm_text,button:c.locales.delete_confirm_button,onConfirm:a})})};CRMInvoicePage.prototype.initRefund=function(){function a(){e||(e=!0,d.post(d.crm.app_url+"?module=invoice&action=refundDialog",
{invoice_id:c.invoice_id},function(a){new CRMDialog({html:a,options:{onRefund:function(){c.reload()}}})}).always(function(){e=!1}))}var c=this,e=!1;c.$wrapper.on("click",".js-change-refund",function(b){b.preventDefault();a()})};CRMInvoicePage.prototype.initRestore=function(){function b(){e||(e=!0,d.post("?module=invoiceRestore",{id:c.invoice_id},function(b){"ok"===b.status?(a(c.invoice_id,b.data.html),c.reload()):alert(b.errors)},"json").always(function(){e=!1}))}var c=this,e=!1;c.$wrapper.on("click",
".js-restore-invoice",function(a){a.preventDefault();b()})};CRMInvoicePage.prototype.load=function(a){a=d("<a />").addClass("js-disable-router").attr("href",a).hide();this.$wrapper.append(a);a.trigger("click")};CRMInvoicePage.prototype.reload=function(){this.load(location.href)};return CRMInvoicePage}(jQuery),CRMInvoiceRefundDialog=function(d){CRMInvoiceRefundDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.initClass()};
CRMInvoiceRefundDialog.prototype.initClass=function(){this.initSubmit()};CRMInvoiceRefundDialog.prototype.initSubmit=function(){function a(){var a={data:[],errors:[]},b=e.serializeArray();d.each(b,function(b,c){a.data.push(c)});return a}function b(a){f||(f=!0,d.post(d.crm.app_url+"?module=invoice&action=handleTransaction",a,function(a){"ok"===a.status?(c.dialog.options.onRefund(),c.dialog.close()):console.log(a.errors)},"json").always(function(){f=!1}))}var c=this,e=c.$form,f=!1;e.on("submit",function(c){c.preventDefault();
c=a();c.errors.length?console.log(c.errors):b(c.data)})};return CRMInvoiceRefundDialog}(jQuery);var CRMInvoices=function(d){function a(){var a=!1,c=d("#c-invoice-page");c.length&&(c=c.data("id"))&&(a=c);return a}CRMInvoices=function(a){this.$wrapper=a.$wrapper;this.$content=this.$wrapper.find("#js-inner-content");this.$sidebar=this.$wrapper.find("#js-aside-block");this.$invoiceList=this.$sidebar.find(".js-invoices-list");this.initClass()};CRMInvoices.prototype.initClass=function(){this.initElastic();this.initContentRouter();this.initLazy();this.initInvoiceList();this.initInvoiceSearch()};CRMInvoices.prototype.initElastic=
...
"?module=autocomplete&type=user",minLength:0,html:!0,focus:function(){return!1},select:function(d,f){d=f.item;f=c.find(".js-user");d.photo_url&&f.find(".icon16").css("background-image","url("+d.photo_url+")");f.find(".c-name").text(d.name);e.val(d.id);b(!1);a.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d("<li />").addClass("ui-menu-item-html").append("<div>"+b.value+"</div>").appendTo(a)};a.on("focus",function(){a.data("uiAutocomplete").search(a.val())})})()})(c);
...
(e=b.contains(d.document,window.frameElement));if(e)c.onScroll();else c.$window.off("scroll",a),b(d).off("scroll",a)}var c=this,d=window.parent;c.$window.on("scroll",a);if(d&&window.frameElement)b(d).on("scroll",a)};a.prototype.onScroll=function(){var a=this.$window,c=a.scrollTop();a=a.height();var d=this.$paging.offset().top;if(window.parent&&window.frameElement){var h=b(window.parent);a=h.height();c+=h.scrollTop();d+=b(window.frameElement).offset().top}c+a>=d&&!this.is_locked&&(this.is_locked=!0,
this.loadNextPage())};a.prototype.loadNextPage=function(){var a=this,c=a.log.filtersData.slice(0);c.push({name:"max_id",value:a.$paging.data("max-id")});c.push({name:"timestamp",value:a.$list.find(a.items_name).last().data("timestamp")});a.xhr&&a.xhr.abort();a.xhr=b.get("?module=logLive",c,function(c){var d=b("<div id='c-temp-wrapper' />");a.log.$wrapper.after(d);d.html(c);c=d.find(a.list_name+" "+a.items_name);d=d.find(a.pagind_name);a.$list.append(c);a.$paging.after(d);a.$paging.remove();a.$paging=
d;a.is_locked=!1;a.onLoad()})};return a}(jQuery),b=function(a){function c(a,b){var c=a.offsetWidth;a=a.offsetHeight;return{outer_width:c,outer_height:a,inner_width:c-b.left-b.right,inner_height:a-b.top-b.bottom}}function d(b){function c(a){var b=a.split("-");a=parseInt(b[0]);var c=parseInt(b[1])-1;b=parseInt(b[2]);return new Date(a,c,b)}var d=[];b=function(b){function c(a,b){var c=a.split("-");a=parseInt(c[0]);var d=parseInt(c[1])-1;c=parseInt(c[2]);d=new Date((new Date(a,d,c)).getTime()+(b?864E5:
-864E5));b=parseInt(d.getFullYear());a=parseInt(d.getMonth())+1;d=parseInt(d.getDate());10>d&&(d="0"+d);10>a&&(a="0"+a);return[b,a,d].join("-")}1===b[0].data.length&&a.each(b,function(a){var d=b[a].data[0],e={value:0,date:c(d.date,!1)},f={value:0,date:c(d.date,!0)};b[a].data=[e,d,f]});return b}(b);for(var e=0;e<b.length;e++){for(var f=b[e].data,g=[],h=0;h<f.length;h++){var k=f[h],t=parseInt(k.value);g.push({date:c(k.date),value:t})}d.push(g)}return d3.layout.stack().offset("zero").values(function(a){return a}).x(function(a){return a.date}).y(function(a){return a.value})(d)}
function g(a,b,c){var d=null;c+=1;a&&c&&(d=(a-b*(c-1))/c,1>d&&(d=1));return d}function h(a,b){var c=b[0];b=b[1]||1;c=b-c+(1<b-c?0:1);b=c/(a-1);for(var d=[],e=0;e<a;e++){var f=10<c?Math.round(e*b):parseInt(e*b*10)/10;d.push(f)}return d}b=function(a){this.$wrapper=a.$wrapper;this.$hint=this.$wrapper.find(".js-hint-wrapper");this.node=this.$wrapper.find(".js-chart-wrapper")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=a.data;this.data=d(this.charts);this.group_by=a.group_by;
...
this.yDomain));this.svg.selectAll(".axis .y").transition().duration(600).call(this.yAxis);this.xAxis.scale(this.x);this.svg.selectAll(".axis .x").transition().duration(600).call(this.xAxis);this.renderCharts()};b.prototype.showHint=function(b,c,d,e){var f=this;b=a(c);if(!(0<Math.ceil(b.attr("height"))))return!1;var g=d.date;c=f.$hint.find(".c-date");var h=f.$hint.find(".c-app"),k=f.$hint.find(".c-value");g=function(a,b){var c=parseInt(a.getMonth());"months"==b?(a=f.locales.months,a[c]||(a="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ")),
c=a[c]):(b=a.getDate(),c+=1,c=(10>b?"0"+b:b)+"."+(10>c?"0"+c:c)+"."+a.getFullYear());return c}(g,f.group_by);c.text(g);h.text(e.name);k.text(d.value);d=function(b){var c=a(window),d=c.width();c.height();c=f.$hint.outerWidth();var e=f.$hint.outerHeight(),g=Math.ceil(b.attr("width")),h=Math.ceil(b.attr("height")),k=f.$wrapper.offset();b=b.offset();e={left:b.left-k.left+g+10,top:b.top-k.top+(h<e?h-e-2:2)};d<b.left+10+c&&(e.left=b.left-k.left-g-c);return e}(b);f.$hint.css(d).addClass(f.show_class)};b.prototype.moveHint=
function(){};b.prototype.hideHint=function(){this.$hint.removeAttr("style").removeClass(this.show_class)};return b}(jQuery);CRMLogLive=function(a){this.$wrapper=a.$wrapper;this.$filtersForm=this.$wrapper.find("form.js-filters-form");this.chartData=a.chartData;this.chartParams=a.chartParams;this.locales=a.locales;this.chart=!1;this.filtersData=this.$filtersForm.serializeArray();this.initClass()};CRMLogLive.prototype.initClass=function(){this.initLogList();this.initDateFilter();this.initChart()};CRMLogLive.prototype.initLogList=
function(){function b(){e.find(".c-activity-item.is-first").each(function(){var a=d(this).prev().prev();a.hasClass("is-last")||a.addClass("is-last")})}var e=this.$wrapper.find("#c-activity-section");b();new a({$wrapper:e,names:{list:".c-activity-list",items:"> li",paging:".c-paging-wrapper"},log:this,onLoad:b})};CRMLogLive.prototype.initDateFilter=function(){function a(a){var c=a.data("timeframe"),d=a.data("group")||"days";p.html(a.find("a").html());r.length&&r.removeClass("selected");r=a.addClass("selected");
k.hide();setTimeout(function(){k.removeAttr("style")},200);m.val(c);l.val(d);"custom"!==c?(n.removeClass("is-shown"),b()):n.addClass("is-shown")}function b(){var a=h.serializeArray();a.push({name:"chart",value:1});d.post("?module=logLive",a,function(a){"ok"==a.status&&(a=a.data,a.group_by=l.val(),f.chart.update(a))},"json").always(function(){q=!1})}var f=this,g=f.$wrapper.find(".js-dates-filter"),h=g.find("form"),k=g.find(".js-list"),l=g.find(".js-group-field"),m=g.find(".js-timeframe-field"),p=g.find(".js-link-text"),
n=g.find(".js-hidden-part"),q=!1,r=k.find(".selected");k.on("click",".js-toggle",function(b){b.preventDefault();a(d(this))});h.on("submit",function(a){a.preventDefault();q||(q=!0,b())});(function(){g.find(".js-datepicker").each(function(){var a=d(this),b=g.find("."+a.data("selector"));a.datepicker({altField:b,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMLogLive.prototype.initChart=function(){var a=this.$wrapper.find(".js-chart-section");a.length&&this.chartData&&this.chartData.length&&
(this.chart=new b({$wrapper:a,data:this.chartData,group_by:this.chartParams.group_by,locales:this.locales}))};return CRMLogLive}(jQuery),CRMLogLiveItem=function(d){CRMLogLiveItem=function(a){this.$wrapper=a.$wrapper;this.initClass()};CRMLogLiveItem.prototype.initClass=function(){d.crm.renderSVG(this.$wrapper);this.$wrapper.data("logLiveItem",this)};return CRMLogLiveItem}(jQuery);var CRMCallPage=function(d){CRMCallPage=function(a){this.$wrapper=a.$wrapper;this.call_ts=a.call_ts;this.locales=a.locales;this.numbers_assigned=a.numbers_assigned;this.initClass()};CRMCallPage.prototype.initClass=function(){d.wa_push&&d.wa_push.init();d.crm.renderSVG(this.$wrapper);this.initRedirectCall();this.initDeleteCall();this.numbers_assigned&&d.wa_push&&d.wa_push.init();this.initAssociateDeal();this.initBackgroundReload();this.initFinishCallLinks()};CRMCallPage.prototype.initFinishCallLinks=
...
function(a){this.$wrapper=a.$wrapper;this.$button=this.$wrapper.find(".js-close-dialog");this.contact_id=a.contact_id;this.message=a.message||{};this.locales=a.locales;this.initClass()};CRMMessageBodyDialog.prototype.initClass=function(){this.initSelectDeal();this.initMessageDeleteLink()};CRMMessageBodyDialog.prototype.initSelectDeal=function(){function a(){p.html("<b><i>"+c.locales.deal_empty+"</i></b>");v.val("none");g.val("");f.addClass("c-deal-name-hidden");h.addClass("hidden").removeAttr("title");
m.addClass("c-empty-deal-hidden");n.addClass("hidden");r.find("li").removeClass("selected");k.removeClass("hidden")}function b(){var b=c.$wrapper.find(".js-created-deal"),h=q.find(".js-visible-link .js-text .funnel-state").clone(),l=d.trim(g.val()),m=e.serializeObject();m.message_id=c.message.id;if("none"===v.val())return e.addClass("shake animated"),setTimeout(function(){e.removeClass("shake animated")},500),!1;if(0>=v.val()&&!l)return f.addClass("shake animated"),setTimeout(function(){f.removeClass("shake animated");
g.focus()},500),!1;e.addClass("deal-form-hidden");b.removeClass("hidden");0>=v.val()?(b.html(h),b.append(d.crm.escape(l))):(l=k.find(".js-visible-link .js-text"),h=l.find(".funnel-state").clone(),l=l.find("b i").text(),b.html(h),b.append(d.crm.escape(l)));d.post(d.crm.app_url+"?module=message&action=associateDealSave",m,function(c){if("ok"===c.status&&c.data.deal_url){var d=b.html();b.html('<a href="'+c.data.deal_url+'">'+d+"</a>")}else b.html(""),b.addClass("hidden"),a(),e.removeClass("deal-form-hidden")})}
var c=this,e=c.$wrapper.find(".deal-form"),f=e.find(".js-deal-name"),g=e.find(".js-deal-name-input"),h=e.find(".js-save-deal"),k=e.find(".js-deals-dropdown"),l=e.find(".js-remove-deal"),m=k.find(".js-empty-deal"),p=e.find(".js-select-deal .js-visible-link .js-text"),n=e.find(".js-select-funnel-wrapper"),q=e.find(".js-select-stage-wrapper"),r=e.find(".js-deals-list"),v=e.find(".js-deal-id"),t=c.contact_id;v.val("none");t&&d.get("?module=deal&action=byContact&id="+t,function(a){"ok"===a.status&&(d.each(a.data.deals,
function(b,c){r.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+c.id+'"><span class="js-text"><i class="icon16 funnel-state svg-icon" data-color="'+a.data.funnels[c.funnel_id].stages[c.stage_id].color+'"></i><b><i>'+c.name+"</i></b></span></a></li>")}),d.crm.renderSVG(c.$wrapper))},"json");e.on("click",".js-create-new-deal",function(){v.val("0");k.addClass("hidden");f.removeClass("c-deal-name-hidden");h.attr("title",c.locales.deal_create).removeClass("hidden");n.removeClass("hidden");
m.removeClass("c-empty-deal-hidden");g.focus()});e.on("click",".js-deal-item",function(){var a=d(this).find(".js-text").html();p.html(a);v.val(d(this).data("deal-id"));h.attr("title",c.locales.deal_add).removeClass("hidden");n.addClass("hidden");m.removeClass("c-empty-deal-hidden");r.find("li").removeClass("selected");d(this).parent().addClass("selected")});r.on("click",function(){r.hide();setTimeout(function(){r.removeAttr("style")},200)});m.on("click",function(){a()});l.on("click",function(){a()});
h.on("click",function(a){a.preventDefault();e.trigger("submit")});e.on("submit",function(a){a.preventDefault();b()});e.on("change",".js-select-deal-funnel",function(){e.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};CRMMessageDeleteLinkMixin.mixInFor(CRMMessageBodyDialog);return CRMMessageBodyDialog}(jQuery),CRMMessagesListPage=function(d){CRMMessagesListPage=function(a){this.$wrapper=a.$wrapper;this.page=a.page;this.last_message_id=a.last_message_id;
this.settings=a;this.initClass()};CRMMessagesListPage.prototype.initClass=function(){d.crm.renderSVG(this.$wrapper);this.$wrapper.on("click",".js-associate-deal",function(a){a.preventDefault();a=d(this).data("dialog-url");d.get(a,function(a){new CRMDialog({html:a})})});this.$wrapper.on("click",".js-write-message",function(a){a.preventDefault();d.get(d.crm.app_url+"?module=message&action=writeNewDialog",function(a){new CRMDialog({html:a})})});this.$wrapper.on("click",".js-switch-message-view",function(){d(this).find(".icon16").attr("class",
"icon16 loading")});this.page||this.initBackgroundUpdate();new CRMPageMessagesOperations(this.settings)};CRMMessagesListPage.prototype.initBackgroundUpdate=function(){function a(){f||(f=!0,d.contains(document,c.$wrapper[0])&&d.post("?module=message&action=listByConversation",{check:1},function(f){"ok"===f.status&&(f=f.data!==e,d.contains(document,c.$wrapper[0])&&(f&&!d(".crm-dialog-wrapper:visible").length?b():(clearTimeout(g),g=setTimeout(a,12E4))))},"json").always(function(){f=!1}))}function b(){d.get(d.crm.app_url+
"message/?view=conversation&reload=1",function(a){d.crm.content.$content.html(a)})}var c=this,e=c.last_message_id,f=!1,g=0;clearTimeout(g);g=setTimeout(a,12E4)};return CRMMessagesListPage}(jQuery);var CRMMessageConversationPage=function(d){CRMMessageConversationPage=function(a){this.$wrapper=a.$wrapper;this.locales=a.locales;this.conversation_id=a.conversation_id;this.contact_id=a.contact_id;this.funnel_id=a.funnel_id;this.last_message_id=a.last_message_id;this.check_interval=a.check_interval;this.initClass()};CRMMessageConversationPage.prototype.initClass=function(){d.crm.renderSVG(this.$wrapper);this.$wrapper.find(".js-deal-link").length||this.initSelectDeal();this.initDealActions();this.initChangeResponsible();
...
"",g="",h="";b&&b.stages&&b.stages[a.stage_id]&&(g=b.stages[a.stage_id].color||"");d.isEmptyObject(b)&&(h='<span class="hint">'+f.locales.funnel_deleted+"</span>");return'<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+c+'"><span class="js-text"><i class="icon16 funnel-state svg-icon" data-color="'+g+'"></i><b><i>'+e+"</i></b></span>"+h+"</a></li>"}function c(){y.html("<b><i>"+f.locales.deal_empty+"</i></b>");z.val("none");p.val("");m.addClass("c-deal-name-hidden");n.addClass("hidden").removeAttr("title");
t.addClass("c-empty-deal-hidden");u.addClass("hidden");w.find("li").removeClass("selected");0<q.data("deals_count")?(q.removeClass("hidden"),r.addClass("hidden")):(q.addClass("hidden"),r.removeClass("hidden"))}function e(){var a=g.find(".js-created-deal"),b=x.find(".js-visible-link .js-text .funnel-state").clone(),e=d.trim(p.val()),h=l.serializeObject();h.conversation_id=f.conversation_id;if("none"===z.val())return l.addClass("shake animated"),setTimeout(function(){l.removeClass("shake animated")},
500),!1;if(0>=z.val()&&!e)return m.addClass("shake animated"),setTimeout(function(){m.removeClass("shake animated");p.focus()},500),!1;l.addClass("deal-form-hidden");a.removeClass("hidden");0>=z.val()?(a.html(b),a.append(d.crm.escape(e))):(e=q.find(".js-visible-link .js-text"),b=e.find(".funnel-state").clone(),e=e.find("b i").text(),a.html(b),a.append(d.crm.escape(e)));d.post(d.crm.app_url+"?module=message&action=conversationAssociateDealSave",h,function(b){"ok"===b.status?d.crm.content.reload():
(a.html(""),a.addClass("hidden"),c(),l.removeClass("deal-form-hidden"))})}var f=this;a=a||{};var g=a.$wrapper||f.$wrapper,h=function(a){a=a||{};var c=a.funnels||{},e=0;d.each(a.deals||{},function(a,d){w.prepend(b(d,c[d.funnel_id]));e++});k.show();q.data("deals_count",e);0<e?(q.removeClass("hidden"),r.addClass("hidden")):(r.removeClass("hidden"),q.addClass("hidden"));d.crm.renderSVG(g)},k=g.find(".js-deal-selector-control-wrapper"),l=k.find(".deal-form"),m=l.find(".js-deal-name"),p=l.find(".js-deal-name-input"),
n=l.find(".js-save-deal"),q=l.find(".js-deals-dropdown"),r=l.find(".js-create-new-deal-link"),v=l.find(".js-remove-deal"),t=q.find(".js-empty-deal"),y=l.find(".js-select-deal .js-visible-link .js-text"),u=l.find(".js-select-funnel-wrapper"),x=l.find(".js-select-stage-wrapper"),w=l.find(".js-deals-list"),z=l.find(".js-deal-id");z.val("none");"undefined"===typeof a.data?f.loadDealListByContact(h):h(a.data);l.on("click",".js-create-new-deal",function(){z.val("0");q.addClass("hidden");r.addClass("hidden");
m.removeClass("c-deal-name-hidden");n.attr("title",f.locales.deal_create).removeClass("hidden");u.removeClass("hidden");t.removeClass("c-empty-deal-hidden");p.focus()});l.on("click",".js-deal-item",function(){var a=d(this).find(".js-text").html();y.html(a);z.val(d(this).data("deal-id"));n.attr("title",f.locales.deal_add).removeClass("hidden");u.addClass("hidden");t.removeClass("c-empty-deal-hidden");w.find("li").removeClass("selected");d(this).parent().addClass("selected")});w.on("click",function(){w.hide();
setTimeout(function(){w.removeAttr("style")},200)});t.on("click",function(){c()});v.on("click",function(){c()});n.on("click",function(a){a.preventDefault();l.trigger("submit")});l.on("submit",function(a){a.preventDefault();e()});l.on("change",".js-select-deal-funnel",function(){l.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())});return{submit:function(){l.trigger("submit")}}};CRMMessageConversationPage.prototype.initDealActions=function(){var a=this,b=
a.$wrapper.find(".js-conversation-deal");b.on("click",".js-attach-other-deal",function(b){b.preventDefault();a.loadDealListByContact(function(b){d.get(d.crm.app_url+"?module=messageConversationDeal&action=attachDialog",{id:a.conversation_id},function(c){var e=d(c);new CRMDialog({html:e,onOpen:function(){var c=e.find(".js-conversation-deal"),d=a.initSelectDeal({$wrapper:c,data:b});e.find(".js-save-button").on("click",function(){d.submit()})}})})})});var c=null;b.on("click",".js-detach-deal",function(e){e.preventDefault();
...
new b({$wrapper:c,type:"bottom"})})();new b({$wrapper:e,type:"top"});(function(){var b=d('<div class="c-scroll-action to-top to-right"><div class="c-icon to-top"></div></div>'),g=d('<div class="c-scroll-action to-bottom to-right"><div class="c-icon to-bottom"></div></div>');b.appendTo(e);g.appendTo(c);b.on("click",function(){d("html, body").animate({scrollTop:0},500)});g.on("click",function(){a.scroll2bottom(!0,!0)})})()};CRMMessageConversationPage.prototype.initChangeResponsible=function(){function a(a){var c=
...
d(a.target).is(":checkbox");a||a||(a=d(this).find(".js-checkbox"),a.trigger("change",[!a.is(":checked")]))});a.$list.shiftSelectable({selector:".js-message-wrapper",behavior_type:"vertical",onSelect:function(a,c){var b=d(c.target);b=!(!b.is("a")&&!b.closest("a").length);var f=c.extra.is_first;c=c.extra.is_last;b||f||c||(a=a.find(".js-checkbox"),a.attr("checked",!0),a.trigger("change"))}})};CRMPageMessagesOperations.prototype.selectAll=function(){this.$list.find(".c-checkbox :checkbox").prop("checked",
...
k=g.find(".js-drop-text"),l=g.find(".js-drop-field"),m=g.find(".c-upload-list"),p=f.file_template_html,n=f.app_url+"?module=file&action=uploadTmp",q=[],r=0,v=0;l.on("change",function(b){b.preventDefault();a(this.files)});h.on("drop",function(b){b.preventDefault();a(b.originalEvent.dataTransfer.files)});h.on("dragover",function(a){a.preventDefault();h.addClass("is-hover");k.text(k.data("hover"));clearTimeout(v);v=setTimeout(function(){h.removeClass("is-hover");k.text(k.data("default"))},100)});g.on("click",
...
c+' <a title="'+e.locales.change_recipient+'" class="c-remove-to-email js-remove-to-email">x</a></div>');n.removeClass("hidden");h.addClass("hidden").val("");k.val(b);m.val(a).trigger("change")}var e=this,f=null,g=null,h=e.$to_input,k=e.$wrapper.find(".js-to-email"),l=e.$wrapper.find(".js-to-new-name"),m=e.$to_id,p=e.$wrapper.find(".js-to-name"),n=e.$wrapper.find(".js-deal-field"),q=e.$wrapper.find(".js-select-funnel"),r=e.$wrapper.find(".js-select-deal .js-visible-link .js-text"),v=e.$wrapper.find(".js-deals-list"),
t=e.$wrapper.find(".js-create-new-deal");h.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",appendTo:e.$wrapper,minLength:0,focus:function(){return!1},select:function(a,b){a=b.item;b=(a.criteria||{}).email||a.email;c(a.id,b,'<i class="icon16 userpic20" style="background-image: url('+a.photo_url+');"></i> <b>'+a.name+'</b> <span style="color: #999;">&lt;'+b+"&gt;</span>");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d('<li class="ui-menu-item-html"><div>'+
b.value+"</div></li>").appendTo(a)};h.on("focus",function(){h.data("uiAutocomplete").search(h.val())});h.on("keydown",function(a){if(13==a.keyCode)return a.preventDefault(),h.blur(),!1});h.on("focusout",function(b){b.preventDefault();a();return!1});p.on("click",".js-remove-to-email",function(){d(this).parent(".js-email-to-user").remove();h.removeClass("hidden").focus();n.addClass("hidden");q.addClass("hidden");v.html(t);r.html("<b><i>"+e.locales.deal_select+"</i></b>");k.val("");l.val("");m.val("").trigger("change");
...
function(){function a(){var a=d.trim(m.val()).split(/[,:;]/);if(a[0].length)return d.each(a,function(a,b){a=d.trim(b).split(/\s+/);var f=!1,g=b=null;d.each(a,function(a,c){d.crm.check.email(c)&&!f&&(b=c.replace(/<|>/g,""),f=a)});!1!==f&&a.splice(f,1);g=a.join(" ");b&&g&&e(0,b,g);b&&!g&&c(0,b,b);g&&!b&&(m.addClass("shake animated"),setTimeout(function(){m.removeClass("shake animated")},500));f=!1;g=b=null}),!1}function c(a,b,c){l.children('[data-email="'+b+'"]').length&&"0"!==a||!b.length||(d(".email-copy-input-div").before('<div class="email-copy-user" title="'+
...
n=f.$wrapper.find(".email-copy-wrapper-collapsed");m.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",appendTo:f.$wrapper,minLength:0,focus:function(){return!1},select:function(a,b){a=b.item;c(a.id,(a.criteria||{}).email||a.email,'<i class="icon16 userpic20" style="background-image: url('+a.photo_url+');"></i><b>'+a.name+"</b>");m.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d('<li class="ui-menu-item-html"><div>'+b.value+"</div></li>").appendTo(a)};
...
e=c.find("a").length;a.length||a.push({id:!1,name:b.locales.no_segments});d.each(a,function(a,b){a="javascript:void(0);";var f="",g='<span class="hint">'+b.name+"</span>";b.id&&(a=d.crm.app_url+"contact/segment/"+b.id+"/",f='<i class="icon16 '+(b.icon?b.icon:"folder-dynamic")+'"></i>',g="<span>"+b.name+"</span>");b='<a href="'+a+'">'+f+g+"</a>";e&&(b=","+b);c.append(b);e=!0})}var b=this,c=b.$wrapper.find(".crm-contact-assign-segments"),e=d.crm.app_url+"?module=contactOperation&action=addToSegments&is_assign=1",
...
f.hide();setTimeout(function(){f.removeAttr("style")},200);g=g.data("id");e.val(g).trigger("change");(g=a.funnels[g]||!1)&&b.trigger("changeFunnel",g)});d.crm.renderSVG(b)})();(function(){function b(b){k.html("");d.each(b,function(b,c){b=a.stage_template_html;var e=d("<div />").text(c.name).html();b=b.replace("%id%",c.id).replace("%color%",c.color).replace("%name%",e);c=d(b);k.append(c)});d.crm.renderSVG(f);k.find("li:first-child a").trigger("click")}var e=a.$wrapper.find(".js-funnels-list"),f=a.$wrapper.find(".js-funnel-stages-list"),
...
c.find("li .js-value, li .js-ext").removeAttr("name");a=a.serializeArray();var f=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],g=!0;d.each(a,function(a,b){b.value=d.trim(b.value);m.data.push(b);0<d.trim(b.value).length&&0<=f.indexOf(b.name)&&(g=!1)});g&&(a=e.$contactSection.find('[name="contact[firstname]"]'),a.length?m.errors.push({name:"contact[firstname]",value:e.locales.empty_contact_name}):(a=e.$contactSection.find('[name="contact[name]"]'),a.length&&m.errors.push({name:"contact[name]",
value:e.locales.empty_contact_name})));b.find("li").each(function(a){var b=d(this),c=b.find(".js-value");b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g="contact[phone]["+a+"][value]";c.attr("name",g);m.data.push({name:g,value:e});a="contact[phone]["+a+"][ext]";b.attr("name",a);m.data.push({name:a,value:f})}});c.find("li").each(function(a){var b=d(this),c=b.find(".js-value");b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g="contact[email]["+a+"][value]";c.attr("name",g);m.data.push({name:g,
value:e});a="contact[email]["+a+"][ext]";b.attr("name",a);m.data.push({name:a,value:f})}})})();e.$extendedFieldsW.length&&e.is_extended&&f();e.selected_access&&a();e.selected_segments&&b();e.create_deal&&c();return m}function b(a,b){b=b?b:[];a&&(b=a);d.each(b,function(a,b){a=b.value;var c=e.$wrapper.find(':input[name="'+b.name+'"]'),f=d("<div />").addClass("errormsg").text(a);c.length?c.hasClass("error")||(c.parent().append(f),c.addClass("error").one("focus click change",function(){c.removeClass("error");
f.remove()})):e.$errorsSection.append(f)})}function c(a){f||(f=!0,d.post("?module=contact&action=newSave",a,function(a){"ok"===a.status?d.crm.content.load(d.crm.app_url+"contact/"+a.data.contact.id+"/"):b(a.errors)},"json").always(function(){f=!1}))}var e=this,f=!1;e.$wrapper.on("click",".js-submit-form",function(d){d.preventDefault();e.$errorsSection.html("");d=a();d.errors.length?b(!1,d.errors):c(d.data)})};CRMNewContactPage.prototype.initExtendedFields=function(){function a(a){a=a||{};var c=b.$wrapper,
e="c-conditional-field-"+(""+Math.random()).slice(2),f=a.input_name;a.parent_field=a.parent_field||"";a.parent_options=a.parent_options||{};a.index=a.index||0;if(a.parent_field&&!d.isEmptyObject(a.parent_options)){var l=a.parent_field.split(":");if(!(1>=l.length)){l='[name="contact['+l[0]+"]["+a.index+"]["+l[1]+']"]';var m=c.find(l);if(!(0>=m.length)){a.show_empty_option=a.required;var p=a.parent_options,n=c.find(':input[name="'+f+'"]').first();if(!(0>=n.length)){if(n.is("input"))var q=n.next();else q=
n,n=q.prev();var r=function(){n[0].hasAttribute("name")||(n.attr("name",q.attr("name")),q[0].removeAttribute("name"));n.show().val("");q.hide()};c=function(){var b=n.is(":visible")?n.val():q.val();var c=d(this).val().toLowerCase();a.hide_unmatched&&n.closest(".field").show();if(p&&p[c]){c=p[c];n.hide();q.show().children().remove();a.show_empty_option&&q.append(d('<option value=""></option>'));for(var e=0;e<c.length;e++)q.append(d("<option></option>").attr("value",c[e]).text(c[e]));q.val(b);n[0].hasAttribute("name")&&
(q.attr("name",n.attr("name")),n[0].removeAttribute("name"))}else a.hide_unmatched?(r(),n.val(""),n.closest(".field").hide()):n.is(":visible")||(r(),n.val(b))};c.call(m);f=m.closest(".field");f.length?(f.off("."+e),f.on("change."+e,l,c)):(m.off("."+e),m.on("change."+e,c))}}}}}var b=this,c=b.$extendedFieldsW,e=c.find("form");(function(){var a=c.find(".js-dynamic-field-wrapper");a.each(function(){var a=d(this),b=a.find(".js-list"),c=b.find(".c-item")[0].outerHTML;a.on("click",".js-add",function(){b.append(c)});
...
errors:[]};d.each(a,function(a,c){b.data.push(c)});return b})};CRMNewContactPage.prototype.setContactData=function(a){var b=this;d.each(a,function(a,e){"string"===typeof e||"number"===typeof e?(a=b.$wrapper.find('[name="contact['+a+']"]'),a.length&&a.val(e).trigger("change")):("phone"===a&&d.each(e,function(a,b){a={number:b.value,ext:b.ext};d(document).trigger("addContactPhone",a)}),"email"===a&&d.each(e,function(a,b){a={name:b.value,ext:b.ext};d(document).trigger("addContactEmail",a)}))})};CRMNewContactPage.prototype.initHeaderActions=
function(){function a(){b||(b=!0,d.post("?module=contact&action=createSettings",{},function(a){new CRMDialog({html:a})}).always(function(){b=!1}))}var b=!1;this.$wrapper.on("click",".js-show-personal-settings-dialog",function(b){b.preventDefault();a()})};CRMNewContactPage.prototype.initWYSIWYG=function(){var a=this.$wrapper.find(".js-wysiwyg");if(!a.length)return!1;a.each(function(){var a=d(this);d.crm.initWYSIWYG(a,{keydownCallback:function(a){}})})};CRMNewContactPage.prototype.initContactUpdateDialog=
function(){function a(){c||(c=!0,d.post(d.crm.app_url+"?module=contact&action=updateDialog",{call_id:b.call_id},function(a){new CRMDialog({html:a})}).always(function(){c=!1}))}var b=this,c=!1;b.$wrapper.on("click",".js-show-update-dialog",function(b){b.preventDefault();a()})};return CRMNewContactPage}(jQuery),CRMContactAccessDialogNew=function(d){CRMContactAccessDialogNew=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$optionsList=this.$wrapper.find(".js-options-list");
...
this.initVaultToggle()};CRMContactAccessDialogNew.prototype.initChangeOptions=function(){var a=this.$optionsList.find(".c-option.is-active");this.$optionsList.on("change",".js-option-field",function(){var b=d(this),c=b.closest(".c-option");"checked"===b.attr("checked")&&(a.length&&a.removeClass("is-active"),a=c.addClass("is-active"))})};CRMContactAccessDialogNew.prototype.initAutocomplete=function(){function a(a){a.addClass("highlighted");setTimeout(function(){a.removeClass("highlighted")},2E3)}function b(a){return d("<div></div>").text(a).html()}
var c=this,e=c.$ownersList.find(".js-autocomplete");e.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user",appendTo:c.$wrapper,minLength:0,focus:function(){return!1},select:function(f,g){f=c.$ownersList.find('.c-owner[data-id="'+g.item.id+'"]');f=f.length?f:void 0;f||(g=g.item,f=c.owner_template_html,f=f.replace(/%id%/,g.id).replace("%name%",b(g.name)).replace("%photo_url%",g.photo_url),g=d(f),c.$ownersList.append(g),f=g);a(f);e.val("");return!1}}).data("ui-autocomplete")._renderItem=
function(a,b){return d('<li class="ui-menu-item-html"><div>'+b.value+"</div></li>").appendTo(a)};e.on("focus",function(){e.data("uiAutocomplete").search(e.val())});c.$ownersList.on("click",".js-delete-owner",function(){d(this).closest(".c-owner").remove()})};CRMContactAccessDialogNew.prototype.initVaultToggle=function(){var a=this.$vaultsToggle,b=a.find(".js-visible-link"),c=a.find(".js-field"),e=a.find(".menu-v");e.on("click","a",function(){var a=d(this);b.find(".js-text").html(a.html());e.find(".selected").removeClass("selected");
a.closest("li").addClass("selected");e.hide();setTimeout(function(){e.removeAttr("style")},200);a=a.data("id");c.val(a)});d.crm.renderSVG(a)};return CRMContactAccessDialogNew}(jQuery),CRMContactResponsibleDialog=function(d){CRMContactResponsibleDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$responsibleList=this.$wrapper.find(".js-responsible-list");this.$submitButton=this.$wrapper.find(".js-save");this.dialog=this.$wrapper.data("dialog");this.locales=a.locales;
this.responsible_template_html=a.responsible_template_html;this.initClass()};CRMContactResponsibleDialog.prototype.initClass=function(){var a=this;a.$wrapper.on("change","input",function(){a.toggleButton(!0)});a.initSubmit();a.initClearResponsible();a.initAutocomplete()};CRMContactResponsibleDialog.prototype.initSubmit=function(){function a(){if(!e){e=!0;var a=d.crm.app_url+"?module=contact&action=responsibleSave",g=b();if(!g)return e=!1;var h=d('<i class="icon16 loading" style="vertical-align: middle; margin: 0;"></i>');
h.appendTo(c.$submitButton.parent());c.$submitButton.attr("disabled",!0);d.post(a,g,function(a){"ok"===a.data.result?d.crm.content.reload().then(function(){c.dialog.close()}):"no_vault_access"===a.data.result&&(d(".no-access-error").html(a.data.message),setTimeout(function(){c.dialog.close()},5E3))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);h.remove();e=!1})}}function b(){var a=d("#contact_id").val(),b=d("#responsible_id").val();return{contact_id:a,responsible_id:b}}
var c=this,e=!1;c.$form.on("submit",function(b){b.preventDefault();a()})};CRMContactResponsibleDialog.prototype.initClearResponsible=function(){function a(){var a=d.crm.app_url+"?module=contact&action=responsibleSave",f={contact_id:d("#contact_id").attr("value"),responsible_id:0},g=d('<i class="icon16 loading" style="vertical-align: middle; margin: 0;"></i>');g.appendTo(c.$submitButton.parent());c.$submitButton.attr("disabled",!0);d.post(a,f,function(a){"ok"===a.status?d.crm.content.reload().then(function(){c.dialog.close()}):
(console.log("Error saving Responsible contact classification: "+arguments[2],arguments),b("Error saving Responsible contact classification: "+arguments[2]))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);g.remove()})}function b(a){a=d('<div class="errormsg" />').text(a);c.$errorsPlace.append(a)}var c=this;c.$wrapper.on("click",".js-clear-responsible",function(b){b.preventDefault();d.crm.confirm.show({title:c.locales.clear_responsible_title,text:c.locales.clear_responsible_text,
button:c.locales.clear_responsible_button,onConfirm:a})})};CRMContactResponsibleDialog.prototype.initAutocomplete=function(){function a(a){return d("<div></div>").text(a).html()}function b(a){a.addClass("highlighted");setTimeout(function(){a.removeClass("highlighted")},2E3)}var c=this,e=d("#contact_id").val(),f=c.$responsibleList.find(".js-autocomplete");f.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user&contact_id="+e,appendTo:c.$wrapper,minLength:0,focus:function(){return!1},select:function(e,
h){e=c.$responsibleList.find('.c-responsible[data-id="'+h.item.id+'"]');e=e.length?e:void 0;e||(h=h.item,e=c.responsible_template_html,e=e.replace(/%id%/,h.id).replace("%name%",a(h.name)).replace("%photo_url%",h.photo_url),d("#responsible_id").val(h.id),h=d(e),c.$responsibleList.append(h),d(".js-input").css("display","none"),c.$submitButton.attr("disabled",!1),c.toggleButton(!0),e=h);b(e);c.toggleButton(!0);f.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){var c=d("<li />");
c.addClass("ui-menu-item-html").append("<div>"+b.value+"</div>").appendTo(a);b.rights||(c.addClass("is-locked"),c.on("click",function(a){a.preventDefault();a.stopPropagation()}));return c};f.on("focus",function(){f.data("uiAutocomplete").search(f.val())});c.$responsibleList.on("click",".js-delete-responsible",function(){d(this).closest(".c-responsible").remove();d("#responsible_id").val("");d(".js-input").css("display","");d(".js-autocomplete").focus();c.$submitButton.attr("disabled",!0);c.toggleButton(!0)})};
CRMContactResponsibleDialog.prototype.toggleButton=function(a){var b=this.$submitButton;a?b.removeClass("green").addClass("yellow"):b.removeClass("yellow").addClass("green")};return CRMContactResponsibleDialog}(jQuery),CRMContactAccessDialog=function(d){CRMContactAccessDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$optionsList=this.$wrapper.find(".js-options-list");this.$vaultsToggle=this.$wrapper.find(".js-vault-toggle");this.$ownersList=this.$wrapper.find(".js-owners-list");
this.$submitButton=this.$wrapper.find(".js-save");this.$errorsPlace=this.$wrapper.find(".js-errors-place");this.dialog=this.$wrapper.data("dialog");this.owner_template_html=a.owner_template_html;this.contact_id=a.contact_id;this.owners=a.owners;this.locales=a.locales;this.initClass()};CRMContactAccessDialog.prototype.initClass=function(){var a=this;a.$wrapper.on("change","input",function(){a.toggleButton(!0)});a.initChangeOptions();a.initSubmit();a.initAutocomplete();a.initVaultToggle()};CRMContactAccessDialog.prototype.initSubmit=
function(){function a(){if(!f){f=!0;e.$errorsPlace.html("");var a=d.crm.app_url+"?module=contact&action=accessSave",h=b();if(!h)return f=!1;var k=d('<i class="icon16 loading" style="vertical-align: middle; margin: 0;"></i>');k.appendTo(e.$submitButton.parent());e.$submitButton.attr("disabled",!0);d.post(a,h,function(a){"ok"===a.status?d.crm.content.reload().then(function(){e.dialog.close()}):(console.log("Error saving contact access classification: "+arguments[2],arguments),c("Error saving contact access classification: "+
arguments[2]))},"json").always(function(){e.$submitButton.attr("disabled",!1);k.remove();e.toggleButton(!1);f=!1})}}function b(){var a=[],b=e.$wrapper.find(".js-option-field:checked");if(b.length){b=b.val();if("vaults"===b){var f=e.$vaultsToggle.find(".js-field").val();a.push({name:"vault_id",value:f})}if("owners"===b){f=e.$ownersList.find(".c-owner");if(!f.length)return c(e.locales.empty_owner),!1;f.each(function(){var b=d(this).data("id");0<b&&a.push({name:"owners[]",value:b})})}"all"===b&&a.push({name:"vault_id",
value:"0"});b=e.$wrapper.find(".js-employees-field");b.length&&"checked"===b.attr("checked")&&a.push({name:"employees",value:"on"});a.push({name:"contact_id",value:e.contact_id})}return a}function c(a){a=d('<div class="errormsg" />').text(a);e.$errorsPlace.append(a)}var e=this,f=!1;e.$form.on("submit",function(b){b.preventDefault();a()})};CRMContactAccessDialog.prototype.initChangeOptions=function(){var a=this,b=a.$optionsList.find(".c-option.is-active");a.$optionsList.on("change",".js-option-field",
function(){var c=d(this),e=c.closest(".c-option");"checked"===c.attr("checked")&&(b.length&&b.removeClass("is-active"),b=e.addClass("is-active"));a.dialog.resize()})};CRMContactAccessDialog.prototype.initAutocomplete=function(){function a(a){a.addClass("highlighted");setTimeout(function(){a.removeClass("highlighted")},2E3)}function b(a){return d("<div></div>").text(a).html()}var c=this,e=c.$ownersList.find(".js-autocomplete");e.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user",appendTo:c.$wrapper,
minLength:0,focus:function(){return!1},select:function(f,g){f=c.$ownersList.find('.c-owner[data-id="'+g.item.id+'"]');f=f.length?f:void 0;f||(g=g.item,f=c.owner_template_html,f=f.replace(/%id%/g,g.id).replace("%name%",b(g.name)).replace("%photo_url%",g.photo_url),g=d(f),c.$ownersList.append(g),c.dialog.resize(),f=g);a(f);c.toggleButton(!0);e.val("");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d('<li class="ui-menu-item-html"><div>'+b.value+"</div></li>").appendTo(a)};e.on("focus",
function(){e.data("uiAutocomplete").search(e.val())});c.$ownersList.on("click",".js-delete-owner",function(){d(this).closest(".c-owner").remove();c.toggleButton(!0)})};CRMContactAccessDialog.prototype.toggleButton=function(a){var b=this.$submitButton;a?b.removeClass("green").addClass("yellow"):b.removeClass("yellow").addClass("green")};CRMContactAccessDialog.prototype.initVaultToggle=function(){var a=this.$vaultsToggle,b=a.find(".js-visible-link"),c=a.find(".js-field"),e=a.find(".menu-v");e.on("click",
"a",function(){var a=d(this);b.find(".js-text").html(a.html());e.find(".selected").removeClass("selected");a.closest("li").addClass("selected");e.hide();setTimeout(function(){e.removeAttr("style")},200);a=a.data("id");c.val(a)});d.crm.renderSVG(a)};return CRMContactAccessDialog}(jQuery),CRMContactCreateSettings=function(d){CRMContactCreateSettings=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMContactCreateSettings.prototype.initClass=
function(){this.initSave()};CRMContactCreateSettings.prototype.initSave=function(){function a(){var a={data:[],errors:[]},b=e.serializeArray();d.each(b,function(b,c){a.data.push(c)});return a}function b(a){f||(f=!0,d.post("?module=contact&action=createSettingsSave",a,function(a){"ok"===a.status?c.dialog.close():(a=(a=a.errors)?a:[],console.log(a))},"json").always(function(){f=!1}))}var c=this,e=c.$form,f=!1;e.on("submit",function(c){c.preventDefault();c=a();c.errors.length?(c=(c=c.errors)?c:[],console.log(c)):
b(c.data)})};return CRMContactCreateSettings}(jQuery),CRMContactAddEmployeeDialog=function(d){CRMContactAddEmployeeDialog=function(a){this.$wrapper=a.$wrapper;this.contact_id=a.contact_id;this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMContactAddEmployeeDialog.prototype.initClass=function(){this.initAddEmployee()};CRMContactAddEmployeeDialog.prototype.initAddEmployee=function(){function a(a){function b(a){var b=d('<div class="line errormsg" />').html(a);f.append(b);c.$form.one("submit",
function(){b.remove()})}if(a[0])d.each(a,function(a,c){b(c.value)});else{var e=Object.keys(a);d.each(e,function(c,d){b(a[d])})}}function b(b){g||(g=!0,d.post("?module=contact&action=addEmployeeSave",b,function(b){"ok"===b.status?(d.crm.content.reload(),c.dialog.close()):b.errors&&a(b.errors)}).always(function(){g=!1}))}var c=this,e=c.$wrapper.find("#c-contact-add-employee-form"),f=c.$wrapper.find(".js-errors-place"),g=!1;e.on("submit",function(c){c.preventDefault();c=e.serializeArray();var d=[];d.length?
a(d):b(c)})};return CRMContactAddEmployeeDialog}(jQuery),CRMContactUpdateDialog=function(d){CRMContactUpdateDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$submitButton=this.$wrapper.find(".js-submit-button");this.initClass()};CRMContactUpdateDialog.prototype.initClass=function(){this.initAutocomplete();this.initSubmit()};CRMContactUpdateDialog.prototype.initAutocomplete=function(){var a=this,b=a.$wrapper.find(".js-autocomplete-wrapper"),
c=b.find(".js-autocomplete"),e=b.find(".js-field");c.autocomplete({appendTo:b,source:d.crm.app_url+"?module=autocomplete",minLength:2,html:!0,focus:function(){return!1},select:function(a,b){a=d("<div />").text(b.item.name).text();c.val(a).blur();e.val(b.item.id).trigger("change");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d("<li />").addClass("ui-menu-item-html").append("<div>"+b.value+"</div>").appendTo(a)};e.on("change",function(){a.$submitButton.attr("disabled",!1)})};
CRMContactUpdateDialog.prototype.initSubmit=function(){function a(){var a={data:[],errors:[]},b=e.serializeArray();d.each(b,function(b,c){a.data.push(c)});return a}function b(a){a=a?a:[];d.each(a,function(a,b){a=b.value;var c=e.find('[name="'+b.name+'"]'),g=d("<span />").addClass("errormsg").text(a);c.length?c.hasClass("error")||(c.parent().append(g),c.addClass("error").one("focus click",function(){c.removeClass("error");g.remove()})):(f.append(g),e.one("submit",function(){g.remove()}))})}function c(a){g||
(g=!0,d.post("?module=contact&action=update",a,function(a){"ok"===a.status?d.crm.content.load(d.crm.app_url+"contact/"+a.data.id+"/"):b(a.errors)},"json").always(function(){g=!1}))}var e=this.$form,f=this.$wrapper.find(".js-errors-place"),g=!1;e.on("submit",function(d){d.preventDefault();d=a();d.errors.length?b(d.errors):c(d.data)})};return CRMContactUpdateDialog}(jQuery),CRMContactAddCompanyContactDialog=function(d){CRMContactAddCompanyContactDialog=function(a){this.$wrapper=a.$wrapper;this.$form=
this.$wrapper.find("form");this.$company_value=this.$wrapper.find(".js-company-value");this.$submit=this.$wrapper.find(".js-submit");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$company_id_input=this.$wrapper.find(".js-company-id");this.$company_name_input=this.$wrapper.find(".js-autocomplete-company");this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMContactAddCompanyContactDialog.prototype.initClass=function(){var a=this;a.$form.on("click",".js-company-item",function(){a.$submit.prop("disabled",
!1)});a.initAutoComplete();a.initSubmit()};CRMContactAddCompanyContactDialog.prototype.initAutoComplete=function(){var a=this,b=a.$wrapper.find(".js-selected-company"),c=a.$wrapper.find(".js-change-company"),e=a.$wrapper.find(".js-label-new-company");a.$company_name_input.autocomplete({source:function(a,b){d.post("?module=autocomplete&type=company",a,function(c){d.isEmptyObject(c)&&a.term?e.css({color:"#999"}):e.css({color:"#FFF"});b(c)},"json")},minLength:0,focus:function(){return!1},select:function(c,
e){a.$company_id_input.val(e.item.id);b.html('<i class="icon16 userpic20" style="background-image: url('+e.item.photo_url+');"></i>').append(d("<span />").text(e.item.name)).removeClass("hidden");a.$company_name_input.addClass("hidden");return!1}}).data("ui-autocomplete")._renderItem=function(a,b){return d("<li />").addClass("ui-menu-item-html").append("<div>"+b.value+"</div>").appendTo(a)};a.$company_name_input.on("focus",function(){a.$company_name_input.data("uiAutocomplete").search(a.company_name)});
...
d(this);b.droppable({tolerance:"pointer",hoverClass:"is-hovered",over:function(a,c){c.draggable.hasClass("ui-draggable")||b.removeClass("is-hovered")},drop:function(b,c){b=d(this).data("id");var e=[],f=c.helper.data("user-id");c=""+c.helper.data("user-ids");f?e.push(f):c&&(0<c.indexOf(",")?e=c.split(","):e.push(c));0<b&&0<e.length&&a(b,e)}})})};return CRMContactsPage}(jQuery),CRMContactsColumnsDialog=function(d){CRMContactsColumnsDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");
...
a.length+"</span></div>":d(this).clone().addClass("is-clone")},start:function(){a.length&&a.addClass("c-drop-here")},stop:function(b,c){b=c.helper;var d=b.clone();d.insertAfter(b).fadeOut(270);setTimeout(function(){d.remove()},300);a.length&&a.removeClass("c-drop-here")}})};return CRMThumbContact}(jQuery),CRMTableContact=function(d){CRMTableContact=function(a){this.$wrapper=a.$wrapper;this.user_id=this.$wrapper.data("user-id");this.can_be_drag=a.can_be_drag;this.initClass()};CRMTableContact.prototype.initClass=
...
b.join(",")+'"><span class="indicator red">'+b.length+"</span></div>";return f},appendTo:"body",delay:200,cursorAt:{top:0,left:0},start:function(a,c){c.helper.addClass("is-clone");b.length&&b.addClass("c-drop-here")},stop:function(a,c){a=c.helper;var d=a.clone();d.insertAfter(a).fadeOut(270);setTimeout(function(){d.remove()},300);b.length&&b.removeClass("c-drop-here")}})};return CRMTableContact}(jQuery);var CRMContactsSidebar=function(d){CRMContactsSidebar=function(a){this.$wrapper=a.$wrapper;this.$segmentsLists=this.$wrapper.find(".c-segment-list");this.$add_new_segment_link=this.$wrapper.find(".c-create-new-segment");this.is_admin=a.is_admin;this.initClass()};CRMContactsSidebar.prototype.initClass=function(){this.initSortable();this.initAddLink();this.initAddNewSegmentLink();this.initHighlight();this.initSelectedLink();this.initArchivedToggles();this.initScrollTopOnClick()};CRMContactsSidebar.prototype.initSortable=
...
f!=d.item.index()&&(c=a(g),b(e,{segments:c,shared:k}))}})})};CRMContactsSidebar.prototype.initAddLink=function(){var a=!1,b=this.$wrapper.find(".js-add-link"),c=b.find(".icon16"),e=c.attr("class");b.on("click",function(){if(!a){a=!0;var b=d.crm.app_url+"?module=contact&action=add";c.attr("class","icon16 loading");d.post(b,{},function(a){new CRMDialog({html:a})}).always(function(){a=!1;c.attr("class",e)})}})};CRMContactsSidebar.prototype.initAddNewSegmentLink=function(){var a=this.$add_new_segment_link;
a.click(function(b){b.preventDefault();d.get(d.crm.app_url+"?module=contactSegment&action=edit").done(function(a){new CRMDialog({html:a})}).always(function(){a.find(".icon16").hide()})})};CRMContactsSidebar.prototype.updateItem=function(a,b){"segment"===a.type&&(a=this.$segmentsLists.find('li[data-id="'+a.info.id+'"]'),a.length&&(void 0!==b.name&&a.find(".name").text(b.name||""),void 0!==b.count&&a.find(".count").text(b.count||"")))};CRMContactsSidebar.prototype.initHighlight=function(a,b){var c=
d(".all-contacts-link");this.$wrapper.find('a[href^="'+d.crm.app_url+'"]').each(function(a,b){if(location.pathname==b.pathname)return a=d(b),b=a.closest("li"),b.length||(b=a),c.removeClass("selected"),b.addClass("selected"),!1;c.addClass("selected")})};CRMContactsSidebar.prototype.initSelectedLink=function(){var a=this;sessionStorage.getItem("selected_contacts")||sessionStorage.setItem("selected_contacts","[]");var b=this.$wrapper.find(".js-selected-contacts"),c=b.find(".count"),e=sessionStorage.getItem("selected_contacts");
...
function(){this.initStartExport()};CRMContactsOperationExport.prototype.initStartExport=function(){var a=this,b=a.$button,c=a.$cancel;b.click(function(c){c.preventDefault();b.attr("disabled",!0);a.currentProcess=a.process()});c.click(function(b){b.preventDefault();a.currentProcess&&a.currentProcess.cancel()});a.dialog.onCancel=function(){a.currentProcess&&a.currentProcess.cancel()}};CRMContactsOperationExport.prototype.cancel=function(){this.currentProcess&&this.currentProcess.cancel()};CRMContactsOperationExport.prototype.process=
function(){var a=this,b=a.url,c=a.$wrapper,e=c.find(".js-export-contacts-progressbar").find(".js-export-contacts-progressbar-progress"),f=c.find(".js-current-progress-txt"),g=null,h=null,k=0,l=d.extend({},a.context,!0);l.separator=c.find("[name=separator]").val();l.encoding=c.find("[name=encoding]").val();l.export_fields_name=c.find("[name=export_fields_name]").is(":checked")?1:0;l.not_export_empty_columns=c.find("[name=not_export_empty_columns]").is(":checked")?1:0;var m=function(a,b){0>=a?a=0:100<=
a&&(a=100);b?(e.stop(),e.clearQueue(),e.animate({width:""+Math.round(a)+"%"},{duration:250,queue:!0})):e.css({width:a});100>a?f.text(Math.round(100*a/100)+"%"):f.html('<span>100% <i class="icon16 yes"></i></span>')},p=function(){h&&clearTimeout(h);h=setTimeout(p,3200);!g||2<=k||(l.processId=g,d.post(b,l,function(b){k--;if(g&&b.ready){if(b=g)h&&clearTimeout(h),g=h=null,a.$download_file_form.attr("action",d.crm.app_url+"?module=contactOperationExport&action=process&processId="+b).appendTo("body").submit(function(){setTimeout(function(){a.$download_file_form.appendTo(a.$wrapper.find(".crm-dialog-content"));
a.dialog.close()},200)}).submit()}else b.progress&&m(b.progress,!0)},"json"),k++)};a.$wrapper.find(".crm-start-block").hide();a.$wrapper.find(".crm-process-block").show();m(0,!1);d.post(b,l,function(a){a.processId||alert("Error processing request.");g=a.processId;p()},"json");return{cancel:function(){h&&clearTimeout(h);d.post(b,{processId:g,ready:1})}}};return CRMContactsOperationExport}(jQuery);var CRMContactsOperationAssignTags=function(d){CRMContactsOperationAssignTags=function(a){this.$wrapper=a.$wrapper;this.$button=this.$wrapper.find(".js-save");this.$input=this.$wrapper.find(".crm-tags-input");this.context=a.context||{};this.dialog=this.$wrapper.data("dialog");this.default_text=this.$input.attr("placeholder");this.is_assign=a.is_assign||!1;this.initClass()};CRMContactsOperationAssignTags.prototype.initClass=function(){this.initTagsInput();this.initPopularTags();this.initSave()};CRMContactsOperationAssignTags.prototype.initTagsInput=
...
this.initSubmit()};CRMContactSegmentAddContacts.prototype.initAutocomplete=function(){var a=this.$find_contact,b=this.$contact_list,c=b.find(".is-template");a.autocomplete({source:"?module=autocomplete",minLength:2,focus:function(){return!1},select:function(d,f){d=c.clone().removeClass("is-template");d.find(".c-contact-id").val(f.item.id);d.find(".c-contact-name").text(f.item.name);d.find(".c-contact-icon").css("backgroundImage","url("+f.item.photo_url+")");b.append(d.show());a.val("");return!1}}).data("ui-autocomplete")._renderItem=
...
var h=e.serializeArray(),k={data:[],errors:[]},l=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],m=!0;d.each(h,function(a,b){k.data.push({name:b.name,value:b.value});0<d.trim(b.value).length&&0<=l.indexOf(b.name)&&(m=!1)});m&&(k.errors.push({name:"contact[firstname]",value:"Name is empty"}),k.errors.push({name:"contact[name]",value:"Name is empty"}));a.find("li").each(function(a){var b=d(this),c=b.find(".js-value");b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g=
"contact[phone]["+a+"][value]";c.attr("name",g);k.data.push({name:g,value:e});a="contact[phone]["+a+"][ext]";b.attr("name",a);k.data.push({name:a,value:f})}});b.find("li").each(function(a){var b=d(this),c=b.find(".js-value");b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g="contact[email]["+a+"][value]";c.attr("name",g);k.data.push({name:g,value:e});a="contact[email]["+a+"][ext]";b.attr("name",a);k.data.push({name:a,value:f})}});return k}var b=this,c=b.$wrapper.find('.js-toggle-content[data-content="contact"]'),
e=c.find("form");(function(){function c(a){d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",a,function(a){"ok"==a.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+"contact/"+a.data.contact.id+"/")):a.errors&&g(a.errors)},"json").always(function(){k=!1})}function g(a){a=a?a:[];d.each(a,function(a,b){a=b.name;b=b.value;"name"===a&&(a="contact[firstname]");var c=e.find('[name="'+a+'"]'),f=d("<span />").addClass("errormsg").text(b);c.length?c.hasClass("error")||
(c.parent().append(f),c.addClass("error").one("focus click",function(){c.removeClass("error");f.remove()})):(h.append(f),e.one("submit",function(){f.remove()}))})}var h=b.$wrapper.find(".js-errors-place"),k=!1;e.on("submit",function(b){b.preventDefault();k||(k=!0,b=a(),b.errors.length?(g(b.errors),k=!1):c(b.data))})})();(function(){c.on("click",".js-extended-form",function(){var b=a(),c=[];c.push("extended=true");d.each(b.data,function(a,b){(a=d.trim(b.value))&&c.push(b.name+"="+a)});b=d.crm.app_url+
...
0<=l.indexOf(b.name)&&(m=!1)});m&&(k.errors.push({name:"contact[firstname]",value:"Name is empty"}),k.errors.push({name:"contact[name]",value:"Name is empty"}));a.find("li").each(function(a){var b=d(this),c=b.find(".js-value");b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g="contact[phone]["+a+"][value]";c.attr("name",g);k.data.push({name:g,value:e});a="contact[phone]["+a+"][ext]";b.attr("name",a);k.data.push({name:a,value:f})}});b.find("li").each(function(a){var b=d(this),c=b.find(".js-value");
b=b.find(".js-ext");var e=c.val(),f=b.val();if(e){var g="contact[email]["+a+"][value]";c.attr("name",g);k.data.push({name:g,value:e});a="contact[email]["+a+"][ext]";b.attr("name",a);k.data.push({name:a,value:f})}});return k}var b=this,c=b.$wrapper.find('.js-toggle-content[data-content="company"]'),e=c.find("form");(function(){function a(){var a={data:[],errors:[]},b=e.serializeArray();d.each(b,function(b,c){c.value=d.trim(c.value);"contact[company]"===c.name&&a.data.push({name:"contact[name]",value:c.value});
a.data.push(c)});b=c.find(".js-phone-list");b.find("li .js-value, li .js-ext").removeAttr("name");b.find("li").each(function(b){var c=d(this),e=c.find(".js-value");c=c.find(".js-ext");var f=e.val(),g=c.val();if(f){var h="contact[phone]["+b+"][value]";e.attr("name",h);a.data.push({name:h,value:f});b="contact[phone]["+b+"][ext]";c.attr("name",b);a.data.push({name:b,value:g})}});b=c.find(".js-email-list");b.find("li .js-value, li .js-ext").removeAttr("name");b.find("li").each(function(b){var c=d(this),
e=c.find(".js-value");c=c.find(".js-ext");var f=e.val(),g=c.val();if(f){var h="contact[email]["+b+"][value]";e.attr("name",h);a.data.push({name:h,value:f});b="contact[email]["+b+"][ext]";c.attr("name",b);a.data.push({name:b,value:g})}});a.data.push({name:"contact[is_company]",value:1});return a}function g(a){a=a?a:[];d.each(a,function(a,b){a=b.name;b=b.value;var f=c.find('[name="'+a+'"]');"contact[firstname]"!==a||f.is(":visible")||(f=c.find(".js-contact-autocomplete"));var g=d("<span class='c-error' />").addClass("errormsg").text(b);
f.length&&!f.hasClass("error")?(f.parent().append(g),f.addClass("error").one("focus click change",function(){f.removeClass("error");g.remove()})):(l.append(g),e.one("submit",function(){remove(g)}))})}function h(a){k||(k=!0,d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",a,function(a){"ok"===a.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+"contact/"+a.data.contact.id+"/")):a.errors&&g(a.errors)},"json").always(function(){k=!1}))}var k=!1,l=c.find(".js-errors-place");
e.on("submit",function(b){b.preventDefault();b=a();b.errors.length?g(errors):h(b.data)})})();(function(){c.on("click",".js-extended-form",function(){var b=a(),c=[];c.push("extended=true");c.push("type=company");d.each(b.data,function(a,b){(a=d.trim(b.value))&&c.push(b.name+"="+a)});b=d.crm.app_url+"contact/new/?"+c.join("&");d.crm.content.load(b)})})()};return CRMContactAddDialog}(jQuery),CRMDealParticipantAdd=function(d){CRMDealParticipantAdd=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");
...
function(a,c){b(c.value)});else{var e=Object.keys(a);d.each(e,function(c,d){b(a[d])})}}function b(b){e||(e=!0,d.post("?module=deal&action=addParticipantSave",b,function(b){"ok"==b.status?(c.dialog.options.onAdd(b.data.html),c.dialog.close()):b.errors&&a(b.errors)}).always(function(){e=!1}))}var c=this,e=!1;c.$form.on("submit",function(d){d.preventDefault();d=c.$form.serializeArray();var e=[];e.length?a(e):b(d)})};return CRMDealParticipantAdd}(jQuery),CRMContactAddForm=function(d){CRMContactAddForm=
...
d?c.$wrapper.find(".js-email-field").val(a.name).trigger("change"):h?c.$wrapper.find(".js-phone-field").val(a.name).trigger("change"):c.$wrapper.find(".js-firstname,.js-name").val(a.name).trigger("change")}}function b(a){d.each(h,function(b,e){b=a[e];var f="phone"===e||"email"===e,g;if(f){b="";for(g=(a[e]||[]).reverse();""==b&&0<g.length;)b=g.pop();d.isPlainObject(b)&&(b=b.value)}b=d.trim(b||"");""!=b&&(e=f?c.$wrapper.find('[name="contact['+e+'][0][value]"]'):c.$wrapper.find('[name="contact['+e+']"]'),
e.val(b))});f.attr("disabled",!0)}var c=this,e=c.$wrapper.find(".js-contact-autocomplete"),f=c.$wrapper.find(".js-field"),g=c.$wrapper.find(".js-contact-id-field"),h=["firstname","company","jobtitle","phone","email"],k="?module=autocomplete&add_new=true&join="+h.join(","),l=!1;e.autocomplete({appendTo:c.$wrapper,source:k,minLength:2,html:!0,focus:function(){return!1},select:function(b,c){l=!0;a(c.item);e.blur();return!1},search:function(){g.val("")},open:function(){l=!1},change:function(){l||a({id:-1,
...
b.on("click",".c-toggle",function(b,l){b.preventDefault();l=!l;b=d(this);var k=b.data("mode");if(b.hasClass("is-active"))return!1;c.length&&c.removeClass("is-active");b.addClass("is-active");c=b;l&&a.$wrapper.find("input").val("").trigger("change");"fio"===k?(g.show(),h.hide(),e.val("new"),f.attr("disabled",!1)):(g.hide(),h.show(),e.val("search"));d(document).trigger("toggleChanged");d(document).trigger("resizeDialog")})};return CRMContactAddForm}(jQuery),CRMCompanyAddForm=function(d){CRMCompanyAddForm=
...
d(this).closest("li").remove()})};CRMCompanyAddForm.prototype.initAddEmail=function(){function a(a,f){a.preventDefault();a=d(b.email_template_html);f&&(a.find(".js-value").val(f.name).trigger("change"),a.find(".js-ext").val(f.ext).trigger("change"));c.append(a)}var b=this,c=b.$wrapper.find(".js-email-list");b.$wrapper.on("click",".js-add-email",a);b.$wrapper.on("click",".js-remove-email",function(a){a.preventDefault();d(this).closest("li").remove()});d(document).on("addContactEmail",function(b,c){a(b,
c)})};return CRMCompanyAddForm}(jQuery);var CRMContactImportPage=function(d){CRMContactImportPage=function(a){this.$wrapper=a.$wrapper;this.$iframe=this.$wrapper.find("iframe");this.initClass()};CRMContactImportPage.prototype.initClass=function(){this.initViewToggle();this.initSubmit()};CRMContactImportPage.prototype.initSubmit=function(){function a(a){a.on("change keydown","input, select, textarea",function(){a.find("input:submit").attr("disabled",!1)});a.on("submit",function(){a.find(".loading").show();e=!0})}var b=this,c=b.$iframe,e=
...
g).each(function(a){d(this).change(function(){p(a,d(this).val())})});var n=function(){d(this).is(":checked")?(g.find("tbody tr:first").removeClass("crm-ignored-row"),k.html((parseInt(k.html(),10)||0)+1)):(g.find("tbody tr:first").addClass("crm-ignored-row"),k.html(parseInt(k.html(),10)-1||""))};d("input[name='first_line']",f).change(n);var q=!1,r=g.find("select");g.find("tbody tr:first-child td").each(function(a,b){var c=null,e=0,f=!1;b=d(b).text().toLowerCase().replace(m,"");for(var g in l){var h=
l[g],k=!1,n=0,t=!1;g.length>e&&!f&&0==b.indexOf(g)&&(n=g.length,k=!0);var v=h.name.toLowerCase().replace(m,"");v&&v.length>e&&0==b.indexOf(v)&&(n=v.length,t=k=!0);if(k){v=k=null;if(h.fields){for(var C in h.fields){if(0<=b.indexOf(C)){k=C;n+=C.length;break}if(0<=b.indexOf(h.fields[C].name.toLowerCase().replace(m,""))){k=C;n+=h.fields[C].name.length;break}}if(!k)continue}if(h.ext)for(var A in h.ext){if(0<=b.indexOf(A)){v=A;break}if(0<=b.indexOf(h.ext[A].toLowerCase().replace(m,""))){v=A;break}}c=g+
...
d.get(d.crm.app_url+"?module=contactOperation&action=AddToSegments",function(b){new CRMDialog({html:b,onOpen:function(b){new CRMContactsOperationAddToSegments({$wrapper:b,onSave:function(b,c){var e=c.data("dialog"),f=[],g=[];c=d(".c-segment-item",c);for(var h=0;h<b.segment_ids.length;h+=1){var n=b.segment_ids[h],q=c.filter('[data-id="'+n+'"]');f.push(q.find(".c-name").text());g.push('<input type="hidden" name="segment_id[]" value="'+n+'">')}f="<span>"+f.join(",")+"</span>";g=g.join(" ");d(".c-add-to-segments-names",
...
var n=function(b,c){var d=a.messages.progress,e=Math.round(1E3*parseFloat(b/c))/10;b=d.replace(":percentage:",e||0).replace(":count:",b).replace(":total_count:",c);f.find(".crm-text").text(b)},q=function(){var e=c.val(),q=0,t=a.groups_count;k.show();h.hide();l.hide();f.show();b.find(".pager").hide();var y=function(){var a=b.find(".crm-merge.crm-js-partial").length;d.get(d.crm.app_url+"?module=contact&action=mergeDuplicates",{offset:a,field:e,no_js:1}).done(function(a){if(a){a=d("<div>").html(a);var b=
a.find(".crm-duplicates-table tbody").find(".crm-mergeduplicates-row");b.length?(g.find("tbody").append(b),z()):D();a.remove()}else D()})},u=function(a){var b=d.crm.app_url+"?module=contact&action=mergeDuplicatesGetContacts";a.attr("data-field-value");d.get(b,{field:e,value:a.attr("data-field-value"),master_slaves:1},function(b){b&&"ok"===b.status&&!d.isEmptyObject(b.data)?x(a,b.data):(a.addClass("crm-finished"),m.resolve())},"json").fail(function(){m.resolve()})},x=function(b,c){crmContactMerger.merge({master_id:c.master,
...
m.resolve()},onError:function(){m.resolve()}})},w=function(){p?setTimeout(w,1E3):z()},z=function(){var a=b.find(".crm-merge:not(.crm-finished):first");a.length?(a.parent().find(".crm-loading").css("opacity",1),m=new d.Deferred,m.fail(function(){k.hide();l.show()}),m.done(function(){q+=1;n(q,t);p?w():z()}),u(a)):q<t?y():D()},D=function(){h.hide();l.hide();k.hide();f.hide();a.$wrapper.find(".crm-attention-message").hide();a.$wrapper.find(".crm-done-message").show()};z()};h.click(function(a){a.preventDefault();
...
function(a){function b(a){function b(a){var b=a.split("-");a=parseInt(b[0]);var c=parseInt(b[1])-1;b=parseInt(b[2]);return new Date(a,c,b)}for(var c=[],d=0;d<a.length;d++){for(var e=a[d].data,f=[],g=0;g<e.length;g++){var h=e[g],k=parseInt(h.value);f.push({date:b(h.date),value:k})}c.push(f)}return d3.layout.stack().offset("zero").values(function(a){return a}).x(function(a){return a.date}).y(function(a){return a.value})(c)}function d(a,b){b=(b[1]||1)-b[0]+1;for(var c=b/(a-1),d=[],e=0;e<a;e++){var f=
10<b?Math.round(e*c):parseInt(e*c*10)/10;d.push(f)}return d}function e(b,c){var d=a(window),e=d.width();d.height();d=c.$hint.outerWidth();var f=c.$hint.outerHeight(),g=c.$wrapper.offset();c=b.pageX;b={left:c-g.left+10,top:b.pageY-g.top+(0<f?0-f-2:2)};e<b.left+d&&(b.left=c-(d+10));return b}c=function(a){this.$wrapper=a.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=a.data;
...
d.date;c=f.$hint.find(".js-name");var h=f.$hint.find(".js-date"),k=f.$hint.find(".js-value");g=function(a,b){var c=parseInt(a.getMonth());"months"==b?(a=f.locales.months,a[c]||(a="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ")),
c=a[c]):(b=a.getDate(),c+=1,c=(10>b?"0"+b:b)+"."+(10>c?"0"+c:c)+"."+a.getFullYear());return c}(g,f.group_by);e.name?c.text(e.name+": ").show():c.hide();h.text(g);k.text(d.value);d=function(b){var c=a(window),d=c.width();c.height();c=f.$hint.outerWidth();var e=f.$hint.outerHeight(),g=Math.ceil(b.attr("width")),h=Math.ceil(b.attr("height")),k=f.$wrapper.offset();b=b.offset();e={left:b.left-k.left+g+10,top:b.top-k.top+(h<e?h-e-2:2)};d<e.left+c&&(e.left=b.left-(c+10));return e}(b);f.$hint.css(d).addClass(f.show_class)};
...
d);c._removeIcon()});e.bind("cancel",function(){c.input.val("");c.hidden.attr("name",c.ns).val("");c.label.text("")})}else(e=d(b.item.option).val())?"value"===c.element.data("pass")?c.hidden.attr("name",c.ns).val(e):c.hidden.attr("name",c.ns+"."+e).val("1"):c.hidden.attr("name",c.ns).val(""),c.input.val(d(b.item.option).text()),c.label.text("="),c._removeIcon();else{e=b.item.value;var f=b.item.text||b.item.name;b.item.option&&(e=d(b.item.option).val());c.hidden.attr("name",c.ns).val(e);c.input.val(f);
...
d.isNumeric(a.count)&&(c+='<span class="count" style="margin-top: 2px;">'+a.count+"</span>");a.label=c;a.value||(a.value=a.name);return a},_showSelectItems:function(){var a=this,b=null,c=a.element.data("readonly"),e=!1;a.input.autocomplete("search","");b=this.response;b(this.element.children("option").map(function(){var b=d(this);if(b.hasClass("sep"))e=!0;else return b=a._formItem({icon:b.data("icon"),count:b.data("count"),label:b.html(),name:b.text(),value:this.value,sep:e,option:this},c),e=!1,b}).toArray())},
_source:function(a,b){var c=new RegExp(d.ui.autocomplete.escapeRegex(a.term),"i"),e=this;e.response=b;if(_other_version_&&!a.term)b([]);else{var f=function(a,c){_other_version_&&(a.highlight=1);d.get(e.options.url,a,function(a){var c=[],f=0;a&&"ok"===a.status&&(d.isArray(a.data.values)&&a.data.values.length&&(c=a.data.values),a.data.count&&(f=a.data.count));a=0;for(var g=c.length;a<g;a+=1)c[a]=e._formItem(d.extend(c[a],{option:null}));e.offset=c.length;e.count=f;b(c)},"json")};if(_other_version_)a.term?
f({term:a.term,id:this.ns}):b(this.element.children("option").map(function(){var b=d(this),e=b.html();if(b.hasClass("sep"))return d.extend({},sep,{option:this});if(this.value&&(!a.term||c.test(e))){var f=e;b.data("icon")&&(f+=' <img src="'+b.data("icon")+'" />');d.isNumeric(b.data("count"))&&(f+='<span class="count">'+b.data("count")+"</span>");return{label:f,text:e,value:this.value,option:this}}}).toArray());else if(a.term&&this.element.data("autocomplete"))f({term:a.term,id:this.ns},function(a){e.ul.height(e.h*
a.length);return a});else{var g=this.element.children("option").map(function(){var b=d(this),e=b.html();if(b.hasClass("sep"))return d.extend({},sep,{option:this});if(this.value&&(!a.term||c.test(e))){var f=e;b.data("icon")&&(f+=' <img src="'+b.data("icon")+'" />');d.isNumeric(b.data("count"))&&(f+='<span class="count">'+b.data("count")+"</span>");return{label:f,text:e,value:this.value,option:this}}}).toArray();this.element.data("autocomplete")?f({term:"",id:this.ns},function(a){a.length&&g[g.length-
1]&&!d(g[g.length-1].option).hasClass("sep")&&g.push(sep);g=g.concat(a);e.ul.height(e.h*g.length);return g}):b(g)}}},_removeIfInvalid:function(a,b){if(!b.item){a=this.input;var c=a.val().toLowerCase(),e=!1;this.element.children("option").each(function(){if(d(this).text().toLowerCase()===c)return this.selected=e=!0,!1});e||((b=a.data("uiAutocomplete"))||(b=a.date("autocomplete")),b&&(b.term=""))}},_updatePeriodInput:function(a,b){this.label.text("");this.hidden.attr("name",this.ns+".period").val("");
...
this,b=a.$wrapper.find(".js-form"),c=a.$wrapper.find(".js-errors-place"),e=a.$taxList,f=!1;b.on("submit",function(g){function h(){e.find(".c-tax-option").each(function(a){var b=d(this),c=b.find(".js-type");b=b.find(".js-percent");c.attr("name","company[tax_options]["+a+"][tax_type]");b.attr("name","company[tax_options]["+a+"][tax_percent]")});return b.serializeArray()}function k(e){e=e?e:[];d.each(e,function(e,f){e=f.name;f=f.value;var g=a.$wrapper.find('[name="'+e+'"]');"contact[firstname]"!==e||
g.is(":visible")||(g=a.$wrapper.find(".js-contact-autocomplete"));var h=d("<span class='c-error' />").addClass("errormsg").text(f);g.length&&!g.hasClass("error")?(g.parent().append(h),g.addClass("error").one("focus click change",function(){g.removeClass("error");h.remove()})):(c.append(h),b.one("submit",function(){remove(h)}))})}g.preventDefault();if(!f){f=!0;g=function(b){var c=new FormData;d.each(b,function(a,b){c.append(b.name,b.value)});d.each(a.files,function(a,b){c.append("images["+b.code+"]",
...
(a=0);this.$slider.css({"-webkit-transform":"translate("+(a?a+"px":0)+", 0)",transform:"translate("+(a?a+"px":0)+", 0)"});this.left=a};a.prototype.moveSlider=function(a,b){b=b?b:parseInt(this.wrapper_w/2);var c=this.slider_w-this.wrapper_w,d=0;0<c&&(d=Math.abs(this.left)+(a?b:-b),d>c?d=c:0>d&&(d=0));this.setLeft(-d);this.showArrows()};a.prototype.reset=function(){this.setLeft(0);this.detectSliderWidth();this.showArrows()};return a}(d);new a({$wrapper:f.find(".c-templates-slider"),$slider:f.find(".c-templates-list")})})();
...
".js-edit-currency",function(a){a.preventDefault();d(this).closest(".c-currency").addClass("is-edit")});this.$wrapper.on("click",".js-save-currency",function(b){function c(a){a=a?a:[];d.each(a,function(a,b){a=b.value;var c=e.find('[name="'+b.name+'"]'),f=d("<span />").addClass("errormsg").text(a);c.length&&!c.hasClass("error")&&(c.closest("div").append(f),c.addClass("error").one("focus click",function(){c.removeClass("error");f.remove()}))})}b.preventDefault();var e=d(this).closest(".c-currency"),
f=!1;b="?module=settings&action=currenciesSave";0<e.find(".js-save-new").length&&(b="?module=settings&action=currenciesAdd");if(!f){f=!0;var g=e.find(".js-rate"),h=g.val();h=h.replace(",",".");String(h).split(".");if(!(0<h)||9999999<h)return g.addClass("error").one("click",function(){g.removeClass("error")}),f=!1;var k={code:e.data("code"),rate:h};d.post(b,k,function(a){"ok"===a.status?e.toggleClass("is-edit").find(".js-rate-text").text(h):a.errors&&c(a.errors)}).always(function(){f=!1;a.attr("disabled",
...
b.status&&(b.data.disabled?(f.text(a.messages.enable),g.addClass("c-is-disabled")):(f.text(a.messages.disable),g.removeClass("c-is-disabled")))}).always(function(){b=null;k.hide()})})};CRMSettingsSources.deleteSource=function(a,b){b=b.messages||{};d.crm.confirm.show({title:b.delete_confirm_title,text:b.delete_confirm_text,button:b.delete_confirm_button,onConfirm:function(){var b=d.crm.app_url+"?module=settings&action=sourceDelete",e=this.$wrapper.find(".crm-loading").show(),f=this.$wrapper.find(".js-confirm-dialog").attr("disabled",
!0);d.post(b,{id:a}).always(function(){d.crm.content.load(d.crm.app_url+"settings/sources/");e.hide();f.attr("disabled",!1)});return!1}})};return CRMSettingsSources}(jQuery);var CRMSettingsSourceEmail=function(d){CRMSettingsSourceEmail=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$button=this.$form.find("[type=submit]");this.source=a.source||{};this.messages=a.messages||{};this.changed=!1;this.submit_xhr=null;this.initClass()};CRMSettingsSourceEmail.prototype.initClass=function(){this.initBlockToggles();this.initStickyButton();this.initSubmit();this.initSecureCheckboxes();this.initChangeListeners();this.initIButton();0<this.source.id&&
...
CRMSettingsSourceEmail.showValidateErrors=function(a,b){var c={};d.each(b||{},function(a,b){"params"===a?d.each(b,function(a,b){c["source[params]["+a+"]"]=d.isArray(b)?b:[b]}):c[a?"source["+a+"]":""]=d.isArray(b)?b:[b]});CRMSettingsSourceEmail.clearValidateErrors(a);d.each(c,function(b,c){var e=d('<div class="crm-errors-block"></div>');b=b?a.find('[name="'+b+'"]'):d();b.addClass("error");d.each(c,function(a,b){e.append('<em class="errormsg">'+b+"</em>")});b.length?b.after(e):a.find(".crm-common-errors-block").append(e)})};
...
"1":"0")});return a.join("@")},p=h(),t=function(){var a=h(),b=a!==p;p=a;return b},y=function(){c.show();m.show();f.hide();g.hide()},u=function(){e()?t()&&y():c.hide()},x=null;k.on("change",u).on("keydown",function(){x&&clearTimeout(x);x=setTimeout(function(){u()},250)});l.on("change",function(){t()&&y()})})();(function(){m.click(function(a){a.preventDefault();p()})})()};return CRMSettingsSourceEmailConnectionTestBlock}(jQuery);var CRMSettingsSourceIm=function(d){CRMSettingsSourceIm=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$button=this.$form.find("[type=submit]");this.source=a.source||{};this.messages=a.messages||{};this.changed=!1;this.submit_xhr=null;this.initClass()};CRMSettingsSourceIm.prototype.initClass=function(){this.initBlockToggles();this.initStickyButton();this.initSubmit();this.initChangeListeners();this.initIButton();0<this.source.id&&this.initDeleteLink()};CRMSettingsSourceIm.prototype.initChangeListeners=
...
d(this),c=a.parents(".crm-fields").find(".js-group-hint");f.val("");"personally"===a.val()?l():(m(),h.hide());"personally"===a.val()||""===a.val()?c.hide():c.show();0<a.val()&&f.val(-a.val());k!=f.val()&&(b.trigger("changeResponsibleUser",[k,f.val()]),k=f.val())});g.on("click"+a.ns,function(a){a.preventDefault();f.val("");l();h.hide()});e.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user&funnel_id="+a.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(a,c){e.val("");
if(0>=c.item.rights)return!1;m();h.show();h.find(".crm-user-icon").css("background-image","url("+c.item.photo_url+")");h.find(".crm-user-name").text(c.item.name).attr("title",c.item.name);f.val(c.item.id);k!=f.val()&&(b.trigger("changeResponsibleUser",[k,f.val()]),k=f.val());return!1}}).data("ui-autocomplete")._renderItem=function(b,c){var e=d("<li />");e.addClass("ui-menu-item-html").append("<div>"+c.value+"</div>").appendTo(b);0<a.funnel_id&&!c.rights&&(e.addClass("is-locked"),e.on("click"+a.ns,
function(a){a.preventDefault();a.stopPropagation()}));return e};e.on("focus"+a.ns,function(){e.data("uiAutocomplete").search(e.val())})};CRMSettingsSourceResponsibleBlock.prototype.reload=function(a,b){var c=this,e=this.$user_info,f=d('<i class="icon16 loading"></i>'),g=c.url;e.is(":visible")&&(c.$user_delete_link.hide(),f.css({marginTop:"-16px",marginRight:"-16px",float:"right"}));e.after(f);a=a||{};a.namespace=c.namespace;"undefined"===typeof a.funnel_id&&(a.funnel_id=c.funnel_id);a.responsible_contact_id=
c.$user_id.val();a.group_id=c.$group.val();f.show();d.get(g,a,function(a){a=d("<div>").html(a);var e=a.find("."+c.class_id);c.$wrapper.replaceWith(e);e=e.data("block_object");b&&b(e);a.remove();c.destroy()})};CRMSettingsSourceResponsibleBlock.prototype.destroy=function(){var a=this;a.$user_delete_link.off(a.ns);a.$group.off(a.ns);a.$wrapper.removeData("block_object");a.$user.data("ui-autocomplete")&&(a.$user.autocomplete("destroy"),a.$user.removeData("ui-autocomplete"));d.each(a,function(b){delete a[b]})};
...
a.data("checked"));a.is(":checked")?c.addClass("bold"):c.removeClass("bold")};a.find(".c-message-to-selector").each(function(){var a=d(this),b=a.find(".c-label");a=a.find(".c-message-to-variants-list");var h=a.find(':checkbox[data-id="client"]');e(h,!c);var k=[];a.find(":checkbox:checked:not(:disabled)").each(function(){var a=d(this).closest("li");k.push(a.find(".c-variant-name-text").text())});k=0<k.length?k.join(", "):b.data("initial_text");b.text(k)})};crmSettingsForm.prototype.getField=function(a,
...
!1).trigger("change"),b.$confirmation_enable_text.show(),b.$form_available_fields.find('.crm-form-field[data-id="password"]').addClass("crm-disabled"),a=b.getFormField("password"),b.deleteFormField(a),b.renderToVariantSelectors());"company"===c&&b.$form_available_fields.find(".crm-form-field[data-person-enabled=0][data-company-enabled=1]").each(function(){var a=d(this),c=a.data("id");c=b.getFormField(c);b.deleteFormField(c);a.addClass("crm-disabled")});b.setFormChanged()}};crmSettingsForm.prototype.getFormField=
function(a,b){var c='.%clz%[data-id="%id%"]%extra%:not(.%not_clz%)';a=[["%clz%","crm-form-field"],["%id%",a],["%extra%",void 0!==b?'[data-id="'+b+'"]':""],["%not_clz%","crm-form-field-template"]];b=0;for(var d=a.length;b<d;b+=1)c=c.replace(a[b][0],a[b][1]);return this.$form_fields.find(c)};crmSettingsForm.prototype.initAvailableFields=function(){var a=this,b=a.default_checked_fields,c=a.$form_available_fields;c.on("click",".crm-form-field:not(.crm-disabled)",function(b){a.addFormField(d(this))});
0>=a.form.id&&0<b.length&&d.each(b,function(b,d){b=c.find('.crm-form-field[data-id="'+d+'"]:not(.crm-disabled)');a.addFormField(b)})};crmSettingsForm.prototype.addFormField=function(a){if(!(0>=a.length)){var b=a.data("id"),c=this.getAvailableField(b);this.$form_available_fields.hide();var d=c.checked+1;c.is_multi||a.addClass("crm-disabled");this.getField(c.id,d)||this.addField(b,d,c);this.updateAvailableField(b,{checked:d});"email"===b&&(this.$confirmation_enable_text.hide(),this.enableIButton(this.$confirmation_checkbox),
(a=this.getAvailableField("password"))&&0>=a.checked&&this.$form_available_fields.find('.crm-form-field[data-id="password"]').removeClass("crm-disabled"));"company"===b&&this.$form_available_fields.find(".crm-form-field.crm-disabled[data-person-enabled=0][data-company-enabled=1]").removeClass("crm-disabled");this.renderField(b,d);"!paragraph"===b&&(b=this.$form_fields.find('.crm-form-field[data-id="'+b+'"][data-checked="'+d+'"]'),this.editField(b));this.setFormChanged();this.renderToVariantSelectors()}};
crmSettingsForm.prototype.initAddNewFieldLink=function(){function a(b){d.contains(document,c[0])?27===b.keyCode&&c.is(":visible")&&c.hide():d(document).off("keypress",a)}function b(a){if(d.contains(document,c[0])){var e=d.contains(c[0],a.target);a=c[0]===a.target;!c.is(":visible")||a||e||c.hide()}else d(document).off("keypress",b)}var c=this.$form_available_fields;this.$wrapper.on("click",".crm-add-new-field-link",function(a){a.stopPropagation();c.toggle()});d(document).on("keydown",a).on("click",
...
h.$sms_sender.attr("disabled",!0);h.$sms_sender_block.find(".js-specified-sms-sender").attr("disabled",!0).hide()}var h=this,k=h.notification,l=h.$wrapper.find(".js-transport-toggle");"email"===a()?(c("specified"===h.$sender.val()),g()):(f("specified"===h.$sms_sender.val()),d());l.on("change",b);h.$sender.on("change",b);h.$sms_sender.on("change",b)};CRMNotificationEdit.prototype.initRecipient=function(){function a(){b(c.$recipient.val())}function b(a){var b=h.filter(":checked").first().val();!b&&
0<c.notification.id&&(b=c.notification.transport);b=c.$wrapper.find('.c-recipient-content[data-id="'+b+'"]');c.$wrapper.find(".c-recipient-content").hide().attr("disabled",!0);"other"===a?(b.show(),b.attr("disabled",!1)):b.hide()}var c=this,d=c.notification.recipient,f=c.recipients,g=c.$recipient,h=c.$wrapper.find(".js-transport-toggle");g.on("change",a);h.on("change",a);f[d]||(c.$recipient.val("other"),b("other"),c.$wrapper.find('.c-recipient-content[data-id="'+h.filter(":checked").first().val()+
'"]').val(d))};CRMNotificationEdit.prototype.initChangeEvent=function(){var a=this,b=a.$wrapper.find(".js-event-toggle"),c=a.$wrapper.find(".js-event-company"),e=a.$wrapper.find(".js-fields-group");b.on("change",function(){var b=d.trim(d(this).val());a.notification_event=b;var g=a.notifications[b];g&&(a.$name.val(g.name),a.$subject.val(g.subject),a.$emailBody.val(g.body).trigger("editorDataUpdated"),a.$smsBody.val(g.sms).trigger("editorDataUpdated"),g.recipient?a.$recipient.val(g.recipient):a.$recipient.val("client"));
"invoice."===b.substr(0,8)?c.removeAttr("disabled").show():c.attr("disabled",!0).hide();e.show()})};CRMNotificationEdit.prototype.initTransport=function(){function a(a){a=a.val();b.transport=a;a=b.$wrapper.find('.c-transport-content[data-id="'+a+'"]');e?(e.removeClass("is-active"),e.find("input, textarea").attr("disabled",!0)):b.$wrapper.find(".c-transport-content").find("input, textarea").attr("disabled",!0);a.find("input, textarea").attr("disabled",!1);e=a.addClass("is-active")}var b=this,c=b.$wrapper.find(".js-transport-toggle"),
...
wa_editor);c.data("wa_editor",e.data("wa_editor"));c.on("editorDataUpdated",function(){var a=e.data("wa_editor");a&&a.getSession().setValue(c.val())});d(document).on("updateEditorTextarea",function(){var a=e.data("wa_editor");a&&(a=a.getValue(),c.val(a).trigger("change"))})})};CRMNotificationEdit.prototype.initSubmit=function(){function a(){var a={data:[],errors:[]},b=f.serializeArray();d.each(b,function(b,c){a.data.push(c)});return a}function b(a,b){b=b?b:[];if(a){var c=Object.keys(a);d.each(c,function(c,
d){b.push({name:d,value:a[d]})})}d.each(b,function(a,b){a=b.value;var c=e.$form.find('[name="'+b.name+'"]');if(c.length&&!c.hasClass("error")){var f=d("<span />").addClass("errormsg").text(a);e.$wrapper.append(f);c.addClass("error").one("focus click change",function(){c.removeClass("error");f.remove()})}})}function c(a){if(!g){g=!0;var c=d(e.locales.saving);e.$footer.append(c);d.post("?module=settings&action=notificationsEditSave",a,"json").done(function(a){if("ok"!==a.status)b(a.errors||{});else if(0>=
e.notification_id)d.crm.content.load(d.crm.app_url+"settings/notifications/edit/"+a.data.notification.id+"/");else{var c=d(e.locales.saved);e.$footer.append(c);setTimeout(function(){d.contains(document,c[0])&&c.remove()},2E3);d(document).trigger("formIsSaved")}}).always(function(){c.remove();g=!1})}}var e=this,f=e.$form,g=!1;f.on("submit",function(e){e.preventDefault();d(document).trigger("updateEditorTextarea");e=a();e.errors.length?b(!1,e.errors):c(e.data)})};CRMNotificationEdit.prototype.initDelete=
function(){var a=this,b=!1;a.$wrapper.on("click",".js-remove-notification",function(c){c.preventDefault();d.crm.confirm.show({title:a.locales.delete_confirm_title,text:a.locales.delete_confirm_text,button:a.locales.delete_confirm_button,onConfirm:function(c){b||(b=!0,d.post("?module=settings&action=notificationsDelete",{id:a.notification_id},function(a){"ok"===a.status&&d.crm.content.load(d.crm.app_url+"settings/notifications/")}).always(function(){b=!1;c.close()}));return!1}})})};CRMNotificationEdit.prototype.initFooterActions=
function(){function a(a){a?b.removeClass("yellow").addClass("green"):b.removeClass("green").addClass("yellow")}var b=this.$footer.find(".js-submit-button");this.$wrapper.on("change","input, textarea, select",function(){a()});d(document).on("formIsSaved",function(){a(!0)})};CRMNotificationEdit.prototype.initHelp=function(){var a=this,b=a.$wrapper,c=d(document),e=d("#wa-editor-help"),f=d("#wa-editor-help-link"),g=function(a){0>=c.find(b).length?c.off("click",g):(a=d(a.target),!a.is(e)&&0>=e.find(a).length&&
e.hide())};c.on("click",g);f.on("click",function(){if(e.is(":visible"))return e.hide(),!1;if(e.data("loaded."+a.notification_event))return e.show(),!1;e.load(a.site_app_url+"?module=pages&action=help","app=crm&key=notification."+a.notification_event,function(){e.find("#wa-help-wa").remove();e.find("#wa-help-wa-content").remove();e.show();e.find("ul>li.no-tab>p.bold").hide();e.data("loaded."+a.notification_event,!0)});return!1});e.on("click","div.fields a.inline-link",function(b){b.preventDefault();
b=d(this).find("i");var c=a.$emailBody;"sms"===a.transport&&(c=a.$smsBody);(c=c.data("wa_editor"))&&c.insert(d.trim(b.text()))})};return CRMNotificationEdit}(jQuery),CRMNotificationStatus=function(d){CRMNotificationStatus=function(a){this.$wrapper=a.$wrapper;this.messages=a.messages||{};this.messages.enable=this.messages.enable||"";this.messages.disable=this.messages.disable||"";this.notifications=a.notifications;this.initDisableLinks()};CRMNotificationStatus.prototype.initDisableLinks=function(){var a=
this,b=null,c=d.crm.app_url+"?module=settingsNotifications&action=status";a.$wrapper.on("click",".js-c-disable-link",function(e){e.preventDefault();var f=d(this),g=f.closest(".c-notification");e=g.data("id");var h=g.hasClass("c-is-disabled"),k=g.find(".c-loading");b&&b.abort();k.show();b=d.post(c,{id:e,status:h?0:1}).done(function(b){"ok"===b.status&&(0<b.data.notification.status?(f.text(a.messages.disable),g.removeClass("c-is-disabled")):(f.text(a.messages.enable),g.addClass("c-is-disabled")))}).always(function(){b=
null;k.hide()})})};return CRMNotificationStatus}(jQuery);var CRMSettingsPayments=function(d){CRMSettingsPayments=function(a){this.$wrapper=a.$wrapper;this.$pluginsDropdown=this.$wrapper.find(".js-plugins-dropdown");this.$table=this.$wrapper.find(".js-payments-table");this.company_id=a.company_id;this.locales=a.locales;this.initClass()};CRMSettingsPayments.prototype.initClass=function(){this.initTabs();this.initDelete();this.initSortable();var a=this.$wrapper.find(".c-payments-list");(new MutationObserver(function(b){a.trigger("refresh")})).observe(a[0],
...
function(a,b){a=b.value;var e=c.$wrapper.find('[name="'+b.name+'"]');if(e.length&&!e.hasClass("error")){var f=d("<span />").addClass("errormsg").text(a);f.insertAfter(e);e.addClass("error").one("focus click",function(){e.removeClass("error");f.remove()})}})}var c=this,e=!1,f=c.$form;f.on("submit",function(c){c.preventDefault();c=f.serializeArray();var d=[];d.length?b(d):a(c)})};CRMPaymentEdit.prototype.initDelete=function(){var a=this,b=!1;a.$wrapper.on("click",".js-delete-payment",function(c){function e(){b||
...
{data:[],errors:[]},b=f.serializeArray();d.each(b,function(b,c){a.data.push(c)});return a}function b(a){a&&a[0]||(a=[]);d.each(a,function(a,b){a=b.value;var c=e.$wrapper.find('[name="'+b.name+'"]'),h=d("<span class='c-error' />").addClass("errormsg").text(a);c.length&&!c.hasClass("error")?(c.parent().append(h),c.addClass("error").one("focus click change",function(){c.removeClass("error");h.remove()})):(g.append(h),f.one("submit",function(){h.remove()}))})}function c(a){h||(h=!0,d.post(d.crm.app_url+
...
function(){var a=f.data("wa_editor");a&&(a=a.getValue(),e.val(a).trigger("change"))})})};CRMSettingsTemplate.prototype.initHelp=function(){var a=this,b=a.$wrapper,c=d(document),e=d("#wa-editor-help"),f=d("#wa-editor-help-link"),g=function(a){0>=c.find(b).length?c.off("click",g):(a=d(a.target),!a.is(e)&&0>=e.find(a).length&&e.hide())};c.on("click",g);f.on("click",function(){if(e.is(":visible"))return e.hide(),!1;e.load(a.site_app_url+"?module=pages&action=help","app=crm&key=invoice&invoice_template_id="+
