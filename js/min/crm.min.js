...
$jscomp.global.Symbol(e):$jscomp.POLYFILL_PREFIX+b+"$"+e),$jscomp.defineProperty(c,$jscomp.propertyToPolyfillSymbol[e],{configurable:!0,writable:!0,value:a})))};$jscomp.polyfill("Array.prototype.find",function(d){return d?d:function(a,b){return $jscomp.findInternal(this,a,b).v}},"es6","es3");$jscomp.initSymbol=function(){};
...
c.css(l)};CRMDialog.prototype.close=function(){this.is_closed=!0;this.onClose(this.$wrapper,this);this.$wrapper.remove()};CRMDialog.prototype.resize=function(){this.$block.addClass("is-animated");this.setPosition();if(this.onResize)this.onResize(this.$wrapper,this)};CRMDialog.prototype.hide=function(){this.$wrapper.hide();this.is_visible=!1};CRMDialog.prototype.show=function(){this.$wrapper.show();this.is_visible=!0};return CRMDialog}(jQuery);var CRMElasticBlock=function(d){CRMElasticBlock=function(a){this.$window=d(window);this.$wrapper=a.$wrapper;this.$aside=a.$aside;this.$content=a.$content;this.top_fix_class="fixed-to-top";this.bottom_fix_class="fixed-to-bottom";this.debug=a.debug;this.initClass()};CRMElasticBlock.prototype.initClass=function(){function a(){if(d.contains(document,p[0])){var z=Math.floor(k.$content.outerHeight()),C=Math.floor(p.outerHeight()),D=Math.floor(m.height()),F=n.scrollTop(),G=Math.floor(p.offset().top),H=B>
F?1:-1,I=F-t;E=p.width();if(!(!v&&D>r&&760<=q)||z&&z<C)v?(D=Math.floor(m.height()),G=Math.floor(m.offset().top),G=D+G-r-F,H=C-r,v=!1,D>C&&F>t&&(H<G?e(0):f())):g();else{z=r>C+0;var K=F<=t,J=parseInt(G+C-F-r),L=0<J;J=0>=J;if(z)0<I+0?(w||x||!y)&&e(0):(w||y||x||A)&&g();else if(K){if(w||x||y)A?G<=t&&g():g()}else L?0<H?G>=0+F&&(w||!y||x)&&e():(!w||y||x)&&c(G-t):J?u.top+D<F+r?(!w||y||x)&&c(D-C):0<H?(!w||y||x)&&c(G-t):(w||y||!x)&&f():(!w||y||x)&&c(G-t)}B=F}else n.off("scroll",a)}function b(){d.contains(document,
p[0])?(q=Math.floor(n.width()),r=Math.floor(n.height()),g(),n.trigger("scroll")):n.off("scroll",b)}function c(z){k.log("Manual top scroll position");p.css("top",z).width(E).removeClass(l).removeClass(h);w=!0;y=x=A=!1}function e(z){k.log("Fixed to top scroll position");p.removeAttr("style").width(E).removeClass(h).addClass(l);z&&(A=!0,p.css("top",z));w=x=!1;y=!0}function f(){k.log("Fixed to bottom scroll position");p.removeAttr("style").width(E).removeClass(l).addClass(h);w=y=A=!1;x=!0}function g(){k.log("Default scroll position");
p.removeAttr("style").removeClass(h).removeClass(l);w=y=x=A=!1}var k=this,l=k.top_fix_class,h=k.bottom_fix_class,n=k.$window,m=k.$wrapper,p=k.$aside;p.addClass("crm-elastic-block");var q=Math.floor(n.width()),r=Math.floor(n.height()),u=m.offset(),t=p.offset().top,v=!0,w=!1,x=!1,y=!1,A=!1,B=0,E;n.on("scroll",a).on("resize",b)};CRMElasticBlock.prototype.log=function(a){this.debug&&console.log(a)};return CRMElasticBlock}(jQuery);(function(d){function a(c,e){var f=d(window);e=f.scrollTop();var g=f.scrollLeft()+f.width(),k=f.scrollTop()+f.height();f=f.scrollLeft();var l=c.element.offset();l.right=l.left+c.element.outerWidth();l.bottom=l.top+c.element.outerHeight();return e<l.top&&f<l.left&&g>l.right&&k>l.bottom}function b(c,e){return c.clone().addClass(e.fixed_class||"sticky-fixed").css(d.extend({position:"fixed",display:"none"},e.fixed_css||{})).removeAttr("id").insertAfter(c)}d.fn.sticky=function(c){function e(){f.closest("body").length?
...
this.renderFunnel(1);this.$icon.data("icon",this)};b.prototype.renderFunnelState=function(){function f(n){return n/16*k.icon_w}function g(n){return n/16*k.icon_h}var k=this,l=k.$icon.data("color")||"#aaa",h=k.svg.append("g");h.append("polygon").attr("points",f(4)+","+g(16)+" "+f(0)+","+g(16)+" "+f(3.9)+","+g(7.9)+" "+f(0)+","+g(0)+" "+f(4)+","+g(0)+" "+f(8.7)+","+g(7.9)).style("opacity",.33).style("fill",l);h.append("polygon").attr("points",f(8)+","+g(16)+" "+f(4)+","+g(16)+" "+f(7.9)+","+g(7.9)+
" "+f(4)+","+g(0)+" "+f(8)+","+g(0)+" "+f(12.6)+","+g(7.9)).style("opacity",.66).style("fill",l);h.append("polygon").attr("points",f(11.9)+","+g(16)+" "+f(7.9)+","+g(16)+" "+f(11.8)+","+g(7.9)+" "+f(7.9)+","+g(0)+" "+f(11.9)+","+g(0)+" "+f(16)+","+g(7.9)).style("fill",l)};b.prototype.renderFunnel=function(f){function g(){var r=[],u=k.icon_w,t=k.icon_h;0<m&&(u-=m,t-=m);var v=u-6+",0";var w=u+","+t/2;u=u-6+","+t;var x="0,"+t;t="6,"+t/2;r.push("0,0");r.push(v);r.push(w);r.push(u);r.push(x);f&&1===f||
r.push(t);return r.join(" ")}var k=this,l=k.$icon.data("color")||"#aaa",h=c.crm.color(l),n=k.$icon.data("hover-color")||h.getTone(20),m=k.$icon.data("stroke-width")||0,p=k.$icon.data("hover")||!1,q=k.svg.append("g").append("polygon").attr("class","is-animated").attr("points",g()).attr("transform","translate("+m/2+","+m/2+")").style("fill",l);0<m&&(h=h.getTone(-20),q.style("stroke",h).style("stroke-width",m));p&&(p=q.node(),p=c(p).closest(".c-state-item "),p.on("mouseenter",function(){q.style("fill",
n)}),p.on("mouseleave",function(){q.style("fill",l)}));(function(){function r(){t||(t=!0,setTimeout(u,100))}function u(){c.contains(document,k.$icon[0])?(k.refresh(),q.attr("points",g())):c(window).off("resize refresh-icons",r);t=!1}var t=!1;c(window).on("resize refresh-icons",r)})()};b.prototype.refresh=function(){this.icon_w=this.$icon.outerWidth();this.icon_h=this.$icon.outerHeight();this.svg.attr("width",this.icon_w).attr("height",this.icon_h)};return b}(jQuery,d3);"string"===typeof a&&(a=d(a));
...
1.055,2.4):p/12.92;h=(.4124*n+.3576*m+.1805*p)/.95047;var q=.2126*n+.7152*m+.0722*p;n=(.0193*n+.1192*m+.9505*p)/1.08883;h=.008856<h?Math.pow(h,1/3):7.787*h+16/116;q=.008856<q?Math.pow(q,1/3):7.787*q+16/116;n=.008856<n?Math.pow(n,1/3):7.787*n+16/116;return[116*q-16,500*(h-q),200*(q-n)]}function k(h,n,m){var p=Math.floor(6*h),q=6*h-p;h=m*(1-n);var r=m*(1-q*n);n=m*(1-(1-q)*n);switch(p%6){case 0:var u=m;var t=n;var v=h;break;case 1:u=r;t=m;v=h;break;case 2:u=h;t=m;v=n;break;case 3:u=h;t=r;v=m;break;case 4:u=
n;t=h;v=m;break;case 5:u=m,t=h,v=r}return[255*u,255*t,255*v]}function l(h){var n=h[0]/255,m=h[1]/255,p=h[2]/255,q,r=Math.max(n,m,p);var u=r-Math.min(n,m,p);if(0==u)var t=q=0;else{q=u/r;h=(r-n)/6/u+.5;var v=(r-m)/6/u+.5;u=(r-p)/6/u+.5;n===r?t=u-v:m===r?t=1/3+h-u:p===r&&(t=2/3+v-h);0>t?t+=1:1<t&&--t}return{h:Math.round(360*t),s:Math.round(100*q),b:Math.round(100*r)}}b=function(h){h=this.hex=h;var n=!1;"string"===typeof h?(h=h.replace("#",""),3===h.length?n=c(h[0]+""+h[0],h[1]+""+h[1],h[2]+""+h[2]):
6===h.length&&(n=c(h[0]+""+h[1],h[2]+""+h[3],h[4]+""+h[5]))):"object"===typeof h&&3===h.length&&(n=h);this.rgb=n};b.prototype.getRange=function(){var h=this.rgb?g(this.rgb):!1;if(h){var n=f([90,h[1],h[2]]),m=f([40,h[1],h[2]]);h=e(n);var p=e(m);h=[h,p];h.getColor=function(q){if(0<=q&&100>=q){var r=n[0],u=n[1],t=n[2];return e([Math.floor(r+(m[0]-r)*q/100),Math.floor(u+(m[1]-u)*q/100),Math.floor(t+(m[2]-t)*q/100)])}return null};return h}return null};b.prototype.getTone=function(h){function n(p){100<
p?p=100:0>p&&(p=0);return p}var m=l(this.rgb);m.s=n(m.s*(1+h/100));m.b=n(m.b*(1+h/100));h=k(m.h/360,m.s/100,m.b/100);return e(h)};return b}();return new b(a)},initWYSIWYG:function(a,b){if(!a||!a.length||a.data("redactor"))return a;b=d.extend({minHeight:130,buttons:"inline bold italic underline deleted lists outdent indent image link horizontalrule fontcolor fontsize fontfamily".split(" "),plugins:["fontcolor","fontsize","fontfamily"],allowedTags:"a b i u pre blockquote p strong em del strike span ul ol li div span br".split(" "),
...
function(){k&&clearTimeout(k);l&&l.abort();l=d.post(h,{process_id:g});l.always(function(){l=null;k=setTimeout(n,e)});l.fail(function(){return!1})};k=setTimeout(n,500+300*c)}catch(m){console.error(["source email worker fail",m])}}()):console.error("Empty url")}})})(jQuery);(function(d,a){d.fn.serializeObject=function(){var b={};d.each(this.serializeArray(),function(c,e){c=e.name;e=e.value;b[c]=b[c]===a?e:d.isArray(b[c])?b[c].concat(e):[b[c],e]});return b}})(jQuery);
...
g=this.href,k=0<=g.indexOf(d.crm.app_url+"contact/")||0<=g.indexOf(d.crm.app_url+"deal/");if(d.crm.iframe&&(k||!f))return!1;f||(e.attr("href","javascript:void(0);"),f=e.attr("href"));k=e.hasClass("js-disable-router");var l=this.href.substr(0,b.length)==b;f=!("#"===f||"javascript:"===f.substr(0,11));f=a.is_enabled&&!k&&l&&f;c.ctrlKey||c.shiftKey||c.metaKey||!f||(c.preventDefault(),a.need_confirm?d.crm.confirm.show({title:d.crm.locales.unsaved_dialog_title,text:d.crm.locales.unsaved_dialog_text,button:d.crm.locales.unsaved_dialog_button,
onConfirm:function(){d(document).trigger("unsavedChanges",!1);a.load(g,!1,e)}}):a.load(g,!1,e))});d("#wa-app-crm").on("click","a",function(c){c.stopPropagation()});a.api_enabled&&(window.onpopstate=function(c){c.stopPropagation();a.onPopState(c)});d(document).on("unsavedChanges",function(c,e){a.need_confirm=!!e})};ContentRouter.prototype.load=function(a,b,c){var e=this;if(!(0<=a.indexOf(d.crm.app_url)))return alert("Determine the path error"),!1;e.animate(!0);e.xhr&&e.xhr.abort();d(document).trigger("wa_before_load",
{content_uri:a});c&&c.find("[data-fa-i2svg]").hide().after('<i class="fas fa-spinner fa-spin"></i>');e.xhr=d.ajax({method:"GET",url:a,dataType:"html",global:!1,cache:!1}).done(function(f){e.api_enabled&&!b&&history.pushState({reload:!0,content_uri:a},"",a);c&&(c.find("[data-fa-i2svg]:first").show(),c.find("[data-fa-i2svg]").slice(1).remove());e.setContent(f);e.animate(!1);e.xhr=!1;d(document).trigger("wa_loaded")}).fail(function(f){f.responseText&&d.crm.alert.show({title:"Error",text:f.responseText,
button:"Close"});c&&(c.find("[data-fa-i2svg]:first").show(),c.find("[data-fa-i2svg]").slice(1).remove())});return e.xhr};ContentRouter.prototype.reload=function(){var a=this.api_enabled&&history.state&&history.state.content_uri?history.state.content_uri:location.href;return a?this.load(a,!0):d.when()};ContentRouter.prototype.setContent=function(a){d(document).trigger("wa_before_render");d(a).filter("#app").length?(d.crm.iframe||this.$content.hide(),this.$spaContainer.show(),this.$spaContainer.is(":empty")&&
this.$spaContainer.html(a)):(this.$content.show().html(a),this.$spaContainer.hide())};ContentRouter.prototype.onPopState=function(a){if(a=a.state||!1){var b=a.current?0<=a.current.indexOf("/contact/")||0<=a.current.indexOf("/deal/"):!0;if(!a.content_uri&&!b)return alert("Determine the path error"),!1;d(document).trigger("wa_before_load",{content_uri:a.content_uri});a.reload?this.reload(a.content_uri):a.content&&this.setContent(a.content);a.title&&d.crm.title.set(a.title);d(document).trigger("wa_loaded")}else location.reload()};
...
function(){a(window.location.href)});b.$body.find("li > a").each(function(){d(this).waTooltip({placement:"right"})});b.$footer.find("li > a").each(function(){d(this).waTooltip({placement:"right"})})};CRMSidebar.prototype.setItem=function(a){if(this.$activeMenuItem.length&&this.$activeMenuItem[0]==a[0])return!1;this.$activeMenuItem.length&&this.$activeMenuItem.removeClass(this.selected_class);a.addClass(this.selected_class);this.$activeMenuItem=a};CRMSidebar.prototype.initMobileToggle=function(){function a(c){b.is_mobile=
b.$toggler.is(":visible");b.is_mobile&&("wa_before_render"!==c.type||b.$sidebar_open)&&(c&&c.preventDefault(),window.scrollTo({top:0,behavior:"smooth"}),b.$toggler.siblings().each(function(e,f){"SCRIPT"!==f.nodeName&&"STYLE"!==f.nodeName&&d(f).slideToggle(400,function(){var g=d(this);g.is(":hidden")?(g.css("display",""),b.$sidebar_open=!1):b.$sidebar_open=!0})}))}var b=this;b.$toggler.on("click.sidebar touchstart.sidebar",a);d(document).on("wa_before_render",a)};CRMSidebar.prototype.selectLink=function(a){var b;
a&&(b=this.$wrapper.find('a[href="'+a+'"]:first'));if(b&&b.length)this.setItem(b.closest("li"));else{a=this.$wrapper.find("a[href^='"+d.crm.app_url+"']");var c=location.pathname,e=0,f=0;a.each(function(g){var k=d(this).attr("href"),l=k.length;0<=c.indexOf(k)&&l>e&&(e=l,f=g)});if(f||0===f)b=a.eq(f),this.setItem(b.closest("li"))}};CRMSidebar.prototype.reload=function(a){var b=this,c=d.crm.app_url+"?module=sidebar&ui="+b.$ui+"&reload=1";a&&(c+="&background_process=1");clearTimeout(b.timer);b.xhr&&b.xhr.abort();
b.xhr=d.get(c,function(e){b.$toggler.off(".sidebar");b.xhr=!1;b.$body.html(e)})};CRMSidebar.prototype.initUpdater=function(){var a=this;a.timer=setTimeout(function(){d.contains(document,a.$wrapper[0])&&a.reload(!0)},3E5)};return CRMSidebar}(jQuery);var CRMDeal=function(d){var a=function(c){a=function(e){this.$window=c(window);this.$wrapper=e.$wrapper;this.$outer_wrapper=e.$outer_wrapper;this.debug=e.debug;this.indent={top:0};this.$clone=null;this.offset=this.getOffset();this.type=null;this.init()};a.prototype.init=function(){function e(){c.contains(document,g.$wrapper[0])?(g.reset(),g.onScroll()):c(document).off("refresh",e)}function f(){if(c.contains(g.$window[0].document,g.$wrapper[0]))g.onScroll();else g.$window.off("scroll",f)}var g=this;
...
l.closest(".c-add-contact");h?(k.hide(),l.addClass("is-shown")):(k.show(),l.removeClass("is-shown"))}function e(l,h){function n(m){m=m?m:[];d.each(m,function(p,q){p=q.text;var r=d('<div class="errormsg" />').html(p);k.one("click",function(){r.remove()});g.prepend(r)})}h=h?h:function(){};d.post("?module=deal&action=userAdd",{contact_id:l,deal_id:f.deal_id},function(m){"ok"===m.status?h(m.data.html):m.errors&&n(m.errors)},"json")}var f=this,g=f.$aside.find(".js-add-user-wrapper"),k=g.find(".js-add-contact");
k.on("click",function(l){l.preventDefault();c(d(this),!0)});g.on("click",".js-close-add-contact",function(l){l.preventDefault();c(d(this))});(function(){function l(n,m){var p=f.$aside.find('.c-contact[data-id="'+n+'"]');p.length&&h(p);e(n,function(q){q=d(q);m.before(q);h(q);d(document).trigger("refresh")})}function h(n){n.addClass("is-highlight");setTimeout(function(){d.each(n,function(m,p){d.contains(document,p)&&d(this).removeClass("is-highlight")})},3E3)}f.$aside.find(".js-contact-autocomplete").each(function(){var n=
d(this);n.autocomplete({appendTo:f.$aside,source:d.crm.app_url+"?module=autocomplete&type=user&funnel_id="+f.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(m,p){l(p.item.id,n.closest(".c-add-contact"));n.val("");f.$aside.find(".js-close-add-contact").trigger("click");return!1}}).data("ui-autocomplete")._renderItem=function(m,p){var q=d("<li />");q.addClass("ui-menu-item-html").append("<div>"+p.value+"</div>").appendTo(m);p.rights||(q.addClass("is-locked"),q.on("click",function(r){r.preventDefault();
r.stopPropagation()}));return q};n.on("focus",function(){n.data("uiAutocomplete").search(n.val())})})})()};CRMDeal.prototype.initRemoveFiles=function(){function c(g,k){d.post("?module=file&action=delete",{id:g},function(l){"ok"==l.status?k.remove():console&&console.log&&console.log("File Remove Error")})}var e=this,f;e.$wrapper.find(".c-files-wrapper").on("click",".js-remove-file",function(g){g.preventDefault();var k=d(this).closest(".c-file");g=k.find(".c-name").text();var l=parseInt(k.data("id"));
...
g=null;new CrmEditable({$wrapper:c,onSave:function(k){var l=k.$field.val();if(l.length&&k.text!==l){g&&g.abort();l={id:f,name:l};k.$field.attr("disabled",!0);var h=d('<i class="icon16 loading"></i>').css("margin","0 0 0 4px").insertAfter(k.$field);g=d.post(e,l,function(n){k.$field.attr("disabled",!1);h.remove();k.toggle("hide");n&&n.data&&n.data.deal&&(k.text=n.data.deal.name,k.$wrapper.text(n.data.deal.name),d.crm.title.set(n.data.deal.name))})}else l.length||k.$field.val(k.text),k.toggle("hide")}})}};
CRMDeal.prototype.initChangeDate=function(){function c(m){m?(g.addClass("is-shown"),h.focus()):(g.removeClass("is-shown"),h.datepicker("hide"))}function e(m){h.val()||(m="");d.post("?module=deal&action=changeExpectedDate",{id:f.deal_id,expected_date:m?m:""},function(p){"ok"==p.status&&p.data&&p.data.deal&&((p=p.data.deal.expected_date)?(k.hide(),l.show().find(".js-name").text(p)):(l.hide().find(".js-name").text(""),k.show()),c())},"json")}var f=this,g=f.$wrapper.find(".js-date-toggle");if(!g.length)return!1;
var k=g.find(".js-link"),l=g.find(".js-span"),h=g.find(".js-datepicker"),n=g.find(".js-field");g.on("click",".js-set-date",function(m){m.preventDefault();c(!0)});h.on("keydown keypress keyup",function(m){27===m.keyCode&&c()});g.on("click",".js-close-edit-date",function(){c()});(function(){h.datepicker({altField:n,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var m=h.val(),p=n.val(),q=d.datepicker._defaults.dateFormat,r=!1;try{d.datepicker.parseDate(q,m),r=!0}catch(u){}if(r)e(p);
else return!1}});h.val()||h.datepicker("setDate","+0d")})()};CRMDeal.prototype.initChangePrice=function(){function c(p){p?k.addClass("is-shown"):k.removeClass("is-shown")}function e(p,q){d.post("?module=deal&action=changeAmount",{id:g.deal_id,amount:p?p:"",currency_id:q?q:""},function(r){"ok"==r.status&&r.data&&r.data.deal&&((r=r.data.deal.amount)?(l.hide(),h.show().text(r)):(h.hide().text(""),l.show()),c())},"json")}function f(){var p=n.val(),q=m.val(),r=!1;p&&(r=p.replace(",","."));0<=r?e(p,q):
n.addClass("error")}var g=this,k=g.$wrapper.find(".js-price-toggle");if(!k.length)return!1;var l=k.find(".js-link"),h=k.find(".js-span"),n=k.find(".js-price-field"),m=k.find(".js-currency-field");k.on("click",".js-set-price",function(p){p.preventDefault();c(!0)});k.on("click",".js-save-price",function(p){p.preventDefault();f()});k.on("click",".js-cancel",function(p){p.preventDefault();c()});n.on("focus",function(){n.hasClass("error")&&n.removeClass("error")});n.on("keydown",function(p){13===p.keyCode&&
(p.preventDefault(),f())})};CRMDeal.prototype.initChangeField=function(){function c(h,n){var m=d(h).parents(".js-field-toggle");n?(m.find(".c-hidden").css({height:d(h).height()+8}),d(h).closest(".js-field-toggle").hasClass("js-textarea")?(m.addClass("is-shown").find(".c-hidden").css("width","100%"),m.find("textarea").slideDown().next().find(".icon16").removeClass("loading").addClass("disk"),m.css({width:"100%","margin-left":0}).prev().hide()):(m.addClass("is-shown"),m.find(".js-datepicker-field").focus())):
d(document).trigger("mousedown")}function e(h){var n=k.data("deal-id"),m="",p=d(h).data("field-id"),q=d(h).data("field-type"),r=!1;switch(q){case "checkbox":d(h).prop("required")&&!d(h).prop("checked")?(r=!0,d(h).addClass("error")):m=Number(d(h).prop("checked"));break;case "date":var u=d(h).siblings(".js-datepicker-field"),t=d.datepicker._defaults.dateFormat,v=!1;try{d.datepicker.parseDate(t,u.val()),v=!0}catch(x){}""!=u.val()&&""!=u.val().trim()&&v||!d(h).prop("required")?m=u.val():(r=!0,u.addClass("error"));
break;case "text":u=d(h).parents(".c-hidden").find(".js-field-value-text");u.next().find(".icon16").removeClass("disk").addClass("loading");""!=u.val()&&""!=u.val().trim()||!u.prop("required")?m=u.val():(r=!0,d(h).parents(".c-hidden").find(".js-field-value-text").addClass("error"));break;case "select":var w=d(h).val();v=!1;d(h).find("option").each(function(x,y){d(y).val()==w&&(v=!0)});!v||""==w&&d(h).prop("required")?(r=!0,d(h).addClass("error")):m=w;break;case "radio":m=d(h).find(":checked").val();
break;case "number":w=d(h).val().replace(",",".");(""==w||isNaN(Number(w)))&&d(h).prop("required")?(r=!0,d(h).addClass("error")):m=w;break;default:w=d(h).val(),""!=w&&""!=w.trim()||!d(h).prop("required")?m=w:(r=!0,d(h).addClass("error"))}r||f(h,{id:n,field_id:p,value:m,value_type:q})}function f(h,n){d.post("?module=deal&action=changeValue",n,function(m){if("ok"==m.status){if(m.data&&m.data.deal_params){m=m.data.deal_params.value;var p=d(h).parents(".js-field-toggle").find(".js-output-value");m?(p.text(m),
...
d(document).on("mousedown",function(h){0!==g.has(h.target).length||g.is(h.target)||g.each(function(n,m){var p=d(m);n=p.find("textarea");p.hasClass("js-textarea")?n.slideUp(function(){p.removeClass("is-shown").removeAttr("style").prev().show()}):p.removeClass("is-shown")})});l.on("keydown",function(h){13===h.keyCode&&(h.preventDefault(),d(this).hasClass("js-datepicker-field")?e(d(this).siblings(".js-field-value")):e(this))});(function(){var h=k.find(".js-datepicker-field"),n=h.siblings(".js-field-value");
h.datepicker({altField:n,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:function(){var m=d(this).siblings(".js-field-value");e(m)}})})()};CRMDeal.prototype.initWYSIWYG=function(){var c=this.$wrapper.find(".js-wysiwyg");if(!c.length)return!1;d.crm.initWYSIWYG(c,{keydownCallback:function(e){}})};CRMDeal.prototype.initChangeDescription=function(){function c(l){l?g.addClass("is-shown"):g.removeClass("is-shown")}function e(l){d.post("?module=deal&action=changeDescription",l,function(h){if("ok"==
...
function(l){l.preventDefault();c(!1)});k.on("focus",function(){k.hasClass("error")&&k.removeClass("error")})};CRMDeal.prototype.initChangeUser=function(){function c(h){if(!h.length)return!1;var n=h.closest(".c-contact");h.autocomplete({appendTo:n,source:"?module=autocomplete&type=user&funnel_id="+k.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(m,p){e(p.item.id,n);h.val("");return!1}}).data("ui-autocomplete")._renderItem=function(m,p){var q=d("<li />");q.addClass("ui-menu-item-html").append("<div>"+
p.value+"</div>").appendTo(m);p.rights||(q.addClass("is-locked"),q.on("click",function(r){r.preventDefault();r.stopPropagation()}));return q};h.on("focus",function(){h.data("uiAutocomplete").search(h.val())})}function e(h,n){l?g(n):f(h,function(){l=!0;d.post("?module=deal&action=changeUser",{id:k.deal_id,user_contact_id:h},function(m){if("ok"!==m.status)m.errors?console.error(m.errors):console.error(m),d.crm.alert.show({title:"Error",button:"Error"});else if(m.data=m.data||{},m.data.deal_access_denied)window.location.href=
d.crm.app_url+"deal/";else if(m.data.html){m=d(m.data.html);var p=k.$aside.find('.c-users-section .c-contact[data-id="'+h+'"]').not(n);p.length&&p.remove();n.replaceWith(m);c(m.find(".js-owner-autocomplete"))}},"json").always(function(){l=!1})})}function f(h,n){d.post("?module=deal&action=changeUserConfirm",{id:k.deal_id,user_contact_id:h},"json").done(function(m){m.data&&m.data.need_confirm?new CRMDialog({html:m.data.html||"",onOpen:function(p,q){p.find(".js-confirm-button").on("click",function(){n()})}}):
n()})}function g(h,n){n?h.addClass("is-edit"):h.removeClass("is-edit")}var k=this,l=!1;k.$aside.on("click",".js-show-combobox",function(h){h.preventDefault();h=d(this).closest(".c-contact");g(h,!0)});k.$aside.on("click",".js-hide-combobox",function(h){h.preventDefault();h=d(this).closest(".c-contact");g(h)});k.$aside.find(".js-owner-autocomplete").each(function(){c(d(this))});(function(){function h(q){m||f(q,function(){m=!0;d.post("?module=deal&action=changeUser",{id:k.deal_id,user_contact_id:q},
function(r){if("ok"===r.status)if(r.data.deal_access_denied)window.location.href=d.crm.app_url+"deal/";else{r=d(r.data.html);var u=k.$aside.find('.c-users-section .c-contact[data-id="'+k.user_id+'"]');u.length&&u.remove();k.$aside.find('.c-contact[data-id="'+r.data("id")+'"]').remove();p.after(r).css("display","none");k.$aside.find(".js-add-user-wrapper").show();c(r.find(".js-owner-autocomplete"))}},"json").always(function(){m=!1})})}function n(q){q?p.addClass("is-extended"):p.removeClass("is-extended")}
var m=!1,p=k.$aside.find(".js-empty-user-wrapper");p.on("click",".js-set-user-me",function(q){q.preventDefault();h(k.user_id)});p.on("click",".js-set-extended",function(q){q.preventDefault();n(!0)});p.on("click",".js-unset-extended",function(q){q.preventDefault();n(!1)});(function(){p.find(".js-empty-user-autocomplete").each(function(){var q=d(this);q.autocomplete({appendTo:p,source:"?module=autocomplete&type=user&funnel_id="+k.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(r,
u){h(u.item.id);q.val("");return!1}}).data("ui-autocomplete")._renderItem=function(r,u){var t=d("<li />");t.addClass("ui-menu-item-html").append("<div>"+u.value+"</div>").appendTo(r);u.rights||(t.addClass("is-locked"),t.on("click",function(v){v.preventDefault();v.stopPropagation()}));return t};q.on("focus",function(){q.data("uiAutocomplete").search(q.val())})})})()})()};CRMDeal.prototype.initChangeClient=function(){function c(l,h,n){g||(g=!0,d.post("?module=deal&action=changeClient",{deal_id:e.deal_id,
...
l=d(this).closest(".c-contact");var h=l.data("type"),n=l.data("id");c(l,n,h)});var k=f.find(".js-empty-contact-wrapper");if(k.length)k.on("click",".js-set-company-owner",function(l){l.preventDefault();c(k,"","contact_owner")})};CRMDeal.prototype.initDealDelete=function(){function c(){f||(f=!0,d.post(d.crm.app_url+"?module=deal&action=delete",{id:e.deal_id},function(g){"ok"===g.status&&d.crm.content.load(d.crm.app_url+"deal/")},"json").always(function(){f=!1}))}var e=this,f=!1;e.$wrapper.on("click",
...
c=b.find(".js-datepicker"),e=b.find('[name="deal[expected_date]"]');c.datepicker({altField:e,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0,onSelect:a});c.on("blur",a);c.on("keydown keypress keyup",function(f){13===f.which&&f.preventDefault()});c.on("click",".js-icon",function(){c.focus()})};CRMDealEdit.prototype.initSave=function(){function a(){for(var m={data:[],errors:[]},p=k.serializeArray(),q=0;q<p.length-1;q++)for(var r=q+1;r<p.length;r++)p[q].name==p[r].name&&(""==p[q].value?p.splice(q,
1):""==p[r].value&&p.splice(r,1));d.each(p,function(u,t){u=d('[name="'+t.name+'"]');var v=0<d('[name="'+t.name+'"][type="radio"]').length,w=""==t.value||""==t.value.trim();1==d(u).prop("required")&&w&&m.errors.push({name:t.name,value:g.locales.bad_amount,is_radio:v});"deal[amount]"===t.name&&(t.value.length&&(t.value=d.trim(t.value)),v=t.value,u=!1,v.length&&(v=v.replace(",","."),0<v||"0"===v)&&(u=!0),u||m.errors.push({name:t.name,value:g.locales.bad_amount}));m.data.push(t)});"edit"===g.contact_mode?
g.can_edit_contact&&e(m):f(m);return m}function b(m){m&&m[0]||(m=[]);d.each(m,function(p,q){p=q.name;var r=q.value;if(q=q.is_radio)var u=g.$wrapper.find('[name="'+p+"\"][type='hidden']"),t=g.$wrapper.find('[name="'+p+"\"][type='radio']");else u=g.$wrapper.find('[name="'+p+'"]');"contact[firstname]"!==p||u.is(":visible")||(u=g.$wrapper.find(".js-contact-autocomplete"));var v=d("<span class='c-error' />").addClass("errormsg").text(r);if(u.length&&!u.hasClass("error"))if(u.parent().append(v),u.addClass("error"),
q)t.one("focus click change",function(){u.removeClass("error");v.remove()});else u.one("focus click change",function(){u.removeClass("error");v.remove()});else l.append(v),k.one("submit",function(){v.remove()})})}function c(m){if(!n){n=!0;var p=d.crm.app_url+"?module=deal&action=save";h.attr("disabled","disabled").prop("disabled",!0);var q=g.$wrapper.find(".loading");q.show();d.post(p,m,function(r){"ok"===r.status?d.crm.content.load(d.crm.app_url+"deal/"+r.data.deal.id+"/"):r.errors&&b(r.errors)},
"json").always(function(){q.hide();n=!1;h.removeAttr("disabled").prop("disabled",!1)})}}function e(m){var p=g.$wrapper.find("#c-contact-edit-form").closest("form"),q=p.find(".js-phone-list"),r=p.find(".js-email-list");p=p.serializeArray();var u=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],t=!0;d.each(p,function(v,w){m.data.push({name:w.name,value:w.value});0<d.trim(w.value).length&&0<=u.indexOf(w.name)&&(t=!1)});t&&(m.errors.push({name:"contact[firstname]",value:g.locales.empty_name}),
m.errors.push({name:"contact[name]",value:g.locales.empty_name}));q.find("li").each(function(v){var w=d(this),x=w.find(".js-value");w=w.find(".js-ext");var y=x.val(),A=w.val();if(y){var B="contact[phone]["+v+"][value]";x.attr("name",B);m.data.push({name:B,value:y});v="contact[phone]["+v+"][ext]";w.attr("name",v);m.data.push({name:v,value:A})}});r.find("li").each(function(v){var w=d(this),x=w.find(".js-value");w=w.find(".js-ext");var y=x.val(),A=w.val();if(y){var B="contact[email]["+v+"][value]";x.attr("name",
B);m.data.push({name:B,value:y});v="contact[email]["+v+"][ext]";w.attr("name",v);m.data.push({name:v,value:A})}});return m}function f(m){var p=g.$wrapper.find("#c-contact-add-form").closest("form").serializeArray(),q=!1,r=!1;d.each(p,function(u,t){u=t.name;var v=t.value;"deal[contact_id]"===u&&v&&(q=!0);"contact[firstname]"===u&&v&&(r=!0);"contact[lastname]"===u&&v&&(r=!0);"contact[middlename]"===u&&v&&(r=!0);"contact[name]"===u&&v&&(r=!0);m.data.push(t)});q||r||(m.errors.push({name:"contact[name]",
value:g.locales.empty_name}),m.errors.push({name:"contact[firstname]",value:g.locales.empty_name}))}var g=this,k=g.$form,l=g.$form.find(".js-errors-place"),h=g.$wrapper.find(".js-submit-button"),n=!1;h.on("click",function(){k.trigger("submit")});k.on("submit",function(m){m.preventDefault();m=a();m.errors.length?b(m.errors):c(m.data)})};CRMDealEdit.prototype.initSuggestName=function(){var a=this,b=a.$form,c=a.$deal_name_input;if(!c.data("edited")){c.one("mark-edited.crm-deal-suggestion",function(){c.data("edited",
...
".js-crm-deal-name-suggester-input",function(k){var l=d(this);f&&clearTimeout(f);f=setTimeout(function(){if(l.hasClass("crm-find-contact-input")){if("keyup"===k.type)return;l=b.find('[name="deal[id]"]')}var h=l.attr("name")||"",n=d.trim(l.val());if(h){a.suggester_values[h]=d.trim(a.suggester_values[h]);if(a.suggester_values[h]===n)return;a.suggester_values[h]=n}g()},250)})}};CRMDealEdit.prototype.initChangeCompanyContact=function(){var a=this,b=a.$wrapper.find(".js-contact-block"),c=b.find(".js-view-toggle"),
...
"contact[lastname]","contact[name]"],q=!0;d.each(n,function(r,u){m.data.push({name:u.name,value:u.value});0<d.trim(u.value).length&&0<=p.indexOf(u.name)&&(q=!1)});q&&(m.errors.push({name:"contact[firstname]",value:"Name is empty"}),m.errors.push({name:"contact[name]",value:"Name is empty"}));l.find("li").each(function(r){var u=d(this),t=u.find(".js-value");u=u.find(".js-ext");var v=t.val(),w=u.val();if(v){var x="contact[phone]["+r+"][value]";t.attr("name",x);m.data.push({name:x,value:v});r="contact[phone]["+
r+"][ext]";u.attr("name",r);m.data.push({name:r,value:w})}});h.find("li").each(function(r){var u=d(this),t=u.find(".js-value");u=u.find(".js-ext");var v=t.val(),w=u.val();if(v){var x="contact[email]["+r+"][value]";t.attr("name",x);m.data.push({name:x,value:v});r="contact[email]["+r+"][ext]";u.attr("name",r);m.data.push({name:r,value:w})}});m.data.push({name:"deal_id",value:e.deal_id});return m}function b(n){d.post(e.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",n,function(m){"ok"==
m.status?(e.dialog.options.onChange(m.data.html),e.dialog.close()):m.errors&&c(m.errors)},"json").always(function(){k=!1})}function c(n){n=n?n:[];d.each(n,function(m,p){m=p.name;p=p.value;"contact[name]"===m&&(m="contact[firstname]");var q=g.find('[name="'+m+'"]'),r=d("<span />").addClass("errormsg").text(p);q.length?q.hasClass("error")||(q.parent().append(r),q.addClass("error").one("focus click",function(){q.removeClass("error");r.remove()})):(f.append(r),g.one("submit",function(){r.remove()}))})}
var e=this,f=e.$wrapper.find(".js-errors-place"),g=e.$wrapper.find("#c-contact-edit-form").closest("form"),k=!1,l=g.find(".js-phone-list"),h=g.find(".js-email-list");e.$wrapper.on("click",".js-save-changed-data",function(n){n.preventDefault();g.trigger("submit")});g.on("submit",function(n){n.preventDefault();k||(k=!0,n=a(),n.errors.length?(c(n.errors),k=!1):b(n.data))})};CRMDealChangeClient.prototype.initSwitchContact=function(){function a(k){k=k?k:[];d.each(k,function(l,h){l=h.name;h=h.value;"contact[name]"===
l&&(l="contact[firstname]");var n=f.find('[name="'+l+'"]'),m=d("<span />").addClass("errormsg").text(h);n.length?n.hasClass("error")||(n.parent().append(m),n.addClass("error").one("focus click",function(){n.removeClass("error");m.remove()})):(e.append(m),c.$wrapper.one("click",".js-switch-contact",function(){m.remove()}))})}function b(k){g||(g=!0,k.push({name:"deal_id",value:c.deal_id}),d.post("?module=deal&action=personUpdate",k,function(l){"ok"===l.status?(c.dialog.options.onChange(l.data),c.dialog.close()):
...
function(){function a(){if(d.contains(document,e[0])){var n=c.scrollTop();k.top<n?g||(g=!0,f=d("<div />"),f.height(h).insertAfter(e),e.width(l).addClass("is-fixed-to-top")):b()}else c.off("scroll",a)}function b(){f&&f.length&&f.remove();f=!1;e.removeAttr("style").removeClass("is-fixed-to-top");l=e.width();h=e.height();g=!1}var c=d(window),e=this.$header,f=!1,g=!1,k=e.offset(),l=e.width(),h=e.height();c.on("scroll",a);c.on("resize",function(){b();c.trigger("scroll")})};CRMDealsFunnel.prototype.initDealsMove=
function(){function a(g,k,l,h){function n(){d.crm.content.reload()}if(!b){b=!0;var m=l.closest(".js-drop-area");e.draggable("disable");l.addClass("is-loading").removeAttr("style").prependTo(h);d.post("?module=deal&action=move",{deal_id:g,stage_id:k},function(p){"ok"===p.status&&(p.data.dialog_html&&p.data.dialog_html.html?new CRMDialog({html:p.data.dialog_html.html,options:{onShopSubmit:n},onCancel:function(){l.removeClass("is-loading").prependTo(m)},onConfirm:function(){d.post("?module=deal&action=move",
{deal_id:g,stage_id:k,force_execute:1},n)}}):n())},"json").always(function(){e.draggable("enable");b=!1})}}var b=!1,c=!1,e=this.$wrapper.find(".c-deal-wrapper"),f=this.$wrapper.find(".js-drop-area");e.draggable({handle:".js-drag-toggle",revert:!0,start:function(){var g=d(this),k=g.closest(".js-drop-area");g.data("stage-index",k.index()).data("stage-id",k.data("id")).draggable("option","revert",!0);c=k.addClass("is-wrapper")}});f.droppable({tolerance:"pointer",drop:function(g,k){g=d(this);k=d(k.draggable);
var l=g.data("id"),h=k.data("stage-id"),n=k.data("id");h!==l&&(k.draggable("option","revert",!1),a(n,l,k,g));c.length&&(c.removeClass("is-wrapper"),c=!1)}})};CRMDealsFunnel.prototype.initMassiveActionsHeader=function(){function a(){if(d.contains(document,f[0]))if(c.selected_deals.length){f.hasClass("is-hidden")&&f.removeClass("is-hidden");var m=e.scrollTop();l.top+n>m+e.height()?k||(k=!0,g=d("<div />"),g.height(n).insertAfter(f),f.width(h).addClass("is-fixed-to-bottom")):b()}else b(),f.hasClass("is-hidden")||
f.addClass("is-hidden");else e.off("scroll",a)}function b(){g&&g.length&&g.remove();g=!1;f.removeAttr("style").removeClass("is-fixed-to-bottom");h=f.width();n=f.height();k=!1}var c=this,e=d(window),f=c.$actionsHeader,g=!1,k=!1,l=f.offset(),h=f.width(),n=f.height();e.on("scroll",a);e.on("resize",function(){b();e.trigger("scroll")})};CRMDealsFunnel.prototype.initMassActions=function(){function a(l){l.find(".js-check-deal").is(":checked")?(l.addClass("is-active"),k.push(l[0])):(l.removeClass("is-active"),
l=k.indexOf(l[0]),k.splice(l,1));b();d(window).trigger("scroll")}function b(){function l(){var p=c("open"),q=f.find(".js-deals-close").closest(".c-action"),r=q.find(".js-open-count");p.length?(r.text(p.length),q.show()):q.hide()}function h(){var p=f.find(".js-deals-merge").closest(".c-action");1<k.length?p.show():p.hide()}function n(){var p=!1;d(k).each(function(){if(d(this).data("can-delete"))return p=!0,!1});var q=f.find(".js-deals-delete").closest(".c-action");p?q.show():q.hide()}var m=k.length;
0<k.length&&(f.find(".js-count").text(m),l(),h(),n())}function c(l){var h=[];d.each(k,function(n,m){n=d(m);m=n.data("id");(!l||n.data(l))&&m&&h.push(m)});return h}var e=this,f=e.$actionsHeader,g=f.find(".js-checkbox-all"),k=e.selected_deals;e.$wrapper.on("click",".js-deal-wrapper",function(l){l=d(l.target);var h=!(!l.is("a")&&!l.closest("a").length);l=l.is(":checkbox");if(!h){h=d(this);var n=h.find(".js-check-deal");l||n.attr("checked",!n.is(":checked"));a(h)}});e.$tableContent.find(".js-state-column").shiftSelectable({selector:".js-deal-wrapper",
onSelect:function(l,h){var n=d(h.target);n=!(!n.is("a")&&!n.closest("a").length);var m=h.extra.is_first;h=h.extra.is_last;n||m||h||(l.find(".js-check-deal").attr("checked",!0),a(l))}});g.on("change",function(){var l=d(this).is(":checked");e.$wrapper.find(".js-deal-wrapper").each(function(){var h=d(this),n=h.find(".js-check-deal");n.is(":checked")!==l&&(n.attr("checked",l),a(h))})});f.on("click",".js-deals-merge",function(l){l.preventDefault();l=c();l=d.crm.app_url+"deal/merge/?ids="+l.join(",");d.crm.content.load(l)});
(function(){var l=!1;f.on("click",".js-deals-delete",function(h){h.preventDefault();d.crm.confirm.show({title:e.locales.delete_confirm_title.replace("%s",k.length),text:e.locales.delete_confirm_text,button:e.locales.delete_confirm_button,onConfirm:function(n){function m(){var u=[],t=c();d.each(t,function(v,w){u.push({name:"id[]",value:w})});return u}function p(){var u=k.map(function(t){return t});d.each(u,function(t,v){t=d(v);t.find(".js-check-deal").attr("checked",!1).trigger("change");t.remove()})}
if(!l){l=!0;var q=d.crm.app_url+"?module=deal&action=delete",r=m();d.post(q,r,function(u){"ok"===u.status&&(p(),n.close(),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){l=!1})}return!1}})})})();(function(){var l=!1;f.on("click",".js-deals-change-responsible",function(h){h.preventDefault();l||(l=!0,h={ids:c().join(",")},d.post("?module=deal&action=changeResponsible",h,function(n){new CRMDialog({html:n})}).always(function(){l=!1}))})})();(function(){var l=!1;f.on("click",".js-deals-close",
function(h){h.preventDefault();l||(l=!0,h={ids:c("open").join(",")},d.post("?module=deal&action=massClose",h,function(n){new CRMDialog({html:n})}).always(function(){l=!1}))})})();(function(){var l=!1;f.on("click",".js-deals-change-funnel",function(h){h.preventDefault();l||(l=!0,h={deal_ids:c().join(",")},d.post("?module=deal&action=changeFunnel",h,function(n){new CRMDialog({html:n})}).always(function(){l=!1}))})})();(function(){var l=!1;f.on("click",".js-deals-export",function(h){h.preventDefault();
l||(l=!0,h=c(),d.post(d.crm.app_url+"?module=deal&action=export",{ids:h},function(n){new CRMDialog({html:n})}).always(function(){l=!1}))})})();(function(){var l=!1;f.on("click",".js-deals-set-tags",function(h){h.preventDefault();if(!l){l=!0;h=c();var n=d.crm.app_url+"?module=dealOperation&action=assignTags",m={deal_ids:h};1===h.length&&(m.is_assign=1);d.post(n,m,function(p){new CRMDialog({html:p})}).always(function(){l=!1})}})})()};return CRMDealsFunnel}(jQuery),CRMDealsList=function(d){CRMDealsList=
...
function(){this.initLazy();this.initElasticHeader();this.initMassActions()};CRMDealsList.prototype.initLazy=function(){function a(){if(d.contains(document,g[0])){var l=d(window).scrollTop(),h=e.height(),n=g.offset().top;l+h>=n&&(k||b())}else e.off("scroll",a)}function b(){var l={offset:g.data("offset")};c.stage_id&&(l.stage=c.stage_id);c.contact_id&&(l.user=c.contact_id);k=!0;d.post("?module=deal&action=list",l,function(h){var n=d(h).find(".js-lazyload");n.length?(c.limit+=l.offset,n.insertAfter(g),
g.remove(),g=n):g.remove();d(h).find(".c-deal-wrapper").insertAfter(f.find("tr:last"))}).always(function(){k=!1})}var c=this,e=d(window),f=c.$tableBody,g=c.$wrapper.find(".js-lazyload"),k=!1;g.length&&(e.on("scroll",a),g.offset().top<e.height()&&e.trigger("scroll"))};CRMDealsList.prototype.initElasticHeader=function(){function a(){d.contains(document,e[0])?b.scrollTop()>f.top?e.css({left:f.left}).width(c.outerWidth()).addClass("is-fixed"):e.removeAttr("style").removeClass("is-fixed"):b.off("scroll",
a)}var b=d(window),c=this.$tableWrapper,e=this.$tableHeaderW,f=c.offset();b.on("scroll",a)};CRMDealsList.prototype.initMassActions=function(){function a(m){m.find(".js-check-deal").prop("checked",!0).trigger("change",[!0])}function b(m){m.find(".js-check-deal").prop("checked",!1).trigger("change",[!1])}function c(m){m.find(".js-check-deal").is(":checked")?(m.addClass("is-active"),k.push(m[0])):(m.removeClass("is-active"),m=k.indexOf(m[0]),k.splice(m,1));e()}function e(){function m(){var u=f("open"),
t=h.find(".js-deals-close").closest(".c-operation-li"),v=t.find(".js-open-count");u.length?(v.text(u.length),t.show()):t.hide()}function p(){var u=h.find(".js-deals-merge").closest(".c-operation-li");1<k.length?u.show():u.hide()}function q(){var u=!1;d(k).each(function(){if(d(this).data("can-delete"))return u=!0,!1});var t=h.find(".js-deals-delete").closest(".c-operation-li");u?t.show():t.hide()}var r=k.length;0<r?(l.hide(),h.show().find(".js-count").text(r),m(),p(),q(),r<g.limit?n.prop("indeterminate",
!0):n.prop("indeterminate",!1).prop("checked",!0)):(l.show(),h.hide(),n.prop("indeterminate",!1).prop("checked",!1))}function f(m){var p=[];d.each(k,function(q,r){q=d(r);r=q.data("id");(!m||q.data(m))&&r&&p.push(r)});return p}var g=this,k=[],l=g.$tableHeader,h=g.$tableActions,n=g.$tableHeaderW.find(".js-checkbox-all");g.$tableBody.on("click",".js-deal-wrapper",function(m){m=d(m.target);var p=d(this),q=p.find(".js-check-deal");q.closest("td");var r=!(!m.is("a")&&!m.closest("a").length),u=!(!m.is(".c-column-checkbox")&&
!m.closest(".c-column-checkbox").length);if(m.is(":checkbox"))return c(p),!0;if(r)return!0;u&&(q.attr("checked",!q.is(":checked")),c(p))});g.$tableBody.shiftSelectable({selector:".js-deal-wrapper",onSelect:function(m,p){var q=d(p.target);q=!(!q.is("a")&&!q.closest("a").length);var r=p.extra.is_first;p=p.extra.is_last;q||r||p||(m.find(".js-check-deal").attr("checked",!0),c(m))}});n.on("change",function(){var m=d(this).is(":checked"),p=g.$wrapper.find(".js-deal-wrapper"),q=p.find(".js-check-deal").filter(":checked").length;
0<q?q<g.limit||q===g.limit?b(p):a(p):m?a(p):b(p);p.each(function(){c(d(this))})});h.on("click",".js-deals-merge",function(m){m.preventDefault();m=f();m=d.crm.app_url+"deal/merge/?ids="+m.join(",");d.crm.content.load(m)});(function(){var m=!1;h.on("click",".js-deals-delete",function(p){p.preventDefault();d.crm.confirm.show({title:g.locales.delete_confirm_title.replace("%s",k.length),text:g.locales.delete_confirm_text,button:g.locales.delete_confirm_button,onConfirm:function(q){function r(){var w=[],
x=f();d.each(x,function(y,A){w.push({name:"id[]",value:A})});return w}function u(){var w=k.map(function(x){return x});d.each(w,function(x,y){x=d(y);x.find(".js-check-deal").attr("checked",!1).trigger("change");x.remove()})}if(!m){m=!0;var t=d.crm.app_url+"?module=deal&action=delete",v=r();d.post(t,v,function(w){"ok"===w.status&&(u(),q.close(),l.show(),h.hide(),n.prop("indeterminate",!1).prop("checked",!1),d.crm.content.reload(),d.crm.sidebar.reload())}).always(function(){m=!1})}return!1}})})})();
(function(){var m=!1;h.on("click",".js-deals-change-responsible",function(p){p.preventDefault();m||(m=!0,p={ids:f().join(",")},d.post("?module=deal&action=changeResponsible",p,function(q){new CRMDialog({html:q})}).always(function(){m=!1}))})})();(function(){var m=!1;h.on("click",".js-deals-close",function(p){p.preventDefault();m||(m=!0,p={ids:f("open").join(",")},d.post("?module=deal&action=massClose",p,function(q){new CRMDialog({html:q})}).always(function(){m=!1}))})})();(function(){var m=!1;h.on("click",
".js-deals-change-funnel",function(p){p.preventDefault();m||(m=!0,p={deal_ids:f().join(",")},d.post("?module=deal&action=changeFunnel",p,function(q){new CRMDialog({html:q})}).always(function(){m=!1}))})})();(function(){var m=!1;h.on("click",".js-deals-export",function(p){p.preventDefault();m||(m=!0,p=f(),d.post(d.crm.app_url+"?module=deal&action=export",{ids:p},function(q){new CRMDialog({html:q})}).always(function(){m=!1}))})})();(function(){var m=!1;h.on("click",".js-deals-set-tags",function(p){p.preventDefault();
if(!m){m=!0;p=f();var q=d.crm.app_url+"?module=dealOperation&action=assignTags",r={deal_ids:p};1===p.length&&(r.is_assign=1);d.post(q,r,function(u){new CRMDialog({html:u})}).always(function(){m=!1})}})})()};return CRMDealsList}(jQuery),CRMDealsMergePage=function(d){CRMDealsMergePage=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$submitButton=this.$wrapper.find(".js-submit-button");this.$activeDeal=this.is_deal_set=!1;this.initClass()};CRMDealsMergePage.prototype.initClass=
function(){this.initSubmit();this.initSelectDeal()};CRMDealsMergePage.prototype.initSubmit=function(){function a(){function e(g){var k="";d.each(g,function(l,h){if("master_id"===h.name)return k=h.value,!1});return k}if(!c){c=!0;var f=b.serializeArray();d.post("?module=deal&action=mergeRun",f,function(g){g=d.crm.app_url+"deal/"+e(f)+"/";var k=(new URLSearchParams(document.location.search)).get("iframe");window.parent&&k?window.parent.location=g:d.crm.content.load(g)},"json").always(function(){c=!1})}}
...
k)}var b=this,c=b.$wrapper.find(".js-funnels-list"),e=c.find(".js-visible-link"),f=c.find(".js-field"),g=c.find(".menu-v");g.on("click","a",function(){var k=d(this);e.find(".js-text").html(k.html());g.find(".selected").removeClass("selected");k.closest("li").addClass("selected");g.hide();setTimeout(function(){g.removeAttr("style")},200);k=k.data("id");f.val(k).trigger("change");a(k)})};CRMDealsChangeFunnelDialog.prototype.initChangeStage=function(){function a(l){k.html("");d.each(l,function(h,n){h=
b.stage_template_html;var m=d("<div />").text(n.name).html();h=h.replace("%id%",n.id).replace("%color%",n.color).replace("%name%",m);n=d(h);k.append(n)});d.crm.renderSVG(e);k.find("li:first-child a").trigger("click")}var b=this,c=b.$wrapper.find(".js-funnels-list"),e=b.$wrapper.find(".js-funnel-stages-list"),f=e.find(".js-visible-link"),g=e.find(".js-field"),k=e.find(".menu-v");k.on("click","a",function(){var l=d(this);f.find(".js-text").html(l.html());k.find(".selected").removeClass("selected");
...
function(){e.changeTableRow(d(this))});e.$table.on("change",".js-price-field",function(){var f=d(this).closest("tr").find(".js-amount-field");f.val()||f.val("1");e.changeTableRow(d(this))});e.$table.on("click",".js-set-product-tax",function(){var f=d(this),g=f.closest(".js-tax-dropdown"),k=g.find(".js-product-tax-percent"),l=g.find(".js-product-tax-type");f=parseInt(f.data("tax-index"));if(f=e.active_tax_array[f])parseInt(e.tax_percent)===parseInt(f.tax_percent)&&e.tax_type===f.tax_type?g.removeClass(e.tax_set_class):
g.addClass(e.tax_set_class),g=e.tax_type,"NONE"===f.tax_type&&(g="NONE"),l.val(g).trigger("change"),l=f.tax_percent+"%","NONE"===f.tax_type&&(l=e.companies[e.$companyField.val()],l=e.locales.no_tax.replace("%name",l.tax_name)),k.val(l).trigger("change"),e.refreshTable()});d(document).on("click",c)};CRMInvoiceEdit.prototype.addTableRow=function(c){var e=d(this.row_template_html);e.find(".js-product-number").text(c);this.renderProductTaxOptions(e);this.$tableBody.append(e);this.renderProductTaxFields();
this.shop_supported&&this.$wrapper.trigger("addProduct",e)};CRMInvoiceEdit.prototype.removeTableRow=function(c){c.remove();this.$tableBody.find("tr").each(function(e){d(this).find(".js-product-number").text(e+1)});this.refreshTable()};CRMInvoiceEdit.prototype.changeTableRow=function(c){var e=this.locale,f="price"===c.data("type"),g=c.val(),k=0;g&&g.length&&(g=g.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(g)&&(k=parseFloat(g)));c.val(f?a(k,e):k);this.refreshTable()};CRMInvoiceEdit.prototype.refreshTable=
function(){var c=this,e=function(){var l=[];c.$tableBody.find("tr").each(function(){var h=d(this),n=h.find(".js-amount-field"),m=h.find(".js-price-field"),p=h.find(".js-product-total"),q=h.find(".js-product-tax-percent");n=b(n.val());m=b(m.val());var r=0;0<n&&0<m&&(r=m*n);p.text(a(r,c.locale));(p=parseInt(q.val()))&&(0<p||0===p)||(p=0);l.push({$tr:h,percent:p,amount:n,price:m,total:r})});return l}(),f=c.tax_type&&"INCLUDE"===c.tax_type,g=0,k=0;d.each(e,function(l,h){g+=h.total;l=h.percent/100;k+=
f?l/(1+l)*h.total:h.total*l});c.$table.find(".js-subtotal").text(a(g,c.locale));c.$table.find(".js-tax").text(a(k,c.locale));c.$table.find(".js-total").text(a(g+(f?0:k),c.locale))};CRMInvoiceEdit.prototype.renderProductTaxOptions=function(c){var e=this,f=!1,g;f=c&&c.length?c.find(".js-tax-dropdown"):e.$tableBody.find(".js-tax-dropdown");var k=f.find(".js-hidden-list").html(""),l=e.companies[e.$companyField.val()],h=[];d.each(e.active_tax_array,function(n,m){g="NONE"===m.tax_type?e.locales.no_tax.replace("%name",
l.tax_name):m.tax_percent+"%";0>h.indexOf(g)&&(h.push(g),k.append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><div class="js-set-product-tax" data-tax-index="'+n+'">'+g+"</div></div></li>"))})};CRMInvoiceEdit.prototype.renderProductTaxFields=function(c){var e=this,f=e.$tableBody.find(".js-tax-dropdown");c&&f.removeClass(e.tax_set_class);f.each(function(){var g=d(this),k=g.find(".js-product-tax-percent"),l=g.find(".js-product-tax-type");g.hasClass(e.tax_set_class)&&
"NONE"!==e.tax_type||(l.val(e.tax_type).trigger("change"),l=e.tax_percent+"%","NONE"===e.tax_type&&(l="\u2014",g.removeClass(e.tax_set_class)),k.val(l).trigger("change"))})};CRMInvoiceEdit.prototype.initSubmit=function(){function c(){var h={data:[],errors:[]},n=k.serializeArray();d.each(n,function(m,p){"invoice[contact]"!==p.name&&h.data.push(p);"invoice[contact_id]"===p.name&&(0<p.value||h.errors.push({name:"invoice[contact_id]",value:g.locales.empty_contact}))});(function(m){g.$tableBody.find("tr").each(function(p){var q=
d(this),r=q.find(".js-product-field"),u=q.find(".js-amount-field"),t=q.find(".js-price-field"),v=q.find(".js-product-tax-percent"),w=q.find(".js-product-tax-type");q=q.find(".js-name-field");u=b(u.val());t=b(t.val());v=parseInt(v.val());w=w.val();r=r.val();q=q.val();if(u||t||q)m.push({name:"items["+p+"][name]",value:q}),m.push({name:"items["+p+"][price]",value:t}),m.push({name:"items["+p+"][quantity]",value:u}),m.push({name:"items["+p+"][tax_percent]",value:0<v||0===v?v:""}),m.push({name:"items["+
p+"][tax_type]",value:w});r&&m.push({name:"items["+p+"][product_id]",value:r})})})(h.data);return h}function e(h,n){n=n?n:[];if(h){var m=Object.keys(h);d.each(m,function(p,q){n.push({name:q,value:h[q]})})}d.each(n,function(p,q){p=q.value;var r=g.$form.find('[name="'+q.name+'"]');if(r.length&&!r.hasClass("state-error")){var u=d("<span />").addClass("state-error-hint").text(p);u.insertAfter(r);r.addClass("state-error").one("focus click change",function(){r.removeClass("state-error");u.remove()})}})}
function f(h,n){if(!l){l=!0;var m=d.crm.app_url+"?module=invoice&action=save",p=spinnerView(n);p.show();d.post(m,h,function(q){if("ok"===q.status){if(q.data.id){d(document).trigger("unsavedChanges",!1);q=d.crm.app_url+"invoice/"+q.data.id+"/";var r=getIframeIfExists();r?(window.parent.iframe_invoice_is_saved=!0,r.src=q+"?iframe=1"):d.crm.content.load(q)}}else p.hide(),e(q.errors)},"json").always(function(){l=!1})}}var g=this,k=g.$form,l=!1;k.on("submit",function(h){h.preventDefault();h=c();h.errors.length?
e(!1,h.errors):f(h.data,k.find(".js-submit-button"))})};CRMInvoiceEdit.prototype.initDatePickers=function(){var c=this,e=c.$wrapper.find(".js-invoice-datepicker"),f=c.$wrapper.find(".js-invoice-due-datepicker"),g=c.$wrapper.find(".js-due-days-field"),k=c.$wrapper.find(".js-clear-due-date");(function(){var l=e.parent().find("input[type='hidden']");e.datepicker({altField:l,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});c.invoice_id||e.datepicker("setDate","+0d")})();(function(){var l=f.parent().find("input[type='hidden']");
f.datepicker({altField:l,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});f.on("change",function(){var h=d(this).val();d.trim(h).length?k.show():(l.val(""),k.hide())})})();c.$wrapper.on("click",".js-focus-on-field",function(){d(this).parent().find(".js-invoice-due-datepicker").trigger("focus")});g.on("change",function(){var l=g.val(),h=0;l&&l.length&&0<parseInt(l)&&(h=parseInt(l),g.val(h));0<h?k.show():k.hide();g.val(h);l=h;h=e.datepicker("getDate");l=new Date(h.getTime()+864E5*l);f.datepicker("setDate",
l)});e.on("change",function(){var l=g.val();l&&l.length&&0<parseInt(l)&&g.trigger("change")});f.on("change",function(){g.val("")});k.on("click",function(){f.val("").trigger("change")})};CRMInvoiceEdit.prototype.initChangeContact=function(){var c=this.$wrapper.find(".js-contact-toggle"),e=c.find(".js-name"),f=c.find(".js-contact-id"),g=!1;c.on("click",".js-change-contact",function(k){k.preventDefault();var l=d(this);d.get(d.crm.app_url+"?module=invoice&action=contactAdd",function(h){d.waDialog({html:h,
options:{onAdd:function(n,m){f.val(n).trigger("change");e.text(m);g||(n=l.find(".js-label"),m=n.data("change-text"),n.html('<span class="c-dotted">'+m+"</span>"),g=!0)}}})})})};CRMInvoiceEdit.prototype.initChangeCompany=function(){function c(k,l,h){k&&k.length&&(e.active_tax_array=k);g.find("option").remove();e.$taxHeader.text(l.length?l:"\u2014");k&&l?(e.$emptyTax.hide(),e.$tax.parent().show(),d.each(k,function(n,m){n=d('<option value="'+n+'"></option>');if("INCLUDE"===m.tax_type){n.data("type",
"INCLUDE");var p=e.locales.include_tax}else"APPEND"===m.tax_type?(n.data("type","APPEND"),p=e.locales.append_tax):"NONE"===m.tax_type&&(n.data("type","NONE"),m.tax_percent=0,p=e.locales.no_tax);0<m.tax_percent?(n.data("percent",m.tax_percent),p=p.replace("%value",m.tax_percent+"%")):(n.data("percent",0),p=p.replace("%value",""));if(p=p.replace("%name",l)){if(e.tax){var q=l===e.tax.name,r=m.tax_type===e.tax.type;m=(+m.tax_percent).toFixed(2)===(+e.tax.percent).toFixed(2);q&&r&&m&&n.attr("selected",
!0)}n.text(p);n.data("name",l);g.append(n)}})):(e.$tax.parent().hide(),e.$emptyTax.show(),k=e.$emptyTaxLink.data("href"),e.$emptyTaxLink.attr("href",k+e.$companyField.val().toString()+"/"));g.trigger("change",!h)}var e=this,f=e.$companyField,g=e.$tax;f.on("change",function(k,l){k=d(this).val();var h=e.companies[k];e.active_tax_array=[];h&&(k=h.tax_name||e.locales.tax,h=JSON.parse(h.tax_options),c(h,k,l))});f.trigger("change",!0)};CRMInvoiceEdit.prototype.initChangeTax=function(){var c=this;c.$tax.on("change",
function(e,f){e=d(this).find("option");c.tax_percent=0;c.tax_type="NONE";c.tax_name="";e.length&&(e=e[this.selectedIndex],c.tax_percent=d(e).data("percent")||0,c.tax_type=d(e).data("type"),c.tax_name=d(e).data("name"));c.$taxPercent.val(c.tax_percent);c.$taxType.val(c.tax_type);c.$taxName.val(c.tax_name);c.renderProductTaxOptions();c.renderProductTaxFields(f);c.refreshTable()})};CRMInvoiceEdit.prototype.initWYSIWYG=function(){var c=this.$wrapper.find(".js-wysiwyg");d.crm.initWYSIWYG(c,{keydownCallback:function(e){}})};
CRMInvoiceEdit.prototype.initProductName=function(){function c(g){function k(x){w&&w.abort();var y=d.crm.backend_url+"shop/?action=autocomplete&with_counts=1";x={term:x};h("loading");w=d.get(y,x,function(A){A.length?(r.html(""),d.each(A,function(B,E){B=d("<div />");B.html(E.label).data("product",E).addClass("js-set-product");h(B)})):e.$wrapper.trigger("searchProduct")},"json").always(function(){w=!1})}function l(x){w&&w.abort();h("loading");var y=e.$currencyField.val();w=d.get(d.crm.backend_url+"shop/?module=orders&action=getProduct",
{product_id:x.id,currency:y},function(A){"ok"===A.status?(r.html(""),d.each(A.data.sku_ids,function(B,E){B=d("<div />");E=A.data.product.skus[E];B.text(A.data.product.name+(E.name.length?" ("+E.name+")":"")).data("product",A.data.product).data("sku",E).addClass("js-set-sku");h(B);1===A.data.sku_ids.length&&B.trigger("click")})):e.$wrapper.trigger("searchProduct")},"json").always(function(){w=!1})}function h(x){if("loading"===x)r.html("").append('<li class="ui-menu-item-html ui-menu-item"><div class="ui-menu-item-wrapper"><i class="fas fa-spinner wa-animation-spin"></i></div></li>');
else{var y=d("<li />").addClass("ui-menu-item-html ui-menu-item");d("<div />").addClass("ui-menu-item-wrapper").append(x).appendTo(y);y.appendTo(r)}}function n(){g.removeClass("is-active");r.html("");t=!1}function m(x){var y=r.find("li"),A=y.filter(".is-highlighted");if(!y.length)return!1;A.length&&1<y.length?(A.removeClass("is-highlighted"),x?(x=A.next(),x.length||(x=y.first())):(x=A.prev(),x.length||(x=y.last()))):x=y.first();x.addClass("is-highlighted")}function p(){var x=r.find("li.is-highlighted");
x.length&&x.find(".ui-menu-item-wrapper > *").first().trigger("click")}var q=g.find(".js-name-field"),r=g.find(".js-hidden-list"),u=g.find(".js-product-field"),t=!1,v=0,w=!1;q.on("keyup",function(x){x=x.keyCode;if(0<=[13,27,37,38,39,40].indexOf(x))switch(x){case 13:p();break;case 27:n();q.trigger("blur");break;case 38:m(!1);break;case 40:m(!0)}else{var y=d(this).val();1<y.length?(t||(e.$wrapper.trigger("searchProduct"),g.addClass("is-active"),t=!0),clearTimeout(v),v=setTimeout(function(){k(y)},500)):
e.$wrapper.trigger("searchProduct")}});q.on("change",function(){u.val("").trigger("change")});e.$wrapper.on("searchProduct",n);r.on("click",".js-set-product",function(){var x=d(this).data("product");x&&l(x)});r.on("click",".js-set-sku",function(){var x=d(this),y=x.data("product");x=x.data("sku")||!1;if(y){var A="shop:"+y.id+(x?":"+x.id:""),B=x.price;q.val(y.name+(x.name.length?" ("+x.name+")":"")).trigger("change");g.closest("tr").find(".js-price-field").val(B).trigger("change");u.val(A).trigger("change")}n();
q.trigger("blur")})}var e=this,f=e.$wrapper.find(".js-name-autocomplete");f.length&&(f.each(function(){c(d(this))}),e.refreshTable());e.$wrapper.on("addProduct",function(g,k){g=d(k).find(".js-name-autocomplete");g.length&&c(g)})};CRMInvoiceEdit.prototype.initChangeCurrency=function(){function c(g,k){e.$tableBody.find(".js-price-field").each(function(){var l=d(this),h=l.val(),n=0;h&&h.length&&(h=h.replace(/,/g,".").replace(/\s/g,""),0<parseFloat(h)&&(n=parseFloat(h)),l.val(n*e.currencies[k].rate/e.currencies[g].rate).trigger("change"))})}
var e=this,f=e.$currencyField.val();e.$currencyField.on("change",function(){var g=e.$currencyField.val(),k=!1;e.$tableBody.find(".js-price-field").each(function(){if(d(this).val().length)return k=!0,!1});k?(e.$currencyField.val(f),d.waDialog({html:e.confirm_dialog_template,options:{changeCurrencyWithPrice:function(){e.$currencyField.val(g);c(g,f);f=g},changeCurrency:function(){e.$currencyField.val(g);f=g}}})):f=g})};CRMInvoiceEdit.prototype.initToggleButton=function(){var c=this.$wrapper.find(".js-footer-actions"),
e=c.find(".js-submit-button");this.$wrapper.on("change keydown","input, textarea, select",function(){e.removeClass("green").addClass("yellow");c.addClass("is-changed");d(document).trigger("unsavedChanges",!0)})};return CRMInvoiceEdit}(jQuery),CRMInvoiceContactAdd=function(d){CRMInvoiceContactAdd=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.locales=a.locales;this.initClass()};CRMInvoiceContactAdd.prototype.initClass=function(){function a(){var g=
e.$form.serializeArray(),k={data:[],errors:[]},l=!1,h=!1;d.each(g,function(n,m){n=m.name;var p=m.value;"deal[contact_id]"===n&&p&&(l=!0);"contact[firstname]"===n&&p&&(h=!0);"contact[lastname]"===n&&p&&(h=!0);"contact[middlename]"===n&&p&&(h=!0);"contact[name]"===n&&p&&(h=!0);k.data.push(m)});l||h||(k.errors.push({name:"contact[name]",value:e.locales.empty_name}),k.errors.push({name:"contact[firstname]",value:e.locales.empty_name}));return k}function b(g){d.post("?module=invoice&action=contactAddSave",
g,function(k){"ok"===k.status?(e.dialog.options.onAdd(k.data.id,k.data.name),e.dialog.close()):c(k.errors)},"json").always(function(){f=!1})}function c(g,k){k=k?k:[];if(g){var l=Object.keys(g);d.each(l,function(h,n){k.push({name:n,value:g[n]})})}d.each(k,function(h,n){h=n.name;n=n.value;"name"===h&&(h="contact[firstname]");var m=e.$form.find('[name="'+h+'"]');"contact[firstname]"!==h||m.is(":visible")||(m=e.$form.find(".js-contact-autocomplete"));if(m.length&&!m.hasClass("state-error")){var p=d("<div />").addClass("state-error-hint").text(n);
p.insertAfter(m);m.addClass("state-error").one("focus click",function(){m.removeClass("state-error");p.remove()});d(document).on("toggleChanged",function(){m.removeClass("state-error");p.remove()})}})}var e=this,f=!1;e.$form.on("submit",function(g){g.preventDefault();g=e.$wrapper.find(".js-contact-id-field").val();if(g){var k=e.$wrapper.find(".js-contact-autocomplete").val();e.dialog.options.onAdd(g,k);e.dialog.close()}else f||(f=!0,g=a(),g.errors.length?(c(!1,g.errors),f=!1):b(g.data))})};return CRMInvoiceContactAdd}(jQuery),
CRMInvoicePage=function(d){function a(b,c){if(!b)return!1;b=d('.js-invoices-list .c-invoice[data-id="'+b+'"]');b.length&&(c?b.replaceWith(c):b.remove())}CRMInvoicePage=function(b){this.$wrapper=b.$wrapper;this.invoice_id=b.invoice_id;this.locales=b.locales;this.initClass()};CRMInvoicePage.prototype.initClass=function(){var b=this;b.initChangeState();b.initDelete();b.initRefund();b.initRestore();setTimeout(function(){d(document).trigger("viewInvoice",b.invoice_id)},100);b.$wrapper.data("page",b);d(".js-action-link").one("click",
function(){spinnerView(d(this)).show()})};CRMInvoicePage.prototype.initChangeState=function(){function b(g,k){if(!f){f=!0;var l={invoice_id:e,action:g},h=spinnerView(k);h.show();d.post("?module=invoice&action=handleTransaction",l,function(n){if("ok"===n.status){var m=getIframeIfExists();m?(window.parent.iframe_invoice_is_saved=!0,m.contentWindow.location.reload()):(a(c.invoice_id,"delete"===g?"":n.data.html),c.load(d.crm.app_url+"invoice/"+c.invoice_id+"/"))}else alert(n.errors)},"json").always(function(){h.hide();
f=!1})}}var c=this,e=c.invoice_id,f=!1;c.$wrapper.on("click",".js-change-state",function(g){g.preventDefault();(g=d(this).data("action"))&&b(g,d(this))})};CRMInvoicePage.prototype.initDelete=function(){function b(f){if(!e){e=!0;var g={invoice_id:c.invoice_id,action:"delete"},k=spinnerView(f.$body.find(".js-success-action"));k.show();d.post("?module=invoice&action=handleTransaction",g,function(l){if("ok"===l.status){l=d.crm.app_url+"invoice/";var h=getIframeIfExists();h?h.dispatchEvent(new CustomEvent("close",
...
!0;var g=d.crm.app_url+"?module=invoice&action=refundDialog",k={invoice_id:c.invoice_id},l=spinnerView(f);l.show();d.post(g,k,function(h){d.waDialog({html:h,options:{onRefund:function(n){var m=getIframeIfExists();m?(window.parent.iframe_invoice_is_saved=!0,m.contentWindow.location.reload()):(a(c.invoice_id,n.html),c.reload())}}})}).always(function(){l.hide();e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-change-refund",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.initRestore=
function(){function b(f){if(!e){e=!0;var g={id:c.invoice_id},k=spinnerView(f);k.show();d.post("?module=invoiceRestore",g,function(l){if("ok"===l.status){var h=getIframeIfExists();h?(window.parent.iframe_invoice_is_saved=!0,h.contentWindow.location.reload()):(a(c.invoice_id,l.data.html),c.reload())}else k.hide(),alert(l.errors)},"json").always(function(){e=!1})}}var c=this,e=!1;c.$wrapper.on("click",".js-restore-invoice",function(f){f.preventDefault();b(d(this))})};CRMInvoicePage.prototype.load=function(b){b=
d("<a />").addClass("js-disable-router").attr("href",b).hide();this.$wrapper.append(b);b.trigger("click")};CRMInvoicePage.prototype.reload=function(){this.load(location.href)};return CRMInvoicePage}(jQuery),CRMInvoiceRefundDialog=function(d){CRMInvoiceRefundDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMInvoiceRefundDialog.prototype.initClass=function(){this.initSubmit()};CRMInvoiceRefundDialog.prototype.initSubmit=
function(){function a(){var g={data:[],errors:[]},k=e.serializeArray();d.each(k,function(l,h){g.data.push(h)});return g}function b(g,k){if(!f){f=!0;var l=d.crm.app_url+"?module=invoice&action=handleTransaction",h=spinnerView(k);h.show();d.post(l,g,function(n){"ok"===n.status?(c.dialog.options.onRefund(n.data),c.dialog.close()):console.log(n.errors)},"json").always(function(){h.hide();f=!1})}}var c=this,e=c.$form,f=!1;e.on("submit",function(g){g.preventDefault();g=a();g.errors.length?console.log(g.errors):
b(g.data,e.find('[type="submit"]'))})};return CRMInvoiceRefundDialog}(jQuery);function getIframeIfExists(){return(new URLSearchParams(document.location.search)).get("iframe")&&window.parent?window.parent.document.getElementById("iframe-invoice"):null}
function spinnerView(d){var a=$('<span class="icon size-16 custom-mr-8 js-loading"><i class="fas fa-spinner wa-animation-spin"></i></span>'),b=d.find(".icon:not(.js-loading)");return{show:function(){b&&b.hide();d.prepend(a).prop("disabled",!0)},hide:function(){d.removeAttr("disabled");d.find(".js-loading").remove();b&&b.show()}}};var CRMInvoices=function(d){function a(){var b=!1,c=d("#c-invoice-page");c.length&&(c=c.data("id"))&&(b=c);return b}CRMInvoices=function(b){this.$wrapper=b.$wrapper;this.$content=this.$wrapper.find("#js-inner-content");this.$sidebar=this.$wrapper.find("#js-aside-block");this.$invoiceList=this.$sidebar.find(".js-invoices-list");this.initClass()};CRMInvoices.prototype.initClass=function(){this.showOnlyDesktopClass="desktop-and-tablet-only";this.patternsBeginContent=[".+\\d+\\/",".+new\\/"];this.initWaLoading();
...
this;d(document).on("click",".js-invoice-hide-mobile",function(){b.hideContentMobile()});for(var c=window.location.pathname,e=$jscomp.makeIterator(this.patternsBeginContent),f=e.next();!f.done;f=e.next())if((new RegExp(f.value,"g")).test(c)){this.showContentMobile();break}};CRMInvoices.prototype.filtersDropdown=function(){d(".dropdown",this.$sidebar).waDropdown({hover:!1,items:".menu > li > a",change:function(b){if("touchend"!==b.type)return!1;b=d(b.target).closest("a");if(!b.length)return!1;if(b=
b.attr("href"))window.location=b}})};CRMInvoices.prototype.initWaLoading=function(){var b=d.waLoading(),c=d(document);c.on("wa_before_load.invoices",function(){b.show();b.animate(1E4,100,!1);c.addClass("is-locked")}).on("wa_loading.invoices",function(e,f){b.set(f.loaded/f.total*100)}).on("wa_abort.invoices",function(){b.abort();c.removeClass("is-locked")}).on("wa_loaded.invoices",function(){b.done();c.removeClass("is-locked")});d("#c-invoices-page").one("remove",function(){c.off(".invoices");b.$bar.remove();
b.$wrapper.remove();c.removeClass("is-locked")})};CRMInvoices.prototype.initContentRouter=function(){function b(l){k&&k.abort();d(document).trigger("wa_before_load");return k=d.ajax({method:"GET",url:l,data:{content_only:1},dataType:"html",global:!1,cache:!1,xhr:function(){var h=new window.XMLHttpRequest;h.addEventListener("progress",function(n){d(document).trigger("wa_loading",n)},!1);h.addEventListener("abort",function(n){d(document).trigger("wa_abort")},!1);return h}}).always(function(){c.xhr=
!1}).done(function(h){g&&history.pushState({reload:!0,content_uri:l},"",l);d(document).trigger("wa_before_render");e.html(h);d(document).trigger("wa_loaded")}).fail(function(h){d(document).trigger("wa_abort");h.responseText&&d.waDialog.alert({title:"Error",text:h.responseText,button_title:"Close"})})}var c=this,e=c.$content.find(".js-inner-content"),f=!1,g=!(!history||!history.pushState),k=!1;c.$wrapper.on("click","a",function(l){var h=d(this),n=h.hasClass("js-disable-router")?h.attr("href"):!1;if(!n)return!0;
l.preventDefault();f?d.waDialog.confirm({title:d.crm.locales.unsaved_dialog_title,text:d.crm.locales.unsaved_dialog_text,success_button_title:d.crm.locales.unsaved_dialog_button,success_button_class:"danger",cancel_button_title:d.crm.locales.cancel,cancel_button_class:"light-gray",onSuccess:function(){d(document).trigger("unsavedChanges",!1);b(n)}}):b(n).then(function(){c.$content.is(":hidden")&&c.showContentMobile()})});d(document).on("unsavedChanges",function(l,h){f=!!h})};CRMInvoices.prototype.initLazy=
function(){function b(){if(!g){var k={offset:f.data("offset")},l=a();l&&(k.invoice_id=l);g=!0;d.post("?module=invoice&action=sidebar",k,function(h){var n=d(h);h=n.find(".js-lazyload");n=n.find(".c-invoice");e.unobserve(f[0]);h.length?(h.insertAfter(f),f.remove(),f=h,e.observe(f[0])):f.remove();c.append(n)}).always(function(){g=!1})}}var c=this.$invoiceList,e=null,f=this.$wrapper.find(".js-lazyload"),g=!1;this.$invoiceList.on("touchstart",function(){d("body").css({overflow:"hidden"});d(this).closest(".sidebar-body").css({overflow:"overlay"});
setTimeout(function(){d("body").css({overflow:"auto"})})});f.length&&function(){e=new IntersectionObserver(function(k){0>=k[0].intersectionRatio||b()});e.observe(f[0])}()};CRMInvoices.prototype.initInvoiceList=function(){function b(f){c.$invoiceList.find(".c-invoice").each(function(){var g=d(this),k=g.data("id");f==k&&(g.addClass("selected"),e=g)})}var c=this,e=c.$invoiceList.find(".c-invoice.selected");d(document).on("viewInvoice",function(f,g){e.length&&e.removeClass("selected");g&&b(g)})};CRMInvoices.prototype.initInvoiceSearch=
...
".js-hide-combobox",function(f){f.stopPropagation();a(!1)});(function(){var f=c.find(".js-autocomplete");f.autocomplete({appendTo:c,position:{my:"right top",at:"right bottom"},source:b.app_url+"?module=autocomplete&type=user",minLength:0,html:!0,focus:function(){return!1},select:function(g,k){b.setContact(k.item);a(!1);f.val("");b.form_is_change=!0;return!1}}).data("ui-autocomplete")._renderItem=function(g,k){return d("<li />").addClass("ui-menu-item-html").append("<div>"+k.value+"</div>").appendTo(g)};
f.on("focus",function(){f.data("uiAutocomplete").search(f.val())})})();b.setContact=function(f){var g=c.find(".js-user");f.photo_url&&g.find(".icon").css("background-image","url("+f.photo_url+")").html("");g.find(".c-name").text(f.name);e.val(f.id)}};CRMReminderFormEdit.prototype.initSearchDeal=function(){var a=this,b=a.$form.find(".c-deal-wrapper"),c=a.$form.find('[name="data[deal_id]"]'),e=a.$form.find('[name="data[contact_id]"]'),f=b.find(".c-search-contact-wrapper"),g=b.find(".c-deal-item"),k=
b.find(".js-autocomplete-deal");k.autocomplete({appendTo:f,position:{my:"right top",at:"right bottom"},source:a.app_url+"?module=autocompleteSidebar",minLength:0,html:!0,focus:function(l,h){return!1},select:function(l,h){a.setDeal(h.item);k.val("");f.find(".ui-autocomplete").hide();a.form_is_change=!0;c.trigger("click");return!1}}).data("ui-autocomplete")._renderItem=function(l,h){return d("<li />").addClass("ui-menu-item-html").append("<div>"+h.value+"</div>").appendTo(l)};b.on("click",function(l){l.preventDefault();
l=d(l.target);f.is(":visible")?l.closest(".js-reset-deal").length&&a.clearDeal():l.closest(".js-open-search").length&&(f.addClass("is-shown"),k.focus())});a.clearDeal=function(){g.html("");f.removeClass("is-hidden is-shown");e.val("");c.val("");a.form_is_change=!0;c.trigger("click");a.tempFormData.contact.id="";a.tempFormData.contact.name="";a.tempFormData.contact.photo_url=""};k.on("focus",function(){k.data("uiAutocomplete").search(k.val())});a.setDeal=function(l,h){h=void 0===h?!1:h;var n=a.app_url+
(l.photo_url?"contact/":"deal/")+l.id;n='<a class="flexbox middle c-user" href="'+(h?n:"javascript:void(0);")+'">\n            '+(l.photo_url?'<span class="icon size-18 rounded js-open-search" style="background-image: url('+l.photo_url+');"></span>':"")+'\n            <span class="c-user-name">&nbsp;'+l.name+"</span>\n            </a>\n            "+(h?"":'<div class="hint custom-pl-12 js-open-search cursor-pointer">\n                <span class="icon size-14"><i class="fas fa-pen" title="[`edit`]"></i></span>\n            </div>');
if(h)return n;f.addClass("is-hidden").removeClass("is-shown");g.html(n);l.photo_url?(e.val(l.id),c.val(""),a.tempFormData.contact.photo_url=l.photo_url):(c.val(l.id),e.val(""),a.tempFormData.contact.photo_url="");a.tempFormData.contact.id=l.id;a.tempFormData.contact.name=l.name}};CRMReminderFormEdit.prototype.initTextArea=function(){var a=this,b=a.$wrapper.find(".js-textarea");a.$textField=a.$main_wrapper.find(".js-float-text");b.css("min-height",a.$textField.height()+"px");b.on("input",function(){b.css("min-height",
0);b.css("min-height",b[0].scrollHeight+"px")});b.on("focusout",function(){a.form_is_change=!0});b.on("keydown",function(c){13!==c.keyCode||c.shiftKey||(c.preventDefault(),c.stopPropagation(),a.$form.trigger("submit"))})};CRMReminderFormEdit.prototype.initDatePicker=function(){var a=this;a.$form.find(".js-datepicker").each(function(){var b=d(this);0<this.value.length&&(this.style.width=7*this.value.length+"px");b.datepicker({changeMonth:!0,changeYear:!0,showOtherMonths:!0,selectOtherMonths:!0,gotoCurrent:!0});
var c=b.parent(),e=c.find(".calendar"),f=c.find(".js-reset-date");e.on("click",function(){b.focus()});a.reminder_id||b.datepicker("setDate","+1d");b.on("change",function(){this.style.width=0<this.value.length?7*this.value.length+"px":8*(this.getAttribute("placeholder").length+1)+"px";""!==b.val()&&c.addClass("is-active");a.form_is_change=!0;c.trigger("click")});f.on("click",function(){b.val("");b.trigger("change");c.removeClass("is-active")})})};CRMReminderFormEdit.prototype.initTimeToggle=function(){function a(f){f?
c.addClass("is-active"):c.removeClass("is-active")}var b=this,c=b.$form.find(".js-time-toggle"),e=c.find(".js-timepicker");e.on("change",function(){a(!0);""==e.val()&&a();b.form_is_change=!0});c.on("click",".js-show-time",function(){e.focus()});c.on("click",".js-reset-time",function(){e.val("");a();b.form_is_change=!0})};CRMReminderFormEdit.prototype.initTimePicker=function(){this.$form.find(".js-timepicker").each(function(){d(this).timepicker()})};CRMReminderFormEdit.prototype.initClickWatcher=function(){var a=
this,b=a.$main_wrapper,c=a.$wrapper;b.on("editOpen",function(){d(".c-reminder-wrapper.highlighted").removeClass("highlighted");a.is_first_click&&(a.initCombobox(),a.initSearchDeal(),a.is_first_click=!1);d(document).on("click",a.editClickWatcher);b.on("escKeyPress",a.$clear)});a.close_edit=function(){b.trigger("reminderNotChanged");a.form_is_change=!1;d(document).off("click",a.editClickWatcher);b.off("escKeyPress",a.$clear)};a.editClickWatcher=function(e){if(d.contains(document,c[0])){var f=d(e.target);
if(c.is(":visible")){e=d.contains(b[0],e.target);var g=!!f.closest(".js-edit-reminder").length,k=!!f.closest(".ui-timepicker-wrapper").length,l=!!f.closest(".ui-datepicker").length||!!f.closest(".ui-corner-all").length,h=c.find(".js-contact-wrapper").hasClass("is-shown"),n=!!f.closest(".js-contact-wrapper").length,m=c.find(".c-search-contact-wrapper").hasClass("is-shown");f=!!f.closest(".c-deal-wrapper").length;e||k||l||(a.checkFormChange()?a.close_edit():g&&a.close_edit());h&&!n&&c.find(".js-contact-wrapper").removeClass("is-shown");
m&&!f&&c.find(".c-search-contact-wrapper").removeClass("is-shown")}}else d(document).off("click",a.editClickWatcher),b.off("escKeyPress",a.$clear)}};CRMReminderFormEdit.prototype.initTypeToggle=function(){var a=this,b=a.$wrapper.find(".js-reminder-type-toggle"),c=b.find(".js-type-field"),e=b.find(".menu");b.waDropdown();e.on("click","a",function(){var f=d(this);b.find(".js-text").html(f.html());e.find(".selected").removeClass("selected");f.closest("li").addClass("selected");f=f.data("type-id");c.val(f).trigger("change");
a.form_is_change=!0})};CRMReminderFormEdit.prototype.checkFormChange=function(a){var b=this.$form.serialize();if(a){a=this.initialFormData;var c=this.$form.serializeArray(),e={all:!0,date_time:!0};e.all=this.initialFormValues===b;b=c.filter(function(g){return"data[due_date]"===g.name})[0].value;var f=c.filter(function(g){return"data[due_time]"===g.name})[0].value;c=c.filter(function(g){return"data[user_contact_id]"===g.name})[0].value;e.date_time=a.due_date===b&&a.due_time===f&&a.user_contact.id===
c?!0:!1;return e}return this.initialFormValues===b};CRMReminderFormEdit.prototype.initSubmit=function(){function a(){var m={data:[],errors:[]},p=k.serializeArray(),q=!1;type_other=!1;d.each(p,function(r,u){u.value.length&&(m.data.push(u),"data[due_time]"===u.name&&(q=!0),"OTHER"===u.value&&(type_other=!0))});m.data.length<(q?5:type_other?4:3)&&m.errors.push({name:"content",value:f.locales.at_least});type_other&&(p=m.data.filter(function(r){return"data[content]"===r.name}),p.length&&/\S/.test(p[0].value)||
m.errors.push({name:"content",value:f.locales.empty}));return m}function b(m,p){p=p?p:[];if(m){var q=Object.keys(m);d.each(q,function(r,u){p.push({name:u,value:m[u]})})}d.each(p,function(r,u){r=u.value;var t=k.find('[name="data['+u.name+']"');if(!t.hasClass("error")){var v=d("<span />").addClass("errormsg").text(r);h.find(".flexbox.vertical.width-100").append(v);t.addClass("error").one("focus click change clear_error",function(){t.removeClass("error");v.remove()});$has_errors=!0}})}function c(m,p){if(!g){g=
!0;var q=f.app_url+"?module=reminder&action=save",r=d("<span/>").addClass("icon").append("<i/>").addClass("fas fa-spinner wa-animation-spin");h.find(".c-actions-button.js-save").append(r);d.post(q,m,function(u){"ok"===u.status?(p?(l.trigger("reminderIsChanged"),d(document).off("click",f.editClickWatcher),l.off("escKeyPress",f.$clear)):e(m),f.initialFormValues=f.$form.serialize(),f.form_is_change=!1):(b(u.errors),r.remove())},"json").always(function(){g=!1})}}function e(m){var p=m.filter(function(r){return"data[content]"===
r.name});m=m.filter(function(r){return"data[type]"===r.name})[0].value;f.tempFormData.content!==p&&(p.length?(f.tempFormData.content=p[0].value,f.$textField.html((p[0].value+"").replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g,"$1<br />$2"))):(f.tempFormData.content="",f.$textField.html("")));if(f.tempFormData.type!==m){p=f.$wrapper.find(".js-reminder-type-toggle button");var q=f.$main_wrapper.find("button.no-hover");"OTHER"===m?q.remove():q.length?q.html(p.html()):(p='<button class="button button-slim smallest rounded light-gray no-hover">'+
p.html()+"</button>",f.$main_wrapper.find(".is-view .c-footer").prepend(p));f.tempFormData.type=m}f.tempFormData.contact.id!==f.initialFormData.contact.id&&f.tempFormData.contact.name!==f.initialFormData.contact.name&&(m=f.$main_wrapper.find(".is-view .c-deal-wrapper"),""!==f.tempFormData.contact.id?m.html(f.setDeal(f.tempFormData.contact,!0)):m.html(""));f.initialFormData=jQuery.extend(!0,{},f.tempFormData);l.addClass("highlighted");l.trigger("reminderNotChanged");l.trigger("updatePadding")}var f=
this,g=!1,k=f.$form,l=f.$main_wrapper,h=f.$wrapper,n=k.find(".js-save");$cancel_button=k.find(".js-cancel");$has_errors=!1;n.on("click",function(m){m.stopPropagation();f.$form.trigger("submit")});$cancel_button.on("click",function(m){m.stopPropagation();m.preventDefault();f.$clear()});f.$clear=function(){var m=k.find(".js-textarea"),p=k.find(".js-datepicker"),q=k.find(".js-timepicker"),r=k.find(".c-search-contact-wrapper").hasClass("is-hidden"),u=k.find(".js-contact-field");if(!f.checkFormChange()){var t=
f.initialFormData;m.val(t.content);h.find(".menu a[data-type-id='"+t.type+"']").trigger("click");p.val(t.due_date).trigger("change");q.val(t.due_time).trigger("change");t.contact.id?f.setDeal(t.contact):r&&f.clearDeal();u!==t.user_contact.id&&f.setContact(t.user_contact);$has_errors&&(k.find('[name="data[content]"').trigger("clear_error"),$has_errors=!1)}f.close_edit()};k.on("submit",function(m){m.preventDefault();m=f.checkFormChange(!0);m.all?f.close_edit():m.date_time?f.$submit_reminder():f.$submit_reminder(!0)});
f.$submit_reminder=function(m){$has_errors&&(k.find('[name="data[content]"').trigger("clear_error"),$has_errors=!1);var p=a();p.errors.length?b(!1,p.errors):c(p.data,m)}};return CRMReminderFormEdit}(jQuery);var CRMReminders=function(d){CRMReminders=function(a){this.$wrapper=a.$wrapper;this.$sidebar=a.$sidebar;this.$iframe=a.iframe;this.$completedSection=this.$wrapper.find(".c-completed-reminders-section");this.user_id=a.is_all_reminders?"all":a.user_id;this.setting_contact_id=a.setting_contact_id;this.setting_deal_id=a.setting_deal_id;this.current_page=a.current_page;this.assign_to_user=a.assign_to_user;this.locales=a.locales;this.click_reminder_event=!1;this.initClass()};CRMReminders.prototype.initClass=
function(){var a=this;a.initToggleSidebar();a.initAddReminder();a.initLazyLoading();a.initReopenReminder();a.user_id&&a.$completedSection.length&&a.initCompletedReminders();a.initTarget();a.$iframe||(d(window).on("beforeunload",function(b){localStorage.setItem("scrollpos",a.$sidebar.scrollTop())}),a.$sidebar.on("click",".c-user-wrapper",function(){d(document).off("is_completed_loaded_false");a.$wrapper.find(".skeleton-wrapper").show();d("html, body").scrollTop(0);a.click_reminder_event=!0;localStorage.setItem("scrollpos",
a.$sidebar.scrollTop());d(this).find(".js-user-photo").html("").append('<span class="icon user-loader" style="font-size: 24px; color: var(--menu-glyph-color); width: 35px; height: 32px;"><i class="fas fa-spinner fa-spin"></i></span>')}))};CRMReminders.prototype.initToggleSidebar=function(){function a(e,f){0<=f.content_uri.indexOf("/reminder/")&&(b.hasClass("sidebar-opened")&&b.removeClass("sidebar-opened"),b.find(".skeleton-wrapper").show());d(document).off("wa_before_load",a)}var b=this.$wrapper,
c=b.find(".js-expand-sidebar");if(c.length)c.on("click",function(e){e.preventDefault();b.addClass("sidebar-opened")});d(document).on("wa_before_load",a)};CRMReminders.prototype.initToggleSidebar=function(){};CRMReminders.prototype.initAddReminder=function(){function a(){return u===p.serialize()}function b(t){t.stopPropagation();var v=d(t.target),w=d.contains(document,m[0]);t=d.contains(m[0],t.target);var x=!!v.closest(".ui-timepicker-wrapper").length,y=!!v.closest(".ui-datepicker").length||!!v.closest(".ui-corner-all").length,
A=$wrapperContact.hasClass("is-shown");v=!!v.closest(".js-contact-wrapper").length;w?(t||x||y||a()&&c(),A&&!v&&l()):d(document).off("click",b)}function c(){r.slideUp(300);q.blur();m.removeClass(extended_class);wrapper_is_open=!1;d(document).off("click",b)}function e(){a()||(q.val(""),m.find(".menu a[data-type-id='OTHER']").trigger("click"),n.$date_clear.trigger("click"),n.$time_clear.trigger("click"),n.clearDeal(),n.setContact(n.assign_to_user),has_errors&&(p.find('[name="data[content]"').trigger("clear_error"),
has_errors=!1));c()}function f(){var t={data:[],errors:[]},v=p.serializeArray(),w=!1;d.each(v,function(x,y){y.value.length&&(t.data.push(y),"OTHER"===y.value&&(w=!0))});w&&(v=t.data.filter(function(x){return"data[content]"===x.name}),v.length&&/\S/.test(v[0].value)||t.errors.push({name:"content",value:n.locales.empty}));return t}function g(t){t=t?t:[];d.each(t,function(v,w){v=w.value;var x=p.find('[name="data['+w.name+']"');if(!x.hasClass("error")){var y=d("<span />").addClass("errormsg").text(v);
m.find(".flexbox.vertical.width-100").append(y);x.addClass("error").one("focus click change clear_error",function(){x.removeClass("error");y.remove();has_errors=!1});has_errors=!0}})}function k(t){var v=t.find(".js-contact-field"),w=t.find(".c-combobox");t.on("click",".js-show-combobox",function(x){x.stopPropagation();l(!0)});t.on("click",".js-hide-combobox",function(x){x.stopPropagation();l(!1)});(function(){var x=t.find(".js-autocomplete");x.autocomplete({appendTo:w,position:{my:"right top",at:"right bottom"},
source:d.crm.app_url+"?module=autocomplete&type=user",minLength:0,html:!0,focus:function(){return!1},select:function(y,A){n.setContact(A.item);l(!1);x.val("");return!1}}).data("ui-autocomplete")._renderItem=function(y,A){return d("<li />").addClass("ui-menu-item-html").append("<div>"+A.value+"</div>").appendTo(y)};x.on("focus",function(){x.data("uiAutocomplete").search(x.val())})})();n.setContact=function(x){var y=t.find(".js-user");x.photo_url&&y.find(".icon").css("background-image","url("+x.photo_url+
")");y.find(".c-name").text(x.name);v.val(x.id)}}function l(t){t?($wrapperContact.addClass("is-shown"),$wrapperContact.find(".js-autocomplete").focus()):$wrapperContact.removeClass("is-shown")}function h(){var t=p.find(".c-deal-wrapper"),v=p.find('[name="data[deal_id]"]'),w=p.find('[name="data[contact_id]"]'),x=t.find(".c-search-contact-wrapper"),y=t.find(".c-deal-item"),A=t.find(".js-autocomplete-deal");A.autocomplete({appendTo:x,position:{my:"right top",at:"right bottom"},source:d.crm.app_url+"?module=autocompleteSidebar",
minLength:0,html:!0,focus:function(){return!1},select:function(B,E){B=E.item;E='<a class="flexbox middle c-user" href="javascript:void(0);">\n                '+(B.photo_url?'<span class="icon size-18 rounded js-open-search" style="background-image: url('+B.photo_url+');"></span>':"")+'\n                <span class="c-user-name">&nbsp;'+B.name+'</span>\n                </a>\n                <div class="hint custom-pl-12 js-open-search cursor-pointer">\n                    <span class="icon size-14"><i class="fas fa-pen" title="[`edit`]"></i></span>\n                </div>';
x.addClass("is-hidden").removeClass("is-shown");y.html(E);B.photo_url?(w.val(B.id),v.val("")):(v.val(B.id),w.val(""));A.val("");x.find(".ui-autocomplete").hide();return!1}}).data("ui-autocomplete")._renderItem=function(B,E){return d("<li />").addClass("ui-menu-item-html").append("<div>"+E.value+"</div>").appendTo(B)};t.on("click",function(B){B=d(B.target);x.is(":visible")?B.closest(".js-reset-deal").length&&n.clearDeal():B.closest(".js-open-search").length&&(x.addClass("is-shown"),A.focus())});n.clearDeal=
function(){y.html("");x.removeClass("is-hidden is-shown");w.val("");v.val("")}}var n=this,m=n.$wrapper.find("#c-add-reminder-form"),p=m.find("form"),q=m.find(".js-textarea"),r=m.find(".c-hidden-form");$plus_icon=m.find(".c-icon-column");$wrapperContact=m.find(".js-contact-wrapper");extended_class="is-extended";is_locked=wrapper_is_open=!1;has_errors=is_first_click=!0;var u=p.serialize();q.on("focus",function(){r.slideDown(300);m.addClass(extended_class);wrapper_is_open=!0;is_first_click&&(k($wrapperContact),
h(),is_first_click=!1);d(document).on("click",b)});q.on("input",function(){q.css("min-height",0);q.css("min-height",q[0].scrollHeight+"px")});q.on("keydown",function(t){var v=t.keyCode;wrapper_is_open&&13===v&&!t.shiftKey&&(t.preventDefault(),t.stopPropagation(),a()?c():p.trigger("submit"))});$plus_icon.on("click",function(){wrapper_is_open?a()?c():p.trigger("submit"):q.focus()});m.on("click",".js-save",function(t){t.preventDefault();a()?c():p.trigger("submit")});m.on("click",".js-cancel",function(t){t.preventDefault();
e()});d(document).on("keydown",function(t){t.stopPropagation();var v=d(t.target),w=t.keyCode,x=27===w;13!==w||wrapper_is_open||(v=v.hasClass("c-text-field"),d(".c-step.is-edit.is-shown").length||v||(t.preventDefault(),q.focus()));x&&(t.preventDefault(),t.stopPropagation(),e(),d(".c-reminder-wrapper").trigger("escKeyPress"))});(function(t){var v=t.find(".js-reminder-type-toggle"),w=v.find(".js-type-field"),x=v.find(".menu");v.waDropdown();x.on("click","a",function(){var y=d(this);v.find(".js-text").html(y.html());
x.find(".selected").removeClass("selected");y.closest("li").addClass("selected");y=y.data("type-id");w.val(y)})})(m);(function(){m.find(".js-datepicker").each(function(){var t=d(this);t.datepicker({changeMonth:!0,changeYear:!0,showOtherMonths:!0,selectOtherMonths:!0,gotoCurrent:!0});var v=t.parent(),w=v.find(".calendar");n.$date_clear=v.find(".js-reset-date");w.on("click",function(){t.focus()});t.on("change",function(){this.style.width=0<this.value.length?7*this.value.length+"px":8*(this.getAttribute("placeholder").length+
1)+"px";""!==t.val()&&v.addClass("is-active")});n.$date_clear.on("click",function(){t.val("");t.trigger("change");v.removeClass("is-active")})})})();(function(){function t(x){x?v.addClass("is-active"):v.removeClass("is-active")}var v=m.find(".js-time-toggle"),w=v.find(".js-timepicker");n.$time_clear=v.find(".js-reset-time");w.on("change",function(){t(!0);""==w.val()&&t()});v.on("click",".js-show-time",function(){w.focus()});n.$time_clear.on("click",function(){w.val("");t()})})();(function(){m.find(".js-timepicker").each(function(){d(this).timepicker()})})();
p.on("submit",function(t,v){t.preventDefault();is_locked||(is_locked=!0,t=f(),data=t.data,a()||(t.errors.length?(g(t.errors),is_locked=!1):($plus_icon.addClass("loading"),$plus_icon.html('<span class="icon size-20"><i class="fas fa-spinner fa-spin"></i></span>'),p.find(".js-save").attr("disabled",!0),d.post("?module=reminder&action=add",data,function(w){"ok"===w.status?v||(n.$iframe?null:d.crm.sidebar.reload(),d.crm.content.reload()):console.error(w.errors)},"json").always(function(){is_locked=!1}))))})};
CRMReminders.prototype.initLazyLoading=function(){function a(){function e(){if(d.contains(document,$loader[0])){var l=$loader,h=d(window).scrollTop(),n=g.height(),m=l.offset().top;h+n>=m&&(c||f(l))}else k.off("scroll",e)}function f(l){var h=d.crm.app_url+"?module=reminder&action=actual"+((0<b.setting_deal_id?"&deal="+b.setting_deal_id:"")+(0<b.setting_contact_id?"&contact="+b.setting_contact_id:"")+(b.$iframe?"&iframe=1":""));data={user_id:b.user_id,page:++b.current_page};c=!0;d.post(h,data,function(n){b.click_reminder_event||
(l&&l.remove(),$list.append(n),a())}).always(function(){c=!1})}var g=d(window),k=g;$list=b.$wrapper.find("#c-main-reminders-list");$loader=$list.find(".js-lazy-load");if($loader.length)if(0<g.height())if(1==b.current_page&&g.height()>$list.height())e();else k.on("scroll",e);else setTimeout(function(){return a()},100)}var b=this,c=!1;a()};CRMReminders.prototype.initCompletedReminders=function(){function a(){var q="?module=reminder&action=completed"+((0<e.setting_deal_id?"&deal="+e.setting_deal_id:
"")+(0<e.setting_contact_id?"&contact="+e.setting_contact_id:"")),r={user_id:e.user_id};p=!0;k.append(h);l.hide();d.post(q,r,function(u){b(!0);n=!0;g.html(u);c();k.children().last().remove();l.show();d(window).trigger("scroll")}).always(function(){p=!1})}function b(q,r){r?(f.toggleClass("is-shown"),m=!m,g.slideToggle(300)):q?(f.addClass("is-shown"),m=!0,g.slideDown(300)):(f.removeClass("is-shown"),m=!1,g.slideUp(300))}function c(){function q(){if(d.contains(document,u[0])){if(m){var v=u,w=g.scrollTop(),
x=g.height(),y=v.offset().top;list_top=g.offset().top;w+x>=y-list_top&&(t||r(v))}}else g.off("scroll",q)}function r(v){var w="?module=reminder&action=completed"+((0<e.setting_deal_id?"&deal="+e.setting_deal_id:"")+(0<e.setting_contact_id?"&contact="+e.setting_contact_id:"")),x={user_id:e.user_id,min_dt:g.find("> li[data-datetime]:last").data("datetime")};t=!0;d.post(w,x,function(y){v.remove();g.append(y);c()}).always(function(){t=!1})}d(window);var u=g.find(".js-lazy-load"),t=!1;if(u.length)g.on("scroll",
q)}var e=this,f=e.$completedSection,g=f.find(".c-reminders-list"),k=f.find(".c-actions"),l=k.find(".sort-down"),h=d("<span/>").addClass("icon size-16").append("<i/>").addClass("fas fa-spinner wa-animation-spin speed-1000 text-gray"),n=!1,m=!1,p=!1;d(document).on("is_completed_loaded_false",function(q,r){console.log(r);n=!1;q=r.state;var u=e.$sidebar.find("[data-id='"+r.user_id+"'] .details");r=e.$sidebar.find("[data-id='all'] .details");var t=u.find(".count.all"),v=r.find(".count.all");t.text(t.text()-
1);v.text(v.text()-1);if("overdue"==q||"burn"==q)t=u.find(".count.overdue"),u=u.find(".count.burn"),t.length?(u=t.data("due-count"),v=+t.text(),"overdue"==q?t.data("due-count",--u):null,t.text(--v),0>=u&&t.removeClass("overdue").addClass("burn"),0>=v&&t.remove()):u.length&&(t=+u.text(),u.text(--t),0>=t&&u.remove()),t=r.find(".count.overdue"),r=r.find(".count.burn"),t.length?(r=t.data("due-count"),u=+t.text(),"overdue"==q?t.data("due-count",--r):null,t.text(--u),0>=r&&t.removeClass("overdue").addClass("burn"),
0>=u&&t.remove()):r.length&&(q=+r.text(),r.text(--q),0>=q&&r.remove())});f.on("click",".js-load-completed-reminders",function(q){q.preventDefault();n?b(!1,!0):p||a()})};CRMReminders.prototype.initReopenReminder=function(){function a(e){if(!c){c=!0;var f={id:e};d.post("?module=reminder&action=markAsUndone",f,function(g){"ok"==g.status&&(f.id?d.crm.content.load(d.crm.app_url+"reminder/"+(b.user_id?b.user_id:"all")+"/?highlight_id="+f.id+(b.$iframe?"&iframe=1":"")+((0<b.setting_deal_id?"&deal="+b.setting_deal_id:
"")+(0<b.setting_contact_id?"&contact="+b.setting_contact_id:"")),!1):d.crm.content.reload())}).always(function(){c=!1})}}var b=this,c=!1;b.$wrapper.on("click",".js-reopen-reminder",function(e){e.preventDefault();e=d(this);var f=e.closest(".c-reminder-wrapper");e.addClass("is-loading");e.html('<span class="icon size-20"><i class="fas fa-spinner fa-spin"></i></span>');a(f.data("id"))})};CRMReminders.prototype.initTarget=function(){var a=this,b=d(window);if(!a.$iframe){var c=localStorage.getItem("scrollpos");
c&&a.$sidebar.scrollTop(c)}d(document).ready(function(){a.$wrapper.find(".skeleton-wrapper").hide();setTimeout(function(){var e=a.$wrapper.find(".c-reminder-wrapper.highlighted");if(e.length){var f=e.offset().top;target_h=e.height();viewportHeight=b.height();scrollIt=f-(viewportHeight-target_h)/2;d("html, body").animate({scrollTop:scrollIt+"px"},300)}},100);setTimeout(function(){var e=a.$wrapper.find(".c-reminder-wrapper.is-target");e.length&&(e=e.offset().top,b.scrollTop(e-50))},100)})};return CRMReminders}(jQuery),
CRMReminder=function(d){CRMReminder=function(a){this.$wrapper=a.$wrapper;this.$marker=this.$wrapper.find(".c-marker");this.marker_html=this.$marker.html();this.$steps=this.$wrapper.find(".c-step");this.$view=this.$steps.filter(".is-view");this.$edit=this.$steps.filter(".is-edit");this.$confirm=this.$steps.filter(".is-confirm");this.$textarea=this.$edit.find("textarea");this.$dots_button=this.$wrapper.find(".js-dots-wrapper");this.$dots_detail=this.$wrapper.find(".c-dots-detail");this.id=a.id;this.$iframe=
a.iframe;this.current_page=a.current_page;this.user_id=a.user_id;this.reminder_user_id=a.reminder_user_id;this.shown_class="is-shown";this.setting_contact_id=a.setting_contact_id;this.setting_deal_id=a.setting_deal_id;this.state=a.state;this.$activeContent=this.$view;this.xhr=!1;this.initClass();this.setPadding()};CRMReminder.prototype.initClass=function(){function a(c){c?b.$confirm.addClass("is-shown"):b.$confirm.removeClass("is-shown")}var b=this;b.$wrapper.on("click",function(c){c.preventDefault();
...
function(){b.toggleContent(b.$view);b.id?(d.crm.content.load(d.crm.app_url+"reminder/"+(b.user_id?b.user_id:"all")+"/?highlight_id="+b.id+(b.$iframe?"&iframe=1":"")+((0<b.setting_deal_id?"&deal="+b.setting_deal_id:"")+(0<b.setting_contact_id?"&contact="+b.setting_contact_id:"")),!0).done(function(){d(".c-reminders-list-loader").hide()}),d(document).off("is_completed_loaded_false")):d.crm.content.reload().done(function(){d(".c-reminders-list-loader").hide()})});b.$wrapper.on("reminderNotChanged",function(){b.toggleContent(b.$view)});
b.$wrapper.on("updatePadding",function(){b.setPadding(!0)})};CRMReminder.prototype.setPadding=function(a){var b=this.$wrapper;$quick_content=b.find(".js-quick-content-toggle-wrapper");0===$quick_content.height()||0===b.find(".c-footer").height()?$quick_content.css("padding-bottom","0"):a?$quick_content.css("padding-bottom","0.5rem"):null};CRMReminder.prototype.setDone=function(){var a=this,b=a.$wrapper,c=d(this);b.css("display","none");c.addClass("is-done");c=a.id;href="?module=reminder&action=markAsDone"+
((0<a.setting_deal_id?"&deal="+a.setting_deal_id:"")+(0<a.setting_contact_id?"&contact="+a.setting_contact_id:""));data={id:c,user_id:a.user_id?a.user_id:"all"};is_locked=!0;console.log(data);d.post(href,data,function(e){if("ok"===e.status){var f;e=null==e?void 0:null==(f=e.data)?void 0:f.completed_title;b.remove();a.$iframe||d.crm.sidebar.reload();d(document).trigger("is_completed_loaded_false",{user_id:a.reminder_user_id,state:a.state});e&&d(".js-completed-reminders-btn-text").text(e);d(window).trigger("scroll")}else b.css("display",
"")}).always(function(){is_locked=!1})};CRMReminder.prototype.initDotsDetail=function(){function a(e){var f=d(e.target);e=!!f.closest(".c-dots-detail").length;f=!!f.closest(".js-dots-wrapper").length;e||f||b.$dots_detail.hide()}var b=this;b.$dots_detail.toggle();var c=b.$dots_detail.height();(function(e){e=e.getBoundingClientRect();return window.innerHeight-e.bottom})(b.$dots_button[0])<c+30?b.$dots_detail.css("bottom","38px"):b.$dots_detail.css("bottom","-"+(c+8)+"px");if(b.$dots_detail.is(":visible"))d(document).on("click",
a);else d(document).off("click",a)};CRMReminder.prototype.remove=function(){var a=this,b={id:a.id};a.xhr&&a.xhr.abort();a.xhr=d.post("?module=reminder&action=delete",b,function(c){"ok"===c.status&&(a.$wrapper.remove(),d.crm.content.reload(),a.$iframe?null:d.crm.sidebar.reload())}).always(function(){a.xhr=!1})};CRMReminder.prototype.toggleContent=function(a){this.$activeContent.length&&this.$activeContent.removeClass(this.shown_class);a.addClass(this.shown_class);this.$activeContent=a;a.focus();this.$edit===
...
k;e.is_locked=!1;e.onLoad()})};return a}(jQuery),b=function(c){function e(l,h){var n=l.offsetWidth;l=l.offsetHeight;return{outer_width:n,outer_height:l,inner_width:n-h.left-h.right,inner_height:l-h.top-h.bottom}}function f(l){function h(v){var w=v.split("-");v=parseInt(w[0]);var x=parseInt(w[1])-1;w=parseInt(w[2]);return new Date(v,x,w)}var n=[];l=function(v){function w(x,y){var A=x.split("-");x=parseInt(A[0]);var B=parseInt(A[1])-1;A=parseInt(A[2]);B=new Date((new Date(x,B,A)).getTime()+(y?864E5:
-864E5));y=parseInt(B.getFullYear());x=parseInt(B.getMonth())+1;B=parseInt(B.getDate());10>B&&(B="0"+B);10>x&&(x="0"+x);return[y,x,B].join("-")}1===v[0].data.length&&c.each(v,function(x){var y=v[x].data[0],A={value:0,date:w(y.date,!1)},B={value:0,date:w(y.date,!0)};v[x].data=[A,y,B]});return v}(l);for(var m=0;m<l.length;m++){for(var p=l[m].data,q=[],r=0;r<p.length;r++){var u=p[r],t=parseInt(u.value);q.push({date:h(u.date),value:t})}n.push(q)}return d3.layout.stack().offset("zero").values(function(v){return v}).x(function(v){return v.date}).y(function(v){return v.value})(n)}
function g(l,h,n){var m=null;n+=1;l&&n&&(m=(l-h*(n-1))/n,1>m&&(m=1));return m}function k(l,h){var n=h[0];h=h[1]||1;n=h-n+(1<h-n?0:1);h=n/(l-1);for(var m=[],p=0;p<l;p++){var q=10<n?Math.round(p*h):parseInt(p*h*10)/10;m.push(q)}return m}b=function(l){this.$wrapper=l.$wrapper;this.$hint=this.$wrapper.find(".js-hint-wrapper");this.node=this.$wrapper.find(".js-chart-wrapper")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=l.data;this.data=f(this.charts);this.group_by=l.group_by;
...
h.outer_width).attr("height",h.outer_height);l.renderBackground();l.renderCharts();l.renderAxis();setTimeout(function(){function n(){c.contains(document,l.$wrapper[0])?l.update():c(window).off("resize",n)}c(window).on("resize",n)},4)};b.prototype.initGraphCore=function(){var l=this.data,h=this.area,n=this.x=d3.time.scale().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([h.inner_height,0]);this.yDomain=function(){var m=d3.min(l,function(q){return d3.min(q,function(r){return r.value})});
0<m&&(m=0);var p=d3.max(l,function(q){return d3.max(q,function(r){return r.value+r.y0})});return[m,p]}();this.xDomain=function(){var m=l[0][0].date;var p=l[0][l[0].length-1].date;var q=parseInt((l[0][1].date.getTime()-m.getTime())/2);m=new Date(m.getTime()-q);p=new Date(p.getTime()+q);return[m,p]}();n.domain(this.xDomain);h.domain(this.yDomain)};b.prototype.renderAxis=function(){var l=this.x,h=this.y,n=this.svg;this.xAxis=d3.svg.axis().scale(l).orient("bottom").ticks(10);this.yAxis=d3.svg.axis().scale(h).innerTickSize(2).orient("right").tickValues(k(6,
this.yDomain)).tickFormat(function(m){return m+""});l=n.append("g").attr("class","axis");l.append("g").attr("transform","translate(10,"+this.margin.top+")").attr("class","y").call(this.yAxis);l.append("g").attr("class","x").attr("transform","translate("+this.margin.left+","+(this.area.outer_height-this.margin.bottom)+")").call(this.xAxis)};b.prototype.renderBackground=function(){var l=this.area.inner_width,h=this.area.inner_height,n,m=this.svg.append("g").attr("class","background").attr("transform",
"translate("+this.margin.left+","+this.margin.top+")");m.append("rect").attr("width",l).attr("height",h);for(n=0;5>=n;n++){var p=1+(h-2)/5*n;m.append("line").attr("x1",1).attr("x2",l).attr("y1",p).attr("y2",p)}};b.prototype.renderCharts=function(){var l=this,h=l.data;h=l.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+l.margin.left+","+l.margin.top+")");var n=h.selectAll(".rect").data(function(m){return m});n.enter().append("rect").attr("class",
"rect").style("fill",function(m,p,q){return(m=l.charts[q].color)?m:!1}).on("mouseover",function(m,p,q){l.showHint(d3.event,this,m,l.charts[q])}).on("mousemove",function(){l.moveHint(this)}).on("mouseout",function(){l.hideHint()});n.transition().duration(1E3).attr("x",function(m,p){return l.x(m.date)-l.column_width/2}).attr("y",function(m){return l.y(m.y0)+l.y(m.value)-l.area.inner_height}).attr("height",function(m){return l.area.inner_height-l.y(m.value)}).attr("width",l.column_width);n.exit().remove();
...
this.yDomain));this.svg.selectAll(".axis .y").transition().duration(600).call(this.yAxis);this.xAxis.scale(this.x);this.svg.selectAll(".axis .x").transition().duration(600).call(this.xAxis);this.renderCharts()};b.prototype.showHint=function(l,h,n,m){var p=this;l=c(h);if(!(0<Math.ceil(l.attr("height"))))return!1;var q=n.date;h=p.$hint.find(".c-date");var r=p.$hint.find(".c-app"),u=p.$hint.find(".c-value");q=function(t,v){var w=parseInt(t.getMonth());"months"==v?(t=p.locales.months,t[w]||(t="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ")),
w=t[w]):(v=t.getDate(),w+=1,w=(10>v?"0"+v:v)+"."+(10>w?"0"+w:w)+"."+t.getFullYear());return w}(q,p.group_by);h.text(q);r.text(m.name);u.text(n.value);n=function(t){var v=c(window),w=v.width();v.height();v=p.$hint.outerWidth();var x=p.$hint.outerHeight(),y=Math.ceil(t.attr("width")),A=Math.ceil(t.attr("height")),B=p.$wrapper.offset();t=t.offset();x={left:t.left-B.left+y+10,top:t.top-B.top+(A<x?A-x-2:2)};w<t.left+10+v&&(x.left=t.left-B.left-y-v);return x}(l);p.$hint.css(n).addClass(p.show_class)};b.prototype.moveHint=
...
function(){function c(){e.find(".c-activity-item.is-first").each(function(){var f=d(this).prev().prev();f.hasClass("is-last")||f.addClass("is-last")})}var e=this.$wrapper.find("#c-activity-section");c();new a({$wrapper:e,names:{list:".c-activity-list",items:"> li",paging:".c-paging-wrapper"},log:this,onLoad:c})};CRMLogLive.prototype.initDateFilter=function(){function c(u){var t=u.data("timeframe"),v=u.data("group")||"days";m.html(u.find("a").html());r.length&&r.removeClass("selected");r=u.addClass("selected");
l.hide();setTimeout(function(){l.removeAttr("style")},200);n.val(t);h.val(v);"custom"!==t?(p.removeClass("is-shown"),e()):p.addClass("is-shown")}function e(){var u=k.serializeArray();u.push({name:"chart",value:1});d.post("?module=logLive",u,function(t){"ok"==t.status&&(t=t.data,t.group_by=h.val(),f.chart.update(t))},"json").always(function(){q=!1})}var f=this,g=f.$wrapper.find(".js-dates-filter"),k=g.find("form"),l=g.find(".js-list"),h=g.find(".js-group-field"),n=g.find(".js-timeframe-field"),m=g.find(".js-link-text"),
p=g.find(".js-hidden-part"),q=!1,r=l.find(".selected");l.on("click",".js-toggle",function(u){u.preventDefault();c(d(this))});k.on("submit",function(u){u.preventDefault();q||(q=!0,e())});(function(){g.find(".js-datepicker").each(function(){var u=d(this),t=g.find("."+u.data("selector"));u.datepicker({altField:t,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMLogLive.prototype.initChart=function(){var c=this.$wrapper.find(".js-chart-section");c.length&&this.chartData&&this.chartData.length&&
(this.chart=new b({$wrapper:c,data:this.chartData,group_by:this.chartParams.group_by,locales:this.locales}))};return CRMLogLive}(jQuery),CRMLogLiveItem=function(d){CRMLogLiveItem=function(a){this.$wrapper=a.$wrapper;this.initClass()};CRMLogLiveItem.prototype.initClass=function(){d.crm.renderSVG(this.$wrapper);this.$wrapper.data("logLiveItem",this)};return CRMLogLiveItem}(jQuery);var CRMCallPage=function(d){CRMCallPage=function(a){this.$wrapper=a.$wrapper;this.call_ts=a.call_ts;this.locales=a.locales;this.iframe=a.iframe;this.current_page=a.current_page;this.numbers_assigned=a.numbers_assigned;this.started_contact=a.contact;this.started_deal=a.deal;this.href_prop="";this.initClass()};CRMCallPage.prototype.initClass=function(){d.wa_push&&d.wa_push.init();this.initRedirectCall();this.initDeleteCall();this.numbers_assigned&&d.wa_push&&d.wa_push.init();this.initAssociateDeal();
this.initBackgroundReload();this.initFinishCallLinks();this.initLazyLoading();this.initCustomAudioPlayer();this.initDotsDetail();this.iframe||this.initFilterDrawer();this.initContactUpdateDialog();this.initContactCreateDialog()};CRMCallPage.prototype.initContactCreateDialog=function(){function a(c){d.waDialog({html:'<div class="dialog" id="call-create-contact-dialog">\n                <div class="dialog-background"></div>\n                <div class="dialog-body" style="width: 761px">\n                    \n                    <div class="dialog-content" style="padding: 0;">\n                        <iframe src="'+
(d.crm.app_url+"frame/contact-new/?phone="+c)+'" frameborder="0" style="height: 94vh; width: 100%;">\n                        </iframe>\n                    </div>\n                </div>\n                </div>',onOpen:function(e,f){e.find(".dialog-body").css("top","2.5%");e.find(".dialog-content").css("min-height","95vh")}})}var b=this;b.escapeHtml=function(c){return c.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")};b.$wrapper.on("click",
".js-show-create-dialog",function(c){c.preventDefault();c=b.escapeHtml(""+d(c.target).data("number"));a(c)})};CRMCallPage.prototype.initContactUpdateDialog=function(){function a(c){b||(b=!0,d.post(d.crm.app_url+"?module=contact&action=updateDialog",{call_id:c},function(e){d.waDialog({html:e})}).always(function(){b=!1}))}var b=!1;this.$wrapper.on("click",".js-show-update-dialog",function(c){c.preventDefault();c=d(c.target).data("id");a(c)})};CRMCallPage.prototype.initFilterDrawer=function(){function a(){p.show();
d("#wa-app").addClass("content-on-top");setTimeout(function(){p.removeClass("is-hide");B?null:d("body").addClass("is-locked").css("padding-right","17px")},50)}function b(){p.addClass("is-hide");setTimeout(function(){p.hide();d("body").removeClass("is-locked").css("padding-right","");d("#wa-app").removeClass("content-on-top")},300)}function c(z){z=void 0===z?!1:z;var C=q.serializeArray();C.forEach(function(G,H){if(""!==G.value&&"null"!==G.value){if(4===H&&"custom"===G.value){var I=p.find(".js-datepicker");
""===I.eq(0).val()&&(C[5].value="");""===I.eq(1).val()&&(C[6].value="")}h.href_prop=h.href_prop+(0==H?"":"&")+G.name+"="+G.value}});d.crm.content.load(d.crm.app_url+"call/?"+h.href_prop);var D=d("<span/>").addClass("icon size-20").append("<i/>").addClass("fas fa-spinner wa-animation-spin speed-1000 ");if(z)n.prop("disabled",!0).append(D);else{var F=p.find(".c-filter-buttom");F.append(D);F.children().each(function(){d(this).prop("disabled",!0)});d(document).one("wa_loaded",function(){D.remove();F.children().each(function(){d(this).prop("disabled",
!1)});b()})}}function e(z){var C=p.find("#dropdown-directions-filter [data-filter='"+z[0].value+"']"),D=p.find("#dropdown-states-filter [data-filter='"+z[1].value+"']"),F=p.find("#dropdown-responsible-filter [data-filter='"+z[7].value+"']"),G=p.find("#dropdown-date-filter [data-timeframe='"+z[4].value+"']"),H=q.serializeArray(),I=p.find(".js-datepicker"),K=p.find("#switch-deal-off");C.trigger("click");D.trigger("click");F.trigger("click");""===z[2].value?g():f(h.started_contact,z[2].value,w,r);""===
z[3].value||"0"===z[3].value?l():k(h.started_deal,z[3].value);z[3].value===H[3].value||"0"!==H[3].value&&"0"!==z[3].value||K.trigger("click");I.eq(0).datepicker("setDate",new Date(z[5].value));I.eq(1).datepicker("setDate",new Date(z[6].value));G.trigger("click")}function f(z,C,D,F){var G=z.name;z='<div class="c-user-wrapper">\n                    <div class="flexbox space-8">\n                        <div class="c-column c-column-image">\n                            <div class="flexbox middle">\n                                <img src="'+
z.userpic+'" alt="'+G+'">\n                            </div>\n                        </div>\n                    <div class="c-column nowrap">\n                            <div class="c-column--name">'+G+'</div>\n                            <div class="c-jobtitle hint">'+(F.val()&&z.email?z.email:"")+'</div>\n                            <div class="c-jobtitle hint">'+(F.val()&&z.phone?z.phone:"")+'</div>\n                    </div>\n                    </div>\n                </div>\n                <span class="icon cursor-pointer js-call-filter-contact-cancel"><i class="fas fa-times-circle"></i></span>';
p.find("#input-contact").val(C);F.val()?F.val(""):null;D.html(z);F.hide()}function g(){r.show();w.html("");p.find("#input-contact").val("")}function k(z,C){var D=h.escapeHtml(z.name);z='\n                <div class="c-deal-wrapper nowrap">\n                <div class="flexbox space-8 ">\n                    <i class="fas fa-circle" style="color: '+(z.stage?z.stage.color:"")+'"></i>\n                </div>\n                <div>\n                    <div class="c-deal-wrapper--name">'+D+'</div>\n                    <div>\n                        <span class="hint">'+
(z.create_datetime?z.create_datetime.split(" ")[0]:"")+"</span>\n                        "+(z.closed_datetime?"<span> - </span>":"")+'\n                        <span class="hint">'+(z.closed_datetime?z.closed_datetime.split(" ")[0]:"")+'</span>\n                    </div>\n                    <div class="hint">'+(z.amount?Math.ceil(+z.amount):"")+" "+z.currency_id+'</div>   \n                </div>\n            </div>\n                <span class="icon js-call-filter-deal-cancel"><i class="fas fa-times-circle"></i></span>';
p.find("#input-deal").val(C);t.val("");x.html(z);t.hide()}function l(){t.show();x.html("");p.find("#input-deal").val("")}var h=this,n=h.$wrapper.find(".js-filter-button"),m=h.$wrapper.find(".js-reload-filter-button"),p=h.$wrapper.find(".c-call-filter"),q=p.find(".c-call-filter-form"),r=p.find(".js-search-field-contact"),u=r.parent(),t=p.find(".js-search-field-deal"),v=t.parent(),w=p.find(".js-call-filter-contact"),x=p.find(".js-call-filter-deal"),y=q.serializeArray(),A=q.serialize(),B=h.$wrapper.height()<
d(".content.blank.c-shadowed-content").height(),E=[{name:"direction",value:"all"},{name:"status",value:"ALL"},{name:"contact",value:""},{name:"deal",value:""},{name:"timeframe",value:"null"},{name:"start",value:""},{name:"end",value:""},{name:"user",value:""}];n.on("click",function(z){z.preventDefault();a()});m.on("click",function(z){z.preventDefault();m.find("svg").removeClass("fa-times").addClass("fa-spinner fa-spin");d.crm.content.load(d.crm.app_url+"call/?direction=all&status=ALL")});p.on("click",
".js-close-drawer",function(z){z.preventDefault();b()});p.on("click",".js-apply-filter",function(z){z.preventDefault();c()});p.on("click",".js-reset-filter",function(z){z.preventDefault();"direction=all&status=ALL&timeframe=null&deal=&contact=&start=&end="!==q.serialize()&&e(E)});p.on("click",".js-restore-filter",function(z){z.preventDefault();A!==q.serialize()&&e(y);b()});p.on("click",".js-call-filter-contact-cancel",function(z){z.preventDefault();g()});p.on("click",".js-call-filter-deal-cancel",
function(z){z.preventDefault();l()});(function(){var z=h.$wrapper.find(".js-search-field-client"),C=z.parent();$search_contact_wrapper=h.$wrapper.find(".js-call-filter-search");$search_contact_cancel=h.$wrapper.find(".c-call-filter-contact .js-call-filter-contact-cancel");z.autocomplete({appendTo:C,source:d.crm.app_url+"?module=autocompleteContact&with_email=1&with_phone=1",minLength:0,html:!0,focus:function(){return!1},select:function(D,F){f(F.item,F.item.id,$search_contact_wrapper,C);c(!0);return!1}}).data("ui-autocomplete")._renderItem=
function(D,F){return d("<li />").addClass("ui-menu-item-html").append("<div><span class='icon userpic custom-mr-4'><i style='background-image: url("+F.userpic+");'></i></span>"+F.name+"</div>").appendTo(D)};$search_contact_cancel.on("click",function(D){D.preventDefault();C.show();$search_contact_wrapper.html("")})})();r.autocomplete({appendTo:u,source:d.crm.app_url+"?module=autocompleteContact&with_email=1&with_phone=1",minLength:0,html:!0,focus:function(){return!1},select:function(z,C){f(C.item,
C.item.id,w,r);return!1}}).data("ui-autocomplete")._renderItem=function(z,C){return d("<li />").addClass("ui-menu-item-html").append("<div class='flexbox'><span class='icon userpic custom-mr-4'><i style='background-image: url("+C.userpic+");'></i></span>"+C.name+"</div>").appendTo(z)};t.autocomplete({appendTo:v,source:d.crm.app_url+"?module=autocompleteDeal",minLength:0,html:!0,focus:function(){return!1},select:function(z,C){k(C.item,C.item.id);return!1}}).data("ui-autocomplete")._renderItem=function(z,
C){return d("<li />").addClass("ui-menu-item-html").append("<div>"+h.escapeHtml(C.name)+"</div>").appendTo(z)};(function(){p.find(".js-datepicker").each(function(){var z=d(this),C=p.find("."+z.data("selector"));z.datepicker({altField:C,altFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0})})})()};CRMCallPage.prototype.initDownloadLink=function(){$records_array=this.$wrapper.find(".c-call-wrapper .c-call-record-link");setTimeout(function(){$records_array.eq(0).trigger("click")},2E3)};CRMCallPage.prototype.initCustomAudioPlayer=
...
var f=null,g=function(l){var h=Math.floor(l%60);return Math.floor(l/60)+":"+(10>h?"0"+h:""+h)};if(loading||pause){var k=function(l){clearTimeout(a);clearInterval(id);var h=l[0];$column_audio.slideDown(200);$duration.text(g(h.duration));$progressbar_item.max=Math.floor(h.duration);$progressbar_new.on("input",function(m){$current_time.text(g($progressbar_item.value));m=m.target;$column_audio[0].style.setProperty("--seek-before-width",m.value/m.max*100+"%");cancelAnimationFrame(f)});$progressbar_new.on("input",
function(){h.currentTime=$progressbar_item.value;requestAnimationFrame(n)});var n=function(){$progressbar_item.value=Math.floor(h.currentTime);$current_time.text(g($progressbar_item.value));$column_audio[0].style.setProperty("--seek-before-width",$progressbar_item.value/$progressbar_item.max*100+"%");f=requestAnimationFrame(n);h.currentTime==h.duration&&(cancelAnimationFrame(f),a=setTimeout(function(){return $column_audio.slideUp(200)},3E3))};l=function(){var m=Math.floor(h.buffered.end(h.buffered.length-
1));$column_audio[0].style.setProperty("--buffered-width",m/$progressbar_item.max*100+"%")};h.addEventListener("progress",l);l();requestAnimationFrame(n)};id=setInterval(function(){var l=e.find("audio");l.length&&0<l[0].readyState&&k(l)},50)}play&&(a=setTimeout(function(){return $column_audio.slideUp(200)},3E3),$progressbar_new.off("change"),$progressbar_new.off("input"),cancelAnimationFrame(f))})};CRMCallPage.prototype.initDotsDetail=function(){var a=this;a.$wrapper.on("click",".js-dots",function(b){$detail=
d(this).siblings(".c-dots-detail");$detail_wrapper=$detail.closest(".js-dots-wrapper");$detail.toggle();$detail_wrapper.toggleClass("open");var c=$detail.height();b=$detail.width();var e=$detail_wrapper[0].getBoundingClientRect();window.innerHeight-e.bottom<c+30?$detail.css("bottom","30px"):$detail.css("bottom","unset");c=$detail_wrapper[0].getBoundingClientRect();window.innerWidth-c.left>b+30?$detail.css("left","0"):$detail.css("right","0")});d(document).on("click",function(b){var c=d(b.target),
...
l[0])){var h=l,n=d(window).scrollTop(),m=g.height(),p=h.offset().top;n+m>=p&&(c||f(h))}else g.off("scroll",e)}function f(h){var n=window.location.href.split("/crm/call/")[1];n=d.crm.app_url+"?module=call"+n?n:"";data={page:++b.current_page};c=!0;d.post(n,data,function(m){h&&h.remove();m=d(m).find("#js-calls-table").html();k.append(m);d(document).trigger("wa_loaded");a()}).always(function(){c=!1})}var g=d(window),k=b.$wrapper.find("#js-calls-table"),l=b.$wrapper.find(".js-lazy-load");if(l.length)g.on("scroll",
...
arguments[2],arguments);var k="Error saving Responsible contact classification: "+arguments[2];k=d('<div class="errormsg" />').text(k);b.$errorsPlace.append(k)}},"json").always(function(){b.$button.attr("disabled",!1);f.remove()})}var b=this;b.$wrapper.find(".js-delete-message").on("click",function(){event.preventDefault();d.crm.confirm.show({title:b.locales.delete_message,text:b.locales.delete_message_text,button:b.locales["delete"],onConfirm:a})})};CRMMessageDeleteLinkMixin.mixInFor=function(a){a.prototype=
d.extend(a.prototype,CRMMessageDeleteLinkMixin.prototype);return a};return CRMMessageDeleteLinkMixin}(jQuery);(function(d){d.message=d.extend(d.message||{},{app_url:!1,is_page_loaded:!1,content:!1,sidebar:!1,locales:!1})})(jQuery);
...
d(document).trigger("wa_before_load",{content_uri:a});d(document).trigger("change_active_id",{target_id:f});c&&c.find("[data-fa-i2svg]").hide().after('<i class="fas fa-spinner fa-spin"></i>');g.xhr=d.ajax({method:"GET",url:d.crm.app_url+"?module=messageConversationId&id="+e,dataType:"html",global:!1,cache:!1}).done(function(k){g.api_enabled&&!b&&history.pushState({reload:!0,content_uri:a},"",a);c&&(c.find("[data-fa-i2svg]:first").show(),c.find("[data-fa-i2svg]").slice(1).remove());g.setContent(k);
g.xhr=!1}).fail(function(k){k.responseText&&d.crm.alert.show({title:"Error",text:k.responseText,button:"Close"});c&&(c.find("[data-fa-i2svg]:first").show(),c.find("[data-fa-i2svg]").slice(1).remove())});return g.xhr};MessageContentRouter.prototype.setContent=function(a){this.$content.html(a)};MessageContentRouter.prototype.animate=function(a){var b=this;b.$content_wrapper=b.$content.find("#js-message-conversation-page");b.$skeleton=b.$content.find(".skeleton-wrapper");var c=b.$skeleton;setTimeout(function(){a?
c.show():c.is(":visible")||b.iframe?c.hide():null},10)};return MessageContentRouter}(jQuery),CRMDealMessagesDialog=function(d){CRMDealMessagesDialog=function(a){this.$wrapper=a.$wrapper;this.initClass()};CRMDealMessagesDialog.prototype.initClass=function(){this.$wrapper.on("click",".c-message-wrapper a",function(a){a.preventDefault()});this.$wrapper.on("click",".c-message-wrapper",function(a){a.preventDefault();a=d(a.target);var b=d(this);a.attr("href")||(a=b.find(".js-message-show-body"),a.length&&
a.trigger("click"))})};return CRMDealMessagesDialog}(jQuery),CRMMessageBodyDialog=function(d){CRMMessageBodyDialog=function(a){this.$wrapper=a.$wrapper;this.is_admin=a.is_admin;this.app_url=a.app_url;this.dialog=this.$wrapper.data("dialog")||!1;this.$button=this.$wrapper.find(".js-close-dialog");this.contact_id=a.contact_id;this.message=a.message||{};this.locales=a.locales;this.initClass()};CRMMessageBodyDialog.prototype.initClass=function(){this.initMessageShowBodyLink();this.is_admin&&(this.initSelectDeal(),
this.initMessageDeleteLink())};CRMMessageBodyDialog.prototype.initSelectDeal=function(){function a(){m.html(""+c.locales.deal_empty);u.val("none");g.val("");f.addClass("c-deal-name-hidden");k.addClass("hidden").removeAttr("title");n.addClass("c-empty-deal-hidden");p.addClass("hidden");r.find("li").removeClass("selected");l.removeClass("hidden")}function b(){var v=c.$wrapper.find(".js-created-deal"),w=q.find(".js-visible-link .js-text .funnel-state").clone(),x=d.trim(g.val()),y=e.serializeObject();
y.message_id=c.message.id;if("none"===u.val())return e.addClass("shake animated"),setTimeout(function(){e.removeClass("shake animated")},500),!1;if(0>=u.val()&&!x)return f.addClass("shake animated"),setTimeout(function(){f.removeClass("shake animated");g.focus()},500),!1;e.addClass("deal-form-hidden");v.removeClass("hidden");0>=u.val()?(v.html(w),v.append(d.crm.escape(x))):(x=l.find(".js-visible-link .js-text"),w=x.find(".funnel-state").clone(),x=x.find("b i").text(),v.html(w),v.append(d.crm.escape(x)));
d.post(d.crm.app_url+"?module=message&action=associateDealSave",y,function(A){if("ok"===A.status&&A.data.deal_url){var B=v.html();v.html('<a href="'+A.data.deal_url+'">'+B+"</a>")}else v.html(""),v.addClass("hidden"),a(),e.removeClass("deal-form-hidden")})}var c=this,e=c.$wrapper.find(".deal-form"),f=e.find(".js-deal-name"),g=e.find(".js-deal-name-input"),k=e.find(".js-save-deal"),l=e.find(".js-deals-dropdown"),h=e.find(".js-remove-deal"),n=l.find(".js-empty-deal"),m=e.find(".js-select-deal .js-visible-link .js-text"),
p=e.find(".js-select-funnel-wrapper"),q=e.find(".js-select-stage-wrapper"),r=e.find(".js-deals-list"),u=e.find(".js-deal-id"),t=c.contact_id;u.val("none");t&&d.get("?module=deal&action=byContact&id="+t,function(v){"ok"===v.status&&d.each(v.data.deals,function(w,x){r.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+x.id+'"><i class="fas fa-circle funnel-state" style="color: '+v.data.funnels[x.funnel_id].stages[x.stage_id].color+'"></i><span class="js-text">'+x.name+"</span></a></li>")})},
"json");e.on("click",".js-create-new-deal",function(){u.val("0");l.addClass("hidden");f.removeClass("c-deal-name-hidden");k.attr("title",c.locales.deal_create).removeClass("hidden");p.removeClass("hidden");n.removeClass("c-empty-deal-hidden");g.focus()});e.on("click",".js-deal-item",function(){var v=d(this).find(".js-text").html();m.html(v);u.val(d(this).data("deal-id"));k.attr("title",c.locales.deal_add).removeClass("hidden");p.addClass("hidden");n.removeClass("c-empty-deal-hidden");r.find("li").removeClass("selected");
d(this).parent().addClass("selected")});r.on("click",function(){r.hide();setTimeout(function(){r.removeAttr("style")},200)});n.on("click",function(){a()});h.on("click",function(){a()});k.on("click",function(v){v.preventDefault();e.trigger("submit")});e.on("submit",function(v){v.preventDefault();b()});e.on("change",".js-select-deal-funnel",function(){e.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};CRMMessageBodyDialog.prototype.initMessageShowBodyLink=
function(){var a=this.dialog,b=this.$wrapper;this.initMessageReplyBtn(b,a);this.initMessageForwardBtn(b,a);b.on("click","a",function(c){"javascript:void(0);"!==d(this).prop("href")&&a.close()})};CRMMessageBodyDialog.prototype.initMessageReplyBtn=function(a,b){var c=this;a.on("click",".js-message-reply",function(){function e(k){var l=f.find(".icon");if(!l.length)return!1;k?l.removeClass("fa-undo").addClass("fa-spinner fa-spin"):l.removeClass("fa-spinner fa-spin").addClass("fa-undo")}var f=d(this),
g=f.data("message-id");e(!0);d.post(c.app_url+"?module=message&action=writeReplyDialog",{id:g},function(k){d.waDialog({html:k,onClose:function(){}})}).always(function(){e(!1)})})};CRMMessageBodyDialog.prototype.initMessageForwardBtn=function(a,b){var c=this;a.on("click",".js-message-forward",function(){function e(k){var l=f.find(".icon");if(!l.length)return!1;k?l.removeClass("fa-redo").addClass("fa-spinner fa-spin"):l.removeClass("fa-spinner fa-spin").addClass("fa-redo")}var f=d(this),g=f.data("message-id");
e(!0);d.post(c.app_url+"?module=message&action=writeForwardDialog",{id:g},function(k){d.waDialog({html:k})}).always(function(){e(!1)})})};CRMMessageDeleteLinkMixin.mixInFor(CRMMessageBodyDialog);return CRMMessageBodyDialog}(jQuery),CRMMessagesSidebar=function(d){CRMMessagesSidebar=function(a){this.$wrapper=a.$wrapper;this.$ui=a.$ui;this.no_messages="true"===a.empty_conversations;this.$sidebar=this.$wrapper.parent();this.$list=this.$wrapper.find(".c-messages-table-section");this.$skeleton=this.$sidebar.find(".skeleton-wrapper");
this.page_of_item=a.page_of_item;this.current_page=a.current_page;this.active_id=a.active_id;this.last_message_id=a.last_message_id;this.$settings_contact_id=+a.settings_contact_id;this.$settings_deal_id=+a.settings_deal_id;this.settings=a;this.iframe=a.iframe;this.initClass()};CRMMessagesSidebar.prototype.initClass=function(){var a=this;a.initLazyLoading();a.initSearchHandler();a.conversationListHandler();a.no_messages&&a.$wrapper.closest("#c-messages-sidebar").addClass("no-messages-sidebar");a.$wrapper.on("click",
".js-associate-deal",function(b){b.preventDefault();b=d(this).data("dialog-url");d.get(b,function(c){d.waDialog({html:c})})});a.$wrapper.on("click",".js-write-message",function(b){b.preventDefault();b=d.crm.app_url+"?module=message&action=writeNewDialog";data={contact_id:a.$settings_contact_id?a.$settings_contact_id:null,deal_id:a.$settings_deal_id?a.$settings_deal_id:null};d.get(b,data,function(c){d.waDialog({html:c})})});a.$wrapper.on("click",".js-filter-open",function(){a.$wrapper.find(".c-message-filter-wrapper").toggle()});
a.current_page&&a.initBackgroundUpdate()};CRMMessagesSidebar.prototype.initSearchHandler=function(){var a=this,b=a.$sidebar,c=b.find(".js-search-wrapper"),e=b.find(".js-page-name-header"),f=c.find(".js-search-field"),g=c.find(".state-with-inner-icon");a.iframe||(f.autocomplete({appendTo:c,source:d.crm.app_url+"?module=autocompleteContact",minLength:0,html:!0,focus:function(){return!1},select:function(k,l){d.crm.content.load(d.crm.app_url+"message/?contact="+l.item.id);a.$skeleton.show();f.val("");
return!1}}).data("ui-autocomplete")._renderItem=function(k,l){return d("<li />").addClass("ui-menu-item-html").append("<div><span class='icon userpic custom-mr-4'><i style='background-image: url("+l.userpic+");'></i></span>"+l.name+"</div>").appendTo(k)});c.on("click",".js-search-contact-cancel",function(){a.$skeleton.show();d.crm.content.load(d.crm.app_url+"message/")});c.on("click",".js-search-mobile-show",function(k){c.find(".js-search-mobile-show").removeClass("mobile-only").hide();e.removeClass("mobile-only").hide();
g.removeClass("desktop-and-tablet-only");c.find(".js-search-contact-hide").show()});c.on("click",".js-search-contact-hide",function(k){c.find(".js-search-contact-hide").hide();c.find(".js-search-mobile-show").add("mobile-only").show();e.addClass("mobile-only").show();g.addClass("desktop-and-tablet-only")})};CRMMessagesSidebar.prototype.initBackgroundUpdate=function(){function a(){f||(f=!0,d.contains(document,c.$wrapper[0])&&d.post("?module=message&action=listByConversation",{check:1},function(k){"ok"===
k.status&&(k=k.data!==e,d.contains(document,c.$wrapper[0])&&(k&&!d(".dialog-background:visible").length?b():(clearTimeout(g),g=setTimeout(a,12E4))))},"json").always(function(){f=!1}))}function b(){d.get(d.crm.app_url+"message/"+(c.active_id?"conversation/"+c.active_id+"/":"")+"?reload=1"+(c.$settings_contact_id?"&contact="+c.$settings_contact_id:c.$settings_deal_id?"&deal="+c.$settings_deal_id:"")+(c.iframe?"&iframe="+c.iframe:""),{ui:c.$ui},function(k){k=d(k).find("#c-messages-conversation-list").html();
c.$wrapper.html(k)})}var c=this,e=c.last_message_id,f=!1,g=0;d(document).on("change_active_id",function(k,l){l.target_id&&(c.active_id=l.target_id)});clearTimeout(g);g=setTimeout(a,12E4)};CRMMessagesSidebar.prototype.conversationListHandler=function(){function a(g){g.preventDefault();g.stopPropagation();g=d(this);var k=e.next(),l=g.prop("href"),h=g.parent().data("id"),n=b.$settings_contact_id?"&contact="+b.$settings_contact_id:b.$settings_deal_id?"&deal="+b.$settings_deal_id:"",m=b.iframe?"&view=chat":
"?view=chat";target_props=h+(b.iframe?"&iframe=1&view=chat":"&view=chat")+n;d.message.content.load(l+(m+n),!1,g,target_props,h);c.find(".selected").removeClass("selected");g.parent().addClass("selected").removeClass("unread");k.is(":visible")||(e.addClass("desktop-and-tablet-only"),k.removeClass("desktop-and-tablet-only"))}var b=this,c=b.$list,e=b.$sidebar,f=d(window);c.on("click","a",a);f.on("beforeunload",function(){c.off("click","a",a)});d(document).ready(function(){b.scrollToSelected();b.$skeleton.hide()})};
CRMMessagesSidebar.prototype.scrollToSelected=function(){var a=this.$sidebar,b=this.$list.find(".js-message-wrapper.selected");if(b.length){var c=b.offset().top;target_h=b.height();viewportHeight=d(window).height();scrollIt=c-(viewportHeight-target_h)/2;a.scrollTop(scrollIt)}};CRMMessagesSidebar.prototype.initLazyLoading=function(){function a(){function h(){if(d.contains(document,n[0])){var m=n,p=f.scrollTop(),q=f.height(),r=m.offset().top;p+q>=r&&(e||b(m))}else g.off("scroll touchmove",h)}var n=
k.find(".js-lazy-load");e=!1;if(l&&l>c.current_page)b(n);else if(l&&l==c.current_page&&c.scrollToSelected(),n.length)g.on("scroll touchmove",h)}function b(h){var n=d.crm.app_url+"?module=messageListByConversation",m=c.$settings_contact_id?+c.$settings_contact_id:void 0,p=c.$settings_deal_id?+c.$settings_deal_id:void 0;data={id:+c.active_id,page:++c.current_page,contact:m,deal:p,iframe:c.iframe};console.log(data);e=!0;d.post(n,data,function(q){h&&h.remove();q=d(q).find(".c-messages-table-section").html();
k.append(q);a()}).always(function(){})}var c=this,e=!1,f=d(window),g=c.$sidebar,k=c.$list,l=c.page_of_item;a()};return CRMMessagesSidebar}(jQuery);var CRMMessageConversationPage=function(d){CRMMessageConversationPage=function(a){this.$wrapper=a.$wrapper;this.locales=a.locales;this.conversation_id=a.conversation_id;this.contact_id=a.contact_id;this.filter_contact_id=a.filter_contact_id;this.filter_deal_id=a.filter_deal_id;this.funnel_id=a.funnel_id;this.last_message_id=a.last_message_id;this.check_interval=a.check_interval;this.$replySection=this.$wrapper.find(".js-reply-wrapper");this.iframe=a.iframe;this.old_message_id=a.old_message_id;this.$dropdown_name=
this.$wrapper.find("#dropdown-c-name");this.initClass()};CRMMessageConversationPage.prototype.initClass=function(){var a=this;a.$wrapper.find(".js-deal-link").length||a.initSelectDeal();a.initDealActions();a.initChangeResponsible();a.initBackgroundActions();a.initDelete();d(document).ready(function(){function b(){0==f&&a.scroll2bottom(!1,!1)}var c=a.$wrapper[0].getElementsByTagName("img"),e=a.$wrapper[0].getElementsByTagName("video"),f=c.length+e.length;b();for(var g=0;g<e.length;g++)3<=e[g].readyState?
(f--,b()):(e[g].addEventListener("loadeddata",function(){f--;b()}),e[g].addEventListener("error",function(){f--;b()}));for(g=0;g<c.length;g++)c[g].complete?(f--,b()):(c[g].addEventListener("load",function(){f--;b()}),c[g].addEventListener("error",function(){f--;b()}))});a.initSingleMessage();a.initToggleSidebar();a.initLazyLoading();a.initBlockquotToggle();a.initScrollToBottom();d(document).on("new_message_blockquot",function(b){a.initBlockquotToggle()})};CRMMessageConversationPage.prototype.initBlockquotToggle=
function(){var a=this.$wrapper.find(".c-message-body");d.each(a,function(b,c){d(c).find(".js-blockquote-toggle").length||(b=d(c).children("blockquote"),d.each(b,function(e,f){e=d('<span class="button light-gray custom-mb-4 size-14 js-blockquote-toggle"><i class="fas fa-ellipsis-h"></i></span>');e.insertBefore(f);e.on("click",function(g){d(f).slideToggle(400)})}))})};CRMMessageConversationPage.prototype.initLazyLoading=function(){function a(){function n(){if(d.contains(document,m[0])){var p=m;0>=c.$wrapper.scrollTop()&&
!e&&(c.$wrapper.off(".lazy"),b(p))}else c.$wrapper.off("scroll.lazy touchmove.lazy",n)}var m=f.find(".js-lazy-load");e=!1;2===c.current_page&&10>l?m.remove():m.length&&(c.$wrapper.on("scroll.lazy touchmove.lazy",n),c.$wrapper.one("bigWindowEvent.lazy",n))}function b(n){var m=d.crm.app_url+"?module=messageConversationId&id="+c.conversation_id+"&old_message_id="+c.old_message_id;e=!0;d.ajax({url:m,type:"POST",dataType:"html",beforeSend:function(){k.show();h=c.$wrapper.prop("scrollHeight")},complete:function(){},
data:{delay:1},success:function(p){var q=d(p).find(".js-messages-list");p=d(p).find(".js-message-wrapper");var r=p.length;if(r){var u=function(){n&&n.remove();f.prepend(g.html());g.html("");c.$wrapper.scrollTop(c.$wrapper.prop("scrollHeight")-h);h=c.$wrapper.prop("scrollHeight");k.hide();a()};c.old_message_id=p.eq(0).data("id");10>r&&q.find(".js-lazy-load").remove();q=q.html();g.append(q);(function(){var t=g[0].getElementsByTagName("img"),v=t.length;if(0==v)u();else for(var w=0;w<t.length;w++)t[w].complete?
v--:(t[w].addEventListener("load",function(){v--;0==v&&u()}),t[w].addEventListener("error",function(){v--;0==v&&u()})),0==v&&u()})()}a()}})}var c=this,e=!1,f=c.$wrapper.find(".js-messages-list"),g=c.$wrapper.find(".c-conversation-body--blank"),k=f.find(".js-messages-list--transparent-layer"),l=f.find(".js-message-wrapper").length,h=c.$wrapper.prop("scrollHeight");c.current_page=2;a()};CRMMessageConversationPage.prototype.initVisiblityWatcher=function(){function a(e){e?(c.addClass("is-extended").trigger("resize"),
b.$wrapper.addClass("scroll-lock")):(c.removeClass("is-extended").trigger("resize"),b.$wrapper.removeClass("scroll-lock"))}var b=this,c=b.$replySection;c.on("click",".js-revert",function(){a(!1)});c.on("click",".js-message-resize",function(){a(!1)});c.on("click",".js-message-resize-open",function(){a(!0)})};CRMMessageConversationPage.prototype.loadDealListByContact=function(a){a=a||function(){};var b=this.contact_id;0>=b||this.iframe?a({}):d.get("?module=deal&action=byContact&id="+b,"json").always(function(c){c&&
"ok"===c.status?a(c.data||{}):a({})})};CRMMessageConversationPage.prototype.initSelectDeal=function(a){function b(){v.html(e.locales.deal_empty);A.val("none");n.val("");h.addClass("c-deal-name-hidden");p.addClass("hidden").removeAttr("title");t.addClass("c-empty-deal-hidden");w.addClass("hidden");y.find("li").removeClass("selected");0<q.data("deals_count")?(q.removeClass("hidden"),r.addClass("hidden")):(q.addClass("hidden"),r.removeClass("hidden"))}function c(){var B=f.find(".js-created-deal"),E=
x.find(".js-visible-link .js-text .funnel-state").clone(),z=d.trim(n.val()),C=l.serializeObject();C.conversation_id=e.conversation_id;if("none"===A.val())return l.addClass("shake animated"),setTimeout(function(){l.removeClass("shake animated")},500),!1;if(0>=A.val()&&!z)return h.addClass("shake animated"),setTimeout(function(){h.removeClass("shake animated");n.focus()},500),!1;l.addClass("deal-form-hidden");B.removeClass("hidden");0>=A.val()?(B.html(E),B.append(d.crm.escape(z))):(z=q.find(".js-visible-link .js-text"),
E=z.find(".funnel-state").clone(),z=z.find(".deal-item--name").text(),B.html(E),B.append(d.crm.escape(z)));d.post(d.crm.app_url+"?module=message&action=conversationAssociateDealSave",C,function(D){"ok"===D.status?(f.closest(".dialog").data("dialog").close(),d.crm.content.reload()):(B.html(""),B.addClass("hidden"),b(),l.removeClass("deal-form-hidden"))})}var e=this;a=a||{};var f=a.$wrapper||e.$wrapper,g=function(B){B=B||{};var E=B.funnels||{},z=0;d.each(B.deals||{},function(C,D){C=y;var F=C.prepend;
var G=E[D.funnel_id];if(!D||0>=D.id)D="";else{var H=D.id,I=D.name||"",K="",J="";G&&G.stages&&G.stages[D.stage_id]&&(K=G.stages[D.stage_id].color||"");d.isEmptyObject(G)&&(J='<span class="hint">'+e.locales.funnel_deleted+"</span>");D='<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+H+'"><span class="flexbox js-text"><i class="fas fa-circle funnel-state custom-mr-4" style="color: '+K+'"></i><span class="deal-item--name" style="word-break: break-word;">'+I+"</span></span>"+J+"</a></li>"}F.call(C,
D);z++});k.show();q.data("deals_count",z);0<z?(q.removeClass("hidden"),r.addClass("hidden")):(r.removeClass("hidden"),q.addClass("hidden"))},k=f.find(".js-deal-selector-control-wrapper"),l=k.find(".deal-form"),h=l.find(".js-deal-name"),n=l.find(".js-deal-name-input"),m=f.closest(".js-conversation-deal-attach-dialog").find(".js-save-button"),p=l.find(".js-save-deal"),q=l.find(".js-deals-dropdown"),r=l.find(".js-create-new-deal-link"),u=l.find(".js-remove-deal"),t=q.find(".js-empty-deal"),v=l.find(".js-select-deal .js-visible-link .js-text"),
w=l.find(".js-select-funnel-wrapper"),x=l.find(".js-select-stage-wrapper"),y=l.find(".js-deals-list"),A=l.find(".js-deal-id");A.val("none");"undefined"===typeof a.data?e.loadDealListByContact(g):g(a.data);l.on("click",".js-create-new-deal",function(){A.val("0");q.addClass("hidden");r.addClass("hidden");h.removeClass("c-deal-name-hidden");p.attr("title",e.locales.deal_create).removeClass("hidden");w.removeClass("hidden");t.removeClass("c-empty-deal-hidden");n.focus();m.addClass("yellow")});l.on("click",
".js-deal-item",function(){var B=d(this).find(".js-text").html();v.html(B);A.val(d(this).data("deal-id"));p.attr("title",e.locales.deal_add).removeClass("hidden");w.addClass("hidden");t.removeClass("c-empty-deal-hidden");y.find("li").removeClass("selected");d(this).parent().addClass("selected");m.addClass("yellow")});y.on("click",function(){y.hide();setTimeout(function(){y.removeAttr("style")},200)});t.on("click",function(){b()});u.on("click",function(){b()});p.on("click",function(B){B.preventDefault();
l.trigger("submit")});l.on("submit",function(B){B.preventDefault();c()});l.on("change",".js-select-deal-funnel",function(){l.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())});return{submit:function(){l.trigger("submit")}}};CRMMessageConversationPage.prototype.initDealActions=function(){function a(f,g){var k=null;f.on("click",".js-detach-deal",function(l){l.preventDefault();d.crm.confirm.show({title:b.locales.deal_detach_title,text:b.locales.deal_detach_text.replace(/%s/,
g),button:b.locales.deal_detach_confirm_button,onConfirm:function(){k&&k.abort();b.loadDealListByContact(function(h){k=d.post(d.crm.app_url+"?module=messageConversationDeal&action=detach",{id:b.conversation_id}).done(function(n){n&&"ok"===n.status&&(d.crm.content.reload(),f.data("dialog").close())}).always(function(){k=null})})}})})}var b=this,c=b.$wrapper,e=c.find(".js-conversation-deal");$deal_second=c.find("#dropdown-c-deal");e.on("click",".js-associate-deal",function(f){f.preventDefault();f=d(this).data("dialog-url");
d.get(f,function(g){d.waDialog({html:g})})});e.on("click",".js-attach-other-deal",function(f){setTimeout(function(){$deal_second.find(".dropdown-toggle").trigger("click")},50)});$deal_second.on("click",".js-return-back",function(f){setTimeout(function(){b.$dropdown_name.find(".dropdown-toggle.c-name").trigger("click")},50)});$deal_second.on("click",".js-attach-other-deal",function(f){f.preventDefault();var g=e.find(".js-deal-link").text();b.loadDealListByContact(function(k){d.get(d.crm.app_url+"?module=messageConversationDeal&action=attachDialog",
{id:b.conversation_id},function(l){var h=d(l);d.waDialog({html:h,onOpen:function(){var n=h.find(".js-conversation-deal"),m=b.initSelectDeal({$wrapper:n,data:k});h.find(".js-save-button").on("click",function(){m.submit()});a(h,g)}})})})});$deal_second.on("click",".js-detach-deal",function(f){f.preventDefault();var g=null;f=e.find(".js-deal-link--name").text();d.crm.confirm.show({title:b.locales.deal_detach_title,text:b.locales.deal_detach_text.replace(/%s/,f),button:b.locales.deal_detach_confirm_button,
onConfirm:function(){g&&g.abort();b.loadDealListByContact(function(k){g=d.post(d.crm.app_url+"?module=messageConversationDeal&action=detach",{id:b.conversation_id}).done(function(l){l&&"ok"===l.status&&d.crm.content.reload()}).always(function(){g=null})})}})})};CRMMessageConversationPage.prototype.initChangeResponsible=function(){function a(){e||(e=!0,d.post("?module=message&action=changeConversationUser",{action:"remove",id:c.conversation_id},function(h){"ok"===h.status&&(e=!1)},"json").always(function(){e=
!1;d.crm.content.reload()}))}function b(h,n){function m(w){var x="?module=autocomplete&type=user";x=0<c.funnel_id?x+("&funnel_id="+c.funnel_id):x+("&contact_id="+c.contact_id);w.autocomplete({appendTo:w.parent(),source:x,minLength:0,html:!0,focus:function(){return!1},select:function(y,A){p(A.item.id);w.val("");n.close();d.crm.content.reload();return!1}}).data("ui-autocomplete")._renderItem=function(y,A){var B=d("<li />");B.addClass("ui-menu-item-html").append("<div>"+A.value+"</div>").appendTo(y);
A.rights||(B.addClass("is-locked"),B.on("click",function(E){E.preventDefault();E.stopPropagation()}));return B};w.on("focus",function(){w.data("uiAutocomplete").search(w.val())})}function p(w){e||(e=!0,d.post("?module=message&action=changeConversationUser",{action:"set",id:c.conversation_id,user_contact_id:w},function(x){"ok"===x.status&&(x=d(x.data.html),r.html(x),t.addClass("hidden"),x=r.find(".js-owner-autocomplete"),x.length&&m(x))},"json").always(function(){e=!1}))}function q(){e||(e=!0,d.post("?module=message&action=changeConversationUser",
{action:"remove",id:c.conversation_id},function(w){"ok"===w.status&&(r.html(""),t.removeClass("hidden"),e=!1)},"json").always(function(){e=!1;n.close();d.crm.content.reload()}))}h.on("click",".js-cancel",function(w){w.preventDefault();n.close()});var r=h.find(".js-responsible-wrapper"),u=r.find(".js-owner-autocomplete"),t=h.find(".js-responsible-empty-wrapper"),v=t.find(".js-responsible-empty-autocomplete");v.length&&m(v);u.length&&m(u);t.on("click",".js-set-extended, .js-unset-extended",function(){t.toggleClass("is-extended");
t.hasClass("is-extended")&&v.focus()});r.on("click",".js-show-combobox",function(){r.find(".c-conversation-member").addClass("is-edit");r.find(".js-owner-autocomplete").focus()});r.on("click",".c-conversation-member .profile",function(){n.close()});r.on("click",".js-hide-combobox",function(){r.find(".c-conversation-member").removeClass("is-edit")});r.on("click",".js-remove-owner",function(w){w.preventDefault();w=d.trim(r.find(".c-name").html());d.crm.confirm.show({title:c.locales.remove_owner_title,
text:c.locales.remove_owner_text.replace(/%s/,w),button:c.locales.remove_owner_button,onConfirm:function(){q()}})})}var c=this,e=!1,f=c.$wrapper.find(".js-conversation-contact"),g=c.$wrapper.find(".js-open-responsible-dialog"),k=c.$wrapper.find("#dropdown-c-contact");$responsible_wrapper_dialog=c.$wrapper.find(".js-conversation-responsible-wrapper");html_content=$responsible_wrapper_dialog.html();f.on("click",".js-open-second-menu",function(h){setTimeout(function(){k.find(".dropdown-toggle").trigger("click")},
50)});k.on("click",".js-return-back",function(h){setTimeout(function(){c.$dropdown_name.find(".dropdown-toggle.c-name").trigger("click")},50)});k.on("click",".js-remove-owner",function(h){h.preventDefault();h=d.trim($responsible_wrapper_dialog.find(".c-name").html());d.crm.confirm.show({title:c.locales.remove_owner_title,text:c.locales.remove_owner_text.replace(/%s/,h),button:c.locales.remove_owner_button,onConfirm:function(){a()}})});var l='<div class="dialog dialog-conversation-responsible" id="my-dialog">\n        <div class="dialog-background"></div>\n        <div class="dialog-body">\n        <div class="dialog-header"><h3><i class="fas fa-cogs text-blue smaller"></i> '+
c.locales.owner+'</h3></div>\n        <div class="dialog-content">\n        '+html_content+'\n        </div>\n        <div class="dialog-footer">\n            <button class="button light-gray js-cancel" type="button">'+c.locales.close+"</button>\n        </div>\n        </div>";g.on("click",function(){d.waDialog({html:l,onOpen:b})})};CRMMessageConversationPage.prototype.initBackgroundActions=function(){function a(){clearTimeout(g);g=setTimeout(b,e.check_interval)}function b(){f||(f=!0,d.post("?module=message&action=conversationIdCheck",
{id:e.conversation_id},function(k){"ok"===k.status&&(+k.data!==e.last_message_id?c().then(function(l){l.length&&e.scroll2bottom(!0,!0);a()}):a())},"json").always(function(){f=!1}))}function c(){var k=d.Deferred();d.get(location.href,function(l){function h(q){function r(){q.removeClass("is-new");q.off("hover",r);u.off("unmark-new-messages",r)}var u=d(document);q.addClass("is-new");q.on("hover",r);u.on("unmark-new-messages",r);setTimeout(function(){d.contains(document,q[0])&&r()},1E4)}var n=e.last_message_id,
m=e.$wrapper.find(".js-messages-list").first();l=d(l).find(".js-messages-list .js-message-wrapper");var p=[];m.length&&(l.each(function(){var q=d(this),r=q.data("id");r>e.last_message_id&&(m.append(q),h(q),p.push({id:r,$message:q}),n=r)}),e.last_message_id=n);k.resolve(p)});return k.promise()}var e=this,f=!1,g=0;d(document).on("wa_before_load",function(){clearTimeout(g);d(document).off("wa_before_load")});a()};CRMMessageConversationPage.prototype.initDelete=function(){function a(){var e=b.filter_contact_id?
"contact="+b.filter_contact_id:b.filter_deal_id?"deal="+b.filter_deal_id:null,f=b.iframe?"?iframe=1":"";e=e?(b.iframe?"&":"?")+e:"";var g=d.crm.app_url+"message/"+f+e;d.post(d.crm.app_url+"?module=message&action=conversationIdDelete",{id:b.conversation_id},function(k){"ok"===k.status&&d.crm.content.load(g)}).always(function(){c=!1},"json")}var b=this,c=!1;b.$wrapper.on("click",".js-delete-conversation",function(e){e.preventDefault();c||d.crm.confirm.show({title:b.locales.delete_conversation_title,
button:b.locales.delete_conversation_button,onConfirm:a})})};CRMMessageConversationPage.prototype.initSendEmail=function(){var a=!1;this.$wrapper.on("click",".js-show-message-dialog",function(b){b.preventDefault();var c=d(this);b=c.data("id");c=c.data("email");!a&&b&&(a=!0,d.post("?module=message&action=writeNewDialog",{contact_id:b,email:c},function(e){d.waDialog({html:e})}).always(function(){a=!1}))})};CRMMessageConversationPage.prototype.initSingleMessage=function(){var a=!1;this.$wrapper.on("click",
".js-open-detail-message",function(b){b.preventDefault();a||(a=!0,b=d(this).data("dialog-url"),d.get(b,function(c){d.waDialog({html:c,onClose:function(){a=!1}})}))})};CRMMessageConversationPage.prototype.initScrollToBottom=function(){function a(){if(d.contains(document,e[0])){var f=c.height()-b.$wrapper.scrollTop()-b.$wrapper.height();0>=f&&e.is(":visible")?e.hide():0<f&&e.is(":hidden")&&e.show()}else b.$wrapper.off("scroll touchmove",a)}var b=this,c=b.$wrapper.find(".js-messages-list"),e=b.$wrapper.find(".js-messages-list--to-bottom-button");
b.$wrapper.on("scroll touchmove",a);e.on("click",function(){return b.scroll2bottom(!0,!0)});d(document).on("scroll_button_event",function(f,g){b.last_message_id=g;b.scroll2bottom(!0,!0)})};CRMMessageConversationPage.prototype.scroll2bottom=function(a,b){function c(){setTimeout(function(){d.contains(document,f.$wrapper[0])&&l&&e()},0)}function e(){var h=f.$wrapper.find("#js-message-conversation-page").height();0<h?(k<h?b?f.$wrapper.animate({scrollTop:h},500):f.$wrapper.scrollTop(h):f.$wrapper.trigger("bigWindowEvent.lazy"),
d.message.content.animate(!1)):setTimeout(function(){return e()},100)}var f=this,g=f.iframe?d(top.window):d(window),k=g.height(),l=!0;if(a)e();else if(d.crm.is_page_loaded||f.iframe)c();else g.one("scroll",function(){l=!1}).one("load",c)};CRMMessageConversationPage.prototype.initToggleSidebar=function(){var a=this.$wrapper.parent().parent(),b=this.$wrapper.find(".js-expand-sidebar");if(b.length)b.on("click",function(c){c.preventDefault();c=a.prev();if(a.is(":visible")){a.addClass("desktop-and-tablet-only");
c.removeClass("desktop-and-tablet-only");c=window.history.state;var e=c.content_uri.replace("?view=chat","");c.content_uri=e;window.history.replaceState(c,c.title,e)}})};return CRMMessageConversationPage}(jQuery),CRMMessagesProfileAdditional=function(d){CRMMessagesProfileAdditional=function(a){this.$main_wrapper=a.$wrapper;this.contact_id=a.contact_id;this.$wrapper=this.$main_wrapper.find("#c-messages-info-additional");this.initClass()};CRMMessagesProfileAdditional.prototype.initClass=function(){function a(){c.$main_wrapper.prepend('<iframe frameborder="0" src="'+
d.crm.app_url+"frame/contact/"+c.contact_id+'" style="width:100%; background-color: var(--background-color);"></iframe>');c.$main_wrapper.find("iframe").on("load",b)}function b(){var g=d(this),k=g.contents().find("#app");k.length?(new ResizeObserver(function(l){l=l[0].target.scrollHeight;g.css("height",l);300<l&&c.$wrapper.removeClass("hidden")})).observe(k[0]):setTimeout(function(){return b()},100);g.on("beforeShowModal",function(){setTimeout(function(){g.addClass("max-height-100");c.$main_wrapper.addClass("freeze-sidebar")},
180)});g.on("beforeCloseModal",function(){g.removeClass("max-height-100");c.$main_wrapper.removeClass("freeze-sidebar")})}var c=this,e=!1,f=d(window).width();if(1024<=f)a(),e=!0;else d(window).on("resize",function(){e||d(this).width()===f||(f=d(this).width(),console.log(f),1024<=f&&(a(),e=!0))});c.initTopInfoFields();c.initAdditionalContentLink()};CRMMessagesProfileAdditional.prototype.initTopInfoFields=function(){function a(){var g=d.crm.app_url+"?module=contact&action=tabs&id="+b.contact_id;f=!0;
d.get(g).done(function(k){d.each(k.data,function(l,h){var n=h.url?"":n;e.append('<li class="custom-mb-16 bold">\n                    <a href="javascript:void(0);" class="js-drawer-list-link js-drawer-list--'+h.app_id+' additional" data-dialog-url="'+(h.url||"")+'" data-class-name="custom" '+(n?'data-dialog-html="'+n+'"':"")+'>\n                    <span class="js-drawer-list-link--header" >'+h.title+"</span>"+(null!==h.count?'<span class="hint custom-ml-4">'+h.count+"</span>":"")+"</a></li>")});e.find(".skeleton").hide();
b.$main_wrapper.animate({scrollTop:b.$main_wrapper[0].scrollHeight},450)})}var b=this,c=b.$wrapper.find(".js-info-list"),e=b.$wrapper.find(".js-drawer-list"),f=!1;b.$wrapper.on("click",".js-info-toggle",function(g){g.preventDefault();g=d(this);f||a();g.toggleClass("is-active");c.slideToggle();g.hasClass("is-active")&&b.$main_wrapper.animate({scrollTop:b.$main_wrapper[0].scrollHeight},450)})};CRMMessagesProfileAdditional.prototype.initAdditionalContentLink=function(){function a(e,f,g){function k(){n.append("\n                    <script>\n                    (() => {\n                        setTimeout( function() {\n                            Array.from(document.getElementsByTagName('a')).forEach(l => {\n                                l.setAttribute('target', '_top');\n                            });\n                            Array.from(document.getElementsByClassName('menu-v')).forEach(l => {\n                                l.classList.remove(\"menu-v\");\n                                l.classList.add(\"menu\");\n                            });\n                        }, 200);\n                        setTimeout( function() {\n                            Array.from(document.getElementsByClassName('menu-v')).forEach(l => {\n                                l.classList.remove(\"menu-v\");\n                                l.classList.add(\"menu\");\n                            });\n                        }, 0);  \n                    })();\n                    \x3c/script>")}
var l=e.contents(),h=l.find("head"),n=l.find("body");l.find("html").attr("data-theme",document.documentElement.getAttribute("data-theme")).addClass("blank");h.append('<meta charset="utf-8">\n                <link rel="icon" href="data:;base64,iVBORw0KGgo=">\n                <meta http-equiv="X-UA-Compatible" content="IE=edge">\n                <meta name="viewport" content="viewport-fit=cover, width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">\n                <link href="'+
wa_url+'wa-content/css/wa/wa-2.0.css" rel="stylesheet" type="text/css">\n                <script src="'+wa_url+'wa-content/js/jquery/jquery-3.6.0.min.js">\x3c/script>');n.addClass("blank custom-px-16");g?(n.html(g),k()):d.ajax({method:"GET",url:f,dataType:"html",global:!1,cache:!1}).done(function(m){n.html(m);k()}).fail(function(m){m.statusText&&n.html(m.statusText)}).always(function(){e.trigger("load")})}var b=this,c=!1;b.$wrapper.on("click",".js-drawer-list-link",function(e){e.preventDefault();
if(!c){c=!0;var f=d(this).data("dialog-url"),g=d(this).hasClass("additional"),k=d(this).data("dialog-html")||null;e=d(this).data("class-name")||"";var l=d(this).find(".js-drawer-list-link--header").text();if(f){drawer_html='<div class="drawer crm-help crm-message-additional '+e+'" id=""> <div class="drawer-background"></div> <div class="drawer-body"><header class="drawer-header"><h3>'+l+'</h3></header><a href="#" class="drawer-close js-close-drawer"><i class="fas fa-times"></i></a><div class="drawer-block"><div class="flexbox middle width-100 height-100 spinner-wrapper"><div class="spinner custom-p-16"></div></div></div></div></div>';
var h='<iframe frameborder="0" src="'+f+'" style="width:100%;  height: 100vh; background-color: var(--background-color);"></iframe>';g&&(h='<iframe frameborder="0" style="width:100%; height: 100vh; background-color: var(--background-color-blank);"></iframe>');b.drawer=d.waDrawer({html:drawer_html,direction:"right",onOpen:function(n,m){n.find(".drawer-block").append(h);var p=n.find("iframe");p.length?(g&&a(p,f,k),p.on("load",function(){n.find(".spinner-wrapper").remove()}),p.on("beforeShowModal",function(){p.addClass("z-10")}),
p.on("beforeCloseModal",function(){p.removeClass("z-10")})):n.find(".spinner-wrapper").remove()},onClose:function(){c=!1}})}else c=!1}})};return CRMMessagesProfileAdditional}(jQuery),CRMMessagesProfile=function(d){CRMMessagesProfile=function(a){this.$wrapper=a.$wrapper;this.photo_dialog_url=a.photo_dialog_url;this.locales=a.locales;this.icons_array={folder:'<i class="fas fa-folder"></i>',search:'<i class="fas fa-search"></i>',user:'<i class="fas fa-user"></i>',blog:'<i class="fas fa-file-image"></i>',
notebook:'<i class="fas fa-file"></i>',lock:'<i class="fas fa-lock"></i>',"lock-unlocked":'<i class="fas fa-lock-open"></i>',broom:'<i class="icon"><svg><use xlink:href="{$wa_url}wa-apps/blog/img/sprites/icons.svg?v={$wa->version()}#clean"></use></svg></i>',star:'<i class="fas fa-star"></i>',livejournal:'<i class="fas fa-pencil-alt"></i>',contact:'<i class="fas fa-users"></i>',lightning:'<i class="fas fa-bolt"></i>',"light-bulb":'<i class="fas fa-lightbulb"></i>',pictures:'<i class="fas fa-images"></i>',
...
h=l.find("a").length;k.length||k.push({id:!1,name:b.locales.no_segments});d.each(k,function(n,m){n="javascript:void(0);";var p="",q='<span class="hint">'+m.name+"</span>";m.id&&(n=d.crm.app_url+"contact/segment/"+m.id+"/",p=b.icons_array[m.icon]?b.icons_array[m.icon]:b.icons_array.noname,q="<span>"+m.name+"</span>");m='<a href="'+n+'">'+p+q+"</a>";h&&(m=", "+m);l.append(m);h=!0})}var b=this,c=b.$wrapper.find(".crm-contact-assign-segments"),e=d.crm.app_url+"?module=contactOperation&action=addToSegments&is_assign=1",
...
a.$wrapper.on("change",a.$sender_email_select,function(b){b.preventDefault();a.$sender_email.val(a.$sender_email_select.val());a.disableResizer(!0)})};CRMEmailConversationEmailSender.prototype.getFilesController=function(){function a(q){q.length&&(d.each(q,function(r,u){r=c.files_storage;var t=r.push,v=d(h);v.find(".js-name").text(u.name);l.prepend(v);f.prop("disabled")&&f.prop("disabled",!1);t.call(r,{$file:v,file:u})}),k.val(""))}function b(q){var r=[];d.each(c.files_storage,function(u,t){q[0]!==
t.$file[0]?r.push(t):q.remove()});c.files_storage=r}var c=this,e=c.$wrapper.find(".js-files-wrapper"),f=c.$wrapper.find(".c-visible .js-save-button");if(!e.length)return!1;var g=c.$wrapper.find(".js-default-drop-area"),k=c.$wrapper.find(".js-drop-field"),l=c.$wrapper.find(".c-upload-list"),h=c.file_template_html,n=d.crm.app_url+"?module=file&action=uploadTmp",m=0,p=0;c.files_storage=[];c.$form.on("click",".js-message-attachment",function(){k.click()});k.on("change",function(q){q.preventDefault();
a(this.files)});g.on("drop",function(q){q.preventDefault();a(q.originalEvent.dataTransfer.files)});g.on("dragover",function(q){q.preventDefault();g.addClass("is-hover");clearTimeout(p);p=setTimeout(function(){g.removeClass("is-hover")},100)});document.onpaste=function(q){q=(q.clipboardData||q.originalEvent.clipboardData).files;console.log(q);a(q)};c.$form.on("click",".js-file-delete",function(q){q.preventDefault();b(d(this).closest(".c-upload-item"))});return{uploadFiles:function(q,r){function u(v){function w(){var z=
new FormData,C=document.cookie.match(/(?:^|; )_csrf=([^;]*)/);(C=C?decodeURIComponent(C[1]):"")&&z.append("_csrf",C);q&&q.length&&d.each(q,function(D,F){F.name&&F.value&&z.append(F.name,F.value)});z.append("file_size",v.file.size);z.append("files",v.file);z.append("file_end",1);d.ajax({xhr:function(){var D=new window.XMLHttpRequest;D.upload.addEventListener("progress",function(F){F.lengthComputable&&(F=parseInt(F.loaded/F.total*100),y.css("--progress-value",F),100===F&&(y.css("background","transparent"),
A.show()))},!1);return D},url:n,data:z,cache:!1,contentType:!1,processData:!1,type:"POST",success:function(D){setTimeout(function(){d.contains(document,x[0])&&(--m,0>=m&&t())},2E3)}}).always(function(){c.is_locked=!1})}var x=v.$file,y=x.find(".js-bar"),A=y.find(".js-progress-success-icon"),B=x.find(".js-status");x.addClass("is-upload");if(c.max_upload_size>v.file.size)w();else{var E=c.$form.find(".js-submit-button");B.addClass("errormsg");x.removeClass("is-upload");c.is_locked=!1;f.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");
E.attr("disabled",!1);c.$textarea_small.attr("disabled",!1);k.prop("disabled",!1);c.$form.find("button").prop("disabled",!1)}}var t=r?r:function(){};c.files_storage.length?(m=c.files_storage.length,d.each(c.files_storage,function(v,w){u(w)})):t()}}};CRMEmailConversationEmailSender.prototype.initWYSIWYG=function(){var a=this,b=a.$textarea;d.crm.initWYSIWYG(b,{maxHeight:50,allowedAttr:[["section","data-role"]],callbacks:{change:function(){a.disableResizer(!0)}}});a.body&&b.redactor("code.set",a.body);
a.$body_redactor_p=a.$wrapper.find(".redactor-layer.redactor-styles.redactor-layer-img-edit section p").eq(0)};CRMEmailConversationEmailSender.prototype.initSave=function(){function a(){k.css("min-height",0);var m=k[0].scrollHeight;250>m?k.css("min-height",m+"px"):k.css("min-height","250px")}function b(){var m=g.send_action_url,p=g.$form.serializeArray();n.prop("disabled",!0);k.attr("disabled",!0);d.ajax({method:"POST",url:m,data:p,dataType:"json"}).done(function(q){var r=jQuery.parseJSON(q.data.html);
q=q.data.id?q.data.id:q.data.message_id;g.$message_list.append(r);f();c(q);d(document).trigger("new_message_blockquot");l.attr("disabled",!0);h.attr("disabled",!0);g.body=g.body_old;g.$replySection.find(".js-revert").trigger("click");a()}).fail(function(q){var r=g.$form.find("#tooltip-error-message");q=Object.values(response.errors);r.addClass("errormsg");d.each(q,function(u,t){r.append('<span><i class="fas fa-exclamation-triangle state-error"></i> <span class="small">'+t+"</span></span>")});f();
l.attr("disabled",!0);h.attr("disabled",!0);g.body=g.body_old;g.$replySection.find(".js-revert").trigger("click");a();g.is_locked=!1;response.errors&&console.error(response.errors);g.$textarea.on("focus",e);k.on("focus",e);g.$form.on("change",e)}).always(function(){g.is_locked=!1})}function c(m){function p(){0==u&&d(document).trigger("scroll_button_event",m)}var q=g.$message_list.find("[data-id="+m+"]"),r=q[0].getElementsByTagName("img");q=q[0].getElementsByTagName("video");var u=r.length+q.length;
p();for(var t=0;t<q.length;t++)3<=q[t].readyState?(u--,p()):(q[t].addEventListener("loadeddata",function(){u--;p()}),q[t].addEventListener("error",function(){u--;p()}));for(t=0;t<r.length;t++)r[t].complete?(u--,p()):(r[t].addEventListener("load",function(){u--;p()}),r[t].addEventListener("error",function(){u--;p()}))}function e(){g.$form.find("#tooltip-error-message").removeClass("errormsg").html("");k.off("focus",e);g.$textarea.off("focus",e);g.$form.off("change",e)}function f(){l.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");
h.attr("disabled",!1);k.attr("disabled",!1);n.prop("disabled",!1);g.$form.find("button").prop("disabled",!1);k.val("");if(g.files_storage.length){var m=g.$form.find(".c-upload-item");d.each(m,function(p,q){q.remove()});g.files_storage=[]}}var g=this,k=g.$textarea_small,l=g.$wrapper.find(".c-visible .js-save-button"),h=g.$form.find(".js-submit-button"),n=g.$form.find(".js-drop-field");g.$message_list=d(".js-messages-list");$main_wrapper=d(".c-messages-page-content-wrapper");d(document).on("wa_before_load",
function(){d(document).off("wa_before_load")});k.on("keydown",function(m){13!==m.keyCode&&10!==m.keyCode||m.ctrlKey||m.metaKey||m.shiftKey||(m.preventDefault(),""!==k.val()||g.files_storage.length?g.$form.submit():(k.addClass("shake animated"),setTimeout(function(){k.removeClass("shake animated")},500)))});k.on("keyup",function(m){if(13!==m.keyCode&&10!==m.keyCode||!(m.ctrlKey||m.metaKey||m.shiftKey))""!==k.val()||g.files_storage.length?l.prop("disabled")&&l.prop("disabled",!1):l.prop("disabled")||
l.prop("disabled",!0);else if(!m.shiftKey){var p=k.val(),q=k.prop("selectionStart");m=p.slice(0,q);p=p.slice(q);k.val(m+"\n"+p)}a();g.$body_redactor_p.html(k.val())});g.$form.on("submit",function(m){m.preventDefault();g.is_locked||(g.is_locked=!0,m=d('<span class="icon size-16"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>'),l.find("svg").removeClass("fa-arrow-up").addClass("fa-spinner fa-spin"),h.attr("disabled",!0),m.insertBefore(h),g.$form.find("button").prop("disabled",!0),
...
c=!1;b.$wrapper.on("click",".js-show-personal-settings-dialog",function(e){e.preventDefault();a()})};CRMEmailConversationEmailSender.prototype.initEmailCopy=function(){function a(){var m=d.trim(l.val()).split(/[,:;]/);if(m[0].length)return d.each(m,function(p,q){p=d.trim(q).split(/\s+/);var r=!1,u=q=null;d.each(p,function(t,v){d.crm.check.email(v)&&!r&&(q=v.replace(/<|>/g,""),r=t)});!1!==r&&p.splice(r,1);u=p.join(" ");q&&u&&c(0,q,u);q&&!u&&b(0,q,q);u&&!q&&(l.addClass("shake animated"),setTimeout(function(){l.removeClass("shake animated")},
500));r=!1;u=q=null}),!1}function b(m,p,q){k.children('[data-email="'+p+'"]').length&&"0"!==m||!p.length||(e.$wrapper.find(".email-copy-input-div").before('<div class="email-copy-user" title="'+d.crm.escape(p)+'" data-contact-id="'+d.crm.escape(m)+'" data-email="'+d.crm.escape(p)+'">'+q+' <a title="'+e.locales.remove_form_cc+'" class="remove-cc js-remove-cc">x</a> <input name="cc['+d.crm.escape(p)+'][email]" type="hidden" value="'+d.crm.escape(p)+'" /><input name="cc['+d.crm.escape(p)+'][id]" type="hidden" value="'+
d.crm.escape(m)+'" /></div>'),e.$wrapper.find(".email-copy-text-collapsed").append('<div class="email-copy-user" title="'+d.crm.escape(p)+'" data-email="'+d.crm.escape(p)+'">'+q+"</div>"));l.val("").focus()}function c(m,p,q){k.children('[data-email="'+p+'"]').length&&"0"!==m||!p.length||(e.$wrapper.find(".email-copy-input-div").before('<div class="email-copy-user" title="'+d.crm.escape(p)+'" data-contact-id="'+m+'" data-email="'+d.crm.escape(p)+'">'+d.crm.escape(q)+' <a title="'+e.locales.remove_form_cc+
'" class="remove-cc js-remove-cc">x</a> <input name="cc['+d.crm.escape(p)+'][email]" type="hidden" value="'+d.crm.escape(p)+'" /><input name="cc['+d.crm.escape(p)+'][id]" type="hidden" value="'+d.crm.escape(m)+'" /><input name="cc['+d.crm.escape(p)+'][name]" type="hidden" value="'+d.crm.escape(q)+'" /></div>'),e.$wrapper.find(".email-copy-text-collapsed").append('<div class="email-copy-user" title="'+d.crm.escape(p)+'" data-email="'+d.crm.escape(p)+'">'+d.crm.escape(q)+"</div>"));l.val("").focus()}
var e=this,f=e.$wrapper.find(".email-copy-wrapper"),g=f.find(".email-copy-area"),k=g.find(".email-copy-text"),l=g.find(".email-copy-input"),h=f.find(".deal-participants-area"),n=e.$wrapper.find(".email-copy-wrapper-collapsed");l.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",appendTo:e.$wrapper,minLength:0,focus:function(){return!1},select:function(m,p){b(p.item.id,p.item.email,'<i class="icon userpic" style="background-image: url('+p.item.photo_url+');"></i><b>'+p.item.name+
"</b>");l.val("");return!1}}).data("ui-autocomplete")._renderItem=function(m,p){return d('<li class="ui-menu-item-html"><div>'+p.value+"</div></li>").appendTo(m)};l.on("focus",function(){l.data("uiAutocomplete").search(l.val())});e.$wrapper.on("click",".js-email-copy-link, .email-copy-text-collapsed",function(m){m.preventDefault();m=e.$wrapper.find(".js-email-copy-link-icon");f.toggleClass("email-copy-wrapper-block");f.is(":visible")?(m.removeClass("fa-caret-right").addClass("fa-caret-down"),l.focus(),
n.removeClass("email-copy-wrapper-collapsed-block")):(m.removeClass("fa-caret-down").addClass("fa-caret-right"),e.$wrapper.find(".email-copy-text-collapsed").children().length&&n.addClass("email-copy-wrapper-collapsed-block"));e.$wrapper.closest(".js-reply-wrapper").trigger("resize")});g.on("click",function(){l.focus()});h.on("click",".email-copy-user",function(){var m=d(this).data("cc-contact-id"),p=d(this).data("cc-email"),q=d(this).html();b(m,p,q)});l.on("focusout",function(m){a()});l.on("keydown",
function(m){13==m.keyCode&&(m.preventDefault(),a())});k.on("click",".js-remove-cc",function(m){m.preventDefault();m=d(this).parent(".email-copy-user");var p=m.data("email");m.remove();e.$wrapper.find(".email-copy-text-collapsed").children('[data-email="'+p+'"]').remove()});l.on("keydown",function(m){if(8==m.keyCode&&0==l.val().length){m=e.$wrapper.find(".email-copy-text .email-copy-user:last");var p=m.data("email");m.remove();e.$wrapper.find(".email-copy-text-collapsed").children('[data-email="'+
p+'"]').remove();l.focus()}})};return CRMEmailConversationEmailSender}(jQuery),CRMImConversationSection=function(d){CRMImConversationSection=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$textarea=this.$form.find(".js-textarea");this.$submitButton=this.$form.find(".js-save-button");this.$attachment_icon=this.$form.find(".js-message-attachment");this.$skeleton_wrapper=this.$wrapper.closest(".c-messages-conversation-wrapper").find(".skeleton-wrapper");this.send_action_url=
a.send_action_url;this.file_template_html=a.file_template_html;this.hash=a.hash;this.max_upload_size=a.max_upload_size;this.is_images_enabled=a.is_images_enabled;this.is_files_enabled=a.is_files_enabled;this.hover_class="is-hover";this.files_controller=this.getFilesController();this.is_locked=!1;this.initClass()};CRMImConversationSection.prototype.initClass=function(){this.initSubmit()};CRMImConversationSection.prototype.getFilesController=function(){function a(m){m.length&&(d.each(m,function(p,q){p=
c.files_storage;var r=p.push,u=d(k);u.find(".js-name").text(q.name);f.prepend(u);c.$submitButton.prop("disabled")&&c.$submitButton.prop("disabled",!1);r.call(p,{$file:u,file:q})}),g.val(""))}function b(m){var p=[];d.each(c.files_storage,function(q,r){m[0]!==r.$file[0]?p.push(r):m.remove()});c.files_storage=p}var c=this,e=c.$form.find(".js-default-drop-area"),f=c.$form.find(".js-upload-list"),g=c.$form.find(".js-drop-field"),k=c.file_template_html,l=d.crm.app_url+"?module=file&action=uploadTmp";c.files_storage=
[];var h=0,n=0;c.$attachment_icon.on("click",function(){g.click()});g.on("change",function(m){m.preventDefault();a(this.files)});e.on("drop",function(m){m.preventDefault();a(m.originalEvent.dataTransfer.files)});e.on("dragover",function(m){m.preventDefault();e.addClass(c.hover_class);clearTimeout(n);n=setTimeout(function(){e.removeClass(c.hover_class)},100)});document.onpaste=function(m){m=(m.clipboardData||m.originalEvent.clipboardData).files;console.log(m);a(m)};c.$wrapper.on("click",".js-file-delete",
function(m){m.preventDefault();b(d(this).closest(".c-upload-item"));c.files_storage.length||""!==c.$textarea.val()||c.$submitButton.prop("disabled")||c.$submitButton.prop("disabled",!0)});return{uploadFiles:function(m,p,q){function r(t){function v(){var E=new FormData,z=document.cookie.match(/(?:^|; )_csrf=([^;]*)/);(z=z?decodeURIComponent(z[1]):"")&&E.append("_csrf",z);m&&m.length&&d.each(m,function(C,D){D.name&&D.value&&E.append(D.name,D.value)});E.append("file_size",t.file.size);E.append("files",
t.file);E.append("file_end",1);d.ajax({xhr:function(){var C=new window.XMLHttpRequest;C.upload.addEventListener("progress",function(D){D.lengthComputable&&(D=parseInt(D.loaded/D.total*100),B.css("--progress-value",D),100===D&&(B.css("background","transparent"),A.show()))},!1);return C},url:l,data:E,cache:!1,contentType:!1,processData:!1,type:"POST",success:function(C){setTimeout(function(){d.contains(document,x[0])&&(--h,0>=h&&u())},250)}}).always(function(){is_locked=!1})}var w="image"===t.file.type.split("/")[0]?
"image":"file";w=p?w===p:!1;var x=t.$file;x.find(".js-file-delete");var y=x.find(".js-status"),A=x.find(".js-progress-success-icon"),B=x.find(".js-bar");x.addClass("is-upload");c.max_upload_size>t.file.size?w?v():(--h,0>=h&&u()):(y.addClass("errormsg"),x.removeClass("is-upload"),c.is_locked=!1,c.$submitButton.prop("disabled",!1),c.$submitButton.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up"),c.$textarea.attr("disabled",!1),g.prop("disabled",!1),c.$form.find("button").prop("disabled",
!1))}var u=q?q:function(){};c.files_storage.length?(h=c.files_storage.length,d.each(c.files_storage,function(t,v){r(v)})):u()}}};CRMImConversationSection.prototype.initSubmit=function(){function a(){c.css("min-height",0);var l=c[0].scrollHeight;250>l?c.css("min-height",l+"px"):c.css("min-height","250px")}var b=this,c=b.$textarea,e=b.$submitButton;b.$form.find(".js-upload-list");var f=b.is_images_enabled?"files-":"",g=b.$form.find(".js-drop-field"),k=b.is_images_enabled?"file":!1;b.$message_list=d(".js-messages-list");
b.is_locked=!1;d(document).on("wa_before_load",function(){d(document).off("wa_before_load")});c.on("keydown",function(l){13!==l.keyCode&&10!==l.keyCode||l.ctrlKey||l.metaKey||l.shiftKey||(l.preventDefault(),""!==c.val()||b.files_storage.length?b.$form.submit():(c.addClass("shake animated"),setTimeout(function(){c.removeClass("shake animated")},500)))});c.on("keyup",function(l){if(13!==l.keyCode&&10!==l.keyCode||!(l.ctrlKey||l.metaKey||l.shiftKey))""!==c.val()||b.files_storage.length?e.prop("disabled")&&
e.prop("disabled",!1):e.prop("disabled")||e.prop("disabled",!0);else if(!l.shiftKey){var h=c.val(),n=c.prop("selectionStart");l=h.slice(0,n);h=h.slice(n);c.val(l+"\n"+h)}a()});b.$form.on("submit",function(l){function h(r){function u(){0==w&&d(document).trigger("scroll_button_event",r)}var t=b.$message_list.find("[data-id="+r+"]"),v=t[0].getElementsByTagName("img");t=t[0].getElementsByTagName("video");var w=v.length+t.length;u();for(var x=0;x<t.length;x++)3<=t[x].readyState?(w--,u()):(t[x].addEventListener("loadeddata",
function(){w--;u()}),t[x].addEventListener("error",function(){w--;u()}));for(x=0;x<v.length;x++)v[x].complete?(w--,u()):(v[x].addEventListener("load",function(){w--;u()}),v[x].addEventListener("error",function(){w--;u()}))}function n(){b.$form.find("#tooltip-error-message").removeClass("errormsg").html("");b.$form.off("change",n);c.off("focus",n)}function m(){e.prop("disabled",!1);e.find("svg").removeClass("fa-spinner fa-spin").addClass("fa-arrow-up");c.attr("disabled",!1);g.prop("disabled",!1);b.$form.find("button").prop("disabled",
!1);c.val("");if(b.files_storage.length){var r=b.$form.find(".c-upload-item");d.each(r,function(u,t){t.remove()});b.files_storage=[]}}l.preventDefault();if(!b.is_locked){var p=function(){var r=b.send_action_url,u=b.$form.serializeArray();c.attr("disabled",!0);g.prop("disabled",!0);d.post(r,u,function(t){if("ok"===t.status){var v=jQuery.parseJSON(t.data.html);t=t.data.message_id;b.$message_list.append(v);m();h(t);e.prop("disabled",!0);a()}else{console.error(t);var w=b.$form.find("#tooltip-error-message");
v=Object.values(t.errors);w.addClass("errormsg");d.each(v,function(x,y){w.append('<span><i class="fas fa-exclamation-triangle state-error"></i> <span class="small">'+y+"</span></span>")});c.addClass("shake animated");setTimeout(function(){c.removeClass("shake animated")},500);b.is_locked=!1;m();e.prop("disabled",!0);a();c.on("focus",n);b.$form.on("change",n)}}).always(function(){b.is_locked=!1})};b.is_locked=!0;e.prop("disabled",!0);e.find("svg").removeClass("fa-arrow-up").addClass("fa-spinner fa-spin");
b.$form.find("button").prop("disabled",!0);if(b.is_images_enabled||b.is_files_enabled){l=function(){b.files_controller.uploadFiles(q,k,p)};var q=[{name:"hash",value:f+b.hash}];b.is_images_enabled?b.files_controller.uploadFiles([{name:"hash",value:"photos-"+b.hash}],"image",l):l()}}})};return CRMImConversationSection}(jQuery),CRMConversationAssociateDealDialog=function(d){CRMConversationAssociateDealDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$footer=this.$wrapper.find(".js-dialog-footer");
...
function(){function a(){var c=d('<span class="icon size-16"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>'),e=d.crm.app_url+"?module=message&action=conversationAssociateDealSave",f=b.$form.serializeArray();b.$submit.prop("disabled",!0);b.$footer.append(c);d.post(e,f,function(g){"ok"===g.status?(d.crm.content.reload(),b.$dialog.close()):(b.$submit.prop("disabled",!1),c.remove())})}var b=this;b.$form.on("submit",function(c){c.preventDefault();if(!b.$deal_id.val())return b.$wrapper.addClass("shake animated"),
setTimeout(function(){b.$wrapper.removeClass("shake animated")},500),!1;if(0==b.$deal_id.val()&&!d.trim(b.$deal_name.val()))return b.$deal_name.addClass("shake animated"),setTimeout(function(){b.$deal_name.removeClass("shake animated")},500),!1;a()})};return CRMConversationAssociateDealDialog}(jQuery);var CRMPageMessagesOperations=function(d){CRMPageMessagesOperations=function(a){this.$wrapper=a.$wrapper;this.$bar=this.$wrapper.find(".js-operations-wrapper");this.$content=this.$wrapper.find(".js-messages-conversation-list");this.page=a.page||1;this.limit=a.limit||30;this.total_count=a.total_count||0;this.total_items_at_page_count=this.getTotalItemsAtPage()||0;this.view=a.view||"all";this.locales=a.locales||[];this.checked_count=0;this.read_list=[];this.unread_list=[];this.unread_counter=this.read_counter=
0;this.deal_list=[];this.deal_counter=0;this.no_deal_list=[];this.no_deal_counter=0;this.is_shown=0<this.checked_count;this.is_checked_all=!1;this.initClass()};CRMPageMessagesOperations.prototype.initClass=function(){};CRMPageMessagesOperations.prototype.initElasticHeader=function(){function a(){d.contains(document,f[0])?c.scrollTop()>g.top?(f.addClass("is-fixed").css({left:g.left,width:k}),l=!0):(f.removeClass("is-fixed").removeAttr("style"),l=!1):c.off("scroll",a)}function b(){d.contains(document,
f[0])?(k=e.outerWidth(),l&&f.width(k)):c.off("resize",b)}var c=d(window),e=this.$wrapper.find(".js-messages-section"),f=this.$bar,g=e.offset(),k=f.outerWidth(),l=!1;c.on("scroll",a).on("resize",b)};CRMPageMessagesOperations.prototype.initCheckboxAll=function(){var a=this;a.$checkbox_all.click(function(){var b=d(this),c=b.is(":checked");0<a.checked_count?a.checked_count<a.total_items_at_page_count||a.checked_count===a.total_items_at_page_count?a.unselectAll():a.selectAll():(b.prop("checked",c),c?a.selectAll():
a.unselectAll());a.formBar();a.showOrHideBar()})};CRMPageMessagesOperations.prototype.initOperations=function(){var a=this;a.$bar.on("click",".crm-operation-link",function(b){b.preventDefault();switch(d(this).data("id")){case "associate":a.associateWithDeal();break;case "detach":a.detachFromDeals();break;case "read":a.markAsRead();break;case "unread":a.markAsUnread();break;case "delete":a.deleteConversation()}})};CRMPageMessagesOperations.prototype.updateBarCount=function(a,b){a.find(".crm-count").text("("+
b+")")};CRMPageMessagesOperations.prototype.showOrHideBar=function(){0<this.checked_count?(this.is_shown||(this.$bar.addClass("is-shown"),this.$list_header.removeClass("is-shown"),this.is_shown=!0),this.formBar()):this.is_shown&&(this.$bar.removeClass("is-shown"),this.$list_header.addClass("is-shown"),this.is_shown=!1)};CRMPageMessagesOperations.prototype.getSelectedIds=function(){return this.$list.find(".c-checkbox :checkbox:checked").map(function(){return parseInt(d(this).val())}).toArray()};CRMPageMessagesOperations.prototype.getTotalItemsAtPage=
function(){return this.page*this.limit>this.total_count?this.total_count%this.limit:this.limit};CRMPageMessagesOperations.prototype.formBar=function(){var a=this.$bar.find('.crm-operation-li[data-id="associate"]'),b=this.$bar.find('.crm-operation-li[data-id="detach"]'),c=this.$bar.find('.crm-operation-li[data-id="read"]'),e=this.$bar.find('.crm-operation-li[data-id="unread"]'),f=this.$bar.find('.crm-operation-li[data-id="delete"]');0<this.unread_counter?(c.show(),this.updateBarCount(c,this.unread_counter)):
c.hide();0<this.read_counter?(e.show(),this.updateBarCount(e,this.read_counter)):e.hide();0<this.no_deal_counter?(a.show(),this.updateBarCount(a,this.no_deal_counter)):a.hide();0<this.deal_counter?(b.show(),this.updateBarCount(b,this.deal_counter)):b.hide();0<this.checked_count?(f.show(),this.updateBarCount(f,this.checked_count)):f.hide()};CRMPageMessagesOperations.prototype.initItemCheckbox=function(){var a=this;a.$list.on("change",".js-checkbox",function(b,c){var e=d(this);b=e.closest(".js-message-wrapper");
"undefined"!==typeof c&&e.attr("checked",c);a.markAsReadList(b);a.markAsUnreadList(b);a.associateWithDealList(b);a.detachFromDealsList(b);(c=b.find(".js-checkbox").is(":checked"))?b.addClass("is-active"):b.removeClass("is-active");a.is_checked_all?(a.is_checked_all=!1,a.checked_count=a.$list.find(".c-checkbox :checkbox:checked").length):c?a.checked_count+=1:--a.checked_count;a.formBar();a.showOrHideBar();0<a.checked_count?a.checked_count<a.limit&&a.checked_count!==a.total_items_at_page_count?a.$checkbox_all.prop("indeterminate",
!0):a.$checkbox_all.prop("indeterminate",!1).prop("checked",!0):a.$checkbox_all.prop("indeterminate",!1).prop("checked",!1)});a.$list.on("click",".c-checkbox",function(b){b=d(b.target).is(":checkbox");b||b||(b=d(this).find(".js-checkbox"),b.trigger("change",[!b.is(":checked")]))});a.$list.shiftSelectable({selector:".js-message-wrapper",behavior_type:"vertical",onSelect:function(b,c){var e=d(c.target);e=!(!e.is("a")&&!e.closest("a").length);var f=c.extra.is_first;c=c.extra.is_last;e||f||c||(b=b.find(".js-checkbox"),
b.attr("checked",!0),b.trigger("change"))}})};CRMPageMessagesOperations.prototype.selectAll=function(){this.$list.find(".c-checkbox :checkbox").prop("checked",!0).trigger("change",[!0]);this.checked_count=this.getSelectedIds().length;this.is_checked_all=!0};CRMPageMessagesOperations.prototype.unselectAll=function(){this.$list.find(".c-checkbox :checkbox").prop("checked",!1).trigger("change",[!1]);this.$checkbox_all.prop("checked",!1);this.checked_count=0;this.is_checked_all=!1};CRMPageMessagesOperations.prototype.associateWithDeal=
function(){var a=this.no_deal_list;1===a.length?this.$list.find('tr[data-id="'+a[0]+'"] .js-associate-deal').trigger("click"):d.get("/webasyst/crm/?module=message&action=conversationAssociateDealDialog&conversation_id="+a[0],function(b){new CRMDialog({html:b})})};CRMPageMessagesOperations.prototype.associateWithDealList=function(a){var b=this,c=a.data("has-deal");a=a.data("id");c||-1!==b.no_deal_list.indexOf(a)||b.no_deal_list.push(a);b.no_deal_list=b.getSelectedIds().filter(function(e){return-1<
b.no_deal_list.indexOf(e)});b.no_deal_counter=b.no_deal_list.length};CRMPageMessagesOperations.prototype.detachFromDeals=function(){var a=this,b=a.$wrapper.find(".crm-dialog-wrapper.js-detach-conversation").clone(),c=a.view,e=a.deal_list,f={message_ids:e},g="detachDeals";"conversation"===c&&(f={conversation_ids:e},g="detachDealsFromConversations");var k=d.crm.app_url+"?module=messageOperation&action="+g,l=function(h,n){new CRMDialog({html:b.show(),onOpen:function(m){m=m.find(".crm-dialog-content");
m.find(".js-confirm-text").html(h);m=m.find(".js-check-text").hide();n=d.trim(n);0<n.length&&(m.find(".js-text").text(n),m.show())},onConfirm:function(){d.post(k,f).done(function(m){var p=Object.keys(f)[0];m=m.data[p];m.length&&(m.forEach(function(q){var r='<a href="javascript:void(0);" class="inline-link small js-associate-deal nowrap" data-dialog-url="'+d.crm.app_url+"?module=message&action=conversationAssociateDealDialog&conversation_id="+q+'"><i class="icon10 add" style="vertical-align: baseline; margin: 0 4px 0 0;"></i><b><i>'+
a.locales.associate_with_deal+"</i></b></a>";"all"===c&&(r="");d('tr[data-id="'+q+'"]',a.$list).data("has-deal",0).attr("data-has-deal",0).find(".c-column-deal").html(r);a.no_deal_list.push(q);a.deal_list=a.deal_list.splice(q,1)}),a.no_deal_counter=a.no_deal_list.length,a.deal_counter=a.deal_list.length,a.formBar())}).fail(function(m){console.error("Detach Deals From Conversations",m)})},onClose:function(m){m.find(".crm-dialog-content").empty()}})};(function(){if("conversation"===c){var h=d.extend({check:1},
f,!0);return d.post(k,h)}return d.Deferred().resolve({})})().done(function(h){l("<h2>"+a.locales.detach_dialog_h2+"</h2>","ok"===h.status&&h.data&&h.data.text||"")})};CRMPageMessagesOperations.prototype.detachFromDealsList=function(a){var b=this,c=a.data("has-deal");a=a.data("id");c&&-1===b.deal_list.indexOf(a)&&b.deal_list.push(a);b.deal_list=b.getSelectedIds().filter(function(e){return-1<b.deal_list.indexOf(e)});b.deal_counter=b.deal_list.length};CRMPageMessagesOperations.prototype.markAsRead=function(){var a=
this,b=d.crm.app_url+"?module=messageOperation&action=markAsRead",c=a.unread_list,e={message_ids:c};"conversation"===a.view&&(e={conversation_ids:c});d.post(b,e).done(function(f){var g=Object.keys(e)[0];f=f.data[g];f.length&&(f.map(function(k){a.$list.find('tr[data-id="'+k+'"]').removeClass("bold").data("read",1).attr("data-read",1);a.read_list.push(k);a.unread_list=a.unread_list.splice(k,1)}),a.read_counter=a.read_list.length,a.unread_counter=a.unread_list.length,a.formBar())}).fail(function(f){console.error("Mark as read",
f)})};CRMPageMessagesOperations.prototype.markAsReadList=function(a){var b=this,c=a.data("id");1===a.data("read")&&-1===b.read_list.indexOf(c)&&b.read_list.push(c);b.read_list=b.getSelectedIds().filter(function(e){return-1<b.read_list.indexOf(e)});b.read_counter=b.read_list.length};CRMPageMessagesOperations.prototype.markAsUnread=function(){var a=this,b=d.crm.app_url+"?module=messageOperation&action=markAsUnread",c=a.read_list,e={message_ids:c};"conversation"===a.view&&(e={conversation_ids:c});d.post(b,
e).done(function(f){var g=Object.keys(e)[0];f=f.data[g];f.length&&(f.map(function(k){a.$list.find('tr[data-id="'+k+'"]').addClass("bold").data("read",0).attr("data-read",0);a.unread_list.push(k);a.read_list=a.read_list.splice(k,1)}),a.unread_counter=a.unread_list.length,a.read_counter=a.read_list.length,a.formBar())}).fail(function(f){console.error("Mark as unread",f)})};CRMPageMessagesOperations.prototype.markAsUnreadList=function(a){var b=this,c=a.data("id");0===a.data("read")&&-1===b.unread_list.indexOf(c)&&
b.unread_list.push(c);b.unread_list=b.getSelectedIds().filter(function(e){return-1<b.unread_list.indexOf(e)});b.unread_counter=b.unread_list.length};CRMPageMessagesOperations.prototype.deleteConversation=function(){var a=this,b=a.$wrapper.find(".js-delete-conversation").clone(),c=a.view,e=a.getSelectedIds(),f={message_ids:e},g="delete";"conversation"===c&&(f={conversation_ids:e},g="deleteConversations");var k=d.crm.app_url+"?module=messageOperation&action="+g,l=function(h,n){new CRMDialog({html:b.show(),
onOpen:function(m){m=m.find(".crm-dialog-content");m.find(".js-confirm-text").html(h);m=m.find(".js-check-text").hide();n=d.trim(n);0<n.length&&(m.find(".js-text").text(n),m.show())},onConfirm:function(){d.post(k,f).done(function(m){var p=Object.keys(f)[0];m=m.data[p];m.length&&(m.map(function(q){d('tr[data-id="'+q+'"]',a.$list).hide()}),a.checked_count-=e.length,a.total_count-=e.length,a.unselectAll(),a.formBar(),1>a.total_count&&(a.$list.hide().before('<div class="no-messages">'+a.locales.no_messages+
"</div>"),a.unselectAll(),a.hideBar()))}).fail(function(m){console.error("Delete messages",m)})},onClose:function(m){m.find(".crm-dialog-content").empty()}})};(function(){if("conversation"===c){var h=d.extend({check:1},f,!0);return d.post(k,h)}return d.Deferred().resolve({})})().done(function(h){l("<h2>"+a.locales.delete_dialog_h2+"</h2>","ok"===h.status&&h.data&&h.data.text||"")})};return CRMPageMessagesOperations}(jQuery);var CRMSendEmailDialog=function(d){function a(b){(b=b.data("redactor"))&&"core"in b&&b.core.destroy()}CRMSendEmailDialog=function(b){this.$wrapper=b.$wrapper;this.$form=this.$wrapper.find("form");this.$textarea=this.$wrapper.find(".js-wysiwyg");this.$sender_email_select=this.$wrapper.find(".js-sender-email-select");this.$sender_email=this.$wrapper.find(".js-sender-email");this.$to_input=this.$wrapper.find(".js-to-input");this.$to_id=this.$wrapper.find(".js-to-id");this.dialog=this.$wrapper.data("dialog");
...
"reply"!=b.action||b.deal_id||b.initSelectDeal();!b.iframe&&b.dialog.resize();b.iframe&&(console.log(d(window.parent).width()),760>d(window.parent).width()&&d(".dialog .dialog-content",window.parent.document).css("padding","0 0.75rem"),b.$wrapper.on("click",".js-close-dialog",function(c){c.preventDefault();d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close"));a(b.$textarea)}))};CRMSendEmailDialog.prototype.getFilesController=function(){function b(r){r.length&&d.each(r,function(u,
t){u=m;var v=u.push,w=d(h);w.find(".js-name").text(t.name);l.prepend(w);!e.iframe&&e.dialog.resize();v.call(u,{$file:w,file:t})})}function c(r){var u=[];d.each(m,function(t,v){r[0]!==v.$file[0]?u.push(v):r.remove()});m=u}var e=this,f=e.$wrapper.find(".js-files-wrapper");if(!f.length)return!1;var g=e.$wrapper.find(".js-drop-area"),k=e.$wrapper.find(".js-drop-field"),l=f.find(".c-upload-list"),h=e.file_template_html,n=e.app_url+"?module=file&action=uploadTmp",m=[],p=0,q=0;k.on("change",function(r){r.preventDefault();
b(this.files)});g.on("drop",function(r){r.preventDefault();b(r.originalEvent.dataTransfer.files)});g.on("dragover",function(r){r.preventDefault();g.addClass("is-hover");clearTimeout(q);q=setTimeout(function(){g.removeClass("is-hover")},100)});f.on("click",".js-file-delete",function(r){r.preventDefault();c(d(this).closest(".c-upload-item"))});return{uploadFiles:function(r,u){function t(w){function x(){var D=new FormData,F=document.cookie.match(/(?:^|; )_csrf=([^;]*)/);(F=F?decodeURIComponent(F[1]):
"")&&D.append("_csrf",F);r&&r.length&&d.each(r,function(G,H){H.name&&H.value&&D.append(H.name,H.value)});D.append("file_size",w.file.size);D.append("files",w.file);D.append("file_end",1);d.ajax({xhr:function(){var G=new window.XMLHttpRequest;G.upload.addEventListener("progress",function(H){H.lengthComputable&&(H=parseInt(H.loaded/H.total*100),A.css("--progress-value",H),100===H&&(A.css("background","transparent"),B.show()))},!1);return G},url:n,data:D,cache:!1,contentType:!1,processData:!1,type:"POST",
success:function(G){setTimeout(function(){d.contains(document,y[0])&&(y.remove(),--p,0>=p&&v())},2E3)}}).always(function(){e.is_locked=!1})}e.is_locked=!0;var y=w.$file,A=y.find(".js-bar"),B=A.find(".js-progress-success-icon"),E=y.find(".js-status");y.addClass("is-upload");if(e.max_upload_size>w.file.size)x();else{E.addClass("errormsg");y.removeClass("is-upload");e.is_locked=!1;E=e.$form.find(".js-submit-button");var z=e.$form.find(".js-drop-field"),C=e.$form.find(".submit-loader");E.attr("disabled",
!1);z.attr("disabled",!1);C.remove();e.$form.find("button").prop("disabled",!1)}}var v=u?u:function(){};m.length?(p=m.length,d.each(m,function(w,x){t(x)})):v()}}};CRMSendEmailDialog.prototype.initWYSIWYG=function(){var b=this,c=b.$textarea,e=0;b.iframe||(b.dialog.onClose=function(){a(c)});b.crm.initWYSIWYG(c,{allowedAttr:[["section","data-role"]],callbacks:{change:function(){var f=b.iframe?0:b.dialog.$block.height();e&&e===f||(e=f,!b.iframe&&b.dialog.resize())}}});b.body&&c.redactor("code.set",b.body)};
CRMSendEmailDialog.prototype.initSendMessage=function(){var b=this,c=b.$wrapper.find(".js-to-email"),e=b.$to_id,f=b.$wrapper.find(".js-to-new-name");b.is_locked=!1;b.$form.on("submit",function(k){k.preventDefault();if(!(0!=e.val()||d.trim(f.val())&&d.trim(c.val())||"new"!=b.action&&"forward"!=b.action))return d(".js-to-input, .js-to-add-name, .js-to-add-email").addClass("shake animated").focus(),setTimeout(function(){d(".js-to-input, .js-to-add-name, .js-to-add-email").removeClass("shake animated").focus()},
500),!1;if(!d.trim(c.val()))return b.$to_input.addClass("shake animated").focus(),setTimeout(function(){b.$to_input.removeClass("shake animated").focus()},500),!1;if(!b.is_locked){b.is_locked=!0;k=b.$form.find(".js-submit-button");var l=b.$form.find(".js-drop-field"),h=d('<span class="icon size-16 submit-loader"><i class="fas fa-spinner wa-animation-spin custom-mr-4"></i></span>');k.attr("disabled",!0);h.insertAfter(k);l.attr("disabled",!0);b.$form.find("button").prop("disabled",!0);b.filesController.uploadFiles([{name:"hash",
value:b.hash}],g)}});var g=function(){var k=b.send_action_url,l=b.$form.serializeArray(),h=function(n,m){if(!d.isEmptyObject(n)){n=d.extend(!0,{},n);var p=b.locales.send_error_title||"Send error",q=b.locales.send_error_text||"Can't send email message";q=d(b.error_html).find(".js-error-text").text(q).end();var r=n.common;b.is_admin&&(r?(q.find(".js-technical-info-block.js-known-error").show(),q.find(".js-technical-info-text").text(r)):q.find(".js-technical-info-block.js-unknown-error").show());d.crm.alert.show({title:p,
text:q.get(0).outerHTML,button:b.locales.close||"close",button_class:"red",onOpen:function(u){u.find(".js-technical-info-link").one("click",function(){d(this).remove();u.find(".js-technical-info-text").show()})}});delete n.common;d.isEmptyObject(n)||console.log.error(n)}m&&console.log.error(m)};d.post(k,l,"json").done(function(n){if("ok"===n.status){a(b.$textarea);b.$wrapper.find(".dialog-body").html(b.success_html);!b.iframe&&b.dialog.resize();var m=null;b.iframe||(b.dialog.onClose=function(){m&&
clearTimeout(m);m=null;b.crm.content.reload()});m=setTimeout(function(){b.iframe?d(".dialog iframe",window.parent.document)[0].dispatchEvent(new Event("close")):b.dialog.close()},2500)}else!b.iframe&&b.dialog.close(),d.isEmptyObject(n.errors)?h({common:"Send error"},n):h(n.errors)}).always(function(){b.is_locked=!1}).fail(function(n){h({},n);!b.iframe&&b.dialog.close()})}};CRMSendEmailDialog.prototype.initPersonalSettingsDialog=function(){function b(){c.is_locked||(c.is_locked=!0,d.post(c.crm.app_url+
...
b.$sender_email_select,function(c){c.preventDefault();b.$sender_email.val(b.$sender_email_select.val())})};CRMSendEmailDialog.prototype.initEmailTo=function(){function b(){var v=d.trim(k.val()).split(/\s+/),w=!1;d.each(v,function(x,y){d.crm.check.email(y)&&!w&&(g=y.replace(/<|>/g,""),w=x)});!1!==w&&v.splice(w,1);f=v.join(" ");g&&f&&(v='<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b>'+d.crm.escape(f)+'</b> <span style="color: #999;">&lt;'+d.crm.escape(g)+"&gt;</span></span>",
c(0,g,v),h.val(d.crm.escape(f)));if(f&&!g)return v='<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b>'+d.crm.escape(f)+'</b></span> <input class="c-to-input js-to-add-email" type="text" autocomplete="off" placeholder="'+e.locales.type_email+'" style="margin-left: 8px; width: 150px;" />',c(0,null,v),h.val(d.crm.escape(f)),d(".js-to-add-email").focus(),!1;if(g&&!f)return v='<input class="c-to-input js-to-add-name" type="text" autocomplete="off" placeholder="'+e.locales.type_name+
'" style="margin-right: 8px; width: 150px;" > <span class="js-edit-recipient" title="'+e.locales.edit_recipient+'" style="color: #999;">&lt;'+d.crm.escape(g)+"&gt;</span>",c(0,g,v),d(".js-to-add-name").focus(),!1}function c(v,w,x){m.prepend('<div class="c-email-to-user js-email-to-user">'+x+' <a title="'+e.locales.change_recipient+'" class="c-remove-to-email js-remove-to-email text-gray"><i class="icon fas fa-times-circle delete"></i></a></div>');p.removeClass("hidden");k.addClass("hidden").val("");
l.val(w);n.val(v).trigger("change")}var e=this,f=null,g=null,k=e.$to_input,l=e.$wrapper.find(".js-to-email"),h=e.$wrapper.find(".js-to-new-name"),n=e.$to_id,m=e.$wrapper.find(".js-to-name"),p=e.$wrapper.find(".js-deal-field"),q=e.$wrapper.find(".js-select-funnel"),r=e.$wrapper.find(".js-select-deal .js-visible-link .js-text"),u=e.$wrapper.find(".js-deals-list"),t=e.$wrapper.find(".js-create-new-deal");k.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",appendTo:e.$wrapper,
minLength:0,focus:function(){return!1},select:function(v,w){v=w.item;w=(v.criteria||{}).email||v.email;c(v.id,w,'<i class="icon userpic" style="background-image: url('+v.photo_url+');"></i>'+v.name+' <span style="color: #999;">&lt;'+w+"&gt;</span>");return!1}}).data("ui-autocomplete")._renderItem=function(v,w){return d('<li class="ui-menu-item-html"><div>'+w.value+"</div></li>").appendTo(v)};k.on("focus",function(){k.data("uiAutocomplete").search(k.val())});k.on("keydown",function(v){if(13==v.keyCode)return v.preventDefault(),
k.blur(),!1});k.on("focusout",function(v){v.preventDefault();b();return!1});m.on("click",".js-remove-to-email",function(){d(this).parent(".js-email-to-user").remove();k.removeClass("hidden").focus();p.addClass("hidden");q.addClass("hidden");u.html(t);r.html(""+e.locales.deal_select);l.val("");h.val("");n.val("").trigger("change");g=f=null});e.$wrapper.on("click",".js-edit-recipient",function(){var v=[f,g].join(" ");k.val(d.trim(v)).removeClass("hidden").focus();d(".js-email-to-user").remove();g=f=
null;l.val("");h.val("")});e.$wrapper.on("keydown",".js-to-add-email",function(v){13==v.keyCode&&(v.preventDefault(),d(this).blur())});e.$wrapper.on("focusout",".js-to-add-email",function(){var v=d(".js-to-add-email"),w=d.trim(v.val());w.length&&!0===d.crm.check.email(w)&&(g=w,l.val(d.crm.escape(w)),v.before(d('<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'" style="color: #999;"></span>').text("<"+w+">")).remove())});e.$wrapper.on("keydown",".js-to-add-name",function(v){13==v.keyCode&&
(v.preventDefault(),d(this).blur())});e.$wrapper.on("focusout",".js-to-add-name",function(){var v=d.trim(d(".js-to-add-name").val());v.length&&(f=v,h.val(d.crm.escape(v)),d(".js-to-add-name:first-child").before(d('<span class="js-edit-recipient" title="'+e.locales.edit_recipient+'"><b></b></span>').text(v)).remove())})};CRMSendEmailDialog.prototype.initEmailCopy=function(){function b(){var p=d.trim(h.val()).split(/[,:;]/);if(p[0].length)return d.each(p,function(q,r){q=d.trim(r).split(/\s+/);var u=
!1,t=r=null;d.each(q,function(v,w){d.crm.check.email(w)&&!u&&(r=w.replace(/<|>/g,""),u=v)});!1!==u&&q.splice(u,1);t=q.join(" ");r&&t&&e(0,r,t);r&&!t&&c(0,r,r);t&&!r&&(h.addClass("shake animated"),setTimeout(function(){h.removeClass("shake animated")},500));u=!1;t=r=null}),!1}function c(p,q,r){l.children('[data-email="'+q+'"]').length&&"0"!==p||!q.length||(d(".email-copy-input-div").before('<div class="email-copy-user" title="'+d.crm.escape(q)+'" data-contact-id="'+d.crm.escape(p)+'" data-email="'+
d.crm.escape(q)+'">'+r+' <a title="'+f.locales.remove_form_cc+'" class="remove-cc js-remove-cc">x</a> <input name="cc['+d.crm.escape(q)+'][email]" type="hidden" value="'+d.crm.escape(q)+'" /><input name="cc['+d.crm.escape(q)+'][id]" type="hidden" value="'+d.crm.escape(p)+'" /></div>'),d(".email-copy-text-collapsed").append('<div class="email-copy-user" title="'+d.crm.escape(q)+'" data-email="'+d.crm.escape(q)+'">'+r+"</div>"));h.val("").focus()}function e(p,q,r){l.children('[data-email="'+q+'"]').length&&
...
d.crm.escape(r)+'" /></div>'),d(".email-copy-text-collapsed").append('<div class="email-copy-user" title="'+d.crm.escape(q)+'" data-email="'+d.crm.escape(q)+'">'+d.crm.escape(r)+"</div>"));h.val("").focus()}var f=this,g=f.$wrapper.find(".email-copy-wrapper"),k=g.find(".email-copy-area"),l=k.find(".email-copy-text"),h=k.find(".email-copy-input"),n=g.find(".deal-participants-area"),m=f.$wrapper.find(".email-copy-wrapper-collapsed");h.autocomplete({source:d.crm.app_url+"?module=autocomplete&emailcomplete=true",
appendTo:f.$wrapper,minLength:0,focus:function(){return!1},select:function(p,q){p=q.item;c(p.id,(p.criteria||{}).email||p.email,'<i class="icon userpic" style="background-image: url('+p.photo_url+');"></i>'+p.name);h.val("");return!1}}).data("ui-autocomplete")._renderItem=function(p,q){return d('<li class="ui-menu-item-html"><div>'+q.value+"</div></li>").appendTo(p)};h.on("focus",function(){h.data("uiAutocomplete").search(h.val())});f.$wrapper.on("click",".js-email-copy-link, .email-copy-text-collapsed",
function(p){p.preventDefault();p=f.$wrapper.find(".js-email-copy-link-icon");g.toggleClass("email-copy-wrapper-block");g.is(":visible")?(p.removeClass("fa-caret-right").addClass("fa-caret-down"),h.focus(),m.removeClass("email-copy-wrapper-collapsed-block")):(p.removeClass("fa-caret-down").addClass("fa-caret-right"),d(".email-copy-text-collapsed").children().length&&m.addClass("email-copy-wrapper-collapsed-block"))});k.on("click",function(){h.focus()});n.on("click",".email-copy-user",function(){var p=
d(this).data("cc-contact-id"),q=d(this).data("cc-email"),r=d(this).html();c(p,q,r)});h.on("focusout",function(p){b()});h.on("keydown",function(p){13==p.keyCode&&(p.preventDefault(),b())});l.on("click",".js-remove-cc",function(p){p.preventDefault();p=d(this).parent(".email-copy-user");var q=p.data("email");p.remove();d(".email-copy-text-collapsed").children('[data-email="'+q+'"]').remove()});h.on("keydown",function(p){if(8==p.keyCode&&0==h.val().length){p=d(".email-copy-text .email-copy-user:last");
var q=p.data("email");p.remove();d(".email-copy-text-collapsed").children('[data-email="'+q+'"]').remove();h.focus()}})};CRMSendEmailDialog.prototype.initSelectDeal=function(){function b(){var m=h.val();l.val("none");m&&d.get("?module=deal&action=byContact&id="+m,function(p){"ok"===p.status&&d.each(p.data.deals,function(q,r){k.prepend('<li><a href="javascript:void(0);" class="js-deal-item" data-deal-id="'+r.id+'"><span class="js-text flexbox"><i class="fas fa-circle funnel-state" style="color: '+
p.data.funnels[r.funnel_id].stages[r.stage_id].color+'"></i><span class="flexbox">'+r.name+"</span></span></a></li>")})},"json")}var c=this,e=c.$form.find(".js-select-deal .js-visible-link .js-text"),f=c.$form.find(".js-select-funnel"),g=c.$wrapper.find(".js-deal-field"),k=c.$form.find(".js-deals-list"),l=c.$form.find(".js-deal-id"),h=c.$to_id,n=c.$form.find(".js-empty-deal");c.$form.on("click",".js-create-new-deal",function(){var m=d(this).find(".js-text").html();f.removeClass("hidden");n.removeClass("c-empty-deal-hidden");
e.html(m);l.val("0")});n.on("click",function(){d(this).addClass("c-empty-deal-hidden");f.addClass("hidden");k.find("li").removeClass("selected");e.html(c.locales.deal_empty);l.val("none")});c.$form.on("click",".js-deal-item",function(){var m=d(this).find(".js-text").html();k.find("li").removeClass("selected");d(this).parent().addClass("selected");e.html(m);n.removeClass("c-empty-deal-hidden");f.addClass("hidden");l.val(d(this).data("deal-id"))});"reply"==c.action&&b();"new"==c.action&&0<h.val()&&
(b(),g.removeClass("hidden"));h.on("change",b);k.on("click",function(){k.hide();setTimeout(function(){k.removeAttr("style")},200)});c.$form.on("change",".js-select-deal-funnel",function(){c.$form.find(".js-select-stage-wrapper").load("?module=deal&action=stagesByFunnel&id="+d(this).val())})};return CRMSendEmailDialog}(jQuery);var CRMSendSmsDialog=function(d){CRMSendSmsDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$textarea=this.$wrapper.find(".js-send-sms-textarea");this.dialog=this.$wrapper.data("dialog");this.success_html=a.success_html;this.error_html=a.error_html;this.hash=a.hash;this.send_action_url=a.send_action_url;var b=!1;window&&window.parent&&window.parent.$&&window.parent.$.crm?b=window.parent.$.crm:window.$&&window.$.crm&&(b=window.$.crm);this.crm=b;this.action=a.action;
...
h=l.find("a").length;k.length||k.push({id:!1,name:b.locales.no_segments});d.each(k,function(n,m){n="javascript:void(0);";var p="",q='<span class="hint">'+m.name+"</span>";m.id&&(n=d.crm.app_url+"contact/segment/"+m.id+"/",p='<i class="icon16 '+(m.icon?m.icon:"folder-dynamic")+'"></i>',q="<span>"+m.name+"</span>");m='<a href="'+n+'">'+p+q+"</a>";h&&(m=","+m);l.append(m);h=!0})}var b=this,c=b.$wrapper.find(".crm-contact-assign-segments"),e=d.crm.app_url+"?module=contactOperation&action=addToSegments&is_assign=1",
...
f.hide();setTimeout(function(){f.removeAttr("style")},200);g=g.data("id");e.val(g).trigger("change");(g=a.funnels[g]||!1)&&b.trigger("changeFunnel",g)});d.crm.renderSVG(b)})();(function(){function c(h){l.html("");d.each(h,function(n,m){n=a.stage_template_html;var p=d("<div />").text(m.name).html();n=n.replace("%id%",m.id).replace("%color%",m.color).replace("%name%",p);m=d(n);l.append(m)});d.crm.renderSVG(f);l.find("li:first-child a").trigger("click")}var e=a.$wrapper.find(".js-funnels-list"),f=a.$wrapper.find(".js-funnel-stages-list"),
g=f.find(".js-visible-link"),k=f.find(".js-field"),l=f.find(".menu-v");l.on("click","a",function(){var h=d(this);g.find(".js-text").html(h.html());l.find(".selected").removeClass("selected");h.closest("li").addClass("selected");l.hide();setTimeout(function(){l.removeAttr("style")},200);h=h.data("id");k.val(h)});e.on("changeFunnel",function(h,n){c(n.stages)})})();(function(){function c(){var k=d.datepicker._defaults.dateFormat,l=!1;try{d.datepicker.parseDate(k,f.val()),l=!0}catch(h){}l?(f.data("last-correct-value",
...
e=c.find(".js-view-toggle"),f=e.find(".is-active");e.on("click",".c-toggle",function(g){g.preventDefault();g=d(this);var k=g.data("id");if(g.hasClass("is-active"))return!1;a.contact_mode=k;f.length&&f.removeClass("is-active");g.addClass("is-active");f=g;c.find(".c-hidden.is-active").removeClass("is-active");c.find(".c-hidden-"+k).addClass("is-active")})})()};CRMNewContactPage.prototype.initCreate=function(){function a(){function g(){var m=e.$wrapper.find(".js-option-field:checked"),p=e.$wrapper.find(".js-vault-toggle"),
q=e.$wrapper.find(".js-owners-list");m.length&&(m=m.val(),"vaults"===m?(p=p.find(".js-field").val(),n.data.push({name:"vault_id",value:p})):"owners"===m&&(p=q.find(".c-owner"),p.length||n.errors.push({name:"owner[autocomplete]"}),p.each(function(){var r=d(this).data("id");0<r&&n.data.push({name:"owners[]",value:r})})))}function k(){var m=e.$segmentsSection.find("form").serializeArray();d.each(m,function(p,q){n.data.push(q)})}function l(){var m=e.$dealSection.find("form").serializeArray(),p=!0;d.each(m,
function(q,r){n.data.push(r);0<d.trim(r.value).length&&"deal[name]"===r.name&&(p=!1)});p&&n.errors.push({name:"deal[name]",value:e.locales.empty_deal_name})}function h(){var m=e.$extendedFieldsW.data("getFormData")();d.each(m.data,function(p,q){n.data.push(q)});d.each(m.errors,function(p,q){n.errors.push(q)})}var n={data:[],errors:[]};(function(){var m=e.$contactSection.find("form.c-general-form"),p=m.find(".js-phone-list"),q=m.find(".js-email-list");p.find("li .js-value, li .js-ext").removeAttr("name");
q.find("li .js-value, li .js-ext").removeAttr("name");m=m.serializeArray();var r=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],u=!0;d.each(m,function(t,v){v.value=d.trim(v.value);n.data.push(v);0<d.trim(v.value).length&&0<=r.indexOf(v.name)&&(u=!1)});u&&(m=e.$contactSection.find('[name="contact[firstname]"]'),m.length?n.errors.push({name:"contact[firstname]",value:e.locales.empty_contact_name}):(m=e.$contactSection.find('[name="contact[name]"]'),m.length&&n.errors.push({name:"contact[name]",
value:e.locales.empty_contact_name})));p.find("li").each(function(t){var v=d(this),w=v.find(".js-value");v=v.find(".js-ext");var x=w.val(),y=v.val();if(x){var A="contact[phone]["+t+"][value]";w.attr("name",A);n.data.push({name:A,value:x});t="contact[phone]["+t+"][ext]";v.attr("name",t);n.data.push({name:t,value:y})}});q.find("li").each(function(t){var v=d(this),w=v.find(".js-value");v=v.find(".js-ext");var x=w.val(),y=v.val();if(x){var A="contact[email]["+t+"][value]";w.attr("name",A);n.data.push({name:A,
value:x});t="contact[email]["+t+"][ext]";v.attr("name",t);n.data.push({name:t,value:y})}})})();e.$extendedFieldsW.length&&e.is_extended&&h();e.selected_access&&g();e.selected_segments&&k();e.create_deal&&l();return n}function b(g,k){k=k?k:[];g&&(k=g);d.each(k,function(l,h){l=h.value;var n=e.$wrapper.find(':input[name="'+h.name+'"]'),m=d("<div />").addClass("errormsg").text(l);n.length?n.hasClass("error")||(n.parent().append(m),n.addClass("error").one("focus click change",function(){n.removeClass("error");
m.remove()})):e.$errorsSection.append(m)})}function c(g){f||(f=!0,d.post("?module=contact&action=newSave",g,function(k){"ok"===k.status?d.crm.content.load(d.crm.app_url+"contact/"+k.data.contact.id+"/"):b(k.errors)},"json").always(function(){f=!1}))}var e=this,f=!1;e.$wrapper.on("click",".js-submit-form",function(g){g.preventDefault();e.$errorsSection.html("");g=a();g.errors.length?b(!1,g.errors):c(g.data)})};CRMNewContactPage.prototype.initExtendedFields=function(){function a(f){f=f||{};var g=b.$wrapper,
k="c-conditional-field-"+(""+Math.random()).slice(2),l=f.input_name;f.parent_field=f.parent_field||"";f.parent_options=f.parent_options||{};f.index=f.index||0;if(f.parent_field&&!d.isEmptyObject(f.parent_options)){var h=f.parent_field.split(":");if(!(1>=h.length)){h='[name="contact['+h[0]+"]["+f.index+"]["+h[1]+']"]';var n=g.find(h);if(!(0>=n.length)){f.show_empty_option=f.required;var m=f.parent_options,p=g.find(':input[name="'+l+'"]').first();if(!(0>=p.length)){if(p.is("input"))var q=p.next();else q=
p,p=q.prev();var r=function(){p[0].hasAttribute("name")||(p.attr("name",q.attr("name")),q[0].removeAttribute("name"));p.show().val("");q.hide()};g=function(){var u=p.is(":visible")?p.val():q.val();var t=d(this).val().toLowerCase();f.hide_unmatched&&p.closest(".field").show();if(m&&m[t]){t=m[t];p.hide();q.show().children().remove();f.show_empty_option&&q.append(d('<option value=""></option>'));for(var v=0;v<t.length;v++)q.append(d("<option></option>").attr("value",t[v]).text(t[v]));q.val(u);p[0].hasAttribute("name")&&
(q.attr("name",p.attr("name")),p[0].removeAttribute("name"))}else f.hide_unmatched?(r(),p.val(""),p.closest(".field").hide()):p.is(":visible")||(r(),p.val(u))};g.call(n);l=n.closest(".field");l.length?(l.off("."+k),l.on("change."+k,h,g)):(n.off("."+k),n.on("change."+k,g))}}}}}var b=this,c=b.$extendedFieldsW,e=c.find("form");(function(){var f=c.find(".js-dynamic-field-wrapper");f.each(function(){var g=d(this),k=g.find(".js-list"),l=k.find(".c-item")[0].outerHTML;g.on("click",".js-add",function(){k.append(l)});
g.on("click",".js-remove",function(){d(this).closest(".c-item").remove()});k.on("change",".js-ext-toggle",function(){var h=d(this),n=h.closest(".c-item").find(".js-ext-field");"custom"===h.val()?n.attr("disabled",!1).show():n.attr("disabled",!0).hide()})});c.on("prepareSave",function(){f.each(function(){d(this).find(".js-list").find(".c-item").each(function(g){d(this).find("[data-name-pattern]").each(function(){var k=d(this),l=k.data("name-pattern");l&&(l=l.replace("%index%",g),k.attr("name",l))})})})})})();
(function(){function f(g){function k(){h.each(function(){d(this).find(".js-address-wrapper").each(function(m){d(this).find("[data-name-pattern]").each(function(){var p=d(this),q=p.data("name-pattern");if(q&&(q=q.replace("%index%",m),p.attr("name",q),p.is("input"))){var r=p.closest(".js-custom-sub-field-line");r.is('[data-type="Conditional"]')&&(p=r.data("field-id"),r=r.data("subfield-id"),(p=l[p].fields[r])&&a(d.extend(p,{input_name:q,index:m})))}})})})}(function(){g.find(".js-custom-sub-field-line").each(function(){var m=
d(this),p=m.data("name-pattern");m.find(":input").each(function(){var q=d(this);q.attr("data-name-pattern",p);q.removeAttr("name")})});g.find('.js-custom-sub-field-line[data-type="Select"]').each(function(){var m=d(this);m.data("sub-type")||m.find("select").find('option[value=""]').text(m.data("label")+"...")});g.find('.js-custom-sub-field-line[data-type="Checkbox"]').each(function(){var m=d(this),p=m.find(":checkbox");p.wrap("<label>");p=p.parent();p.append("<span>");p.find("span").append(" "+m.data("label"))})})();
var l=b.extended_fields||{},h=g.find(".js-address-list"),n=g.find(".js-address-wrapper")[0].outerHTML;c.on("prepareSave",k);k();g.on("click",".js-add",function(){h.append(n);k()});g.on("click",".js-remove",function(){d(this).closest(".js-address-wrapper").remove()});g.on("click",".js-clear-selected-radio-value",function(){d(this).closest(".js-custom-sub-field-line").find(":radio:checked").attr("checked",!1)});g.on("change",".js-ext-toggle",function(){var m=d(this),p=m.closest(".js-address-wrapper").find(".js-ext-field");
"custom"===m.val()?p.attr("disabled",!1).show():p.attr("disabled",!0).hide()});g.on("change",".js-country-toggle",function(){function m(){w&&w.abort();w=d.post(d.crm.backend_url+"?module=profile&action=regions",{country:v},function(x){"ok"===x.status&&(d.isEmptyObject(x.data.options)?p(!1):p(x.data))}).always(function(){w=!1})}function p(x){u.html("");t.val("");x&&Object.keys(x).length?(u.attr("disabled",!1).show(),t.attr("disabled",!0).hide(),d.each(x.oOrder,function(y,A){(y=x.options[A])&&u.append('<option value="'+
A+'">'+y+"</option>")})):(u.attr("disabled",!0).hide(),t.attr("disabled",!1).show())}var q=d(this),r=q.closest(".js-address-wrapper"),u=r.find(".js-region-select"),t=r.find(".js-region-field"),v=q.val(),w=!1;v?m(v):p(!1)})}c.find(".js-address-section").each(function(){f(d(this))})})();(function(){var f=c.find(".js-bank-section");if(!f.length)return!1;var g=f.find(".js-bank-list"),k=f.find(".js-bank-wrapper")[0].outerHTML;f.on("click",".js-add",function(){g.append(k)});g.on("click",".js-remove",function(){d(this).closest(".js-bank-wrapper").remove()});
f.on("change",".js-ext-toggle",function(){var l=d(this),h=l.closest(".js-bank-wrapper").find(".js-ext-field");"custom"===l.val()?h.attr("disabled",!1).show():h.attr("disabled",!0).hide()});c.on("prepareSave",function(){g.each(function(){d(this).find(".js-bank-wrapper").each(function(l){d(this).find("[data-name-pattern]").each(function(){var h=d(this),n=h.data("name-pattern");n&&(n=n.replace("%index%",l),h.attr("name",n))})})})})})();(function(){c.find(".js-datepicker input:text").each(function(){function f(){try{d.datepicker.parseDate(d.datepicker._defaults.dateFormat,
...
this,c=b.$ownersList.find(".js-autocomplete");c.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user",appendTo:b.$wrapper,minLength:0,focus:function(){return!1},select:function(e,f){e=b.$ownersList.find('.c-owner[data-id="'+f.item.id+'"]');e=e.length?e:void 0;if(!e){var g=f.item;e=b.owner_template_html;f=g.photo_url;e=e.replace(/%id%/,g.id);var k=e.replace;g=g.name;g=d("<div></div>").text(g).html();e=k.call(e,"%name%",g).replace("%photo_url%",f);f=d(e);b.$ownersList.append(f);e=f}a(e);
...
minLength:0,focus:function(){return!1},select:function(f,g){f=b.$responsibleList.find('.c-responsible[data-id="'+g.item.id+'"]');f=f.length?f:void 0;if(!f){g=g.item;var k=b.responsible_template_html;f=g.photo_url;k=k.replace(/%id%/,g.id);var l=k.replace;var h=g.name;h=d("<div></div>").text(h).html();k=l.call(k,"%name%",h).replace("%photo_url%",f);d("#responsible_id").val(g.id);g=d(k);b.$responsibleList.append(g);d(".js-input").css("display","none");b.$submitButton.attr("disabled",!1);b.toggleButton(!0);
...
"?module=autocomplete&type=user",appendTo:b.$wrapper,minLength:0,focus:function(){return!1},select:function(e,f){e=b.$ownersList.find('.c-owner[data-id="'+f.item.id+'"]');e=e.length?e:void 0;if(!e){var g=f.item;e=b.owner_template_html;f=g.photo_url;e=e.replace(/%id%/g,g.id);var k=e.replace;g=g.name;g=d("<div></div>").text(g).html();e=k.call(e,"%name%",g).replace("%photo_url%",f);f=d(e);b.$ownersList.append(f);b.dialog.resize();e=f}a(e);b.toggleButton(!0);c.val("");return!1}}).data("ui-autocomplete")._renderItem=
...
function(){function a(k){function l(n){var m=d('<div class="line errormsg" />').html(n);f.append(m);c.$form.one("submit",function(){m.remove()})}if(k[0])d.each(k,function(n,m){l(m.value)});else{var h=Object.keys(k);d.each(h,function(n,m){l(k[m])})}}function b(k){g||(g=!0,d.post("?module=contact&action=addEmployeeSave",k,function(l){"ok"===l.status?(d.crm.content.reload(),c.dialog.close()):l.errors&&a(l.errors)}).always(function(){g=!1}))}var c=this,e=c.$wrapper.find("#c-contact-add-employee-form"),
...
function(f,g){return d("<li />").addClass("ui-menu-item-html").append("<div>"+g.value+"</div>").appendTo(f)};e.on("change",function(){a.$submitButton.attr("disabled",!1)})};CRMContactUpdateDialog.prototype.initSubmit=function(){function a(){var l={data:[],errors:[]},h=f.serializeArray();d.each(h,function(n,m){l.data.push(m)});return l}function b(l){l=l?l:[];d.each(l,function(h,n){h=n.value;var m=f.find('[name="'+n.name+'"]'),p=d("<span />").addClass("errormsg").text(h);m.length?m.hasClass("error")||
(m.parent().append(p),m.addClass("error").one("focus click",function(){m.removeClass("error");p.remove()})):(g.append(p),f.one("submit",function(){p.remove()}))})}function c(l){k||(k=!0,d.post("?module=contact&action=update",l,function(h){"ok"===h.status?e.$dialog.close():b(h.errors)},"json").always(function(){k=!1}))}var e=this,f=e.$form,g=e.$wrapper.find(".js-errors-place"),k=!1;f.on("submit",function(l){l.preventDefault();l=a();l.errors.length?b(l.errors):c(l.data)})};return CRMContactUpdateDialog}(jQuery),
CRMContactAddCompanyContactDialog=function(d){CRMContactAddCompanyContactDialog=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$company_value=this.$wrapper.find(".js-company-value");this.$submit=this.$wrapper.find(".js-submit");this.$footer=this.$wrapper.find(".js-dialog-footer");this.$company_id_input=this.$wrapper.find(".js-company-id");this.$company_name_input=this.$wrapper.find(".js-autocomplete-company");this.dialog=this.$wrapper.data("dialog");this.initClass()};
CRMContactAddCompanyContactDialog.prototype.initClass=function(){var a=this;a.$form.on("click",".js-company-item",function(){a.$submit.prop("disabled",!1)});a.initAutoComplete();a.initSubmit()};CRMContactAddCompanyContactDialog.prototype.initAutoComplete=function(){var a=this,b=a.$wrapper.find(".js-selected-company"),c=a.$wrapper.find(".js-change-company"),e=a.$wrapper.find(".js-label-new-company");a.$company_name_input.autocomplete({source:function(f,g){d.post("?module=autocomplete&type=company",
f,function(k){d.isEmptyObject(k)&&f.term?e.css({color:"#999"}):e.css({color:"#FFF"});g(k)},"json")},minLength:0,focus:function(){return!1},select:function(f,g){a.$company_id_input.val(g.item.id);b.html('<i class="icon userpic size-20" style="background-image: url('+g.item.photo_url+');"></i>').append(d("<span />").text(g.item.name)).removeClass("hidden");a.$company_name_input.addClass("hidden");return!1}}).data("ui-autocomplete")._renderItem=function(f,g){return d("<li />").addClass("ui-menu-item-html").append("<div>"+
g.value+"</div>").appendTo(f)};a.$company_name_input.on("focus",function(){a.$company_name_input.data("uiAutocomplete").search(a.company_name)});c.on("click",function(){a.$company_id_input.val(0);b.html("").addClass("hidden");a.$company_name_input.removeClass("hidden").focus()})};CRMContactAddCompanyContactDialog.prototype.initSubmit=function(){function a(){var c=d('<span class="icon loading"><i class="fas fa-spinner wa-animation-spin"></i></span>'),e=d.crm.app_url+"?module=contact&action=addCompanyContactSave",
...
hash:c,name:a.find(".crm-contact-list-name").text()};d.get(b,c).done(function(e){new CRMDialog({html:e})})})};CRMContactsPage.prototype.initTableSlider=function(){function a(){d.contains(document,g[0])?(q=g.outerWidth(),r=k.outerWidth(),b(),u&&(u=!1,t=0,e(t))):d(window).off("resize",a)}function b(){if(r>q){var v=t+q>=r,w=t+q<r;0<t?v?(m.addClass("is-active"),p.removeClass("is-active")):w&&(m.addClass("is-active"),p.addClass("is-active")):(m.removeClass("is-active"),p.addClass("is-active"))}else m.removeClass("is-active"),
p.removeClass("is-active")}function c(v){var w=q/3;v?(v=t+w,v>r-q&&(v=r-q)):(v=t-w,0>v&&(v=0));t=v;u=!0;e(v);b()}function e(v){var w="-"+v+"px";k.data("isLeftSet",0<v);k.css({"-webkit-transform":"translate("+w+",0)",transform:"translate("+w+",0)"});h.css({"-webkit-transform":"translate("+w+",0)",transform:"translate("+w+",0)"})}var f=this,g=f.$wrapper.find(".js-contacts-section");if(!g.length)return!1;var k=g.find(".js-slider-body"),l=g.find(".js-header-table-wrapper"),h=l.find(".js-header-table"),
n=g.find(".js-arrows-wrapper"),m=n.find(".js-arrow-left"),p=n.find(".js-arrow-right"),q=g.outerWidth(),r=k.outerWidth(),u=!1,t=0;b();(function(){function v(){if(d.contains(document,x[0])){var A=w.scrollTop()>y.top,B=f.$content.height()>w.height();A&&B?(l.css({left:y.left}).width(g.outerWidth()).addClass("is-fixed"),x.addClass("is-fixed")):(l.removeAttr("style").removeClass("is-fixed"),x.removeClass("is-fixed"))}else w.off("scroll",v)}var w=d(window),x=n,y=g.offset();w.on("scroll",v)})();m.on("click",
...
f=[],g=d.extend({},a.context,!0);g.is_assign=a.is_assign?1:0;var k=function(h){c.hide();b.attr("disabled",!1);a.sidebar&&d.each(h.segments||{},function(n,m){a.sidebar.updateItem({type:"segment",info:{id:m.id}},m)});g.is_assign?d.crm.content.reload():1==f.length?d.crm.content.load(d.crm.app_url+"contact/segment/"+f[0]+"/"):d.crm.content.load(d.crm.app_url)},l=function(h){h=d.extend({offset:h||0},g);d.post(e,h).done(function(n){"ok"==n.status&&(n.data.done?k(n.data):l(n.data.offset||0))})};b.click(function(h){h.preventDefault();
...
a.dialog&&(a.dialog.onCancel=function(){a.currentProcess&&a.currentProcess.cancel();a.dialog.close()})};CRMContactsOperationExport.prototype.cancel=function(){this.currentProcess&&this.currentProcess.cancel()};CRMContactsOperationExport.prototype.process=function(){var a=this,b=a.url,c=a.$wrapper,e=c.find(".js-export-contacts-progressbar").find(".js-export-contacts-progressbar-progress"),f=c.find(".progressbar-text"),g=null,k=null,l=!1,h=0,n=d.extend({},a.context,!0);n.separator=c.find("[name=separator]").val();
n.encoding=c.find("[name=encoding]").val();n.export_fields_name=c.find("[name=export_fields_name]").is(":checked")?1:0;n.not_export_empty_columns=c.find("[name=not_export_empty_columns]").is(":checked")?1:0;var m=function(q,r){0>=q?q=0:100<=q&&(q=100);r?(e.stop(),e.clearQueue(),e.animate({width:""+Math.round(q)+"%"},{duration:250,queue:!0})):e.css({width:""+Math.round(q)+"%"});100>q?f.text(Math.round(100*q/100)+"%"):(a.$wrapper.find(".crm-process-block .loader").html('<i class="icon fas fa-check yes"></i>'),
f.text("100%"),l=!0)},p=function(){a.$wrapper.find(".dialog-footer--visible").addClass("hidden");k&&clearTimeout(k);k=setTimeout(p,3200);!g||2<=h||(n.processId=g,d.post(b,n,function(q){h--;if(g&&q.ready){if(a.pid=g,a.pid){k&&clearTimeout(k);g=k=null;q=d.crm.app_url+"?module=contactOperationExport&action=process&processId="+a.pid;var r=a.$download_file_form.find('input[name="_csrf"]').val(),u=a.$download_file_form.find('input[name="file"]').val();d.post(q,{processId:a.pid,_csrf:r,file:u},function(t){t=
JSON.parse(t);a.$download_button.attr("href",d.crm.app_url+"?module=contactOperation&action=download&file="+t.file)});a.$wrapper.find(".dialog-footer--hidden").removeClass("hidden")}}else q.progress&&m(q.progress,!l)},"json"),h++)};a.$wrapper.find(".crm-start-block").hide();a.$wrapper.find(".crm-process-block").show();m(0,!1);d.post(b,n,function(q){q.processId||alert("Error processing request.");g=q.processId;p()},"json");return{cancel:function(){k&&clearTimeout(k);d.post(b,{processId:g,ready:1})}}};
...
h=l?d.crm.app_url+"contact/responsible/"+l+"/":d.crm.app_url+"contact/";d.post(f,g,function(n){"ok"===n.data.result?d.crm.content.reload().then(function(){c.dialog.close();d.crm.content.load(h)}):"no_vault_access"===n.data.result&&(d(".crm-dialog-header h1").html(c.$errorh1),d(".crm-dialog-content p, .js-responsible-list").html(""),d(".crm-dialog-footer").html('<a class="button js-close-dialog" href="javascript:void(0);">'+c.$close_dialog+"</a>"),d(".no-access-error").html(n.data.message),d.each(n.data.users,
function(m,p){d(".no-access-users").append('<a href="'+p.id+'" style="display: block; margin-top: 10px;"><i class="icon16 userpic20" style="background-image: url('+p.photo+');"></i><span>'+p.name+"</span></a>")}))},"json").always(function(){c.$submitButton.attr("disabled",!1);c.toggleButton(!1);k.remove();e=!1})}}function b(){var f=d("#responsible_id").val();return{contact_ids:d("#contact_ids").val(),responsible_id:f}}var c=this,e=!1;c.$form.on("submit",function(f){f.preventDefault();a()})};CRMContactsOperationAssignResponsible.prototype.initAutocomplete=
...
var l=f.name;l=d("<div></div>").text(l).html();g=k.call(g,"%name%",l).replace("%photo_url%",e);d("#responsible_id").val(f.id);f=d(g);b.$responsibleList.append(f);d(".js-input").css("display","none");b.$submitButton.attr("disabled",!1);b.toggleButton(!0);e=f}a(e);b.toggleButton(!0);c.val("");return!1}}).data("ui-autocomplete")._renderItem=function(e,f){return d('<li class="ui-menu-item-html"><div>'+f.value+"</div></li>").appendTo(e)};c.on("focus",function(){c.data("uiAutocomplete").search(c.val())});
...
this,b=a.$form,c=b.find(".crm-loading"),e=a.$button;b.submit(function(f){f.preventDefault();a.clearValidateErrors();e.attr("disabled",!0);c.show();d.post(b.attr("action"),b.serialize()).done(function(g){if("ok"!==g.status)e.attr("disabled",!1),c.hide(),a.showValidateErrors(g.errors||{});else if(!a.dialog.options.afterSave||!1!==a.dialog.options.afterSave(g))a:if(g.data.segment){var k="search"==a.segment.type,l="category"===g.data.segment.type?"category":"search",h=g.data.segment.id;if(0>=a.segment.id){if("search"===
l&&!k){d.crm.content.load(d.crm.app_url+"contact/search/segment/"+g.data.segment.id+"/");break a}d.crm.storage.set("crm/create/category",{id:h,timestamp:+new Date})}d.crm.content.load(d.crm.app_url+"contact/segment/"+g.data.segment.id+"/")}})})};CRMContactSegmentEdit.prototype.initDeleteLink=function(){var a=this,b=a.$wrapper.find(".crm-delete-link"),c=null,e=d.crm.app_url+"?module=dialogConfirm",f=null,g=d.crm.app_url+"?module=contactSegment&action=delete";b.click(function(k){k.preventDefault();
...
g.find("li .js-value, li .js-ext").removeAttr("name");var k=e.serializeArray(),l={data:[],errors:[]},h=["contact[firstname]","contact[middlename]","contact[lastname]","contact[name]"],n=!0;d.each(k,function(m,p){l.data.push({name:p.name,value:p.value});0<d.trim(p.value).length&&0<=h.indexOf(p.name)&&(n=!1)});n&&(l.errors.push({name:"contact[firstname]",value:"Name is empty"}),l.errors.push({name:"contact[name]",value:"Name is empty"}));f.find("li").each(function(m){var p=d(this),q=p.find(".js-value");
p=p.find(".js-ext");var r=q.val(),u=p.val();if(r){var t="contact[phone]["+m+"][value]";q.attr("name",t);l.data.push({name:t,value:r});m="contact[phone]["+m+"][ext]";p.attr("name",m);l.data.push({name:m,value:u})}});g.find("li").each(function(m){var p=d(this),q=p.find(".js-value");p=p.find(".js-ext");var r=q.val(),u=p.val();if(r){var t="contact[email]["+m+"][value]";q.attr("name",t);l.data.push({name:t,value:r});m="contact[email]["+m+"][ext]";p.attr("name",m);l.data.push({name:m,value:u})}});return l}
var b=this,c=b.$wrapper.find('.js-toggle-content[data-content="contact"]'),e=c.find("form");(function(){function f(h){d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",h,function(n){"ok"==n.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+"contact/"+n.data.contact.id+"/")):n.errors&&g(n.errors)},"json").always(function(){l=!1})}function g(h){h=h?h:[];d.each(h,function(n,m){n=m.name;m=m.value;"name"===n&&(n="contact[firstname]");var p=e.find('[name="'+n+
...
n=!0;d.each(k,function(m,p){l.data.push({name:p.name,value:p.value});0<d.trim(p.value).length&&0<=h.indexOf(p.name)&&(n=!1)});n&&(l.errors.push({name:"contact[firstname]",value:"Name is empty"}),l.errors.push({name:"contact[name]",value:"Name is empty"}));f.find("li").each(function(m){var p=d(this),q=p.find(".js-value");p=p.find(".js-ext");var r=q.val(),u=p.val();if(r){var t="contact[phone]["+m+"][value]";q.attr("name",t);l.data.push({name:t,value:r});m="contact[phone]["+m+"][ext]";p.attr("name",
m);l.data.push({name:m,value:u})}});g.find("li").each(function(m){var p=d(this),q=p.find(".js-value");p=p.find(".js-ext");var r=q.val(),u=p.val();if(r){var t="contact[email]["+m+"][value]";q.attr("name",t);l.data.push({name:t,value:r});m="contact[email]["+m+"][ext]";p.attr("name",m);l.data.push({name:m,value:u})}});return l}var b=this,c=b.$wrapper.find('.js-toggle-content[data-content="company"]'),e=c.find("form");(function(){function f(){var n={data:[],errors:[]},m=e.serializeArray();d.each(m,function(p,
q){q.value=d.trim(q.value);"contact[company]"===q.name&&n.data.push({name:"contact[name]",value:q.value});n.data.push(q)});m=c.find(".js-phone-list");m.find("li .js-value, li .js-ext").removeAttr("name");m.find("li").each(function(p){var q=d(this),r=q.find(".js-value");q=q.find(".js-ext");var u=r.val(),t=q.val();if(u){var v="contact[phone]["+p+"][value]";r.attr("name",v);n.data.push({name:v,value:u});p="contact[phone]["+p+"][ext]";q.attr("name",p);n.data.push({name:p,value:t})}});m=c.find(".js-email-list");
m.find("li .js-value, li .js-ext").removeAttr("name");m.find("li").each(function(p){var q=d(this),r=q.find(".js-value");q=q.find(".js-ext");var u=r.val(),t=q.val();if(u){var v="contact[email]["+p+"][value]";r.attr("name",v);n.data.push({name:v,value:u});p="contact[email]["+p+"][ext]";q.attr("name",p);n.data.push({name:p,value:t})}});n.data.push({name:"contact[is_company]",value:1});return n}function g(n){n=n?n:[];d.each(n,function(m,p){m=p.name;p=p.value;var q=c.find('[name="'+m+'"]');"contact[firstname]"!==
m||q.is(":visible")||(q=c.find(".js-contact-autocomplete"));var r=d("<span class='c-error' />").addClass("errormsg").text(p);q.length&&!q.hasClass("error")?(q.parent().append(r),q.addClass("error").one("focus click change",function(){q.removeClass("error");r.remove()})):(h.append(r),e.one("submit",function(){remove(r)}))})}function k(n){l||(l=!0,d.post(b.contact_id?"?module=deal&action=contactUpdate":"?module=contact&action=save",n,function(m){"ok"===m.status?(b.dialog.close(),d.crm.content.load(d.crm.app_url+
"contact/"+m.data.contact.id+"/")):m.errors&&g(m.errors)},"json").always(function(){l=!1}))}var l=!1,h=c.find(".js-errors-place");e.on("submit",function(n){n.preventDefault();n=f();n.errors.length?g(errors):k(n.data)})})();(function(){c.on("click",".js-extended-form",function(){var f=a(),g=[];g.push("extended=true");g.push("type=company");d.each(f.data,function(k,l){(k=d.trim(l.value))&&g.push(l.name+"="+k)});f=d.crm.app_url+"contact/new/?"+g.join("&");d.crm.content.load(f)})})()};return CRMContactAddDialog}(jQuery),
...
c.$toggleW.find(".js-show-fio").trigger("click",!0);f.val("");var m=0<=n.name.indexOf("@"),p=!!n.name.match(/^\+?\d/);m?c.$wrapper.find(".js-email-field").val(n.name).trigger("change"):p?c.$wrapper.find(".js-phone-field").val(n.name).trigger("change"):c.$wrapper.find(".js-firstname,.js-name").val(n.name).trigger("change")}}function b(n){d.each(k,function(m,p){m=n[p];var q="phone"===p||"email"===p,r;if(q){m="";for(r=(n[p]||[]).reverse();""==m&&0<r.length;)m=r.pop();d.isPlainObject(m)&&(m=m.value)}m=
d.trim(m||"");""!=m&&(p=q?c.$wrapper.find('[name="contact['+p+'][0][value]"]'):c.$wrapper.find('[name="contact['+p+']"]'),p.val(m))});f.attr("disabled",!0)}var c=this,e=c.$wrapper.find(".js-contact-autocomplete"),f=c.$wrapper.find(".js-field"),g=c.$wrapper.find(".js-contact-id-field"),k=["firstname","company","jobtitle","phone","email"],l="?module=autocomplete&add_new=true&join="+k.join(","),h=!1;e.autocomplete({appendTo:c.$wrapper,source:l,minLength:2,html:!0,focus:function(){return!1},select:function(n,
m){h=!0;a(m.item);e.blur();return!1},search:function(){g.val("")},open:function(){h=!1},change:function(){h||a({id:-1,name:e.val()})}}).data("ui-autocomplete")._renderItem=function(n,m){return d("<li />").addClass("ui-menu-item-html").append("<div>"+m.value+"</div>").appendTo(n)};e.on("keydown",function(n){13!==n.keyCode&&(f.attr("disabled",!1),f.val(""))})};CRMContactAddForm.prototype.initCompanyAutocomplete=function(){var a=this.$wrapper.find(".js-company-autocomplete"),b=this.$wrapper.find(".js-company-id-field");
...
e=a.$wrapper.find(".js-action-field"),f=a.$wrapper.find(".js-field"),g=a.$wrapper.find(".js-fio"),k=a.$wrapper.find(".js-combo-name");b.on("click",".c-toggle",function(l,h){l.preventDefault();h=!h;l=d(this);var n=l.data("mode");if(l.hasClass("is-active"))return!1;c.length&&c.removeClass("is-active");l.addClass("is-active");c=l;h&&a.$wrapper.find("input").val("").trigger("change");"fio"===n?(g.show(),k.hide(),e.val("new"),f.attr("disabled",!1)):(g.hide(),k.show(),e.val("search"));d(document).trigger("toggleChanged");
...
var f=d(this).data("content"),g=f===c;console.log(e.target);if(g)return!1;c=f;a.$wrapper.find(".js-toggle-content.is-active").removeClass("is-active");e=a.$wrapper.find('.js-toggle-content[data-content="'+f+'"]');e.length&&e.addClass("is-active")})};return CRMContactImportPage}(jQuery);var crmContactImportUpload=function(d){var a=function(c){var e=c.$wrapper,f=e.find("form"),g=e.find(".crm-import-upload-table"),k=e.find(".crm-import-upload-button"),l=e.find(".crm-total-count-column .crm-count");this.$wrapper=e;this.$form=f;var h=c.fieldInfo,n=/[\s~!@#\$%\^&\*\(\)_\+\|\\=\-`\{\}:"<>\?\[\];',\.\/]+/g,m=function(u,t){u+=1;t?(g.find("td:nth-child("+u+")").addClass("crm-highlight-cell"),k.attr("disabled",!1)):g.find("td:nth-child("+u+")").removeClass("crm-highlight-cell")};d("select",
g).each(function(u){d(this).change(function(){m(u,d(this).val())})});var p=function(){d(this).is(":checked")?(g.find("tbody tr:first").removeClass("crm-ignored-row"),l.html((parseInt(l.html(),10)||0)+1)):(g.find("tbody tr:first").addClass("crm-ignored-row"),l.html(parseInt(l.html(),10)-1||""))};d("input[name='first_line']",f).change(p);var q=!1,r=g.find("select");g.find("tbody tr:first-child td").each(function(u,t){var v=null,w=0,x=!1;t=d(t).text().toLowerCase().replace(n,"");for(var y in h){var A=
h[y],B=!1,E=0,z=!1;y.length>w&&!x&&0==t.indexOf(y)&&(E=y.length,B=!0);var C=A.name.toLowerCase().replace(n,"");C&&C.length>w&&0==t.indexOf(C)&&(E=C.length,z=B=!0);if(B){C=B=null;if(A.fields){for(var D in A.fields){if(0<=t.indexOf(D)){B=D;E+=D.length;break}if(0<=t.indexOf(A.fields[D].name.toLowerCase().replace(n,""))){B=D;E+=A.fields[D].name.length;break}}if(!B)continue}if(A.ext)for(var F in A.ext){if(0<=t.indexOf(F)){C=F;break}if(0<=t.indexOf(A.ext[F].toLowerCase().replace(n,""))){C=F;break}}v=y+
(B?":"+B:"")+(C?"."+C:"");w=E;x=z}}v&&w&&(r.eq(u).val(v),m(u,!0),q=!0)});q&&p.call(f.find("input[name='first_line']").attr("checked",!1));this.initCreateDealsSettings();this.initAddToSegments();f.submit(function(u){u.preventDefault();u=e.find(".crm-warning-require-primary-fields").hide();var t=!1;g.find("select").each(function(){var v=d(this).val();if("firstname"==v||"lastname"==v||"company"==v||"email"==v.substr(0,5))return t=!0,!1});t?(e.find(".crm-loading").show(),(new b({$wrapper:e,need_validation:f.find("[name=validate]").is(":checked"),
...
d.get(d.crm.app_url+"?module=contactOperation&action=AddToSegments",function(e){d.waDialog({html:e,onOpen:function(f){new CRMContactsOperationAddToSegments({$wrapper:f,onSave:function(g,k){var l=k.data("dialog"),h=[],n=[];k=d(".c-segment-item",k);for(var m=0;m<g.segment_ids.length;m+=1){var p=g.segment_ids[m],q=k.filter('[data-id="'+p+'"]');h.push(q.find(".c-name").text());n.push('<input type="hidden" name="segment_id[]" value="'+p+'">')}h="<span>"+h.join(",")+"</span>";n=n.join(" ");d(".c-add-to-segments-names",
c).html(h+n);l.close();return!1}})}})}):d(".c-add-to-segments-names",c).html("")})};var b=function(c){this.$wrapper=c.$wrapper;this.$form=this.$wrapper.find("form");this.processId=null;this.requests=0;this.$loading=this.$wrapper.find(".crm-loading");this.timer=null;this.messages=c.messages||{};this.url=d.crm.app_url+"?module=contact&action=importProcess"+(c.need_validation?"&need_validation=1":"");this.$progress_bar_dialog=this.$wrapper.find(".crm-import-progressbar-dialog");this.$progress_bar=this.$progress_bar_dialog.find(".crm-progressbar")};
...
var k="";k=0<f.rowsRejected?0>=f.rowsAdded?c.messages.no_imported:c.messages.some_imported:c.messages.all_imported;d.waDialog.alert({text:k,button_title:c.messages.button,button_class:"gray",onClose:function(){location.href=0<f.rowsAdded?d.crm.app_url+"contact/import/result/"+f.timeStart+"/":d.crm.app_url+"contact/import/"}})},queue:!1})):g.animate({width:""+Math.round(100*f.done/f.total)+"%"},{duration:500,queue:!1})},"json"),c.requests++)};d.post(c.url,c.$form.serializeArray(),function(f){c.processId=
...
location.href=d.crm.app_url+"?module=contactMergeDuplicates&field="+b+(d.crm.iframe?"&iframe=1":"")})};CRMContactsMergePage.prototype.initAutoMerge=function(){var a=this,b=a.$wrapper,c=a.$merge_field,e=a.$wrapper.find(".crm-auto-merge-duplicates-start-text"),f=a.$wrapper.find(".crm-auto-merge-duplicates-progress"),g=a.$table,k=a.$auto_merge_start_button,l=a.$auto_merge_pause_button,h=a.$auto_merge_resume_button,n=null,m=!1;a.$auto_merge_link.on("click",function(r){r.preventDefault();e.toggle();k.toggle()});
var p=function(r,u){var t=a.messages.progress,v=Math.round(1E3*parseFloat(r/u))/10;r=t.replace(":percentage:",v||0).replace(":count:",r).replace(":total_count:",u);f.find(".crm-text").text(r)},q=function(){var r=c.val(),u=0,t=a.groups_count;l.show();k.hide();h.hide();f.show();b.find(".pager").hide();var v=function(){var E=b.find(".crm-merge.crm-js-partial").length;d.get(d.crm.app_url+"?module=contact&action=mergeDuplicates",{offset:E,field:r,no_js:1}).done(function(z){if(z){z=d("<div>").html(z);var C=
z.find(".crm-duplicates-table tbody").find(".crm-mergeduplicates-row");C.length?(g.find("tbody").append(C),A()):B();z.remove()}else B()})},w=function(E){var z=d.crm.app_url+"?module=contact&action=mergeDuplicatesGetContacts";E.attr("data-field-value");d.get(z,{field:r,value:E.attr("data-field-value"),master_slaves:1},function(C){C&&"ok"===C.status&&!d.isEmptyObject(C.data)?x(E,C.data):(E.addClass("crm-finished"),n.resolve())},"json").fail(function(){n.resolve()})},x=function(E,z){crmContactMerger.merge({master_id:z.master,
slave_ids:z.slaves,onDone:function(C){if(C.result&&C.result.total_count===C.result.merged_count){var D=d.crm.app_url+"contact/"+C.master.id+"/";E.closest("tr").find("td:not(:first)").css({textDecoration:"line-through"}).end().find("td:first").html('<a href="'+D+'" target="_blank">'+d.crm.encodeHTML(C.master.name)+"</a>")}else E.addClass("crm-partial");C=C.message||a.messages.done||"Done";E.closest("td").css({textDecoration:""}).html('<span class="float-right" style="margin-right: 10px;">'+C+"</span>").append(E.hide().addClass("crm-finished"));
n.resolve()},onError:function(){n.resolve()}})},y=function(){m?setTimeout(y,1E3):A()},A=function(){var E=b.find(".crm-merge:not(.crm-finished):first");E.length?(E.parent().find(".crm-loading").css("opacity",1),n=new d.Deferred,n.fail(function(){l.hide();h.show()}),n.done(function(){u+=1;p(u,t);m?y():A()}),w(E)):u<t?v():B()},B=function(){k.hide();h.hide();l.hide();f.hide();a.$wrapper.find(".crm-attention-message").hide();a.$wrapper.find(".crm-done-message").show()};A()};k.click(function(r){r.preventDefault();
q()});h.click(function(r){r.preventDefault();l.show();h.hide();m=!1});l.click(function(r){r.preventDefault();m=!0;l.hide();h.show()});p(0,a.groups_count)};CRMContactsMergePage.prototype.initGroupMergeLinks=function(){var a=(new URLSearchParams(document.location.search)).get("iframe");if(window.parent&&a)this.$table.find(".js-merge-group-link").on("click",function(b){b.preventDefault();window.parent.history&&window.parent.history.pushState?window.parent.history.pushState({reload:!0},"",this.href):
...
","+this.area.top+")")};return a}(jQuery,d3);this.$wrapper.find(".js-svg-bar").each(function(){var b=d(this);new a({$wrapper:b})})};CRMReportPage.prototype.initChart=function(){function a(f,g){function k(l,h,n){var m=l.date.split("-");l=parseInt(m[0]);var p=parseInt(m[1]);m=parseInt(m[2]);l=[l,p,m];"years"===n?(n=l.slice(),n[0]+=h?1:-1):"months"===n?(n=l.slice(),n[1]+=h?1:-1):(n=l.slice(),n[2]+=h?1:-1);n[1]=(10>n[1]?"0":"")+n[1];n[2]=(10>n[2]?"0":"")+n[2];return{date:n.join("-"),value:0}}d.each(f,
function(l){l=f[l];if(1===l.data.length){var h=l.data[0],n=k(h,!1,g),m=k(h,!0,g);console.log(h);console.log(n);console.log(m);h=[n].concat(l.data);h.push(m);l.data=h;console.log(l.data)}});return f}var b=this.$wrapper.find(".js-graph-section");if(!b.length)return!1;var c=function(f){function g(h){function n(w){var x=w.split("-");w=parseInt(x[0]);var y=parseInt(x[1])-1;x=parseInt(x[2]);return new Date(w,y,x)}for(var m=[],p=0;p<h.length;p++){for(var q=h[p].data,r=[],u=0;u<q.length;u++){var t=q[u],v=
parseInt(t.value);r.push({date:n(t.date),value:v})}m.push(r)}return d3.layout.stack().offset("zero").values(function(w){return w}).x(function(w){return w.date}).y(function(w){return w.value})(m)}function k(h,n){n=(n[1]||1)-n[0]+1;for(var m=n/(h-1),p=[],q=0;q<h;q++){var r=10<n?Math.round(q*m):parseInt(q*m*10)/10;p.push(r)}return p}function l(h,n){var m=f(window),p=m.width();m.height();m=n.$hint.outerWidth();var q=n.$hint.outerHeight(),r=n.$wrapper.offset();n=h.pageX;h={left:n-r.left+10,top:h.pageY-
r.top+(0<q?0-q-2:2)};p<h.left+m&&(h.left=n-(m+10));return h}c=function(h){this.$wrapper=h.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=h.data;this.data=g(this.charts);this.color=h.color;this.group_by=h.group_by;this.locales=h.locales;this.margin={top:14,right:10,bottom:20,left:34};var n=this.node;h=this.margin;var m=n.offsetWidth;n=n.offsetHeight;this.area={outer_width:m,
outer_height:n,inner_width:m-h.left-h.right,inner_height:n-h.top-h.bottom};this.column_indent=4;h=this.area.inner_width;m=this.data[0].length;n=null;m+=1;h&&m&&(n=(h-this.column_indent*(m-1))/m,0>n&&(n=0));this.column_width=n;this.axisIndent=2;this.yDomain=this.xDomain=this.svgArea=this.svgLine=this.y=this.x=this.defs=this.svg=!1;this.initGraph()};c.prototype.initGraph=function(){var h=this,n=h.area;h.initGraphCore();h.svg=h.d3node.append("svg").attr("width",n.outer_width).attr("height",n.outer_height);
h.renderBackground();f.each(h.data,function(m,p){m=h.data.length-1-m;h.renderChart(h.data[m],h.charts[m])});h.renderAxis()};c.prototype.initGraphCore=function(){var h=this,n=h.data,m=h.area,p=h.x=d3.time.scale().range([0,m.inner_width]),q=h.y=d3.scale.linear().range([m.inner_height,0]);h.yDomain=function(){var r=d3.min(n,function(t){return d3.min(t,function(v){return v.value})});0<r&&(r=0);var u=d3.max(n,function(t){return d3.max(t,function(v){return v.value+v.y0})});return[r,u]}();h.xDomain=function(){var r=
n[0][0].date;var u=n[0][n[0].length-1].date;var t=.05*(u.getTime()-r.getTime());r=new Date(r.getTime()-t);u=new Date(u.getTime()+t);return[r,u]}();p.domain(h.xDomain);q.domain(h.yDomain);h.svgArea=d3.svg.area().interpolate("monotone").x(function(r){return p(r.date)}).y(function(r){return q(r.value+r.y0)-h.axisIndent}).y0(function(r){return q(0)});h.svgLine=d3.svg.line().interpolate("monotone").x(function(r){return p(r.date)}).y(function(r){return q(r.value+r.y0)-h.axisIndent})};c.prototype.renderAxis=
function(){var h=this.x,n=this.y,m=this.svg;h=d3.svg.axis().scale(h).orient("bottom").ticks(10);n=d3.svg.axis().scale(n).innerTickSize(2).orient("right").tickValues(k(6,this.yDomain)).tickFormat(function(p){return p+""});m=m.append("g").attr("class","axis");m.append("g").attr("transform","translate(10,"+this.margin.top+")").attr("class","y").call(n);m.append("g").attr("class","x").attr("transform","translate("+this.margin.left+","+(this.area.outer_height-this.margin.bottom)+")").call(h)};c.prototype.renderBackground=
function(){var h=this.area.inner_width,n=this.area.inner_height,m,p=this.svg.append("g").attr("class","background").attr("transform","translate("+this.margin.left+","+this.margin.top+")");p.append("rect").attr("width",h).attr("height",n);for(m=0;5>=m;m++){var q=1+(n-2)/5*m;p.append("line").attr("x1",1).attr("x2",h).attr("y1",q).attr("y2",q)}};c.prototype.renderChart=function(h,n){var m=this,p=n.color;m.svg.append("g").attr("class","c-graph-wrapper").attr("transform","translate("+m.margin.left+","+
m.margin.top+")").datum(h).append("path").style("stroke",function(){return 1<m.charts.length?"":m.color}).style("fill",function(){return p?p:m.color}).attr("class","area").attr("d",m.svgArea(h)).on("mouseover",function(q){m.showHint(d3.event,this,n)}).on("mousemove",function(){m.moveHint(this)}).on("mouseout",function(){m.hideHint()})};c.prototype.update=function(h){this.data=g(this.charts,h);this.initGraphCore();h=d3.svg.axis().scale(this.y).innerTickSize(2).orient("right").tickValues(k(6,this.yDomain)).tickFormat(function(n){return n+
""});this.svg.selectAll(".axis .y").call(h);this.renderCharts()};c.prototype.showHint=function(h,n,m){n=this.$hint.find(".js-name");this.$hint.find(".js-date");this.$hint.find(".js-value");m.name&&(n.text(m.name),h=l(h,this),this.$hint.css(h).addClass(this.show_class))};c.prototype.moveHint=function(){if(this.$hint.hasClass(this.show_class)){var h=l(event,this);this.$hint.css(h)}};c.prototype.hideHint=function(){this.$hint.removeAttr("style").removeClass(this.show_class)};return c}(jQuery),e=function(f){function g(l){function h(v){var w=
v.split("-");v=parseInt(w[0]);var x=parseInt(w[1])-1;w=parseInt(w[2]);return new Date(v,x,w)}for(var n=[],m=0;m<l.length;m++){for(var p=l[m].data,q=[],r=0;r<p.length;r++){var u=p[r],t=parseInt(u.value);q.push({date:h(u.date),value:t})}n.push(q)}return d3.layout.stack().offset("zero").values(function(v){return v}).x(function(v){return v.date}).y(function(v){return v.value})(n)}function k(l,h){var n=h[0];h=h[1]||1;n=0<h-n?h-n:1;h=n/(l-1);for(var m=[],p=0;p<l;p++){var q=10<n?Math.round(p*h):parseInt(p*
h*10)/10;q=0<parseInt(q)?parseInt(q):1;m.push(q)}return m}e=function(l){this.$wrapper=l.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=l.data;this.data=g(this.charts);this.color=l.color;this.group_by=l.group_by;this.locales=l.locales;this.margin={top:8,right:10,bottom:4,left:34};var h=this.node;l=this.margin;var n=h.offsetWidth;h=h.offsetHeight;this.area={outer_width:n,outer_height:h,
inner_width:n-l.left-l.right,inner_height:h-l.top-l.bottom};this.column_indent=200<this.data[0].length?2:4;l=this.area.inner_width;n=this.data[0].length;h=null;n+=1;l&&n&&(h=(l-this.column_indent*(n-1))/n,1>h?h=1:20<h&&(h=20));this.column_width=h;this.yDomain=this.xDomain=this.y=this.x=this.defs=this.svg=!1;this.initGraph()};e.prototype.initGraph=function(){var l=this.area;this.initGraphCore();200<this.data[0].length?this.$wrapper.addClass("is-large"):this.$wrapper.removeClass("is-large");this.svg=
this.d3node.append("svg").attr("width",l.outer_width).attr("height",l.outer_height);this.renderBackground();this.renderCharts();this.renderAxis()};e.prototype.initGraphCore=function(){var l=this.data,h=this.area,n=this.x=d3.time.scale().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([0,h.inner_height]);this.yDomain=function(){var m=d3.min(l,function(q){return d3.min(q,function(r){return r.value})});0<m&&(m=0);var p=d3.max(l,function(q){return d3.max(q,function(r){return r.value+r.y0})});
return[m,p]}();this.xDomain=function(){var m=l[0][0].date;var p=l[0][l[0].length-1].date;var q=.05*(p.getTime()-m.getTime());m=new Date(m.getTime()-q);p=new Date(p.getTime()+q);return[m,p]}();n.domain(this.xDomain);h.domain(this.yDomain)};e.prototype.renderAxis=function(){var l=this.x,h=this.y,n=this.svg;d3.svg.axis().scale(l).orient("bottom").ticks(10);l=d3.svg.axis().scale(h).innerTickSize(2).orient("right").tickValues(k(6,this.yDomain)).tickFormat(function(m){return m+""});n.append("g").attr("class",
"axis").append("g").attr("transform","translate(10,"+this.margin.top+")").attr("class","y").call(l)};e.prototype.renderBackground=function(){var l=this.area.inner_width,h=this.area.inner_height,n,m=this.svg.append("g").attr("class","background").attr("transform","translate("+this.margin.left+","+this.margin.top+")");m.append("rect").attr("width",l).attr("height",h);for(n=0;5>=n;n++){var p=1+(h-2)/5*n;m.append("line").attr("x1",1).attr("x2",l).attr("y1",p).attr("y2",p)}};e.prototype.renderCharts=function(){var l=
this,h=l.data;h=l.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+l.margin.left+","+l.margin.top+")");var n=h.selectAll(".rect").data(function(q){return q}),m=!1;if(l.color){var p=f.crm.color(l.color).rgb;p.push(.5);m="rgba("+p.join(",")+")"}n.enter().append("rect").attr("class","rect").on("mouseover",function(q,r,u){l.showHint(d3.event,this,q,l.charts[u])}).on("mousemove",function(){l.moveHint(this)}).on("mouseout",function(){l.hideHint()});
n.transition().duration(1E3).attr("x",function(q,r){return l.x(q.date)-l.column_width/2}).attr("y",function(q){return l.y(q.y0)}).attr("height",function(q){return l.y(q.value)}).style("stroke",function(q,r,u){return l.charts[u].color?"":l.color}).style("fill",function(q,r,u){q=l.charts[u];return q.color?q.color:m}).attr("width",l.column_width);n.exit().remove();h.exit().remove()};e.prototype.update=function(l){this.data=g(this.charts,l);this.column_indent=200<this.data[0].length?2:4;200<this.data[0].length?
this.$wrapper.addClass("is-large"):this.$wrapper.removeClass("is-large");this.initGraphCore();l=d3.svg.axis().scale(this.y).innerTickSize(2).orient("right").tickValues(k(6,this.yDomain)).tickFormat(function(h){return h+""});this.svg.selectAll(".axis .y").call(l);this.renderCharts()};e.prototype.showHint=function(l,h,n,m){var p=this;l=f(h);if(!(0<Math.ceil(l.attr("height"))))return!1;var q=n.date;h=p.$hint.find(".js-name");var r=p.$hint.find(".js-date"),u=p.$hint.find(".js-value");q=function(t,v){var w=
parseInt(t.getMonth());"months"==v?(t=p.locales.months,t[w]||(t="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ")),w=t[w]):
(v=t.getDate(),w+=1,w=(10>v?"0"+v:v)+"."+(10>w?"0"+w:w)+"."+t.getFullYear());return w}(q,p.group_by);m.name?h.text(m.name+": ").show():h.hide();r.text(q);u.text(n.value);n=function(t){var v=f(window),w=v.width();v.height();v=p.$hint.outerWidth();var x=p.$hint.outerHeight(),y=Math.ceil(t.attr("width")),A=Math.ceil(t.attr("height")),B=p.$wrapper.offset();t=t.offset();x={left:t.left-B.left+y+10,top:t.top-B.top+(A<x?A-x-2:2)};w<x.left+v&&(x.left=t.left-(v+10));return x}(l);p.$hint.css(n).addClass(p.show_class)};
...
this.$wrapper.find(".js-stage-graph-section"),c=a.stages;if(!b.length||!c.length)return!1;var e=[0,2*c.length],f=function(k){f=function(l){this.$wrapper=l.$wrapper;this.$hint=this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";console.log(l.data);for(var h=l.data,n=0;n<h.length;n++){var m=h[n];1!==n||m.color||(m.color="#e07d6e")}h=this.charts=h;n=[];for(m=0;m<h.length;m++){for(var p=h[m].data,q=[],r=0;r<p.length;r++){var u=
parseInt(p[r].value);q.push({index:1+2*r,value:u})}n.push(q)}this.data=n;this.color=l.color;this.group_by=l.group_by;this.locales=l.locales;this.margin={top:20,right:0,bottom:0,left:0};n=this.node;l=this.margin;h=n.offsetWidth;n=n.offsetHeight;this.area={outer_width:h,outer_height:n,inner_width:h-l.left-l.right,inner_height:n-l.top-l.bottom};this.column_indent=8;l=this.area.inner_width;h=this.data[0].length;n=null;l&&h&&(n=(l-this.column_indent*(h-1))/h,1>n&&(n=1));this.column_width=n;this.yDomain=
this.xDomain=this.y=this.x=this.defs=this.svg=!1;this.initGraph()};f.prototype.initGraph=function(){var l=this.area;this.initGraphCore();this.svg=this.d3node.append("svg").attr("width",l.outer_width).attr("height",l.outer_height);this.renderCharts()};f.prototype.initGraphCore=function(){var l=this.data,h=this.area,n=this.x=d3.scale.linear().range([0,h.inner_width]);h=this.y=d3.scale.linear().range([0,h.inner_height]);this.yDomain=function(){var m=d3.min(l,function(q){return d3.min(q,function(r){return r.value})});
0<m&&(m=0);var p=d3.max(l,function(q){return d3.max(q,function(r){return r.value})});return[m,p]}();this.xDomain=e;n.domain(this.xDomain);h.domain(this.yDomain)};f.prototype.renderCharts=function(){var l=this,h=l.data;h=l.svg.selectAll(".c-graph-wrapper").data(h);h.enter().append("g").attr("class","c-graph-wrapper").attr("transform","translate("+l.margin.left+","+l.margin.top+")");var n=h.selectAll(".rect").data(function(q){return q});n.enter().append("rect").attr("class","rect");n.transition().duration(1E3).attr("x",
function(q,r){return l.x(q.index)-l.column_width/2}).attr("y",function(q){return l.area.inner_height-l.y(q.value)}).attr("height",function(q){return l.y(q.value)}).style("stroke",function(q,r,u){return l.charts[u].color?"":l.color}).style("fill",function(q,r,u){q=l.charts[u];return q.color?q.color:l.color}).attr("width",l.column_width);var m=h.selectAll(".base-text").data(function(q){return q});m.enter().append("text").attr("class","base-text");m.transition().duration(1E3).attr("text-anchor","middle").attr("x",
...
r,u){q="";if(r=l.charts[u].data[r])q=r.over_text;return q});m.exit().remove();p.exit().remove();n.exit().remove();h.exit().remove()};return f}(jQuery),g=function(k){function l(h){for(var n=[],m=0;m<h.length;m++){for(var p=h[m].data,q=[],r=0;r<p.length;r++){var u=parseInt(p[r].value);q.push({index:1+2*r,value:u})}n.push(q)}return d3.layout.stack().offset("zero").values(function(t){return t}).x(function(t){return t.index}).y(function(t){return t.value})(n)}g=function(h){this.$wrapper=h.$wrapper;this.$hint=
this.$wrapper.find(".c-hint-wrapper");this.node=this.$wrapper.find(".js-graph")[0];this.d3node=d3.select(this.node);this.show_class="is-shown";this.charts=h.data;this.data=l(this.charts);this.color=h.color;this.group_by=h.group_by;this.locales=h.locales;this.margin={top:0,right:0,bottom:20,left:0};var n=this.node;h=this.margin;var m=n.offsetWidth;n=n.offsetHeight;this.area={outer_width:m,outer_height:n,inner_width:m-h.left-h.right,inner_height:n-h.top-h.bottom};this.column_indent=8;h=this.area.inner_width;
...
var m=n.selectAll(".rect").data(function(r){return r});m.enter().append("rect").attr("class","rect");m.transition().duration(1E3).attr("x",function(r,u){return h.x(r.index)-h.column_width/2}).attr("y",function(r){return h.y(r.y0)}).attr("height",function(r){return h.y(r.value)}).style("stroke",function(r,u,t){return h.charts[t].color?"":h.color}).style("fill",function(r,u,t){r=h.charts[t];return r.color?r.color:h.color}).attr("width",h.column_width);var p=n.selectAll(".base-text").data(function(r){return r});
p.enter().append("text").attr("class","base-text").text(function(r,u,t){r="";if(u=h.charts[t].data[u])r=u.base_text;return r}).append("tspan").style("fill","#cc270e").text(function(r,u,t){r="";(u=h.charts[t].data[u])&&u.sub_text&&(r=" ("+u.sub_text+")");return r});p.transition().duration(1E3).attr("text-anchor","middle").attr("x",function(r){return h.x(r.index)}).attr("y",16);var q=n.selectAll(".over-text").data(function(r){return r});q.enter().append("text").attr("class","over-text");q.transition().duration(1E3).attr("text-anchor",
"middle").attr("x",function(r){return h.x(r.index)}).attr("y",function(r){r=h.y(r.y0)+h.y(r.value)+16;34>r&&(r=34);return r}).text(function(r,u,t){r="";if(u=h.charts[t].data[u])r=u.over_text;return r});p.exit().remove();q.exit().remove();m.exit().remove();n.exit().remove()};return g}(jQuery);c=b.find(".js-graph-wrapper-1");c.length&&new f({$wrapper:c,data:a.charts[0],color:"#d0d0d0",group_by:this.group_by,locales:this.locales});b=b.find(".js-graph-wrapper-2");b.length&&new g({$wrapper:b,data:[a.charts[1]],
color:"#b0b0b0",group_by:this.group_by,locales:this.locales})};return CRMReportPage}(jQuery);(function(d){d.crm=d.crm||{};d.crm.search={state:null,url:d.crm.app_url+"?module=contactSearch",serialize:function(a,b,c,e){var f={},g=a.serializeArray();a=0;for(var k=g.length;a<k;a+=1){var l=(g[a].value||"").trim();try{l=JSON.parse(l)}catch(v){}var h=g[a].name;if(!(!h||!l||d.isPlainObject(l)&&d.isEmptyObject(l)||b&&0!==h.indexOf(b)||void 0!==c&&-1===h.indexOf("["+c+"]"))){var n=""+(d.isPlainObject(l)?l.val:l);if(n=d.trim(n)){l=d.isPlainObject(l)?l.op||"=":"=";n=n.replace(/\//g,"\\/").replace(/&/,
"\\&");h=h.split(".");for(var m=f,p=0,q=h.length-1;p<q;p+=1){var r=(h[p]||"").trim();if("undefined"===typeof m[r]||"object"!==typeof m[r])m[r]={};m=m[r]}r=h[h.length-1];d.isArray(m[r])?m[r].push({val:n,op:l}):d.isPlainObject(m[r])||(m[r]=[{val:n,op:l}])}}}var u=function(v,w,x){if(d.isPlainObject(v))for(var y in v)v.hasOwnProperty(y)&&u(v[y],w,x?x+"."+y:y);else"undefined"!==typeof v&&(w[x]=v)};b={};u(f,b,"");f=[];for(var t in b)if(b.hasOwnProperty(t))if(d.isArray(b[t])&&1<b[t].length)for(a=0,k=b[t].length;a<
k;a+=1)n=b[t][a].val,e||(n=this.encodeURIComponent(b[t][a].val)),f.push(t+"["+a+"]"+b[t][a].op+n);else n=b[t][0].val,e||(n=this.encodeURIComponent(b[t][0].val)),f.push(t+b[t][0].op+n);return f.join("&")},encodeURIComponent:function(a){a=encodeURIComponent(a);return a=a.replace(/%2F/g,"%252F").replace(/%5C/g,"%255C")},indexBlocks:function(a){var b={},c=d('#c-search-block .js-field[data-multiple="1"]');a&&(c=c.filter('[data-id="'+a+'"]'));c.each(function(){var e=d(this),f=e.data("id"),g=void 0!==b[f]?
...
typeof c.options.clear&&c.options.clear.apply(this))});this.input.bind("autocompleteopen",function(g,k){var l=c.input.width();c.ul.find("li.ui-menu-item").each(function(){var h=d(this),n=h.find(".count"),m=h.find(".crm-text");n.insertBefore(m);m.width(Math.max(l-n.outerWidth(!0)-30,0)).data("sep")&&h.css({borderTop:"0px solid #ccc"})});c.ul.width(l)});_other_version_||(this.input.bind("autocompleteopen",function(g,k){c.ul.width(c.input.outerWidth(!0)-5);void 0!==c.offset&&void 0!==c.count&&(c.offset<
c.count?(c.height=c.ul.height(),c.ul.unbind("scroll."+c.ns).bind("scroll."+c.ns,function(){var n=d(this).find(".dummy-end");n.length?d(this).scrollTop()+c.height>=n.position().top&&c.input.trigger("autocompleteload"):c.ul.unbind("scroll."+c.ns)}),g=c.ul.find(".ui-menu-item:first").height(),d('<li class="dummy-end ignore-hover" role="menuitem"><a class="ui-corner-all" style="padding: .2em .4em; line-height: 1.5; display: block;"></a></li>').height(g).appendTo(c.ul),c.ul.css({overflowY:"scroll",overflowX:"hidden",
height:c.height})):(c.ul.unbind("scroll."+c.ns),c.ul.css({overflowY:"",overflowX:""})));c.ul.find(".sep").closest("li").addClass("ignore-hover");var l=c.ul.width(),h="scroll"===c.ul.css("overflowY");c.ul.find("li.ui-menu-item").each(function(){var n=d(this);n.find(".sep").length?n.find(".sep").width(h?l-25:l-10):n.find(".crm-text").width(Math.max(l-n.find(".count").outerWidth(!0)-30,0))})}),this.input.bind("autocompleteload",function(g){!c.loading&&c.offset<c.count&&(c.loading=!0,c.input.addClass("ui-autocomplete-loading"),
d.get(c.options.url,{id:c.ns,offset:c.offset,limit:c.limit,term:c.input.val()},function(k){if("ok"===k.status){var l=k.data.values,h=[];c.ul.find(".ui-menu-item").each(function(){h.push(d(this).data("item.autocomplete"))});for(var n=0;n<l.length;n+=1)h.push(c._formItem(l[n]));c.count=k.data.count;c.response(h);c.offset+=l.length;c.offset>=c.count&&c.ul.find(".dummy-end").remove()}c.loading=!1;c.input.removeClass("ui-autocomplete-loading")},"json"))}));this.input.bind("autocompletefocus",function(g,
...
_source:function(a,b){var c=new RegExp(d.ui.autocomplete.escapeRegex(a.term),"i"),e=this;e.response=b;if(_other_version_&&!a.term)b([]);else{var f=function(k,l){_other_version_&&(k.highlight=1);d.get(e.options.url,k,function(h){var n=[],m=0;h&&"ok"===h.status&&(d.isArray(h.data.values)&&h.data.values.length&&(n=h.data.values),h.data.count&&(m=h.data.count));h=0;for(var p=n.length;h<p;h+=1)n[h]=e._formItem(d.extend(n[h],{option:null}));e.offset=n.length;e.count=m;b(n)},"json")};if(_other_version_)a.term?
...
(function(){function f(){d.contains(document,a[0])?g():k.off("resize",f)}function g(){var h=a.outerWidth(!0)-l-38;b.css("max-width",h+"px")}var k=d(window),l=a.find(".c-add-wrapper").outerWidth(!0);g();k.on("resize",f)})();d.crm.tabSlider({$wrapper:b,$slider:c,$activeSlide:e.length?e:!1});(function(){var f=!1;c.sortable({distance:10,items:"> li",axis:"x",start:function(g,k){},stop:function(){var g={ids:function(){var k=[];c.find(".c-company").each(function(){k.push(d(this).data("id"))});return k.join(",")}()};
f&&f.abort();f=d.post("?module=settings&action=companiesSortSave",g,function(k){}).always(function(){f=!1})}})})()};CRMSettingsCompanies.prototype.initTaxActions=function(){var a=this,b=a.$company.find(".js-tax-name"),c=a.$taxList;a.$company.on("click",".js-delete-option",function(e){e.preventDefault();d(this).closest("li").remove();b.find("li").length||b.attr("required",!1);a.toggleButton(!0)});a.$company.on("click",".js-add-option",function(e){e.preventDefault();d(a.tax_option_template).appendTo(c);
b.attr("required",!0);a.toggleButton(!0)});(function(){c.sortable({handler:".js-sort-toggle",helper:"clone",distance:10,items:"> li",axis:"y",start:function(e,f){},stop:function(e,f){}})})()};CRMSettingsCompanies.prototype.initLogoChange=function(){function a(h){h=h[0];if(h.type.match(/^image\/(png|jpe?g|gif)$/)){var n=new FileReader;n.onload=function(m){l.attr("src",m.target.result);b.$logoWrapper.removeClass(b.empty_class)};n.readAsDataURL(h);b.logo=h}}var b=this,c=!1,e=!1,f=b.$logoWrapper,g=f.find(".js-drop-area"),
k=g.find(".js-field"),l=f.find(".js-image");g.on("drop",function(h){h.stopPropagation();h=h.originalEvent.dataTransfer.files;h.length&&(a(h),b.toggleButton(!0))});k.on("change",function(){var h=this.files;h.length&&(a(h),b.toggleButton(!0))});f.on("click",".js-delete-logo",function(h){h.preventDefault();l.attr("src","");if(h=k.attr("name")){var n=d('<input type="hidden" />').attr("name",h).val("delete");k.attr("name","").data("name",h).after(n)}f.addClass(b.empty_class);b.logo=!1;b.toggleButton(!0)});
d(document).on("myDragEnter",function(){d.contains(document,g[0])?g.addClass("is-highlighted"):d(document).off("myDragEnter",watcher)});d(document).on("myDragLeave",function(){d.contains(document,g[0])?g.removeClass("is-highlighted"):d(document).off("myDragLeave",watcher)});g.on("dragover",function(h){h.preventDefault();c?clearTimeout(c):e||(e=!0,g.addClass("is-hover"));c=setTimeout(function(){c=null;e=!1;g.removeClass("is-hover")},100)})};CRMSettingsCompanies.prototype.initSubmit=function(){var a=
this,b=a.$wrapper.find(".js-form"),c=a.$wrapper.find(".js-errors-place"),e=a.$taxList,f=!1;b.on("submit",function(g){function k(){e.find(".c-tax-option").each(function(n){var m=d(this),p=m.find(".js-type");m=m.find(".js-percent");p.attr("name","company[tax_options]["+n+"][tax_type]");m.attr("name","company[tax_options]["+n+"][tax_percent]")});return b.serializeArray()}function l(n){n=n?n:[];d.each(n,function(m,p){m=p.name;p=p.value;var q=a.$wrapper.find('[name="'+m+'"]');q.removeClass("error");q.parent().find("span.errormsg").remove();
"contact[firstname]"!==m||q.is(":visible")||(q=a.$wrapper.find(".js-contact-autocomplete"));var r=d("<span class='c-error' />").addClass("errormsg").text(p);q.length&&!q.hasClass("error")?(q.parent().append(r),q.addClass("error").one("focus click change",function(){q.removeClass("error");r.remove()})):(c.append(r),b.one("submit",function(){remove(r)}))})}g.preventDefault();if(!f){f=!0;g=function(n){var m=new FormData;d.each(n,function(p,q){m.append(q.name,q.value)});d.each(a.files,function(p,q){m.append("images["+
q.code+"]",q.file)});a.logo&&m.append("logo",a.logo);(n=(n=document.cookie.match(/(?:^|; )_csrf=([^;]*)/))?decodeURIComponent(n[1]):"")&&m.append("_csrf",n);return m}(k());var h=d(a.locales.loading);h.insertAfter(a.$submitButton);d.ajax({url:"?module=settings&action=companiesSave",data:g,dataType:"json",processData:!1,contentType:!1,type:"POST",success:function(n){"ok"===n.status?(d(a.locales.saved_html).insertAfter(a.$submitButton),a.company_id?d.crm.content.reload():d.crm.content.load(d.crm.app_url+
"settings/companies/"+n.data.id+"/")):n.errors&&l(n.errors)}}).always(function(){h.remove();f=!1})}});b.on("keydown keypress keyup","input",function(g){13===g.keyCode&&g.preventDefault()})};CRMSettingsCompanies.prototype.initDeleteCompany=function(){var a=this,b=!1;a.$wrapper.on("click",".js-company-delete",function(c){c.preventDefault();b||(b=!0,d.post("?module=settings&action=companyDeleteDialog",{id:a.company_id},function(e){d.waDialog({html:e})}).always(function(){b=!1}))})};CRMSettingsCompanies.prototype.toggleButton=
function(a){var b=this.$submitButton,c=this.$footer.find(".js-edit-actions");a?(b.addClass("yellow"),c.show()):(b.removeClass("yellow"),c.hide())};CRMSettingsCompanies.prototype.initTemplatesSection=function(){function a(n,m){xhr&&xhr.abort();xhr=d.post("?module=settings&action=companiesRenderParams",{company_id:m,template_id:n},function(p){g.html(p);g.find(".c-color-section").each(function(){b(d(this))});g.find(".js-image-section").each(function(){c(d(this))})}).always(function(){xhr=!1})}function b(n){var m=
n.find(".c-colors"),p=n.find(".js-color-field"),q=m.find(".is-active"),r=function(t){r=function(v){this.$wrapper=v.$wrapper;this.$field=p;this.$icon=this.$wrapper.find(".js-toggle");this.$colorPicker=this.$wrapper.find(".js-color-picker");this.farbtastic=this.is_opened=!1;this.initClass()};r.prototype.initClass=function(){function v(){q.length&&(q.removeClass("is-active"),q=!1)}function w(y){t.contains(document,x.$wrapper[0])?27===y.keyCode&&x.is_opened&&x.displayToggle(!1):t(document).off("keyup",
w)}var x=this;x.farbtastic=t.farbtastic(x.$colorPicker,function(y){x.$field.val()!==y&&(v(),x.$field.val(y).change())});x.$wrapper.data("colorPicker",x);x.$field.on("change keyup",function(){var y=t(this).val();x.$icon.css("background-color",y);x.farbtastic.setColor(y)});x.$icon.on("click",function(y){y.preventDefault();x.displayToggle(!x.is_opened)});x.$field.on("focus",function(){x.is_opened||x.displayToggle(!0)});x.$field.on("keyup",v);t(document).on("keyup",w)};r.prototype.displayToggle=function(v){v?
(this.$wrapper.removeClass("is-hidden"),this.is_opened=!0):(this.$wrapper.addClass("is-hidden"),this.is_opened=!1)};return r}(jQuery),u=new r({$wrapper:n.find(".js-toggle-wrapper").first()});m.on("click",".js-set-color",function(t){t.preventDefault();t=d(this);q.length&&q.removeClass("is-active");t.addClass("is-active");q=t;t=t.data("color");p.val(t).change();u.is_opened&&u.displayToggle(!1)});p.trigger("change")}function c(n){function m(w){w=w[0];if(w.type.match(/^image\/(png|jpe?g|gif)$/)){var x=
new FileReader;x.onload=function(y){v.attr("src",y.target.result);n.removeClass(e.empty_class)};x.readAsDataURL(w);w={code:n.data("code"),type:"param_image",file:w};e.files.push(w);p();n.data("file",w)}}function p(){var w=n.data("file");w&&(w=e.files.indexOf(w),e.files.splice(w,1),n.data("file",!1))}var q=!1,r=!1,u=n.find(".js-drop-area"),t=u.find(".js-field"),v=n.find(".js-image");u.on("drop",function(w){w.stopPropagation();w=w.originalEvent.dataTransfer.files;w.length&&(m(w),e.toggleButton(!0))});
t.on("change",function(){var w=this.files;w.length&&(m(w),e.toggleButton(!0))});n.on("click",".js-delete-image",function(w){w.preventDefault();v.attr("src","");if(w=t.attr("name")){var x=d('<input type="hidden" />').attr("name",w).val("delete");t.attr("name","").data("name",w).after(x)}n.addClass(e.empty_class);p();e.toggleButton(!0)});d(document).on("myDragEnter",function(){d.contains(document,u[0])?u.addClass("is-highlighted"):d(document).off("myDragEnter",watcher)});d(document).on("myDragLeave",
function(){d.contains(document,u[0])?u.removeClass("is-highlighted"):d(document).off("myDragLeave",watcher)});u.on("dragover",function(w){w.preventDefault();q?clearTimeout(q):r||(r=!0,u.addClass("is-hover"));q=setTimeout(function(){q=null;r=!1;u.removeClass("is-hover")},100)})}var e=this,f=e.$wrapper.find(".c-templates-section"),g=f.find(".js-template-options-wrapper"),k=f.find(".c-templates-slider"),l=f.find(".c-templates-list"),h=l.find(".js-template-wrapper.is-active");xhr=!1;(function(){var n=
f.find(".js-template-wrapper.is-active");f.on("click",".js-template-wrapper",function(m){m.preventDefault();m=d(this);if(!m.hasClass("is-active")){var p=m.data("id");m.find(".js-field").attr("checked",!0).trigger("change");n.length&&n.removeClass("is-active");n=m.addClass("is-active");a(p,e.company_id)}})})();d.crm.tabSlider({$wrapper:k,$slider:l,$activeSlide:h.length?h:!1});f.find(".c-color-section").each(function(){b(d(this))});f.find(".js-image-section").each(function(){c(d(this))})};return CRMSettingsCompanies}(jQuery),
CRMCompanyDeleteDialog=function(d){CRMCompanyDeleteDialog=function(a){this.$wrapper=a.$wrapper;this.company_id=a.company_id;this.dialog=this.$wrapper.data("dialog");this.initClass()};CRMCompanyDeleteDialog.prototype.initClass=function(){this.initDelete()};CRMCompanyDeleteDialog.prototype.initDelete=function(){function a(){var k={data:[],errors:[]},l=f.serializeArray();d.each(l,function(h,n){k.data.push(n)});return k}function b(k,l){l=l?l:[];if(k){var h=Object.keys(k);d.each(h,function(n,m){l.push({name:m,
value:k[m]})})}d.each(l,function(n,m){n=m.value;var p=e.$form.find('[name="'+m.name+'"]');if(p.length&&!p.hasClass("error")){var q=d("<span />").addClass("errormsg").text(n);e.$wrapper.append(q);p.addClass("error").one("focus click change",function(){p.removeClass("error");q.remove()})}})}function c(k){g||(g=!0,d.post("?module=settings&action=companyDelete",k,function(l){"ok"===l.status?d.crm.content.load(d.crm.app_url+"settings/companies/"):b(l.errors)},"json").always(function(){g=!1;e.dialog.close()}))}
var e=this,f=e.$wrapper.find("form"),g=!1;f.on("submit",function(k){k.preventDefault();k=a();k.errors.length?b(!1,k.errors):c(k.data)})};return CRMCompanyDeleteDialog}(jQuery);var CRMSettingsCurrencies=function(d){CRMSettingsCurrencies=function(a){this.$wrapper=a.$wrapper;this.$currenciesList=this.$wrapper.find(".js-currencies-list");this.$currencySelect=this.$wrapper.find(".js-add-currency");this.currencies_is_locked=a.currencies_is_locked;this.currency_template_html=a.currency_template_html;this.copy_shop_currencies_dialog_html=a.copy_shop_currencies_dialog_html;this.locales=a.locales;this.currencies=a.currencies;this.initClass()};CRMSettingsCurrencies.prototype.initClass=
...
cancel_button_title:a.locales.confirm_cancel_button,cancel_button_class:"light-gray",onSuccess:function(){e()}}),b=!1)})()})};CRMSettingsCurrencies.prototype.initCurrenciesSort=function(){function a(){var e=[];b.$currenciesList.find(".c-currency").each(function(){var f=d(this).data("code");f&&e.push(f)});return e}var b=this,c=!1;b.$currenciesList.sortable({distance:10,handle:".js-sort-toggle",helper:"clone",items:"> .c-currency",axis:"y",stop:function(){c&&c.abort();var e={codes:a()};c=d.post("?module=settings&action=currenciesSort",
e,function(f){}).always(function(){c=!1})}})};CRMSettingsCurrencies.prototype.initShopToggle=function(){function a(){l.set(!1)}function b(){var h=d.waDialog({html:e.copy_shop_currencies_dialog_html}).$wrapper.find("form");h.on("submit",function(n){n.preventDefault();is_locked||(is_locked=!0,n=h.serializeArray(),d.post("?module=settings&action=currenciesShopCopy",n,function(){d.crm.content.reload()}).always(function(){is_locked=!1}))});h.on("click",".js-cancel-button",a)}function c(h){is_locked||(is_locked=
!0,d.post("?module=settings&action=currenciesShopCopy",h?{}:{disable:1},function(n){d.crm.content.reload()}).always(function(){is_locked=!1}))}var e=this,f=e.$wrapper.find(".js-shop-currency-toggle"),g=e.$wrapper.find("#shop-currency-switch");is_locked=!1;if(!f.length)return!1;var k=f.data("use-shop")||!1;g.waSwitch({change:function(h,n){is_locked||(h?k?d.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+e.locales.confirm_shop_title,text:e.locales.confirm_shop_text,
success_button_title:e.locales.confirm_shop_button,success_button_class:"danger",cancel_button_title:""+e.locales.confirm_cancel_button,cancel_button_class:"light-gray",onSuccess:function(){c(!0)},onCancel:a}):b():c(!1))}});var l=g.waSwitch("switch")};CRMSettingsCurrencies.prototype.initChangePrimary=function(){function a(){b||(b=!0,d.post("?module=settings&action=currenciesPrimary",{},function(c){d.waDialog({html:c,options:{onChange:function(e){d.crm.content.reload()}}})}).always(function(){b=!1}))}
var b=!1;this.$wrapper.on("click",".js-change-primary",function(c){c.preventDefault();a()})};CRMSettingsCurrencies.prototype.initCurrencyEdit=function(){var a=this.$currencySelect;this.$wrapper.on("click",".js-edit-currency",function(b){b.preventDefault();d(this).closest(".c-currency").addClass("is-edit")});this.$wrapper.on("click",".js-save-currency",function(b){function c(h){h=h?h:[];d.each(h,function(n,m){n=m.value;var p=e.find('[name="'+m.name+'"]'),q=d("<span />").addClass("errormsg").text(n);
...
function(){a.toggleButton(!0)})};CRMSettingsFunnel.prototype.initColorSection=function(){function a(h){var n=g.find(".c-stage .c-ornament .svg-icon"),m=n.length;if(4===h.length||7===h.length){var p=(new d.crm.color(h)).getRange();b.val(p[0]);c.val(p[1]);n.each(function(q){q=p.getColor(Math.floor(100*(q+1)/m));var r=d(this),u=r.find("svg");u.length?u.find("polygon").css("fill",q):r.data("color",q)})}}var b=this.$wrapper.find(".js-start-color-field"),c=this.$wrapper.find(".js-end-color-field"),e=this.$wrapper.find(".c-color-section .c-colors"),
f=this.$wrapper.find(".c-color-section .js-color-field"),g=this.$wrapper.find(".c-color-section .c-stages"),k=e.find(".is-active"),l=function(h){l=function(n){this.$wrapper=n.$wrapper;this.$field=f;this.$icon=this.$wrapper.find(".js-toggle");this.$colorPicker=this.$wrapper.find(".js-color-picker");this.farbtastic=this.is_opened=!1;this.initClass()};l.prototype.initClass=function(){function n(){k.length&&(k.removeClass("is-active"),k=!1)}var m=this;m.farbtastic=h.farbtastic(m.$colorPicker,function(p){m.$field.val()!==
p&&(n(),m.$field.val(p).change())});m.$wrapper.data("colorPicker",m);m.$field.on("change keyup",function(){var p=h(this).val();m.$icon.css("background-color",p);m.farbtastic.setColor(p)});m.$icon.on("click",function(p){p.preventDefault();m.displayToggle(!m.is_opened)});m.$field.on("click",function(){m.displayToggle(!m.is_opened)});m.$field.on("keyup",n)};l.prototype.displayToggle=function(n){n?(this.$wrapper.removeClass("is-hidden"),this.is_opened=!0):(this.$wrapper.addClass("is-hidden"),this.is_opened=
!1)};return l}(jQuery);e.on("click",".js-set-color",function(h){h.preventDefault();h=d(this);k.length&&k.removeClass("is-active");h.addClass("is-active");k=h;h=h.data("color");f.val(h).change()});f.on("change",function(){a(f.val())});new l({$wrapper:this.$wrapper.find(".js-toggle-wrapper").first()});f.change();d.crm.renderSVG(this.$wrapper)};CRMSettingsFunnel.prototype.initStagesSection=function(){function a(f){function g(k){function l(){var q=parseInt(n.val()),r=parseInt(p.val()),u="";0<q&&0<r&&
(u=q*r);m.val(u)}function h(q){q?(k.addClass("is-extended"),n.focus()):(k.removeClass("is-extended"),n.val(""),m.val(""),b.toggleButton(!0))}var n=k.find(".js-visible-time-field"),m=k.find(".js-hidden-time-field"),p=k.find(".js-time-period-select");k.on("click",".js-show-time",function(){h(!0)});k.on("click",".js-remove-limit",function(){h(!1)});n.on("change",l);p.on("change",l);n.on("keyup",function(){var q=d(this),r=q.val();r=parseInt(r.replace(",","").replace(".",""));isNaN(r)?q.val(""):r?q.val(r):
q.val("")});(function(){var q=m.val();q&&0<parseInt(q)&&(0===parseInt(q)%24?(p.val("24"),n.val(parseInt(q)/24)):p.val("1"))})()}f.find(".js-time-limit-wrapper").each(function(){g(d(this))})}var b=this,c=b.$stagesSection,e=b.$stages;e.on("click",".js-delete-stage",function(f){f.preventDefault();1<b.$stages.find("li").length&&d(this).closest(".c-stage").remove();b.toggleButton(!0)});e.on("keydown keypress keyup","input",function(f){13===f.keyCode&&f.preventDefault()});c.on("click",".js-add-stage",function(f){f.preventDefault();
f=d(b.stage_html);b.$stages.append(f);a(f);b.toggleButton(!0)});e.sortable({distance:10,handle:".js-sort-toggle",helper:"clone",items:"> li",axis:"y",start:function(f,g){},stop:function(f,g){b.toggleButton(!0)}});a(e)};CRMSettingsFunnel.prototype.initSave=function(){function a(){var l=c.$form.serializeArray();c.$stages.find("li").each(function(h){var n=d(this),m=n.data("id");l.push({name:"stages["+h+"][name]",value:n.find(".js-name-field").val()});m&&l.push({name:"stages["+h+"][id]",value:m})});return l}
...
location.href=d.crm.app_url+"settings/field/")})})};a.prototype.save=function(){var b=this,c=b.$form,e=d(".crm-dialog-edit-field-wrapper").find(".js-save"),f=d('<i class="fas fa-spinner fa-spin loading" style="vertical-align: middle;margin-left: 10px;"></i>');d(".loading").remove();e.prop("disabled",!0);var g=!0;c.find(".errormsg").text("");c.find(".error").removeClass("error");d('[name$="[localized_names]"]').each(function(){var k=d(this);!k.val()&&0>=k.parents(".template").length&&k.closest("tr").find('[name$="[_disabled]"]:checked').length&&
(g=!1,k.addClass("error").parent().append(d('<em class="errormsg"></em>').text(b.locales.field_is_required)))});if(!g)return e.attr("disabled",!1),!1;f.appendTo(e.parent());return d.post(c.attr("action"),c.serialize(),function(k){"ok"==k.status&&(d(".loading").remove(),d('<i class="fas fa-check-circle" style="vertical-align: middle;margin-left: 10px;"></i>').appendTo(e.parent()),setTimeout(function(){d.crm.content.reload();b.dialog.close()},1E3));if("ok"!==k.status&&k.errors){e.removeProp("disabled");
d(".loading").remove();for(var l=0,h=k.errors.length;l<h;l+=1){var n=k.errors[l];if("string"===typeof n)c.find(".errormsg.crm-common-errors").append(n);else if("object"===typeof n)for(var m in n)if(n.hasOwnProperty(m)){var p=c.find('[data-error-id="'+m+'"]');p.addClass("state-error");p.nextAll(".state-error-hint:first").text(n[m])}}c.one("input, keydown",".state-error",function(){d(this).removeClass("state-error").nextAll(".state-error-hint:first, .errormsg:first").empty()});c.find("[type=submit]").attr("disabled",
!1)}})};a.prototype.initIDAutoFiller=function(){var b,c=this.$form,e=c.find('input[name^="name["][data-main-locale]'),f=c.find('input[name="id_val"]'),g=null;f.on("keydown.check_edited",function(){var k=d(this);k.data("val",k.val())}).on("keyup.check_edited",function(){var k=d(this);k.val()&&k.val()!=k.data("value")&&(k.off(".check_edited"),k.data("edited",1))});if(!f.prop("disabled")&&!f.data("edited"))c.on("keydown.crm-id-auto-filler",'input[name^="name["]',function(){var k=d(this),l=c.find('[type="submit"]'),
h=f.next(".loading");if(k.data("main-locale")||!e.val())f.prop("disabled")||f.data("edited")?c.off(".crm-id-auto-filler"):(l.prop("disabled",!0),h=h.length?h:d('<i class="icon16 loading"></i>'),h.insertAfter(f),b&&clearTimeout(b),b=setTimeout(function(){var n=function(){g&&(g.abort(),g=null);b&&clearTimeout(b);l.prop("disabled",!1);h.remove()};f.data("edited")?n():g=d.post(d.crm.app_url+"?module=settings&action=fieldTransliterate",c.find('input[name^="name["]').serialize(),function(m){n();"ok"!==
m.status||f.data("edited")||f.val(m.data)},"json")},300))})};a.prototype.editSubFields=function(){function b(k){var l=d(".crm-dialog-edit-field-wrapper").find(".js-save");k?l.addClass("yellow").removeAttr("disabled"):l.removeClass("yellow")}var c=this,e=d(".crm-dialog-edit-field-wrapper"),f=e.find(".subfields-list > .ui-sortable"),g=1;f.sortable({items:".field-row",handle:".js-subfield-sort",axis:"y",update:function(k){b(!0)}});f.on("click","a.js-add-subfield",function(){var k=f.find(".field-row.template");
k=k.clone().insertBefore(k).removeClass("template").removeClass("hidden");c.dialog.resize();var l="__"+g;g++;k.find("[name]").each(function(){var h=d(this);h.attr("name",h.attr("name").replace(/%FID%/g,l))});k.data("fieldId",l);k.find("select.type-selector").change();b(!0);return!1});e.on("click",".js-edit-subfield",function(k){k.preventDefault();d(this).closest("tr").addClass("editor-on").removeClass("editor-off");b(!0)});e.on("click",".js-delete-subfield",function(k){k.preventDefault();var l=d(this).closest("tr");
l.hasClass("just-added")&&l.remove();d.crm.confirm.show({title:c.locales.delete_subfield_title,text:c.locales.delete_subfield_text,button:c.locales.delete_subfield_button,onConfirm:function(){l.addClass("editor-off").removeClass("editor-on");var h=l.find('input:hidden[name$="[_disabled]"]').attr("name").replace("[_disabled]","[_deleted]");d(".js-field-form-edit").append(d('<input type="hidden" name="" value="1">').attr("name",h));l.children().children(":not(label)").remove();l.find("label").addClass("gray").addClass("strike");
b(!0)}})});f.on("click","a.add-item",function(){c.dialog.resize()});e.on("change","select.type-selector",function(){var k=d(this),l=k.closest("tr"),h=l.closest("table"),n=l.find(".field-advanced-settings").html('<i class="icon16 loading"></i>');d.post(d.crm.app_url+"?module=settings&action=fieldEditor",{ftype:k.val(),fid:l.data("fieldId"),parent:h.data("fieldParent")||"",prefix:h.data("fieldPrefix")},function(m){n.html(m);b(!0)})});e.on("change",":checkbox, .name-input",function(){b(!0)});e.on("input change",
function(){b(!0)})};return a}(jQuery);var crmSettingsFieldEditSubfieldValues=function(d){var a=function(c){this.$wrapper=d(".subfields-list");this.$hidden=c.hidden;this.$dialog_link=c.dialog_link;this.dialog_url=c.dialog_url;this.locales=c.locales;this.initClass()};a.prototype.initClass=function(){this.initValuesLink()};a.prototype.initValuesLink=function(){var c=this;c.$wrapper.find(c.$dialog_link).on("click",function(){d.get(c.dialog_url,function(e){new CRMDialog({html:e,onOpen:function(f,g){c.editValues(f,g);c.initSubmit(f,g)}})})})};
a.prototype.editValues=function(c,e){var f=c.find("form");c.on("click",".s-add-rule",function(){var g=c.find(".s-new-rule");if(g.length){var k=g.clone();k.removeClass("s-new-rule").show().insertBefore(g);k.find('input[name^="parent"]').attr("disabled",!1);k.find(".s-add-value").click();b(c);k=parseInt(g.find('input[name="parent[]"]').val(),10)+1||1;g.find('input[name="parent[]"]').val(k);g.find('input[name^="parent_value"]').attr("name","parent_value["+k+"]");g.find('input[name^="value"]').attr("name",
"value["+k+"][0]");e.resize()}return!1});c.on("click",".s-add-value",function(){var g=d(this).parents("table:first").find(".s-new-value");if(g.length){var k=g.clone();k.addClass("sortable").removeClass("s-new-value").show().insertBefore(g);k.find("input").attr("disabled",!1);k=g.find("input:first").attr("name");var l=k.lastIndexOf("["),h=(parseInt(k.substr(l+1),10)||0)-1;k=k.substr(0,l)+"["+h+"]";g.find("input:first").attr("name",k)}e.resize();return!1});c.on("click",".s-delete-value",function(){var g=
d(this),k=g.attr("data-id");g=g.parents("tr:first");var l=g.parents("table:first");k&&f.append('<input type="hidden" name="delete[]" value="'+k+'">');g.remove();l.find("tr.sortable:first").length||l.parents("div.field:first").remove();e.resize();return!1});b(c);this.$hidden.val()?c.find("select.otherwise-options").val("hide"):c.find("select.otherwise-options").val("input")};a.prototype.initSubmit=function(c,e){var f=this,g=c.find("form"),k=c.find(".js-save-values"),l=d('<i class="icon16 loading" style="vertical-align: middle;margin-left: 10px;"></i>'),
h=d('<i class="icon16 yes" style="vertical-align: middle;margin-left: 10px;"></i>');g.submit(function(n){n.preventDefault();k.prop("disabled",!0);d(".loading").remove();l.appendTo(k.parent());var m=!0;c.find(".errormsg").remove();c.find(".error").removeClass("error");c.find('[name^="parent_value["]:not(:disabled)').each(function(){this.value||(m=!1,d(this).addClass("error").after(d('<em class="errormsg"></em>').text(f.locales.field_is_required)))});c.find('[name^="value["]:not(:disabled)').each(function(){this.value||
(m=!1,d(this).addClass("error").after(d('<em class="errormsg"></em>').text(f.locales.field_is_required)))});if(!m)return d("#s-field-values").closest(".dialog").find(".dialog-buttons :submit").attr("disabled",!1),!1;"input"==c.find("select.otherwise-options").val()?f.$hidden.val(""):f.$hidden.val("1").closest("td").find('input:checkbox[name$="[required]"]').attr("checked",!1);d.post(g.attr("action"),g.serialize()).done(function(p){d(".loading").remove();h.appendTo(k.parent());"ok"==p.status&&(f.$dialog_link.parents(".field-advanced-settings").find(".show-when-modified").show(),
...
a.each(function(){var e=d(this),f=e.closest(".c-source"),g=f.data("id"),k=f.find(".c-loading");e.find("#switch-"+g).waSwitch({ready:function(l){var h=l.$wrapper.siblings("label");l.$label=h;l.active_text=h.data("active-text");l.inactive_text=h.data("inactive-text")},change:function(l,h){k.show();h.disable(!0);b&&b.abort();b=d.post(c,{id:g,disabled:l?0:1}).done(function(n){"ok"===n.status&&(l?(h.$label.text(h.inactive_text),f.removeClass("c-is-disabled")):(h.$label.text(h.active_text),f.addClass("c-is-disabled")),
...
b=b.data("block_object");a=a.data("block_object");b.setResponsibleBlock(a)};CRMSettingsSourceEmail.clearValidateErrors=function(a){a.find(".error").removeClass("error");a.find(".crm-errors-block").remove()};CRMSettingsSourceEmail.showValidateErrors=function(a,b){var c={};d.each(b||{},function(e,f){"params"===e?d.each(f,function(g,k){c["source[params]["+g+"]"]=d.isArray(k)?k:[k]}):c[e?"source["+e+"]":""]=d.isArray(f)?f:[f]});CRMSettingsSourceEmail.clearValidateErrors(a);d.each(c,function(e,f){var g=
d('<div class="crm-errors-block"></div>');e=e?a.find('[name="'+e+'"]'):d();e.addClass("error");d.each(f,function(k,l){g.append('<em class="errormsg text-red">'+l+"</em>")});e.length?e.after(g):a.find(".crm-common-errors-block").append(g)})};return CRMSettingsSourceEmail}(jQuery);var CRMSettingsSourceEmailConnectionTestBlock=function(d){CRMSettingsSourceEmailConnectionTestBlock=function(a){this.$wrapper=a.$wrapper;this.source=a.source||{};this.url=a.url||d.crm.app_url+"?module=settingsSource&action=testConnection";this.initClass()};CRMSettingsSourceEmailConnectionTestBlock.prototype.initClass=function(){var a=this,b=a.$wrapper,c=b.find(".c-test-connection-button-block"),e=c.find(".c-loading"),f=c.find(".c-test-connection-success-message"),g=c.find(".c-test-connection-fail-message"),
k=null,l=b.find(".js-connection-settings-input"),h=b.find(".js-connection-settings-checkbox"),n=b.find(".c-test-connection-button"),m=function(){var p=a.url;k&&k.abort();f.hide();g.hide();e.show();l.attr("disabled",!0);var q=function(){g.show()};d.post(p,function(){var r=function(t){return{name:d.trim(t.attr("name")).match(/^source\[params\]\[(.+)\]$/)[1],value:t.val()}},u=[];l.each(function(){u.push(r(d(this)))});h.each(function(){var t=d(this);t.is(":checked")&&u.push(r(t))});0<a.source.id?u.push({name:"id",
...
"1":"0")});return y.join("@")},u=r(),t=function(){var y=r(),A=y!==u;u=y;return A},v=function(){c.show();n.show();f.hide();g.hide()},w=function(){q()?t()&&v():c.hide()},x=null;l.on("change",w).on("keydown",function(){x&&clearTimeout(x);x=setTimeout(function(){w()},250)});h.on("change",function(){t()&&v()})})();(function(){n.click(function(p){p.preventDefault();m()})})()};return CRMSettingsSourceEmailConnectionTestBlock}(jQuery);var CRMSettingsSourceIm=function(d){CRMSettingsSourceIm=function(a){this.$wrapper=a.$wrapper;this.$form=this.$wrapper.find("form");this.$button=this.$form.find("[type=submit]");this.source=a.source||{};this.messages=a.messages||{};this.changed=!1;this.submit_xhr=null;this.initClass()};CRMSettingsSourceIm.prototype.initClass=function(){this.initBlockToggles();this.initSubmit();this.initChangeListeners();0<this.source.id&&this.initDeleteLink()};CRMSettingsSourceIm.prototype.initChangeListeners=function(){var a=
...
function(b,c){b=a.find(".js-responsible-section").data("block_object");c?b.reload({}):b.reload({funnel_id:0})})};CRMSettingsSourceIm.prototype.setFormChanged=function(a){(a=void 0!==a?a:!0)?this.$button.addClass("yellow"):this.$button.removeClass("yellow");this.changed=a};CRMSettingsSourceIm.prototype.clearValidateErrors=function(){var a=this.$form;a.find(".error").removeClass("error");a.find(".crm-errors-block").remove()};CRMSettingsSourceIm.prototype.initSubmit=function(){var a=this,b=a.$form,c=
a.$wrapper.find(".crm-form-buttons").find(".crm-loading"),e=a.$button,f=b.find(".crm-success-status"),g=d.crm.app_url+"?module=settingsSource&action=save";CRMSettingsSourceIm.clearValidateErrors(b);b.submit(function(k){k.preventDefault();k=b.serializeArray();k.push({name:"id",value:0<a.source.id?a.source.id:a.source.provider});c.show();e.prop("disabled",!0);a.submit_xhr&&a.submit_xhr.abort();a.submit_xhr=d.post(g,k,null,"json").done(function(l){"ok"===l.status?(a.setFormChanged(!1),f.show().fadeOut(500,
function(){l.data.source?d.crm.content.load(d.crm.app_url+"settings/sources/"+l.data.source.id+"/"):d.crm.content.reload()})):CRMSettingsSourceIm.showValidateErrors(b,l.errors||{})}).always(function(){c.hide();e.prop("disabled",!1);a.submit_xhr=null})})};CRMSettingsSourceIm.prototype.initDeleteLink=function(){var a=this;a.$wrapper.find(".crm-delete-source-link").click(function(b){b.preventDefault();CRMSettingsSources.deleteSource(a.source.id,{messages:a.messages})})};CRMSettingsSourceIm.prototype.initIButton=
function(){var a=this;a.$wrapper.find(".c-checkbox .js-ibutton").each(function(){var b=d(this),c=b.parent();$switch_wrapper=d('<span class="switch smaller"></span>');$switch_wrapper.prependTo(c);b.clone().appendTo($switch_wrapper);b.remove();a.$switch=$switch_wrapper.waSwitch({ready:function(e){var f=e.$wrapper.siblings("label");e.$label=f;e.inactive_text=f.eq(0).text();e.active_text=f.eq(1).text();f.eq(0).removeClass("gray");f.eq(1).hide()},change:function(e,f){e?f.$label.text(f.active_text):f.$label.text(f.inactive_text)}})})};
CRMSettingsSourceIm.clearValidateErrors=function(a){a.find(".error").removeClass("error");a.find(".crm-errors-block").remove()};CRMSettingsSourceIm.showValidateErrors=function(a,b){var c={};d.each(b||{},function(e,f){"params"===e?d.each(f,function(g,k){c["source[params]["+g+"]"]=d.isArray(k)?k:[k]}):c[e?"source["+e+"]":""]=d.isArray(f)?f:[f]});CRMSettingsSourceIm.clearValidateErrors(a);d.each(c,function(e,f){var g=d('<div class="crm-errors-block"></div>');e=e?a.find('[name="'+e+'"]'):d();e.addClass("error");
d.each(f,function(k,l){g.append('<em class="errormsg">'+l+"</em>")});e.length?e.after(g):a.find(".crm-common-errors-block").append(g)})};return CRMSettingsSourceIm}(jQuery);var CRMSettingsSourceWithContactBlock=function(d){CRMSettingsSourceWithContactBlock=function(a){this.$wrapper=a.$wrapper;this.segments_list_stages=a.segments_list_stages||{};this.init()};CRMSettingsSourceWithContactBlock.prototype.init=function(){this.initAddToSegments()};CRMSettingsSourceWithContactBlock.prototype.initAddToSegments=function(){var a=this.$wrapper,b=this.segments_list_stages,c=a.find(".c-segments-ul-fold-link"),e=a.find(".c-segments-ul");c.click(function(){var f=c.data("state");f=
...
this.source=a.source||{};this.funnel_id=this.source.funnel_id;this.namespace=a.namespace||"";this.class_id=a.class_id||"";this.initClass();this.$wrapper.data("block_object",this)};CRMSettingsSourceResponsibleBlock.prototype.initClass=function(){var a=this,b=a.$wrapper,c=a.$group,e=a.$user,f=a.$user_id,g=a.$user_delete_link,k=a.$user_info,l=f.val(),h=function(){e.show().attr("disabled",!1).attr("required",!0)},n=function(){e.hide().attr("disabled",!0).attr("required",!1)};c.on("change"+a.ns,function(){var m=
d(this),p=m.parents(".crm-fields").find(".js-group-hint");f.val("");"personally"===m.val()?h():(n(),k.hide());"personally"===m.val()||""===m.val()?p.hide():p.show();0<m.val()&&f.val(-m.val());l!=f.val()&&(b.trigger("changeResponsibleUser",[l,f.val()]),l=f.val())});g.on("click"+a.ns,function(m){m.preventDefault();f.val("");h();k.hide()});e.autocomplete({source:d.crm.app_url+"?module=autocomplete&type=user&funnel_id="+a.funnel_id,minLength:0,html:!0,focus:function(){return!1},select:function(m,p){e.val("");
if(0>=p.item.rights)return!1;n();k.show();k.find(".crm-user-icon").css("background-image","url("+p.item.photo_url+")");k.find(".crm-user-name").text(p.item.name).attr("title",p.item.name);f.val(p.item.id);l!=f.val()&&(b.trigger("changeResponsibleUser",[l,f.val()]),l=f.val());return!1}}).data("ui-autocomplete")._renderItem=function(m,p){var q=d("<li />");q.addClass("ui-menu-item-html").append("<div>"+p.value+"</div>").appendTo(m);0<a.funnel_id&&!p.rights&&(q.addClass("is-locked"),q.on("click"+a.ns,
...
function(){var a=this.$wrapper,b=a.find(".crm-form-preview-submit-button-caption-input"),c=a.find(".crm-form-preview-submit-button"),e=function(f){f?(b.show(),c.hide(),b.val(c.val())):(b.hide(),c.show())};c.click(function(){e(!0)});b.blur(function(){c.val(b.val());e(!1)}).keyup(function(f){f.preventDefault();13==f.keyCode?(c.val(b.val()),e(!1)):27==f.keyCode&&e(!1)})};crmSettingsForm.prototype.initFormWidthInput=function(){var a=this.$wrapper,b=a.find(".crm-form-width-input"),c=a.find(".crm-form-preview-block");
b.keyup(function(e){13==e.keyCode&&(b.val(Math.max(Math.min(parseInt(b.val(),10)||0,600),200)),c.width(b.val()))})};crmSettingsForm.prototype.initTextEditor=function(){var a=this,b=a.$form.find('[name="form[params][confirm_mail_body]"]');b.waEditor({focus:!1,buttons:["formatting","bold","italic","link"],plugins:["fontcolor","fontsize","fontfamily"],minHeight:200,callbacks:{keydown:function(c){},change:function(){b.waEditor("sync");a.setFormChanged()}},lang:a.lang})};crmSettingsForm.prototype.initMessagesBlock=
...
f.prop("disabled",!0).prop("checked",!1)):f.prop("disabled",!1).prop("checked",f.data("checked"));f.is(":checked")?k.addClass("bold"):k.removeClass("bold")};a.find(".c-message-to-selector").each(function(){var f=d(this),g=f.find(".c-label");f=f.find(".c-message-to-variants-list");var k=f.find(':checkbox[data-id="client"]');e(k,!c);var l=[];f.find(":checkbox:checked:not(:disabled)").each(function(){var h=d(this).closest("li");l.push(h.find(".c-variant-name-text").text())});l=0<l.length?l.join(", "):
...
d.extend({},this.available_fields[a]);if("!horizontal_rule"===a.id||"!paragraph"===a.id)a.captionplace="none";return a}return null};crmSettingsForm.prototype.updateAvailableField=function(a,b){this.available_fields[a]&&d.extend(this.available_fields[a],b)};crmSettingsForm.prototype.addField=function(a,b,c){b=parseInt(b,10)||0;0>=b||!c||(this.deleteField(a,b),c=d.extend({},c,{id:a,checked:b}),this.form.params.fields.push(c))};crmSettingsForm.prototype.deleteField=function(a,b){var c=this.form.params.fields,
e=c.length;b=parseInt(b,10)||0;for(var f=[],g=0;g<e;g+=1)c[g].id==a&&c[g].checked==b||f.push(c[g]);b=0;e=f.length;for(g=0;g<e;g+=1)f[g].id==a&&(b+=1,f[g].checked=b);this.form.params.fields=f};crmSettingsForm.prototype.updateField=function(a,b,c){0>=b||(b=this.getField(a,b),b=d.extend(b,c),this.form.params.fields[a]=b,this.setFormChanged())};crmSettingsForm.prototype.renderField=function(a,b){var c=this.getField(a,b),e=this.$form_fields.find('.crm-form-field:not(.crm-form-field-template)[data-id="'+
...
"<label>"+f+(c.required&&"!captcha"!==c.id?" *":"")+"</label>");e.removeClass("crm-caption-style-none crm-caption-style-above").addClass("crm-caption-style-"+c.captionplace);e.find(":input:eq(0)").prop("placeholder",c.placeholder||"");"password"===c.id&&e.find(":input:eq(1)").prop("placeholder",c.placeholder_confirm||"");"!deal_description"===c.id&&this.renderDealDescription(c)}else e.remove()};crmSettingsForm.prototype.initFields=function(){var a=this;a.$form_fields.on("click",".crm-caption-col, .crm-input-col",
...
c.html=a;"!agreement_checkbox"===b?new crmSettingsFormAgreementCheckboxEditDialog(c):"!paragraph"===b?new crmSettingsFormParagraphEditDialog(c):new crmSettingsFormFieldEditDialog(c)}};crmSettingsForm.prototype.initSubmit=function(){var a=this,b=a.$form,c=b.find(".crm-loading"),e=b.find(".crm-success-status");b.on("keypress","input",function(f){13==f.keyCode&&f.preventDefault()});b.submit(function(f){f.preventDefault();f=b.serializeArray();var g=[];d.each(a.form.params.fields,function(k,l){if(0<l.checked){var h=
g.length;d.each(l,function(n,m){"html"!==n&&(g[h]=g[k]||{},g[h][n]=m)})}});f.push({name:"form[params][fields]",value:JSON.stringify(g)});a.clearValidateErrors();c.show();a.$button.prop("disabled",!0);a.submit_xhr&&a.submit_xhr.abort();a.submit_xhr=d.post(b.attr("action"),f).done(function(k){"ok"!==k.status?a.showValidateErrors(k.errors||{}):(a.setFormChanged(!1),e.show().fadeOut(500),d.crm.content.load(d.crm.app_url+"settings/form/"+k.data.form.id))}).fail(function(){a.showValidateErrors({"":a.messages.unknown_server_error})}).always(function(){c.hide();
setTimeout(function(){a.$button.prop("disabled",!1)},1500)})})};crmSettingsForm.prototype.clearValidateErrors=function(){var a=this.$form;a.find(".error").removeClass("error");a.find(".crm-errors-block").remove()};crmSettingsForm.prototype.showValidateErrors=function(a){var b=this.$form,c={};d.each(a||{},function(e,f){"params"===e?d.each(f,function(g,k){c["form[params]["+g+"]"]=d.isArray(k)?k:[k]}):c[e?"form["+e+"]":""]=d.isArray(f)?f:[f]});this.clearValidateErrors();d.each(c,function(e,f){var g=
d('<div class="crm-errors-block"></div>');e=e?b.find('[name="'+e+'"]'):d();e.addClass("error");d.each(f,function(k,l){g.append('<em class="errormsg">'+l+"</em>")});e.length?e.after(g):b.find(".crm-common-errors-block").append(g)})};crmSettingsForm.prototype.initDeleteLink=function(){var a=this,b=a.messages||{};a.$delete_link.click(function(c){c.preventDefault();d.crm.confirm.show({title:b.delete_confirm_title,text:b.delete_confirm_text,button:b.delete_confirm_button,onConfirm:function(){var e=d(".crm-confirm-dialog"),
f=e.find(".crm-loading").show(),g=e.find(".js-confirm-dialog").attr("disabled",!0);d.post(d.crm.app_url+"?module=settings&action=formDelete",{id:a.form.id}).always(function(){d.crm.content.load(d.crm.app_url+"settings/form");f.hide();g.attr("disabled",!1)});return!1}})})};crmSettingsForm.prototype.initSortable=function(){var a=this;a.$form_fields.sortable({distance:5,helper:"clone",items:".crm-form-field:not(:hidden)",opacity:.75,handle:".sort",tolerance:"pointer",containment:a.$form_fields,update:function(){for(var b=
a.form.params.fields,c=b.length,e={},f=[],g=a.$form_fields.find(".crm-form-field:not(.crm-form-field-template)"),k=0;k<c;k+=1)e[b[k].id+"-"+b[k].checked]=k;g.each(function(){var l=d(this),h=l.data("id");l=l.data("checked");f.push(b[e[h+"-"+l]])});a.form.params.fields=f;a.setFormChanged()}})};crmSettingsForm.prototype.initDeleteFieldLinks=function(){var a=this;a.$wrapper.on("click",".crm-delete-field-link",function(){var b=d(this).closest(".crm-form-field");a.deleteFormField(b)})};crmSettingsForm.prototype.deleteFormField=
...
function(){function a(){var k={data:[],errors:[]},l=f.serializeArray();d.each(l,function(h,n){k.data.push(n)});return k}function b(k,l){l=l?l:[];if(k){var h=Object.keys(k);d.each(h,function(n,m){l.push({name:m,value:k[m]})})}d.each(l,function(n,m){n=m.value;var p=e.$form.find('[name="'+m.name+'"]');if(p.length&&!p.hasClass("error")){var q=d("<span />").addClass("errormsg").text(n);e.$wrapper.append(q);p.addClass("error").one("focus click change",function(){p.removeClass("error");q.remove()})}})}function c(k){if(!g){g=
!0;var l=d(e.locales.saving);e.$footer.append(l);d.post("?module=settings&action=notificationsEditSave",k,"json").done(function(h){if("ok"!==h.status)b(h.errors||{});else if(0>=e.notification_id)d.crm.content.load(d.crm.app_url+"settings/notifications/edit/"+h.data.notification.id+"/");else{var n=d(e.locales.saved);e.$footer.append(n);setTimeout(function(){d.contains(document,n[0])&&n.remove()},2E3);d(document).trigger("formIsSaved")}}).always(function(){l.remove();g=!1})}}var e=this,f=e.$form,g=
...
d.get(g,k,function(l){d(".drawer .drawer-block").html(l);a(!0);f=!0},"html")})};return CRMNotificationEdit}(jQuery),CRMNotificationStatus=function(d){CRMNotificationStatus=function(a){this.$wrapper=a.$wrapper;this.messages=a.messages||{};this.messages.enable=this.messages.enable||"";this.messages.disable=this.messages.disable||"";this.notifications=a.notifications;this.initDisableLinks()};CRMNotificationStatus.prototype.initDisableLinks=function(){var a=this.$wrapper.find(".js-c-disable-link"),b=
null,c=d.crm.app_url+"?module=settingsNotifications&action=status";a.each(function(){var e=d(this),f=e.closest(".c-notification"),g=f.data("id"),k=f.find(".c-loading");e.find("#switch-"+g).waSwitch({ready:function(l){var h=l.$wrapper.siblings("label");l.$label=h;l.active_text=h.data("active-text");l.inactive_text=h.data("inactive-text")},change:function(l,h){k.show();h.disable(!0);b&&b.abort();b=d.post(c,{id:g,status:l?0:1}).done(function(n){"ok"===n.status&&(l?(h.$label.text(h.inactive_text),f.removeClass("c-is-disabled")):
...
d(this).data("id");f&&e.push(f)});return e}var b=this,c=!1;b.$list.sortable({distance:10,handle:".js-sort-toggle",helper:"clone",items:"> .c-vault-item",axis:"y",stop:function(e,f){var g=d(f.item);c&&c.abort();e={vaults:a()};var k=d(b.locales.saving);k.appendTo(g);c=d.post("?module=settings&action=vaultsSave",e,function(l){if("ok"==l.status){var h=d(b.locales.saved);h.appendTo(g);setTimeout(function(){d.contains(document,h[0])&&h.remove()},2E3)}}).always(function(){k.remove();c=!1})}})};return CRMSettingsVaults}(jQuery),
...
f.status&&e&&"function"===typeof e&&e()})}var b=this;b.$wrapper.on("click",".js-vault-delete",function(c){c.preventDefault();var e=b.vault_id;d.waDialog.confirm({title:'<i class="fas fa-exclamation-triangle smaller state-error"></i> '+b.locales.confirm_delete_title+"?",text:b.locales.confirm_delete_text,success_button_title:""+b.locales.confirm_delete_button,success_button_class:"danger",cancel_button_title:""+b.locales.confirm_cancel_button,cancel_button_class:"light-gray",onSuccess:function(){a(e,
function(){b.dialog.options.onDelete();b.dialog.close()})}})})};CRMVaultEdit.prototype.initSave=function(){function a(){var h={data:[],errors:[]},n=f.serializeArray();d.each(n,function(m,p){"data[name]"===p.name&&(k=p.value);"data[color]"===p.name&&(l=p.value);h.data.push(p)});return h}function b(h,n){n=n?n:[];if(h){var m=Object.keys(h);d.each(m,function(p,q){n.push({name:q,value:h[q]})})}d.each(n,function(p,q){p=q.value;var r=e.$form.find('[name="'+q.name+'"]');if(r.length&&!r.hasClass("error")){var u=
d("<span />").addClass("errormsg").text(p);e.$wrapper.append(u);r.addClass("error").one("focus click change",function(){r.removeClass("error");u.remove()})}})}function c(h){g||(g=!0,d.post("?module=settings&action=vaultDialogSave",h,function(n){"ok"===n.status?(console.log(e.dialog),e.dialog.options.onSave(n.data.id,k,l),e.dialog.close()):n.errors&&b(n.errors)},"json").always(function(){g=!1}))}var e=this,f=e.$form,g=!1,k="",l="#aaa";f.on("submit",function(h){h.preventDefault();h=a();h.errors.length?
b(!1,h.errors):c(h.data)})};CRMVaultEdit.prototype.initColorPicker=function(){var a=function(b){a=function(c){this.$wrapper=c.$wrapper;this.$field=c.$field;this.$icon=c.$icon;this.$colorPicker=c.$colorPicker;this.farbtastic=this.is_opened=!1;this.initClass()};a.prototype.initClass=function(){var c=this;c.farbtastic=b.farbtastic(c.$colorPicker,function(e){c.$field.val(e).change()});c.$wrapper.data("colorPicker",c);c.bindEvents()};a.prototype.bindEvents=function(){var c=this;c.$icon.on("click",function(e){e.preventDefault();
e.stopPropagation();c.displayToggle(!c.is_opened)});c.$colorPicker.on("click",function(e){e.stopPropagation()});c.$field.on("click",function(e){e.stopPropagation()});c.$field.on("focus",function(){c.is_opened||c.displayToggle(!0)});c.$field.on("change keyup",function(){var e=b(this).val();c.$icon.css("background-color",e);c.farbtastic.setColor(e)});b(document).on("click",function(){c.displayToggle(!1)});b(document).on("colorPickerIsOpened",function(){c.is_opened&&c.displayToggle(!1)})};a.prototype.displayToggle=
function(c){var e=this.$colorPicker;c?(b(document).trigger("colorPickerIsOpened",this),e.addClass("is-shown"),this.is_opened=!0):(b(document).trigger("colorPickerIsClosed",this),e.removeClass("is-shown"),this.is_opened=!1)};return a}(jQuery);this.$wrapper.find(".js-color-toggle").each(function(){var b=d(this);new a({$wrapper:b,$field:b.find(".js-field"),$icon:b.find(".js-toggle"),$colorPicker:b.find(".js-color-picker")})})};CRMVaultEdit.prototype.initNoAccessList=function(){var a=this,b=a.$wrapper.find(".js-no-access-wrapper");
b.on("click",".js-show-access-list",function(c){c.preventDefault();b.addClass("is-active");a.dialog.resize()});b.on("click",".js-hide-access-list",function(c){c.preventDefault();b.removeClass("is-active");a.dialog.resize()})};return CRMVaultEdit}(jQuery);var CRMSettingsMessagesBlock=function(d){CRMSettingsMessagesBlock=function(a){this.$wrapper=a.$wrapper;this.namespace=a.namespace||"";this.type=a.type||"form";this.initClass()};CRMSettingsMessagesBlock.prototype.initClass=function(){var a=this,b=a.$wrapper,c=a.namespace,e=d.crm.app_url+"?module=settings&action=emailTemplateEditor";a.renderCheckboxLabel();b.on("click",".js-crm-add-message-checkbox",function(){var f=d(this),g=b.find(".crm-template").clone();g.removeClass("crm-template");b.find(".crm-one-message:last").after(g.show());
...
this.$wrapper.find(".js-footer-actions"),b=a.find(".js-submit-button");this.$wrapper.on("change keydown","input, textarea, select",function(){b.addClass("yellow");a.addClass("is-changed")})};CRMSettingsShopWorkflowPage.prototype.initSubmit=function(){function a(){var l={data:[],errors:[]},h=f.serializeArray();d.each(h,function(n,m){l.data.push(m)});return l}function b(l){l&&l[0]||(l=[]);d.each(l,function(h,n){h=n.value;var m=e.$wrapper.find('[name="'+n.name+'"]'),p=d("<span class='c-error' />").addClass("errormsg").text(h);
m.length&&!m.hasClass("error")?(m.parent().append(p),m.addClass("error").one("focus click change",function(){m.removeClass("error");p.remove()})):(g.append(p),f.one("submit",function(){p.remove()}))})}function c(l){if(!k){k=!0;var h=d.crm.app_url+"?module=settings&action=shopWorkflowSave",n=e.$form.find(".c-loading");n.show();d.post(h,l,function(m){"ok"===m.status?d.crm.content.reload():b(m.errors)},"json").always(function(){k=!1;n.hide()})}}var e=this,f=e.$form,g=e.$wrapper.find(".js-errors-place"),
...
button_class:"warning"});setTimeout(function(){d(".js-dialog-close").click()},5E3)})}var c=this,e=a.data("plugin-id"),f=a.data("number"),g=!1;a.on("click",".js-user-delete",function(k){k.preventDefault();var l=d(this).closest(".c-user-wrapper"),h=l.find(".js-name");k=a.find(".js-number");h=h.html();d.waDialog.confirm({title:c.locales.delete_confirm_title.replace("%name%",h).replace("%number%",k.html()),text:c.locales.delete_confirm_text,success_button_title:c.locales.delete_confirm_button,success_button_class:"danger",
cancel_button_title:c.locales.dialog_error_button,cancel_button_class:"light-gray",onSuccess:function(){var n=l.data("id");g||(g=!0,d.post("?module=settingsPBX&action=delete",{p:e,n:f,u:n},function(m){"ok"===m.status&&l.remove()},"json").always(function(){g=!1}))}})});a.on("click",".js-delete-pbx-num",function(){var k=d(this).parents("tr"),l={p:e,n:f};k.addClass("hidden");d.post("?module=settingsPBX&action=deleteNumber",l,function(h){"ok"===h.status?k.remove():k.removeClass("hidden")},"json").always(function(){k.removeClass("hidden")})});
(function(){function k(p){p?h.addClass("is-shown"):h.removeClass("is-shown")}function l(p){m||(m=!0,d.post("?module=settingsPBX&action=add",{p:e,n:f,u:p.id},function(q){"ok"===q.status?(q=d(c.user_template_html),p.photo_url&&q.find(".userpic i").css("background-image","url("+p.photo_url+")"),q.find(".js-name").text(p.name),q.data("id",p.id),n.append(q)):b(q.errors)}).always(function(){m=!1}))}var h=a.find(".js-user-add-wrapper"),n=a.find(".js-users-list"),m=!1;h.on("click",".js-show-combobox",function(p){p.stopPropagation();
...
b&&clearTimeout(b),b=setTimeout(function(){a=d.post(d.crm.app_url+"?module=settings&action=fieldTransliterate",{"name[]":g},function(n){a&&(a.abort(),a=null);b&&clearTimeout(b);h.prop("disabled",!1);d(".fa-spinner").remove();"ok"===n.status&&l&&k.val(n.data)},"json")},300))})};CRMSettingsTemplate.prototype.validate=function(){var a=this.$param_list.find(".js-code-field"),b=this.locales;this.$param_list.find(".errormsg").remove();this.$param_list.find(".error").removeClass("error");a.each(function(){var c=
