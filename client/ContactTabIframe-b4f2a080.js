import{d as h,a as r,be as v,ai as w,P as b,B as p,o as a,c as s,g as i,k as y,f as l,h as g,v as k,F as I,q as x,s as C,i as S,_ as $}from"./main-07d84941.js";import{u as B}from"./iframeObserver-a4514515.js";import"./index-00e882cb.js";const j=e=>(x("data-v-d86997be"),e=e(),C(),e),q={key:0},D={key:1,class:"tw-absolute tw-top-1/2 tw-left-1/2 -tw-translate-x-1/2 -tw-translate-y-1/2"},E=j(()=>S("div",{class:"spinner custom-p-16"},null,-1)),F=[E],T=["srcdoc"],A=h({__name:"ContactTabIframe",props:{tab:{}},setup(e){const u=e,d=r(),o=r(""),c=r(!1),{data:f,error:m,isFetching:_}=v(u.tab.url).get().text();return B(d),w(()=>{b(f,n=>{if(n){const t=`
<!DOCTYPE html>
