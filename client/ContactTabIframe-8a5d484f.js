import{d as h,a as r,aY as v,aa as w,P as b,A as p,o as a,c as s,g as i,k as y,f as l,h as g,v as k,F as I,q as x,s as C,i as S,_ as $}from"./main-ad3d4b2a.js";import{u as j}from"./iframeObserver-2315e964.js";import"./index-38eb481c.js";const q=e=>(x("data-v-d86997be"),e=e(),C(),e),A={key:0},B={key:1,class:"tw-absolute tw-top-1/2 tw-left-1/2 -tw-translate-x-1/2 -tw-translate-y-1/2"},D=q(()=>S("div",{class:"spinner custom-p-16"},null,-1)),E=[D],F=["srcdoc"],T=h({__name:"ContactTabIframe",props:{tab:{}},setup(e){const u=e,d=r(),o=r(""),c=r(!1),{data:f,error:m,isFetching:_}=v(u.tab.url).get().text();return j(d),w(()=>{b(f,n=>{if(n){const t=`
<!DOCTYPE html>
