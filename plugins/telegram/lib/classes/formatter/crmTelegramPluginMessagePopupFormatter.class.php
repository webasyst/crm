...
class crmTelegramPluginMessagePopupFormatter extends crmTelegramPluginMessageContentFormatter
{
    ...
    protected function getAssigns()
    {
        return array(
            ...
            'sticker'    => ifset($this->message['params']['sticker_id']) ? $this->prepareSticker(24) : false,
            'photo'      => ifset($this->message['params']['photo']) ? $this->preparePhoto() : null,
    ...
    {
        return wa()->getAppPath("plugins/telegram/templates/source/message/formatted/PopupFormatted.html", 'crm');
    }
